...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S208)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z433)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z434)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z435)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z436)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z486)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X93,F2,Z315)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X89,F2,Z311)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X95,F2,Z317)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X91,F2,Z313)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X94,F2,Z316)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X90,F2,Z312)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X96,F2,Z318)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X92,F2,Z314)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9
       I3=K6*K5
       call EGEMM(I1,I2,I3,X72,F2,Z128)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9
       I3=K6*K7
       call EGEMM(I1,I2,I3,X73,F2,Z129)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9
       I3=K0*K5
       call EGEMM(I1,I2,I3,X74,F2,Z130)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K5*K9*K9
       I3=K6
       call EGEMM(I1,I2,I3,X86,F2,Z150)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K5*K9*K9
       I3=K0
       call EGEMM(I1,I2,I3,X87,F2,Z151)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S512)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call EGEMM(I1,I2,I3,X88,D2,Z234)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,X99,D2,Z331)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,X98,D2,Z329)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S588)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,X97,D2,Z327)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,X101,D2,Z334)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,X100,D2,Z333)
       deallocate(D2)
C
       call
