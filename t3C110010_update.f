...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U148)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,F1,B2,Z149)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U251)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K0*K6
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z312)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K0*K6
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z313)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z513)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z523)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z539)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z540)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z541)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z542)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U557)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call EGEMM(I1,I2,I3,F1,D2,Z558)
       deallocate(F1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,F1,B2,U738)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,X109,B2,Z252)
       deallocate(B2)
C
       V3C=V3C-Z252
       deallocate(Z252)
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X112,F2,Z308)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K9*K7
       call EGEMM(I1,I2,I3,X113,F2,Z309)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X115,F2,Z315)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X116,F2,Z316)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X117,F2,Z317)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X110,F2,Z306)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X111,F2,Z307)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X89,F2,Z131)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X92,F2,Z134)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X90,F2,Z132)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K7
       call EGEMM(I1,I2,I3,X93,F2,Z135)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K0
       I3=K0*K7
       call EGEMM(I1,I2,I3,X91,F2,Z133)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X94,F2,Z136)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K0*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X95,F2,Z137)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K0*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X96,F2,Z138)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N2,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K0*K6
       I3=K9*K8
       call EGEMM(I1,I2,I3,X97,F2,Z139)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0*K6
       I3=K5
       call EGEMM(I1,I2,I3,X104,F2,Z146)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K0*K6
       I3=K5
       call EGEMM(I1,I2,I3,X98,F2,Z140)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X100,F2,Z142)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K0*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X101,F2,Z143)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K0*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X102,F2,Z144)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N2,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K0*K6
       I3=K9*K8
       call EGEMM(I1,I2,I3,X103,F2,Z145)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0*K6
       I3=K8
       call EGEMM(I1,I2,I3,X105,F2,Z147)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6*K0*K6
       I3=K8
       call EGEMM(I1,I2,I3,X99,F2,Z141)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K6*K6
       I3=K0
       call EGEMM(I1,I2,I3,X108,F2,Z158)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K6*K0
       I3=K6
       call EGEMM(I1,I2,I3,X106,F2,Z153)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       ...
       I2=K8*K6
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S637)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N2))
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S655)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S668)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,Q91,B2,Q92)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,Q93,B2,Q95)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,Q93,B2,Q94)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       ...
       I2=K8*K6
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S777)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call EGEMM(I1,I2,I3,D1,D2,S763)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K0
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S775)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K0
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S766)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S774)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S788)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S770)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S785)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S807)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S813)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S815)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S800)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X88,F2,Z130)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K0
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S781)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
