...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K9*K7
       call EGEMM(I1,I2,I3,D1,F2,Z409)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,D1,F2,Z424)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,M2,N3,M1,N2,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K8*K6*K0
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z433)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,B1,D2,S335)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S336)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z664)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z665)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6
       I3=K0*K0*K8
       call EGEMM(I1,I2,I3,D1,F2,S576)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X93,F2,Z97)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X94,F2,Z98)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X95,F2,Z99)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X96,F2,Z100)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,N0,M1,t3B2,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X97,F2,Z152)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,M1,N2,N0,M1,t3B3,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X98,F2,Z153)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X99,F2,Z154)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K9*K7
       call EGEMM(I1,I2,I3,X100,F2,Z155)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3B3,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X101,F2,Z173)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3B3,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X102,F2,Z174)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X103,F2,Z175)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K9*K7
       call EGEMM(I1,I2,I3,X104,F2,Z176)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X129,F2,Z463)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X125,F2,Z459)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X131,F2,Z465)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X127,F2,Z461)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X130,F2,Z464)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X126,F2,Z460)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X132,F2,Z466)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X128,F2,Z462)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X137,F2,Z479)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X133,F2,Z475)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X139,F2,Z481)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X135,F2,Z477)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X138,F2,Z480)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X134,F2,Z476)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X140,F2,Z482)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X136,F2,Z478)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X106,F2,Z201)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X107,F2,Z202)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K7
       call EGEMM(I1,I2,I3,X108,F2,Z203)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X109,F2,Z208)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X110,F2,Z209)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X111,F2,Z210)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K7
       call EGEMM(I1,I2,I3,X112,F2,Z211)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X117,F2,Z216)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X113,F2,Z212)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X119,F2,Z218)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X115,F2,Z214)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X118,F2,Z217)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X114,F2,Z213)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K8
       call EGEMM(I1,I2,I3,X120,F2,Z219)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K8
       call EGEMM(I1,I2,I3,X116,F2,Z215)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6*K0
       I3=K5
       call EGEMM(I1,I2,I3,X121,F2,Z220)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6*K0
       I3=K8
       call EGEMM(I1,I2,I3,X122,F2,Z221)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K8*K9*K6
       I3=K6
       call EGEMM(I1,I2,I3,X123,F2,Z229)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K8*K9*K6
       I3=K0
       call EGEMM(I1,I2,I3,X124,F2,Z230)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S796)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S801)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q94,D2,S845)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q94,D2,S835)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S837)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S843)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8
       I3=K3*K4
       call EGEMM(I1,I2,I3,D1,D2,S842)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,M2,N3,M1,N1,t2A,D2)
       ...
       I2=K7*K6
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S881)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,D1,B2,S875)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       ...
       I2=K5*K9
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S892)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S886)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S893)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S878)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,D1,B2,S883)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S898)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S906)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S902)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S904)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q104,D2,S908)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q104,D2,S903)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S846)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
