...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z400)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call EGEMM(I1,I2,I3,X102,D2,Z457)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X70,F2,Z107)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K6*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X73,F2,Z104)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,M2,N3,M1,N2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K8*K6*K0
       I3=K6
       call EGEMM(I1,I2,I3,X84,F2,Z127)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K8*K6*K0
       I3=K0
       call EGEMM(I1,I2,I3,X85,F2,Z122)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,M2,N3,M1,N2,t2B,D2)
       ...
       I2=K8*K6*K0
       I3=K1
       call EGEMM(I1,I2,I3,X97,D2,Z250)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S473)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S467)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6*K0
       I3=K2
       call EGEMM(I1,I2,I3,X87,D2,Z147)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S551)
       deallocate(B1)
       deallocate(D2)
C
       call
