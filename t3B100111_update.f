       subroutine t3B100111_update(N0,N1,N2,N3,HT3B1,shift,
...
C
       ...
       real*8,allocatable::Z369(:,:,:,:,:,:)
       real*8,allocatable::Z370(:,:,:,:,:,:)
       real*8,allocatable::Z371(:,:,:,:,:,:)
       ...
       real*8,allocatable::Z632(:,:,:,:,:,:)
       real*8,allocatable::Z633(:,:,:,:,:,:)
       real*8,allocatable::Z660(:,:,:,:,:,:)
       real*8,allocatable::Z661(:,:,:,:,:,:)
       real*8,allocatable::Z662(:,:,:,:,:,:)
       real*8,allocatable::Z663(:,:,:,:,:,:)
C
       allocate(V3B(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       V3B=0.0d0
C
...
C
       ...
       X3=0.0d0
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X3,S3,-1.000)
       deallocate(S3)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X82(M1+1:N1,M2+1:N3,N1+1:M2,M1+1:N1))
       X82=0.0d0
       call
     & sum3124(M1,N1,M2,N3,N1,M2,M1,N1,X82,S37, 1.000)
       deallocate(S37)
C
       allocate(D1(N0+1:N1,M1+1:N1,N1+1:M2,M1+1:N1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X83(M1+1:N1,N1+1:M2,N1+1:M2,M1+1:N1))
       X83=0.0d0
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X83,S38, 1.000)
       deallocate(S38)
C
...
C
       ...
       X84=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X84,S49, 1.000)
       deallocate(S49)
C
       allocate(D1(N0+1:N1,M1+1:N1,M2+1:N3,N0+1:M1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X85(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:M1))
       X85=0.0d0
       call
     & sum3124(M1,N1,M2,N3,N1,M2,N0,M1,X85,S50, 1.000)
       deallocate(S50)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,N0+1:M1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X86(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:M1))
       X86=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X86,S51, 1.000)
       deallocate(S51)
C
       allocate(D1(N0+1:N1,M1+1:N1,N1+1:M2,N0+1:M1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X87(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:M1))
       X87=0.0d0
       call
     & sum3124(M1,N1,N1,M2,N1,M2,N0,M1,X87,S52, 1.000)
       deallocate(S52)
C
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X46(M2+1:N3,M2+1:N3,N1+1:M2,N1+1:M2))
       X46=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N1,M2,N1,M2,X46,S61,-1.000)
       deallocate(S61)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X47(M2+1:N3,N1+1:M2,N1+1:M2,N1+1:M2))
       X47=0.0d0
       call
     & sum4123(M2,N3,N1,M2,N1,M2,N1,M2,X47,S62,-1.000)
       deallocate(S62)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X48(N1+1:M2,N1+1:M2,N1+1:M2,N1+1:M2))
       X48=0.0d0
       call
     & sum4123(N1,M2,N1,M2,N1,M2,N1,M2,X48,S63,-1.000)
       deallocate(S63)
C
...
C
       call
     & sum3124(M2,N3,M2,N3,N1,M2,N1,M2,X46,S64, 1.000)
       deallocate(S64)
C
       allocate(D1(N0+1:N1,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum3124(M2,N3,N1,M2,N1,M2,N1,M2,X47,S65, 1.000)
       deallocate(S65)
C
       allocate(D1(N0+1:N1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum3124(N1,M2,N1,M2,N1,M2,N1,M2,X48,S66, 1.000)
       deallocate(S66)
C
       allocate(D1(N0+1:N1,N1+1:N3,M2+1:N3,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
     ...
     & N1,N3,M1,N1,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X88(M1+1:N1,M2+1:N3,N2+1:M2,M1+1:N1))
       X88=0.0d0
       call
     & sum4123(M1,N1,M2,N3,N2,M2,M1,N1,X88,S70, 1.000)
       deallocate(S70)
C
     ...
     & N1,N3,M1,N1,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X89(M1+1:N1,N2+1:M2,N2+1:M2,M1+1:N1))
       X89=0.0d0
       call
     & sum4123(M1,N1,N2,M2,N2,M2,M1,N1,X89,S71, 1.000)
       deallocate(S71)
C
...
C
       ...
       X90=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N2,M2,N0,M1,X90,S76, 1.000)
       deallocate(S76)
C
       allocate(D1(N1+1:N3,M1+1:N1,M2+1:N3,N2+1:M2))
       call reorder2413(N2,N3,N1,N3,N2,N3,N0,N1,
     ...
     & N1,N3,N0,M1,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X91(M1+1:N1,M2+1:N3,N2+1:M2,N0+1:M1))
       X91=0.0d0
       call
     & sum4123(M1,N1,M2,N3,N2,M2,N0,M1,X91,S77, 1.000)
       deallocate(S77)
C
...
C
       ...
       X92=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N2,M2,N0,M1,X92,S78, 1.000)
       deallocate(S78)
C
       allocate(D1(N1+1:N3,M1+1:N1,N2+1:M2,N2+1:M2))
       call reorder2413(N2,N3,N1,N3,N2,N3,N0,N1,
     ...
     & N1,N3,N0,M1,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X93(M1+1:N1,N2+1:M2,N2+1:M2,N0+1:M1))
       X93=0.0d0
       call
     & sum4123(M1,N1,N2,M2,N2,M2,N0,M1,X93,S79, 1.000)
       deallocate(S79)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,N1,N0,M1,M2,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S80(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
...
C
       ...
       X94=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X94,S80, 1.000)
       deallocate(S80)
C
     ...
     & N0,N1,M1,N2,M2,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S81(N1+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K9
       I3=K1
...
C
       ...
       X95=0.0d0
       call
     & sum3124(M1,N2,M2,N3,N1,M2,N0,M1,X95,S81, 1.000)
       deallocate(S81)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,N0+1:M1))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N0,M1,N1,M2,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S82(N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K9
       I3=K1
...
C
       ...
       X96=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X96,S82, 1.000)
       deallocate(S82)
C
     ...
     & N0,N1,M1,N2,N1,M2,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S83(N1+1:M2,M1+1:N2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K8
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X97(M1+1:N2,N1+1:M2,N1+1:M2,N0+1:M1))
       X97=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,N0,M1,X97,S83, 1.000)
       deallocate(S83)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X98(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:M1))
       X98=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X98,S84, 1.000)
       deallocate(S84)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,N0+1:M1))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X99(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:M1))
       X99=0.0d0
       call
     & sum3124(M1,N2,M2,N3,N1,M2,N0,M1,X99,S85, 1.000)
       deallocate(S85)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,N0+1:M1))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X100(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:M1))
       X100=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X100,S86, 1.000)
       deallocate(S86)
C
       allocate(D1(N0+1:N1,M1+1:N2,N1+1:M2,N0+1:M1))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X101(M1+1:N2,N1+1:M2,N1+1:M2,N0+1:M1))
       X101=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,N0,M1,X101,S87, 1.000)
       deallocate(S87)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N0+1:M1))
...
C
     ...
     & N0,N1,M2,N3,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S88(N1+1:M2,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X70(M2+1:N3,M2+1:N3,N2+1:M2,N1+1:M2))
       X70=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N2,M2,N1,M2,X70,S88,-1.000)
       deallocate(S88)
C
     ...
     & N0,N1,N2,M2,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S89(N1+1:M2,N2+1:M2,M2+1:N3,N2+1:M2))
       I1=K0*K6*K0
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X71(N2+1:M2,M2+1:N3,N2+1:M2,N1+1:M2))
       X71=0.0d0
       call
     & sum4123(N2,M2,M2,N3,N2,M2,N1,M2,X71,S89,-1.000)
       deallocate(S89)
C
     ...
     & N0,N1,M2,N3,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S90(N1+1:M2,M2+1:N3,N1+1:M2,N2+1:M2))
       I1=K0*K9*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X72(M2+1:N3,N1+1:M2,N2+1:M2,N1+1:M2))
       X72=0.0d0
       call
     & sum4123(M2,N3,N1,M2,N2,M2,N1,M2,X72,S90,-1.000)
       deallocate(S90)
C
     ...
     & N0,N1,N2,M2,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S91(N1+1:M2,N2+1:M2,N1+1:M2,N2+1:M2))
       I1=K0*K9*K0
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X73(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       X73=0.0d0
       call
     & sum4123(N2,M2,N1,M2,N2,M2,N1,M2,X73,S91,-1.000)
       deallocate(S91)
C
       allocate(D1(N0+1:N1,M2+1:N3,M2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,M2,N3,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S92(N1+1:M2,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X74(M2+1:N3,M2+1:N3,N2+1:M2,N1+1:M2))
       X74=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N2,M2,N1,M2,X74,S92,-1.000)
       deallocate(S92)
C
       allocate(D1(N0+1:N1,N2+1:M2,M2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N2,M2,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S93(N1+1:M2,N2+1:M2,M2+1:N3,N2+1:M2))
       I1=K0*K6*K0
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X75(N2+1:M2,M2+1:N3,N2+1:M2,N1+1:M2))
       X75=0.0d0
       call
     & sum4123(N2,M2,M2,N3,N2,M2,N1,M2,X75,S93,-1.000)
       deallocate(S93)
C
       allocate(D1(N0+1:N1,M2+1:N3,N1+1:M2,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,M2,N3,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S94(N1+1:M2,M2+1:N3,N1+1:M2,N2+1:M2))
       I1=K0*K9*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X76(M2+1:N3,N1+1:M2,N2+1:M2,N1+1:M2))
       X76=0.0d0
       call
     & sum4123(M2,N3,N1,M2,N2,M2,N1,M2,X76,S94,-1.000)
       deallocate(S94)
C
       allocate(D1(N0+1:N1,N2+1:M2,N1+1:M2,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N2,M2,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S95(N1+1:M2,N2+1:M2,N1+1:M2,N2+1:M2))
       I1=K0*K9*K0
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X77(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       X77=0.0d0
       call
     & sum4123(N2,M2,N1,M2,N2,M2,N1,M2,X77,S95,-1.000)
       deallocate(S95)
C
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z201(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z201,-1.000)
       deallocate(Z201)
       deallocate(S96)
C
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z202(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z202,-1.000)
       deallocate(Z202)
       deallocate(S97)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,M1+1:N1))
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S98(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N1))
       I1=K7*K6*K8
       I2=K9
       I3=K1
...
C
     ...
     & M1,N2,M2,N3,N1,M2,M1,N1,S98,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z203(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z203, 1.000)
       deallocate(Z203)
       deallocate(S98)
C
       allocate(D1(N0+1:N1,M1+1:N2,N2+1:M2,M1+1:N1))
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S99(N1+1:M2,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0*K8
       I2=K9
       I3=K1
...
C
     ...
     & M1,N2,N2,M2,N1,M2,M1,N1,S99,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z204(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z204, 1.000)
       deallocate(Z204)
       deallocate(S99)
C
...
C
     ...
     & M1,N2,M2,N3,N1,M2,M1,N1,S100,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z205(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z205, 1.000)
       deallocate(Z205)
       deallocate(S100)
C
...
C
     ...
     & M1,N2,N2,M2,N1,M2,M1,N1,S101,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z206(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z206, 1.000)
       deallocate(Z206)
       deallocate(S101)
C
       allocate(D1(N1+1:N3,M1+1:N2,M2+1:N3,N1+1:M2))
     ...
     & N1,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S102(M1+1:N1,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K7
       I3=K3
...
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,M1,N2,M2,N3,N1,M2,
     & M1,N2,M2,N3,N1,M2,M1,N1,S102,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z207(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z207,-1.000)
       deallocate(Z207)
       deallocate(S102)
C
       allocate(D1(N1+1:N3,M1+1:N2,N2+1:M2,N1+1:M2))
...
C
     ...
     & M1,N2,N2,M2,N1,M2,M1,N1,S103,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z208(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z208,-1.000)
       deallocate(Z208)
       deallocate(S103)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,N1,N0,M1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S104(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N0,M1,S104,D1)
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z209(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z209,-1.000)
       deallocate(Z209)
       deallocate(S104)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,N0+1:M1))
     ...
     & N0,N1,M1,N2,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S105(N1+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z210, 1.000)
       deallocate(Z210)
       deallocate(S105)
C
     ...
     & N0,N1,N0,M1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S106(N1+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z211,-1.000)
       deallocate(Z211)
       deallocate(S106)
C
     ...
     & N0,N1,M1,N2,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S107(N1+1:M2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z212, 1.000)
       deallocate(Z212)
       deallocate(S107)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,N1,N0,M1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S108(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,M1,M2,N3,N0,M1,
     & N0,M1,M2,N3,N1,M2,N0,M1,S108,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z213(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z213, 1.000)
       deallocate(Z213)
       deallocate(S108)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,N0+1:M1))
     ...
     & N0,N1,M1,N2,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S109(N1+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K9
       I3=K1
...
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,M1,N2,M2,N3,N0,M1,
     & M1,N2,M2,N3,N1,M2,N0,M1,S109,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z214(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z214,-1.000)
       deallocate(Z214)
       deallocate(S109)
C
       allocate(D1(N0+1:N1,N0+1:M1,N2+1:M2,N0+1:M1))
     ...
     & N0,N1,N0,M1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S110(N1+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,M1,N2,M2,N0,M1,
     & N0,M1,N2,M2,N1,M2,N0,M1,S110,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z215(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z215, 1.000)
       deallocate(Z215)
       deallocate(S110)
C
       allocate(D1(N0+1:N1,M1+1:N2,N2+1:M2,N0+1:M1))
     ...
     & N0,N1,M1,N2,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S111(N1+1:M2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K9
       I3=K1
...
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,M1,N2,N2,M2,N0,M1,
     & M1,N2,N2,M2,N1,M2,N0,M1,S111,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z216(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z216,-1.000)
       deallocate(Z216)
       deallocate(S111)
C
       allocate(D1(N1+1:N3,N0+1:M1,M2+1:N3,N1+1:M2))
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N0,M1,S112,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z217(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z217, 1.000)
       deallocate(Z217)
       deallocate(S112)
C
       allocate(D1(N1+1:N3,M1+1:N2,M2+1:N3,N1+1:M2))
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N0,M1,S113,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z218(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z218,-1.000)
       deallocate(Z218)
       deallocate(S113)
C
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N0,M1,S114,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z219(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z219, 1.000)
       deallocate(Z219)
       deallocate(S114)
C
       allocate(D1(N1+1:N3,M1+1:N2,N2+1:M2,N1+1:M2))
...
C
     ...
     & M1,N2,N2,M2,N1,M2,N0,M1,S115,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z220(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z220,-1.000)
       deallocate(Z220)
       deallocate(S115)
C
       allocate(D1(N1+1:N3,N0+1:M1,M2+1:N3,N1+1:M2))
     ...
     & N1,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S116(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K5
       I3=K3
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,M1,M2,N3,N1,M2,
     & N0,M1,M2,N3,N1,M2,N0,M1,S116,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z221(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z221,-1.000)
       deallocate(Z221)
       deallocate(S116)
C
       allocate(D1(N1+1:N3,M1+1:N2,M2+1:N3,N1+1:M2))
     ...
     & N1,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S117(N0+1:M1,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K5
       I3=K3
...
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder2341(N0,M1,M1,N2,M2,N3,N1,M2,
     & M1,N2,M2,N3,N1,M2,N0,M1,S117,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z222(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z222, 1.000)
       deallocate(Z222)
       deallocate(S117)
C
       allocate(D1(N1+1:N3,N0+1:M1,N2+1:M2,N1+1:M2))
     ...
     & N1,N3,N0,M1,N2,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S118(N0+1:M1,N0+1:M1,N2+1:M2,N1+1:M2))
       I1=K9*K0*K5
       I2=K5
       I3=K3
...
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,M1,N2,M2,N1,M2,
     & N0,M1,N2,M2,N1,M2,N0,M1,S118,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z223(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z223,-1.000)
       deallocate(Z223)
       deallocate(S118)
C
       allocate(D1(N1+1:N3,M1+1:N2,N2+1:M2,N1+1:M2))
     ...
     & N1,N3,M1,N2,N2,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S119(N0+1:M1,M1+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K8
       I2=K5
       I3=K3
...
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder2341(N0,M1,M1,N2,N2,M2,N1,M2,
     & M1,N2,N2,M2,N1,M2,N0,M1,S119,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z224(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z224, 1.000)
       deallocate(Z224)
       deallocate(S119)
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       allocate(S120(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X1,S120,-1.000)
       deallocate(S120)
C
     ...
     & N2,N3,N0,M1,t1B,B2)
       allocate(S121(N0+1:M1,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,M1,N1,X1,S121, 1.000)
       deallocate(S121)
C
     ...
     & N0,N2,N0,N1,N0,M1,N0,M1,VBHHHH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S122(N2+1:M2,N0+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,N0,M1,X2,S122,-1.000)
       deallocate(S122)
C
     ...
     & N2,N3,N0,N1,N2,M2,N0,M1,VBHPHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S123(N0+1:M1,N0+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,N0,M1,X2,S123, 1.000)
       deallocate(S123)
C
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X3,S124,-1.000)
       deallocate(S124)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder3241(N0,N2,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N1,M2,N0,M1,VBPHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S125(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X4,S125,-1.000)
       deallocate(S125)
C
...
C
       call
     & sum4123(N1,N3,N2,M2,N1,M2,N0,M1,X3,S126, 1.000)
       deallocate(S126)
C
       allocate(D1(N2+1:N3,N1+1:N3,N2+1:M2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,N3,N1,N3,N2,M2,N1,M2,VBAPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S127(N0+1:M1,N1+1:N3,N2+1:M2,N1+1:M2))
       I1=K9*K0*K3
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N1,N3,N2,M2,N1,M2,N0,M1,X4,S127, 1.000)
       deallocate(S127)
C
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,M1,N1,X9,S128, 1.000)
       deallocate(S128)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3124(N0,N2,N1,N3,N2,N3,N0,N1,
     & N2,N3,N0,N2,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S129(N0+1:M1,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,M1,N1,X10,S129, 1.000)
       deallocate(S129)
C
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X11,S130,-1.000)
       deallocate(S130)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S131(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X12,S131,-1.000)
       deallocate(S131)
C
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,N0,M1,X13,S132, 1.000)
       deallocate(S132)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,N0+1:M1))
       call reorder3124(N0,N2,N1,N3,N2,N3,N0,N1,
     & N2,N3,N0,N2,N1,M2,N0,M1,VBHPPH,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S133(N0+1:M1,N0+1:N2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,N0,M1,X14,S133, 1.000)
       deallocate(S133)
C
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X15,S134,-1.000)
       deallocate(S134)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,VBHPPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S135(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X16,S135,-1.000)
       deallocate(S135)
C
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S136(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       ...
       X17=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X17,S136,-1.000)
       deallocate(S136)
C
     ...
     & N0,N2,M1,N1,M2,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S137(N2+1:M2,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K0
       I3=K2
...
C
       ...
       X18=0.0d0
       call
     & sum3124(M1,N1,M2,N3,N2,M2,N0,M1,X18,S137,-1.000)
       deallocate(S137)
C
     ...
     & N0,N2,N0,M1,N1,M2,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S138(N2+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K0
       I3=K2
...
C
       ...
       X19=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N2,M2,N0,M1,X19,S138,-1.000)
       deallocate(S138)
C
     ...
     & N0,N2,M1,N1,N1,M2,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S139(N2+1:M2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K7
       I2=K0
       I3=K2
...
C
       ...
       X20=0.0d0
       call
     & sum3124(M1,N1,N1,M2,N2,M2,N0,M1,X20,S139,-1.000)
       deallocate(S139)
C
     ...
     & N2,N3,N0,M1,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S140(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:M2))
       I1=K0*K6*K5
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N0,M1,M2,N3,N2,M2,N0,M1,X17,S140, 1.000)
       deallocate(S140)
C
     ...
     & N2,N3,M1,N1,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S141(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:M2))
       I1=K0*K6*K7
       I2=K5
       I3=K4
...
C
       call
     & sum4123(M1,N1,M2,N3,N2,M2,N0,M1,X18,S141, 1.000)
       deallocate(S141)
C
     ...
     & N2,N3,N0,M1,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S142(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:M2))
       I1=K0*K9*K5
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N0,M1,N1,M2,N2,M2,N0,M1,X19,S142, 1.000)
       deallocate(S142)
C
     ...
     & N2,N3,M1,N1,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S143(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:M2))
       I1=K0*K9*K7
       I2=K5
       I3=K4
...
C
       call
     & sum4123(M1,N1,N1,M2,N2,M2,N0,M1,X20,S143, 1.000)
       deallocate(S143)
C
...
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S144(N0+1:M1,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,N0,M1,N0,M1,M1,N1,X49,S144, 1.000)
       deallocate(S144)
C
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S145(N0+1:M1,N0+1:M1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N1,N0,M1,M1,N1,X50,S145, 1.000)
       deallocate(S145)
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S146(N0+1:M1,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N1,N0,M1,M1,N1,X51,S146, 1.000)
       deallocate(S146)
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S147(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K0
       I3=K2
...
C
       ...
       X52=0.0d0
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N1,X52,S147,-1.000)
       deallocate(S147)
C
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z52(N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K5*K5*K9*K9
       I3=K6*K7
...
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z52,-1.000)
       deallocate(Z52)
       deallocate(X52)
C
     ...
     & N0,N2,M1,N1,N2,M2,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S148(N2+1:M2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K7
       I2=K0
       I3=K2
...
C
       ...
       X53=0.0d0
       call
     & sum3124(M1,N1,N2,M2,N2,M2,M1,N1,X53,S148,-1.000)
       deallocate(S148)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z53(N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K5*K5*K9*K9
       I3=K0*K7
...
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z53,-1.000)
       deallocate(Z53)
       deallocate(X53)
C
...
C
     ...
     & N2,N3,N0,M1,N0,M1,N0,M1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S149(N0+1:M1,N0+1:M1,N0+1:M1,N0+1:M1))
       I1=K5*K5*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,N0,M1,N0,M1,N0,M1,X54,S149, 1.000)
       deallocate(S149)
C
     ...
     & N2,N3,M1,N2,N0,M1,N0,M1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S150(N0+1:M1,M1+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,N0,M1,N0,M1,N0,M1,X55,S150, 1.000)
       deallocate(S150)
C
     ...
     & N2,N3,N0,M1,M1,N1,N0,M1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S151(N0+1:M1,N0+1:M1,M1+1:N1,N0+1:M1))
       I1=K5*K7*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N1,N0,M1,N0,M1,X56,S151, 1.000)
       deallocate(S151)
C
     ...
     & N2,N3,M1,N2,M1,N1,N0,M1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S152(N0+1:M1,M1+1:N2,M1+1:N1,N0+1:M1))
       I1=K5*K7*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N1,N0,M1,N0,M1,X57,S152, 1.000)
       deallocate(S152)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N2,N0,M1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S153(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       ...
       X58=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X58,S153,-1.000)
       deallocate(S153)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z58(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K5
...
C
       call
     & sum234615(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z58,-1.000)
       deallocate(Z58)
       deallocate(X58)
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,N0+1:M1))
     ...
     & N0,N2,M1,N1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S154(N2+1:M2,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K0
       I3=K2
...
C
       ...
       X59=0.0d0
       call
     & sum3124(M1,N1,M2,N3,N2,M2,N0,M1,X59,S154,-1.000)
       deallocate(S154)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z59(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K7
...
C
       call
     & sum234615(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z59,-1.000)
       deallocate(Z59)
       deallocate(X59)
C
     ...
     & N0,N2,N0,M1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S155(N2+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K0
       I3=K2
...
C
       ...
       X60=0.0d0
       call
     & sum3124(N0,M1,N2,M2,N2,M2,N0,M1,X60,S155,-1.000)
       deallocate(S155)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z60(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K0*K5
...
C
       call
     & sum234615(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z60,-1.000)
       deallocate(Z60)
       deallocate(X60)
C
     ...
     & N0,N2,M1,N1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S156(N2+1:M2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K7
       I2=K0
       I3=K2
...
C
       ...
       X61=0.0d0
       call
     & sum3124(M1,N1,N2,M2,N2,M2,N0,M1,X61,S156,-1.000)
       deallocate(S156)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z61(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K0*K7
...
C
       call
     & sum234615(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z61,-1.000)
       deallocate(Z61)
       deallocate(X61)
C
...
C
     ...
     & N2,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S157(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X62(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:M1))
       X62=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N1,M2,N0,M1,X62,S157, 1.000)
       deallocate(S157)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
     & N0,M1,M2,N3,N1,M2,N0,M1,X62,VBPHPH, 1.000)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z62(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z62,-1.000)
       deallocate(Z62)
       deallocate(X62)
C
     ...
     & N2,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S158(N0+1:M1,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X63(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:M1))
       X63=0.0d0
       call
     & sum4123(M1,N2,M2,N3,N1,M2,N0,M1,X63,S158, 1.000)
       deallocate(S158)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
     & M1,N2,M2,N3,N1,M2,N0,M1,X63,VBPHPH, 1.000)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z63(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z63,-1.000)
       deallocate(Z63)
       deallocate(X63)
C
     ...
     & N2,N3,N0,M1,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S159(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K5
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X64(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:M1))
       X64=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,N0,M1,X64,S159, 1.000)
       deallocate(S159)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
     & N0,M1,N1,M2,N1,M2,N0,M1,X64,VBPHPH, 1.000)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z64(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K5
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z64,-1.000)
       deallocate(Z64)
       deallocate(X64)
C
     ...
     & N2,N3,M1,N2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S160(N0+1:M1,M1+1:N2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K8
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X65(M1+1:N2,N1+1:M2,N1+1:M2,N0+1:M1))
       X65=0.0d0
       call
     & sum4123(M1,N2,N1,M2,N1,M2,N0,M1,X65,S160, 1.000)
       deallocate(S160)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
     & M1,N2,N1,M2,N1,M2,N0,M1,X65,VBPHPH, 1.000)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z65(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K8
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z65,-1.000)
       deallocate(Z65)
       deallocate(X65)
C
       allocate(D1(N2+1:N3,N0+1:M1,M2+1:N3,N1+1:M2))
     ...
     & N2,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S161(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K5
       I3=K4
...
C
       ...
       X66=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N1,M2,N0,M1,X66,S161, 1.000)
       deallocate(S161)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z66(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z66, 1.000)
       deallocate(Z66)
       deallocate(X66)
C
       allocate(D1(N2+1:N3,M1+1:N2,M2+1:N3,N1+1:M2))
     ...
     & N2,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S162(N0+1:M1,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K5
       I3=K4
...
C
       ...
       X67=0.0d0
       call
     & sum4123(M1,N2,M2,N3,N1,M2,N0,M1,X67,S162, 1.000)
       deallocate(S162)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z67(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z67, 1.000)
       deallocate(Z67)
       deallocate(X67)
C
       allocate(D1(N2+1:N3,N0+1:M1,N1+1:M2,N1+1:M2))
     ...
     & N2,N3,N0,M1,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S163(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K5
       I2=K5
       I3=K4
...
C
       ...
       X68=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,N0,M1,X68,S163, 1.000)
       deallocate(S163)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z68(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K5
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z68, 1.000)
       deallocate(Z68)
       deallocate(X68)
C
       allocate(D1(N2+1:N3,M1+1:N2,N1+1:M2,N1+1:M2))
     ...
     & N2,N3,M1,N2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S164(N0+1:M1,M1+1:N2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K8
       I2=K5
       I3=K4
...
C
       ...
       X69=0.0d0
       call
     & sum4123(M1,N2,N1,M2,N1,M2,N0,M1,X69,S164, 1.000)
       deallocate(S164)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z69(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K8
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z69, 1.000)
       deallocate(Z69)
       deallocate(X69)
C
     ...
     & N0,N2,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S165(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X70,S165,-1.000)
       deallocate(S165)
C
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S166(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X71,S166,-1.000)
       deallocate(S166)
C
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S167(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X72,S167,-1.000)
       deallocate(S167)
C
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S168(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X73,S168,-1.000)
       deallocate(S168)
C
       allocate(D1(N0+1:N2,M2+1:N3,M2+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S169(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X74,S169,-1.000)
       deallocate(S169)
C
       allocate(D1(N0+1:N2,N2+1:M2,M2+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S170(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X75,S170,-1.000)
       deallocate(S170)
C
       allocate(D1(N0+1:N2,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S171(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X76,S171,-1.000)
       deallocate(S171)
C
       allocate(D1(N0+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S172(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X77,S172,-1.000)
       deallocate(S172)
C
...
C
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S173(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X78(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:M1))
       X78=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X78,S173,-1.000)
       deallocate(S173)
C
     ...
     & N0,N2,M1,N2,M2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S174(N2+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X79(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:M1))
       X79=0.0d0
       call
     & sum3124(M1,N2,M2,N3,N2,M2,N0,M1,X79,S174,-1.000)
       deallocate(S174)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,N0+1:M1))
       call reorder3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N0,M1,N2,M2,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S175(N2+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X80(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:M1))
       X80=0.0d0
       call
     & sum3124(N0,M1,N2,M2,N2,M2,N0,M1,X80,S175,-1.000)
       deallocate(S175)
C
     ...
     & N0,N2,M1,N2,N2,M2,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S176(N2+1:M2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X81(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:M1))
       X81=0.0d0
       call
     & sum3124(M1,N2,N2,M2,N2,M2,N0,M1,X81,S176,-1.000)
       deallocate(S176)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N0+1:M1))
...
C
     ...
     & N2,N3,N0,M1,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S177(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:M2))
       I1=K0*K6*K5
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N0,M1,M2,N3,N2,M2,N0,M1,X78,S177,-1.000)
       deallocate(S177)
C
     ...
     & N2,N3,M1,N2,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S178(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:M2))
       I1=K0*K6*K8
       I2=K5
       I3=K4
...
C
       call
     & sum4123(M1,N2,M2,N3,N2,M2,N0,M1,X79,S178,-1.000)
       deallocate(S178)
C
     ...
     & N2,N3,N0,M1,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S179(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:M2))
       I1=K0*K0*K5
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N0,M1,N2,M2,N2,M2,N0,M1,X80,S179,-1.000)
       deallocate(S179)
C
     ...
     & N2,N3,M1,N2,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S180(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K8
       I2=K5
       I3=K4
...
C
       call
     & sum4123(M1,N2,N2,M2,N2,M2,N0,M1,X81,S180,-1.000)
       deallocate(S180)
C
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       allocate(S181(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K3
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S181,-1.000)
       deallocate(S181)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,N1,FAHP,B1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       allocate(S182(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K3
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X6,S182,-1.000)
       deallocate(S182)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S183(N2+1:M2,N0+1:M1,N0+1:M1,N0+1:N1))
       I1=K1
       I2=K5*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S183)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S183, 1.000)
       deallocate(S183)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S184(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S184)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S184, 1.000)
       deallocate(S184)
C
     ...
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S185(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X1,S185, 1.000)
       deallocate(S185)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S186(N1+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N1,M2,N0,M1,M1,N1,X5,S186, 1.000)
       deallocate(S186)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,VAHHHP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S187(N1+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N1,M2,N0,M1,M1,N1,X6,S187,-1.000)
       deallocate(S187)
C
     ...
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S188(N1+1:M2,N1+1:M2,N1+1:N3,M1+1:N1))
       I1=K7*K3
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum2314(N1,N3,N1,M2,N1,M2,M1,N1,X7,S188, 0.500)
       deallocate(S188)
C
     ...
     & N0,N1,N1,N3,N0,N1,N0,M1,VAHHHP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S189(N2+1:M2,N0+1:M1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,N0,M1,X2,S189, 1.000)
       deallocate(S189)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N0+1:M1))
       call reorder3142(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S190(N1+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N1,N1,M2,N0,M1,M1,N1,X5,S190,-1.000)
       deallocate(S190)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N0+1:M1))
       call reorder4132(N1,N3,N0,N1,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,N1,N0,M1,VAHHHP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S191(N1+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N1,N1,M2,N0,M1,M1,N1,X6,S191, 1.000)
       deallocate(S191)
C
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,N0,M1,X3,S192,-1.000)
       deallocate(S192)
C
...
C
       call
     & sum3412(N0,N1,N1,M2,N0,M1,M1,N1,X5,S193, 0.500)
       deallocate(S193)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S194(N2+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,N0,M1,X4,S194,-1.000)
       deallocate(S194)
C
       allocate(D1(N1+1:N3,N1+1:N3,N0+1:N1,N1+1:M2))
       call reorder1243(N1,N3,N1,N3,N1,N3,N0,N1,
     & N1,N3,N1,N3,N0,N1,N1,M2,VAHPPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,N0,M1,M1,N1,t2A,D2)
       allocate(S195(N0+1:M1,M1+1:N1,N0+1:N1,N1+1:M2))
       I1=K9*K1
       I2=K7*K5
       I3=K3*K3
...
C
       call
     & sum3412(N0,N1,N1,M2,N0,M1,M1,N1,X6,S195, 0.500)
       deallocate(S195)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
     ...
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S196(N1+1:M2,M1+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(N1,N3,N1,M2,N1,M2,M1,N1,X7,S196, 1.000)
       deallocate(S196)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4213(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S197(N1+1:M2,M1+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N1,M2,N1,M2,M1,N1,X7,S197,-1.000)
       deallocate(S197)
C
     ...
     & N0,N1,N0,N1,N1,N3,N0,M1,VAHHHP,D1)
       ...
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S198(N1+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum2314(N1,N3,N1,M2,N1,M2,N0,M1,X8,S198, 0.500)
       deallocate(S198)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4213(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum3412(N1,N3,N1,M2,N1,M2,N0,M1,X8,S199, 1.000)
       deallocate(S199)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4213(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S200(N1+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N1,M2,N1,M2,N0,M1,X8,S200,-1.000)
       deallocate(S200)
C
     ...
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S201(N2+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,N0,M1,X4,S201, 1.000)
       deallocate(S201)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,N0+1:M1))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N1,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S202(N2+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,N0,M1,X3,S202, 1.000)
       deallocate(S202)
C
     ...
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S203(N1+1:M2,N0+1:M1,N1+1:N3,N2+1:M2))
       I1=K0*K3
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(N1,N3,N2,M2,N1,M2,N0,M1,X4,S203,-1.000)
       deallocate(S203)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N2,N3,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S204(N1+1:M2,N0+1:M1,N1+1:N3,N2+1:M2))
       I1=K0*K3
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(N1,N3,N2,M2,N1,M2,N0,M1,X3,S204,-1.000)
       deallocate(S204)
C
...
C
       call
     & sum2413(N0,N1,N2,M2,N0,M1,N0,M1,X2,S205,-1.000)
       deallocate(S205)
C
     ...
     & N0,N1,N1,N3,N0,N2,N0,M1,VBHHPH,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S206(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X9,S206, 1.000)
       deallocate(S206)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N0,M1,VBHHPH,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S207(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X10,S207, 1.000)
       deallocate(S207)
C
     ...
     & N2,N3,N1,N3,N0,M1,N0,M1,t2B,D2)
       allocate(S208(N0+1:M1,N0+1:M1,N0+1:N1,N2+1:M2))
       I1=K0*K1
       I2=K5*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N1,N2,M2,N0,M1,N0,M1,X2,S208, 1.000)
       deallocate(S208)
C
     ...
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S209(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X11,S209, 1.000)
       deallocate(S209)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S210(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X12,S210, 1.000)
       deallocate(S210)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,N0+1:M1))
       call reorder3241(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S211(N2+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum2413(N0,N1,N2,M2,N0,M1,M1,N1,X1,S211,-1.000)
       deallocate(S211)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N0,M1,VBHHPH,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S212(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,N0,M1,X13,S212, 1.000)
       deallocate(S212)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N0,M1,VBHHPH,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S213(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,N0,M1,X14,S213, 1.000)
       deallocate(S213)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N1,N2+1:M2))
       call reorder1243(N2,N3,N1,N3,N2,N3,N0,N1,
     ...
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S214(N0+1:M1,M1+1:N1,N0+1:N1,N2+1:M2))
       I1=K0*K1
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N1,N2,M2,N0,M1,M1,N1,X1,S214, 1.000)
       deallocate(S214)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S215(N1+1:M2,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,N0,M1,X15,S215, 1.000)
       deallocate(S215)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S216(N1+1:M2,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,N0,M1,X16,S216, 1.000)
       deallocate(S216)
C
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X1,S217, 1.000)
       deallocate(S217)
C
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,N0,M1,X2,S218, 1.000)
       deallocate(S218)
C
     ...
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S219(N2+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,N0,M1,X3,S219, 1.000)
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,N0,M1,X4,S219, 1.000)
       deallocate(S219)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X4,S220, 1.000)
       deallocate(S220)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X4,S221, 0.500)
       deallocate(S221)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X4,S222, 1.000)
       deallocate(S222)
C
     ...
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S223(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X4,S223, 0.500)
       deallocate(S223)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,M1,N1,M2,N3,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S224(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S224,-1.000)
       deallocate(S224)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & M1,N1,M1,N1,M2,N3,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S225(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S225,-0.500)
       deallocate(S225)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,M1,N1,N1,M2,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S226(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S226,-1.000)
       deallocate(S226)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & M1,N1,M1,N1,N1,M2,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S227(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S227,-0.500)
       deallocate(S227)
C
     ...
     & N1,N3,N1,N3,N0,M1,M1,N1,VAHHPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,N0,M1,M1,N1,t2A,D2)
       allocate(S228(N0+1:M1,M1+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K7*K5
       I3=K3*K3
...
C
       call
     & sum3412(N0,M1,M1,N1,N0,M1,M1,N1,X32,S228, 0.500)
       deallocate(S228)
C
     ...
     & N1,N3,N1,N3,M1,N1,M1,N1,VAHHPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,N0,M1,M1,N1,t2A,D2)
       allocate(S229(N0+1:M1,M1+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7
       I2=K7*K5
       I3=K3*K3
...
C
       call
     & sum3412(M1,N1,M1,N1,N0,M1,M1,N1,X33,S229, 0.500)
       deallocate(S229)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S230,-0.500)
       deallocate(S230)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S231,-1.000)
       deallocate(S231)
C
     ...
     & M1,N1,N1,M2,N1,M2,N2,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(S232(N2+1:M2,N0+1:M1,N0+1:M1,N0+1:N1))
       I1=K1
       I2=K5*K5*K0
       I3=K9*K9*K7
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S232,-0.500)
       deallocate(S232)
C
     ...
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S233(N1+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,M2,N3,N1,M2,M1,N1,X34,S233,-1.000)
       deallocate(S233)
C
     ...
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S234(N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X35,S234,-1.000)
       deallocate(S234)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S235(N1+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K9
       I3=K3*K1
...
C
     ...
     & M1,N1,M2,N3,N1,M2,M1,N1,S235,D1)
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z356(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z356,-1.000)
       deallocate(Z356)
       deallocate(S235)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z357,-1.000)
       deallocate(Z357)
       deallocate(S236)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S238, 0.500)
       deallocate(S238)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S240, 1.000)
       deallocate(S240)
C
...
C
     ...
     & M1,N1,N1,M2,N1,M2,N2,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S242(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K9*K9*K7
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S242, 0.500)
       deallocate(S242)
C
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S243(N1+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,N0,M1,X38,S243,-1.000)
       deallocate(S243)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S244(N1+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,M2,N3,N1,M2,N0,M1,X39,S244,-1.000)
       deallocate(S244)
C
     ...
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S245(N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,N0,M1,X40,S245,-1.000)
       deallocate(S245)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S246(N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,N0,M1,X41,S246,-1.000)
       deallocate(S246)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S247(N1+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K9
       I3=K3*K1
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N0,M1,S247,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z369(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z369)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z369,-1.000)
       deallocate(Z369)
       deallocate(S247)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S248(N1+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K9
       I3=K3*K1
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N0,M1,S248,D1)
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z370(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,D1,F2,Z370)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z370,-1.000)
       deallocate(Z370)
       deallocate(S248)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S249(N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K9
       I3=K3*K1
...
C
     ...
     & N0,M1,N1,M2,N1,M2,N0,M1,S249,D1)
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z371(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,D1,F2,Z371)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z371,-1.000)
       deallocate(Z371)
       deallocate(S249)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
     ...
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S250(N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z372,-1.000)
       deallocate(Z372)
       deallocate(S250)
C
...
C
     ...
     & N0,N1,N0,N1,M2,N3,M2,N3,VAHHPP,D1)
       ...
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S251(N1+1:M2,N1+1:M2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum3412(M2,N3,M2,N3,N1,M2,N1,M2,X46,S251, 0.500)
       deallocate(S251)
C
     ...
     & N0,N1,N0,N1,M2,N3,N1,M2,VAHHPP,D1)
       ...
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S252(N1+1:M2,N1+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum3412(M2,N3,N1,M2,N1,M2,N1,M2,X47,S252, 0.500)
       deallocate(S252)
C
     ...
     & N0,N1,N0,N1,N1,M2,N1,M2,VAHHPP,D1)
       ...
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S253(N1+1:M2,N1+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum3412(N1,M2,N1,M2,N1,M2,N1,M2,X48,S253, 0.500)
       deallocate(S253)
C
...
C
     ...
     & M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z380(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K5*K5*K9*K0
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z380)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sum124563(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z380,-0.500)
       deallocate(Z380)
       deallocate(Q39)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,N1+1:M2))
...
C
     ...
     & N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z381(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K5*K5*K9*K0
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z381)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sum124563(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z381,-0.500)
       deallocate(Z381)
       deallocate(Q40)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S254, 1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S256, 1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S258,-1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S255,-1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S257, 1.000)
C
       call
...
C
     ...
     & M1,N2,M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S259(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K0*K7*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X3,S259, 1.000)
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X4,S259, 1.000)
       deallocate(S259)
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S260(N2+1:M2,N0+1:M1,N0+1:M1,N0+1:N1))
       I1=K1
       I2=K5*K5*K0
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S260,-1.000)
       deallocate(S260)
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S261(N2+1:M2,N0+1:M1,N0+1:M1,N0+1:N1))
       I1=K1
       I2=K5*K5*K0
       I3=K6*K0*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S261,-1.000)
       deallocate(S261)
C
     ...
     & M1,N2,M2,N3,N1,M2,N2,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S262(N2+1:M2,N0+1:M1,N0+1:M1,N0+1:N1))
       I1=K1
       I2=K5*K5*K0
       I3=K9*K6*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S262,-1.000)
       deallocate(S262)
C
     ...
     & M1,N2,N2,M2,N1,M2,N2,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S263(N2+1:M2,N0+1:M1,N0+1:M1,N0+1:N1))
       I1=K1
       I2=K5*K5*K0
       I3=K9*K0*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S263,-1.000)
       deallocate(S263)
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       ...
       deallocate(D2)
C
       allocate(X106(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       X106=0.0d0
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N1,X106,S264, 1.000)
       deallocate(S264)
C
...
C
       ...
       X107=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X107,S265, 1.000)
       deallocate(S265)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S266(N1+1:M2,M1+1:N1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K7*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X108(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       X108=0.0d0
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N1,X108,S266, 1.000)
       deallocate(S266)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S267(N1+1:M2,M1+1:N1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K7*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X109(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       X109=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X109,S267, 1.000)
       deallocate(S267)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(S268(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S268, 1.000)
       deallocate(S268)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(S269(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S269,-1.000)
       deallocate(S269)
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(S270(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S270, 1.000)
       deallocate(S270)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(S271(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K6*K0*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S271,-1.000)
       deallocate(S271)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,N1,M2,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(S272(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S272, 1.000)
       deallocate(S272)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S276(N1+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K9
       I3=K3*K1
...
C
       ...
       X110=0.0d0
       call
     & sum3412(N0,M1,M2,N3,N1,M2,N0,M1,X110,S276, 1.000)
       deallocate(S276)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S277(N1+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X111(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:M1))
       X111=0.0d0
       call
     & sum3412(M1,N2,M2,N3,N1,M2,N0,M1,X111,S277, 1.000)
       deallocate(S277)
C
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S278(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K9
       I3=K3*K1
...
C
       ...
       X112=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N1,M2,N0,M1,X112,S278, 1.000)
       deallocate(S278)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S279(N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X113(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:M1))
       X113=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,N0,M1,X113,S279, 1.000)
       deallocate(S279)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X114=0.0d0
       call
     & sum3412(N0,M1,M2,N3,N1,M2,N0,M1,X114,S280, 1.000)
       deallocate(S280)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S281(N1+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K9
       I3=K3*K1
...
C
       ...
       X115=0.0d0
       call
     & sum3412(M1,N2,M2,N3,N1,M2,N0,M1,X115,S281, 1.000)
       deallocate(S281)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X116=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N1,M2,N0,M1,X116,S282, 1.000)
       deallocate(S282)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X117=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,N0,M1,X117,S283, 1.000)
       deallocate(S283)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S284, 1.000)
       deallocate(S284)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S285, 1.000)
       deallocate(S285)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S286(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K4
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S286, 1.000)
       deallocate(S286)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,N2,FBHP,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S287(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K4
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S287, 1.000)
       deallocate(S287)
C
     ...
     & N0,N2,N0,N1,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S288(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X12,S288, 1.000)
       deallocate(S288)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S289(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X11,S289, 1.000)
       deallocate(S289)
C
     ...
     & N0,N1,N2,N3,N0,N2,M1,N1,VBHHHP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S290(N1+1:M2,N0+1:M1,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,M1,N1,X10,S290,-1.000)
       deallocate(S290)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder4132(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N1,N2,N3,N0,N2,M1,N1,VBHHHP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S291(N1+1:M2,N0+1:M1,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,M1,N1,X9,S291,-1.000)
       deallocate(S291)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
     ...
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S292(N1+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N1,M2,N0,M1,M1,N1,X5,S292, 1.000)
       deallocate(S292)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N0,N1,N2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S294(N2+1:M2,N1+1:M2,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,N0,M1,X16,S294, 1.000)
       deallocate(S294)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,N0+1:M1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S295(N2+1:M2,N1+1:M2,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,N0,M1,X15,S295, 1.000)
       deallocate(S295)
C
     ...
     & N0,N1,N2,N3,N0,N2,N0,M1,VBHHHP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S296(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,N0,M1,X14,S296,-1.000)
       deallocate(S296)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder4132(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N1,N2,N3,N0,N2,N0,M1,VBHHHP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S297(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,N0,M1,X13,S297,-1.000)
       deallocate(S297)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N0+1:M1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S298(N1+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N1,N1,M2,N0,M1,M1,N1,X5,S298,-1.000)
       deallocate(S298)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N0+1:M1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S300(N1+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(N1,N3,N1,M2,N1,M2,N0,M1,X8,S300, 1.000)
       deallocate(S300)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S301(N1+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum2413(N1,N3,N1,M2,N1,M2,N0,M1,X8,S301,-1.000)
       deallocate(S301)
C
     ...
     & N0,N2,N1,N3,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S302(N2+1:M2,N0+1:M1,N2+1:N3,N1+1:M2))
       I1=K9*K4
       I2=K5*K0
       I3=K3*K2
...
C
       call
     & sum2413(N2,N3,N2,M2,N1,M2,N0,M1,X15,S302,-1.000)
       deallocate(S302)
C
     ...
     & N2,N3,N1,N3,N0,N2,N1,M2,VBPHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S303(N0+1:M1,M1+1:N1,N0+1:N2,N1+1:M2))
       I1=K9*K2
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N2,N1,M2,N0,M1,M1,N1,X9,S303, 1.000)
       deallocate(S303)
C
       allocate(D1(N0+1:N2,N1+1:N3,N2+1:N3,N1+1:M2))
       call reorder3214(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S304(N2+1:M2,N0+1:M1,N2+1:N3,N1+1:M2))
       I1=K9*K4
       I2=K5*K0
       I3=K3*K2
...
C
       call
     & sum2413(N2,N3,N2,M2,N1,M2,N0,M1,X16,S304,-1.000)
       deallocate(S304)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N0,N2,N1,N3,
     & N2,N3,N1,N3,N0,N2,N1,M2,VBPHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S305(N0+1:M1,M1+1:N1,N0+1:N2,N1+1:M2))
       I1=K9*K2
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N2,N1,M2,N0,M1,M1,N1,X10,S305, 1.000)
       deallocate(S305)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N0,N2,N1,N3,
     & N2,N3,N1,N3,N0,N2,N1,M2,VBPHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,N0,M1,t2B,D2)
       allocate(S306(N0+1:M1,N0+1:M1,N0+1:N2,N1+1:M2))
       I1=K9*K2
       I2=K5*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N2,N1,M2,N0,M1,N0,M1,X13,S306, 1.000)
       deallocate(S306)
C
       allocate(D1(N0+1:N2,N1+1:N3,N2+1:N3,N1+1:M2))
       call reorder3214(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S307(N2+1:M2,M1+1:N1,N2+1:N3,N1+1:M2))
       I1=K9*K4
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum2413(N2,N3,N2,M2,N1,M2,M1,N1,X11,S307,-1.000)
       deallocate(S307)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N0,N2,N1,N3,
     & N2,N3,N1,N3,N0,N2,N1,M2,VBPHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,N0,M1,t2B,D2)
       allocate(S308(N0+1:M1,N0+1:M1,N0+1:N2,N1+1:M2))
       I1=K9*K2
       I2=K5*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N2,N1,M2,N0,M1,N0,M1,X14,S308, 1.000)
       deallocate(S308)
C
       allocate(D1(N0+1:N2,N1+1:N3,N2+1:N3,N1+1:M2))
       call reorder3214(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S309(N2+1:M2,M1+1:N1,N2+1:N3,N1+1:M2))
       I1=K9*K4
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum2413(N2,N3,N2,M2,N1,M2,M1,N1,X12,S309,-1.000)
       deallocate(S309)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S310(N1+1:M2,M1+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N1,N3,N1,M2,N1,M2,M1,N1,X7,S310, 1.000)
       deallocate(S310)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S311(N1+1:M2,M1+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N1,N3,N1,M2,N1,M2,M1,N1,X7,S311,-1.000)
       deallocate(S311)
C
     ...
     & N0,N2,N2,N3,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S312(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,N0,M1,X14,S312,-1.000)
       deallocate(S312)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S313(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,N0,M1,X13,S313, 1.000)
       deallocate(S313)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S314(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X9,S314, 1.000)
       deallocate(S314)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder4132(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S315(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X10,S315,-1.000)
       deallocate(S315)
C
     ...
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S316(N1+1:M2,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,N0,M1,X16,S316, 1.000)
       deallocate(S316)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S317(N1+1:M2,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,N0,M1,X15,S317,-1.000)
       deallocate(S317)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S318(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X11,S318,-1.000)
       deallocate(S318)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S319(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X12,S319, 1.000)
       deallocate(S319)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,t3A,F2)
       allocate(S320(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S320,-1.000)
       deallocate(S320)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & M1,N1,M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,t3A,F2)
       allocate(S321(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K6*K7*K7
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S321, 0.500)
       deallocate(S321)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & N0,M1,M1,N1,N1,M2,N1,M2,N1,M2,N0,M1,t3A,F2)
       allocate(S322(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K9*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S322,-1.000)
       deallocate(S322)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & M1,N1,M1,N1,N1,M2,N1,M2,N1,M2,N0,M1,t3A,F2)
       allocate(S323(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S323, 0.500)
       deallocate(S323)
C
     ...
     & N0,M1,N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,t3A,F2)
       allocate(S324(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K5*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S324, 0.500)
       deallocate(S324)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N1,M2,N1,M2,M1,N1,t3A,F2)
       allocate(S325(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S325, 1.000)
       deallocate(S325)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & M1,N1,M1,N1,M2,N3,N1,M2,N1,M2,M1,N1,t3A,F2)
       allocate(S326(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K7*K7
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S326, 0.500)
       deallocate(S326)
C
     ...
     & N0,M1,N0,M1,N1,M2,N1,M2,N1,M2,M1,N1,t3A,F2)
       allocate(S327(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K9*K5*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S327, 0.500)
       deallocate(S327)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & N0,M1,M1,N1,N1,M2,N1,M2,N1,M2,M1,N1,t3A,F2)
       allocate(S328(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K9*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S328, 1.000)
       deallocate(S328)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & M1,N1,M1,N1,N1,M2,N1,M2,N1,M2,M1,N1,t3A,F2)
       allocate(S329(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S329, 0.500)
       deallocate(S329)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S336,-0.500)
       deallocate(S336)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S337, 0.500)
       deallocate(S337)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S338,-1.000)
       deallocate(S338)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S339, 1.000)
       deallocate(S339)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S340,-0.500)
       deallocate(S340)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S341, 0.500)
       deallocate(S341)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X17,S342, 1.000)
       deallocate(S342)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S343(N2+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,N0,M1,X18,S343, 1.000)
       deallocate(S343)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S344(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,N0,M1,X19,S344, 1.000)
       deallocate(S344)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S345(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,N0,M1,X20,S345, 1.000)
       deallocate(S345)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(S346(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K6*K5*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S346,-1.000)
       deallocate(S346)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S347(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S347, 1.000)
       deallocate(S347)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S348(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K6*K7*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S348, 1.000)
       deallocate(S348)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(S349(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K0*K5*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S349,-1.000)
       deallocate(S349)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S350(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K0*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S350, 1.000)
       deallocate(S350)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S351(N1+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K9
       I3=K0*K7*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,N0,M1,X8,S351, 1.000)
       deallocate(S351)
C
     ...
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(S352(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K6*K5*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X16,S352,-1.000)
       deallocate(S352)
C
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S353(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X16,S353, 1.000)
       deallocate(S353)
C
     ...
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S354(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K6*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X16,S354, 1.000)
       deallocate(S354)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S358,-1.000)
       deallocate(S358)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S359, 1.000)
       deallocate(S359)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S360, 1.000)
       deallocate(S360)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N0,M1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & M1,N2,N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(S361(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K9*K5*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S361,-1.000)
       deallocate(S361)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M1,N1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder462135(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S362(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S362, 1.000)
       deallocate(S362)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M1,N1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder462135(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S363(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S363, 1.000)
       deallocate(S363)
C
     ...
     & N2,N3,N1,N3,M1,N2,N0,M1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S364(N0+1:M1,M1+1:N1,M1+1:N2,N0+1:M1))
       I1=K5*K8
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,N0,M1,N0,M1,M1,N1,X49,S364, 1.000)
       deallocate(S364)
C
     ...
     & N2,N3,N1,N3,N0,M1,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S365(N0+1:M1,M1+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,M1,M1,N1,N0,M1,M1,N1,X50,S365, 1.000)
       deallocate(S365)
C
     ...
     & N2,N3,N1,N3,M1,N2,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S366(N0+1:M1,M1+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,M1,N1,N0,M1,M1,N1,X51,S366, 1.000)
       deallocate(S366)
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(S367(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K6*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S367,-1.000)
       deallocate(S367)
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(S368(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S368,-1.000)
       deallocate(S368)
C
     ...
     & M1,N1,M2,N3,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(S369(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S369,-1.000)
       deallocate(S369)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S371,-1.000)
       deallocate(S371)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S372,-1.000)
       deallocate(S372)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S373,-1.000)
       deallocate(S373)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N1,N2,M2,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(S374(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K9*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S374,-1.000)
       deallocate(S374)
C
     ...
     & N0,N2,N1,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S375(N2+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N1,X88,S375,-1.000)
       deallocate(S375)
C
     ...
     & N0,N2,N1,N3,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S376(N2+1:M2,M1+1:N1,M1+1:N1,N2+1:M2))
       I1=K0*K7
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(M1,N1,N2,M2,N2,M2,M1,N1,X89,S376,-1.000)
       deallocate(S376)
C
     ...
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S377(N1+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N1,M2,M1,N1,X34,S377,-1.000)
       deallocate(S377)
C
     ...
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S378(N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X35,S378,-1.000)
       deallocate(S378)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S379(N1+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N1,M2,M1,N1,X36,S379,-1.000)
       deallocate(S379)
C
...
C
       ...
       call reorder621345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z36(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z36, 1.000)
       deallocate(Z36)
       deallocate(X36)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
     ...
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S380(N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X37,S380,-1.000)
       deallocate(S380)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder621345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z37(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K9*K7
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z37, 1.000)
       deallocate(Z37)
       deallocate(X37)
C
...
C
     ...
     & N0,M1,N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S381(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K5*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S381,-1.000)
       deallocate(S381)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S382(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K5*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S382,-1.000)
       deallocate(S382)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S383(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S383,-1.000)
       deallocate(S383)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,M2,N3,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S384(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K7*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S384,-1.000)
       deallocate(S384)
C
     ...
     & N0,M1,N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S385(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K0*K5*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S385,-1.000)
       deallocate(S385)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S386(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K0*K5*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S386,-1.000)
       deallocate(S386)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S387(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K0*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S387,-1.000)
       deallocate(S387)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S388(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K0*K7*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X7,S388,-1.000)
       deallocate(S388)
C
     ...
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S389(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K5*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X12,S389,-1.000)
       deallocate(S389)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S390(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K5*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X12,S390,-1.000)
       deallocate(S390)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S397,-1.000)
       deallocate(S397)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S398,-1.000)
       deallocate(S398)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M1,N1,M2,N3,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S399(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S399,-1.000)
       deallocate(S399)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M1,N1,M2,N3,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S400(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S400,-1.000)
       deallocate(S400)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,N0,M1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S401(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K5*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S401,-1.000)
       deallocate(S401)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N0,M1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S402(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K5*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S402,-1.000)
       deallocate(S402)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M1,N1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S403(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S403,-1.000)
       deallocate(S403)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M1,N1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M1,N1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S404(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S404,-1.000)
       deallocate(S404)
C
     ...
     & N2,N3,N1,N3,N0,M1,N0,M1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,N0,M1,t2B,D2)
       allocate(S405(N0+1:M1,N0+1:M1,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K5*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,M1,N0,M1,N0,M1,N0,M1,X54,S405, 1.000)
       deallocate(S405)
C
       allocate(D1(N2+1:N3,N1+1:N3,M1+1:N2,N0+1:M1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N2,N0,M1,N0,M1,N0,M1,X55,S406, 1.000)
       deallocate(S406)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:M1,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,N0,M1,t2B,D2)
       allocate(S407(N0+1:M1,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K5*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,M1,M1,N1,N0,M1,N0,M1,X56,S407, 1.000)
       deallocate(S407)
C
       allocate(D1(N2+1:N3,N1+1:N3,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,N0,M1,t2B,D2)
       allocate(S408(N0+1:M1,N0+1:M1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K5*K5
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,M1,N1,N0,M1,N0,M1,X57,S408, 1.000)
       deallocate(S408)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S409, 1.000)
       deallocate(S409)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S410, 1.000)
       deallocate(S410)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S417, 1.000)
       deallocate(S417)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S418, 1.000)
       deallocate(S418)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,N2,M2,M2,N3,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S419(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S419, 1.000)
       deallocate(S419)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N1,N2,M2,M2,N3,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S420(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S420, 1.000)
       deallocate(S420)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M2,N3,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S421(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S421, 1.000)
       deallocate(S421)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N1,M2,N3,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S422(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S422, 1.000)
       deallocate(S422)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,N2,M2,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S423(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S423, 1.000)
       deallocate(S423)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N1,N2,M2,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S424(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K9*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S424, 1.000)
       deallocate(S424)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X90,S425,-1.000)
       deallocate(S425)
C
       allocate(D1(N0+1:N2,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,N0,M1,X91,S426,-1.000)
       deallocate(S426)
C
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,N0,M1,X92,S427,-1.000)
       deallocate(S427)
C
       allocate(D1(N0+1:N2,N1+1:N3,M1+1:N1,N2+1:M2))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,N2,M2,N2,M2,N0,M1,X93,S428,-1.000)
       deallocate(S428)
C
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S429(N1+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,N0,M1,X38,S429,-1.000)
       deallocate(S429)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S430(N1+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N1,M2,N0,M1,X39,S430,-1.000)
       deallocate(S430)
C
     ...
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S431(N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,N0,M1,X40,S431,-1.000)
       deallocate(S431)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S432(N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,N0,M1,X41,S432,-1.000)
       deallocate(S432)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z42(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z42, 1.000)
       deallocate(Z42)
       deallocate(X42)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z43(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z43, 1.000)
       deallocate(Z43)
       deallocate(X43)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z44(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K5
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z44, 1.000)
       deallocate(Z44)
       deallocate(X44)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z45(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K7
...
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z45, 1.000)
       deallocate(Z45)
       deallocate(X45)
C
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S445(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S445,-1.000)
       deallocate(S445)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S446(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S446,-1.000)
       deallocate(S446)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,N2,M2,M2,N3,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S447(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S447,-1.000)
       deallocate(S447)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S448(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K6*K0*K8
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S448,-1.000)
       deallocate(S448)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M2,N3,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S449(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S449,-1.000)
       deallocate(S449)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M2,N3,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S450(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K9*K6*K8
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S450,-1.000)
       deallocate(S450)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,N2,M2,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S451(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S451,-1.000)
       deallocate(S451)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S452(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K9*K0*K8
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S452,-1.000)
       deallocate(S452)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S453(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N0,M1,S453,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z590(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z590, 1.000)
       deallocate(Z590)
       deallocate(S453)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S454(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N0,M1,S454,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z591(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K8
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z591, 1.000)
       deallocate(Z591)
       deallocate(S454)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S455(N2+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N0,M1,S455,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z592(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K0*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z592, 1.000)
       deallocate(Z592)
       deallocate(S455)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S456(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N0,M1,S456,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z593(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K0*K8
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z593, 1.000)
       deallocate(Z593)
       deallocate(S456)
C
     ...
     & N0,N1,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S457(N1+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,N0,M1,X94,S457, 1.000)
       deallocate(S457)
C
     ...
     & N0,N1,N2,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S458(N1+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,N0,M1,X95,S458, 1.000)
       deallocate(S458)
C
     ...
     & N0,N1,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S459(N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,N0,M1,X96,S459, 1.000)
       deallocate(S459)
C
     ...
     & N0,N1,N2,N3,M1,N2,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S460(N1+1:M2,N0+1:M1,M1+1:N2,N1+1:M2))
       I1=K9*K8
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,N0,M1,X97,S460, 1.000)
       deallocate(S460)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,N0,M1,X98,S461, 1.000)
       deallocate(S461)
C
       allocate(D1(N0+1:N1,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,N0,M1,X99,S462, 1.000)
       deallocate(S462)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,N0,M1,X100,S463, 1.000)
       deallocate(S463)
C
       allocate(D1(N0+1:N1,N2+1:N3,M1+1:N2,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,N0,M1,X101,S464, 1.000)
       deallocate(S464)
C
...
C
       call
     & sum21(N0,M1,N0,M1,X102,Q44, 1.000)
       deallocate(Q44)
C
...
C
       call
     & sum21(M1,N2,N0,M1,X103,Q45, 1.000)
       deallocate(Q45)
C
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,N1,M2,X70,S465, 1.000)
       deallocate(S465)
C
...
C
       call
     & sum3412(N2,M2,M2,N3,N2,M2,N1,M2,X71,S466, 1.000)
       deallocate(S466)
C
...
C
       call
     & sum3412(M2,N3,N1,M2,N2,M2,N1,M2,X72,S467, 1.000)
       deallocate(S467)
C
...
C
       call
     & sum3412(N2,M2,N1,M2,N2,M2,N1,M2,X73,S468, 1.000)
       deallocate(S468)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,N1,M2,X74,S469, 1.000)
       deallocate(S469)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N2,M2,M2,N3,N2,M2,N1,M2,X75,S470, 1.000)
       deallocate(S470)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M2,N3,N1,M2,N2,M2,N1,M2,X76,S471, 1.000)
       deallocate(S471)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N2,M2,N1,M2,N2,M2,N1,M2,X77,S472, 1.000)
       deallocate(S472)
C
...
C
       call
     & sum21(M2,N3,N2,M2,X104,Q46,-1.000)
       deallocate(Q46)
C
...
C
       call
     & sum21(N2,M2,N2,M2,X105,Q47,-1.000)
       deallocate(Q47)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X16,S473, 1.000)
       deallocate(S473)
C
     ...
     & M1,N2,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S474(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K6*K8*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X16,S474, 0.500)
       deallocate(S474)
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S475(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K0*K8*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X16,S475, 1.000)
       deallocate(S475)
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S476(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K0*K8*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X16,S476, 0.500)
       deallocate(S476)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
     ...
     & N0,M1,M1,N2,M2,N3,N2,N3,VCHHPP,D1)
       ...
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S477(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K6*K8*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S477,-1.000)
       deallocate(S477)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,M1,N2,M2,N3,N2,N3,VCHHPP,D1)
       ...
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S478(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K6*K8*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S478,-0.500)
       deallocate(S478)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,M1,M1,N2,N2,M2,N2,N3,VCHHPP,D1)
       ...
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S479(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K0*K8*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S479,-1.000)
       deallocate(S479)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,M1,N2,N2,M2,N2,N3,VCHHPP,D1)
       ...
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S480(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K9*K0
       I3=K0*K8*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,N0,M1,X15,S480,-0.500)
       deallocate(S480)
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3C3,F2)
       allocate(S481(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S481, 0.500)
       deallocate(S481)
C
     ...
     & M1,N2,M2,N3,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S482(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S482, 1.000)
       deallocate(S482)
C
     ...
     & M1,N2,N2,M2,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S483(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K0*K0*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S483, 0.500)
       deallocate(S483)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,M2,N3,M2,N3,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3C3,F2)
       allocate(S484(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S484,-0.500)
       deallocate(S484)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,M2,N3,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S485(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S485,-1.000)
       deallocate(S485)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,N2,M2,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S486(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K0*K0*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S486,-0.500)
       deallocate(S486)
C
     ...
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S487(N1+1:M2,M1+1:N1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K7*K9
       I3=K4*K2
...
C
     ...
     & M1,N2,M2,N3,N1,M2,M1,N1,S487,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z632(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z632)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z632, 1.000)
       deallocate(Z632)
       deallocate(S487)
C
     ...
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S488(N1+1:M2,M1+1:N1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K7*K9
       I3=K4*K2
...
C
     ...
     & M1,N2,N2,M2,N1,M2,M1,N1,S488,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z633(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z633)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z633, 1.000)
       deallocate(Z633)
       deallocate(S488)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
     ...
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S489(N1+1:M2,M1+1:N1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N1,X108,S489, 1.000)
       deallocate(S489)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S490(N1+1:M2,M1+1:N1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X109,S490, 1.000)
       deallocate(S490)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X12,S491, 0.500)
       deallocate(S491)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X12,S492, 1.000)
       deallocate(S492)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X12,S493, 0.500)
       deallocate(S493)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X12,S494, 0.500)
       deallocate(S494)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X12,S495, 1.000)
       deallocate(S495)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X12,S496, 0.500)
       deallocate(S496)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S497,-0.500)
       deallocate(S497)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S498,-1.000)
       deallocate(S498)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S499,-0.500)
       deallocate(S499)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S500,-0.500)
       deallocate(S500)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S501,-1.000)
       deallocate(S501)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X11,S502,-0.500)
       deallocate(S502)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S505,-1.000)
       deallocate(S505)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,M2,N3,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(S506(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S506, 1.000)
       deallocate(S506)
C
     ...
     & N0,M1,N2,M2,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(S507(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K0*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S507,-0.500)
       deallocate(S507)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,N2,M2,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(S508(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K0*K0*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S508, 0.500)
       deallocate(S508)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S509, 0.500)
       deallocate(S509)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S510,-0.500)
       deallocate(S510)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S511, 1.000)
       deallocate(S511)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S512,-1.000)
       deallocate(S512)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S513, 0.500)
       deallocate(S513)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S514,-0.500)
       deallocate(S514)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S515(N1+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder3412(N1,M2,N0,M1,N0,M1,M2,N3,
     & N0,M1,M2,N3,N1,M2,N0,M1,S515,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z660(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z660)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z660, 1.000)
       deallocate(Z660)
       deallocate(S515)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
     ...
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S516(N1+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K9
       I3=K4*K2
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N0,M1,S516,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z661(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z661)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z661,-1.000)
       deallocate(Z661)
       deallocate(S516)
C
     ...
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S517(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K9
       I3=K4*K2
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N0,M1,S517,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z662(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z662)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z662, 1.000)
       deallocate(Z662)
       deallocate(S517)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S518(N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K9
       I3=K4*K2
...
C
     ...
     & M1,N2,N2,M2,N1,M2,N0,M1,S518,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z663(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z663)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z663,-1.000)
       deallocate(Z663)
       deallocate(S518)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S519(N1+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,N0,M1,X114,S519, 1.000)
       deallocate(S519)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S520(N1+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,N0,M1,X115,S520, 1.000)
       deallocate(S520)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S521(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N1,M2,N0,M1,X116,S521, 1.000)
       deallocate(S521)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S522(N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N1,M2,N0,M1,X117,S522, 1.000)
       deallocate(S522)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S523(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X17,S523, 1.000)
       deallocate(S523)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S524(N2+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,N0,M1,X18,S524, 1.000)
       deallocate(S524)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S525(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,N0,M1,X19,S525, 1.000)
       deallocate(S525)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S526(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,N0,M1,X20,S526, 1.000)
       deallocate(S526)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X78,S527,-1.000)
       deallocate(S527)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S528(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N2,M2,N0,M1,X79,S528,-1.000)
       deallocate(S528)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S529(N2+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,N0,M1,X80,S529,-1.000)
       deallocate(S529)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S530(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,N0,M1,X81,S530,-1.000)
       deallocate(S530)
C
...
C
     ...
     & N1,N3,N0,N1,N0,N1,M1,N1,VAHHHP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S531(N0+1:M1,N0+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1*K1
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N0,N1,N0,M1,M1,N1,S531,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S533(N1+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,N0,M1,M1,N1,X6,S533, 1.000)
       deallocate(S533)
C
       allocate(D1(N0+1:N1,N0+1:N1,N0+1:M1,M1+1:N1))
...
C
       call
     & sum2134(N0,N1,N1,M2,N0,M1,M1,N1,X5,S532,-1.000)
       deallocate(S532)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,N3,M1,N1,VAHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S534(N1+1:M2,N0+1:N1,N1+1:N3,M1+1:N1))
       I1=K7*K3*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S534,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
     ...
     & N1,N3,N0,N1,N0,N1,N0,M1,VAHHHP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S536(M1+1:N1,N0+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,N1,N0,M1,M1,N1,S536,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S538(N1+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,N0,M1,M1,N1,X6,S538,-1.000)
       deallocate(S538)
C
       allocate(D1(N0+1:N1,N0+1:N1,N0+1:M1,M1+1:N1))
     ...
     & N0,N1,N0,N1,N0,M1,M1,N1,S536,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S537(N1+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,N0,M1,M1,N1,X5,S537, 1.000)
       deallocate(S537)
C
     ...
     & N1,N3,N0,N1,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S539(M1+1:N1,N0+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S539,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S543(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,M1,N1,X7,S543,-1.000)
       deallocate(S543)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N1,N3,N1,M2,
     & N1,N3,N0,N1,N1,M2,M1,N1,S539,D1)
       allocate(B2(N1+1:N3,N0+1:M1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S540(N0+1:M1,N0+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K1
       I2=K5
       I3=K3
...
C
       call
     & sum3124(N0,N1,N1,M2,N0,M1,M1,N1,X5,S540, 1.000)
       deallocate(S540)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:N3,N1+1:M2))
       call reorder2413(N1,N3,N1,N3,N1,N3,N0,N1,
     & N1,N3,N0,N1,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S541(M1+1:N1,N0+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3*K1
       I2=K7
       I3=K3
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N1,N3,N1,M2,
     & N0,N1,N1,N3,N1,M2,M1,N1,S541,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S544(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X7,S544, 1.000)
       deallocate(S544)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N1,N3,N1,M2,
     & N1,N3,N0,N1,N1,M2,M1,N1,S541,D1)
       allocate(B2(N1+1:N3,N0+1:M1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S542(N0+1:M1,N0+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K1
       I2=K5
       I3=K3
...
C
       call
     & sum3124(N0,N1,N1,M2,N0,M1,M1,N1,X6,S542, 1.000)
       deallocate(S542)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,N0+1:M1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,N3,N0,M1,VAHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S545(N1+1:M2,N0+1:N1,N1+1:N3,N0+1:M1))
       I1=K5*K3*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,N1,N3,N1,M2,N0,M1,S545,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S546(N1+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,N0,M1,X8,S546, 1.000)
       deallocate(S546)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:N3,N1+1:M2))
       call reorder1423(N1,N3,N1,N3,N1,N3,N0,N1,
     & N1,N3,N0,N1,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S547(N0+1:M1,N0+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3*K1
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N1,N3,N1,M2,N0,M1,S547,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S548(N1+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,N0,M1,X8,S548, 1.000)
       deallocate(S548)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:N3,N1+1:M2))
       call reorder1423(N1,N3,N1,N3,N1,N3,N0,N1,
     & N1,N3,N0,N1,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S549(N0+1:M1,N0+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3*K1
       I2=K5
       I3=K3
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N1,N1,N3,N1,M2,
     & N0,N1,N1,N3,N1,M2,N0,M1,S549,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,N0,M1,X8,S550,-1.000)
       deallocate(S550)
C
     ...
     & N1,N3,N0,N2,N0,N1,N0,M1,VBHHPH,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S551(M1+1:N1,N0+1:N2,N0+1:N1,N0+1:M1))
       I1=K5*K1*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,N2,N0,M1,M1,N1,S551,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S553(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X10,S553,-1.000)
       deallocate(S553)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N0,M1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S551,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S615(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X1,S615,-1.000)
       deallocate(S615)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N0,M1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S551,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S552(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X9,S552,-1.000)
       deallocate(S552)
C
     ...
     & N1,N3,N0,N1,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S554(M1+1:N1,N0+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N2,N3,N2,M2,M1,N1,S554,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S555(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X11,S555,-1.000)
       deallocate(S555)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N2,N3,N2,M2,
     & N2,N3,N0,N1,N2,M2,M1,N1,S554,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,M1,N1,X1,S616, 1.000)
       deallocate(S616)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N2,N3,N2,M2,
     & N0,N1,N2,N3,N2,M2,M1,N1,S554,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S556(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X12,S556,-1.000)
       deallocate(S556)
C
       allocate(D1(N1+1:N3,N0+1:N1,N2+1:N3,N2+1:M2))
       call reorder2413(N2,N3,N1,N3,N2,N3,N0,N1,
     & N1,N3,N0,N1,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S560(N0+1:M1,N0+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4*K1
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N2,N3,N2,M2,N0,M1,S560,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S562(N1+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,N0,M1,X16,S562,-1.000)
       deallocate(S562)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,N0+1:M1))
       call reorder3241(N0,M1,N0,N1,N2,N3,N2,M2,
     & N2,N3,N0,N1,N2,M2,N0,M1,S560,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S618(N0+1:M1,N0+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,N0,M1,X2,S618, 1.000)
       deallocate(S618)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N1,N2,N3,N2,M2,
     & N0,N1,N2,N3,N2,M2,N0,M1,S560,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S561(N1+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,N0,M1,X15,S561,-1.000)
       deallocate(S561)
C
     ...
     & N1,N3,M1,N1,M1,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S565(M1+1:N1,M1+1:N1,M1+1:N1,N1+1:N3))
       I1=K3*K7*K7
       I2=K7
       I3=K3
...
C
     ...
     & N1,N3,M1,N1,M1,N1,M1,N1,S565,D1)
       allocate(B2(N1+1:N3,N0+1:M1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S566(N0+1:M1,M1+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K7
       I2=K5
       I3=K3
...
C
       call
     & sum3124(M1,N1,M1,N1,N0,M1,M1,N1,X33,S566, 1.000)
       deallocate(S566)
C
       call sumx3412(N0,N1,N0,N1,N0,N1,N0,N1,
     & M1,N1,M1,N1,N0,M1,M1,N1,X33,VAHHHH, 1.000)
C
       allocate(F2(M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1))
       call reorder561234(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z33(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K5*K9*K9*K0
       I3=K7*K7
...
C
     ...
     & N1,N3,N0,N1,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S567(M1+1:N1,N0+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,M2,N3,M1,N1,S567,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S568(N1+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,M2,N3,N1,M2,M1,N1,X34,S568, 1.000)
       deallocate(S568)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder621345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z34(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z34,-1.000)
       deallocate(Z34)
       deallocate(X34)
C
     ...
     & N1,N3,N0,N1,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S569(M1+1:N1,N0+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S569,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S570(N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X35,S570, 1.000)
       deallocate(S570)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder621345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z35(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K9*K7
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z35,-1.000)
       deallocate(Z35)
       deallocate(X35)
C
     ...
     & N1,N3,M1,N1,N0,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S571(M1+1:N1,M1+1:N1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K7
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,M2,N3,M1,N1,S571,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S572(N1+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,M2,N3,N1,M2,M1,N1,X82,S572,-1.000)
       deallocate(S572)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder621345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z131(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X82,F2,Z131)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z131, 1.000)
       deallocate(Z131)
       deallocate(X82)
C
     ...
     & N1,N3,M1,N1,N0,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S573(M1+1:N1,M1+1:N1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K7
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S573,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S574(N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X83,S574,-1.000)
       deallocate(S574)
C
       allocate(F2(M1+1:N1,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder621345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z132(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K9*K7
       call EGEMM(I1,I2,I3,X83,F2,Z132)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z132, 1.000)
       deallocate(Z132)
       deallocate(X83)
C
...
C
     ...
     & N1,N3,N0,N1,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S577(N0+1:M1,N0+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K1
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,M2,N3,N0,M1,S577,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S578(N1+1:M2,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,M2,N3,N1,M2,N0,M1,X39,S578, 1.000)
       deallocate(S578)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z39(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z39,-1.000)
       deallocate(Z39)
       deallocate(X39)
C
     ...
     & N1,N3,N0,N1,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S579(N0+1:M1,N0+1:N1,N0+1:M1,N1+1:M2))
       I1=K9*K5*K1
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N1,M2,N0,M1,S579,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S580(N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X40,S580, 1.000)
       deallocate(S580)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z40(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K5
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z40,-1.000)
       deallocate(Z40)
       deallocate(X40)
C
       allocate(D1(N1+1:N3,N0+1:N1,M1+1:N1,N1+1:M2))
     ...
     & N1,N3,N0,N1,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S581(N0+1:M1,N0+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K1
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,N1,M2,N0,M1,S581,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S582(N1+1:M2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,N0,M1,X41,S582, 1.000)
       deallocate(S582)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z41(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K7
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z41,-1.000)
       deallocate(Z41)
       deallocate(X41)
C
     ...
     & N1,N3,N0,M1,N0,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S583(N0+1:M1,N0+1:M1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K5
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,M2,N3,N0,M1,S583,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S584(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X84,S584,-1.000)
       deallocate(S584)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z144(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X84,F2,Z144)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z144, 1.000)
       deallocate(Z144)
       deallocate(X84)
C
       allocate(D1(N1+1:N3,M1+1:N1,N0+1:N1,M2+1:N3))
     ...
     & N1,N3,M1,N1,N0,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S585(N0+1:M1,M1+1:N1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K7
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,M2,N3,N0,M1,S585,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S586(N1+1:M2,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,M2,N3,N1,M2,N0,M1,X85,S586,-1.000)
       deallocate(S586)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z145(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X85,F2,Z145)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z145, 1.000)
       deallocate(Z145)
       deallocate(X85)
C
     ...
     & N1,N3,N0,M1,N0,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S587(N0+1:M1,N0+1:M1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K5
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N1,M2,N0,M1,S587,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S588(N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X86,S588,-1.000)
       deallocate(S588)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z146(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X86,F2,Z146)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z146, 1.000)
       deallocate(Z146)
       deallocate(X86)
C
       allocate(D1(N1+1:N3,M1+1:N1,N0+1:N1,N1+1:M2))
     ...
     & N1,N3,M1,N1,N0,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S589(N0+1:M1,M1+1:N1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K7
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,N1,M2,N0,M1,S589,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S590(N1+1:M2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,N0,M1,X87,S590,-1.000)
       deallocate(S590)
C
       allocate(F2(M1+1:N1,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z147(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K7
       call EGEMM(I1,I2,I3,X87,F2,Z147)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z147, 1.000)
       deallocate(Z147)
       deallocate(X87)
C
...
C
     ...
     & N1,N3,N0,N1,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S575(N0+1:M1,N0+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5*K1
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,M2,N3,N0,M1,S575,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S576(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X38,S576, 1.000)
       deallocate(S576)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z38(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z38,-1.000)
       deallocate(Z38)
       deallocate(X38)
C
       allocate(D1(N0+1:N1,N0+1:N1,M2+1:N3,M2+1:N3))
     ...
     & N0,N1,N0,N1,M2,N3,M2,N3,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S591(N1+1:M2,N0+1:N1,M2+1:N3,M2+1:N3))
       I1=K6*K6*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,M2,N3,M2,N3,N1,M2,S591,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S592(N1+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M2,N3,M2,N3,N1,M2,N1,M2,X46,S592, 1.000)
       deallocate(S592)
C
       call sumx1234(N1,N3,N1,N3,N1,N3,N1,M2,
     & M2,N3,M2,N3,N1,M2,N1,M2,X46,VAAPPP, 1.000)
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N1,t3B3,F2)
       allocate(Z46(N2+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9
       I2=K7*K5*K5*K0
       I3=K6*K6
...
C
       call
     & sum145623(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z46, 0.500)
       deallocate(Z46)
       deallocate(X46)
C
       allocate(D1(N0+1:N1,N0+1:N1,M2+1:N3,N1+1:M2))
     ...
     & N0,N1,N0,N1,M2,N3,N1,M2,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S593(N1+1:M2,N0+1:N1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,M2,N3,N1,M2,N1,M2,S593,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S594(N1+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M2,N3,N1,M2,N1,M2,N1,M2,X47,S594, 1.000)
       deallocate(S594)
C
       call sumx1234(N1,N3,N1,N3,N1,N3,N1,M2,
     & M2,N3,N1,M2,N1,M2,N1,M2,X47,VAAPPP, 1.000)
C
     ...
     & M2,N3,N1,M2,N2,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z47(N2+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9
       I2=K7*K5*K5*K0
       I3=K9*K6
...
C
       call
     & sum145623(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z47, 1.000)
       deallocate(Z47)
       deallocate(X47)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:M2,N1+1:M2))
     ...
     & N0,N1,N0,N1,N1,M2,N1,M2,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S595(N1+1:M2,N0+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,N1,M2,N1,M2,N1,M2,S595,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S596(N1+1:M2,N1+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K9
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,M2,N1,M2,N1,M2,N1,M2,X48,S596, 1.000)
       deallocate(S596)
C
       call sumx1234(N1,N3,N1,N3,N1,N3,N1,M2,
     & N1,M2,N1,M2,N1,M2,N1,M2,X48,VAAPPP, 1.000)
C
       allocate(F2(N1+1:M2,N1+1:M2,N2+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder231456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N1,M2,N1,M2,N2,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z48(N2+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9
       I2=K7*K5*K5*K0
       I3=K9*K9
...
C
       call
     & sum145623(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z48, 0.500)
       deallocate(Z48)
       deallocate(X48)
C
...
C
     ...
     & N1,N3,M1,N2,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S597(M1+1:N1,M1+1:N2,N0+1:N1,M2+1:N3))
       I1=K6*K1*K8
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,S597,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S601(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N1))
       I1=K7*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N1,X108,S601,-1.000)
       deallocate(S601)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z400(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X108,F2,Z400)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z400,-1.000)
       deallocate(Z400)
       deallocate(X108)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,M1+1:N1))
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,S597,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S598(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N1))
       I1=K7*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N1,X106,S598,-1.000)
       deallocate(S598)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z398(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X106,F2,Z398)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z398, 1.000)
       deallocate(Z398)
       deallocate(X106)
C
     ...
     & N1,N3,M1,N2,N0,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S599(M1+1:N1,M1+1:N2,N0+1:N1,N2+1:M2))
       I1=K0*K1*K8
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,S599,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S602(N1+1:M2,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,M1,N1,X109,S602,-1.000)
       deallocate(S602)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z401(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X109,F2,Z401)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z401,-1.000)
       deallocate(Z401)
       deallocate(X109)
C
       allocate(D1(N0+1:N1,M1+1:N2,N2+1:M2,M1+1:N1))
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,S599,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S600(N1+1:M2,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,M1,N1,X107,S600,-1.000)
       deallocate(S600)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z399(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X107,F2,Z399)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z399, 1.000)
       deallocate(Z399)
       deallocate(X107)
C
       allocate(D1(N1+1:N3,N0+1:M1,N0+1:N1,M2+1:N3))
     ...
     & N1,N3,N0,M1,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S603(N0+1:M1,N0+1:M1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K5
       I2=K5
       I3=K3
...
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder3241(N0,M1,N0,M1,N0,N1,M2,N3,
     & N0,N1,N0,M1,M2,N3,N0,M1,S603,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X114,S611,-1.000)
       deallocate(S611)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z414(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X114,F2,Z414)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z414,-1.000)
       deallocate(Z414)
       deallocate(X114)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,N1,N0,M1,M2,N3,N0,M1,S603,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S604(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X110,S604,-1.000)
       deallocate(S604)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z410(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X110,F2,Z410)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z410, 1.000)
       deallocate(Z410)
       deallocate(X110)
C
     ...
     & N1,N3,N0,M1,N0,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S607(N0+1:M1,N0+1:M1,N0+1:N1,N2+1:M2))
       I1=K0*K1*K5
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N2,M2,N0,M1,S607,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S613(N1+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N2,M2,N1,M2,N0,M1,X116,S613,-1.000)
       deallocate(S613)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z416(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X116,F2,Z416)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z416,-1.000)
       deallocate(Z416)
       deallocate(X116)
C
       allocate(D1(N0+1:N1,N0+1:M1,N2+1:M2,N0+1:M1))
     ...
     & N0,N1,N0,M1,N2,M2,N0,M1,S607,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S608(N1+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N2,M2,N1,M2,N0,M1,X112,S608,-1.000)
       deallocate(S608)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z412(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X112,F2,Z412)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z412, 1.000)
       deallocate(Z412)
       deallocate(X112)
C
       allocate(D1(N1+1:N3,M1+1:N2,N0+1:N1,M2+1:N3))
     ...
     & N1,N3,M1,N2,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S605(N0+1:M1,M1+1:N2,N0+1:N1,M2+1:N3))
       I1=K6*K1*K8
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,M1,N2,M2,N3,N0,M1,S605,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S612(N1+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,N0,M1,X115,S612,-1.000)
       deallocate(S612)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z415(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X115,F2,Z415)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z415, 1.000)
       deallocate(Z415)
       deallocate(X115)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,N0+1:M1))
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,N0,M1,X111,S606,-1.000)
       deallocate(S606)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z411(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X111,F2,Z411)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z411,-1.000)
       deallocate(Z411)
       deallocate(X111)
C
       allocate(D1(N1+1:N3,M1+1:N2,N0+1:N1,N2+1:M2))
     ...
     & N1,N3,M1,N2,N0,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S609(N0+1:M1,M1+1:N2,N0+1:N1,N2+1:M2))
       I1=K0*K1*K8
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,M1,N2,N2,M2,N0,M1,S609,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S614(N1+1:M2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,N0,M1,X117,S614,-1.000)
       deallocate(S614)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z417(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X117,F2,Z417)
       deallocate(F2)
C
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z417, 1.000)
       deallocate(Z417)
       deallocate(X117)
C
       allocate(D1(N0+1:N1,M1+1:N2,N2+1:M2,N0+1:M1))
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,N0,M1,X113,S610,-1.000)
       deallocate(S610)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z413(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X113,F2,Z413)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z413,-1.000)
       deallocate(Z413)
       deallocate(X113)
C
       allocate(D1(N1+1:N3,N0+1:N2,N0+1:N1,N0+1:M1))
     ...
     & N1,N3,N0,N2,N0,N1,N0,M1,VBHHPH,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S557(N0+1:M1,N0+1:N2,N0+1:N1,N0+1:M1))
       I1=K5*K1*K2
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N0,N2,N0,M1,N0,M1,S557,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S559(N1+1:M2,N0+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,N0,M1,X14,S559,-1.000)
       deallocate(S559)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,N1,N0,M1,
     & N0,N2,N0,N1,N0,M1,N0,M1,S557,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S617(N2+1:M2,N0+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,N0,M1,X2,S617,-1.000)
       deallocate(S617)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,N0+1:M1))
       call reorder3241(N0,M1,N0,N2,N0,N1,N0,M1,
     & N0,N1,N0,N2,N0,M1,N0,M1,S557,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S558(N1+1:M2,N0+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,N0,M1,X13,S558,-1.000)
       deallocate(S558)
C
     ...
     & N1,N3,N0,M1,M1,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S563(M1+1:N1,N0+1:M1,M1+1:N1,N1+1:N3))
       I1=K3*K7*K5
       I2=K7
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,M1,N1,M1,N1,S563,D1)
       allocate(B2(N1+1:N3,N0+1:M1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S564(N0+1:M1,N0+1:M1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K5
       I2=K5
       I3=K3
...
C
       call
     & sum3124(N0,M1,M1,N1,N0,M1,M1,N1,X32,S564, 1.000)
       deallocate(S564)
C
       call sumx3412(N0,N1,N0,N1,N0,N1,N0,N1,
...
C
       ...
       call reorder561234(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z32(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K5*K9*K9*K0
       I3=K7*K5
...
C
     ...
     & N0,N1,N0,N2,N1,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S619(N1+1:M2,N0+1:N2,N1+1:N3,N0+1:M1))
       I1=K5*K3*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S619,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S620(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X3,S620, 1.000)
       deallocate(S620)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,N0+1:M1))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N0,N2,N1,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S621(N1+1:M2,N0+1:N2,N1+1:N3,N0+1:M1))
       I1=K5*K3*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N1,N3,N0,M1,
     & N0,N2,N1,N3,N1,M2,N0,M1,S621,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S622(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X4,S622, 1.000)
       deallocate(S622)
C
     ...
     & N2,N3,N0,N1,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S623(N0+1:M1,N0+1:N1,N1+1:N3,N2+1:M2))
       I1=K0*K3*K1
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,N1,N3,N2,M2,N0,M1,S623,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S625(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X4,S625,-1.000)
       deallocate(S625)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N1,N1,N3,N2,M2,
     & N0,N1,N1,N3,N2,M2,N0,M1,S623,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S624(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X3,S624,-1.000)
       deallocate(S624)
C
     ...
     & N2,N3,N0,N2,N0,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S626(N0+1:M1,N0+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,N0,N2,N0,M1,M1,N1,S626,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S628(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X10,S628,-1.000)
       deallocate(S628)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S626,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S777(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X1,S777,-1.000)
       deallocate(S777)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder3214(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S626,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S627(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X9,S627,-1.000)
       deallocate(S627)
C
     ...
     & N0,N1,N0,N2,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S631(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S631,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S632(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X12,S632, 1.000)
       deallocate(S632)
C
     ...
     & N1,N3,N0,N2,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S633(M1+1:N1,N0+1:N2,N2+1:N3,N1+1:M2))
       I1=K9*K4*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S633,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X11,S637,-1.000)
       deallocate(S637)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,M1,N1,S633,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S634(N0+1:M1,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,M1,N1,X9,S634, 1.000)
       deallocate(S634)
C
       allocate(D1(N1+1:N3,N0+1:N2,N2+1:N3,N1+1:M2))
       call reorder2314(N2,N3,N1,N3,N0,N2,N1,N3,
     & N1,N3,N0,N2,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S635(M1+1:N1,N0+1:N2,N2+1:N3,N1+1:M2))
       I1=K9*K4*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S635,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S638(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X12,S638,-1.000)
       deallocate(S638)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,M1,N1,S635,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S636(N0+1:M1,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,M1,N1,X10,S636, 1.000)
       deallocate(S636)
C
     ...
     & N2,N3,N0,N2,N0,N1,N0,M1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S639(N0+1:M1,N0+1:N2,N0+1:N1,N0+1:M1))
       I1=K5*K1*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,N0,N2,N0,M1,N0,M1,S639,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S641(N1+1:M2,N0+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,N0,M1,X14,S641,-1.000)
       deallocate(S641)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,N0+1:M1))
       call reorder2314(N0,M1,N0,N2,N0,N1,N0,M1,
     & N0,N2,N0,N1,N0,M1,N0,M1,S639,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S778(N2+1:M2,N0+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,N0,M1,X2,S778,-1.000)
       deallocate(S778)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,N0+1:M1))
       call reorder3214(N0,M1,N0,N2,N0,N1,N0,M1,
     & N0,N1,N0,N2,N0,M1,N0,M1,S639,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S640(N1+1:M2,N0+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,N0,M1,X13,S640,-1.000)
       deallocate(S640)
C
     ...
     & N0,N1,N0,N2,N2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S644(N1+1:M2,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,N3,N1,M2,N0,M1,S644,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S645(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X16,S645, 1.000)
       deallocate(S645)
C
       allocate(D1(N1+1:N3,N0+1:N2,N2+1:N3,N1+1:M2))
       call reorder2314(N2,N3,N1,N3,N0,N2,N1,N3,
     & N1,N3,N0,N2,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S646(N0+1:M1,N0+1:N2,N2+1:N3,N1+1:M2))
       I1=K9*K4*K2
       I2=K5
       I3=K3
...
C
     ...
     & N0,N2,N2,N3,N1,M2,N0,M1,S646,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S650(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X15,S650,-1.000)
       deallocate(S650)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,N0+1:M1))
       call reorder3241(N0,M1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,N0,M1,S646,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S647(N0+1:M1,N0+1:N2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,N0,M1,X13,S647, 1.000)
       deallocate(S647)
C
       allocate(D1(N1+1:N3,N0+1:N2,N2+1:N3,N1+1:M2))
       call reorder2314(N2,N3,N1,N3,N0,N2,N1,N3,
     & N1,N3,N0,N2,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S648(N0+1:M1,N0+1:N2,N2+1:N3,N1+1:M2))
       I1=K9*K4*K2
       I2=K5
       I3=K3
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N2,N3,N1,M2,
     & N0,N2,N2,N3,N1,M2,N0,M1,S648,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S651(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X16,S651,-1.000)
       deallocate(S651)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,N0+1:M1))
       call reorder3241(N0,M1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,N0,M1,S648,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S649(N0+1:M1,N0+1:N2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,N0,M1,X14,S649, 1.000)
       deallocate(S649)
C
     ...
     & N1,N3,M1,N2,N0,M1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S652(M1+1:N1,M1+1:N2,N0+1:M1,N2+1:N3))
       I1=K4*K5*K8
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,S652,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S653(N0+1:M1,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,N0,M1,N0,M1,M1,N1,X49,S653, 1.000)
       deallocate(S653)
C
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & M1,N2,N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(Z49(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K5*K9*K9*K0
       I3=K5*K8
...
C
       call
     & sum123546(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z49,-1.000)
       deallocate(Z49)
       deallocate(X49)
C
     ...
     & N1,N3,N0,M1,M1,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S654(M1+1:N1,N0+1:M1,M1+1:N1,N2+1:N3))
       I1=K4*K7*K5
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,S654,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S655(N0+1:M1,N0+1:M1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N1,N0,M1,M1,N1,X50,S655, 1.000)
       deallocate(S655)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder461235(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z50(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K5*K9*K9*K0
       I3=K7*K5
...
C
       call
     & sum123546(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z50, 1.000)
       deallocate(Z50)
       deallocate(X50)
C
     ...
     & N1,N3,M1,N2,M1,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S656(M1+1:N1,M1+1:N2,M1+1:N1,N2+1:N3))
       I1=K4*K7*K8
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,S656,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S657(N0+1:M1,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N1,N0,M1,M1,N1,X51,S657, 1.000)
       deallocate(S657)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder461235(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z51(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K5*K9*K9*K0
       I3=K7*K8
...
C
       call
     & sum123546(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z51, 1.000)
       deallocate(Z51)
       deallocate(X51)
C
     ...
     & N1,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S658(M1+1:N1,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,S658,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S659(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N1,X88,S659,-1.000)
       deallocate(S659)
C
       allocate(F2(M1+1:N1,M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z171(N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K5*K5*K9*K9
       I3=K6*K7
       call EGEMM(I1,I2,I3,X88,F2,Z171)
       deallocate(F2)
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z171,-1.000)
       deallocate(Z171)
       deallocate(X88)
C
...
C
       call
     & sum3124(M1,N1,N2,M2,N2,M2,M1,N1,X89,S661,-1.000)
       deallocate(S661)
C
       allocate(F2(M1+1:N1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z172(N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K5*K5*K9*K9
       I3=K0*K7
       call EGEMM(I1,I2,I3,X89,F2,Z172)
       deallocate(F2)
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z172,-1.000)
       deallocate(Z172)
       deallocate(X89)
C
...
C
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z23(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K5*K9*K9*K0
       I3=K7
...
C
       call
     & sum123465(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z23,-1.000)
       deallocate(Z23)
       deallocate(X23)
C
       allocate(B1(N1+1:N3,M1+1:N1))
...
C
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z21(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7
       I2=K5*K5*K9*K9*K0
       I3=K7
...
C
     ...
     & N1,N3,M1,N2,N0,M1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S664(N0+1:M1,M1+1:N2,N0+1:M1,N2+1:N3))
       I1=K4*K5*K8
       I2=K5
       I3=K3
...
C
     ...
     & N2,N3,M1,N2,N0,M1,N0,M1,S664,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S665(N0+1:M1,M1+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,N0,M1,N0,M1,N0,M1,X55,S665, 1.000)
       deallocate(S665)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(Z55(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K7*K9*K9*K0
       I3=K5*K8
...
C
       call
     & sum123645(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z55, 1.000)
       deallocate(Z55)
       deallocate(X55)
C
       allocate(D1(N1+1:N3,N0+1:M1,M1+1:N1,N2+1:N3))
     ...
     & N1,N3,N0,M1,M1,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S666(N0+1:M1,N0+1:M1,M1+1:N1,N2+1:N3))
       I1=K4*K7*K5
       I2=K5
       I3=K3
...
C
     ...
     & N2,N3,N0,M1,M1,N1,N0,M1,S666,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S667(N0+1:M1,N0+1:M1,M1+1:N1,N0+1:M1))
       I1=K5*K7*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N1,N0,M1,N0,M1,X56,S667, 1.000)
       deallocate(S667)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(Z56(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K7*K9*K9*K0
       I3=K7*K5
...
C
       call
     & sum123645(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z56, 1.000)
       deallocate(Z56)
       deallocate(X56)
C
       allocate(D1(N1+1:N3,M1+1:N2,M1+1:N1,N2+1:N3))
     ...
     & N1,N3,M1,N2,M1,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S668(N0+1:M1,M1+1:N2,M1+1:N1,N2+1:N3))
       I1=K4*K7*K8
       I2=K5
       I3=K3
...
C
     ...
     & N2,N3,M1,N2,M1,N1,N0,M1,S668,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S669(N0+1:M1,M1+1:N2,M1+1:N1,N0+1:M1))
       I1=K5*K7*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N1,N0,M1,N0,M1,X57,S669, 1.000)
       deallocate(S669)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M1,N1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(Z57(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K7*K9*K9*K0
       I3=K7*K8
...
C
       call
     & sum123645(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z57, 1.000)
       deallocate(Z57)
       deallocate(X57)
C
     ...
     & N1,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S670(N0+1:M1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K5
       I3=K3
...
C
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,S670,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S671(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X90,S671,-1.000)
       deallocate(S671)
C
       allocate(F2(N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z177(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K5
       call EGEMM(I1,I2,I3,X90,F2,Z177)
       deallocate(F2)
C
       call
     & sum234615(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z177,-1.000)
       deallocate(Z177)
       deallocate(X90)
C
       allocate(D1(N1+1:N3,N0+1:N2,M1+1:N1,M2+1:N3))
     ...
     & N1,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S672(N0+1:M1,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K5
       I3=K3
...
C
     ...
     & N0,N2,M1,N1,M2,N3,N0,M1,S672,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S673(N2+1:M2,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,N0,M1,X91,S673,-1.000)
       deallocate(S673)
C
       allocate(F2(M1+1:N1,M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z178(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K7
       call EGEMM(I1,I2,I3,X91,F2,Z178)
       deallocate(F2)
C
       call
     & sum234615(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z178,-1.000)
       deallocate(Z178)
       deallocate(X91)
C
     ...
     & N1,N3,N0,N2,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S674(N0+1:M1,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K5
       I3=K3
...
C
     ...
     & N0,N2,N0,M1,N2,M2,N0,M1,S674,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S675(N2+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,N0,M1,X92,S675,-1.000)
       deallocate(S675)
C
       allocate(F2(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z179(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K0*K5
       call EGEMM(I1,I2,I3,X92,F2,Z179)
       deallocate(F2)
C
       call
     & sum234615(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z179,-1.000)
       deallocate(Z179)
       deallocate(X92)
C
       allocate(D1(N1+1:N3,N0+1:N2,M1+1:N1,N2+1:M2))
     ...
     & N1,N3,N0,N2,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S676(N0+1:M1,N0+1:N2,M1+1:N1,N2+1:M2))
       I1=K0*K7*K2
       I2=K5
       I3=K3
...
C
     ...
     & N0,N2,M1,N1,N2,M2,N0,M1,S676,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S677(N2+1:M2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N2,M2,N2,M2,N0,M1,X93,S677,-1.000)
       deallocate(S677)
C
       allocate(F2(M1+1:N1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z180(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K0*K7
       call EGEMM(I1,I2,I3,X93,F2,Z180)
       deallocate(F2)
C
       call
     & sum234615(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z180,-1.000)
       deallocate(Z180)
       deallocate(X93)
C
...
C
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z22(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K5*K9*K9*K0
       I3=K5
...
C
       call
     & sum123465(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z22,-1.000)
       deallocate(Z22)
       deallocate(X22)
C
     ...
     & N1,N3,N0,M1,N0,M1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S662(N0+1:M1,N0+1:M1,N0+1:M1,N2+1:N3))
       I1=K4*K5*K5
       I2=K5
       I3=K3
...
C
     ...
     & N2,N3,N0,M1,N0,M1,N0,M1,S662,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S663(N0+1:M1,N0+1:M1,N0+1:M1,N0+1:M1))
       I1=K5*K5*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,N0,M1,N0,M1,N0,M1,X54,S663, 1.000)
       deallocate(S663)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(Z54(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K7*K9*K9*K0
       I3=K5*K5
...
C
       call
     & sum123645(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z54, 1.000)
       deallocate(Z54)
       deallocate(X54)
C
     ...
     & N2,N3,N0,M1,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S678(N0+1:M1,N0+1:M1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K5
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder3241(N0,M1,N0,M1,N0,N1,M2,N3,
     & N0,N1,N0,M1,M2,N3,N0,M1,S678,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S686(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X98,S686, 1.000)
       deallocate(S686)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z185(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z185,-1.000)
       deallocate(Z185)
       deallocate(X98)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,N1,N0,M1,M2,N3,N0,M1,S678,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S679(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X94,S679, 1.000)
       deallocate(S679)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z181(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X94,F2,Z181)
       deallocate(F2)
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z181, 1.000)
       deallocate(Z181)
       deallocate(X94)
C
     ...
     & N2,N3,N0,M1,N0,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S682(N0+1:M1,N0+1:M1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K5
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,N0+1:M1))
       call reorder3241(N0,M1,N0,M1,N0,N1,N1,M2,
     & N0,N1,N0,M1,N1,M2,N0,M1,S682,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S688(N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X100,S688, 1.000)
       deallocate(S688)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z187(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K5
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z187,-1.000)
       deallocate(Z187)
       deallocate(X100)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,N0+1:M1))
     ...
     & N0,N1,N0,M1,N1,M2,N0,M1,S682,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S683(N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X96,S683, 1.000)
       deallocate(S683)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z183(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K5
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z183, 1.000)
       deallocate(Z183)
       deallocate(X96)
C
     ...
     & N2,N3,M1,N2,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S680(N0+1:M1,M1+1:N2,N0+1:N1,M2+1:N3))
       I1=K6*K1*K8
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,N0+1:M1))
       call reorder3241(N0,M1,M1,N2,N0,N1,M2,N3,
     & N0,N1,M1,N2,M2,N3,N0,M1,S680,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S687(N1+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,N0,M1,X99,S687, 1.000)
       deallocate(S687)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z186(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z186,-1.000)
       deallocate(Z186)
       deallocate(X99)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,N0+1:M1))
     ...
     & N0,N1,M1,N2,M2,N3,N0,M1,S680,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S681(N1+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,N0,M1,X95,S681, 1.000)
       deallocate(S681)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z182(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z182, 1.000)
       deallocate(Z182)
       deallocate(X95)
C
     ...
     & N2,N3,M1,N2,N0,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S684(N0+1:M1,M1+1:N2,N0+1:N1,N1+1:M2))
       I1=K9*K1*K8
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,M1,N2,N1,M2,N0,M1,S684,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,N0,M1,X101,S689, 1.000)
       deallocate(S689)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z188(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K8
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z188,-1.000)
       deallocate(Z188)
       deallocate(X101)
C
       allocate(D1(N0+1:N1,M1+1:N2,N1+1:M2,N0+1:M1))
     ...
     & N0,N1,M1,N2,N1,M2,N0,M1,S684,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S685(N1+1:M2,M1+1:N2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,N0,M1,X97,S685, 1.000)
       deallocate(S685)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z184(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K9*K8
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z184, 1.000)
       deallocate(Z184)
       deallocate(X97)
C
...
C
       call
     & sum21(N0,M1,N0,M1,X102,Q73, 1.000)
       deallocate(Q73)
C
       allocate(F2(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z189(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K5*K9*K9*K0
       I3=K5
...
C
       call
     & sum123564(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z189,-1.000)
       deallocate(Z189)
       deallocate(X102)
C
...
C
       call
     & sum21(M1,N2,N0,M1,X103,Q75, 1.000)
       deallocate(Q75)
C
       allocate(F2(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z190(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K5*K9*K9*K0
       I3=K8
...
C
       call
     & sum123564(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z190,-1.000)
       deallocate(Z190)
       deallocate(X103)
C
...
C
     ...
     & N0,N2,M2,N3,M2,N3,N1,M2,S690,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S691(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X70,S691, 1.000)
       deallocate(S691)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,M2,N3,N2,M2,N1,M2,X70,VBAPPP, 1.000)
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z70(N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K5*K5*K9
       I3=K6*K6
...
C
       call
     & sum345612(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z70, 1.000)
       deallocate(Z70)
       deallocate(X70)
C
...
C
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,S692,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S693(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X71,S693, 1.000)
       deallocate(S693)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,M2,N3,N2,M2,N1,M2,X71,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,M2+1:N3,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z71(N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K5*K5*K9
       I3=K6*K0
...
C
       call
     & sum345612(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z71, 1.000)
       deallocate(Z71)
       deallocate(X71)
C
...
C
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,S694,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S695(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X72,S695, 1.000)
       deallocate(S695)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,N1,M2,N2,M2,N1,M2,X72,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z72(N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K5*K5*K9
       I3=K9*K6
...
C
       call
     & sum345612(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z72, 1.000)
       deallocate(Z72)
       deallocate(X72)
C
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,S696,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S697(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X73,S697, 1.000)
       deallocate(S697)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,N1,M2,N2,M2,N1,M2,X73,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z73(N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K5*K5*K9
       I3=K9*K0
...
C
       call
     & sum345612(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z73, 1.000)
       deallocate(Z73)
       deallocate(X73)
C
       allocate(D1(N0+1:N1,N0+1:N2,M2+1:N3,M2+1:N3))
     ...
     & N0,N1,N0,N2,M2,N3,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S698(N1+1:M2,N0+1:N2,M2+1:N3,M2+1:N3))
       I1=K6*K6*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,M2+1:N3,M2+1:N3,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,M2,N3,M2,N3,
     & N0,N2,M2,N3,M2,N3,N1,M2,S698,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S699(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X74,S699, 1.000)
       deallocate(S699)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,M2,N3,N2,M2,N1,M2,X74,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,M2+1:N3,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z74(N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K5*K5*K9
       I3=K6*K6
...
C
       call
     & sum245613(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z74,-1.000)
       deallocate(Z74)
       deallocate(X74)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:M2,M2+1:N3))
     ...
     & N0,N1,N0,N2,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S700(N1+1:M2,N0+1:N2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:M2,M2+1:N3,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,N2,M2,M2,N3,
     & N0,N2,N2,M2,M2,N3,N1,M2,S700,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S701(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X75,S701, 1.000)
       deallocate(S701)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,M2,N3,N2,M2,N1,M2,X75,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,M2+1:N3,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z75(N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K5*K5*K9
       I3=K6*K0
...
C
       call
     & sum245613(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z75,-1.000)
       deallocate(Z75)
       deallocate(X75)
C
       allocate(D1(N0+1:N1,N0+1:N2,M2+1:N3,N1+1:M2))
     ...
     & N0,N1,N0,N2,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S702(N1+1:M2,N0+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,M2,N3,N1,M2,
     & N0,N2,M2,N3,N1,M2,N1,M2,S702,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S703(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X76,S703, 1.000)
       deallocate(S703)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,N1,M2,N2,M2,N1,M2,X76,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z76(N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K5*K5*K9
       I3=K9*K6
...
C
       call
     & sum245613(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z76,-1.000)
       deallocate(Z76)
       deallocate(X76)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:M2,N1+1:M2))
     ...
     & N0,N1,N0,N2,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S704(N1+1:M2,N0+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,N2,M2,N1,M2,
     & N0,N2,N2,M2,N1,M2,N1,M2,S704,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S705(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X77,S705, 1.000)
       deallocate(S705)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,N1,M2,N2,M2,N1,M2,X77,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z77(N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K5*K5*K9
       I3=K9*K0
...
C
       call
     & sum245613(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z77,-1.000)
       deallocate(Z77)
       deallocate(X77)
C
...
C
       call
     & sum21(M2,N3,N2,M2,X104,Q77,-1.000)
       deallocate(Q77)
C
       allocate(F2(M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z199(N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K5*K5*K9*K9
       I3=K6
       call EGEMM(I1,I2,I3,X104,F2,Z199)
       deallocate(F2)
C
       call
     & sum234561(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z199, 1.000)
       deallocate(Z199)
       deallocate(X104)
C
...
C
       call
     & sum21(N2,M2,N2,M2,X105,Q79,-1.000)
       deallocate(Q79)
C
       allocate(F2(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z200(N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K5*K5*K9*K9
       I3=K0
       call EGEMM(I1,I2,I3,X105,F2,Z200)
       deallocate(F2)
C
       call
     & sum234561(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z200, 1.000)
       deallocate(Z200)
       deallocate(X105)
C
...
C
       ...
       call reorder213456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z26(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K5*K5*K9*K0
       I3=K6
...
C
       call
     & sum124563(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z26,-1.000)
       deallocate(Z26)
       deallocate(X26)
C
       allocate(B2(N0+1:N1,N1+1:M2))
...
C
       ...
       call reorder213456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z24(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K5*K5*K9*K0
       I3=K6
...
C
       call
     & sum134562(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z24, 1.000)
       deallocate(Z24)
       deallocate(X24)
C
...
C
       ...
       call reorder213456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z27(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K5*K5*K9*K0
       I3=K9
...
C
       call
     & sum124563(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z27,-1.000)
       deallocate(Z27)
       deallocate(X27)
C
       allocate(B2(N0+1:N1,N1+1:M2))
...
C
       ...
       call reorder213456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z25(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K5*K5*K9*K0
       I3=K9
...
C
       call
     & sum134562(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z25, 1.000)
       deallocate(Z25)
       deallocate(X25)
C
     ...
     & N1,N3,N0,N1,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S706(M1+1:N1,N0+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,S706,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S708(N1+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N1,M2,N0,M1,M1,N1,X5,S708, 1.000)
       deallocate(S708)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,S706,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S709(N1+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N1,M2,N0,M1,M1,N1,X6,S709,-1.000)
       deallocate(S709)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N0,N1,N1,N3,M1,N1,S706,D1)
       allocate(D2(N0+1:N1,N0+1:N1,N1+1:M2,N1+1:M2))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S710(N1+1:M2,N1+1:M2,N1+1:N3,M1+1:N1))
       I1=K7*K3
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum2314(N1,N3,N1,M2,N1,M2,M1,N1,X7,S710, 0.500)
       deallocate(S710)
C
       allocate(D1(N1+1:N3,N0+1:N1,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N1,N0,N1,N1,N3,
     & N1,N3,N0,N1,N0,N1,M1,N1,S706,D1)
       allocate(B2(N1+1:N3,N0+1:M1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S843(N0+1:M1,N0+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1*K1
       I2=K5
       I3=K3
...
C
       allocate(D1(N0+1:N1,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N1,N0,N1,M1,N1,
     & N0,N1,N0,N1,N0,M1,M1,N1,S843,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S844(N1+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,N0,M1,M1,N1,X5,S844,-1.000)
       deallocate(S844)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
     ...
     & N0,N1,N0,N1,N1,N3,M1,N1,S706,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S846(N1+1:M2,N0+1:N1,N1+1:N3,M1+1:N1))
       I1=K7*K3*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S846,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S847(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X7,S847, 1.000)
       deallocate(S847)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N1,M1,N1,S706,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S707(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X1,S707, 1.000)
       deallocate(S707)
C
       allocate(D1(N0+1:N1,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder3214(N0,M1,N0,N1,N0,N1,M1,N1,
     & N0,N1,N0,N1,N0,M1,M1,N1,S843,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S845(N1+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,N0,M1,M1,N1,X6,S845, 1.000)
       deallocate(S845)
C
     ...
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S715(N2+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & N0,N1,N1,N3,N2,M2,N0,M1,S715,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S719(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X4,S719,-1.000)
       deallocate(S719)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,N0,M1,S715,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S716(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X3,S716,-1.000)
       deallocate(S716)
C
     ...
     & N1,N3,N1,N3,N0,N1,N0,N1,VAHHPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,N0,M1,M1,N1,t2A,D2)
       allocate(S717(N0+1:M1,M1+1:N1,N0+1:N1,N0+1:N1))
       I1=K1*K1
       I2=K7*K5
       I3=K3*K3
...
C
     ...
     & N0,N1,N0,N1,N0,M1,M1,N1,S717,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S721(N1+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,N0,M1,M1,N1,X6,S721, 0.500)
       deallocate(S721)
C
       allocate(D1(N0+1:N1,N0+1:N1,N0+1:M1,M1+1:N1))
     ...
     & N0,N1,N0,N1,N0,M1,M1,N1,S717,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S718(N1+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,N0,M1,M1,N1,X5,S718,-0.500)
       deallocate(S718)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
     ...
     & N1,N3,N0,N1,Q86,B1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       allocate(S722(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K3
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X6,S722,-1.000)
       deallocate(S722)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q86,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S727(N2+1:M2,N0+1:M1,N0+1:M1,N0+1:N1))
       I1=K1
       I2=K5*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S727)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S727, 1.000)
       deallocate(S727)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q86,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S733(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K3
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S733, 1.000)
       deallocate(S733)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S720,-1.000)
       deallocate(S720)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder4231(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S723(N1+1:M2,M1+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K7*K9
       I3=K3*K1
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S723,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S724(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X7,S724,-1.000)
       deallocate(S724)
C
       allocate(D1(N1+1:N3,N0+1:N1,N0+1:N1,N1+1:N3))
       call reorder2341(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N0,N1,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S711(N0+1:M1,N0+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1*K1
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N1,N3,N0,N1,N0,M1,S711,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S712(N2+1:M2,N0+1:M1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,N0,M1,X2,S712, 1.000)
       deallocate(S712)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N0+1:M1))
       call reorder2431(N0,M1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N1,N0,M1,S711,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S713(N1+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N1,N1,M2,N0,M1,M1,N1,X5,S713,-1.000)
       deallocate(S713)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N0+1:M1))
     ...
     & N0,N1,N1,N3,N0,N1,N0,M1,S711,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S714(N1+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N1,N1,M2,N0,M1,M1,N1,X6,S714, 1.000)
       deallocate(S714)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,N0+1:M1))
       call reorder3241(N0,M1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N0,N1,N1,N3,N0,M1,S711,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S848(N1+1:M2,N0+1:N1,N1+1:N3,N0+1:M1))
       I1=K5*K3*K1
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N1,N1,N3,N0,M1,
     & N0,N1,N1,N3,N1,M2,N0,M1,S848,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S849(N1+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,N0,M1,X8,S849, 1.000)
       deallocate(S849)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,N0+1:M1))
     ...
     & N0,N1,N0,N1,N1,N3,N0,M1,S711,D1)
       ...
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S728(N1+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum2314(N1,N3,N1,M2,N1,M2,N0,M1,X8,S728, 0.500)
       deallocate(S728)
C
     ...
     & N1,N3,N0,N2,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S736(N0+1:M1,N0+1:N2,N0+1:N1,N2+1:N3))
       I1=K4*K1*K2
       I2=K5
       I3=K3
...
C
     ...
     & N0,N2,N0,N1,N2,N3,N0,M1,S736,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S747(N2+1:M2,N1+1:M2,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K9*K0
       I3=K1*K2
       call EGEMM(I1,I2,I3,D1,D2,S747)
       deallocate(D1)
       deallocate(D2)
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,N0,M1,X16,S747, 1.000)
       deallocate(S747)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,N0,M1,S736,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S748(N2+1:M2,N1+1:M2,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,N0,M1,X15,S748, 1.000)
       deallocate(S748)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,N0,M1,S736,D1)
       allocate(D2(N0+1:N1,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S749(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,N0,M1,X14,S749,-1.000)
       deallocate(S749)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,N0,M1,S736,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S750(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,N0,M1,X13,S750,-1.000)
       deallocate(S750)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N0+1:M1))
       call reorder2431(N0,M1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,N0,M1,S736,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S751(N1+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N1,N1,M2,N0,M1,M1,N1,X5,S751,-1.000)
       deallocate(S751)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N0+1:M1))
       call reorder2431(N0,M1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,N0,M1,S736,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S752(N1+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N1,N1,M2,N0,M1,M1,N1,X6,S752,-1.000)
       deallocate(S752)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,N0+1:M1))
       call reorder4231(N0,M1,N0,N2,N0,N1,N2,N3,
     & N2,N3,N0,N2,N0,N1,N0,M1,S736,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S857(N0+1:M1,N0+1:N2,N0+1:N1,N0+1:M1))
       I1=K5*K1*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,N0+1:M1))
       call reorder3214(N0,M1,N0,N2,N0,N1,N0,M1,
     & N0,N1,N0,N2,N0,M1,N0,M1,S857,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S858(N1+1:M2,N0+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,N0,M1,X13,S858,-1.000)
       deallocate(S858)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder3241(N0,M1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,N0,M1,S736,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S862(N1+1:M2,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N2,N3,N0,M1,
     & N0,N2,N2,N3,N1,M2,N0,M1,S862,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S863(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X16,S863, 1.000)
       deallocate(S863)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder3241(N0,M1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,N0,M1,S736,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S860(N1+1:M2,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N2,N3,N0,M1,
     & N0,N2,N2,N3,N1,M2,N0,M1,S860,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S861(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X15,S861, 1.000)
       deallocate(S861)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N0+1:M1))
       call reorder2431(N0,M1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,N0,M1,S736,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S737(N2+1:M2,N0+1:M1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,N0,M1,X2,S737, 1.000)
       deallocate(S737)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,N0+1:M1))
       call reorder3214(N0,M1,N0,N2,N0,N1,N0,M1,
     & N0,N1,N0,N2,N0,M1,N0,M1,S857,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S859(N1+1:M2,N0+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,N0,M1,X14,S859,-1.000)
       deallocate(S859)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,N0+1:M1))
       call reorder2314(N0,M1,N0,N2,N0,N1,N0,M1,
     & N0,N2,N0,N1,N0,M1,N0,M1,S857,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S865(N2+1:M2,N0+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,N0,M1,X2,S865,-1.000)
       deallocate(S865)
C
       allocate(D1(N1+1:N3,N0+1:N2,N0+1:N1,N2+1:N3))
       call reorder2341(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N0,N2,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S734(M1+1:N1,N0+1:N2,N0+1:N1,N2+1:N3))
       I1=K4*K1*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N2,N3,N0,N2,M1,N1,S734,D1)
       allocate(D2(N0+1:N1,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S743(N1+1:M2,N0+1:M1,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,M1,N1,X10,S743,-1.000)
       deallocate(S743)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,M1,N1,S734,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S744(N1+1:M2,N0+1:M1,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,M1,N1,X9,S744,-1.000)
       deallocate(S744)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S734,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S735(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X1,S735, 1.000)
       deallocate(S735)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N2,N0,N1,N2,N3,
     & N2,N3,N0,N2,N0,N1,M1,N1,S734,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S850(N0+1:M1,N0+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder3214(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S850,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S851(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X9,S851,-1.000)
       deallocate(S851)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,M1,N1,S734,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S855(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,S855,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S856(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X12,S856, 1.000)
       deallocate(S856)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S734,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S745(N1+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N1,M2,N0,M1,M1,N1,X5,S745, 1.000)
       deallocate(S745)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S734,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S746(N1+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N1,M2,N0,M1,M1,N1,X6,S746, 1.000)
       deallocate(S746)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,M1,N1,S734,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S853(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,S853,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S854(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X11,S854, 1.000)
       deallocate(S854)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,M1,N1,S734,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S741(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X12,S741, 1.000)
       deallocate(S741)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,M1,N1,S734,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S742(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X11,S742, 1.000)
       deallocate(S742)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder3214(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S850,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S852(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X10,S852,-1.000)
       deallocate(S852)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S850,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X1,S864,-1.000)
       deallocate(S864)
C
     ...
     & N0,N2,N1,N3,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S767(N2+1:M2,M1+1:N1,N0+1:N1,N2+1:N3))
       I1=K4*K1
       I2=K7*K0
       I3=K3*K2
       call EGEMM(I1,I2,I3,D1,D2,S767)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder3412(N2,M2,M1,N1,N0,N1,N2,N3,
     & N0,N1,N2,N3,N2,M2,M1,N1,S767,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S771(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X12,S771, 1.000)
       deallocate(S771)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder4312(N2,M2,M1,N1,N0,N1,N2,N3,
     & N2,N3,N0,N1,N2,M2,M1,N1,S767,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S817(N0+1:M1,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,M1,N1,X1,S817,-1.000)
       deallocate(S817)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder3412(N2,M2,M1,N1,N0,N1,N2,N3,
     & N0,N1,N2,N3,N2,M2,M1,N1,S767,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S768(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X11,S768, 1.000)
       deallocate(S768)
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,N0,M1,t2B,D2)
       allocate(S765(N0+1:M1,N0+1:M1,N0+1:N2,N0+1:N1))
       I1=K1*K2
       I2=K5*K5
       I3=K3*K4
       call EGEMM(I1,I2,I3,D1,D2,S765)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,N0+1:M1))
       call reorder3412(N0,M1,N0,M1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N0,M1,N0,M1,S765,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S811(N2+1:M2,N0+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,N0,M1,X2,S811,-1.000)
       deallocate(S811)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,N0+1:M1))
       call reorder4312(N0,M1,N0,M1,N0,N2,N0,N1,
     & N0,N1,N0,N2,N0,M1,N0,M1,S765,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S766(N1+1:M2,N0+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,N0,M1,X13,S766,-1.000)
       deallocate(S766)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,N0+1:M1))
       call reorder4312(N0,M1,N0,M1,N0,N2,N0,N1,
     & N0,N1,N0,N2,N0,M1,N0,M1,S765,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S769(N1+1:M2,N0+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,N0,M1,X14,S769,-1.000)
       deallocate(S769)
C
     ...
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S775(N1+1:M2,M1+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K7*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N1,M2,M1,N1,S775,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S776(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,M1,N1,X7,S776, 1.000)
       deallocate(S776)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder4312(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N1,N0,N2,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S629(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,S629,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X11,S630, 1.000)
       deallocate(S630)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder4312(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N1,N0,N2,N2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S642(N1+1:M2,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N2,N3,N0,M1,
     & N0,N2,N2,N3,N1,M2,N0,M1,S642,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S643(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X15,S643, 1.000)
       deallocate(S643)
C
     ...
     & N2,N3,N0,N2,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S779(N0+1:M1,N0+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S779,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S780(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X3,S780,-1.000)
       deallocate(S780)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:N3,N1+1:M2))
       call reorder1324(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S781,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S782(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X4,S782,-1.000)
       deallocate(S782)
C
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S783(N0+1:M1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,N0,M1,S783,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S784(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X17,S784,-1.000)
       deallocate(S784)
C
...
C
       ...
       call reorder412356(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3A,F2)
       allocate(Z17(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z17, 1.000)
       deallocate(Z17)
       deallocate(X17)
C
     ...
     & N2,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S785(N0+1:M1,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,M1,N1,M2,N3,
     & N0,N2,M1,N1,M2,N3,N0,M1,S785,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S786(N2+1:M2,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,N0,M1,X18,S786,-1.000)
       deallocate(S786)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder512346(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3A,F2)
       allocate(Z18(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K7
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z18,-1.000)
       deallocate(Z18)
       deallocate(X18)
C
     ...
     & N2,N3,N0,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S787(N0+1:M1,N0+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N1,M2,N0,M1,S787,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,N0,M1,X19,S788,-1.000)
       deallocate(S788)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder412356(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & N0,M1,N1,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3A,F2)
       allocate(Z19(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K9*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z19, 1.000)
       deallocate(Z19)
       deallocate(X19)
C
     ...
     & N2,N3,N0,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S789(N0+1:M1,N0+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,N1,M2,N0,M1,S789,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S790(N2+1:M2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,N0,M1,X20,S790,-1.000)
       deallocate(S790)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder512346(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & M1,N1,N1,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3A,F2)
       allocate(Z20(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K9*K7
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z20,-1.000)
       deallocate(Z20)
       deallocate(X20)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S791(N0+1:M1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,N0,M1,S791,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S792(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X78,S792, 1.000)
       deallocate(S792)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,M1,M2,N3,N2,M2,N0,M1,X78,VCHPHP, 1.000)
C
       allocate(F2(N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z78(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z78,-1.000)
       deallocate(Z78)
       deallocate(X78)
C
     ...
     & N2,N3,N0,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S793(N0+1:M1,N0+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,M2,N3,N0,M1,S793,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S794(N2+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,M2,N3,N2,M2,N0,M1,X79,S794, 1.000)
       deallocate(S794)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & M1,N2,M2,N3,N2,M2,N0,M1,X79,VCHPHP, 1.000)
C
       allocate(F2(M1+1:N2,M2+1:N3,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z79(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K6*K8
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z79,-1.000)
       deallocate(Z79)
       deallocate(X79)
C
     ...
     & N2,N3,N0,N2,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S795(N0+1:M1,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,M1,N2,M2,
     & N0,N2,N0,M1,N2,M2,N0,M1,S795,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S796(N2+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,N0,M1,X80,S796, 1.000)
       deallocate(S796)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,M1,N2,M2,N2,M2,N0,M1,X80,VCHPHP, 1.000)
C
       allocate(F2(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z80(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K0*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z80,-1.000)
       deallocate(Z80)
       deallocate(X80)
C
     ...
     & N2,N3,N0,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S797(N0+1:M1,N0+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,N2,M2,N0,M1,S797,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S798(N2+1:M2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,N0,M1,X81,S798, 1.000)
       deallocate(S798)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & M1,N2,N2,M2,N2,M2,N0,M1,X81,VCHPHP, 1.000)
C
       allocate(F2(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z81(N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K5*K9*K9
       I3=K0*K8
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z81,-1.000)
       deallocate(Z81)
       deallocate(X81)
C
...
C
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z28(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K5*K9*K9*K0
       I3=K5
...
C
       call
     & sum123564(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z28,-1.000)
       deallocate(Z28)
       deallocate(X28)
C
...
C
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z29(N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K5*K9*K9*K0
       I3=K8
...
C
       call
     & sum123564(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z29,-1.000)
       deallocate(Z29)
       deallocate(X29)
C
...
C
       ...
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z30(N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K5*K5*K9*K9
       I3=K6
...
C
       call
     & sum234561(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z30, 1.000)
       deallocate(Z30)
       deallocate(X30)
C
...
C
       ...
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       allocate(Z31(N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K5*K5*K9*K9
       I3=K0
...
C
       call
     & sum234561(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z31, 1.000)
       deallocate(Z31)
       deallocate(X31)
C
     ...
     & N2,N3,N0,N2,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S799(N0+1:M1,N0+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,N1,N1,N3,N0,M1,S799,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S801(N2+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,N0,M1,X3,S801, 1.000)
       deallocate(S801)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,N0,M1,S799,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
...
C
     ...
     & N0,N1,N1,N3,N0,N2,N0,M1,S799,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S818(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,N0,M1,X13,S818, 1.000)
       deallocate(S818)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,N0,M1,S799,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S819(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,N0,M1,X14,S819, 1.000)
       deallocate(S819)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,N0+1:M1))
       call reorder3241(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N0,N2,N1,N3,N0,M1,S799,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S866(N1+1:M2,N0+1:N2,N1+1:N3,N0+1:M1))
       I1=K5*K3*K2
       I2=K9
       I3=K1
       call EGEMM(I1,I2,I3,D1,B2,S866)
       deallocate(D1)
       deallocate(B2)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N1,N3,N0,M1,
     & N0,N2,N1,N3,N1,M2,N0,M1,S866,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S867(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X3,S867, 1.000)
       deallocate(S867)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,N0+1:M1))
       call reorder3241(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N0,N2,N1,N3,N0,M1,S799,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S868(N1+1:M2,N0+1:N2,N1+1:N3,N0+1:M1))
       I1=K5*K3*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N1,N3,N0,M1,
     & N0,N2,N1,N3,N1,M2,N0,M1,S868,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S869(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X4,S869, 1.000)
       deallocate(S869)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N2,N0,N1,N1,N3,N0,M1,S799,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S800(N2+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,N0,M1,X4,S800, 1.000)
       deallocate(S800)
C
     ...
     & N0,N1,N2,N3,N0,N2,N1,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S804(N1+1:M2,N0+1:M1,N0+1:N2,N1+1:N3))
       I1=K3*K2
       I2=K5*K9
       I3=K4*K1
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S804,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S805(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X3,S805, 1.000)
       deallocate(S805)
C
...
C
     ...
     & N2,N3,N0,N2,Q87,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S770(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K4
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S770, 1.000)
       deallocate(S770)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q87,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S762(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S762)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S762, 1.000)
       deallocate(S762)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q87,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S764(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S764)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S764, 1.000)
       deallocate(S764)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q87,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S772(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S772)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S772, 1.000)
       deallocate(S772)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S812(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K3*K1
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S812,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S813(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X11,S813,-1.000)
       deallocate(S813)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N1,N3,N0,N1,Q96,B1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       allocate(S807(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K3
...
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X6,S807,-1.000)
       deallocate(S807)
C
...
C
     ...
     & N0,N1,N2,M2,N1,M2,N0,M1,t2B,D2)
       allocate(Z6(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K9
       I2=K5*K9*K0
       I3=K1
...
C
       call
     & sum124356(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z6, 1.000)
       deallocate(Z6)
       deallocate(X6)
C
       allocate(B1(N1+1:N3,N0+1:N1))
     ...
     & N1,N3,N0,N1,Q96,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S825(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S825)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X1,S825, 1.000)
       deallocate(S825)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q96,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S816(N2+1:M2,N0+1:M1,N0+1:M1,N0+1:N1))
       I1=K1
       I2=K5*K5*K0
       I3=K3
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X2,S816, 1.000)
       deallocate(S816)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q96,B1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       allocate(S806(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K9
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S806)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N1,M2,N0,M1,M1,N1,X5,S806,-1.000)
       deallocate(S806)
C
       call sumx2134(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,M2,N1,M2,N0,M1,t2B,D2)
       allocate(Z5(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K9
       I2=K5*K9*K0
       I3=K1
...
C
       call
     & sum134256(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z5,-1.000)
       deallocate(Z5)
       deallocate(X5)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S823(N1+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K9
       I3=K3*K1
...
C
     ...
     & N0,N2,N2,N3,N1,M2,N0,M1,S823,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S824(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X16,S824,-1.000)
       deallocate(S824)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N0+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,N2,N0,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S759(N0+1:M1,M1+1:N1,N0+1:N2,N0+1:N1))
       I1=K1*K2
       I2=K7*K5
       I3=K3*K4
...
C
     ...
     & N0,N1,N0,N2,N0,M1,M1,N1,S759,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S760(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X9,S760,-1.000)
       deallocate(S760)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder4312(N0,M1,M1,N1,N0,N2,N0,N1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S759,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S763(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X10,S763,-1.000)
       deallocate(S763)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder3412(N0,M1,M1,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S759,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S820(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X1,S820,-1.000)
       deallocate(S820)
C
...
C
     ...
     & N0,N1,N1,M2,N1,M2,N0,M1,t2A,D2)
       allocate(Z1(N1+1:M2,N1+1:M2,N0+1:M1,N2+1:M2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K0
       I2=K5*K9*K9
       I3=K1
...
C
       call
     & sum235146(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z1, 1.000)
       deallocate(Z1)
       deallocate(X1)
C
     ...
     & N2,N3,N0,N2,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S826(N0+1:M1,N0+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N2,N3,N0,N2,N0,M1,S826,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S830(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S830)
       deallocate(D1)
       deallocate(D2)
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X10,S830, 1.000)
       deallocate(S830)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,N0,N2,N0,M1,S826,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S827(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,N0,M1,X14,S827, 1.000)
       deallocate(S827)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
     ...
     & N0,N2,N2,N3,N0,N2,N0,M1,S826,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S828(N1+1:M2,N0+1:M1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K5*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,N0,M1,X13,S828,-1.000)
       deallocate(S828)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder2431(N0,M1,N0,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,N0,N2,N0,M1,S826,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S829(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X9,S829,-1.000)
       deallocate(S829)
C
...
C
     ...
     & N2,N3,N0,N2,Q97,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S836(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K4
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X10,S836, 1.000)
       deallocate(S836)
C
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       allocate(Z10(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K9
       I2=K5*K9*K0
       I3=K2
...
C
       call
     & sum125346(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z10,-1.000)
       deallocate(Z10)
       deallocate(X10)
C
       allocate(B1(N2+1:N3,N0+1:N2))
     ...
     & N2,N3,N0,N2,Q97,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S841(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S841)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X14,S841, 1.000)
       deallocate(S841)
C
       call sumx1234(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       allocate(Z14(N2+1:M2,N1+1:M2,M1+1:N1,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K9
       I2=K7*K9*K0
       I3=K2
...
C
       call
     & sum126345(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z14, 1.000)
       deallocate(Z14)
       deallocate(X14)
C
       allocate(B1(N2+1:N3,N0+1:N2))
     ...
     & N2,N3,N0,N2,Q97,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       allocate(S842(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S842)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X13,S842, 1.000)
       deallocate(S842)
C
       call sumx1234(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       allocate(Z13(N2+1:M2,N1+1:M2,M1+1:N1,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K9
       I2=K7*K9*K0
       I3=K2
...
C
       call
     & sum136245(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z13,-1.000)
       deallocate(Z13)
       deallocate(X13)
C
       allocate(B1(N2+1:N3,N0+1:N2))
     ...
     & N2,N3,N0,N2,Q97,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S835(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S835)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S835, 1.000)
       deallocate(S835)
C
       call sumx1234(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       allocate(Z9(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:M2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K9
       I2=K5*K9*K0
       I3=K2
...
C
       call
     & sum135246(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z9, 1.000)
       deallocate(Z9)
       deallocate(X9)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S837(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S837,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S838(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X11,S838, 1.000)
       deallocate(S838)
C
...
C
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       allocate(Z11(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K0
       I2=K5*K5*K9
       I3=K4
...
C
       call
     & sum345126(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z11,-1.000)
       deallocate(Z11)
       deallocate(X11)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S839(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S839,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S840(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X12,S840,-1.000)
       deallocate(S840)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder4231(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S729(N1+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K9
       I3=K3*K1
...
C
     ...
     & N0,N1,N1,N3,N1,M2,N0,M1,S729,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S730(N1+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,N0,M1,X8,S730,-1.000)
       deallocate(S730)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
     ...
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S731(N1+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K9
       I3=K3*K1
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder3412(N1,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N1,M2,N0,M1,S731,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S732(N1+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,N0,M1,X8,S732,-1.000)
       deallocate(S732)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3241(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S725(N1+1:M2,M1+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K7*K9
       I3=K3*K1
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N1,M2,M1,N1,S725,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S726(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,M1,N1,X7,S726,-1.000)
       deallocate(S726)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S753(N1+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder3412(N1,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N1,M2,N0,M1,S753,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S754(N1+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,N0,M1,X8,S754,-1.000)
       deallocate(S754)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S755(N1+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder3412(N1,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N1,M2,N0,M1,S755,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S756(N1+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,N0,M1,X8,S756, 1.000)
       deallocate(S756)
C
...
C
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(Z8(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K9
       I2=K7*K5*K0
       I3=K3
...
C
       call
     & sum146235(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z8,-1.000)
       deallocate(Z8)
       deallocate(X8)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,N2+1:N3))
     ...
     & N0,N2,N1,N3,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S757(N2+1:M2,N0+1:M1,N0+1:N1,N2+1:N3))
       I1=K4*K1
       I2=K5*K0
       I3=K3*K2
...
C
     ...
     & N0,N1,N2,N3,N2,M2,N0,M1,S757,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S761(N1+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,N0,M1,X16,S761, 1.000)
       deallocate(S761)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,N0+1:M1))
       call reorder4312(N2,M2,N0,M1,N0,N1,N2,N3,
     & N2,N3,N0,N1,N2,M2,N0,M1,S757,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S808(N0+1:M1,N0+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,N0,M1,X2,S808,-1.000)
       deallocate(S808)
C
       call sumx2134(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       allocate(Z2(N1+1:M2,N1+1:M2,M1+1:N1,N2+1:M2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K0
       I2=K7*K9*K9
       I3=K1
...
C
       call
     & sum236145(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z2,-1.000)
       deallocate(Z2)
       deallocate(X2)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,N0+1:M1))
     ...
     & N0,N1,N2,N3,N2,M2,N0,M1,S757,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S758(N1+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,N0,M1,X15,S758, 1.000)
       deallocate(S758)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S814(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K3*K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S814,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S815(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X12,S815,-1.000)
       deallocate(S815)
C
       call sumx2314(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       allocate(Z12(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K0
       I2=K5*K5*K9
       I3=K4
...
C
       call
     & sum245136(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z12, 1.000)
       deallocate(Z12)
       deallocate(X12)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S833(N1+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder3412(N1,M2,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,N0,M1,S833,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S834(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X15,S834, 1.000)
       deallocate(S834)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S738(N2+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K0
       I3=K4*K2
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,N0,M1,S738,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S740(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X4,S740,-1.000)
       deallocate(S740)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,N0,M1,S738,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S739(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X3,S739,-1.000)
       deallocate(S739)
C
...
C
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       allocate(Z3(N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K0
       I2=K7*K5*K9
       I3=K3
...
C
       call
     & sum356124(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z3, 1.000)
       deallocate(Z3)
       deallocate(X3)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,N0,M1,t2A,D2)
       allocate(S821(N1+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K9
       I3=K3*K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder3412(N1,M2,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,N0,M1,S821,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S822(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X15,S822,-1.000)
       deallocate(S822)
C
       call sumx2314(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(Z15(N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K0
       I2=K7*K5*K9
       I3=K4
...
C
       call
     & sum346125(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z15, 1.000)
       deallocate(Z15)
       deallocate(X15)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
     ...
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S773(N1+1:M2,M1+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K7*K9
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S773)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N1,M2,M1,N1,S773,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S774(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X7,S774,-1.000)
       deallocate(S774)
C
       call sumx2314(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       allocate(Z7(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K9
       I2=K5*K5*K0
       I3=K3
...
C
       call
     & sum145236(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z7, 1.000)
       deallocate(Z7)
       deallocate(X7)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S831(N1+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,N0+1:M1))
       call reorder3412(N1,M2,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,N0,M1,S831,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S832(N2+1:M2,N2+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,N0,M1,X16,S832,-1.000)
       deallocate(S832)
C
       call sumx2314(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(Z16(N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K0
       I2=K7*K5*K9
       I3=K4
...
C
       call
     & sum246135(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z16,-1.000)
       deallocate(Z16)
       deallocate(X16)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,N1+1:N3))
     ...
     & N0,N1,N2,N3,N0,N2,N1,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S802(N1+1:M2,N0+1:M1,N0+1:N2,N1+1:N3))
       I1=K3*K2
       I2=K5*K9
       I3=K4*K1
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder3412(N1,M2,N0,M1,N0,N2,N1,N3,
     & N0,N2,N1,N3,N1,M2,N0,M1,S802,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S803(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X4,S803, 1.000)
       deallocate(S803)
C
       call sumx2341(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       allocate(Z4(N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K0
       I2=K7*K5*K9
       I3=K3
...
C
       call
     & sum256134(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z4,-1.000)
       deallocate(Z4)
       deallocate(X4)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
     ...
     & M1,N2,M2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z82(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z82, 1.000)
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z82,-1.000)
       deallocate(Z82)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & M1,N2,N2,M2,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z83(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K5*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z83, 1.000)
       call
     & sum124536(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z83,-1.000)
       deallocate(Z83)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,M1,M2,N3,N1,M2,N0,M1,VBHPPH,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z84(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z84, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z84,-1.000)
       deallocate(Z84)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & M1,N2,M2,N3,N1,M2,N0,M1,VBHPPH,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z85(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z85,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z85, 1.000)
       deallocate(Z85)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,M1,N2,M2,N1,M2,N0,M1,VBHPPH,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z86(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z86, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z86,-1.000)
       deallocate(Z86)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & M1,N2,N2,M2,N1,M2,N0,M1,VBHPPH,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z87(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum134625(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z87,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,V3B,Z87, 1.000)
       deallocate(Z87)
C
       call sumx3(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,HT3B1,V3B,1.0)
       deallocate(V3B)
C
       end
