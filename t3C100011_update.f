...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S111)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S128)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z339)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X63,F2,Z89)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K0*K7
       call EGEMM(I1,I2,I3,X64,F2,Z88)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,Q56,B2,Q60)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,Q58,B2,Q61)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,M2,N3,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K6*K0
       I3=K0
       call EGEMM(I1,I2,I3,X74,F2,Z102)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S393)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S482)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K0
       I3=K2
       call EGEMM(I1,I2,I3,X77,D2,Z124)
       deallocate(D2)
C
       call
