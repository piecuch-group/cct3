...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call EGEMM(I1,I2,I3,X21,B2,Z48)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       ...
       I2=K5*K9*K0
       I3=K6*K8*K5
       call EGEMM(I1,I2,I3,X16,F2,Z32)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       ...
       I2=K5*K9*K0
       I3=K6*K8*K8
       call EGEMM(I1,I2,I3,X17,F2,Z33)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       ...
       I2=K5*K9*K0
       I3=K0*K8*K5
       call EGEMM(I1,I2,I3,X18,F2,Z34)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       ...
       I2=K5*K9*K0
       I3=K0*K8*K8
       call EGEMM(I1,I2,I3,X19,F2,Z35)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,X22,B2,Z90)
       deallocate(B2)
C
       V2B=V2B+Z90
       deallocate(Z90)
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9
       I3=K0*K0*K8
       call EGEMM(I1,I2,I3,X20,F2,Z38)
       deallocate(F2)
C
       call
