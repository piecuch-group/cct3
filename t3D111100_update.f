...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call EGEMM(I1,I2,I3,X45,D2,Z128)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N2,t2C,D2)
       ...
       I2=K8*K6*K6
       I3=K2
       call EGEMM(I1,I2,I3,X46,D2,Z132)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call EGEMM(I1,I2,I3,X47,D2,Z140)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X39,F2,Z102)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X40,F2,Z103)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U182)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       ...
       I2=K6*K6
       I3=K2*K2
       call EGEMM(I1,I2,I3,F1,D2,Z183)
       deallocate(F1)
       deallocate(D2)
C
       V3D=V3D+0.250*Z183
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,U224)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M1+1:N2))
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,Z225)
       deallocate(F1)
       deallocate(B2)
C
       V3D=V3D+0.500*Z225
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X37,F2,Z66)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X38,F2,Z67)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,Q42,B2,Q44)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N2,t2C,D2)
       ...
       I2=K8*K6*K6
       I3=K2
       call EGEMM(I1,I2,I3,X35,D2,Z37)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call EGEMM(I1,I2,I3,X34,D2,Z36)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call EGEMM(I1,I2,I3,X36,D2,Z38)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N2,t2C,D2)
       ...
       I2=K8*K6*K6
       I3=K2
       call EGEMM(I1,I2,I3,X41,D2,Z113)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call EGEMM(I1,I2,I3,X42,D2,Z114)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call EGEMM(I1,I2,I3,X44,D2,Z116)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,X43,D2,Z115)
       deallocate(D2)
C
       call
