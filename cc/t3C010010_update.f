...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U135)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,F1,B2,Z136)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U229)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K0*K6
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z281)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,N2,M2,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K0*K6
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z282)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S168)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S169)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S170)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S171)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S206)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S207)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z471)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z475)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z487)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z497)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z498)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U505)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call EGEMM(I1,I2,I3,F1,D2,Z506)
       deallocate(F1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,F1,B2,U664)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,X96,B2,Z230)
       deallocate(B2)
C
       V3C=V3C-Z230
       deallocate(Z230)
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X99,F2,Z277)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K9*K7
       call EGEMM(I1,I2,I3,X100,F2,Z278)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X101,F2,Z283)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X102,F2,Z284)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X103,F2,Z285)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X104,F2,Z286)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X97,F2,Z275)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X98,F2,Z276)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X79,F2,Z121)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X82,F2,Z124)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X80,F2,Z122)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K7
       call EGEMM(I1,I2,I3,X83,F2,Z125)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K0
       I3=K0*K7
       call EGEMM(I1,I2,I3,X81,F2,Z123)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K0*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X84,F2,Z126)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N2,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K0*K6
       I3=K9*K8
       call EGEMM(I1,I2,I3,X85,F2,Z127)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K0*K6
       I3=K8
       call EGEMM(I1,I2,I3,X86,F2,Z128)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K6*K6
       I3=K0
       call EGEMM(I1,I2,I3,X95,F2,Z145)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,M2,N3,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K6*K0
       I3=K0
       call EGEMM(I1,I2,I3,X94,F2,Z141)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K6*K0
       I3=K6
       call EGEMM(I1,I2,I3,X93,F2,Z140)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S573)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S576)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S579)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S605)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S595)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S602)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,Q84,B2,Q85)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,Q86,B2,Q88)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,Q86,B2,Q87)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N0,N1,N2,M2,M2,N3,t2B,D2)
       ...
       I2=K6*K0
       I3=K1*K2
       call EGEMM(I1,I2,I3,D1,D2,S684)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N1,N3,N2,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K0
       I3=K3*K2
       call EGEMM(I1,I2,I3,D1,D2,S606)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,N0+1:M1))
...
C
     ...
     & N0,N2,N0,N1,N2,M2,M2,N3,t2B,D2)
       ...
       I2=K6*K0
       I3=K1*K2
       call EGEMM(I1,I2,I3,D1,D2,S690)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S702)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S716)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S698)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S721)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S741)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S743)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S728)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X78,F2,Z120)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N2,N3,M2,N3,M1,N2,t2B,D2)
       ...
       I2=K8*K6
       I3=K4*K1
       call EGEMM(I1,I2,I3,D1,D2,S707)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N1+1:N3,M2+1:N3,M1+1:N2))
