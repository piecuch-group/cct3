...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3C2,F2)
       ...
       I2=K7*K5*K5*K9
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U112)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,Z113)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,M2,N3,N0,M1,N0,M1,M1,N1,t3C2,F2)
       ...
       I2=K7*K5*K5*K6*K6
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z122)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,U310)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N1+1:M2,N0+1:M1,N0+1:M1,M1+1:N1))
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,Z311)
       deallocate(F1)
       deallocate(B2)
C
       V3C=V3C+0.500*Z311
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3C2,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K9*K7
       call EGEMM(I1,I2,I3,X47,F2,Z120)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call EGEMM(I1,I2,I3,Q33,B2,Q34)
       deallocate(B2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X48,F2,Z123)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3C2,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X37,F2,Z53)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K0*K7
       call EGEMM(I1,I2,I3,X38,F2,Z54)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3C2,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X39,F2,Z55)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3C3,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K8
       call EGEMM(I1,I2,I3,X40,F2,Z56)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3C2,F2)
       ...
       I2=K7*K5*K5*K9*K6
       I3=K6
       call EGEMM(I1,I2,I3,X43,F2,Z62)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K9*K6
       I3=K0
       call EGEMM(I1,I2,I3,X44,F2,Z63)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K6
       I3=K2
       call EGEMM(I1,I2,I3,X45,D2,Z71)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S296)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S232)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,X46,D2,Z72)
       deallocate(D2)
C
       call
