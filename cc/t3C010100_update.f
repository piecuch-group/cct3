...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,Z175)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K5*K9
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U381)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       ...
       I2=K6*K6
       I3=K2*K2
       call EGEMM(I1,I2,I3,F1,D2,Z382)
       deallocate(F1)
       deallocate(D2)
C
       V3C=V3C+0.250*Z382
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,U483)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2,N0+1:M1))
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,Z484)
       deallocate(F1)
       deallocate(B2)
C
       V3C=V3C+0.500*Z484
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X70,F2,Z188)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C3,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X68,F2,Z183)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,t3C3,F2)
       ...
       I2=K8*K5*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X54,F2,Z83)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,t3C3,F2)
       ...
       I2=K8*K5*K9*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X55,F2,Z84)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3C3,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K9*K8
       call EGEMM(I1,I2,I3,X58,F2,Z87)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3C3,F2)
       ...
       I2=K5*K5*K9*K6*K6
       I3=K8
       call EGEMM(I1,I2,I3,X59,F2,Z88)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K6*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X60,F2,Z89)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K5*K9*K6
       I3=K6
       call EGEMM(I1,I2,I3,X64,F2,Z96)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S360)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S377)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S375)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S445)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,X66,D2,Z112)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X67,D2,Z114)
       deallocate(D2)
C
       call
