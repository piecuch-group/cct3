...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call EGEMM(I1,I2,I3,X103,D2,Z460)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X90,F2,Z239)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X91,F2,Z240)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X92,F2,Z241)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K7
       call EGEMM(I1,I2,I3,X93,F2,Z242)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X94,F2,Z247)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X95,F2,Z248)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X96,F2,Z249)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X97,F2,Z250)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,X102,D2,Z273)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,X98,D2,Z253)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S542)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S546)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S564)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,X100,D2,Z256)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X101,D2,Z264)
       deallocate(D2)
C
       call
