       subroutine t3C110111_update(N0,N1,N2,N3,HT3C1,shift,
...
C
       ...
       real*8,allocatable::Z592(:,:,:,:,:,:)
       real*8,allocatable::Z593(:,:,:,:,:,:)
       real*8,allocatable::Z594(:,:,:,:,:,:)
       real*8,allocatable::Z609(:,:,:,:,:,:)
       real*8,allocatable::Z610(:,:,:,:,:,:)
       real*8,allocatable::Z611(:,:,:,:,:,:)
       real*8,allocatable::Z612(:,:,:,:,:,:)
       real*8,allocatable::Z621(:,:,:,:,:,:)
       real*8,allocatable::Z622(:,:,:,:,:,:)
       real*8,allocatable::Z623(:,:,:,:,:,:)
       real*8,allocatable::Z624(:,:,:,:,:,:)
C
       allocate(V3C(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       V3C=0.0d0
C
...
C
       ...
       X13=0.0d0
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X13,S5,-1.000)
       deallocate(S5)
C
...
C
       ...
       X14=0.0d0
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X14,S6,-1.000)
       deallocate(S6)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X15(N2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1))
       X15=0.0d0
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X15,S7,-1.000)
C
       allocate(X16(N2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1))
       X16=0.0d0
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X16,S7,-1.000)
       deallocate(S7)
C
...
C
       call
     & sum4123(N0,N2,N1,M2,M1,N2,M1,N1,X13,S8, 1.000)
       deallocate(S8)
C
...
C
       call
     & sum4123(N0,N2,N1,M2,N0,M1,M1,N1,X14,S9, 1.000)
       deallocate(S9)
C
...
C
       call
     & sum4123(N2,N3,N2,M2,N1,M2,M1,N1,X15,S10, 1.000)
C
       call
     & sum4123(N2,N3,N2,M2,N1,M2,M1,N1,X16,S10, 1.000)
       deallocate(S10)
C
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z126(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z126,-1.000)
       deallocate(Z126)
       deallocate(S11)
C
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z127(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K7
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z127,-1.000)
       deallocate(Z127)
       deallocate(S12)
C
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z128(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K9*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z128,-1.000)
       deallocate(Z128)
       deallocate(S13)
C
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z129(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K9*K7
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z129,-1.000)
       deallocate(Z129)
       deallocate(S14)
C
...
C
     ...
     & N0,M1,M2,N3,N1,M2,M1,N1,S15,D1)
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z132(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z132,-1.000)
       deallocate(Z132)
       deallocate(S15)
C
...
C
     ...
     & M1,N1,M2,N3,N1,M2,M1,N1,S16,D1)
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z133(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K7
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z133,-1.000)
       deallocate(Z133)
       deallocate(S16)
C
...
C
     ...
     & N0,M1,N1,M2,N1,M2,M1,N1,S17,D1)
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z134(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K9*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z134,-1.000)
       deallocate(Z134)
       deallocate(S17)
C
...
C
     ...
     & M1,N1,N1,M2,N1,M2,M1,N1,S18,D1)
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z135(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K9*K7
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z135,-1.000)
       deallocate(Z135)
       deallocate(S18)
C
...
C
       allocate(X103(N0+1:M1,M2+1:N3,N2+1:M2,M1+1:N1))
       X103=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N2,M2,M1,N1,X103,S26, 1.000)
       deallocate(S26)
C
...
C
       allocate(X105(N0+1:M1,N2+1:M2,N2+1:M2,M1+1:N1))
       X105=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N2,M2,M1,N1,X105,S28, 1.000)
       deallocate(S28)
C
...
C
       allocate(X107(M1+1:N1,M2+1:N3,N2+1:M2,M1+1:N1))
       X107=0.0d0
       call
     & sum4123(M1,N1,M2,N3,N2,M2,M1,N1,X107,S27, 1.000)
       deallocate(S27)
C
...
C
       allocate(X109(M1+1:N1,N2+1:M2,N2+1:M2,M1+1:N1))
       X109=0.0d0
       call
     & sum4123(M1,N1,N2,M2,N2,M2,M1,N1,X109,S29, 1.000)
       deallocate(S29)
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S30(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K9
       I3=K1
...
C
       ...
       X110=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N2,X110,S30, 1.000)
       deallocate(S30)
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S31(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K9
       I3=K1
...
C
       ...
       X111=0.0d0
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N2,X111,S31, 1.000)
       deallocate(S31)
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S32(N1+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K9
       I3=K1
...
C
       ...
       X112=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X112,S32, 1.000)
       deallocate(S32)
C
     ...
     & N0,N1,M1,N2,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S33(N1+1:M2,M1+1:N2,N1+1:M2,M1+1:N2))
       I1=K8*K9*K8
       I2=K9
       I3=K1
...
C
       ...
       X113=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X113,S33, 1.000)
       deallocate(S33)
C
...
C
     ...
     & N0,N1,N0,M1,M2,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S34(N1+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X116(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:M1))
       X116=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X116,S34, 1.000)
       deallocate(S34)
C
     ...
     & N0,N1,M1,N2,M2,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S35(N1+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X117(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:M1))
       X117=0.0d0
       call
     & sum3124(M1,N2,M2,N3,N1,M2,N0,M1,X117,S35, 1.000)
       deallocate(S35)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X118(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:M1))
       X118=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X118,S36, 1.000)
       deallocate(S36)
C
     ...
     & N0,N1,M1,N2,N1,M2,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S37(N1+1:M2,M1+1:N2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K8
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X119(M1+1:N2,N1+1:M2,N1+1:M2,N0+1:M1))
       X119=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,N0,M1,X119,S37, 1.000)
       deallocate(S37)
C
...
C
     ...
     & N0,N1,M2,N3,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S38(N1+1:M2,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X72(M2+1:N3,M2+1:N3,N2+1:M2,N1+1:M2))
       X72=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N2,M2,N1,M2,X72,S38,-1.000)
C
       allocate(X76(M2+1:N3,M2+1:N3,N2+1:M2,N1+1:M2))
       X76=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N2,M2,N1,M2,X76,S38,-1.000)
       deallocate(S38)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X74(M2+1:N3,N1+1:M2,N2+1:M2,N1+1:M2))
       X74=0.0d0
       call
     & sum4123(M2,N3,N1,M2,N2,M2,N1,M2,X74,S40,-1.000)
C
       allocate(X78(M2+1:N3,N1+1:M2,N2+1:M2,N1+1:M2))
       X78=0.0d0
       call
     & sum4123(M2,N3,N1,M2,N2,M2,N1,M2,X78,S40,-1.000)
       deallocate(S40)
C
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X73(N2+1:M2,M2+1:N3,N2+1:M2,N1+1:M2))
       X73=0.0d0
       call
     & sum4123(N2,M2,M2,N3,N2,M2,N1,M2,X73,S39,-1.000)
C
       allocate(X77(N2+1:M2,M2+1:N3,N2+1:M2,N1+1:M2))
       X77=0.0d0
       call
     & sum4123(N2,M2,M2,N3,N2,M2,N1,M2,X77,S39,-1.000)
       deallocate(S39)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X75(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       X75=0.0d0
       call
     & sum4123(N2,M2,N1,M2,N2,M2,N1,M2,X75,S41,-1.000)
C
       allocate(X79(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       X79=0.0d0
       call
     & sum4123(N2,M2,N1,M2,N2,M2,N1,M2,X79,S41,-1.000)
       deallocate(S41)
C
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z177(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z177,-1.000)
       deallocate(Z177)
       deallocate(S42)
C
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z178(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K8
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z178, 1.000)
       deallocate(Z178)
       deallocate(S43)
C
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z179(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K0*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z179,-1.000)
       deallocate(Z179)
       deallocate(S44)
C
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z180(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K0*K8
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z180, 1.000)
       deallocate(Z180)
       deallocate(S45)
C
       allocate(D1(N1+1:N3,N0+1:M1,M2+1:N3,N1+1:M2))
...
C
     ...
     & N0,M1,M2,N3,N1,M2,M1,N1,S46,D1)
       ...
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z181(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z181, 1.000)
       deallocate(Z181)
       deallocate(S46)
C
...
C
     ...
     & M1,N2,M2,N3,N1,M2,M1,N1,S47,D1)
       ...
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z182(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K8
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z182,-1.000)
       deallocate(Z182)
       deallocate(S47)
C
...
C
     ...
     & N0,M1,N2,M2,N1,M2,M1,N1,S48,D1)
       ...
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z183(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K0*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z183, 1.000)
       deallocate(Z183)
       deallocate(S48)
C
...
C
     ...
     & M1,N2,N2,M2,N1,M2,M1,N1,S49,D1)
       ...
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z184(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K0*K8
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z184,-1.000)
       deallocate(Z184)
       deallocate(S49)
C
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,VBPHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S58(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X5,S58,-1.000)
       deallocate(S58)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder3241(N0,N2,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N1,M2,M1,N2,VBPHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S59(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X6,S59,-1.000)
       deallocate(S59)
C
     ...
     & N2,N3,N1,N3,N2,M2,N1,M2,VBAPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S60(M1+1:N2,N1+1:N3,N2+1:M2,N1+1:M2))
       I1=K9*K0*K3
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N1,N3,N2,M2,N1,M2,M1,N2,X5,S60, 1.000)
       deallocate(S60)
C
       allocate(D1(N2+1:N3,N1+1:N3,N2+1:M2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,N3,N1,N3,N2,M2,N1,M2,VBAPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S61(M1+1:N2,N1+1:N3,N2+1:M2,N1+1:M2))
       I1=K9*K0*K3
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N1,N3,N2,M2,N1,M2,M1,N2,X6,S61, 1.000)
       deallocate(S61)
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,VBPHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S62(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X7,S62,-1.000)
       deallocate(S62)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder3241(N0,N2,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N1,M2,N0,M1,VBPHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S63(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X8,S63,-1.000)
       deallocate(S63)
C
       allocate(D1(N2+1:N3,N1+1:N3,N2+1:M2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,N3,N1,N3,N2,M2,N1,M2,VBAPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S64(N0+1:M1,N1+1:N3,N2+1:M2,N1+1:M2))
       I1=K9*K0*K3
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N1,N3,N2,M2,N1,M2,N0,M1,X7,S64, 1.000)
       deallocate(S64)
C
       allocate(D1(N2+1:N3,N1+1:N3,N2+1:M2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,N3,N1,N3,N2,M2,N1,M2,VBAPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S65(N0+1:M1,N1+1:N3,N2+1:M2,N1+1:M2))
       I1=K9*K0*K3
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N1,N3,N2,M2,N1,M2,N0,M1,X8,S65, 1.000)
       deallocate(S65)
C
...
C
     ...
     & N2,N3,N0,N2,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S78(M1+1:N2,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X13,S78, 1.000)
       deallocate(S78)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3124(N0,N2,N1,N3,N2,N3,N0,N1,
     & N2,N3,N0,N2,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S79(N0+1:M1,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,M1,N1,X14,S79, 1.000)
       deallocate(S79)
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S80(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X15,S80,-1.000)
       deallocate(S80)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S81(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X16,S81,-1.000)
       deallocate(S81)
C
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z56(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum234516(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z56,-1.000)
       deallocate(Z56)
       deallocate(X56)
C
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z57(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum234516(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z57,-1.000)
       deallocate(Z57)
       deallocate(X57)
C
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z58(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum234516(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z58,-1.000)
       deallocate(Z58)
       deallocate(X58)
C
...
C
     ...
     & M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z59(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K0*K7
...
C
       call
     & sum234516(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z59,-1.000)
       deallocate(Z59)
       deallocate(X59)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N1))
...
C
       ...
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z60(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum134526(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z60, 1.000)
       deallocate(Z60)
       deallocate(X60)
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,M1+1:N1))
...
C
       ...
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z61(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum134526(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z61, 1.000)
       deallocate(Z61)
       deallocate(X61)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,M1+1:N1))
...
C
       ...
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z62(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum134526(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z62, 1.000)
       deallocate(Z62)
       deallocate(X62)
C
       allocate(D1(N0+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
...
C
       ...
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z63(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K0*K7
...
C
       call
     & sum134526(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z63, 1.000)
       deallocate(Z63)
       deallocate(X63)
C
...
C
     ...
     & N2,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S129(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K8
       I3=K4
...
C
       ...
       X64=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N1,M2,M1,N2,X64,S129, 1.000)
       deallocate(S129)
C
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z64(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K5*K0*K0
       I3=K6*K5
...
C
       call
     & sum124635(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z64, 1.000)
       deallocate(Z64)
       deallocate(X64)
C
     ...
     & N2,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S130(M1+1:N2,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K8
       I3=K4
...
C
       ...
       X65=0.0d0
       call
     & sum4123(M1,N2,M2,N3,N1,M2,M1,N2,X65,S130, 1.000)
       deallocate(S130)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z65(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K5*K0*K0
       I3=K6*K8
...
C
       call
     & sum124635(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z65,-1.000)
       deallocate(Z65)
       deallocate(X65)
C
     ...
     & N2,N3,N0,M1,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S131(M1+1:N2,N0+1:M1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K5
       I2=K8
       I3=K4
...
C
       ...
       X66=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,M1,N2,X66,S131, 1.000)
       deallocate(S131)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z66(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K5*K0*K0
       I3=K9*K5
...
C
       call
     & sum124635(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z66, 1.000)
       deallocate(Z66)
       deallocate(X66)
C
     ...
     & N2,N3,M1,N2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S132(M1+1:N2,M1+1:N2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K8
       I2=K8
       I3=K4
...
C
       ...
       X67=0.0d0
       call
     & sum4123(M1,N2,N1,M2,N1,M2,M1,N2,X67,S132, 1.000)
       deallocate(S132)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
     ...
     & M1,N2,N1,M2,N2,M2,N2,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z67(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K5*K0*K0
       I3=K9*K8
...
C
       call
     & sum124635(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z67,-1.000)
       deallocate(Z67)
       deallocate(X67)
C
       allocate(D1(N2+1:N3,N0+1:M1,M2+1:N3,N1+1:M2))
     ...
     & N2,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S133(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K5
       I3=K4
...
C
       ...
       X68=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N1,M2,N0,M1,X68,S133, 1.000)
       deallocate(S133)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z68(N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K8*K0*K0
       I3=K6*K5
...
C
       call
     & sum125634(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z68,-1.000)
       deallocate(Z68)
       deallocate(X68)
C
       allocate(D1(N2+1:N3,M1+1:N2,M2+1:N3,N1+1:M2))
     ...
     & N2,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S134(N0+1:M1,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K5
       I3=K4
...
C
       ...
       X69=0.0d0
       call
     & sum4123(M1,N2,M2,N3,N1,M2,N0,M1,X69,S134, 1.000)
       deallocate(S134)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z69(N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K8*K0*K0
       I3=K6*K8
...
C
       call
     & sum125634(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z69,-1.000)
       deallocate(Z69)
       deallocate(X69)
C
       allocate(D1(N2+1:N3,N0+1:M1,N1+1:M2,N1+1:M2))
     ...
     & N2,N3,N0,M1,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S135(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K5
       I2=K5
       I3=K4
...
C
       ...
       X70=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,N0,M1,X70,S135, 1.000)
       deallocate(S135)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z70(N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K8*K0*K0
       I3=K9*K5
...
C
       call
     & sum125634(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z70,-1.000)
       deallocate(Z70)
       deallocate(X70)
C
       allocate(D1(N2+1:N3,M1+1:N2,N1+1:M2,N1+1:M2))
     ...
     & N2,N3,M1,N2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S136(N0+1:M1,M1+1:N2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K8
       I2=K5
       I3=K4
...
C
       ...
       X71=0.0d0
       call
     & sum4123(M1,N2,N1,M2,N1,M2,N0,M1,X71,S136, 1.000)
       deallocate(S136)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
     ...
     & M1,N2,N1,M2,N2,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z71(N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K8*K0*K0
       I3=K9*K8
...
C
       call
     & sum125634(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z71,-1.000)
       deallocate(Z71)
       deallocate(X71)
C
     ...
     & N0,N2,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S137(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X72,S137,-1.000)
       deallocate(S137)
C
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S138(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X73,S138,-1.000)
       deallocate(S138)
C
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S139(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X74,S139,-1.000)
       deallocate(S139)
C
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S140(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X75,S140,-1.000)
       deallocate(S140)
C
       allocate(D1(N0+1:N2,M2+1:N3,M2+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S141(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X76,S141,-1.000)
       deallocate(S141)
C
       allocate(D1(N0+1:N2,N2+1:M2,M2+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X77,S142,-1.000)
       deallocate(S142)
C
       allocate(D1(N0+1:N2,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X78,S143,-1.000)
       deallocate(S143)
C
       allocate(D1(N0+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X79,S144,-1.000)
       deallocate(S144)
C
...
C
     ...
     & N0,N2,M2,N3,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S183(N2+1:M2,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6*K6
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X99(M2+1:N3,M2+1:N3,N2+1:M2,N2+1:M2))
       X99=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N2,M2,N2,M2,X99,S183,-1.000)
       deallocate(S183)
C
     ...
     & N0,N2,M2,N3,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S184(N2+1:M2,M2+1:N3,N2+1:M2,N2+1:M2))
       I1=K0*K0*K6
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X100(M2+1:N3,N2+1:M2,N2+1:M2,N2+1:M2))
       X100=0.0d0
       call
     & sum4123(M2,N3,N2,M2,N2,M2,N2,M2,X100,S184,-1.000)
       deallocate(S184)
C
     ...
     & N0,N2,N2,M2,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S185(N2+1:M2,N2+1:M2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K0
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X101(N2+1:M2,N2+1:M2,N2+1:M2,N2+1:M2))
       X101=0.0d0
       call
     & sum4123(N2,M2,N2,M2,N2,M2,N2,M2,X101,S185,-1.000)
       deallocate(S185)
C
...
C
     ...
     & N0,N2,M2,N3,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S186(N2+1:M2,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N2,M2,X99,S186, 1.000)
       deallocate(S186)
C
       allocate(D1(N0+1:N2,M2+1:N3,N2+1:M2,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,M2,N3,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S187(N2+1:M2,M2+1:N3,N2+1:M2,N2+1:M2))
       I1=K0*K0*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N2,M2,N2,M2,N2,M2,X100,S187, 1.000)
       deallocate(S187)
C
       allocate(D1(N0+1:N2,N2+1:M2,N2+1:M2,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,M2,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S188(N2+1:M2,N2+1:M2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N2,M2,N2,M2,N2,M2,X101,S188, 1.000)
       deallocate(S188)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S189(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X13,S189, 1.000)
       deallocate(S189)
C
     ...
     & N0,N1,N1,N3,N0,N2,N0,M1,VBHHPH,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S190(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X14,S190, 1.000)
       deallocate(S190)
C
     ...
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S191(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X15,S191, 1.000)
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X16,S191, 1.000)
       deallocate(S191)
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       ...
       deallocate(D2)
C
       allocate(X126(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N1))
       X126=0.0d0
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X126,S192, 1.000)
       deallocate(S192)
C
     ...
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S193(N1+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X127(M1+1:N1,M2+1:N3,N1+1:M2,M1+1:N1))
       X127=0.0d0
       call
     & sum3412(M1,N1,M2,N3,N1,M2,M1,N1,X127,S193, 1.000)
       deallocate(S193)
C
     ...
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S194(N1+1:M2,M1+1:N1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K7*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X128(N0+1:M1,N1+1:M2,N1+1:M2,M1+1:N1))
       X128=0.0d0
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N1,X128,S194, 1.000)
       deallocate(S194)
C
     ...
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S195(N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K7*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X129(M1+1:N1,N1+1:M2,N1+1:M2,M1+1:N1))
       X129=0.0d0
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X129,S195, 1.000)
       deallocate(S195)
C
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z354(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K8*K5*K0*K0
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z354)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sum124563(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z354, 0.500)
       deallocate(Z354)
       deallocate(Q37)
C
...
C
     ...
     & N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z355(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K8*K5*K0*K0
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z355)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sum124563(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z355, 0.500)
       deallocate(Z355)
       deallocate(Q38)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       ...
       deallocate(D2)
C
       allocate(X130(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N1))
       X130=0.0d0
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X130,S196, 1.000)
       deallocate(S196)
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       ...
       deallocate(D2)
C
       allocate(X131(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       X131=0.0d0
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N1,X131,S197, 1.000)
       deallocate(S197)
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       ...
       deallocate(D2)
C
       allocate(X132(N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
       X132=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X132,S198, 1.000)
       deallocate(S198)
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       ...
       deallocate(D2)
C
       allocate(X133(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       X133=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X133,S199, 1.000)
       deallocate(S199)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S200, 1.000)
       deallocate(S200)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S201, 1.000)
       deallocate(S201)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S202, 1.000)
       deallocate(S202)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S203, 1.000)
       deallocate(S203)
C
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X4,S204, 1.000)
       deallocate(S204)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,VAHHHP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S206(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X3,S206, 1.000)
       deallocate(S206)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X2,S207, 1.000)
       deallocate(S207)
C
     ...
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S208(N2+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,N0,M1,X8,S208,-1.000)
       deallocate(S208)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S209(N2+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,N0,M1,X7,S209,-1.000)
       deallocate(S209)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S210(N2+1:M2,M1+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,M1,N2,X6,S210,-1.000)
       deallocate(S210)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S211(N2+1:M2,M1+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,M1,N2,X5,S211,-1.000)
       deallocate(S211)
C
     ...
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S212(N2+1:M2,N1+1:M2,N1+1:N3,M1+1:N2))
       I1=K8*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,M1,N2,X6,S212, 1.000)
       deallocate(S212)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N1,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S213(N2+1:M2,N1+1:M2,N1+1:N3,M1+1:N2))
       I1=K8*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,M1,N2,X5,S213, 1.000)
       deallocate(S213)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X10,S214, 1.000)
       deallocate(S214)
C
...
C
       call
     & sum2413(N0,N1,N2,M2,M1,N2,M1,N1,X1,S215,-1.000)
       deallocate(S215)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,M1,N2,VBHHPH,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S216(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X9,S216, 1.000)
       deallocate(S216)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,M1+1:N2))
       call reorder3241(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N0,N1,M1,N2,VBHHPH,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S217(N2+1:M2,M1+1:N1,N0+1:N1,M1+1:N2))
       I1=K8*K1
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum2413(N0,N1,N2,M2,M1,N2,M1,N1,X2,S217,-1.000)
       deallocate(S217)
C
     ...
     & N0,N2,N0,N1,N1,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S218(N2+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,N0,M1,X8,S218, 1.000)
       deallocate(S218)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,N0+1:M1))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N1,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S219(N2+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,N0,M1,X7,S219, 1.000)
       deallocate(S219)
C
     ...
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S220(N1+1:M2,N0+1:M1,N1+1:N3,N2+1:M2))
       I1=K0*K3
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(N1,N3,N2,M2,N1,M2,N0,M1,X7,S220,-1.000)
       deallocate(S220)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S221(N2+1:M2,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N2,M2,N0,M1,X12,S221, 1.000)
       deallocate(S221)
C
     ...
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S222(M1+1:N2,M1+1:N1,N0+1:N1,N2+1:M2))
       I1=K0*K1
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,N1,N2,M2,M1,N2,M1,N1,X1,S222, 1.000)
       deallocate(S222)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N2,N3,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S223(N1+1:M2,N0+1:M1,N1+1:N3,N2+1:M2))
       I1=K0*K3
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(N1,N3,N2,M2,N1,M2,N0,M1,X8,S223,-1.000)
       deallocate(S223)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S224(N2+1:M2,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2413(N2,N3,N2,M2,N2,M2,N0,M1,X12,S224,-1.000)
       deallocate(S224)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N1,N2+1:M2))
       call reorder1243(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N1,N3,N0,N1,N2,M2,VBHPPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S225(M1+1:N2,M1+1:N1,N0+1:N1,N2+1:M2))
       I1=K0*K1
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,N1,N2,M2,M1,N2,M1,N1,X2,S225, 1.000)
       deallocate(S225)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X10,S226,-1.000)
       deallocate(S226)
C
...
C
       call
     & sum2413(N0,N1,N2,M2,N0,M1,M1,N1,X3,S227,-1.000)
       deallocate(S227)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N0,M1,VBHHPH,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S228(N2+1:M2,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X9,S228,-1.000)
       deallocate(S228)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,N0+1:M1))
       call reorder3241(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N0,N1,N0,M1,VBHHPH,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S229(N2+1:M2,M1+1:N1,N0+1:N1,N0+1:M1))
       I1=K5*K1
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum2413(N0,N1,N2,M2,N0,M1,M1,N1,X4,S229,-1.000)
       deallocate(S229)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     ...
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S230(N1+1:M2,M1+1:N2,N1+1:N3,N2+1:M2))
       I1=K0*K3
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N1,N3,N2,M2,N1,M2,M1,N2,X5,S230,-1.000)
       deallocate(S230)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S231(N2+1:M2,M1+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N2,M2,M1,N2,X11,S231, 1.000)
       deallocate(S231)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N1,N2+1:M2))
       call reorder1243(N2,N3,N1,N3,N2,N3,N0,N1,
     ...
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S232(N0+1:M1,M1+1:N1,N0+1:N1,N2+1:M2))
       I1=K0*K1
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N1,N2,M2,N0,M1,M1,N1,X3,S232, 1.000)
       deallocate(S232)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N2,N3,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S233(N1+1:M2,M1+1:N2,N1+1:N3,N2+1:M2))
       I1=K0*K3
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N1,N3,N2,M2,N1,M2,M1,N2,X6,S233,-1.000)
       deallocate(S233)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S234(N2+1:M2,M1+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2413(N2,N3,N2,M2,N2,M2,M1,N2,X11,S234,-1.000)
       deallocate(S234)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N1,N2+1:M2))
       call reorder1243(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N1,N3,N0,N1,N2,M2,VBHPPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S235(N0+1:M1,M1+1:N1,N0+1:N1,N2+1:M2))
       I1=K0*K1
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N1,N2,M2,N0,M1,M1,N1,X4,S235, 1.000)
       deallocate(S235)
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S236(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K4
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S236, 1.000)
       deallocate(S236)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S237(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K4
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S237, 1.000)
       deallocate(S237)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(S238(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S238)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S238,-1.000)
       deallocate(S238)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,N2,FBHP,B1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(S239(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S239)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S239,-1.000)
       deallocate(S239)
C
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S240(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X4,S240, 1.000)
       deallocate(S240)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S241(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X3,S241, 1.000)
       deallocate(S241)
C
     ...
     & N0,N1,N2,N3,N0,N2,M1,N1,VBHHHP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S242(N1+1:M2,M1+1:N2,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X13,S242,-1.000)
       deallocate(S242)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S243(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X2,S243, 1.000)
       deallocate(S243)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S244(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S244, 1.000)
       deallocate(S244)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder4132(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N1,N2,N3,N0,N2,M1,N1,VBHHHP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S245(N1+1:M2,N0+1:M1,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,M1,N1,X14,S245,-1.000)
       deallocate(S245)
C
     ...
     & N0,N2,N0,N1,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S246(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X15,S246, 1.000)
       deallocate(S246)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S247(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X16,S247, 1.000)
       deallocate(S247)
C
     ...
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S248(N2+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,N0,M1,X8,S248, 1.000)
       deallocate(S248)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S249(N2+1:M2,N0+1:M1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,N0,M1,X7,S249, 1.000)
       deallocate(S249)
C
     ...
     & N2,N3,N1,N3,N0,N2,N1,M2,VBPHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S250(M1+1:N2,M1+1:N1,N0+1:N2,N1+1:M2))
       I1=K9*K2
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,N2,N1,M2,M1,N2,M1,N1,X13,S250, 1.000)
       deallocate(S250)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S251(N2+1:M2,M1+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,M1,N2,X6,S251, 1.000)
       deallocate(S251)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S252(N2+1:M2,M1+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,M1,N2,X5,S252, 1.000)
       deallocate(S252)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N0,N2,N1,N3,
     & N2,N3,N1,N3,N0,N2,N1,M2,VBPHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S253(N0+1:M1,M1+1:N1,N0+1:N2,N1+1:M2))
       I1=K9*K2
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,N2,N1,M2,N0,M1,M1,N1,X14,S253, 1.000)
       deallocate(S253)
C
     ...
     & N0,N2,N1,N3,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S254(N2+1:M2,M1+1:N1,N2+1:N3,N1+1:M2))
       I1=K9*K4
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum2413(N2,N3,N2,M2,N1,M2,M1,N1,X15,S254,-1.000)
       deallocate(S254)
C
       allocate(D1(N0+1:N2,N1+1:N3,N2+1:N3,N1+1:M2))
       call reorder3214(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S255(N2+1:M2,M1+1:N1,N2+1:N3,N1+1:M2))
       I1=K9*K4
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum2413(N2,N3,N2,M2,N1,M2,M1,N1,X16,S255,-1.000)
       deallocate(S255)
C
     ...
     & N0,N2,N0,N2,N2,M2,N2,M2,t2C,D2)
       allocate(S256(N2+1:M2,N2+1:M2,N2+1:N3,M1+1:N2))
       I1=K8*K4
       I2=K0*K0
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N2,M2,M1,N2,X11,S256, 0.500)
       deallocate(S256)
C
     ...
     & N0,N2,N2,N3,N0,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S257(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X10,S257, 1.000)
       deallocate(S257)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S258(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X9,S258, 1.000)
       deallocate(S258)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S259(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X13,S259,-1.000)
       deallocate(S259)
C
     ...
     & N0,N2,N0,N2,N2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N2,M2,t2C,D2)
       allocate(S260(N2+1:M2,N2+1:M2,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K0*K0
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N2,M2,N0,M1,X12,S260, 0.500)
       deallocate(S260)
C
     ...
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S261(N2+1:M2,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,N2,M2,N2,M2,N0,M1,X12,S261,-1.000)
       deallocate(S261)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S262(N2+1:M2,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2413(N2,N3,N2,M2,N2,M2,N0,M1,X12,S262, 1.000)
       deallocate(S262)
C
     ...
     & N0,N2,N2,N3,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S263(N2+1:M2,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X10,S263,-1.000)
       deallocate(S263)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S264(N2+1:M2,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X9,S264,-1.000)
       deallocate(S264)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder4132(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S265(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X14,S265,-1.000)
       deallocate(S265)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S266(N2+1:M2,M1+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,N2,M2,N2,M2,M1,N2,X11,S266,-1.000)
       deallocate(S266)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S267(N2+1:M2,M1+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2413(N2,N3,N2,M2,N2,M2,M1,N2,X11,S267, 1.000)
       deallocate(S267)
C
...
C
       call
     & sum3412(N0,N2,N2,M2,N0,M1,M1,N2,X9,S268, 0.500)
       deallocate(S268)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
     ...
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S269(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X15,S269, 1.000)
       deallocate(S269)
C
       allocate(D1(N2+1:N3,N2+1:N3,N0+1:N2,N2+1:M2))
       call reorder1243(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,N2,N3,N0,N2,N2,M2,VCHPPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S270(N0+1:M1,M1+1:N2,N0+1:N2,N2+1:M2))
       I1=K0*K2
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(N0,N2,N2,M2,N0,M1,M1,N2,X10,S270, 0.500)
       deallocate(S270)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S271(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X16,S271, 1.000)
       deallocate(S271)
C
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S272(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S272, 1.000)
       deallocate(S272)
C
     ...
     & M1,N1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S273(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S273, 0.500)
       deallocate(S273)
C
     ...
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S274(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S274, 1.000)
       deallocate(S274)
C
     ...
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S275(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S275, 0.500)
       deallocate(S275)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,M1,N1,M2,N3,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S276(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S276, 1.000)
       deallocate(S276)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     & M1,N1,M1,N1,M2,N3,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S277(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S277, 0.500)
       deallocate(S277)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,M1,N1,N1,M2,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S278(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S278, 1.000)
       deallocate(S278)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     & M1,N1,M1,N1,N1,M2,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(S279(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S279, 0.500)
       deallocate(S279)
C
     ...
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(S280(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K5*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S280, 0.500)
       deallocate(S280)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S281(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S281, 1.000)
       deallocate(S281)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & M1,N1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S282(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S282, 0.500)
       deallocate(S282)
C
     ...
     & N0,M1,N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(S283(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K9*K5*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S283, 0.500)
       deallocate(S283)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S284(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S284, 1.000)
       deallocate(S284)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S285(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S285, 0.500)
       deallocate(S285)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,N0,M1,M2,N3,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(S286(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K5*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S286, 0.500)
       deallocate(S286)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S287, 1.000)
       deallocate(S287)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S288, 0.500)
       deallocate(S288)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S289, 0.500)
       deallocate(S289)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S290, 1.000)
       deallocate(S290)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S291, 0.500)
       deallocate(S291)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S292, 0.500)
       deallocate(S292)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S293, 0.500)
       deallocate(S293)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S294, 1.000)
       deallocate(S294)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S295, 1.000)
       deallocate(S295)
C
     ...
     & N0,M1,N1,M2,N1,M2,N2,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S296(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K9*K9*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S296, 0.500)
       deallocate(S296)
C
     ...
     & M1,N1,N1,M2,N1,M2,N2,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S297(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K9*K9*K7
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S297, 0.500)
       deallocate(S297)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S298(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X17,S298, 1.000)
       deallocate(S298)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S299(N2+1:M2,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X18,S299, 1.000)
       deallocate(S299)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S300(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X19,S300, 1.000)
       deallocate(S300)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S301(N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X20,S301, 1.000)
       deallocate(S301)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S302, 0.500)
       deallocate(S302)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S303, 0.500)
       deallocate(S303)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S304, 1.000)
       deallocate(S304)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S305, 1.000)
       deallocate(S305)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S306, 0.500)
       deallocate(S306)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S307, 0.500)
       deallocate(S307)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S308(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X21,S308, 1.000)
       deallocate(S308)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S309(N2+1:M2,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X22,S309, 1.000)
       deallocate(S309)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S310(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X23,S310, 1.000)
       deallocate(S310)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S311(N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X24,S311, 1.000)
       deallocate(S311)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S312, 0.500)
       deallocate(S312)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S313, 0.500)
       deallocate(S313)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S314, 1.000)
       deallocate(S314)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S315, 1.000)
       deallocate(S315)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S316, 0.500)
       deallocate(S316)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S317, 0.500)
       deallocate(S317)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X25,S318, 1.000)
       deallocate(S318)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S319(N2+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,N0,M1,X26,S319, 1.000)
       deallocate(S319)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S320(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,N0,M1,X27,S320, 1.000)
       deallocate(S320)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S321(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,N0,M1,X28,S321, 1.000)
       deallocate(S321)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S322, 0.500)
       deallocate(S322)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S323, 0.500)
       deallocate(S323)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S326, 0.500)
       deallocate(S326)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S327, 0.500)
       deallocate(S327)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S328(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X29,S328, 1.000)
       deallocate(S328)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S329(N2+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,N0,M1,X30,S329, 1.000)
       deallocate(S329)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S330(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,N0,M1,X31,S330, 1.000)
       deallocate(S330)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S331(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,N0,M1,X32,S331, 1.000)
       deallocate(S331)
C
     ...
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S332(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K5*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S332, 1.000)
       deallocate(S332)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3C4,F2)
       allocate(S333(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S333,-1.000)
       deallocate(S333)
C
     ...
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S334(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S334, 1.000)
       deallocate(S334)
C
     ...
     & M1,N2,N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S335(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K0*K5*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S335, 1.000)
       deallocate(S335)
C
     ...
     & N0,M1,M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,t3C4,F2)
       allocate(S336(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K0*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S336,-1.000)
       deallocate(S336)
C
     ...
     & M1,N2,M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S337(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K0*K7*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X8,S337, 1.000)
       deallocate(S337)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N0,M1,M2,N3,N1,N3,VBHHPP,D1)
       ...
       call reorder561234(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S338(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K5*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S338, 1.000)
       deallocate(S338)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M1,N1,M2,N3,N1,N3,VBHHPP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3C4,F2)
       allocate(S339(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S339,-1.000)
       deallocate(S339)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M1,N1,M2,N3,N1,N3,VBHHPP,D1)
       ...
       call reorder561234(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(S340(N2+1:M2,N1+1:M2,N0+1:M1,N1+1:N3))
       I1=K3
       I2=K5*K9*K0
       I3=K6*K7*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S340, 1.000)
       deallocate(S340)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S341, 1.000)
       deallocate(S341)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S342,-1.000)
       deallocate(S342)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,N0,M1,X7,S343, 1.000)
       deallocate(S343)
C
...
C
     ...
     & N0,M1,M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,t3C4,F2)
       allocate(S348(N2+1:M2,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,N0,M1,X12,S348,-1.000)
       deallocate(S348)
C
     ...
     & M1,N2,M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,t3C1,F2)
       allocate(S349(N2+1:M2,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K0
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,N0,M1,X12,S349, 1.000)
       deallocate(S349)
C
     ...
     & N2,N3,N1,N3,M1,N2,N0,M1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S350(M1+1:N2,M1+1:N1,M1+1:N2,N0+1:M1))
       I1=K5*K8
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,N0,M1,M1,N2,M1,N1,X49,S350, 1.000)
       deallocate(S350)
C
     ...
     & N2,N3,N1,N3,N0,M1,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S351(M1+1:N2,M1+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,M1,M1,N1,M1,N2,M1,N1,X50,S351, 1.000)
       deallocate(S351)
C
     ...
     & N2,N3,N1,N3,M1,N2,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S352(M1+1:N2,M1+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,M1,N1,M1,N2,M1,N1,X51,S352, 1.000)
       deallocate(S352)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S353(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K5*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S353,-1.000)
       deallocate(S353)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S354(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K5*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S354,-1.000)
       deallocate(S354)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S355(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S355,-1.000)
       deallocate(S355)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S356(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K7*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S356,-1.000)
       deallocate(S356)
C
     ...
     & N0,M1,N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S357(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K0*K5*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S357,-1.000)
       deallocate(S357)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S358(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K0*K5*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S358,-1.000)
       deallocate(S358)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S359(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K0*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S359,-1.000)
       deallocate(S359)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S360(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K0*K7*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X6,S360,-1.000)
       deallocate(S360)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,N0,M1,M2,N3,N1,N3,VBHHPP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S361(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K5*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S361,-1.000)
       deallocate(S361)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S362,-1.000)
       deallocate(S362)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S363,-1.000)
       deallocate(S363)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S364,-1.000)
       deallocate(S364)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S365,-1.000)
       deallocate(S365)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S366,-1.000)
       deallocate(S366)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S367,-1.000)
       deallocate(S367)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X5,S368,-1.000)
       deallocate(S368)
C
...
C
     ...
     & N0,M1,M1,N1,N1,M2,N2,M2,N2,M2,M1,N2,t3C1,F2)
       allocate(S375(N2+1:M2,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X11,S375,-1.000)
       deallocate(S375)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,N1,M2,N2,M2,N2,M2,M1,N2,t3C1,F2)
       allocate(S376(N2+1:M2,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K0
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X11,S376,-1.000)
       deallocate(S376)
C
     ...
     & N2,N3,N1,N3,N0,M1,N0,M1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S377(N0+1:M1,M1+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,M1,N0,M1,N0,M1,M1,N1,X52,S377, 1.000)
       deallocate(S377)
C
       allocate(D1(N2+1:N3,N1+1:N3,M1+1:N2,N0+1:M1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,N0,M1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S378(N0+1:M1,M1+1:N1,M1+1:N2,N0+1:M1))
       I1=K5*K8
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,N0,M1,N0,M1,M1,N1,X53,S378, 1.000)
       deallocate(S378)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:M1,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S379(N0+1:M1,M1+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(N0,M1,M1,N1,N0,M1,M1,N1,X54,S379, 1.000)
       deallocate(S379)
C
       allocate(D1(N2+1:N3,N1+1:N3,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S380(N0+1:M1,M1+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K7*K5
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,M1,N1,N0,M1,M1,N1,X55,S380, 1.000)
       deallocate(S380)
C
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S387(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S387,-1.000)
       deallocate(S387)
C
     ...
     & M1,N1,N2,M2,N1,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S388(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K9*K0*K7
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S388,-1.000)
       deallocate(S388)
C
     ...
     & N0,N2,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S389(N2+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N1,X102,S389,-1.000)
       deallocate(S389)
C
     ...
     & N0,N2,N1,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S390(N2+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N1,X106,S390,-1.000)
       deallocate(S390)
C
     ...
     & N0,N2,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S391(N2+1:M2,M1+1:N1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N1,X104,S391,-1.000)
       deallocate(S391)
C
     ...
     & N0,N2,N1,N3,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S392(N2+1:M2,M1+1:N1,M1+1:N1,N2+1:M2))
       I1=K0*K7
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(M1,N1,N2,M2,N2,M2,M1,N1,X108,S392,-1.000)
       deallocate(S392)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S399,-1.000)
       deallocate(S399)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S400,-1.000)
       deallocate(S400)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S401(N2+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N1,X103,S401,-1.000)
       deallocate(S401)
C
       allocate(D1(N0+1:N2,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S402(N2+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N1,X107,S402,-1.000)
       deallocate(S402)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:M1,N2+1:M2))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S403(N2+1:M2,M1+1:N1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N1,X105,S403,-1.000)
       deallocate(S403)
C
       allocate(D1(N0+1:N2,N1+1:N3,M1+1:N1,N2+1:M2))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S404(N2+1:M2,M1+1:N1,M1+1:N1,N2+1:M2))
       I1=K0*K7
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(M1,N1,N2,M2,N2,M2,M1,N1,X109,S404,-1.000)
       deallocate(S404)
C
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S405(N1+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K9
       I3=K4*K2
...
C
       ...
       X45=0.0d0
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X45,S405,-1.000)
       deallocate(S405)
C
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z45(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z45,-1.000)
       deallocate(Z45)
       deallocate(X45)
C
     ...
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S406(N1+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K9
       I3=K4*K2
...
C
       ...
       X46=0.0d0
       call
     & sum3412(M1,N1,M2,N3,N1,M2,M1,N1,X46,S406,-1.000)
       deallocate(S406)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z46(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K7
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z46,-1.000)
       deallocate(Z46)
       deallocate(X46)
C
     ...
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S407(N1+1:M2,M1+1:N1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K7*K9
       I3=K4*K2
...
C
       ...
       X47=0.0d0
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N1,X47,S407,-1.000)
       deallocate(S407)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z47(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K9*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z47,-1.000)
       deallocate(Z47)
       deallocate(X47)
C
     ...
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S408(N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K7*K9
       I3=K4*K2
...
C
       ...
       X48=0.0d0
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X48,S408,-1.000)
       deallocate(S408)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z48(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K9*K7
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z48,-1.000)
       deallocate(Z48)
       deallocate(X48)
C
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(S415(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S415, 1.000)
       deallocate(S415)
C
...
C
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S417(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M1,N2,S417,D1)
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z579(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z579,-1.000)
       deallocate(Z579)
       deallocate(S417)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S418(N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M1,N2,S418,D1)
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z580(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z580)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z580, 1.000)
       deallocate(Z580)
       deallocate(S418)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S419(N2+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M1,N2,S419,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z581(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z581)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z581,-1.000)
       deallocate(Z581)
       deallocate(S419)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S420(N2+1:M2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M1,N2,S420,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z582(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z582)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z582, 1.000)
       deallocate(Z582)
       deallocate(S420)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(S427(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S427, 1.000)
       deallocate(S427)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder513246(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,N2,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(S428(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K9*K0*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S428,-1.000)
       deallocate(S428)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S429(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K3*K1
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,M1,M2,N3,
     & N0,M1,M2,N3,N2,M2,M1,N2,S429,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z591(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z591, 1.000)
       deallocate(Z591)
       deallocate(S429)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S430(N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K0
       I3=K3*K1
...
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,M1,N2,M2,N3,
     & M1,N2,M2,N3,N2,M2,M1,N2,S430,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z592(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z592)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z592,-1.000)
       deallocate(Z592)
       deallocate(S430)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S431(N2+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K0
       I3=K3*K1
...
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,M1,N2,M2,
     & N0,M1,N2,M2,N2,M2,M1,N2,S431,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z593(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z593)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z593, 1.000)
       deallocate(Z593)
       deallocate(S431)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S432(N2+1:M2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K0
       I3=K3*K1
...
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,M1,N2,N2,M2,
     & M1,N2,N2,M2,N2,M2,M1,N2,S432,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z594(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z594)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z594,-1.000)
       deallocate(Z594)
       deallocate(S432)
C
     ...
     & N0,N1,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S433(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N2,X110,S433, 1.000)
       deallocate(S433)
C
     ...
     & N0,N1,N2,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S434(N1+1:M2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N2,X111,S434, 1.000)
       deallocate(S434)
C
     ...
     & N0,N1,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S435(N1+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N2,X112,S435, 1.000)
       deallocate(S435)
C
     ...
     & N0,N1,N2,N3,M1,N2,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S436(N1+1:M2,M1+1:N2,M1+1:N2,N1+1:M2))
       I1=K9*K8
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,M1,N2,X113,S436, 1.000)
       deallocate(S436)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X114,Q41, 1.000)
       deallocate(Q41)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X115,Q42, 1.000)
       deallocate(Q42)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S445(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N0,M1,S445,D1)
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z609(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z609, 1.000)
       deallocate(Z609)
       deallocate(S445)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S446(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N0,M1,S446,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z610(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z610)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z610, 1.000)
       deallocate(Z610)
       deallocate(S446)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S447(N2+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N0,M1,S447,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z611(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z611)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z611, 1.000)
       deallocate(Z611)
       deallocate(S447)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S448(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N0,M1,S448,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z612(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z612)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z612, 1.000)
       deallocate(Z612)
       deallocate(S448)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N1,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(S455(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S455, 1.000)
       deallocate(S455)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(S456(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K9*K0*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S456, 1.000)
       deallocate(S456)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S457(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K3*K1
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,M1,M2,N3,
     & N0,M1,M2,N3,N2,M2,N0,M1,S457,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z621(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z621,-1.000)
       deallocate(Z621)
       deallocate(S457)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S458(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K0
       I3=K3*K1
...
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,M1,N2,M2,N3,
     & M1,N2,M2,N3,N2,M2,N0,M1,S458,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z622(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z622)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z622,-1.000)
       deallocate(Z622)
       deallocate(S458)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
...
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,M1,N2,M2,
     & N0,M1,N2,M2,N2,M2,N0,M1,S459,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z623(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z623)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z623,-1.000)
       deallocate(Z623)
       deallocate(S459)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
...
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,M1,N2,N2,M2,
     & M1,N2,N2,M2,N2,M2,N0,M1,S460,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z624(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z624)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z624,-1.000)
       deallocate(Z624)
       deallocate(S460)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N1,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S461(N1+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,N0,M1,X116,S461, 1.000)
       deallocate(S461)
C
       allocate(D1(N0+1:N1,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S462(N1+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,N0,M1,X117,S462, 1.000)
       deallocate(S462)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S463(N1+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,N0,M1,X118,S463, 1.000)
       deallocate(S463)
C
       allocate(D1(N0+1:N1,N2+1:N3,M1+1:N2,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,M1,N2,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S464(N1+1:M2,N0+1:M1,M1+1:N2,N1+1:M2))
       I1=K9*K8
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,N0,M1,X119,S464, 1.000)
       deallocate(S464)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N0+1:M1))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum21(N0,M1,N0,M1,X120,Q43, 1.000)
       deallocate(Q43)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum21(M1,N2,N0,M1,X121,Q44, 1.000)
       deallocate(Q44)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S465(N2+1:M2,N1+1:M2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,N1,M2,X72,S465, 1.000)
       deallocate(S465)
C
     ...
     & N0,N2,N0,N1,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S466(N2+1:M2,N1+1:M2,N2+1:M2,M2+1:N3))
       I1=K6*K0
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(N2,M2,M2,N3,N2,M2,N1,M2,X73,S466, 1.000)
       deallocate(S466)
C
     ...
     & N0,N2,N0,N1,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S467(N2+1:M2,N1+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(M2,N3,N1,M2,N2,M2,N1,M2,X74,S467, 1.000)
       deallocate(S467)
C
     ...
     & N0,N2,N0,N1,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S468(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(N2,M2,N1,M2,N2,M2,N1,M2,X75,S468, 1.000)
       deallocate(S468)
C
...
C
       call
     & sum21(M2,N3,N2,M2,X122,Q45,-1.000)
       deallocate(Q45)
C
...
C
       call
     & sum21(N2,M2,N2,M2,X124,Q46,-1.000)
       deallocate(Q46)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,M2,N3,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S469(N2+1:M2,N1+1:M2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,N1,M2,X76,S469, 1.000)
       deallocate(S469)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S470(N2+1:M2,N1+1:M2,N2+1:M2,M2+1:N3))
       I1=K6*K0
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(N2,M2,M2,N3,N2,M2,N1,M2,X77,S470, 1.000)
       deallocate(S470)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S471(N2+1:M2,N1+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(M2,N3,N1,M2,N2,M2,N1,M2,X78,S471, 1.000)
       deallocate(S471)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S472(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(N2,M2,N1,M2,N2,M2,N1,M2,X79,S472, 1.000)
       deallocate(S472)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum21(M2,N3,N2,M2,X123,Q47,-1.000)
       deallocate(Q47)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,N2+1:M2))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum21(N2,M2,N2,M2,X125,Q48,-1.000)
       deallocate(Q48)
C
...
C
       call
     & sum21(M2,N3,N1,M2,X35,Q49,-1.000)
       deallocate(Q49)
C
...
C
       call
     & sum21(N1,M2,N1,M2,X36,Q50,-1.000)
       deallocate(Q50)
C
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,t3D,F2)
       allocate(S475(N2+1:M2,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K0
       I3=K0*K8*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,N0,M1,X12,S475, 1.000)
       deallocate(S475)
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,t3D,F2)
       allocate(S476(N2+1:M2,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K0
       I3=K0*K8*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,N0,M1,X12,S476,-0.500)
       deallocate(S476)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X11,S478,-1.000)
       deallocate(S478)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X11,S479,-0.500)
       deallocate(S479)
C
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       allocate(S481(N2+1:M2,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K0
       I3=K0*K8*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X11,S481,-1.000)
       deallocate(S481)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       allocate(S482(N2+1:M2,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K0
       I3=K0*K8*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X11,S482,-0.500)
       deallocate(S482)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S483,-0.500)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S483,-0.500)
       deallocate(S483)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S485,-1.000)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S485,-1.000)
       deallocate(S485)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S487,-0.500)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S487,-0.500)
       deallocate(S487)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S484, 0.500)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S484, 0.500)
       deallocate(S484)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S486, 1.000)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S486, 1.000)
       deallocate(S486)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S488, 0.500)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S488, 0.500)
       deallocate(S488)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S489(N1+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X130,S489, 1.000)
       deallocate(S489)
C
     ...
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S490(N1+1:M2,M1+1:N1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N1,X131,S490, 1.000)
       deallocate(S490)
C
     ...
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S491(N1+1:M2,M1+1:N1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X132,S491, 1.000)
       deallocate(S491)
C
     ...
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S492(N1+1:M2,M1+1:N1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X133,S492, 1.000)
       deallocate(S492)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S493(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K5*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S493,-1.000)
       deallocate(S493)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S494(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K5*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S494,-1.000)
       deallocate(S494)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S495(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S495,-1.000)
       deallocate(S495)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S496(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S496,-1.000)
       deallocate(S496)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S497(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K5*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S497,-1.000)
       deallocate(S497)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S498(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K5*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S498,-1.000)
       deallocate(S498)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S501,-1.000)
       deallocate(S501)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S502,-1.000)
       deallocate(S502)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S503,-1.000)
       deallocate(S503)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S504,-1.000)
       deallocate(S504)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S505,-1.000)
       deallocate(S505)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S506,-1.000)
       deallocate(S506)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M1,N1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S507(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S507,-1.000)
       deallocate(S507)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M1,N1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M1,N1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S508(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S508,-1.000)
       deallocate(S508)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S509(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S509, 1.000)
       deallocate(S509)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S510(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K6*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S510, 1.000)
       deallocate(S510)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S511(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S511, 1.000)
       deallocate(S511)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S512(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S512, 1.000)
       deallocate(S512)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S513(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K9*K6*K5
       call EGEMM(I1,I2,I3,D1,F2,S513)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S513, 1.000)
       deallocate(S513)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(S514(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K9*K6*K7
       call EGEMM(I1,I2,I3,D1,F2,S514)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S514, 1.000)
       deallocate(S514)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9
       I3=K9*K0*K5
       call EGEMM(I1,I2,I3,D1,F2,S515)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9
       I3=K9*K0*K7
       call EGEMM(I1,I2,I3,D1,F2,S516)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X17,S517, 1.000)
       deallocate(S517)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X18,S518, 1.000)
       deallocate(S518)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X19,S519, 1.000)
       deallocate(S519)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X20,S520, 1.000)
       deallocate(S520)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S521(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X21,S521, 1.000)
       deallocate(S521)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S522(N2+1:M2,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X22,S522, 1.000)
       deallocate(S522)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S523(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X23,S523, 1.000)
       deallocate(S523)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S524(N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X24,S524, 1.000)
       deallocate(S524)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S525(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S525, 1.000)
       deallocate(S525)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S526(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K6*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S526, 1.000)
       deallocate(S526)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S527(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S527, 1.000)
       deallocate(S527)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S528(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S528, 1.000)
       deallocate(S528)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S529(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S529, 1.000)
       deallocate(S529)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S530(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S530, 1.000)
       deallocate(S530)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S533(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X25,S533, 1.000)
       deallocate(S533)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S534(N2+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,N0,M1,X26,S534, 1.000)
       deallocate(S534)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S535(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,N0,M1,X27,S535, 1.000)
       deallocate(S535)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S536(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,N0,M1,X28,S536, 1.000)
       deallocate(S536)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S537(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X29,S537, 1.000)
       deallocate(S537)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S538(N2+1:M2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,N0,M1,X30,S538, 1.000)
       deallocate(S538)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S539(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,N0,M1,X31,S539, 1.000)
       deallocate(S539)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S540(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,N0,M1,X32,S540, 1.000)
       deallocate(S540)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
     ...
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,t3C4,F2)
       allocate(S541(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K5*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S541, 0.500)
       deallocate(S541)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M1,N2,M2,N3,N2,M2,N1,M2,M1,N1,t3C1,F2)
       allocate(S542(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K8*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S542, 1.000)
       deallocate(S542)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M1,N2,M2,N3,N2,M2,N1,M2,M1,N1,t3C1,F2)
       allocate(S543(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K6*K8*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S543, 0.500)
       deallocate(S543)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,N0,M1,N2,M2,N2,M2,N1,M2,M1,N1,t3C4,F2)
       allocate(S544(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K0*K5*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S544, 0.500)
       deallocate(S544)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N1,M2,M1,N1,t3C1,F2)
       allocate(S545(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K0*K8*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S545, 1.000)
       deallocate(S545)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N1,M2,M1,N1,t3C1,F2)
       allocate(S546(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K0*K8*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X16,S546, 0.500)
       deallocate(S546)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,t3C4,F2)
       ...
       I2=K7*K9*K0
       I3=K6*K5*K5
       call EGEMM(I1,I2,I3,D1,F2,S547)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S547, 0.500)
       deallocate(S547)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S548, 1.000)
       deallocate(S548)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S549, 0.500)
       deallocate(S549)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S550, 0.500)
       deallocate(S550)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S551, 1.000)
       deallocate(S551)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X15,S552, 0.500)
       deallocate(S552)
C
     ...
     & N2,N3,N2,N3,N0,M1,N0,M1,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S553(N0+1:M1,M1+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(N0,M1,N0,M1,N0,M1,M1,N2,X80,S553, 0.500)
       deallocate(S553)
C
     ...
     & N2,N3,N2,N3,N0,M1,M1,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S554(N0+1:M1,M1+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(N0,M1,M1,N2,N0,M1,M1,N2,X81,S554, 0.500)
       deallocate(S554)
C
     ...
     & N2,N3,N2,N3,M1,N2,M1,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S555(N0+1:M1,M1+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(M1,N2,M1,N2,N0,M1,M1,N2,X82,S555, 0.500)
       deallocate(S555)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C2,F2)
       allocate(S556(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S556,-0.500)
       deallocate(S556)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C3,F2)
       allocate(S557(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S557, 0.500)
       deallocate(S557)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,M1,M2,N3,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(S558(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K0*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S558,-1.000)
       deallocate(S558)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,M2,N3,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(S559(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S559, 1.000)
       deallocate(S559)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,M1,N2,M2,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(S560(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K0*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S560,-0.500)
       deallocate(S560)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,N2,M2,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(S561(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K0*K0*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S561, 0.500)
       deallocate(S561)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S562(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X83,S562,-1.000)
       deallocate(S562)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S563(N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N2,M2,M1,N2,X84,S563,-1.000)
       deallocate(S563)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S564(N2+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N2,X85,S564,-1.000)
       deallocate(S564)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S565(N2+1:M2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,M1,N2,X86,S565,-1.000)
       deallocate(S565)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S566(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X87,S566,-1.000)
       deallocate(S566)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S567(N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N2,M2,M1,N2,X88,S567,-1.000)
       deallocate(S567)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S568(N2+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N2,X89,S568,-1.000)
       deallocate(S568)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S569(N2+1:M2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,M1,N2,X90,S569,-1.000)
       deallocate(S569)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S570,-0.500)
       deallocate(S570)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S571,-0.500)
       deallocate(S571)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9
       I3=K0*K6*K5
       call EGEMM(I1,I2,I3,D1,F2,S572)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S572,-1.000)
       deallocate(S572)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9
       I3=K0*K6*K8
       call EGEMM(I1,I2,I3,D1,F2,S573)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S573,-1.000)
       deallocate(S573)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9
       I3=K0*K0*K5
       call EGEMM(I1,I2,I3,D1,F2,S574)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S574,-0.500)
       deallocate(S574)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9
       I3=K0*K0*K8
       call EGEMM(I1,I2,I3,D1,F2,S575)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S575,-0.500)
       deallocate(S575)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S576(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X91,S576,-1.000)
       deallocate(S576)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S577(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N2,M2,N0,M1,X92,S577,-1.000)
       deallocate(S577)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S578(N2+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,N0,M1,X93,S578,-1.000)
       deallocate(S578)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S579(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,N0,M1,X94,S579,-1.000)
       deallocate(S579)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S580(N2+1:M2,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,N0,M1,X95,S580,-1.000)
       deallocate(S580)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S581(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N2,M2,N0,M1,X96,S581,-1.000)
       deallocate(S581)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S582(N2+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,N0,M1,X97,S582,-1.000)
       deallocate(S582)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S583(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,N0,M1,X98,S583,-1.000)
       deallocate(S583)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N0+1:M1))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
     ...
     & N0,N2,N0,N2,M2,N3,M2,N3,VCHHPP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N2,M2,t2C,D2)
       allocate(S584(N2+1:M2,N2+1:M2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K0*K0
       I3=K2*K2
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,N2,M2,X99,S584, 0.500)
       deallocate(S584)
C
     ...
     & N0,N2,N0,N2,M2,N3,N2,M2,VCHHPP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N2,M2,t2C,D2)
       allocate(S585(N2+1:M2,N2+1:M2,M2+1:N3,N2+1:M2))
       I1=K0*K6
       I2=K0*K0
       I3=K2*K2
...
C
       call
     & sum3412(M2,N3,N2,M2,N2,M2,N2,M2,X100,S585, 0.500)
       deallocate(S585)
C
     ...
     & N0,N2,N0,N2,N2,M2,N2,M2,VCHHPP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N2,M2,t2C,D2)
       allocate(S586(N2+1:M2,N2+1:M2,N2+1:M2,N2+1:M2))
       I1=K0*K0
       I2=K0*K0
       I3=K2*K2
...
C
       call
     & sum3412(N2,M2,N2,M2,N2,M2,N2,M2,X101,S586, 0.500)
       deallocate(S586)
C
...
C
     ...
     & N1,N3,N0,N2,N0,N1,M1,N2,VBHHPH,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S587(M1+1:N1,N0+1:N2,N0+1:N1,M1+1:N2))
       I1=K8*K1*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S587,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S609(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S609,-1.000)
       deallocate(S609)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,M1,N2,
     & N0,N2,N0,N1,M1,N2,M1,N1,S587,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S610(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X2,S610,-1.000)
       deallocate(S610)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,M1,N2,
     & N0,N1,N0,N2,M1,N2,M1,N1,S587,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S588(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X13,S588,-1.000)
       deallocate(S588)
C
     ...
     & N1,N3,N0,N1,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S591(M1+1:N1,N0+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4*K1
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,N0,N1,N2,M2,M1,N1,S591,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S611(M1+1:N2,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X1,S611, 1.000)
       deallocate(S611)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N2,N3,N2,M2,
     & N2,N3,N0,N1,N2,M2,M1,N1,S591,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S612(M1+1:N2,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X2,S612, 1.000)
       deallocate(S612)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N2,N3,N2,M2,
     & N2,N3,N0,N1,N2,M2,M1,N1,S591,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S615(N0+1:M1,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,M1,N1,X3,S615, 1.000)
       deallocate(S615)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N2,N3,N2,M2,
     & N2,N3,N0,N1,N2,M2,M1,N1,S591,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S616(N0+1:M1,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,M1,N1,X4,S616, 1.000)
       deallocate(S616)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N2,N3,N2,M2,
     & N0,N1,N2,N3,N2,M2,M1,N1,S591,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S592(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X15,S592,-1.000)
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X16,S592,-1.000)
       deallocate(S592)
C
...
C
       call
     & sum21(M2,N3,N1,M2,X35,Q64,-1.000)
       deallocate(Q64)
C
...
C
       call
     & sum21(N1,M2,N1,M2,X36,Q66,-1.000)
       deallocate(Q66)
C
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N1,X130,S602,-1.000)
       deallocate(S602)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z356(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X130,F2,Z356)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z356, 1.000)
       deallocate(Z356)
       deallocate(X130)
C
     ...
     & N1,N3,M1,N2,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S603(M1+1:N1,M1+1:N2,N0+1:N1,M2+1:N3))
       I1=K6*K1*K8
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,S603,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S604(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N1))
       I1=K7*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N1,X131,S604,-1.000)
       deallocate(S604)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z357(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X131,F2,Z357)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z357,-1.000)
       deallocate(Z357)
       deallocate(X131)
C
     ...
     & N1,N3,N0,M1,N0,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S605(M1+1:N1,N0+1:M1,N0+1:N1,N2+1:M2))
       I1=K0*K1*K5
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N2,M2,M1,N1,S605,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S606(N1+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N2,M2,N1,M2,M1,N1,X132,S606,-1.000)
       deallocate(S606)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z358(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X132,F2,Z358)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z358, 1.000)
       deallocate(Z358)
       deallocate(X132)
C
     ...
     & N1,N3,M1,N2,N0,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S607(M1+1:N1,M1+1:N2,N0+1:N1,N2+1:M2))
       I1=K0*K1*K8
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,S607,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S608(N1+1:M2,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,M1,N1,X133,S608,-1.000)
       deallocate(S608)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z359(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X133,F2,Z359)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z359,-1.000)
       deallocate(Z359)
       deallocate(X133)
C
     ...
     & N1,N3,N0,N2,N0,N1,N0,M1,VBHHPH,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S589(M1+1:N1,N0+1:N2,N0+1:N1,N0+1:M1))
       I1=K5*K1*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N0,N1,N0,M1,M1,N1,S589,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S613(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X3,S613,-1.000)
       deallocate(S613)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N0,M1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S589,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S614(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X4,S614,-1.000)
       deallocate(S614)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N0,M1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S589,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S590(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X14,S590,-1.000)
       deallocate(S590)
C
     ...
     & N1,N3,N0,M1,N0,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S597(M1+1:N1,N0+1:M1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K5
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N1,S597,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S598(N1+1:M2,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N1,X128,S598,-1.000)
       deallocate(S598)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z350(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X128,F2,Z350)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z350, 1.000)
       deallocate(Z350)
       deallocate(X128)
C
       allocate(D1(N1+1:N3,N0+1:M1,N0+1:N1,M2+1:N3))
     ...
     & N1,N3,N0,M1,N0,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S593(M1+1:N1,N0+1:M1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K5
       I2=K7
       I3=K3
...
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,M1,N0,N1,M2,N3,
     & N0,N1,N0,M1,M2,N3,M1,N1,S593,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S594(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N1,X126,S594,-1.000)
       deallocate(S594)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z348(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X126,F2,Z348)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z348, 1.000)
       deallocate(Z348)
       deallocate(X126)
C
     ...
     & N1,N3,M1,N1,N0,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S595(M1+1:N1,M1+1:N1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K7
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,M2,N3,M1,N1,S595,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S596(N1+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,M2,N3,N1,M2,M1,N1,X127,S596,-1.000)
       deallocate(S596)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z349(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X127,F2,Z349)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z349, 1.000)
       deallocate(Z349)
       deallocate(X127)
C
     ...
     & N1,N3,M1,N1,N0,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S599(M1+1:N1,M1+1:N1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K7
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S599,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S600(N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X129,S600,-1.000)
       deallocate(S600)
C
       allocate(F2(M1+1:N1,N1+1:M2,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z351(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K9*K7
       call EGEMM(I1,I2,I3,X129,F2,Z351)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z351, 1.000)
       deallocate(Z351)
       deallocate(X129)
C
...
C
     ...
     & N0,N1,N0,N2,N1,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S617(N1+1:M2,N0+1:N2,N1+1:N3,M1+1:N2))
       I1=K8*K3*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S617,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S619(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X6,S619, 1.000)
       deallocate(S619)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder2314(N1,M2,N0,N2,N1,N3,M1,N2,
     & N0,N2,N1,N3,N1,M2,M1,N2,S617,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S618(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X5,S618, 1.000)
       deallocate(S618)
C
     ...
     & N2,N3,N0,N1,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S620(M1+1:N2,N0+1:N1,N1+1:N3,N2+1:M2))
       I1=K0*K3*K1
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,S620,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S621(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X5,S621,-1.000)
       deallocate(S621)
C
       allocate(D1(N2+1:N3,N0+1:N1,N1+1:N3,N2+1:M2))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N0,N1,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S622(M1+1:N2,N0+1:N1,N1+1:N3,N2+1:M2))
       I1=K0*K3*K1
       I2=K8
       I3=K4
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder2341(M1,N2,N0,N1,N1,N3,N2,M2,
     & N0,N1,N1,N3,N2,M2,M1,N2,S622,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S623(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X6,S623,-1.000)
       deallocate(S623)
C
     ...
     & N0,N1,N0,N2,N1,N3,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S624(N1+1:M2,N0+1:N2,N1+1:N3,N0+1:M1))
       I1=K5*K3*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S624,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S626(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X8,S626, 1.000)
       deallocate(S626)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N1,N3,N0,M1,
     & N0,N2,N1,N3,N1,M2,N0,M1,S624,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S625(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X7,S625, 1.000)
       deallocate(S625)
C
       allocate(D1(N2+1:N3,N0+1:N1,N1+1:N3,N2+1:M2))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N0,N1,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S627(N0+1:M1,N0+1:N1,N1+1:N3,N2+1:M2))
       I1=K0*K3*K1
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,N1,N3,N2,M2,N0,M1,S627,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S628(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X7,S628,-1.000)
       deallocate(S628)
C
       allocate(D1(N2+1:N3,N0+1:N1,N1+1:N3,N2+1:M2))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N0,N1,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S629(N0+1:M1,N0+1:N1,N1+1:N3,N2+1:M2))
       I1=K0*K3*K1
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N1,N1,N3,N2,M2,
     & N0,N1,N1,N3,N2,M2,N0,M1,S629,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S630(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X8,S630,-1.000)
       deallocate(S630)
C
     ...
     & N2,N3,N0,N2,N0,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S631(M1+1:N2,N0+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S631,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S740,-1.000)
       deallocate(S740)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S631,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S741(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X2,S741,-1.000)
       deallocate(S741)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S631,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S632(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X13,S632,-1.000)
       deallocate(S632)
C
     ...
     & N0,N1,N0,N2,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S635(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S635,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S636(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X15,S636, 1.000)
       deallocate(S636)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,S635,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S637(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X16,S637, 1.000)
       deallocate(S637)
C
     ...
     & N1,N3,N0,N2,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S638(M1+1:N1,N0+1:N2,N2+1:N3,N1+1:M2))
       I1=K9*K4*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S638,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S641(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X15,S641,-1.000)
       deallocate(S641)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N2,N3,N1,M2,
     & N0,N2,N2,N3,N1,M2,M1,N1,S638,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S642(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X16,S642,-1.000)
       deallocate(S642)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,M1,N1,S638,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S639(M1+1:N2,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X13,S639, 1.000)
       deallocate(S639)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,M1,N1,S638,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S640(N0+1:M1,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,M1,N1,X14,S640, 1.000)
       deallocate(S640)
C
...
C
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,S645,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S652(N0+1:M1,N0+1:M1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N1,N0,M1,M1,N1,X54,S652, 1.000)
       deallocate(S652)
C
...
C
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z54(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K8*K9*K0*K0
       I3=K7*K5
...
C
       call
     & sum123546(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z54, 1.000)
       deallocate(Z54)
       deallocate(X54)
C
       allocate(D1(N2+1:N3,N0+1:M1,M1+1:N1,M1+1:N1))
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,S645,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S646(M1+1:N2,N0+1:M1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K5
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N2,M1,N1,X50,S646, 1.000)
       deallocate(S646)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,t3C4,F2)
       allocate(Z50(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K5*K9*K0*K0
       I3=K7*K5
...
C
     ...
     & N1,N3,N0,M1,N0,M1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S649(M1+1:N1,N0+1:M1,N0+1:M1,N2+1:N3))
       I1=K4*K5*K5
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N1,S649,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S650(N0+1:M1,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,N0,M1,N0,M1,M1,N1,X52,S650, 1.000)
       deallocate(S650)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z52(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K8*K9*K0*K0
       I3=K5*K5
...
C
       call
     & sum123546(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z52, 1.000)
       deallocate(Z52)
       deallocate(X52)
C
...
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,S643,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S644(M1+1:N2,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K8
       I2=K8
       I3=K4
...
C
       call
     & sum3124(M1,N2,N0,M1,M1,N2,M1,N1,X49,S644, 1.000)
       deallocate(S644)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder561234(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z49(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K5*K9*K0*K0
       I3=K5*K8
...
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,S643,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S651(N0+1:M1,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,N0,M1,N0,M1,M1,N1,X53,S651, 1.000)
       deallocate(S651)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z53(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K8*K9*K0*K0
       I3=K5*K8
...
C
       call
     & sum123546(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z53, 1.000)
       deallocate(Z53)
       deallocate(X53)
C
...
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,S647,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S648(M1+1:N2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K8
       I2=K8
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N1,M1,N2,M1,N1,X51,S648, 1.000)
       deallocate(S648)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder561234(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z51(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K5*K9*K0*K0
       I3=K7*K8
...
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,S647,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S653(N0+1:M1,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N1,N0,M1,M1,N1,X55,S653, 1.000)
       deallocate(S653)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z55(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K8*K9*K0*K0
       I3=K7*K8
...
C
       call
     & sum123546(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z55, 1.000)
       deallocate(Z55)
       deallocate(X55)
C
     ...
     & N1,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S656(M1+1:N1,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,S656,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S663(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N1,X107,S663,-1.000)
       deallocate(S663)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z150(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X107,F2,Z150)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z150, 1.000)
       deallocate(Z150)
       deallocate(X107)
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,M1+1:N1))
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,S656,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S657(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N1,X106,S657,-1.000)
       deallocate(S657)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z146(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X106,F2,Z146)
       deallocate(F2)
C
       call
     & sum234516(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z146,-1.000)
       deallocate(Z146)
       deallocate(X106)
C
     ...
     & N1,N3,N0,N2,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S660(M1+1:N1,N0+1:N2,M1+1:N1,N2+1:M2))
       I1=K0*K7*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,M1,N1,N2,M2,M1,N1,S660,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S665(N2+1:M2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N2,M2,N2,M2,M1,N1,X109,S665,-1.000)
       deallocate(S665)
C
       allocate(F2(M1+1:N1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z152(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K0*K7
...
C
       call
     & sum134526(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z152, 1.000)
       deallocate(Z152)
       deallocate(X109)
C
       allocate(D1(N0+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
     ...
     & N0,N2,M1,N1,N2,M2,M1,N1,S660,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S661(N2+1:M2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N2,M2,N2,M2,M1,N1,X108,S661,-1.000)
       deallocate(S661)
C
       allocate(F2(M1+1:N1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z148(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K0*K7
       call EGEMM(I1,I2,I3,X108,F2,Z148)
       deallocate(F2)
C
       call
     & sum234516(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z148,-1.000)
       deallocate(Z148)
       deallocate(X108)
C
     ...
     & N1,N3,N0,N2,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S658(M1+1:N1,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N1,S658,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S664(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N1,X105,S664,-1.000)
       deallocate(S664)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z151(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X105,F2,Z151)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z151, 1.000)
       deallocate(Z151)
       deallocate(X105)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,M1+1:N1))
     ...
     & N0,N2,N0,M1,N2,M2,M1,N1,S658,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S659(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N1,X104,S659,-1.000)
       deallocate(S659)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z147(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum234516(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z147,-1.000)
       deallocate(Z147)
       deallocate(X104)
C
     ...
     & N1,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S654(M1+1:N1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N1,S654,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S655(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N1,X102,S655,-1.000)
       deallocate(S655)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z145(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum234516(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z145,-1.000)
       deallocate(Z145)
       deallocate(X102)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N1))
     ...
     & N0,N2,N0,M1,M2,N3,M1,N1,S654,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S662(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N1,X103,S662,-1.000)
       deallocate(S662)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z149(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K8*K5*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X103,F2,Z149)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z149, 1.000)
       deallocate(Z149)
       deallocate(X103)
C
...
C
       ...
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z34(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       I1=K7
       I2=K8*K5*K9*K0*K0
       I3=K7
...
C
     ...
     & N2,N3,N0,M1,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S666(M1+1:N2,N0+1:M1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K5
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N2,S666,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S667(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N2,X110,S667, 1.000)
       deallocate(S667)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z153(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K5*K0*K0
       I3=K6*K5
...
C
       call
     & sum124635(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z153,-1.000)
       deallocate(Z153)
       deallocate(X110)
C
     ...
     & N2,N3,M1,N2,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S668(M1+1:N2,M1+1:N2,N0+1:N1,M2+1:N3))
       I1=K6*K1*K8
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N2,S668,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S669(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N2,X111,S669, 1.000)
       deallocate(S669)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1))
       call reorder531246(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z154(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K5*K0*K0
       I3=K6*K8
...
C
       call
     & sum124635(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z154, 1.000)
       deallocate(Z154)
       deallocate(X111)
C
     ...
     & N2,N3,N0,M1,N0,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S670(M1+1:N2,N0+1:M1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K5
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N2,S670,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S671(N1+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X112,S671, 1.000)
       deallocate(S671)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z155(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K5*K0*K0
       I3=K9*K5
...
C
       call
     & sum124635(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z155,-1.000)
       deallocate(Z155)
       deallocate(X112)
C
     ...
     & N2,N3,M1,N2,N0,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S672(M1+1:N2,M1+1:N2,N0+1:N1,N1+1:M2))
       I1=K9*K1*K8
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,M1,N2,N1,M2,M1,N2,S672,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S673(N1+1:M2,M1+1:N2,N1+1:M2,M1+1:N2))
       I1=K8*K9*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X113,S673, 1.000)
       deallocate(S673)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1))
       call reorder531246(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N1,M2,N2,M2,N2,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z156(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K5*K0*K0
       I3=K9*K8
...
C
       call
     & sum124635(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z156, 1.000)
       deallocate(Z156)
       deallocate(X113)
C
...
C
       call
     & sum21(N0,M1,N0,M1,X120,Q75, 1.000)
       deallocate(Q75)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z163(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K8*K9*K0*K0
       I3=K5
...
C
       call
     & sum123564(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z163,-1.000)
       deallocate(Z163)
       deallocate(X120)
C
       allocate(B1(N2+1:N3,N0+1:M1))
...
C
       call
     & sum21(N0,M1,M1,N2,X114,Q72, 1.000)
       deallocate(Q72)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z157(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,M1+1:N2))
       I1=K8
       I2=K7*K5*K9*K0*K0
       I3=K5
...
C
       call
     & sum123465(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z157, 1.000)
       deallocate(Z157)
       deallocate(X114)
C
       allocate(D1(N2+1:N3,N0+1:M1,N0+1:N1,M2+1:N3))
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,N0,M1,X116,S675, 1.000)
       deallocate(S675)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z159(N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K8*K0*K0
       I3=K6*K5
...
C
       call
     & sum125634(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z159, 1.000)
       deallocate(Z159)
       deallocate(X116)
C
       allocate(D1(N2+1:N3,M1+1:N2,N0+1:N1,M2+1:N3))
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,N0,M1,X117,S677, 1.000)
       deallocate(S677)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z160(N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K8*K0*K0
       I3=K6*K8
...
C
       call
     & sum125634(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z160, 1.000)
       deallocate(Z160)
       deallocate(X117)
C
       allocate(D1(N2+1:N3,N0+1:M1,N0+1:N1,N1+1:M2))
     ...
     & N2,N3,N0,M1,N0,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S678(N0+1:M1,N0+1:M1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K5
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,N0,M1,N1,M2,N0,M1,S678,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X118,S679, 1.000)
       deallocate(S679)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z161(N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K8*K0*K0
       I3=K9*K5
...
C
       call
     & sum125634(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z161, 1.000)
       deallocate(Z161)
       deallocate(X118)
C
       allocate(D1(N2+1:N3,M1+1:N2,N0+1:N1,N1+1:M2))
     ...
     & N2,N3,M1,N2,N0,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S680(N0+1:M1,M1+1:N2,N0+1:N1,N1+1:M2))
       I1=K9*K1*K8
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,M1,N2,N1,M2,N0,M1,S680,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S681(N1+1:M2,M1+1:N2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,N0,M1,X119,S681, 1.000)
       deallocate(S681)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N1,M2,N2,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z162(N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9
       I2=K7*K8*K0*K0
       I3=K9*K8
...
C
       call
     & sum125634(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z162, 1.000)
       deallocate(Z162)
       deallocate(X119)
C
...
C
       call
     & sum21(M1,N2,N0,M1,X121,Q76, 1.000)
       deallocate(Q76)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z164(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K8*K9*K0*K0
       I3=K8
       call EGEMM(I1,I2,I3,X121,F2,Z164)
       deallocate(F2)
C
       call
     & sum123564(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z164,-1.000)
       deallocate(Z164)
       deallocate(X121)
C
       allocate(B1(N2+1:N3,M1+1:N2))
...
C
       call
     & sum21(M1,N2,M1,N2,X115,Q74, 1.000)
       deallocate(Q74)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z158(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,M1+1:N2))
       I1=K8
       I2=K7*K5*K9*K0*K0
       I3=K8
...
C
       call
     & sum123465(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z158,-1.000)
       deallocate(Z158)
       deallocate(X115)
C
     ...
     & N0,N1,N0,N2,M2,N3,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S682(N1+1:M2,N0+1:N2,M2+1:N3,M2+1:N3))
       I1=K6*K6*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,M2,N3,M2,N3,N1,M2,S682,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S690(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X76,S690, 1.000)
       deallocate(S690)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,M2,N3,N2,M2,N1,M2,X76,VBAPPP, 1.000)
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z76(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K8*K5*K0
       I3=K6*K6
...
C
       call
     & sum145623(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z76,-1.000)
       deallocate(Z76)
       deallocate(X76)
C
       allocate(D1(N0+1:N2,M2+1:N3,M2+1:N3,N1+1:M2))
     ...
     & N0,N2,M2,N3,M2,N3,N1,M2,S682,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S683(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X72,S683, 1.000)
       deallocate(S683)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,M2,N3,N2,M2,N1,M2,X72,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder132456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z72(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K8*K5*K0
       I3=K6*K6
...
C
       call
     & sum245613(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z72, 1.000)
       deallocate(Z72)
       deallocate(X72)
C
     ...
     & N0,N1,N0,N2,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S686(N1+1:M2,N0+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,S686,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S692(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X78,S692, 1.000)
       deallocate(S692)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,N1,M2,N2,M2,N1,M2,X78,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,N1+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder132456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M2,N3,N1,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z78(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K8*K5*K0
       I3=K9*K6
...
C
       call
     & sum145623(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z78,-1.000)
       deallocate(Z78)
       deallocate(X78)
C
       allocate(D1(N0+1:N2,M2+1:N3,N1+1:M2,N1+1:M2))
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,S686,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S687(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X74,S687, 1.000)
       deallocate(S687)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,N1,M2,N2,M2,N1,M2,X74,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,N1+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder132456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M2,N3,N1,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z74(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K8*K5*K0
       I3=K9*K6
...
C
       call
     & sum245613(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z74, 1.000)
       deallocate(Z74)
       deallocate(X74)
C
...
C
       call
     & sum21(M2,N3,N2,M2,X123,Q81,-1.000)
       deallocate(Q81)
C
     ...
     & M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z175(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K8*K5*K9*K0
       I3=K6
       call EGEMM(I1,I2,I3,X123,F2,Z175)
       deallocate(F2)
C
       call
     & sum134562(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z175,-1.000)
       deallocate(Z175)
       deallocate(X123)
C
       allocate(B2(N0+1:N2,N2+1:M2))
...
C
       call
     & sum21(M2,N3,N2,M2,X122,Q78,-1.000)
       deallocate(Q78)
C
       allocate(F2(M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z169(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K8*K5*K9*K0
       I3=K6
       call EGEMM(I1,I2,I3,X122,F2,Z169)
       deallocate(F2)
C
       call
     & sum234561(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z169, 1.000)
       deallocate(Z169)
       deallocate(X122)
C
     ...
     & N0,N1,N0,N2,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S684(N1+1:M2,N0+1:N2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,S684,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S691(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X77,S691, 1.000)
       deallocate(S691)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,M2,N3,N2,M2,N1,M2,X77,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder132456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z77(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K8*K5*K0
       I3=K6*K0
...
C
       call
     & sum145623(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z77,-1.000)
       deallocate(Z77)
       deallocate(X77)
C
       allocate(D1(N0+1:N2,N2+1:M2,M2+1:N3,N1+1:M2))
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,S684,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S685(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X73,S685, 1.000)
       deallocate(S685)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,M2,N3,N2,M2,N1,M2,X73,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder132456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z73(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K8*K5*K0
       I3=K6*K0
...
C
       call
     & sum245613(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z73, 1.000)
       deallocate(Z73)
       deallocate(X73)
C
     ...
     & N0,N1,N0,N2,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S688(N1+1:M2,N0+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,S688,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S693(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X79,S693, 1.000)
       deallocate(S693)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,N1,M2,N2,M2,N1,M2,X79,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,N1+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder132456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,N1,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z79(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K8*K5*K0
       I3=K9*K0
...
C
       call
     & sum145623(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z79,-1.000)
       deallocate(Z79)
       deallocate(X79)
C
       allocate(D1(N0+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,S688,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S689(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X75,S689, 1.000)
       deallocate(S689)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,N1,M2,N2,M2,N1,M2,X75,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,N1+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder132456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,N1,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z75(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K8*K5*K0
       I3=K9*K0
...
C
       call
     & sum245613(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z75, 1.000)
       deallocate(Z75)
       deallocate(X75)
C
...
C
       call
     & sum21(N2,M2,N2,M2,X125,Q82,-1.000)
       deallocate(Q82)
C
       allocate(F2(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z176(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K8*K5*K9*K0
       I3=K0
       call EGEMM(I1,I2,I3,X125,F2,Z176)
       deallocate(F2)
C
       call
     & sum134562(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z176,-1.000)
       deallocate(Z176)
       deallocate(X125)
C
       allocate(B2(N0+1:N2,N2+1:M2))
...
C
       call
     & sum21(N2,M2,N2,M2,X124,Q80,-1.000)
       deallocate(Q80)
C
       allocate(F2(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z170(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K8*K5*K9*K0
       I3=K0
       call EGEMM(I1,I2,I3,X124,F2,Z170)
       deallocate(F2)
C
       call
     & sum234561(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z170, 1.000)
       deallocate(Z170)
       deallocate(X124)
C
...
C
       call
     & sum21(M2,N3,N1,M2,X35,Q84,-1.000)
       deallocate(Q84)
C
...
C
       ...
       call reorder312456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z35(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K8*K5*K0*K0
       I3=K6
...
C
       call
     & sum124563(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z35, 1.000)
       deallocate(Z35)
       deallocate(X35)
C
...
C
       call
     & sum21(N1,M2,N1,M2,X36,Q86,-1.000)
       deallocate(Q86)
C
       call sumx12(N1,N3,N1,N3,
...
C
       ...
       call reorder312456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z36(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K8*K5*K0*K0
       I3=K9
...
C
       call
     & sum124563(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z36, 1.000)
       deallocate(Z36)
       deallocate(X36)
C
...
C
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,S694,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S696(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S696, 1.000)
       deallocate(S696)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N1,M1,N1,S694,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S697(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X3,S697, 1.000)
       deallocate(S697)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N1,M1,N1,S694,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S698(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X2,S698, 1.000)
       deallocate(S698)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N1,M1,N1,S694,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S695(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X4,S695, 1.000)
       deallocate(S695)
C
     ...
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S699(N2+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & N0,N1,N1,N3,N2,M2,N0,M1,S699,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S700(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X8,S700,-1.000)
       deallocate(S700)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
     ...
     & N1,N3,N0,N1,Q87,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S704(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S704)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S704, 1.000)
       deallocate(S704)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q87,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S707(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S707)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S707, 1.000)
       deallocate(S707)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q87,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S710(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K3
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X4,S710, 1.000)
       deallocate(S710)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q87,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S701(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S701)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S701, 1.000)
       deallocate(S701)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S702(N2+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K0
       I3=K3*K1
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,N0,M1,S702,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S703(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X7,S703,-1.000)
       deallocate(S703)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S708(N2+1:M2,M1+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,S708,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X5,S709,-1.000)
       deallocate(S709)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S705(N2+1:M2,M1+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K8*K0
       I3=K3*K1
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,M1,N2,S705,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S706(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X6,S706,-1.000)
       deallocate(S706)
C
     ...
     & N1,N3,N0,N2,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S711(M1+1:N1,N0+1:N2,N0+1:N1,N2+1:N3))
       I1=K4*K1*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N2,N3,N0,N1,M1,N1,S711,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S713(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X3,S713, 1.000)
       deallocate(S713)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,M1,N1,S711,D1)
       allocate(D2(N0+1:N1,N2+1:N3,N1+1:M2,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S714(N1+1:M2,M1+1:N2,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X13,S714,-1.000)
       deallocate(S714)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S711,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S715(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X2,S715, 1.000)
       deallocate(S715)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S711,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S716(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S716, 1.000)
       deallocate(S716)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,M1,N1,S711,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S717(N1+1:M2,N0+1:M1,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K5*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,M1,N1,X14,S717,-1.000)
       deallocate(S717)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,M1,N1,S711,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S718(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X15,S718, 1.000)
       deallocate(S718)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,M1,N1,S711,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S719(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X16,S719, 1.000)
       deallocate(S719)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N2,N0,N1,N2,N3,
     & N2,N3,N0,N2,N0,N1,M1,N1,S711,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S899(M1+1:N2,N0+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1*K2
       I2=K8
       I3=K4
...
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S899,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S900(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X13,S900,-1.000)
       deallocate(S900)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,M1,N1,S711,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S903(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S903,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S905(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X16,S905, 1.000)
       deallocate(S905)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N2,N0,N1,N2,N3,
     & N2,N3,N0,N2,N0,N1,M1,N1,S711,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S901(N0+1:M1,N0+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,N0,N2,N0,M1,M1,N1,S901,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S902(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X14,S902,-1.000)
       deallocate(S902)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S711,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S712(N2+1:M2,N0+1:M1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,N0,M1,M1,N1,X4,S712, 1.000)
       deallocate(S712)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S899,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S906,-1.000)
       deallocate(S906)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S899,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S907(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X2,S907,-1.000)
       deallocate(S907)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X15,S904, 1.000)
       deallocate(S904)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S901,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X3,S908,-1.000)
       deallocate(S908)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S901,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S909(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X4,S909,-1.000)
       deallocate(S909)
C
     ...
     & N0,N2,N1,N3,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S734(N2+1:M2,M1+1:N1,N0+1:N1,N2+1:N3))
       I1=K4*K1
       I2=K7*K0
       I3=K3*K2
...
C
     ...
     & N2,N3,N0,N1,N2,M2,M1,N1,S734,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S840(M1+1:N2,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X1,S840,-1.000)
       deallocate(S840)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder4312(N2,M2,M1,N1,N0,N1,N2,N3,
     & N2,N3,N0,N1,N2,M2,M1,N1,S734,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S857(N0+1:M1,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,M1,N1,X3,S857,-1.000)
       deallocate(S857)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder3412(N2,M2,M1,N1,N0,N1,N2,N3,
     & N0,N1,N2,N3,N2,M2,M1,N1,S734,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S735(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X15,S735, 1.000)
       deallocate(S735)
C
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S736)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N0,N2,Q88,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S726(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S726)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X13,S726, 1.000)
       deallocate(S726)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q88,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S733(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S733)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S733, 1.000)
       deallocate(S733)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q88,B1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(S739(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S739)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S739,-1.000)
       deallocate(S739)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder1342(N2,N3,N0,N1,N0,N2,N0,N1,
     & N2,N3,N0,N2,N0,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S633(N0+1:M1,N0+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder3214(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S633,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S634(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X14,S634,-1.000)
       deallocate(S634)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S633,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X3,S742,-1.000)
       deallocate(S742)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S633,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S743(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X4,S743,-1.000)
       deallocate(S743)
C
     ...
     & N2,N3,N0,N2,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S747(N0+1:M1,N0+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S747,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S749(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X8,S749,-1.000)
       deallocate(S749)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N1,N3,N1,M2,
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X7,S748,-1.000)
       deallocate(S748)
C
     ...
     & N2,N3,N0,N2,N0,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S750(N0+1:M1,N0+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S750,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X10,S752,-1.000)
       deallocate(S752)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
       call reorder2314(N0,M1,N0,N2,N0,N2,M1,N2,
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X9,S751,-1.000)
       deallocate(S751)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
     ...
     & N0,N2,N0,N2,N2,N3,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S753(N2+1:M2,N0+1:N2,N2+1:N3,M1+1:N2))
       I1=K8*K4*K2
       I2=K0
       I3=K2
...
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,S753,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S754(N2+1:M2,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X11,S754, 1.000)
       deallocate(S754)
C
     ...
     & N2,N3,N0,N2,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S755(M1+1:N2,N0+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S755,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S757(N2+1:M2,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X10,S757, 1.000)
       deallocate(S757)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,N2,N0,M1,
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X9,S756, 1.000)
       deallocate(S756)
C
     ...
     & N2,N3,N0,N2,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S758(M1+1:N2,N0+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,S758,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S762(N2+1:M2,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,N2,M2,N2,M2,M1,N2,X11,S762,-1.000)
       deallocate(S762)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:M2,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N2,N3,N2,M2,
     & N2,N3,N0,N2,N2,M2,M1,N2,S758,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S759(N0+1:M1,N0+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N2,M2,N0,M1,M1,N2,X9,S759, 1.000)
       deallocate(S759)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:N3,N2+1:M2))
       call reorder2413(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,N0,N2,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S760(M1+1:N2,N0+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4*K2
       I2=K8
       I3=K4
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N2,N3,N2,M2,
     & N0,N2,N2,N3,N2,M2,M1,N2,S760,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S763(N2+1:M2,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X11,S763, 1.000)
       deallocate(S763)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:M2,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N2,N3,N2,M2,
     & N2,N3,N0,N2,N2,M2,M1,N2,S760,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S761(N0+1:M1,N0+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N2,M2,N0,M1,M1,N2,X10,S761, 1.000)
       deallocate(S761)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder4312(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S764(N2+1:M2,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K0
       I3=K2
...
C
     ...
     & N2,N3,N0,N2,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S766(N0+1:M1,N0+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,S766,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S767(N2+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,N2,M2,N2,M2,N0,M1,X12,S767, 1.000)
       deallocate(S767)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:N3,N2+1:M2))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,N0,N2,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S768(N0+1:M1,N0+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N2,N3,N2,M2,
     & N0,N2,N2,N3,N2,M2,N0,M1,S768,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S769(N2+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,N0,M1,X12,S769,-1.000)
       deallocate(S769)
C
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S770(M1+1:N2,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,S770,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S778(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X21,S778,-1.000)
       deallocate(S778)
C
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z21(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z21, 1.000)
       deallocate(Z21)
       deallocate(X21)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,S770,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S771(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X17,S771,-1.000)
       deallocate(S771)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z17(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z17,-1.000)
       deallocate(Z17)
       deallocate(X17)
C
     ...
     & N2,N3,N0,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S774(M1+1:N2,N0+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,S774,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S780(N2+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,M1,N2,X23,S780,-1.000)
       deallocate(S780)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z23(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K9*K5
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z23, 1.000)
       deallocate(Z23)
       deallocate(X23)
C
       allocate(D1(N0+1:N2,N0+1:M1,N1+1:M2,M1+1:N2))
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,S774,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S775(N2+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,M1,N2,X19,S775,-1.000)
       deallocate(S775)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z19(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K9*K5
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z19,-1.000)
       deallocate(Z19)
       deallocate(X19)
C
     ...
     & N2,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S772(M1+1:N2,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N2,S772,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S779(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N2,X22,S779,-1.000)
       deallocate(S779)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z22(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z22, 1.000)
       deallocate(Z22)
       deallocate(X22)
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,M1+1:N2))
     ...
     & N0,N2,M1,N1,M2,N3,M1,N2,S772,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S773(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N2,X18,S773,-1.000)
       deallocate(S773)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z18(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K7
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z18,-1.000)
       deallocate(Z18)
       deallocate(X18)
C
     ...
     & N2,N3,N0,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S776(M1+1:N2,N0+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,S776,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S781(N2+1:M2,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,M1,N2,X24,S781,-1.000)
       deallocate(S781)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z24(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K9*K7
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z24, 1.000)
       deallocate(Z24)
       deallocate(X24)
C
       allocate(D1(N0+1:N2,M1+1:N1,N1+1:M2,M1+1:N2))
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,M1,N2,X20,S777,-1.000)
       deallocate(S777)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       allocate(Z20(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K9*K7
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z20,-1.000)
       deallocate(Z20)
       deallocate(X20)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S782(N0+1:M1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,S782,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S790(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X29,S790,-1.000)
       deallocate(S790)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z29(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z29,-1.000)
       deallocate(Z29)
       deallocate(X29)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,S782,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S783(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X25,S783,-1.000)
       deallocate(S783)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z25(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z25, 1.000)
       deallocate(Z25)
       deallocate(X25)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,N1+1:M2))
     ...
     & N2,N3,N0,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S786(N0+1:M1,N0+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N1,M2,N0,M1,S786,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S792(N2+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,N0,M1,X31,S792,-1.000)
       deallocate(S792)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z31(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K9*K5
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z31,-1.000)
       deallocate(Z31)
       deallocate(X31)
C
       allocate(D1(N0+1:N2,N0+1:M1,N1+1:M2,N0+1:M1))
     ...
     & N0,N2,N0,M1,N1,M2,N0,M1,S786,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S787(N2+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,N0,M1,X27,S787,-1.000)
       deallocate(S787)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z27(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K9*K5
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z27, 1.000)
       deallocate(Z27)
       deallocate(X27)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N1,M2+1:N3))
     ...
     & N2,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S784(N0+1:M1,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,M2,N3,N0,M1,S784,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S791(N2+1:M2,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,N0,M1,X30,S791,-1.000)
       deallocate(S791)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z30(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K7
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z30,-1.000)
       deallocate(Z30)
       deallocate(X30)
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,N0+1:M1))
     ...
     & N0,N2,M1,N1,M2,N3,N0,M1,S784,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S785(N2+1:M2,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,N0,M1,X26,S785,-1.000)
       deallocate(S785)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z26(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K7
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z26, 1.000)
       deallocate(Z26)
       deallocate(X26)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N1,N1+1:M2))
     ...
     & N2,N3,N0,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S788(N0+1:M1,N0+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,N1,M2,N0,M1,S788,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S793(N2+1:M2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,N0,M1,X32,S793,-1.000)
       deallocate(S793)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z32(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K9*K7
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z32,-1.000)
       deallocate(Z32)
       deallocate(X32)
C
       allocate(D1(N0+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,N0,M1,X28,S789,-1.000)
       deallocate(S789)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z28(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K9*K7
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z28, 1.000)
       deallocate(Z28)
       deallocate(X28)
C
     ...
     & N2,N3,N0,M1,N0,M1,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S794(M1+1:N2,N0+1:M1,N0+1:M1,N2+1:N3))
       I1=K4*K5*K5
       I2=K8
       I3=K4
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N2,S794,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S795(N0+1:M1,N0+1:M1,N0+1:M1,M1+1:N2))
       I1=K8*K5*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,N0,M1,N0,M1,M1,N2,X80,S795, 1.000)
       deallocate(S795)
C
...
C
       ...
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N0,M1,N2,M2,N2,M2,N1,M2,M1,N1,t3C4,F2)
       allocate(Z80(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K7*K9*K0*K0
       I3=K5*K5
...
C
       call
     & sum123645(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z80, 0.500)
       deallocate(Z80)
       deallocate(X80)
C
     ...
     & N2,N3,N0,M1,M1,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S796(M1+1:N2,N0+1:M1,M1+1:N2,N2+1:N3))
       I1=K4*K8*K5
       I2=K8
       I3=K4
...
C
     ...
     & N2,N3,N0,M1,M1,N2,M1,N2,S796,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S797(N0+1:M1,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N2,N0,M1,M1,N2,X81,S797, 1.000)
       deallocate(S797)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
...
C
       ...
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N2,N2,M2,N2,M2,N1,M2,M1,N1,t3C1,F2)
       allocate(Z81(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K7*K9*K0*K0
       I3=K8*K5
...
C
       call
     & sum123645(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z81, 1.000)
       deallocate(Z81)
       deallocate(X81)
C
     ...
     & N2,N3,M1,N2,M1,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S798(M1+1:N2,M1+1:N2,M1+1:N2,N2+1:N3))
       I1=K4*K8*K8
       I2=K8
       I3=K4
...
C
     ...
     & N2,N3,M1,N2,M1,N2,M1,N2,S798,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S799(N0+1:M1,M1+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N2,N0,M1,M1,N2,X82,S799, 1.000)
       deallocate(S799)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
...
C
       ...
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N2,N2,M2,N2,M2,N1,M2,M1,N1,t3C1,F2)
       allocate(Z82(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K7*K9*K0*K0
       I3=K8*K8
...
C
       call
     & sum123645(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z82, 0.500)
       deallocate(Z82)
       deallocate(X82)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S800(M1+1:N2,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K8
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,M1,N2,S800,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S808(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X87,S808, 1.000)
       deallocate(S808)
C
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z87(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z87,-1.000)
       deallocate(Z87)
       deallocate(X87)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,S800,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S801(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X83,S801, 1.000)
       deallocate(S801)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z83(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K5
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z83, 1.000)
       deallocate(Z83)
       deallocate(X83)
C
     ...
     & N2,N3,N0,N2,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S804(M1+1:N2,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,S804,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S810(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N2))
       I1=K8*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N2,X89,S810, 1.000)
       deallocate(S810)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z89(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z89,-1.000)
       deallocate(Z89)
       deallocate(X89)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,M1+1:N2))
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,S804,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S805(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N2))
       I1=K8*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N2,X85,S805, 1.000)
       deallocate(S805)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z85(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K0*K5
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z85, 1.000)
       deallocate(Z85)
       deallocate(X85)
C
     ...
     & N2,N3,N0,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S802(M1+1:N2,N0+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,S802,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S809(N2+1:M2,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,M2,N3,N2,M2,M1,N2,X88,S809, 1.000)
       deallocate(S809)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z88(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z88, 1.000)
       deallocate(Z88)
       deallocate(X88)
C
       allocate(D1(N0+1:N2,M1+1:N2,M2+1:N3,M1+1:N2))
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,S802,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S803(N2+1:M2,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,M2,N3,N2,M2,M1,N2,X84,S803, 1.000)
       deallocate(S803)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z84(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K6*K8
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z84,-1.000)
       deallocate(Z84)
       deallocate(X84)
C
     ...
     & N2,N3,N0,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S806(M1+1:N2,N0+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,S806,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S811(N2+1:M2,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,M1,N2,X90,S811, 1.000)
       deallocate(S811)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z90(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum134625(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z90, 1.000)
       deallocate(Z90)
       deallocate(X90)
C
       allocate(D1(N0+1:N2,M1+1:N2,N2+1:M2,M1+1:N2))
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,M1,N2,X86,S807, 1.000)
       deallocate(S807)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z86(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K5*K9*K0
       I3=K0*K8
...
C
       call
     & sum234615(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z86,-1.000)
       deallocate(Z86)
       deallocate(X86)
C
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z39(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K8*K9*K0*K0
       I3=K5
...
C
       call
     & sum123564(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z39,-1.000)
       deallocate(Z39)
       deallocate(X39)
C
       allocate(B1(N2+1:N3,N0+1:M1))
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       allocate(Z37(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,M1+1:N2))
       I1=K8
       I2=K7*K5*K9*K0*K0
       I3=K5
...
C
       call
     & sum123465(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z37, 1.000)
       deallocate(Z37)
       deallocate(X37)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S812(N0+1:M1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,N0,M1,S812,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S820(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X95,S820, 1.000)
       deallocate(S820)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z95(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z95, 1.000)
       deallocate(Z95)
       deallocate(X95)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,S812,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S813(N2+1:M2,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,N0,M1,X91,S813, 1.000)
       deallocate(S813)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z91(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z91,-1.000)
       deallocate(Z91)
       deallocate(X91)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,N2+1:M2))
     ...
     & N2,N3,N0,N2,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S816(N0+1:M1,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N2,M2,N0,M1,S816,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S822(N2+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,N0,M1,X97,S822, 1.000)
       deallocate(S822)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z97(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K0*K5
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z97, 1.000)
       deallocate(Z97)
       deallocate(X97)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,N0+1:M1))
     ...
     & N0,N2,N0,M1,N2,M2,N0,M1,S816,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S817(N2+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,N0,M1,X93,S817, 1.000)
       deallocate(S817)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z93(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K0*K5
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z93,-1.000)
       deallocate(Z93)
       deallocate(X93)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N2,M2+1:N3))
     ...
     & N2,N3,N0,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S814(N0+1:M1,N0+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,M2,N3,N0,M1,S814,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S821(N2+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,M2,N3,N2,M2,N0,M1,X96,S821, 1.000)
       deallocate(S821)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z96(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K8
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z96, 1.000)
       deallocate(Z96)
       deallocate(X96)
C
       allocate(D1(N0+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
     ...
     & N0,N2,M1,N2,M2,N3,N0,M1,S814,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S815(N2+1:M2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,M2,N3,N2,M2,N0,M1,X92,S815, 1.000)
       deallocate(S815)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z92(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K6*K8
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z92,-1.000)
       deallocate(Z92)
       deallocate(X92)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N2,N2+1:M2))
     ...
     & N2,N3,N0,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S818(N0+1:M1,N0+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,N2,M2,N0,M1,S818,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S823(N2+1:M2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,N0,M1,X98,S823, 1.000)
       deallocate(S823)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z98(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K0*K8
...
C
       call
     & sum135624(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z98, 1.000)
       deallocate(Z98)
       deallocate(X98)
C
       allocate(D1(N0+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,N0,M1,X94,S819, 1.000)
       deallocate(S819)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z94(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K7*K8*K9*K0
       I3=K0*K8
...
C
       call
     & sum235614(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z94,-1.000)
       deallocate(Z94)
       deallocate(X94)
C
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z40(N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N0+1:M1))
       I1=K5
       I2=K7*K8*K9*K0*K0
       I3=K8
...
C
       call
     & sum123564(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z40,-1.000)
       deallocate(Z40)
       deallocate(X40)
C
       allocate(B1(N2+1:N3,M1+1:N2))
...
C
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       allocate(Z38(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N1,M1+1:N2))
       I1=K8
       I2=K7*K5*K9*K0*K0
       I3=K8
...
C
       call
     & sum123465(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z38,-1.000)
       deallocate(Z38)
       deallocate(X38)
C
       allocate(D1(N0+1:N2,N0+1:N2,M2+1:N3,M2+1:N3))
     ...
     & N0,N2,N0,N2,M2,N3,M2,N3,VCHHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S824(N2+1:M2,N0+1:N2,M2+1:N3,M2+1:N3))
       I1=K6*K6*K2
       I2=K0
       I3=K2
...
C
     ...
     & N0,N2,M2,N3,M2,N3,N2,M2,S824,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S825(N2+1:M2,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N2,M2,X99,S825, 1.000)
       deallocate(S825)
C
       call sumx1234(N2,N3,N2,N3,N2,N3,N2,M2,
     & M2,N3,M2,N3,N2,M2,N2,M2,X99,VCAPPP, 1.000)
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,t3C3,F2)
       allocate(Z99(N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N2+1:M2))
       I1=K0*K0
       I2=K7*K8*K5*K9
       I3=K6*K6
...
C
       call
     & sum345612(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z99, 0.500)
       deallocate(Z99)
       deallocate(X99)
C
       allocate(D1(N0+1:N2,N0+1:N2,M2+1:N3,N2+1:M2))
     ...
     & N0,N2,N0,N2,M2,N3,N2,M2,VCHHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S826(N2+1:M2,N0+1:N2,M2+1:N3,N2+1:M2))
       I1=K0*K6*K2
       I2=K0
       I3=K2
...
C
     ...
     & N0,N2,M2,N3,N2,M2,N2,M2,S826,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S827(N2+1:M2,M2+1:N3,N2+1:M2,N2+1:M2))
       I1=K0*K0*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N2,M2,N2,M2,N2,M2,X100,S827, 1.000)
       deallocate(S827)
C
       call sumx1234(N2,N3,N2,N3,N2,N3,N2,M2,
     & M2,N3,N2,M2,N2,M2,N2,M2,X100,VCAPPP, 1.000)
C
       allocate(F2(M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z100(N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N2+1:M2))
       I1=K0*K0
       I2=K7*K8*K5*K9
       I3=K0*K6
...
C
       call
     & sum345612(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z100, 1.000)
       deallocate(Z100)
       deallocate(X100)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:M2,N2+1:M2))
     ...
     & N0,N2,N0,N2,N2,M2,N2,M2,VCHHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S828(N2+1:M2,N0+1:N2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K2
       I2=K0
       I3=K2
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N2,M2,S828,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S829(N2+1:M2,N2+1:M2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N2,M2,N2,M2,N2,M2,X101,S829, 1.000)
       deallocate(S829)
C
       call sumx1234(N2,N3,N2,N3,N2,N3,N2,M2,
     & N2,M2,N2,M2,N2,M2,N2,M2,X101,VCAPPP, 1.000)
C
       allocate(F2(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z101(N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2,N2+1:M2))
       I1=K0*K0
       I2=K7*K8*K5*K9
       I3=K0*K0
       call EGEMM(I1,I2,I3,X101,F2,Z101)
       deallocate(F2)
C
       call
     & sum345612(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z101, 0.500)
       deallocate(Z101)
       deallocate(X101)
C
...
C
       ...
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z43(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K8*K5*K9*K0
       I3=K6
...
C
       call
     & sum134562(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z43,-1.000)
       deallocate(Z43)
       deallocate(X43)
C
       allocate(B2(N0+1:N2,N2+1:M2))
...
C
       ...
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z41(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K8*K5*K9*K0
       I3=K6
...
C
       call
     & sum234561(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z41, 1.000)
       deallocate(Z41)
       deallocate(X41)
C
...
C
       ...
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z44(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K8*K5*K9*K0
       I3=K0
...
C
       call
     & sum134562(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z44,-1.000)
       deallocate(Z44)
       deallocate(X44)
C
       allocate(B2(N0+1:N2,N2+1:M2))
...
C
       ...
       call reorder123456(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       allocate(Z42(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K8*K5*K9*K0
       I3=K0
...
C
       call
     & sum234561(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z42, 1.000)
       deallocate(Z42)
       deallocate(X42)
C
     ...
     & N2,N3,N0,N2,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S830(M1+1:N2,N0+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,N1,N1,N3,M1,N2,S830,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S837(N2+1:M2,N1+1:M2,N1+1:N3,M1+1:N2))
       I1=K8*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,M1,N2,X6,S837, 1.000)
       deallocate(S837)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N2,N0,N1,N1,N3,M1,N2,S830,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S838(N2+1:M2,N1+1:M2,N1+1:N3,M1+1:N2))
       I1=K8*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,M1,N2,X5,S838, 1.000)
       deallocate(S838)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S830,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S839(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X10,S839, 1.000)
       deallocate(S839)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S830,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S841(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X9,S841, 1.000)
       deallocate(S841)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N0,N2,N1,N3,M1,N2,S830,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S910(N1+1:M2,N0+1:N2,N1+1:N3,M1+1:N2))
       I1=K8*K3*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder2314(N1,M2,N0,N2,N1,N3,M1,N2,
     & N0,N2,N1,N3,N1,M2,M1,N2,S910,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X5,S911, 1.000)
       deallocate(S911)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S830,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S831(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X13,S831, 1.000)
       deallocate(S831)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder2314(N1,M2,N0,N2,N1,N3,M1,N2,
     & N0,N2,N1,N3,N1,M2,M1,N2,S910,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S912(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X6,S912, 1.000)
       deallocate(S912)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:N3,N1+1:M2))
       call reorder1324(N2,N3,N1,N3,N0,N2,N1,N3,
     & N2,N3,N0,N2,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S744(M1+1:N2,N0+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S744,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S746(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X6,S746,-1.000)
       deallocate(S746)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N1,N3,N1,M2,
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X5,S745,-1.000)
       deallocate(S745)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,N2+1:N3))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S737(N2+1:M2,M1+1:N1,N0+1:N1,N2+1:N3))
       I1=K4*K1
       I2=K7*K0
       I3=K3*K2
...
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder3412(N2,M2,M1,N1,N0,N1,N2,N3,
     & N0,N1,N2,N3,N2,M2,M1,N1,S737,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S738(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X16,S738, 1.000)
       deallocate(S738)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder4312(N2,M2,M1,N1,N0,N1,N2,N3,
     & N2,N3,N0,N1,N2,M2,M1,N1,S737,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S859(N0+1:M1,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,N0,M1,M1,N1,X4,S859,-1.000)
       deallocate(S859)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder4312(N2,M2,M1,N1,N0,N1,N2,N3,
     & N2,N3,N0,N1,N2,M2,M1,N1,S737,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S842(M1+1:N2,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X2,S842,-1.000)
       deallocate(S842)
C
     ...
     & N0,N1,N2,N3,N0,N2,N1,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,N0,M1,t2B,D2)
       allocate(S845(N1+1:M2,N0+1:M1,N0+1:N2,N1+1:N3))
       I1=K3*K2
       I2=K5*K9
       I3=K4*K1
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S845,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S845,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S846(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X7,S846, 1.000)
       deallocate(S846)
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S724(M1+1:N2,M1+1:N1,N0+1:N2,N0+1:N1))
       I1=K1*K2
       I2=K7*K8
       I3=K3*K4
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S724,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
     ...
     & N0,N1,N0,N2,M1,N2,M1,N1,S724,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S725(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X13,S725,-1.000)
       deallocate(S725)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder3412(M1,N2,M1,N1,N0,N2,N0,N1,
...
C
     ...
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S852(N2+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,S852,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S853(N2+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,N2,M2,N2,M2,N0,M1,X12,S853, 1.000)
       deallocate(S853)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S847(N2+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K0
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S847)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N2,M2,N0,M1,S847,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S848(N2+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,N0,M1,X12,S848,-1.000)
       deallocate(S848)
C
...
C
     ...
     & N1,N3,N0,N1,Q101,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S866(N2+1:M2,N0+1:M1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S866)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,M1,N1,X3,S866, 1.000)
       deallocate(S866)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
...
C
     ...
     & N1,N3,N0,N1,Q101,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S851(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S851)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S851, 1.000)
       deallocate(S851)
C
...
C
     ...
     & N0,N1,N2,M2,N1,M2,N0,M1,t2B,D2)
       allocate(Z1(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K0
       I2=K5*K9*K0
       I3=K1
...
C
       call
     & sum234156(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z1, 1.000)
       deallocate(Z1)
       deallocate(X1)
C
       allocate(B1(N1+1:N3,N0+1:N1))
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S855)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,M2,N1,M2,N0,M1,t2B,D2)
       allocate(Z2(N2+1:M2,N1+1:M2,N0+1:M1,N2+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K0
       I2=K5*K9*K0
       I3=K1
...
C
       call
     & sum134256(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z2,-1.000)
       deallocate(Z2)
       deallocate(X2)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,N1+1:N3))
     ...
     & N2,N3,N0,N2,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S832(N0+1:M1,N0+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,N1,N3,N0,N2,N0,M1,S832,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K0
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S856)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N0,N1,N1,N3,N0,M1,S832,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S843(N2+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,N0,M1,X8,S843, 1.000)
       deallocate(S843)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,N0,M1,S832,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S858(N2+1:M2,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K0
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S858)
       deallocate(D1)
       deallocate(D2)
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X9,S858,-1.000)
       deallocate(S858)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,N0,M1,S832,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S833(N1+1:M2,M1+1:N1,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X14,S833, 1.000)
       deallocate(S833)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,N0+1:M1))
       call reorder3241(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N0,N2,N1,N3,N0,M1,S832,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S913(N1+1:M2,N0+1:N2,N1+1:N3,N0+1:M1))
       I1=K5*K3*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N1,N3,N0,M1,
     & N0,N2,N1,N3,N1,M2,N0,M1,S913,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X7,S914, 1.000)
       deallocate(S914)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N2,N0,N1,N1,N3,N0,M1,S832,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S844(N2+1:M2,N1+1:M2,N1+1:N3,N0+1:M1))
       I1=K5*K3
       I2=K9*K0
       I3=K1*K2
       call EGEMM(I1,I2,I3,D1,D2,S844)
       deallocate(D1)
       deallocate(D2)
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,N0,M1,X7,S844, 1.000)
       deallocate(S844)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2314(N1,M2,N0,N2,N1,N3,N0,M1,
     & N0,N2,N1,N3,N1,M2,N0,M1,S913,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S915(N2+1:M2,N1+1:N3,N1+1:M2,N0+1:M1))
       I1=K5*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,N0,M1,X8,S915, 1.000)
       deallocate(S915)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N0+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,N2,N0,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       allocate(S731(N0+1:M1,M1+1:N1,N0+1:N2,N0+1:N1))
       I1=K1*K2
       I2=K7*K5
       I3=K3*K4
...
C
     ...
     & N0,N2,N0,N1,N0,M1,M1,N1,S731,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S864(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,D1,B2,S864)
       deallocate(D1)
       deallocate(B2)
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X3,S864,-1.000)
       deallocate(S864)
C
       call sumx2134(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       allocate(Z3(N2+1:M2,N1+1:M2,M1+1:N2,N2+1:M2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K0
       I2=K8*K9*K0
       I3=K1
...
C
       call
     & sum235146(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z3,-1.000)
       deallocate(Z3)
       deallocate(X3)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder4312(N0,M1,M1,N1,N0,N2,N0,N1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S731,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S732(N1+1:M2,N0+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X14,S732,-1.000)
       deallocate(S732)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder3412(N0,M1,M1,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S731,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S869(N2+1:M2,N0+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,N0,M1,M1,N1,X4,S869,-1.000)
       deallocate(S869)
C
       call sumx2134(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       allocate(Z4(N2+1:M2,N1+1:M2,M1+1:N2,N2+1:M2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K0
       I2=K8*K9*K0
       I3=K1
...
C
       call
     & sum135246(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z4, 1.000)
       deallocate(Z4)
       deallocate(X4)
C
     ...
     & N2,N3,M1,N2,t1B,B2)
       ...
       I2=K8
       I3=K4
       call EGEMM(I1,I2,I3,D1,B2,S871)
       deallocate(D1)
       deallocate(B2)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
     ...
     & N0,N2,N2,N3,N0,N2,M1,N2,S871,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S874(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X9,S874,-1.000)
       deallocate(S874)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
...
C
     ...
     & N0,N2,N0,N2,N2,N3,M1,N2,S871,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N2,M2,t2C,D2)
       allocate(S872(N2+1:M2,N2+1:M2,N2+1:N3,M1+1:N2))
       I1=K8*K4
       I2=K0*K0
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N2,M2,M1,N2,X11,S872,-0.500)
       deallocate(S872)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,M1+1:N2))
     ...
     & N2,N3,N0,N2,N0,N2,M1,N2,S871,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S916(N0+1:M1,N0+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
       call reorder2314(N0,M1,N0,N2,N0,N2,M1,N2,
     & N0,N2,N0,N2,N0,M1,M1,N2,S916,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X9,S917, 1.000)
       deallocate(S917)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
     ...
     & N0,N2,N0,N2,N2,N3,M1,N2,S871,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S919(N2+1:M2,N0+1:N2,N2+1:N3,M1+1:N2))
       I1=K8*K4*K2
       I2=K0
       I3=K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder2314(N2,M2,N0,N2,N2,N3,M1,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,S919,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S920(N2+1:M2,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X11,S920,-1.000)
       deallocate(S920)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder2431(M1,N2,N0,N2,N0,N2,N2,N3,
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S916,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S918(N2+1:M2,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X10,S918, 1.000)
       deallocate(S918)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,N2+1:N3))
       call reorder1342(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
     ...
     & N0,N2,N2,N3,N0,N2,N0,M1,S876,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S884(N2+1:M2,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X9,S884, 1.000)
       deallocate(S884)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
...
C
     ...
     & N0,N2,N0,N2,N2,N3,N0,M1,S876,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N2,M2,t2C,D2)
       allocate(S877(N2+1:M2,N2+1:M2,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K0*K0
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N2,M2,N0,M1,X12,S877,-0.500)
       deallocate(S877)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
     ...
     & N0,N2,N0,N2,N2,N3,N0,M1,S876,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S921(N2+1:M2,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K0
       I3=K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder2314(N2,M2,N0,N2,N2,N3,N0,M1,
     & N0,N2,N2,N3,N2,M2,N0,M1,S921,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S922(N2+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,N0,M1,X12,S922,-1.000)
       deallocate(S922)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder2431(N0,M1,N0,N2,N0,N2,N2,N3,
...
C
     ...
     & N2,N3,N0,N2,Q102,B1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(S896(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S896)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X10,S896,-1.000)
       deallocate(S896)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q102,B1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(S898(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S898)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X9,S898,-1.000)
       deallocate(S898)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S882)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       allocate(Z13(N2+1:M2,N2+1:M2,N0+1:M1,N1+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K9
       I2=K5*K0*K0
       I3=K2
...
C
       call
     & sum124356(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z13, 1.000)
       deallocate(Z13)
       deallocate(X13)
C
       allocate(B1(N2+1:N3,N0+1:N2))
     ...
     & N2,N3,N0,N2,Q102,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(S890(N1+1:M2,N0+1:M1,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S890)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X14,S890, 1.000)
       deallocate(S890)
C
       call sumx1234(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       allocate(Z14(N2+1:M2,N2+1:M2,M1+1:N2,N1+1:M2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K9
       I2=K8*K0*K0
       I3=K2
...
C
       call
     & sum125346(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z14,-1.000)
       deallocate(Z14)
       deallocate(X14)
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S891(N0+1:M1,M1+1:N2,N0+1:N2,N0+1:N2))
       I1=K2*K2
       I2=K8*K5
       I3=K4*K4
       call EGEMM(I1,I2,I3,D1,D2,S891)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
       call reorder3412(N0,M1,M1,N2,N0,N2,N0,N2,
     & N0,N2,N0,N2,N0,M1,M1,N2,S891,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S895(N2+1:M2,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X10,S895,-0.500)
       deallocate(S895)
C
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       allocate(Z10(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:M2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K0
       I2=K7*K9*K0
       I3=K2
...
C
       call
     & sum136245(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z10, 1.000)
       deallocate(Z10)
       deallocate(X10)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S891,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S892(N2+1:M2,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X9,S892,-0.500)
       deallocate(S892)
C
       call sumx2134(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       allocate(Z9(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:M2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K0
       I2=K7*K9*K0
       I3=K2
...
C
       call
     & sum236145(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z9,-1.000)
       deallocate(Z9)
       deallocate(X9)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S893(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K4*K2
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S893,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S897(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X16,S897,-1.000)
       deallocate(S897)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S893,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S894(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X15,S894,-1.000)
       deallocate(S894)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S722(N2+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K0
       I3=K4*K2
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,N0,M1,S722,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S723(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X7,S723,-1.000)
       deallocate(S723)
C
...
C
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z7(N2+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K0
       I2=K7*K8*K0
       I3=K3
...
C
       call
     & sum256134(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z7, 1.000)
       deallocate(Z7)
       deallocate(X7)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
...
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,S862,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S863(N2+1:M2,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X11,S863,-1.000)
       deallocate(S863)
C
...
C
       ...
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z33(N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       I1=K7
       I2=K8*K5*K9*K0*K0
       I3=K5
...
C
     ...
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S727(N2+1:M2,M1+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K8*K0
       I3=K4*K2
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,M1,N2,S727,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S728(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X6,S728,-1.000)
       deallocate(S728)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S729(N2+1:M2,M1+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K8*K0
       I3=K4*K2
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,M1,N2,S729,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S730(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X5,S730,-1.000)
       deallocate(S730)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S886)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,S886,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S887(N2+1:M2,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,D1,B2,S887)
       deallocate(D1)
       deallocate(B2)
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X11,S887, 1.000)
       deallocate(S887)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,N1+1:N3))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9
       I3=K4*K1
       call EGEMM(I1,I2,I3,D1,D2,S860)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S860,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S861(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X5,S861, 1.000)
       deallocate(S861)
C
       call sumx2341(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(Z5(N2+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2,M1+1:N2))
       I1=K8*K9*K0
       I2=K7*K5*K0
       I3=K3
...
C
       call
     & sum246135(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z5,-1.000)
       deallocate(Z5)
       deallocate(X5)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S860,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S865(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X6,S865, 1.000)
       deallocate(S865)
C
       call sumx2341(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       allocate(Z6(N2+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N1+1:M2,M1+1:N2))
       I1=K8*K9*K0
       I2=K7*K5*K0
       I3=K3
...
C
       call
     & sum146235(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z6, 1.000)
       deallocate(Z6)
       deallocate(X6)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S834(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K3*K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S834,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X15,S835,-1.000)
       deallocate(S835)
C
       call sumx2314(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N2,M2,N1,M2,M1,N1,X15,VBHPPP, 1.000)
C
       allocate(D2(N2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(Z15(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K0
       I2=K8*K5*K0
       I3=K4
...
C
       call
     & sum245136(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z15, 1.000)
       deallocate(Z15)
       deallocate(X15)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S834,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S836(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X16,S836,-1.000)
       deallocate(S836)
C
       call sumx2314(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(Z16(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K0
       I2=K8*K5*K0
       I3=K4
...
C
       call
     & sum145236(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z16,-1.000)
       deallocate(Z16)
       deallocate(X16)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S867(N2+1:M2,M1+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K8*K0
       I3=K3*K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,N2,M2,M1,N2,S867,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S868(N2+1:M2,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,N2,M2,N2,M2,M1,N2,X11,S868, 1.000)
       deallocate(S868)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
       call reorder4132(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S878)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,S878,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S879(N2+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,D1,B2,S879)
       deallocate(D1)
       deallocate(B2)
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,N0,M1,X12,S879, 1.000)
       deallocate(S879)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S880(N2+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K0
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N2,M2,N0,M1,S880,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S881(N2+1:M2,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,N2,M2,N2,M2,N0,M1,X12,S881, 1.000)
       deallocate(S881)
C
...
C
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z12(N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K0
       I2=K7*K8*K9
       I3=K4
...
C
       call
     & sum356124(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z12,-1.000)
       deallocate(Z12)
       deallocate(X12)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
     ...
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S720(N2+1:M2,N0+1:M1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K5*K0
       I3=K4*K2
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,N0,M1,S720,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S721(N1+1:M2,N1+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,N0,M1,X8,S721,-1.000)
       deallocate(S721)
C
       call sumx2341(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z8(N2+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2,N0+1:M1))
       I1=K5*K9*K0
       I2=K7*K8*K0
       I3=K3
...
C
       call
     & sum156234(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z8,-1.000)
       deallocate(Z8)
       deallocate(X8)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S888(N2+1:M2,M1+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K8*K0
       I3=K4*K2
       call EGEMM(I1,I2,I3,D1,D2,S888)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,N2,M2,M1,N2,S888,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S889(N2+1:M2,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,N2,M2,N2,M2,M1,N2,X11,S889, 1.000)
       deallocate(S889)
C
       call sumx2314(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       allocate(Z11(N1+1:M2,N0+1:M1,M1+1:N1,N2+1:M2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K0
       I2=K7*K5*K9
       I3=K4
...
C
       call
     & sum346125(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z11, 1.000)
       deallocate(Z11)
       deallocate(X11)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N1))
     ...
     & N0,M1,M2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z102(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z102, 1.000)
       deallocate(Z102)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & M1,N2,M2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z103(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K6*K8
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z103,-1.000)
       deallocate(Z103)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,M1,N2,M2,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z104(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K0*K5
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z104, 1.000)
       deallocate(Z104)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & M1,N2,N2,M2,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z105(N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K8*K5*K0*K0
       I3=K0*K8
...
C
       call
     & sum124536(N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z105,-1.000)
       deallocate(Z105)
C
       call sumx3(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,HT3C1,V3C,1.0)
       deallocate(V3C)
C
       end
