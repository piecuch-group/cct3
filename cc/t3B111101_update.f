...
C
     ...
     & M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,M1,N1,t3B3,F2)
       ...
       I2=K7*K7*K8*K6*K0
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z297)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,N2,M2,M2,N3,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K6*K0
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z298)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z439)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z440)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z441)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z442)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3B3,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X72,F2,Z105)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3B3,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X73,F2,Z106)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X74,F2,Z107)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K9*K7
       call EGEMM(I1,I2,I3,X75,F2,Z108)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X97,F2,Z327)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X93,F2,Z323)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X99,F2,Z329)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X95,F2,Z325)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X98,F2,Z328)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X94,F2,Z324)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X100,F2,Z330)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X96,F2,Z326)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X76,F2,Z133)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X77,F2,Z134)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X78,F2,Z135)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K7
       call EGEMM(I1,I2,I3,X79,F2,Z136)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N1,M1,N1,t3B3,F2)
       ...
       I2=K7*K7*K6*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X84,F2,Z141)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X80,F2,Z137)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K6*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X86,F2,Z143)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K0
       I3=K9*K5
       call EGEMM(I1,I2,I3,X82,F2,Z139)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N1,M1,N1,t3B3,F2)
       ...
       I2=K7*K7*K6*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X85,F2,Z142)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X81,F2,Z138)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,N2,M2,M2,N3,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K6*K0
       I3=K9*K8
       call EGEMM(I1,I2,I3,X87,F2,Z144)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K0
       I3=K9*K8
       call EGEMM(I1,I2,I3,X83,F2,Z140)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6*K0
       I3=K5
       call EGEMM(I1,I2,I3,X88,F2,Z145)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6*K0
       I3=K8
       call EGEMM(I1,I2,I3,X89,F2,Z146)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9*K6
       I3=K6
       call EGEMM(I1,I2,I3,X90,F2,Z154)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9*K6
       I3=K0
       call EGEMM(I1,I2,I3,X91,F2,Z155)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,M2,N3,M1,N2,t2B,D2)
       ...
       I2=K8*K6*K0
       I3=K1
       call EGEMM(I1,I2,I3,X71,D2,Z80)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S578)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S571)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,X105,D2,Z346)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K0
       I3=K2
       call EGEMM(I1,I2,I3,X104,D2,Z345)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S587)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q90,D2,S586)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,X102,D2,Z339)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q80,D2,S539)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,X101,D2,Z331)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S541)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X103,D2,Z341)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call EGEMM(I1,I2,I3,X92,D2,Z237)
       deallocate(D2)
C
       call
