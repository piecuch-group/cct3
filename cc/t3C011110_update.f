...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K8*K0*K6
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z242)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K8*K0*K6
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z243)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call EGEMM(I1,I2,I3,X102,D2,Z448)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X89,F2,Z236)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X90,F2,Z237)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X91,F2,Z238)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K9*K7
       call EGEMM(I1,I2,I3,X92,F2,Z239)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X93,F2,Z244)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X94,F2,Z245)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X95,F2,Z246)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X96,F2,Z247)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X69,F2,Z103)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N1,M2,M1,N2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K8*K9*K0
       I3=K6
       call EGEMM(I1,I2,I3,X83,F2,Z121)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K8*K9*K6
       I3=K6
       call EGEMM(I1,I2,I3,X85,F2,Z126)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,Q77,D2,S461)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,X101,D2,Z270)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q78,D2,S480)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S478)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,Q89,D2,S549)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,X87,D2,Z146)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q90,D2,S571)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,X99,D2,Z253)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,X97,D2,Z248)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X100,D2,Z261)
       deallocate(D2)
C
       call
