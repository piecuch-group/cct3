...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,X18,B2,Z42)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,N2,M2,M2,N3,M2,N3,M1,N1,t3C4,F2)
       ...
       I2=K7*K6*K6
       I3=K0*K5*K5
       call EGEMM(I1,I2,I3,X13,F2,Z30)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,M2,N3,M1,N1,t3C1,F2)
       ...
       I2=K7*K6*K6
       I3=K0*K8*K5
       call EGEMM(I1,I2,I3,X14,F2,Z31)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,M2,N3,M2,N3,M1,N1,t3C1,F2)
       ...
       I2=K7*K6*K6
       I3=K0*K8*K8
       call EGEMM(I1,I2,I3,X15,F2,Z32)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,X19,B2,Z80)
       deallocate(B2)
C
       V2B=V2B-Z80
       deallocate(Z80)
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6
       I3=K0*K0*K5
       call EGEMM(I1,I2,I3,X16,F2,Z35)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6
       I3=K0*K0*K8
       call EGEMM(I1,I2,I3,X17,F2,Z36)
       deallocate(F2)
C
       call
