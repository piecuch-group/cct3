...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S135)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9*K0
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z296)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z444)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z496)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z499)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X94,F2,Z326)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,X90,F2,Z322)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X96,F2,Z328)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,X92,F2,Z324)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X95,F2,Z327)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X91,F2,Z323)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X97,F2,Z329)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X93,F2,Z325)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K9
       I3=K6*K5
       call EGEMM(I1,I2,I3,X73,F2,Z130)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K9
       I3=K6*K7
       call EGEMM(I1,I2,I3,X74,F2,Z131)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K9
       I3=K0*K5
       call EGEMM(I1,I2,I3,X75,F2,Z132)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9*K9
       I3=K6
       call EGEMM(I1,I2,I3,X87,F2,Z152)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9*K9
       I3=K0
       call EGEMM(I1,I2,I3,X88,F2,Z153)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S520)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,X67,D2,Z76)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,X68,D2,Z77)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S548)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S580)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S589)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call EGEMM(I1,I2,I3,X89,D2,Z236)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X100,D2,Z342)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X99,D2,Z340)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S598)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S597)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,X98,D2,Z338)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,X102,D2,Z345)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,X101,D2,Z344)
       deallocate(D2)
C
       call
