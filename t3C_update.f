       subroutine t3C_update(N0,N1,N2,N3,V3C,
     & K1,K2,K3,K4,
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N1,N2,N3,N0,N2,N0,N1,X1,S7,-1.000)
       deallocate(S7)
C
     ...
     & N2,N3,N0,N2,t1B,B2)
       ...
       deallocate(B2)
C
       call sum3124(N0,N1,N2,N3,N0,N2,N0,N1,X1,S8, 1.000)
       deallocate(S8)
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N1,N3,N2,N3,N1,N3,N0,N2,X2,S9,-1.000)
       deallocate(S9)
C
     ...
     & N2,N3,N0,N2,t1B,B2)
       ...
       deallocate(B2)
C
       call sum4123(N1,N3,N2,N3,N1,N3,N0,N2,X2,S10, 1.000)
       deallocate(S10)
C
...
C
       ...
       X3=0.0d0
       call sum2134(N0,N2,N2,N3,N0,N2,N0,N2,X3,S11, 1.000)
       deallocate(S11)
C
...
C
       ...
       X7=0.0d0
       call sum3124(N0,N2,N2,N3,N0,N2,N0,N2,X7,S12, 1.000)
       deallocate(S12)
C
...
C
       ...
       X8=0.0d0
       call sum3124(N2,N3,N2,N3,N2,N3,N0,N2,X8,S13, 1.000)
       deallocate(S13)
C
...
C
       ...
       X4=0.0d0
       call sum4123(N2,N3,N2,N3,N2,N3,N0,N2,X4,S14,-1.000)
       deallocate(S14)
C
...
C
     ...
     & N0,N1,N1,N3,N1,N3,N0,N1,t2A,D2)
       ...
       deallocate(D2)
C
       call sum2413(N0,N2,N1,N3,N0,N2,N0,N1,X5,S17, 1.000)
       deallocate(S17)
C
     ...
     & N0,N1,N1,N3,N1,N3,N0,N1,t2A,D2)
       ...
       deallocate(D2)
C
       call sum3412(N2,N3,N2,N3,N1,N3,N0,N1,X6,S18, 1.000)
       deallocate(S18)
C
     ...
     & N1,N3,N2,N3,N0,N2,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N1,N2,N3,N0,N2,N0,N1,X1,S19, 1.000)
       deallocate(S19)
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N1,N2,N3,N0,N2,N0,N1,X1,S20, 1.000)
       deallocate(S20)
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2413(N1,N3,N2,N3,N1,N3,N0,N2,X2,S21, 1.000)
       deallocate(S21)
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N1,N3,N2,N3,N1,N3,N0,N2,X2,S22, 1.000)
       deallocate(S22)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:N2))
       call reorder4231(N0,N3,N0,N3,N0,N3,N0,N3,
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N2,N2,N3,N0,N2,N0,N2,X7,S23,-1.000)
       deallocate(S23)
C
     ...
     & N0,N2,N1,N3,N2,N3,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2413(N0,N1,N2,N3,N0,N2,N0,N1,X1,S24,-1.000)
       deallocate(S24)
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum3412(N1,N3,N2,N3,N1,N3,N0,N2,X2,S25,-1.000)
       deallocate(S25)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:N3))
       call reorder4213(N0,N3,N0,N3,N0,N3,N0,N3,
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum3412(N2,N3,N2,N3,N2,N3,N0,N2,X8,S26, 1.000)
       deallocate(S26)
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum3412(N0,N1,N2,N3,N0,N2,N0,N1,X1,S27, 1.000)
       deallocate(S27)
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N2,N1,N3,N0,N2,N0,N1,X5,S28, 1.000)
       deallocate(S28)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(0,N3,0,N3,
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N2,N2,N3,N0,N2,N0,N2,X3,S29, 1.000)
       deallocate(S29)
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N1,N2,N3,N0,N2,N0,N1,X1,S30, 1.000)
       deallocate(S30)
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N2,N1,N3,N0,N2,N0,N1,X5,S31,-1.000)
       deallocate(S31)
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N2,N3,N2,N3,N1,N3,N0,N1,X6,S32, 1.000)
       deallocate(S32)
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2413(N1,N3,N2,N3,N1,N3,N0,N2,X2,S33, 1.000)
       deallocate(S33)
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum3412(N0,N2,N1,N3,N0,N2,N0,N1,X5,S34, 1.000)
       deallocate(S34)
C
     ...
     & N0,N2,N1,N3,N2,N3,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2413(N2,N3,N2,N3,N1,N3,N0,N1,X6,S35,-1.000)
       deallocate(S35)
C
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2314(N2,N3,N2,N3,N2,N3,N0,N2,X4,S36, 0.500)
       deallocate(S36)
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N2,N2,N3,N0,N2,N0,N2,X7,S37,-1.000)
       deallocate(S37)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:N2))
       call reorder4132(N0,N3,N0,N3,N0,N3,N0,N3,
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2413(N0,N2,N1,N3,N0,N2,N0,N1,X5,S38,-1.000)
       deallocate(S38)
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum3412(N2,N3,N2,N3,N2,N3,N0,N2,X8,S39, 1.000)
       deallocate(S39)
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum3412(N0,N2,N2,N3,N0,N2,N0,N2,X3,S40, 0.500)
       deallocate(S40)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:N3))
       call reorder3214(N0,N3,N0,N3,N0,N3,N0,N3,
...
C
     ...
     & N0,N2,N0,N1,N0,N2,N0,N1,S42,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N1,N2,N3,N0,N2,N0,N1,X1,S46,-1.000)
       deallocate(S46)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:N2,N0+1:N1))
       call reorder3241(N0,N1,N0,N2,N0,N1,N0,N2,
     & N0,N1,N0,N2,N0,N2,N0,N1,S42,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N2,N1,N3,N0,N2,N0,N1,X5,S43,-1.000)
       deallocate(S43)
C
...
C
     ...
     & N2,N3,N0,N1,N2,N3,N0,N1,S44,D1)
       allocate(B2(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,N2,t1B,B2)
       ...
       deallocate(B2)
C
       call sum3124(N0,N1,N2,N3,N0,N2,N0,N1,X1,S47, 1.000)
       deallocate(S47)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:N3,N0+1:N1))
       call reorder2341(N0,N1,N0,N1,N2,N3,N2,N3,
     & N0,N1,N2,N3,N2,N3,N0,N1,S44,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
       ...
       deallocate(B2)
C
       call sum3124(N2,N3,N2,N3,N1,N3,N0,N1,X6,S45,-1.000)
       deallocate(S45)
C
...
C
     ...
     & N0,N2,N1,N3,N1,N3,N0,N2,S48,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N1,N3,N2,N3,N1,N3,N0,N2,X2,S49, 1.000)
       deallocate(S49)
C
...
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,S50,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
       ...
       deallocate(B2)
C
       call sum3124(N1,N3,N2,N3,N1,N3,N0,N2,X2,S51,-1.000)
       deallocate(S51)
C
...
C
     ...
     & N0,N2,N0,N1,N0,N2,N0,N1,S52,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N1,N2,N3,N0,N2,N0,N1,X1,S76,-1.000)
       deallocate(S76)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:N2,N0+1:N1))
       call reorder3214(N0,N2,N0,N2,N0,N1,N0,N1,
     & N0,N1,N0,N2,N0,N2,N0,N1,S52,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N2,N1,N3,N0,N2,N0,N1,X5,S53,-1.000)
       deallocate(S53)
C
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,S56,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N2,N3,N2,N3,N1,N3,N0,N1,X6,S58,-1.000)
       deallocate(S58)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:N3,N0+1:N1))
       call reorder3241(N0,N1,N0,N2,N2,N3,N1,N3,
     & N2,N3,N0,N2,N1,N3,N0,N1,S56,D1)
       allocate(B2(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,N2,t1B,B2)
       ...
       deallocate(B2)
C
       call sum3124(N0,N2,N1,N3,N0,N2,N0,N1,X5,S57, 1.000)
       deallocate(S57)
C
...
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N1,N2,N3,N0,N2,N0,N1,X1,S60, 1.000)
       deallocate(S60)
C
...
C
     ...
     & N0,N1,N1,N3,t1A,B2)
       ...
       deallocate(B2)
C
       call sum3124(N1,N3,N2,N3,N1,N3,N0,N2,X2,S62,-1.000)
       deallocate(S62)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N0,N3,N0,N3,N0,N3,N0,N3,
...
C
     ...
     & N1,N3,N2,N3,N0,N2,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N1,N2,N3,N0,N2,N0,N1,X1,S63, 1.000)
       deallocate(S63)
C
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N2,N1,N3,N0,N2,N0,N1,X5,S66,-1.000)
       deallocate(S66)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,N0+1:N1))
       call reorder2341(N0,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,N0,N1,S64,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N2,N3,N2,N3,N1,N3,N0,N1,X6,S67, 1.000)
       deallocate(S67)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,N0+1:N1))
...
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:N2,N0+1:N1))
       call reorder3214(N0,N2,N0,N2,N0,N1,N0,N1,
     & N0,N1,N0,N2,N0,N2,N0,N1,S111,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,S113,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N2,N3,N2,N3,N1,N3,N0,N1,X6,S114, 1.000)
       deallocate(S114)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N0+1:N1))
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N1,N2,N3,N0,N2,N0,N1,X1,S65, 1.000)
       deallocate(S65)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:N2,N0+1:N1))
       call reorder2314(N0,N2,N0,N2,N0,N1,N0,N1,
     & N0,N2,N0,N1,N0,N2,N0,N1,S111,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N1,N2,N3,N0,N2,N0,N1,X1,S115,-1.000)
       deallocate(S115)
C
...
C
     ...
     & N2,N3,N0,N1,N2,N3,N0,N1,S73,D1)
       allocate(B2(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,N2,t1B,B2)
...
C
     ...
     & N0,N1,N2,N3,N2,N3,N0,N1,S73,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
       ...
       deallocate(B2)
C
       call sum3124(N2,N3,N2,N3,N1,N3,N0,N1,X6,S74, 1.000)
       deallocate(S74)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,N0+1:N1))
       call reorder4312(N0,N3,N0,N3,N0,N3,N0,N3,
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N0+1:N1))
       call reorder2314(N1,N3,N0,N2,N2,N3,N0,N1,
     & N0,N2,N2,N3,N1,N3,N0,N1,S54,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N2,N3,N2,N3,N1,N3,N0,N1,X6,S55, 1.000)
       deallocate(S55)
C
...
C
     ...
     & N0,N2,N1,N3,N1,N3,N0,N2,S77,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N1,N3,N2,N3,N1,N3,N0,N2,X2,S78,-1.000)
       deallocate(S78)
C
...
C
     ...
     & N0,N2,N0,N2,N0,N2,N0,N2,S79,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N2,N2,N3,N0,N2,N0,N2,X7,S80, 1.000)
       deallocate(S80)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:N2))
       call reorder4312(N0,N3,N0,N3,N0,N3,N0,N3,
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,S81,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N2,N3,N2,N3,N2,N3,N0,N2,X4,S82, 1.000)
       deallocate(S82)
C
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,S83,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum3124(N2,N3,N2,N3,N2,N3,N0,N2,X8,S85, 1.000)
       deallocate(S85)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:N3,N0+1:N2))
       call reorder3241(N0,N2,N0,N2,N2,N3,N2,N3,
     & N2,N3,N0,N2,N2,N3,N0,N2,S83,D1)
       allocate(B2(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,N2,t1B,B2)
       ...
       deallocate(B2)
C
       call sum3124(N0,N2,N2,N3,N0,N2,N0,N2,X3,S84, 1.000)
       deallocate(S84)
C
...
C
     ...
     & N0,N2,N0,N1,N1,N3,N0,N2,S86,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N1,N3,N2,N3,N1,N3,N0,N2,X2,S90, 1.000)
       deallocate(S90)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:N2))
       call reorder3421(N0,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,N0,N2,S86,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:N3,N0+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N2,N2,N3,N0,N2,N0,N2,X7,S91,-1.000)
       deallocate(S91)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,N0+1:N2))
       call reorder3241(N0,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N0,N2,N1,N3,N0,N2,S86,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:N3,N0+1:N2))
       call reorder2314(N1,N3,N0,N2,N1,N3,N0,N2,
     & N0,N2,N1,N3,N1,N3,N0,N2,S116,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N1,N3,N2,N3,N1,N3,N0,N2,X2,S117, 1.000)
       deallocate(S117)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:N2))
       call reorder3421(N0,N2,N0,N2,N0,N1,N1,N3,
     ...
     & N0,N1,N1,N3,N1,N3,N0,N1,t2A,D2)
       ...
       deallocate(D2)
C
       call sum2413(N0,N2,N1,N3,N0,N2,N0,N1,X5,S87, 1.000)
       deallocate(S87)
C
...
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N2,N1,N3,N0,N2,N0,N1,X5,S72, 1.000)
       deallocate(S72)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N2,N2,N3,N0,N2,N0,N2,X3,S75, 1.000)
       deallocate(S75)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N0,N3,N0,N3,N0,N3,N0,N3,
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,S95,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N2,N3,N2,N3,N2,N3,N0,N2,X8,S96,-1.000)
       deallocate(S96)
C
...
C
     ...
     & N0,N1,N0,N2,N0,N2,N0,N1,S70,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N2,N1,N3,N0,N2,N0,N1,X5,S71,-1.000)
       deallocate(S71)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:N2,N0+1:N1))
       call reorder3412(N0,N2,N0,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N0,N2,N0,N1,S70,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N1,N2,N3,N0,N2,N0,N1,X1,S97,-1.000)
       deallocate(S97)
C
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2314(N0,N2,N2,N3,N0,N2,N0,N2,X7,S101, 1.000)
       deallocate(S101)
C
       allocate(D2(N0+1:N2,N2+1:N3,N1+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum236145(N2,N3,N2,N3,N1,N3,N0,N2,N0,N2,N0,N1,V3C,U18, 1.000)
       call
     & sum136245(N2,N3,N2,N3,N1,N3,N0,N2,N0,N2,N0,N1,V3C,U18,-1.000)
       call
     & sum236154(N2,N3,N2,N3,N1,N3,N0,N2,N0,N2,N0,N1,V3C,U18,-1.000)
       call
     & sum136254(N2,N3,N2,N3,N1,N3,N0,N2,N0,N2,N0,N1,V3C,U18, 1.000)
       deallocate(U18)
       deallocate(X7)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:N2))
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2413(N0,N2,N1,N3,N0,N2,N0,N1,X5,S102, 1.000)
       deallocate(S102)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,N0+1:N2))
       call reorder4231(N0,N2,N0,N2,N0,N2,N2,N3,
     & N2,N3,N0,N2,N0,N2,N0,N2,S99,D1)
       allocate(B2(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,N2,t1B,B2)
...
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:N2,N0+1:N2))
       call reorder2314(N0,N2,N0,N2,N0,N2,N0,N2,
     & N0,N2,N0,N2,N0,N2,N0,N2,S118,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N2,N2,N3,N0,N2,N0,N2,X3,S119,-1.000)
       deallocate(S119)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:N2))
       call reorder3241(N0,N2,N0,N2,N0,N2,N2,N3,
     & N0,N2,N0,N2,N2,N3,N0,N2,S99,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N0+1:N2))
       call reorder2314(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N0,N2,S120,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N2,N3,N2,N3,N2,N3,N0,N2,X4,S121,-1.000)
       deallocate(S121)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:N2))
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2314(N2,N3,N2,N3,N2,N3,N0,N2,X4,S100,-0.500)
       deallocate(S100)
C
       call sumxold1423(N0,N3,N2,N3,N2,N3,N2,N3,N0,N2,X4,IntB, 1.000)
C
       allocate(D2(N2+1:N3,N1+1:N3,N0+1:N2,N0+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,N0,N2,N0,N1,t2B,D2)
...
C
     ...
     & N0,N2,N0,N2,N0,N2,N0,N2,S106,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N0,N2,N2,N3,N0,N2,N0,N2,X3,S107, 0.500)
       deallocate(S107)
C
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,S108,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
...
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N2,N1,N3,N0,N2,N0,N1,X5,S105, 1.000)
       deallocate(S105)
C
...
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N2,N2,N3,N0,N2,N0,N2,X3,S110, 1.000)
       deallocate(S110)
C
       call sumxold3412(N0,N3,N0,N2,N2,N3,N0,N2,N0,N2,X3,IntB, 1.000)
C
       allocate(D2(N0+1:N2,N2+1:N3,N1+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
...
C
     ...
     & N1,N3,N2,N3,N0,N2,N0,N1,t2B,D2)
       ...
       deallocate(D2)
C
       call sum2341(N0,N1,N2,N3,N0,N2,N0,N1,X1,S98, 1.000)
       deallocate(S98)
C
...
C
     ...
     & N0,N2,N1,N3,N1,N3,N0,N2,S93,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N1,N3,N2,N3,N1,N3,N0,N2,X2,S94, 1.000)
       deallocate(S94)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N0,N3,N0,N3,N0,N3,N0,N3,
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N0+1:N1))
       call reorder3412(N1,N3,N0,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,N3,N0,N1,S88,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N2,N3,N2,N3,N1,N3,N0,N1,X6,S89,-1.000)
       deallocate(S89)
C
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N0+1:N2))
       call reorder3412(N2,N3,N0,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,N2,N3,N0,N2,S103,D1)
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       call sum2134(N2,N3,N2,N3,N2,N3,N0,N2,X8,S104, 1.000)
       deallocate(S104)
C
       allocate(D2(N2+1:N3,N1+1:N3,N0+1:N2,N0+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum346125(N2,N3,N2,N3,N1,N3,N0,N2,N0,N2,N0,N1,V3C,U19, 1.000)
       call
     & sum346215(N2,N3,N2,N3,N1,N3,N0,N2,N0,N2,N0,N1,V3C,U19,-1.000)
       call
     & sum356124(N2,N3,N2,N3,N1,N3,N0,N2,N0,N2,N0,N1,V3C,U19,-1.000)
       call
     & sum356214(N2,N3,N2,N3,N1,N3,N0,N2,N0,N2,N0,N1,V3C,U19, 1.000)
       deallocate(U19)
       deallocate(X8)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N0+1:N2))
       call reorder3412(N2,N3,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,N3,N0,N2,S68,D1)
       allocate(B2(N0+1:N1,N1+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,N3,t1A,B2)
       ...
       deallocate(S68)
C
       call sum3124(N1,N3,N2,N3,N1,N3,N0,N2,X2,S69,-1.000)
       deallocate(S69)
C
