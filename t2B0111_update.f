...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call EGEMM(I1,I2,I3,X29,B2,Z74)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K9
       I3=K9*K0*K5
       call EGEMM(I1,I2,I3,X17,F2,Z29)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K9
       I3=K9*K0*K7
       call EGEMM(I1,I2,I3,X18,F2,Z30)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       ...
       I2=K5*K9*K0
       I3=K6*K8*K5
       call EGEMM(I1,I2,I3,X23,F2,Z51)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       ...
       I2=K5*K9*K0
       I3=K6*K8*K8
       call EGEMM(I1,I2,I3,X24,F2,Z52)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,X30,B2,Z138)
       deallocate(B2)
C
       V2B=V2B-Z138
       deallocate(Z138)
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9
       I3=K0*K0*K5
       call EGEMM(I1,I2,I3,X27,F2,Z59)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9
       I3=K0*K0*K8
       call EGEMM(I1,I2,I3,X28,F2,Z60)
       deallocate(F2)
C
       call
