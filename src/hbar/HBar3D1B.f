...
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K4
       I3=K3*K1
       call DMATMAT(I1,I2,I3,D1,D2,S4)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,X2,B2,U5)
       deallocate(B2)
C
       V3D1B=V3D1B-U5
       call
...
C
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,t2C,D2)
       ...
       I2=K4*K4
       I3=K2*K2
       call DMATMAT(I1,I2,I3,X3,D2,U8)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,D1,B2,U20)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,X4,B2,U12)
       deallocate(B2)
C
       V3D1B=V3D1B+U12
       deallocate(U12)
