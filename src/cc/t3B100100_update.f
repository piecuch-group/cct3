...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U171)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z172)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U248)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,D1,F2,Z323)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,M2,N3,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K6*K6
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z341)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S248)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z527)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U536)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z537)
       deallocate(F1)
       deallocate(D2)
C
       V3B=V3B+Z537
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,U696)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X98,B2,Z249)
       deallocate(B2)
C
       V3B=V3B-Z249
       deallocate(Z249)
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C2,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X75,F2,Z76)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C3,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X76,F2,Z77)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X77,F2,Z78)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X78,F2,Z79)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X79,F2,Z122)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X80,F2,Z133)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X81,F2,Z134)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q58,B2,Q60)
       deallocate(B2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3C3,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X99,F2,Z354)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X101,F2,Z356)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X100,F2,Z355)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C2,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X102,F2,Z363)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C3,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X103,F2,Z364)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X106,F2,Z367)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X104,F2,Z365)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X107,F2,Z368)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X105,F2,Z366)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X82,F2,Z153)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X83,F2,Z154)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X84,F2,Z159)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X85,F2,Z160)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X86,F2,Z161)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X87,F2,Z162)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X88,F2,Z163)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X89,F2,Z164)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X92,F2,Z167)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X90,F2,Z165)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X93,F2,Z168)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X91,F2,Z166)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6*K6
       I3=K5
       call DMATMAT(I1,I2,I3,X94,F2,Z169)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6*K6
       I3=K8
       call DMATMAT(I1,I2,I3,X95,F2,Z170)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9*K6
       I3=K6
       call DMATMAT(I1,I2,I3,X96,F2,Z179)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9*K6
       I3=K0
       call DMATMAT(I1,I2,I3,X97,F2,Z180)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S637)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S642)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S647)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S635)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S686)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S676)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S678)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S684)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6
       I3=K4*K2
       call DMATMAT(I1,I2,I3,D1,D2,S670)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N1,N3,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6
       I3=K3*K2
       call DMATMAT(I1,I2,I3,D1,D2,S675)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5
       I3=K3*K4
       call DMATMAT(I1,I2,I3,D1,D2,S677)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6
       I3=K4*K2
       call DMATMAT(I1,I2,I3,D1,D2,S689)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S719)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S738)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5
       I3=K3*K4
       call DMATMAT(I1,I2,I3,D1,D2,S673)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S749)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S754)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S755)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S748)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N1,N3,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6
       I3=K3*K2
       call DMATMAT(I1,I2,I3,D1,D2,S671)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N2+1:N3,N0+1:N1,M2+1:N3,N0+1:M1))
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z75)
       deallocate(D1)
       deallocate(F2)
C
       call
