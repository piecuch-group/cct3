       subroutine t2B0110_update(N0,N1,N2,N3,HT2B,shift,
...
C
       allocate(V2B(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       V2B=0.0d0
C
...
C
     ...
     & N0,M1,N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,t3B4,F2)
       allocate(Z5(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K6*K5*K5
...
C
     ...
     & N0,M1,M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,t3B1,F2)
       allocate(Z6(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K6*K7*K5
...
C
     ...
     & M1,N1,M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,t3B1,F2)
       allocate(Z7(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K6*K7*K7
...
C
     ...
     & N0,M1,N0,M1,N1,M2,M2,N3,N1,M2,M1,N2,t3B4,F2)
       allocate(Z8(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K9*K5*K5
...
C
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,N1,M2,M1,N2,t3B1,F2)
       allocate(Z9(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K9*K7*K5
...
C
     ...
     & M1,N1,M1,N1,N1,M2,M2,N3,N1,M2,M1,N2,t3B1,F2)
       allocate(Z10(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K9*K7*K7
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       allocate(S69(N1+1:M2,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K9
       I3=K1
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,S69,D1)
     ...
     & N0,M1,M2,N3,N1,M2,M2,N3,M1,N2,N0,M1,t3B4,F2)
       allocate(Z70(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K6*K5
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z70,-1.000)
       deallocate(Z70)
       deallocate(S69)
C
     ...
     & N0,N1,M1,N1,M2,N3,N1,M2,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S71(N1+1:M2,M1+1:N1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K7
       I2=K9
       I3=K1
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,S71,D1)
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,M1,N2,N0,M1,t3B1,F2)
       allocate(Z72(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K6*K7
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z72, 1.000)
       deallocate(Z72)
       deallocate(S71)
C
     ...
     & N0,N1,N0,M1,N1,M2,N1,M2,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S73(N1+1:M2,N0+1:M1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z74,-0.500)
       deallocate(Z74)
       deallocate(S73)
C
     ...
     & N0,N1,M1,N1,N1,M2,N1,M2,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S75(N1+1:M2,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z76, 0.500)
       deallocate(Z76)
       deallocate(S75)
C
...
C
     ...
     & N1,N3,N0,M1,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S81(N0+1:M1,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5*K5
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,M1,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S83(N0+1:M1,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K8
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S85(N0+1:M1,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K5
       I2=K5
       I3=K3
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N0,M1,S85,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2))
       call reorder461235(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,t3C3,F2)
       allocate(Z86(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K6*K7*K5
...
C
     ...
     & N1,N3,M1,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S87(N0+1:M1,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K8
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S89(N0+1:M1,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5*K5
       I2=K5
       I3=K3
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N0,M1,S89,D1)
     ...
     & N0,M1,N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,t3C1,F2)
       allocate(Z90(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K0*K5*K5
...
C
     ...
     & N1,N3,M1,N2,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S91(N0+1:M1,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K8
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S93(N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2))
       I1=K0*K7*K5
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,M1,N2,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S95(N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0*K7*K8
       I2=K5
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S97(N1+1:M2,N0+1:M1,N2+1:M2,M2+1:N3))
       I1=K6*K0*K5
       I2=K9
       I3=K1
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,S97,D1)
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3C1,F2)
       allocate(Z98(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K6*K0*K5
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z98, 1.000)
       deallocate(Z98)
       deallocate(S97)
C
     ...
     & N0,N1,M1,N2,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S99(N1+1:M2,M1+1:N2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z100, 1.000)
       deallocate(Z100)
       deallocate(S99)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,N1+1:M2))
     ...
     & N0,N1,N0,M1,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S101(N1+1:M2,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z102,-1.000)
       deallocate(Z102)
       deallocate(S101)
C
     ...
     & N0,N1,M1,N2,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S103(N1+1:M2,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z104,-1.000)
       deallocate(Z104)
       deallocate(S103)
C
     ...
     & N0,N1,N0,M1,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S105(N1+1:M2,N0+1:M1,N2+1:M2,N1+1:M2))
       I1=K9*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z106, 1.000)
       deallocate(Z106)
       deallocate(S105)
C
     ...
     & N0,N1,M1,N2,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S107(N1+1:M2,M1+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z108, 1.000)
       deallocate(Z108)
       deallocate(S107)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(Z109(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K6*K5
       call DVECMAT(I2,I3,Q5,F2,Z109)
       deallocate(F2)
C
       V2B=V2B+Z109
       deallocate(Z109)
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(Z110(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K6*K8
       call DVECMAT(I2,I3,Q6,F2,Z110)
       deallocate(F2)
C
       V2B=V2B+Z110
       deallocate(Z110)
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z111(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K0*K5
       call DVECMAT(I2,I3,Q7,F2,Z111)
       deallocate(F2)
C
       V2B=V2B-Z111
       deallocate(Z111)
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z112(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K0*K8
       call DVECMAT(I2,I3,Q8,F2,Z112)
       deallocate(F2)
C
       V2B=V2B-Z112
       deallocate(Z112)
...
C
     ...
     & N2,N3,M1,N2,t1B,B2)
       allocate(S113(M1+1:N2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K8
       I2=K8
       I3=K4
...
C
       ...
       X11=0.0d0
       call
     & sum4123(M1,N2,N0,M1,M2,N3,M1,N2,X11,S113, 1.000)
       deallocate(S113)
C
...
C
     ...
     & M1,N2,N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,t3B4,F2)
       allocate(Z15(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K6*K5*K8
...
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z15,-1.000)
       deallocate(Z15)
       deallocate(X11)
C
     ...
     & N2,N3,N0,M1,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S115(M1+1:N2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K5
       I2=K8
       I3=K4
...
C
       ...
       X12=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M2,N3,M1,N2,X12,S115, 1.000)
       deallocate(S115)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,t3B1,F2)
       allocate(Z16(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K6*K7*K5
...
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z16, 1.000)
       deallocate(Z16)
       deallocate(X12)
C
     ...
     & N2,N3,M1,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S117(M1+1:N2,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K8
       I2=K8
       I3=K4
...
C
       ...
       X13=0.0d0
       call
     & sum4123(M1,N2,M1,N1,M2,N3,M1,N2,X13,S117, 1.000)
       deallocate(S117)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,t3B1,F2)
       allocate(Z17(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K6*K7*K8
       call DMATMAT(I1,I2,I3,X13,F2,Z17)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z17, 1.000)
       deallocate(Z17)
       deallocate(X13)
C
     ...
     & N2,N3,M1,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S119(M1+1:N2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K8
       I2=K8
       I3=K4
...
C
       ...
       X14=0.0d0
       call
     & sum4123(M1,N2,N0,M1,N1,M2,M1,N2,X14,S119, 1.000)
       deallocate(S119)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,N0,M1,N1,M2,M2,N3,N1,M2,N0,M1,t3B4,F2)
       allocate(Z18(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K9*K5*K8
       call DMATMAT(I1,I2,I3,X14,F2,Z18)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z18,-1.000)
       deallocate(Z18)
       deallocate(X14)
C
     ...
     & N2,N3,N0,M1,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S121(M1+1:N2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K5
       I2=K8
       I3=K4
...
C
       ...
       X15=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N1,M2,M1,N2,X15,S121, 1.000)
       deallocate(S121)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,N1,M2,N0,M1,t3B1,F2)
       allocate(Z19(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K9*K7*K5
       call DMATMAT(I1,I2,I3,X15,F2,Z19)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z19, 1.000)
       deallocate(Z19)
       deallocate(X15)
C
     ...
     & N2,N3,M1,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S123(M1+1:N2,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K8
       I2=K8
       I3=K4
...
C
       ...
       X16=0.0d0
       call
     & sum4123(M1,N2,M1,N1,N1,M2,M1,N2,X16,S123, 1.000)
       deallocate(S123)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,N1,M2,M2,N3,N1,M2,N0,M1,t3B1,F2)
       allocate(Z20(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K9*K7*K8
       call DMATMAT(I1,I2,I3,X16,F2,Z20)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z20, 1.000)
       deallocate(Z20)
       deallocate(X16)
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(S125(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K6*K5
       ...
       deallocate(F2)
C
       allocate(X25(N0+1:N2,N1+1:M2,M1+1:N2,N0+1:M1))
       X25=0.0d0
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S125, 1.000)
       deallocate(S125)
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(S127(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S127,-1.000)
       deallocate(S127)
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(S129(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S129, 1.000)
       deallocate(S129)
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(S131(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S131,-1.000)
       deallocate(S131)
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(S133(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S133, 1.000)
       deallocate(S133)
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(S135(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S135,-1.000)
       deallocate(S135)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S137, 1.000)
       deallocate(S137)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S139,-1.000)
       deallocate(S139)
C
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z1(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K6*K5
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z2(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K6*K7
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z3(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K9*K5
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z4(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K9*K7
...
C
     ...
     & N2,N3,N0,M1,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S145(M1+1:N2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8*K5
       I2=K8
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X21(N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       X21=0.0d0
       call
     & sum4123(N0,M1,M1,N2,M2,N3,M1,N2,X21,S145,-1.000)
       deallocate(S145)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,M1,M1,N2,M2,N3,M1,N2,X21,VCHHHP, 1.000)
C
     ...
     & N0,M1,M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,t3C3,F2)
       allocate(Z47(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K6*K8*K5
       call DMATMAT(I1,I2,I3,X21,F2,Z47)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z47,-1.000)
       deallocate(Z47)
       deallocate(X21)
C
     ...
     & N2,N3,M1,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S147(M1+1:N2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K8
       I2=K8
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X22(M1+1:N2,M1+1:N2,M2+1:N3,M1+1:N2))
       X22=0.0d0
       call
     & sum4123(M1,N2,M1,N2,M2,N3,M1,N2,X22,S147,-1.000)
       deallocate(S147)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & M1,N2,M1,N2,M2,N3,M1,N2,X22,VCHHHP, 1.000)
C
       allocate(F2(M1+1:N2,M1+1:N2,M2+1:N3,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder451236(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,t3C3,F2)
       allocate(Z48(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K6*K8*K8
       call DMATMAT(I1,I2,I3,X22,F2,Z48)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z48,-0.500)
       deallocate(Z48)
       deallocate(X22)
C
     ...
     & N2,N3,N0,M1,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S149(M1+1:N2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8*K5
       I2=K8
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X23(N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       X23=0.0d0
       call
     & sum4123(N0,M1,M1,N2,N2,M2,M1,N2,X23,S149,-1.000)
       deallocate(S149)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,M1,M1,N2,N2,M2,M1,N2,X23,VCHHHP, 1.000)
C
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,t3C1,F2)
       allocate(Z49(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K0*K8*K5
...
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z49, 1.000)
       deallocate(Z49)
       deallocate(X23)
C
     ...
     & N2,N3,M1,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S151(M1+1:N2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K8
       I2=K8
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X24(M1+1:N2,M1+1:N2,N2+1:M2,M1+1:N2))
       X24=0.0d0
       call
     & sum4123(M1,N2,M1,N2,N2,M2,M1,N2,X24,S151,-1.000)
       deallocate(S151)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & M1,N2,M1,N2,N2,M2,M1,N2,X24,VCHHHP, 1.000)
C
       allocate(F2(M1+1:N2,M1+1:N2,N2+1:M2,M2+1:N3,N1+1:M2,N0+1:M1))
       call reorder452136(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,t3C1,F2)
       allocate(Z50(M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K6
       I3=K0*K8*K8
...
C
       call
     & sum1243(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z50, 0.500)
       deallocate(Z50)
       deallocate(X24)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
     ...
     & N0,M1,M2,N3,M2,N3,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(S153(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S153,-0.500)
       deallocate(S153)
C
     ...
     & M1,N2,M2,N3,M2,N3,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(S155(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S155,-0.500)
       deallocate(S155)
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(S157(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K0*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S157,-1.000)
       deallocate(S157)
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(S159(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S159,-1.000)
       deallocate(S159)
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(S161(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K0*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S161,-0.500)
       deallocate(S161)
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(S163(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K0*K0*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X25,S163,-0.500)
       deallocate(S163)
C
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(Z126(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5*K8*K9
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X25,B2,Z126)
       deallocate(B2)
C
       V2B=V2B-Z126
       deallocate(Z126)
...
C
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(Z29(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K6*K5
       call DVECMAT(I2,I3,X17,F2,Z29)
       deallocate(F2)
C
       V2B=V2B+Z29
       deallocate(Z29)
...
C
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(Z30(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K6*K8
       call DVECMAT(I2,I3,X18,F2,Z30)
       deallocate(F2)
C
       V2B=V2B+Z30
       deallocate(Z30)
...
C
       ...
       call reorder421356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z31(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K0*K5
...
C
       ...
       call reorder421356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z32(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K6
       I3=K0*K8
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder523146(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,M2,N3,N1,M2,M2,N3,M1,N2,N0,M1,t3B4,F2)
       allocate(Z11(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K6*K5
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z11,-1.000)
       deallocate(Z11)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder623145(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,M2,N3,M1,N2,N0,M1,t3B1,F2)
       allocate(Z12(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K6*K7
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z12, 1.000)
       deallocate(Z12)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,M1,N1,M2,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder523146(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N1,M2,N1,M2,M2,N3,M1,N2,N0,M1,t3B4,F2)
       allocate(Z13(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K9*K5
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z13,-0.500)
       deallocate(Z13)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & M1,N1,N1,M2,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder623145(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N1,M2,M2,N3,M1,N2,N0,M1,t3B1,F2)
       allocate(Z14(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K9*K7
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z14, 0.500)
       deallocate(Z14)
C
     ...
     & N0,M1,M2,N3,M2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z21(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z21, 1.000)
       deallocate(Z21)
C
     ...
     & M1,N1,M2,N3,M2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z22(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K6*K6*K7
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z22,-1.000)
       deallocate(Z22)
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z23(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K6*K0*K5
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z23, 1.000)
       deallocate(Z23)
C
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z24(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z24,-1.000)
       deallocate(Z24)
C
     ...
     & N0,M1,M2,N3,N1,M2,M2,N3,VBHPPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z25(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K9*K6*K5
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z25, 1.000)
       deallocate(Z25)
C
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z26(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z26,-1.000)
       deallocate(Z26)
C
     ...
     & N0,M1,N2,M2,N1,M2,M2,N3,VBHPPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z27(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K9*K0*K5
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z27, 1.000)
       deallocate(Z27)
C
     ...
     & M1,N1,N2,M2,N1,M2,M2,N3,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z28(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K9*K0*K7
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z28,-1.000)
       deallocate(Z28)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,M1,N0,M1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,t3C3,F2)
       allocate(Z33(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K6*K5*K5
...
C
     ...
     & M1,N2,N0,M1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,t3C3,F2)
       allocate(Z34(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K6*K5*K8
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,t3C3,F2)
       allocate(Z35(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K6*K7*K5
...
C
     ...
     & M1,N2,M1,N1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,t3C3,F2)
       allocate(Z36(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K6*K7*K8
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder462135(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,t3C1,F2)
       allocate(Z37(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K0*K5*K5
...
C
     ...
     & M1,N2,N0,M1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder462135(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,t3C1,F2)
       allocate(Z38(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K0*K5*K8
...
C
     ...
     & N0,M1,M1,N1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder462135(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,t3C1,F2)
       allocate(Z39(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K0*K7*K5
...
C
     ...
     & M1,N2,M1,N1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder462135(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,t3C1,F2)
       allocate(Z40(M2+1:N3,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K6
       I3=K0*K7*K8
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder423156(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3C1,F2)
       allocate(Z41(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K6*K0*K5
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z41,-1.000)
       deallocate(Z41)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & M1,N2,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder423156(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3C1,F2)
       allocate(Z42(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K6*K0*K8
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z42,-1.000)
       deallocate(Z42)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,M1,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N1,M2,M2,N3,M1,N2,N0,M1,t3C3,F2)
       allocate(Z43(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K6*K5
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z43, 1.000)
       deallocate(Z43)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & M1,N2,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N1,M2,M2,N3,M1,N2,N0,M1,t3C3,F2)
       allocate(Z44(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K6*K8
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z44, 1.000)
       deallocate(Z44)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,M1,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder423156(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N1,M2,M2,N3,M1,N2,N0,M1,t3C1,F2)
       allocate(Z45(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K0*K5
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z45,-1.000)
       deallocate(Z45)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & M1,N2,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder423156(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,M2,N3,M1,N2,N0,M1,t3C1,F2)
       allocate(Z46(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K6
       I3=K9*K0*K8
...
C
       call
     & sum1342(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z46,-1.000)
       deallocate(Z46)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,M2+1:N3))
     ...
     & N0,M1,M2,N3,M2,N3,M2,N3,VCHPPP,D1)
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(Z51(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z51,-0.500)
       deallocate(Z51)
C
     ...
     & M1,N2,M2,N3,M2,N3,M2,N3,VCHPPP,D1)
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(Z52(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z52,-0.500)
       deallocate(Z52)
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z53(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K0*K6*K5
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z53,-1.000)
       deallocate(Z53)
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z54(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z54,-1.000)
       deallocate(Z54)
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z55(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K0*K0*K5
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z55,-0.500)
       deallocate(Z55)
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z56(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6
       I2=K5*K8*K9
       I3=K0*K0*K8
...
C
       call
     & sum2341(M2,N3,N1,M2,M1,N2,N0,M1,V2B,Z56,-0.500)
       deallocate(Z56)
C
       call sumx2(N2,N3,N1,N3,N0,N2,N0,N1,
     & M2,N3,N1,M2,M1,N2,N0,M1,HT2B,V2B,1.0)
       deallocate(V2B)
C
       end
