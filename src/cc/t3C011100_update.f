...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K8*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U129)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,Z130)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,X60,D2,Z189)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N2,t2C,D2)
       ...
       I2=K8*K6*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X61,D2,Z246)
       deallocate(D2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K8*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U276)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       ...
       I2=K6*K6
       I3=K2*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z277)
       deallocate(F1)
       deallocate(D2)
C
       V3C=V3C+0.250*Z277
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,U348)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N2,N0+1:M1))
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,Z349)
       deallocate(F1)
       deallocate(B2)
C
       V3C=V3C+0.500*Z349
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X53,F2,Z137)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X54,F2,Z138)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X55,F2,Z142)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X56,F2,Z143)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X41,F2,Z63)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K8*K9*K6
       I3=K6
       call DMATMAT(I1,I2,I3,X49,F2,Z74)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S256)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X57,D2,Z145)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K3
       call DMATMAT(I1,I2,I3,X58,D2,Z146)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S314)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X51,D2,Z85)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S321)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S326)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S266)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,X59,D2,Z151)
       deallocate(D2)
C
       call
