...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,X21,B2,Z82)
       deallocate(B2)
C
       V2A=V2A+0.500*Z82
       deallocate(Z82)
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,X22,B2,Z94)
       deallocate(B2)
C
       call
