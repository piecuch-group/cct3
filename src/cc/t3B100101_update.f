...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,D1,F2,Z373)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z374)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,D1,F2,Z375)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K5*K6*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z383)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,N2,M2,M2,N3,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K6*K0
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z384)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S290)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,B1,D2,S292)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z586)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z587)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X83,F2,Z85)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X84,F2,Z86)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X85,F2,Z87)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X86,F2,Z88)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,t3B3,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X87,F2,Z136)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X88,F2,Z137)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X89,F2,Z149)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X90,F2,Z150)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X91,F2,Z151)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X92,F2,Z152)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X113,F2,Z403)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X111,F2,Z401)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X114,F2,Z404)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X112,F2,Z402)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X119,F2,Z417)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X115,F2,Z413)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X121,F2,Z419)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X117,F2,Z415)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X120,F2,Z418)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X116,F2,Z414)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X122,F2,Z420)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X118,F2,Z416)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X93,F2,Z176)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X94,F2,Z177)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X105,F2,Z192)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X104,F2,Z191)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X106,F2,Z193)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6*K0
       I3=K5
       call DMATMAT(I1,I2,I3,X107,F2,Z194)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X108,F2,Z195)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9*K6
       I3=K6
       call DMATMAT(I1,I2,I3,X109,F2,Z203)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9*K6
       I3=K0
       call DMATMAT(I1,I2,I3,X110,F2,Z204)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S708)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S718)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q87,D2,S757)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q87,D2,S747)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S798)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S805)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S790)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S791)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S819)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q97,D2,S820)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q97,D2,S815)
       deallocate(D2)
C
       call
