...
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K4
       I3=K3*K1
       call DMATMAT(I1,I2,I3,D1,D2,S5)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       I2=K2*K2*K4
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S7)
       deallocate(B1)
       deallocate(D2)
C
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       I2=K2*K4*K4
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,U11)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       I2=K2*K2*K4
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S12)
       deallocate(B1)
       deallocate(D2)
C
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       I2=K2*K4*K4
       I3=K2
       call DMATMAT(I1,I2,I3,X8,D2,U16)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       I2=K2*K4
       I3=K4*K2
       call DMATMAT(I1,I2,I3,D1,D2,S28)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       I2=K2*K4*K4
       I3=K2
       call DMATMAT(I1,I2,I3,X7,D2,U15)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       I2=K2*K2*K4
       I3=K4
       call DMATMAT(I1,I2,I3,X5,D2,U10)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       I2=K2*K4
       I3=K4*K2
       call DMATMAT(I1,I2,I3,D1,D2,S29)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N0+1:N2))
...
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       I2=K2*K2*K4
       I3=K4
       call DMATMAT(I1,I2,I3,X6,D2,U12)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,t2C,D2)
       ...
       I2=K2*K2*K4
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S33)
       deallocate(B1)
       deallocate(D2)
       deallocate(Q2)
C
