...
C
     ...
     & N1,N3,N1,N3,N0,N1,N0,N1,t2A,D2)
       ...
       I2=K1*K1*K3
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S17)
       deallocate(B1)
       deallocate(D2)
C
...
C
     ...
     & N1,N3,N2,N3,N0,N2,N0,N1,t2B,D2)
       ...
       I2=K1*K2*K4
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S18)
       deallocate(B1)
       deallocate(D2)
C
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K3*K4
       I3=K1
       call DMATMAT(I1,I2,I3,X9,D2,U48)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K3*K4
       I3=K1
       call DMATMAT(I1,I2,I3,X10,D2,U49)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K3*K4
       I3=K1
       call DMATMAT(I1,I2,I3,X11,D2,U96)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K3*K4
       I3=K1
       call DMATMAT(I1,I2,I3,X12,D2,U97)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K3*K4
       I3=K1
       call DMATMAT(I1,I2,I3,X7,D2,U10)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,N3,N0,N2,N0,N1,t2B,D2)
       ...
       I2=K1*K2*K4
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S108)
       deallocate(B1)
       deallocate(D2)
C
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       ...
       I2=K1*K3*K4
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,U92)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       ...
       I2=K1*K3*K4
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,U93)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,N3,N0,N2,N0,N1,t2B,D2)
       ...
       I2=K1*K2*K4
       I3=K3
       call DMATMAT(I1,I2,I3,X8,D2,U11)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,t2B,D2)
       ...
       I2=K1*K2*K3
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S94)
       deallocate(B1)
       deallocate(D2)
C
