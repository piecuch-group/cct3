...
C
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K6
       I3=K9*K6*K7
       call DMATMAT(I1,I2,I3,D1,F2,S27)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,X12,B2,Z28)
       deallocate(B2)
C
       call
...
C
     ...
     & M1,N2,N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,t3B4,F2)
       ...
       I2=K5*K6*K6
       I3=K9*K5*K8
       call DMATMAT(I1,I2,I3,X4,F2,Z6)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,t3B1,F2)
       ...
       I2=K5*K6*K6
       I3=K9*K7*K5
       call DMATMAT(I1,I2,I3,X5,F2,Z7)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,t3B1,F2)
       ...
       I2=K5*K6*K6
       I3=K9*K7*K8
       call DMATMAT(I1,I2,I3,X6,F2,Z8)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3B3,F2)
       ...
       I2=K5*K5*K6
       I3=K6*K0*K7
       call DMATMAT(I1,I2,I3,D1,F2,S51)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K6
       I3=K9*K6*K7
       call DMATMAT(I1,I2,I3,D1,F2,S53)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,t3C1,F2)
       ...
       I2=K5*K6*K6
       I3=K0*K8*K5
       call DMATMAT(I1,I2,I3,X9,F2,Z19)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,t3C1,F2)
       ...
       I2=K5*K6*K6
       I3=K0*K8*K8
       call DMATMAT(I1,I2,I3,X10,F2,Z20)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X13,B2,Z52)
       deallocate(B2)
C
       V2B=V2B+Z52
       deallocate(Z52)
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6
       I3=K0*K0*K8
       call DMATMAT(I1,I2,I3,X11,F2,Z22)
       deallocate(F2)
C
       call
