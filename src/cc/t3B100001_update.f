...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U102)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z103)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,X74,D2,Z212)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,X75,D2,Z216)
       deallocate(D2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U246)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,N0,N1,M2,N3,M2,N3,t2A,D2)
       ...
       I2=K6*K6
       I3=K1*K1
       call DMATMAT(I1,I2,I3,F1,D2,Z247)
       deallocate(F1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,U461)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N1,N2+1:M2,M2+1:N3,N0+1:M1,N0+1:M1,M1+1:N1))
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z462)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K5*K6*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z250)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,N2,M2,M2,N3,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K6*K0
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z251)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K5*K6*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z252)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,N2,M2,M2,N3,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K6*K0
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z253)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z367)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,t3B3,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X52,F2,Z79)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X53,F2,Z80)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,t3B3,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X54,F2,Z81)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X55,F2,Z82)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X57,F2,Z89)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X58,F2,Z90)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X59,F2,Z91)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X60,F2,Z92)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X61,F2,Z93)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X62,F2,Z94)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X63,F2,Z95)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X56,F2,Z88)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X76,F2,Z264)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X77,F2,Z265)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X78,F2,Z274)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X79,F2,Z275)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X80,F2,Z276)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X81,F2,Z277)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X65,F2,Z116)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X66,F2,Z117)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X67,F2,Z118)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K0
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X70,F2,Z121)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K6*K0
       I3=K5
       call DMATMAT(I1,I2,I3,X71,F2,Z122)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K6*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X72,F2,Z123)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S466)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6*K0
       I3=K1
       call DMATMAT(I1,I2,I3,X83,D2,Z305)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6*K0
       I3=K1
       call DMATMAT(I1,I2,I3,X82,D2,Z301)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X91,D2,Z412)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,M2,N3,N0,M1,t2B,D2)
       ...
       I2=K5*K6*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X90,D2,Z408)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X86,D2,Z388)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X87,D2,Z390)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X89,D2,Z402)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X88,D2,Z396)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X84,D2,Z380)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X85,D2,Z384)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S539)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,X50,D2,Z61)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,X51,D2,Z63)
       deallocate(D2)
C
       call
