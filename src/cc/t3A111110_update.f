...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call DMATMAT(I1,I2,I3,B1,D2,S83)
       deallocate(B1)
       deallocate(D2)
C
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S84)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X59,D2,Z204)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X60,D2,Z210)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X47,D2,Z54)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X48,D2,Z55)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X49,F2,Z84)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X50,F2,Z85)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X51,F2,Z86)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X52,F2,Z87)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X66,F2,Z298)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X70,F2,Z302)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X62,F2,Z288)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X69,F2,Z301)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X73,F2,Z305)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X65,F2,Z291)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X64,F2,Z290)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X72,F2,Z304)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X68,F2,Z300)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X63,F2,Z289)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X67,F2,Z299)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X71,F2,Z303)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call DMATMAT(I1,I2,I3,X46,D2,Z53)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S347)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q65,D2,S341)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S349)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X54,D2,Z162)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X55,D2,Z163)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call DMATMAT(I1,I2,I3,X58,D2,Z176)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S365)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S366)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q66,D2,S364)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,X56,D2,Z165)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,X57,D2,Z166)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K6
       I3=K3
       call DMATMAT(I1,I2,I3,X53,D2,Z156)
       deallocate(D2)
C
       call
