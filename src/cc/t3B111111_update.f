       subroutine t3B111111_update(N0,N1,N2,N3,HT3B1,shift,
...
C
       ...
       real*8,allocatable::Z499(:,:,:,:,:,:)
C
       allocate(V3B(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       V3B=0.0d0
C
...
C
       ...
       X2=0.0d0
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X2,S2,-1.000)
       deallocate(S2)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       X67=0.0d0
       call
     & sum3124(N0,N1,N1,M2,M1,N1,M1,N1,X67,S6, 1.000)
       deallocate(S6)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:M2,M1+1:N1))
       call reorder1432(N1,N3,N0,N1,N1,N3,N0,N1,
     ...
     & N1,N3,M1,N1,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X68(N0+1:N1,N1+1:M2,M1+1:N1,M1+1:N1))
       X68=0.0d0
       call
     & sum3124(N0,N1,N1,M2,M1,N1,M1,N1,X68,S7, 1.000)
       deallocate(S7)
C
...
C
     ...
     & N0,N1,N2,N3,N2,M2,M1,N1,VBHPHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S13(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X9(N2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1))
       X9=0.0d0
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X9,S13,-1.000)
       deallocate(S13)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder4132(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & N1,N3,N2,N3,N2,M2,N1,M2,VBAPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S17(M1+1:N1,N2+1:N3,N2+1:M2,N1+1:M2))
       I1=K9*K0*K4
       I2=K7
       I3=K3
...
C
       call
     & sum4123(N2,N3,N2,M2,N1,M2,M1,N1,X9,S17, 1.000)
       deallocate(S17)
C
       allocate(D1(N1+1:N3,N2+1:N3,N2+1:M2,N1+1:M2))
       call reorder2134(N2,N3,N1,N3,N2,N3,N1,M2,
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(Z95(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7
       I2=K8*K9*K9*K0
       I3=K5*K5
...
C
       V3B=V3B+0.500*Z95
       call
     & sum123465(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z95,-0.500)
       deallocate(Z95)
       deallocate(S19)
C
...
C
     ...
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(Z96(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7
       I2=K8*K9*K9*K0
       I3=K7*K5
...
C
       V3B=V3B+Z96
       call
     & sum123465(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z96,-1.000)
       deallocate(Z96)
       deallocate(S20)
C
...
C
     ...
     & M1,N1,M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(Z97(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7
       I2=K8*K9*K9*K0
       I3=K7*K7
...
C
       V3B=V3B+0.500*Z97
       call
     & sum123465(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z97,-0.500)
       deallocate(Z97)
       deallocate(S21)
C
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X69(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N1))
       X69=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N1,X69,S26, 1.000)
       deallocate(S26)
C
       allocate(D1(N0+1:N1,M1+1:N1,M2+1:N3,M1+1:N1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X70(M1+1:N1,M2+1:N3,N1+1:M2,M1+1:N1))
       X70=0.0d0
       call
     & sum3124(M1,N1,M2,N3,N1,M2,M1,N1,X70,S27, 1.000)
       deallocate(S27)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,M1+1:N1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X71(N0+1:M1,N1+1:M2,N1+1:M2,M1+1:N1))
       X71=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N1,X71,S28, 1.000)
       deallocate(S28)
C
       allocate(D1(N0+1:N1,M1+1:N1,N1+1:M2,M1+1:N1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X72(M1+1:N1,N1+1:M2,N1+1:M2,M1+1:N1))
       X72=0.0d0
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X72,S29, 1.000)
       deallocate(S29)
C
...
C
       ...
       X36=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N1,M2,N1,M2,X36,S38,-1.000)
       deallocate(S38)
C
...
C
       ...
       X37=0.0d0
       call
     & sum4123(M2,N3,N1,M2,N1,M2,N1,M2,X37,S39,-1.000)
       deallocate(S39)
C
...
C
       ...
       X38=0.0d0
       call
     & sum4123(N1,M2,N1,M2,N1,M2,N1,M2,X38,S40,-1.000)
       deallocate(S40)
C
...
C
       call
     & sum3124(M2,N3,M2,N3,N1,M2,N1,M2,X36,S41, 1.000)
       deallocate(S41)
C
       allocate(D1(N0+1:N1,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum3124(M2,N3,N1,M2,N1,M2,N1,M2,X37,S42, 1.000)
       deallocate(S42)
C
       allocate(D1(N0+1:N1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum3124(N1,M2,N1,M2,N1,M2,N1,M2,X38,S43, 1.000)
       deallocate(S43)
C
       allocate(D1(N0+1:N1,N1+1:N3,M2+1:N3,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
     ...
     & N1,N3,M1,N1,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X73(N0+1:M1,M2+1:N3,N2+1:M2,M1+1:N1))
       X73=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N2,M2,M1,N1,X73,S48, 1.000)
       deallocate(S48)
C
...
C
       ...
       X74=0.0d0
       call
     & sum4123(M1,N1,M2,N3,N2,M2,M1,N1,X74,S49, 1.000)
       deallocate(S49)
C
     ...
     & N1,N3,M1,N1,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X75(N0+1:M1,N2+1:M2,N2+1:M2,M1+1:N1))
       X75=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N2,M2,M1,N1,X75,S50, 1.000)
       deallocate(S50)
C
...
C
       ...
       X76=0.0d0
       call
     & sum4123(M1,N1,N2,M2,N2,M2,M1,N1,X76,S51, 1.000)
       deallocate(S51)
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S52(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X77(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N2))
       X77=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N2,X77,S52, 1.000)
       deallocate(S52)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X78(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N2))
       X78=0.0d0
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N2,X78,S53, 1.000)
       deallocate(S53)
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S54(N1+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X79(N0+1:M1,N1+1:M2,N1+1:M2,M1+1:N2))
       X79=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X79,S54, 1.000)
       deallocate(S54)
C
     ...
     & N0,N1,M1,N2,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S55(N1+1:M2,M1+1:N2,N1+1:M2,M1+1:N2))
       I1=K8*K9*K8
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X80(M1+1:N2,N1+1:M2,N1+1:M2,M1+1:N2))
       X80=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X80,S55, 1.000)
       deallocate(S55)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,M1+1:N2))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X81(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N2))
       X81=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N2,X81,S56, 1.000)
       deallocate(S56)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,M1+1:N2))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X82(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N2))
       X82=0.0d0
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N2,X82,S57, 1.000)
       deallocate(S57)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,M1+1:N2))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X83(N0+1:M1,N1+1:M2,N1+1:M2,M1+1:N2))
       X83=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X83,S58, 1.000)
       deallocate(S58)
C
       allocate(D1(N0+1:N1,M1+1:N2,N1+1:M2,M1+1:N2))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       deallocate(B2)
C
       allocate(X84(M1+1:N2,N1+1:M2,N1+1:M2,M1+1:N2))
       X84=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X84,S59, 1.000)
       deallocate(S59)
C
...
C
     ...
     & N0,N1,M2,N3,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S60(N1+1:M2,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X55(M2+1:N3,M2+1:N3,N2+1:M2,N1+1:M2))
       X55=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N2,M2,N1,M2,X55,S60,-1.000)
       deallocate(S60)
C
     ...
     & N0,N1,N2,M2,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S61(N1+1:M2,N2+1:M2,M2+1:N3,N2+1:M2))
       I1=K0*K6*K0
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X56(N2+1:M2,M2+1:N3,N2+1:M2,N1+1:M2))
       X56=0.0d0
       call
     & sum4123(N2,M2,M2,N3,N2,M2,N1,M2,X56,S61,-1.000)
       deallocate(S61)
C
     ...
     & N0,N1,M2,N3,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S62(N1+1:M2,M2+1:N3,N1+1:M2,N2+1:M2))
       I1=K0*K9*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X57(M2+1:N3,N1+1:M2,N2+1:M2,N1+1:M2))
       X57=0.0d0
       call
     & sum4123(M2,N3,N1,M2,N2,M2,N1,M2,X57,S62,-1.000)
       deallocate(S62)
C
     ...
     & N0,N1,N2,M2,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S63(N1+1:M2,N2+1:M2,N1+1:M2,N2+1:M2))
       I1=K0*K9*K0
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X58(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       X58=0.0d0
       call
     & sum4123(N2,M2,N1,M2,N2,M2,N1,M2,X58,S63,-1.000)
       deallocate(S63)
C
       allocate(D1(N0+1:N1,M2+1:N3,M2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,M2,N3,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S64(N1+1:M2,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X59(M2+1:N3,M2+1:N3,N2+1:M2,N1+1:M2))
       X59=0.0d0
       call
     & sum4123(M2,N3,M2,N3,N2,M2,N1,M2,X59,S64,-1.000)
       deallocate(S64)
C
       allocate(D1(N0+1:N1,N2+1:M2,M2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N2,M2,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S65(N1+1:M2,N2+1:M2,M2+1:N3,N2+1:M2))
       I1=K0*K6*K0
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X60(N2+1:M2,M2+1:N3,N2+1:M2,N1+1:M2))
       X60=0.0d0
       call
     & sum4123(N2,M2,M2,N3,N2,M2,N1,M2,X60,S65,-1.000)
       deallocate(S65)
C
       allocate(D1(N0+1:N1,M2+1:N3,N1+1:M2,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,M2,N3,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S66(N1+1:M2,M2+1:N3,N1+1:M2,N2+1:M2))
       I1=K0*K9*K6
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X61(M2+1:N3,N1+1:M2,N2+1:M2,N1+1:M2))
       X61=0.0d0
       call
     & sum4123(M2,N3,N1,M2,N2,M2,N1,M2,X61,S66,-1.000)
       deallocate(S66)
C
       allocate(D1(N0+1:N1,N2+1:M2,N1+1:M2,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N2,M2,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S67(N1+1:M2,N2+1:M2,N1+1:M2,N2+1:M2))
       I1=K0*K9*K0
       I2=K9
       I3=K1
       ...
       deallocate(B2)
C
       allocate(X62(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       X62=0.0d0
       call
     & sum4123(N2,M2,N1,M2,N2,M2,N1,M2,X62,S67,-1.000)
       deallocate(S67)
C
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S68(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K9
       I3=K1
...
C
     ...
     & N0,M1,M2,N3,N1,M2,M1,N1,S68,D1)
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z154(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z154, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z154,-1.000)
       deallocate(Z154)
       deallocate(S68)
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S69(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N1))
       I1=K7*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z155, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z155,-1.000)
       deallocate(Z155)
       deallocate(S69)
C
     ...
     & N0,N1,N0,M1,N2,M2,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S70(N1+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z156, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z156,-1.000)
       deallocate(Z156)
       deallocate(S70)
C
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S71(N1+1:M2,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z157, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z157,-1.000)
       deallocate(Z157)
       deallocate(S71)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,M1+1:N1))
     ...
     & N0,N1,N0,M1,M2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S72(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,M1,M2,N3,M1,N1,
     & N0,M1,M2,N3,N1,M2,M1,N1,S72,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z158(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z158,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z158, 1.000)
       deallocate(Z158)
       deallocate(S72)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,M1+1:N1))
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S73(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N1))
       I1=K7*K6*K8
       I2=K9
       I3=K1
...
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,M1,N2,M2,N3,M1,N1,
     & M1,N2,M2,N3,N1,M2,M1,N1,S73,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z159(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K8
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z159,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z159, 1.000)
       deallocate(Z159)
       deallocate(S73)
C
       allocate(D1(N0+1:N1,N0+1:M1,N2+1:M2,M1+1:N1))
     ...
     & N0,N1,N0,M1,N2,M2,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S74(N1+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,M1,N2,M2,M1,N1,
     & N0,M1,N2,M2,N1,M2,M1,N1,S74,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z160(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K5
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z160,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z160, 1.000)
       deallocate(Z160)
       deallocate(S74)
C
       allocate(D1(N0+1:N1,M1+1:N2,N2+1:M2,M1+1:N1))
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S75(N1+1:M2,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0*K8
       I2=K9
       I3=K1
...
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,M1,N2,N2,M2,M1,N1,
     & M1,N2,N2,M2,N1,M2,M1,N1,S75,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z161(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K8
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z161,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z161, 1.000)
       deallocate(Z161)
       deallocate(S75)
C
       allocate(D1(N1+1:N3,N0+1:M1,M2+1:N3,N1+1:M2))
     ...
     & N1,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S76(M1+1:N1,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K7
       I3=K3
...
C
     ...
     & N0,M1,M2,N3,N1,M2,M1,N1,S76,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z162(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z162,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z162, 1.000)
       deallocate(Z162)
       deallocate(S76)
C
     ...
     & N1,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S77(M1+1:N1,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K7
       I3=K3
...
C
     ...
     & M1,N2,M2,N3,N1,M2,M1,N1,S77,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z163(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z163,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z163, 1.000)
       deallocate(Z163)
       deallocate(S77)
C
     ...
     & N1,N3,N0,M1,N2,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S78(M1+1:N1,N0+1:M1,N2+1:M2,N1+1:M2))
       I1=K9*K0*K5
       I2=K7
       I3=K3
...
C
     ...
     & N0,M1,N2,M2,N1,M2,M1,N1,S78,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z164(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K5
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z164,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z164, 1.000)
       deallocate(Z164)
       deallocate(S78)
C
     ...
     & N1,N3,M1,N2,N2,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S79(M1+1:N1,M1+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K8
       I2=K7
       I3=K3
...
C
     ...
     & M1,N2,N2,M2,N1,M2,M1,N1,S79,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z165(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z165,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z165, 1.000)
       deallocate(Z165)
       deallocate(S79)
C
       allocate(D1(N1+1:N3,N0+1:M1,M2+1:N3,N1+1:M2))
     ...
     & N1,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S80(M1+1:N1,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K7
       I3=K3
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,M1,M2,N3,N1,M2,
     & N0,M1,M2,N3,N1,M2,M1,N1,S80,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z166(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z166, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z166,-1.000)
       deallocate(Z166)
       deallocate(S80)
C
       allocate(D1(N1+1:N3,M1+1:N2,M2+1:N3,N1+1:M2))
     ...
     & N1,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S81(M1+1:N1,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K7
       I3=K3
...
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,M1,N2,M2,N3,N1,M2,
     & M1,N2,M2,N3,N1,M2,M1,N1,S81,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z167(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K8
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z167, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z167,-1.000)
       deallocate(Z167)
       deallocate(S81)
C
       allocate(D1(N1+1:N3,N0+1:M1,N2+1:M2,N1+1:M2))
     ...
     & N1,N3,N0,M1,N2,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S82(M1+1:N1,N0+1:M1,N2+1:M2,N1+1:M2))
       I1=K9*K0*K5
       I2=K7
       I3=K3
...
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,M1,N2,M2,N1,M2,
     & N0,M1,N2,M2,N1,M2,M1,N1,S82,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z168(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K5
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z168, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z168,-1.000)
       deallocate(Z168)
       deallocate(S82)
C
       allocate(D1(N1+1:N3,M1+1:N2,N2+1:M2,N1+1:M2))
     ...
     & N1,N3,M1,N2,N2,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S83(M1+1:N1,M1+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K8
       I2=K7
       I3=K3
...
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,M1,N2,N2,M2,N1,M2,
     & M1,N2,N2,M2,N1,M2,M1,N1,S83,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z169(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K8
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z169, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z169,-1.000)
       deallocate(Z169)
       deallocate(S83)
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       allocate(S84(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S84,-1.000)
       deallocate(S84)
C
     ...
     & N2,N3,M1,N2,t1B,B2)
       allocate(S85(M1+1:N2,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X1,S85, 1.000)
       deallocate(S85)
C
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X2,S86,-1.000)
       deallocate(S86)
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder3241(N0,N2,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N1,M2,M1,N2,VBPHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S87(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X3,S87,-1.000)
       deallocate(S87)
C
...
C
       call
     & sum4123(N1,N3,N2,M2,N1,M2,M1,N2,X2,S88, 1.000)
       deallocate(S88)
C
       allocate(D1(N2+1:N3,N1+1:N3,N2+1:M2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,N3,N1,N3,N2,M2,N1,M2,VBAPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S89(M1+1:N2,N1+1:N3,N2+1:M2,N1+1:M2))
       I1=K9*K0*K3
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N1,N3,N2,M2,N1,M2,M1,N2,X3,S89, 1.000)
       deallocate(S89)
C
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X7,S90, 1.000)
       deallocate(S90)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3124(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X8,S91, 1.000)
       deallocate(S91)
C
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X9,S92,-1.000)
       deallocate(S92)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S93(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X10,S93,-1.000)
       deallocate(S93)
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S94(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K0
       I3=K2
...
C
       ...
       X11=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X11,S94,-1.000)
       deallocate(S94)
C
...
C
       ...
       X12=0.0d0
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N2,X12,S95,-1.000)
       deallocate(S95)
C
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S96(N2+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K0
       I3=K2
...
C
       ...
       X13=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N2,M2,M1,N2,X13,S96,-1.000)
       deallocate(S96)
C
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S97(N2+1:M2,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K7
       I2=K0
       I3=K2
...
C
       ...
       X14=0.0d0
       call
     & sum3124(M1,N1,N1,M2,N2,M2,M1,N2,X14,S97,-1.000)
       deallocate(S97)
C
     ...
     & N2,N3,N0,M1,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S98(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:M2))
       I1=K0*K6*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,M2,N3,N2,M2,M1,N2,X11,S98, 1.000)
       deallocate(S98)
C
...
C
       call
     & sum4123(M1,N1,M2,N3,N2,M2,M1,N2,X12,S99, 1.000)
       deallocate(S99)
C
     ...
     & N2,N3,N0,M1,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S100(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:M2))
       I1=K0*K9*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,N1,M2,N2,M2,M1,N2,X13,S100, 1.000)
       deallocate(S100)
C
     ...
     & N2,N3,M1,N1,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S101(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:M2))
       I1=K0*K9*K7
       I2=K8
       I3=K4
...
C
       call
     & sum4123(M1,N1,N1,M2,N2,M2,M1,N2,X14,S101, 1.000)
       deallocate(S101)
C
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S102(M1+1:N2,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K5
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,M1,N0,M1,M1,N2,M1,N1,X39,S102, 1.000)
       deallocate(S102)
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S103(M1+1:N2,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K8
       I2=K8
       I3=K4
...
C
       call
     & sum3124(M1,N2,N0,M1,M1,N2,M1,N1,X40,S103, 1.000)
       deallocate(S103)
C
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S104(M1+1:N2,N0+1:M1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K5
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N2,M1,N1,X41,S104, 1.000)
       deallocate(S104)
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S105(M1+1:N2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K8
       I2=K8
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N1,M1,N2,M1,N1,X42,S105, 1.000)
       deallocate(S105)
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S106(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K0
       I3=K2
...
C
       ...
       X43=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N1,X43,S106,-1.000)
       deallocate(S106)
C
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z43(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K7*K8*K9*K9
       I3=K6*K5
...
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z43, 1.000)
       call
     & sum234615(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z43,-1.000)
       deallocate(Z43)
       deallocate(X43)
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S107(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K0
       I3=K2
...
C
       ...
       X44=0.0d0
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N1,X44,S107,-1.000)
       deallocate(S107)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z44(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K7*K8*K9*K9
       I3=K6*K7
...
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z44, 1.000)
       call
     & sum234615(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z44,-1.000)
       deallocate(Z44)
       deallocate(X44)
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S108(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K0
       I3=K2
...
C
       ...
       X45=0.0d0
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N1,X45,S108,-1.000)
       deallocate(S108)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z45(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K7*K8*K9*K9
       I3=K0*K5
...
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z45, 1.000)
       call
     & sum234615(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z45,-1.000)
       deallocate(Z45)
       deallocate(X45)
C
     ...
     & N0,N2,M1,N1,N2,M2,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S109(N2+1:M2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K7
       I2=K0
       I3=K2
...
C
       ...
       X46=0.0d0
       call
     & sum3124(M1,N1,N2,M2,N2,M2,M1,N1,X46,S109,-1.000)
       deallocate(S109)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z46(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K7*K8*K9*K9
       I3=K0*K7
...
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z46, 1.000)
       call
     & sum234615(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z46,-1.000)
       deallocate(Z46)
       deallocate(X46)
C
...
C
     ...
     & N2,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S110(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K8
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X47(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N2))
       X47=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N1,M2,M1,N2,X47,S110, 1.000)
       deallocate(S110)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
     & N0,M1,M2,N3,N1,M2,M1,N2,X47,VBPHPH, 1.000)
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z47(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K6*K5
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z47,-1.000)
       deallocate(Z47)
       deallocate(X47)
C
     ...
     & N2,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S111(M1+1:N2,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K8
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X48(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N2))
       X48=0.0d0
       call
     & sum4123(M1,N2,M2,N3,N1,M2,M1,N2,X48,S111, 1.000)
       deallocate(S111)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
     & M1,N2,M2,N3,N1,M2,M1,N2,X48,VBPHPH, 1.000)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z48(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K6*K8
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z48,-1.000)
       deallocate(Z48)
       deallocate(X48)
C
     ...
     & N2,N3,N0,M1,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S112(M1+1:N2,N0+1:M1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K5
       I2=K8
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X49(N0+1:M1,N1+1:M2,N1+1:M2,M1+1:N2))
       X49=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,M1,N2,X49,S112, 1.000)
       deallocate(S112)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
     & N0,M1,N1,M2,N1,M2,M1,N2,X49,VBPHPH, 1.000)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z49(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K9*K5
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z49,-1.000)
       deallocate(Z49)
       deallocate(X49)
C
     ...
     & N2,N3,M1,N2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S113(M1+1:N2,M1+1:N2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K8
       I2=K8
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X50(M1+1:N2,N1+1:M2,N1+1:M2,M1+1:N2))
       X50=0.0d0
       call
     & sum4123(M1,N2,N1,M2,N1,M2,M1,N2,X50,S113, 1.000)
       deallocate(S113)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
     & M1,N2,N1,M2,N1,M2,M1,N2,X50,VBPHPH, 1.000)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z50(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K9*K8
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z50,-1.000)
       deallocate(Z50)
       deallocate(X50)
C
       allocate(D1(N2+1:N3,N0+1:M1,M2+1:N3,N1+1:M2))
     ...
     & N2,N3,N0,M1,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S114(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K5
       I2=K8
       I3=K4
...
C
       ...
       X51=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N1,M2,M1,N2,X51,S114, 1.000)
       deallocate(S114)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z51(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K6*K5
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z51, 1.000)
       deallocate(Z51)
       deallocate(X51)
C
       allocate(D1(N2+1:N3,M1+1:N2,M2+1:N3,N1+1:M2))
     ...
     & N2,N3,M1,N2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S115(M1+1:N2,M1+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K8
       I2=K8
       I3=K4
...
C
       ...
       X52=0.0d0
       call
     & sum4123(M1,N2,M2,N3,N1,M2,M1,N2,X52,S115, 1.000)
       deallocate(S115)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z52(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K6*K8
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z52, 1.000)
       deallocate(Z52)
       deallocate(X52)
C
       allocate(D1(N2+1:N3,N0+1:M1,N1+1:M2,N1+1:M2))
     ...
     & N2,N3,N0,M1,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S116(M1+1:N2,N0+1:M1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K5
       I2=K8
       I3=K4
...
C
       ...
       X53=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,M1,N2,X53,S116, 1.000)
       deallocate(S116)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z53(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K9*K5
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z53, 1.000)
       deallocate(Z53)
       deallocate(X53)
C
       allocate(D1(N2+1:N3,M1+1:N2,N1+1:M2,N1+1:M2))
     ...
     & N2,N3,M1,N2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S117(M1+1:N2,M1+1:N2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K8
       I2=K8
       I3=K4
...
C
       ...
       X54=0.0d0
       call
     & sum4123(M1,N2,N1,M2,N1,M2,M1,N2,X54,S117, 1.000)
       deallocate(S117)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z54(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K9*K8
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z54, 1.000)
       deallocate(Z54)
       deallocate(X54)
C
     ...
     & N0,N2,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S118(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X55,S118,-1.000)
       deallocate(S118)
C
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S119(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X56,S119,-1.000)
       deallocate(S119)
C
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S120(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X57,S120,-1.000)
       deallocate(S120)
C
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S121(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X58,S121,-1.000)
       deallocate(S121)
C
       allocate(D1(N0+1:N2,M2+1:N3,M2+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S122(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X59,S122,-1.000)
       deallocate(S122)
C
       allocate(D1(N0+1:N2,N2+1:M2,M2+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S123(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X60,S123,-1.000)
       deallocate(S123)
C
       allocate(D1(N0+1:N2,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S124(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X61,S124,-1.000)
       deallocate(S124)
C
       allocate(D1(N0+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S125(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X62,S125,-1.000)
       deallocate(S125)
C
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S126(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K0
       I3=K2
...
C
       ...
       X63=0.0d0
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X63,S126,-1.000)
       deallocate(S126)
C
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S127(N2+1:M2,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K0
       I3=K2
...
C
       ...
       X64=0.0d0
       call
     & sum3124(M1,N2,M2,N3,N2,M2,M1,N2,X64,S127,-1.000)
       deallocate(S127)
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S128(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N2))
       I1=K8*K0*K5
       I2=K0
       I3=K2
...
C
       ...
       X65=0.0d0
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N2,X65,S128,-1.000)
       deallocate(S128)
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S129(N2+1:M2,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K8
       I2=K0
       I3=K2
...
C
       ...
       X66=0.0d0
       call
     & sum3124(M1,N2,N2,M2,N2,M2,M1,N2,X66,S129,-1.000)
       deallocate(S129)
C
...
C
     ...
     & N2,N3,N0,M1,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S130(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:M2))
       I1=K0*K6*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,M2,N3,N2,M2,M1,N2,X63,S130,-1.000)
       deallocate(S130)
C
     ...
     & N2,N3,M1,N2,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S131(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:M2))
       I1=K0*K6*K8
       I2=K8
       I3=K4
...
C
       call
     & sum4123(M1,N2,M2,N3,N2,M2,M1,N2,X64,S131,-1.000)
       deallocate(S131)
C
     ...
     & N2,N3,N0,M1,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S132(M1+1:N2,N0+1:M1,N2+1:M2,N2+1:M2))
       I1=K0*K0*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,N2,M2,N2,M2,M1,N2,X65,S132,-1.000)
       deallocate(S132)
C
     ...
     & N2,N3,M1,N2,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S133(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K8
       I2=K8
       I3=K4
...
C
       call
     & sum4123(M1,N2,N2,M2,N2,M2,M1,N2,X66,S133,-1.000)
       deallocate(S133)
C
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S134,-1.000)
       deallocate(S134)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S135,-1.000)
       deallocate(S135)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S136)
       deallocate(B1)
       deallocate(D2)
C
       allocate(X89(N0+1:N1,N2+1:M2,M1+1:N2,M1+1:N1))
       X89=0.0d0
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S136, 1.000)
       deallocate(S136)
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S137(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S137, 1.000)
       deallocate(S137)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N1,N3,N0,N1,N0,N1,N0,N1,
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S138(N1+1:M2,M1+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X67,S138, 1.000)
       deallocate(S138)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,VAHHHP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S139(N1+1:M2,M1+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X68,S139,-1.000)
       deallocate(S139)
C
     ...
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S140(N1+1:M2,N1+1:M2,N1+1:N3,M1+1:N1))
       I1=K7*K3
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum2314(N1,N3,N1,M2,N1,M2,M1,N1,X6,S140, 0.500)
       deallocate(S140)
C
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,M1,N2,X2,S141,-1.000)
       deallocate(S141)
C
...
C
       call
     & sum3412(N0,N1,N1,M2,M1,N1,M1,N1,X4,S142, 0.500)
       deallocate(S142)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S143(N2+1:M2,M1+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,M1,N2,X3,S143,-1.000)
       deallocate(S143)
C
       allocate(D1(N1+1:N3,N1+1:N3,N0+1:N1,N1+1:M2))
       call reorder1243(N1,N3,N1,N3,N1,N3,N0,N1,
     & N1,N3,N1,N3,N0,N1,N1,M2,VAHPPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,M1,N1,M1,N1,t2A,D2)
       allocate(S144(M1+1:N1,M1+1:N1,N0+1:N1,N1+1:M2))
       I1=K9*K1
       I2=K7*K7
       I3=K3*K3
...
C
       call
     & sum3412(N0,N1,N1,M2,M1,N1,M1,N1,X5,S144, 0.500)
       deallocate(S144)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
     ...
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S145(N1+1:M2,M1+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(N1,N3,N1,M2,N1,M2,M1,N1,X6,S145, 1.000)
       deallocate(S145)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4213(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,N1,N1,N3,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S146(N1+1:M2,M1+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N1,N3,N1,M2,N1,M2,M1,N1,X6,S146,-1.000)
       deallocate(S146)
C
     ...
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S147(N2+1:M2,N1+1:M2,N1+1:N3,M1+1:N2))
       I1=K8*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,M1,N2,X3,S147, 1.000)
       deallocate(S147)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N1,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S148(N2+1:M2,N1+1:M2,N1+1:N3,M1+1:N2))
       I1=K8*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,M1,N2,X2,S148, 1.000)
       deallocate(S148)
C
     ...
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S149(N1+1:M2,M1+1:N2,N1+1:N3,N2+1:M2))
       I1=K0*K3
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N1,N3,N2,M2,N1,M2,M1,N2,X3,S149,-1.000)
       deallocate(S149)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N2,N3,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S150(N1+1:M2,M1+1:N2,N1+1:N3,N2+1:M2))
       I1=K0*K3
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N1,N3,N2,M2,N1,M2,M1,N2,X2,S150,-1.000)
       deallocate(S150)
C
     ...
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S151(N2+1:M2,M1+1:N1,N0+1:N1,M1+1:N2))
       I1=K8*K1
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum2413(N0,N1,N2,M2,M1,N2,M1,N1,X89,S151,-1.000)
       deallocate(S151)
C
     ...
     & N0,N1,N1,N3,N0,N2,M1,N2,VBHHPH,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S152(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X7,S152, 1.000)
       deallocate(S152)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,M1,N2,VBHHPH,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S153(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X8,S153, 1.000)
       deallocate(S153)
C
     ...
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S154(M1+1:N2,M1+1:N1,N0+1:N1,N2+1:M2))
       I1=K0*K1
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,N1,N2,M2,M1,N2,M1,N1,X89,S154, 1.000)
       deallocate(S154)
C
     ...
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S155(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X9,S155, 1.000)
       deallocate(S155)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S156(N1+1:M2,M1+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X10,S156, 1.000)
       deallocate(S156)
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S157(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S157, 1.000)
       deallocate(S157)
C
...
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,M1,N2,X2,S158, 1.000)
C
       call
     & sum2413(N1,N3,N2,M2,N1,M2,M1,N2,X3,S158, 1.000)
       deallocate(S158)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X3,S159, 0.500)
       deallocate(S159)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X3,S160, 1.000)
       deallocate(S160)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X3,S162, 0.500)
       deallocate(S162)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X3,S163, 1.000)
       deallocate(S163)
C
     ...
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S164(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X3,S164, 0.500)
       deallocate(S164)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,N0,M1,M2,N3,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(S165(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K5*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S165,-0.500)
       deallocate(S165)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,M1,N1,M2,N3,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S166(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S166,-1.000)
       deallocate(S166)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & M1,N1,M1,N1,M2,N3,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S167(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K6*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S167,-0.500)
       deallocate(S167)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,N0,M1,N1,M2,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(S168(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K9*K5*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S168,-0.500)
       deallocate(S168)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,M1,N1,N1,M2,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S169(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S169,-1.000)
       deallocate(S169)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & M1,N1,M1,N1,N1,M2,N1,N3,VAHHPP,D1)
       ...
       call reorder562134(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(S170(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K9*K7*K7
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S170,-0.500)
       deallocate(S170)
C
     ...
     & N1,N3,N1,N3,N0,M1,N0,M1,VAHHPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,M1,N1,M1,N1,t2A,D2)
       allocate(S171(M1+1:N1,M1+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K7*K7
       I3=K3*K3
...
C
       ...
       X25=0.0d0
       call
     & sum3412(N0,M1,N0,M1,M1,N1,M1,N1,X25,S171, 0.500)
       deallocate(S171)
C
     ...
     & N1,N3,N1,N3,N0,M1,M1,N1,VAHHPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,M1,N1,M1,N1,t2A,D2)
       allocate(S172(M1+1:N1,M1+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K7*K7
       I3=K3*K3
...
C
       ...
       X26=0.0d0
       call
     & sum3412(N0,M1,M1,N1,M1,N1,M1,N1,X26,S172, 0.500)
       deallocate(S172)
C
     ...
     & N1,N3,N1,N3,M1,N1,M1,N1,VAHHPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,M1,N1,M1,N1,t2A,D2)
       allocate(S173(M1+1:N1,M1+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7
       I2=K7*K7
       I3=K3*K3
...
C
       ...
       X27=0.0d0
       call
     & sum3412(M1,N1,M1,N1,M1,N1,M1,N1,X27,S173, 0.500)
       deallocate(S173)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S174, 0.500)
       deallocate(S174)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S175, 0.500)
       deallocate(S175)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S176, 1.000)
       deallocate(S176)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S177, 1.000)
       deallocate(S177)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S178, 0.500)
       deallocate(S178)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S179, 0.500)
       deallocate(S179)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X28,S180,-1.000)
       deallocate(S180)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,N1,M2,M1,N1,X29,S181,-1.000)
       deallocate(S181)
C
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N1,X30,S182,-1.000)
       deallocate(S182)
C
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X31,S183,-1.000)
       deallocate(S183)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S184(N1+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K9
       I3=K3*K1
...
C
     ...
     & N0,M1,M2,N3,N1,M2,M1,N1,S184,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z285(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z285)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z285, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z285,-1.000)
       deallocate(Z285)
       deallocate(S184)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S185(N1+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z286, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z286,-1.000)
       deallocate(Z286)
       deallocate(S185)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S186(N1+1:M2,M1+1:N1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z287, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z287,-1.000)
       deallocate(Z287)
       deallocate(S186)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
     ...
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S187(N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z288, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z288,-1.000)
       deallocate(Z288)
       deallocate(S187)
C
...
C
     ...
     & N0,N1,N0,N1,M2,N3,M2,N3,VAHHPP,D1)
       ...
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S188(N1+1:M2,N1+1:M2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum3412(M2,N3,M2,N3,N1,M2,N1,M2,X36,S188, 0.500)
       deallocate(S188)
C
     ...
     & N0,N1,N0,N1,M2,N3,N1,M2,VAHHPP,D1)
       ...
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S189(N1+1:M2,N1+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum3412(M2,N3,N1,M2,N1,M2,N1,M2,X37,S189, 0.500)
       deallocate(S189)
C
     ...
     & N0,N1,N0,N1,N1,M2,N1,M2,VAHHPP,D1)
       ...
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S190(N1+1:M2,N1+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum3412(N1,M2,N1,M2,N1,M2,N1,M2,X38,S190, 0.500)
       deallocate(S190)
C
...
C
     ...
     & M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z296(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K7*K8*K9*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z296)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sum124563(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z296,-0.500)
       deallocate(Z296)
       deallocate(Q35)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,N1+1:M2))
...
C
     ...
     & N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z297(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K7*K8*K9*K0
       I3=K9
...
C
       call
     & sum124563(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z297,-0.500)
       deallocate(Z297)
       deallocate(Q36)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S191,-1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S193,-1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S195,-1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S197,-1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S192,-1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S194,-1.000)
C
       call
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S196,-1.000)
C
       call
...
C
     ...
     & M1,N2,M1,N1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(S198(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:N3))
       I1=K3
       I2=K8*K9*K0
       I3=K0*K7*K8
...
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X2,S198,-1.000)
C
       call
     & sum2341(N1,N3,N2,M2,N1,M2,M1,N2,X3,S198,-1.000)
       deallocate(S198)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S199, 1.000)
       deallocate(S199)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S200, 1.000)
       deallocate(S200)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S201, 1.000)
       deallocate(S201)
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(S202(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K6*K0*K8
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S202, 1.000)
       deallocate(S202)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,N1,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(S203(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S203, 1.000)
       deallocate(S203)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S204, 1.000)
       deallocate(S204)
C
     ...
     & N0,M1,N2,M2,N1,M2,N2,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(S205(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S205, 1.000)
       deallocate(S205)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S206, 1.000)
       deallocate(S206)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S207(N1+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K9
       I3=K3*K1
...
C
       ...
       X90=0.0d0
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X90,S207, 1.000)
       deallocate(S207)
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       ...
       deallocate(D2)
C
       allocate(X91(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       X91=0.0d0
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N1,X91,S208, 1.000)
       deallocate(S208)
C
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S209(N1+1:M2,M1+1:N1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K7*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X92(N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
       X92=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X92,S209, 1.000)
       deallocate(S209)
C
     ...
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S210(N1+1:M2,M1+1:N1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K7*K9
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X93(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       X93=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X93,S210, 1.000)
       deallocate(S210)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S211(N1+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K9
       I3=K3*K1
...
C
       ...
       X94=0.0d0
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X94,S211, 1.000)
       deallocate(S211)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S212(N1+1:M2,M1+1:N1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K7*K9
       I3=K3*K1
...
C
       ...
       X95=0.0d0
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N1,X95,S212, 1.000)
       deallocate(S212)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S213(N1+1:M2,M1+1:N1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K7*K9
       I3=K3*K1
...
C
       ...
       X96=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X96,S213, 1.000)
       deallocate(S213)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X97=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X97,S214, 1.000)
       deallocate(S214)
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S215(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K4
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X7,S215, 1.000)
       deallocate(S215)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,N2,FBHP,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S216(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K4
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S216, 1.000)
       deallocate(S216)
C
     ...
     & N0,N2,N0,N1,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S217(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X10,S217, 1.000)
       deallocate(S217)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S218(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X9,S218, 1.000)
       deallocate(S218)
C
     ...
     & N0,N1,N2,N3,N0,N2,M1,N1,VBHHHP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S219(N1+1:M2,M1+1:N2,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X8,S219,-1.000)
       deallocate(S219)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder4132(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N1,N2,N3,N0,N2,M1,N1,VBHHHP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S220(N1+1:M2,M1+1:N2,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X7,S220,-1.000)
       deallocate(S220)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S221(N1+1:M2,M1+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X67,S221, 1.000)
       deallocate(S221)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S222(N1+1:M2,M1+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X68,S222, 1.000)
       deallocate(S222)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S223(N1+1:M2,M1+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K7*K9
       I3=K4*K2
       ...
       deallocate(D2)
C
       allocate(X98(N1+1:N3,N1+1:M2,N1+1:M2,M1+1:N1))
       X98=0.0d0
       call
     & sum3412(N1,N3,N1,M2,N1,M2,M1,N1,X98,S223, 1.000)
       deallocate(S223)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S224(N1+1:M2,M1+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N1,N3,N1,M2,N1,M2,M1,N1,X98,S224,-1.000)
       deallocate(S224)
C
     ...
     & N0,N2,N1,N3,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S225(N2+1:M2,M1+1:N1,N2+1:N3,N1+1:M2))
       I1=K9*K4
       I2=K7*K0
       I3=K3*K2
       ...
       deallocate(D2)
C
       allocate(X99(N2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1))
       X99=0.0d0
       call
     & sum2413(N2,N3,N2,M2,N1,M2,M1,N1,X99,S225, 1.000)
       deallocate(S225)
C
     ...
     & N2,N3,N1,N3,N0,N2,N1,M2,VBPHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S226(M1+1:N2,M1+1:N1,N0+1:N2,N1+1:M2))
       I1=K9*K2
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,N2,N1,M2,M1,N2,M1,N1,X7,S226, 1.000)
       deallocate(S226)
C
       allocate(D1(N0+1:N2,N1+1:N3,N2+1:N3,N1+1:M2))
       call reorder3214(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,N2,N1,N3,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S227(N2+1:M2,M1+1:N1,N2+1:N3,N1+1:M2))
       I1=K9*K4
       I2=K7*K0
       I3=K3*K2
...
C
       ...
       X100=0.0d0
       call
     & sum2413(N2,N3,N2,M2,N1,M2,M1,N1,X100,S227, 1.000)
       deallocate(S227)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N0,N2,N1,N3,
     & N2,N3,N1,N3,N0,N2,N1,M2,VBPHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S228(M1+1:N2,M1+1:N1,N0+1:N2,N1+1:M2))
       I1=K9*K2
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,N2,N1,M2,M1,N2,M1,N1,X8,S228, 1.000)
       deallocate(S228)
C
...
C
       ...
       X101=0.0d0
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X101,S229, 1.000)
       deallocate(S229)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S230(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K4*K2
       ...
       deallocate(D2)
C
       allocate(X102(N0+1:N2,N1+1:M2,M1+1:N2,M1+1:N1))
       X102=0.0d0
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X102,S230, 1.000)
       deallocate(S230)
C
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X100,S231,-1.000)
       deallocate(S231)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum3412(N2,N3,N2,M2,N1,M2,M1,N1,X99,S232, 1.000)
       deallocate(S232)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S233, 0.500)
       deallocate(S233)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S234, 1.000)
       deallocate(S234)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S235, 0.500)
       deallocate(S235)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S236, 0.500)
       deallocate(S236)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S237, 1.000)
       deallocate(S237)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S238, 0.500)
       deallocate(S238)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S239, 0.500)
       deallocate(S239)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S240, 0.500)
       deallocate(S240)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S241, 1.000)
       deallocate(S241)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S242, 1.000)
       deallocate(S242)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S243, 0.500)
       deallocate(S243)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
     ...
     & M1,N1,N1,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3A,F2)
       allocate(S244(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K9*K9*K7
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S244, 0.500)
       deallocate(S244)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,M1,M2,N3,M2,N3,N0,N1,VAHHPP,D1)
       ...
       call reorder412356(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3A,F2)
       allocate(S245(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S245,-0.500)
       deallocate(S245)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S246,-0.500)
       deallocate(S246)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S247,-1.000)
       deallocate(S247)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S248,-1.000)
       deallocate(S248)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S249,-0.500)
       deallocate(S249)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S250,-0.500)
       deallocate(S250)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S251(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X11,S251, 1.000)
       deallocate(S251)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S252(N2+1:M2,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X12,S252, 1.000)
       deallocate(S252)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X13,S253, 1.000)
       deallocate(S253)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X14,S254, 1.000)
       deallocate(S254)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S255,-1.000)
       deallocate(S255)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S256(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K5*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S256,-1.000)
       deallocate(S256)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S257(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S257,-1.000)
       deallocate(S257)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,M2,N3,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S258(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K6*K7*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S258,-1.000)
       deallocate(S258)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S259(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K0*K5*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S259,-1.000)
       deallocate(S259)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S260(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K0*K5*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S260,-1.000)
       deallocate(S260)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S261(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K0*K7*K5
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S261,-1.000)
       deallocate(S261)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S262(N1+1:M2,N1+1:M2,M1+1:N1,N1+1:N3))
       I1=K3
       I2=K7*K9*K9
       I3=K0*K7*K8
...
C
       call
     & sum2341(N1,N3,N1,M2,N1,M2,M1,N1,X98,S262,-1.000)
       deallocate(S262)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S263, 1.000)
       deallocate(S263)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S264, 1.000)
       deallocate(S264)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S265, 1.000)
       deallocate(S265)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S266, 1.000)
       deallocate(S266)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S267, 1.000)
       deallocate(S267)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S268, 1.000)
       deallocate(S268)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S269, 1.000)
       deallocate(S269)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S270, 1.000)
       deallocate(S270)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S271, 1.000)
       deallocate(S271)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S272, 1.000)
       deallocate(S272)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S273, 1.000)
       deallocate(S273)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S274, 1.000)
       deallocate(S274)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S275, 1.000)
       deallocate(S275)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N0,M1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S276(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K5*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S276, 1.000)
       deallocate(S276)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M1,N1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S277(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S277, 1.000)
       deallocate(S277)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M1,N1,N1,M2,N2,N3,VBHHPP,D1)
       ...
       call reorder452136(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M1,N1,N1,M2,N2,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(S278(N2+1:M2,N1+1:M2,M1+1:N1,N2+1:N3))
       I1=K4
       I2=K7*K9*K0
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S278, 1.000)
       deallocate(S278)
C
     ...
     & N2,N3,N1,N3,N0,M1,N0,M1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S279(M1+1:N2,M1+1:N1,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,M1,N0,M1,M1,N2,M1,N1,X39,S279, 1.000)
       deallocate(S279)
C
     ...
     & N2,N3,N1,N3,M1,N2,N0,M1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S280(M1+1:N2,M1+1:N1,M1+1:N2,N0+1:M1))
       I1=K5*K8
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,N0,M1,M1,N2,M1,N1,X40,S280, 1.000)
       deallocate(S280)
C
     ...
     & N2,N3,N1,N3,N0,M1,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S281(M1+1:N2,M1+1:N1,N0+1:M1,M1+1:N1))
       I1=K7*K5
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(N0,M1,M1,N1,M1,N2,M1,N1,X41,S281, 1.000)
       deallocate(S281)
C
     ...
     & N2,N3,N1,N3,M1,N2,M1,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S282(M1+1:N2,M1+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K7*K8
       I3=K3*K4
...
C
       call
     & sum3412(M1,N2,M1,N1,M1,N2,M1,N1,X42,S282, 1.000)
       deallocate(S282)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X101,S283,-1.000)
       deallocate(S283)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S291, 1.000)
       deallocate(S291)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S292, 1.000)
       deallocate(S292)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S293, 1.000)
       deallocate(S293)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S294, 1.000)
       deallocate(S294)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S295, 1.000)
       deallocate(S295)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N1,M2,N3,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S296(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S296, 1.000)
       deallocate(S296)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,N2,M2,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S297(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S297, 1.000)
       deallocate(S297)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N1,N2,M2,N1,M2,N0,N2,VBHHPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(S298(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K9*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S298, 1.000)
       deallocate(S298)
C
     ...
     & N0,N2,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S299(N2+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N1,X73,S299,-1.000)
       deallocate(S299)
C
     ...
     & N0,N2,N1,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S300(N2+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N1,X74,S300,-1.000)
       deallocate(S300)
C
     ...
     & N0,N2,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S301(N2+1:M2,M1+1:N1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N1,X75,S301,-1.000)
       deallocate(S301)
C
     ...
     & N0,N2,N1,N3,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S302(N2+1:M2,M1+1:N1,M1+1:N1,N2+1:M2))
       I1=K0*K7
       I2=K7*K0
       I3=K3*K2
...
C
       call
     & sum3412(M1,N1,N2,M2,N2,M2,M1,N1,X76,S302,-1.000)
       deallocate(S302)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X28,S303,-1.000)
       deallocate(S303)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,N1,M2,M1,N1,X29,S304,-1.000)
       deallocate(S304)
C
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N1,X30,S305,-1.000)
       deallocate(S305)
C
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X31,S306,-1.000)
       deallocate(S306)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S307(N1+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X32,S307,-1.000)
       deallocate(S307)
C
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z32(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z32,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z32, 1.000)
       deallocate(Z32)
       deallocate(X32)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
     ...
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S308(N1+1:M2,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N1,M2,M1,N1,X33,S308,-1.000)
       deallocate(S308)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z33(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K7
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z33,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z33, 1.000)
       deallocate(Z33)
       deallocate(X33)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
     ...
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S309(N1+1:M2,M1+1:N1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N1,X34,S309,-1.000)
       deallocate(S309)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z34(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K9*K5
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z34,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z34, 1.000)
       deallocate(Z34)
       deallocate(X34)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
     ...
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S310(N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X35,S310,-1.000)
       deallocate(S310)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z35(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K9*K7
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z35,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z35, 1.000)
       deallocate(Z35)
       deallocate(X35)
C
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S312,-1.000)
       deallocate(S312)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S313,-1.000)
       deallocate(S313)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S320,-1.000)
       deallocate(S320)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S321,-1.000)
       deallocate(S321)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(S322(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K6*K0*K8
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S322,-1.000)
       deallocate(S322)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M2,N3,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(S323(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S323,-1.000)
       deallocate(S323)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,M2,N3,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(S324(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K9*K6*K8
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S324,-1.000)
       deallocate(S324)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,N2,M2,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(S325(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S325,-1.000)
       deallocate(S325)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,N0,N1,VBHHPP,D1)
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(S326(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K9*K0*K8
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S326,-1.000)
       deallocate(S326)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S327(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M1,N2,S327,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z444(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z444)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z444, 1.000)
       deallocate(Z444)
       deallocate(S327)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M1,N2,S328,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z445(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z445)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z445, 1.000)
       deallocate(Z445)
       deallocate(S328)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S329(N2+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M1,N2,S329,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z446(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K0*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z446)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z446, 1.000)
       deallocate(Z446)
       deallocate(S329)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S330(N2+1:M2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M1,N2,S330,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z447(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z447)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z447, 1.000)
       deallocate(Z447)
       deallocate(S330)
C
     ...
     & N0,N1,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S331(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N2,X77,S331, 1.000)
       deallocate(S331)
C
     ...
     & N0,N1,N2,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S332(N1+1:M2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N2,X78,S332, 1.000)
       deallocate(S332)
C
     ...
     & N0,N1,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S333(N1+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N2,X79,S333, 1.000)
       deallocate(S333)
C
     ...
     & N0,N1,N2,N3,M1,N2,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S334(N1+1:M2,M1+1:N2,M1+1:N2,N1+1:M2))
       I1=K9*K8
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,M1,N2,X80,S334, 1.000)
       deallocate(S334)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S335(N1+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N2,X81,S335, 1.000)
       deallocate(S335)
C
       allocate(D1(N0+1:N1,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S336(N1+1:M2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N2,X82,S336, 1.000)
       deallocate(S336)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S337(N1+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N2,X83,S337, 1.000)
       deallocate(S337)
C
       allocate(D1(N0+1:N1,N2+1:N3,M1+1:N2,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,M1,N2,N1,M2,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S338(N1+1:M2,M1+1:N2,M1+1:N2,N1+1:M2))
       I1=K9*K8
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,M1,N2,X84,S338, 1.000)
       deallocate(S338)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X85,Q39, 1.000)
       deallocate(Q39)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X86,Q40, 1.000)
       deallocate(Q40)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S339(N2+1:M2,N1+1:M2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,N1,M2,X55,S339, 1.000)
       deallocate(S339)
C
     ...
     & N0,N2,N0,N1,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S340(N2+1:M2,N1+1:M2,N2+1:M2,M2+1:N3))
       I1=K6*K0
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(N2,M2,M2,N3,N2,M2,N1,M2,X56,S340, 1.000)
       deallocate(S340)
C
     ...
     & N0,N2,N0,N1,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S341(N2+1:M2,N1+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(M2,N3,N1,M2,N2,M2,N1,M2,X57,S341, 1.000)
       deallocate(S341)
C
     ...
     & N0,N2,N0,N1,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S342(N2+1:M2,N1+1:M2,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(N2,M2,N1,M2,N2,M2,N1,M2,X58,S342, 1.000)
       deallocate(S342)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,M2,N3,VBHHPP,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S343(N2+1:M2,N1+1:M2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,N1,M2,X59,S343, 1.000)
       deallocate(S343)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N2,M2,M2,N3,N2,M2,N1,M2,X60,S344, 1.000)
       deallocate(S344)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M2,N3,N1,M2,N2,M2,N1,M2,X61,S345, 1.000)
       deallocate(S345)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N2,M2,N1,M2,N2,M2,N1,M2,X62,S346, 1.000)
       deallocate(S346)
C
...
C
       call
     & sum21(M2,N3,N2,M2,X87,Q41,-1.000)
       deallocate(Q41)
C
...
C
       call
     & sum21(N2,M2,N2,M2,X88,Q42,-1.000)
       deallocate(Q42)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S347,-0.500)
       deallocate(S347)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S348,-1.000)
       deallocate(S348)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S349,-0.500)
       deallocate(S349)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S350,-0.500)
       deallocate(S350)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S351,-1.000)
       deallocate(S351)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X100,S352,-0.500)
       deallocate(S352)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S353, 0.500)
       deallocate(S353)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S354, 1.000)
       deallocate(S354)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S355, 0.500)
       deallocate(S355)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S356, 0.500)
       deallocate(S356)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S357, 1.000)
       deallocate(S357)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,N1,M2,M1,N1,X99,S358, 0.500)
       deallocate(S358)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X101,S360, 0.500)
       deallocate(S360)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X101,S362, 1.000)
       deallocate(S362)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X101,S364, 0.500)
       deallocate(S364)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,M1,M2,N3,M2,N3,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       allocate(S365(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S365, 0.500)
       deallocate(S365)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & M1,N2,M2,N3,M2,N3,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       allocate(S366(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S366, 0.500)
       deallocate(S366)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,M1,M2,N3,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(S367(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K0*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S367, 1.000)
       deallocate(S367)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S368, 1.000)
       deallocate(S368)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S369, 0.500)
       deallocate(S369)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X102,S370, 0.500)
       deallocate(S370)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S371(N1+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,M1,M2,N3,
     & N0,M1,M2,N3,N1,M2,M1,N1,S371,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z496(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z496)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z496,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z496, 1.000)
       deallocate(Z496)
       deallocate(S371)
C
     ...
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S372(N1+1:M2,M1+1:N1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K7*K9
       I3=K4*K2
...
C
     ...
     & M1,N2,M2,N3,N1,M2,M1,N1,S372,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z497(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z497,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z497, 1.000)
       deallocate(Z497)
       deallocate(S372)
C
     ...
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S373(N1+1:M2,M1+1:N1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K7*K9
       I3=K4*K2
...
C
     ...
     & N0,M1,N2,M2,N1,M2,M1,N1,S373,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z498(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K5
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z498,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z498, 1.000)
       deallocate(Z498)
       deallocate(S373)
C
     ...
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S374(N1+1:M2,M1+1:N1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K7*K9
       I3=K4*K2
...
C
     ...
     & M1,N2,N2,M2,N1,M2,M1,N1,S374,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z499(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z499)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z499,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z499, 1.000)
       deallocate(Z499)
       deallocate(S374)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S375(N1+1:M2,M1+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N1,M2,M1,N1,X94,S375, 1.000)
       deallocate(S375)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S376(N1+1:M2,M1+1:N1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N1,M2,M1,N1,X95,S376, 1.000)
       deallocate(S376)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S377(N1+1:M2,M1+1:N1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X96,S377, 1.000)
       deallocate(S377)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S378(N1+1:M2,M1+1:N1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X97,S378, 1.000)
       deallocate(S378)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S379(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X11,S379, 1.000)
       deallocate(S379)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S380(N2+1:M2,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X12,S380, 1.000)
       deallocate(S380)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S381(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X13,S381, 1.000)
       deallocate(S381)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S382(N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X14,S382, 1.000)
       deallocate(S382)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S383(N2+1:M2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X63,S383,-1.000)
       deallocate(S383)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S384(N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,N2,M2,M1,N2,X64,S384,-1.000)
       deallocate(S384)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S385(N2+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N2,X65,S385,-1.000)
       deallocate(S385)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,M1,N2,X66,S386,-1.000)
       deallocate(S386)
C
...
C
     ...
     & N1,N3,N0,N1,N0,N1,M1,N1,VAHHHP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S387(M1+1:N1,N0+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,N1,M1,N1,M1,N1,S387,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S389(N1+1:M2,N0+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X68,S389, 1.000)
       deallocate(S389)
C
       allocate(D1(N0+1:N1,N0+1:N1,M1+1:N1,M1+1:N1))
     ...
     & N0,N1,N0,N1,M1,N1,M1,N1,S387,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S388(N1+1:M2,N0+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X67,S388,-1.000)
       deallocate(S388)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,N3,M1,N1,VAHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S390(N1+1:M2,N0+1:N1,N1+1:N3,M1+1:N1))
       I1=K7*K3*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S390,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S391(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X6,S391, 1.000)
       deallocate(S391)
C
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S392,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S396(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,M1,N1,X6,S396,-1.000)
       deallocate(S396)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:M2,M1+1:N1))
...
C
       call
     & sum3124(N0,N1,N1,M2,M1,N1,M1,N1,X4,S393, 1.000)
       deallocate(S393)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:N3,N1+1:M2))
       call reorder2413(N1,N3,N1,N3,N1,N3,N0,N1,
     & N1,N3,N0,N1,N1,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S394(M1+1:N1,N0+1:N1,N1+1:N3,N1+1:M2))
       I1=K9*K3*K1
       I2=K7
       I3=K3
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N1,N3,N1,M2,
     & N0,N1,N1,N3,N1,M2,M1,N1,S394,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S397(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X6,S397, 1.000)
       deallocate(S397)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N1,N3,N1,M2,
     & N1,N3,N0,N1,N1,M2,M1,N1,S394,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S395(M1+1:N1,N0+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K1
       I2=K7
       I3=K3
...
C
       call
     & sum3124(N0,N1,N1,M2,M1,N1,M1,N1,X5,S395, 1.000)
       deallocate(S395)
C
     ...
     & N1,N3,N0,N2,N0,N1,M1,N2,VBHHPH,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S398(M1+1:N1,N0+1:N2,N0+1:N1,M1+1:N2))
       I1=K8*K1*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,N2,M1,N2,M1,N1,S398,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S400(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S400,-1.000)
       deallocate(S400)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,M1,N2,
     & N0,N2,N0,N1,M1,N2,M1,N1,S398,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S444(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S444,-1.000)
       deallocate(S444)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,M1,N2,
     & N0,N1,N0,N2,M1,N2,M1,N1,S398,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S399(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X7,S399,-1.000)
       deallocate(S399)
C
     ...
     & N1,N3,N0,N1,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S401(M1+1:N1,N0+1:N1,N2+1:N3,N2+1:M2))
       I1=K0*K4*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N2,N3,N2,M2,M1,N1,S401,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S402(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X9,S402,-1.000)
       deallocate(S402)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N2,N3,N2,M2,
     & N2,N3,N0,N1,N2,M2,M1,N1,S401,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S445(M1+1:N2,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X1,S445, 1.000)
       deallocate(S445)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N2,N3,N2,M2,
     & N0,N1,N2,N3,N2,M2,M1,N1,S401,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S403(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X10,S403,-1.000)
       deallocate(S403)
C
     ...
     & N1,N3,M1,N1,M1,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S408(M1+1:N1,M1+1:N1,M1+1:N1,N1+1:N3))
       I1=K3*K7*K7
       I2=K7
       I3=K3
...
C
     ...
     & N1,N3,M1,N1,M1,N1,M1,N1,S408,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S409(M1+1:N1,M1+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K7
       I2=K7
       I3=K3
...
C
       call
     & sum3124(M1,N1,M1,N1,M1,N1,M1,N1,X27,S409, 1.000)
       deallocate(S409)
C
...
C
       ...
       call reorder561234(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(Z27(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7
       I2=K8*K9*K9*K0
       I3=K7*K7
...
C
     ...
     & N1,N3,N0,N1,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S410(M1+1:N1,N0+1:N1,N0+1:M1,M2+1:N3))
       I1=K6*K5*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N1,S410,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S411(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N1,X28,S411, 1.000)
       deallocate(S411)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z28(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z28, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z28,-1.000)
       deallocate(Z28)
       deallocate(X28)
C
     ...
     & N1,N3,N0,N1,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S412(M1+1:N1,N0+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,M2,N3,M1,N1,S412,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S413(N1+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,M2,N3,N1,M2,M1,N1,X29,S413, 1.000)
       deallocate(S413)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z29(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K7
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z29, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z29,-1.000)
       deallocate(Z29)
       deallocate(X29)
C
     ...
     & N1,N3,N0,N1,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S414(M1+1:N1,N0+1:N1,N0+1:M1,N1+1:M2))
       I1=K9*K5*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N1,S414,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S415(N1+1:M2,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N1,X30,S415, 1.000)
       deallocate(S415)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z30(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K9*K5
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z30, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z30,-1.000)
       deallocate(Z30)
       deallocate(X30)
C
     ...
     & N1,N3,N0,N1,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S416(M1+1:N1,N0+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S416,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S417(N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X31,S417, 1.000)
       deallocate(S417)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       ...
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z31(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K9*K7
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z31, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z31,-1.000)
       deallocate(Z31)
       deallocate(X31)
C
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N1,S418,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S419(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N1,X69,S419,-1.000)
       deallocate(S419)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z102(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z102,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z102, 1.000)
       deallocate(Z102)
       deallocate(X69)
C
     ...
     & N1,N3,M1,N1,N0,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S420(M1+1:N1,M1+1:N1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K7
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,M2,N3,M1,N1,S420,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S421(N1+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,M2,N3,N1,M2,M1,N1,X70,S421,-1.000)
       deallocate(S421)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z103(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K7
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z103,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z103, 1.000)
       deallocate(Z103)
       deallocate(X70)
C
     ...
     & N1,N3,N0,M1,N0,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S422(M1+1:N1,N0+1:M1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K5
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N1,S422,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S423(N1+1:M2,N0+1:M1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N1,X71,S423,-1.000)
       deallocate(S423)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z104(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K9*K5
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z104,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z104, 1.000)
       deallocate(Z104)
       deallocate(X71)
C
     ...
     & N1,N3,M1,N1,N0,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S424(M1+1:N1,M1+1:N1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K7
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S424,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S425(N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X72,S425,-1.000)
       deallocate(S425)
C
       allocate(F2(M1+1:N1,N1+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder521346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z105(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K9*K7
...
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z105,-1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z105, 1.000)
       deallocate(Z105)
       deallocate(X72)
C
...
C
     ...
     & N0,N1,N0,N1,M2,N3,M2,N3,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S426(N1+1:M2,N0+1:N1,M2+1:N3,M2+1:N3))
       I1=K6*K6*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,M2,N3,M2,N3,N1,M2,S426,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S427(N1+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M2,N3,M2,N3,N1,M2,N1,M2,X36,S427, 1.000)
       deallocate(S427)
C
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N1,M1,N1,t3B3,F2)
       allocate(Z36(N2+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9
       I2=K7*K7*K8*K0
       I3=K6*K6
...
C
       call
     & sum145623(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z36, 0.500)
       deallocate(Z36)
       deallocate(X36)
C
       allocate(D1(N0+1:N1,N0+1:N1,M2+1:N3,N1+1:M2))
     ...
     & N0,N1,N0,N1,M2,N3,N1,M2,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S428(N1+1:M2,N0+1:N1,M2+1:N3,N1+1:M2))
       I1=K9*K6*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,M2,N3,N1,M2,N1,M2,S428,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S429(N1+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M2,N3,N1,M2,N1,M2,N1,M2,X37,S429, 1.000)
       deallocate(S429)
C
       call sumx1234(N1,N3,N1,N3,N1,N3,N1,M2,
...
C
     ...
     & M2,N3,N1,M2,N2,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z37(N2+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9
       I2=K7*K7*K8*K0
       I3=K9*K6
...
C
       call
     & sum145623(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z37, 1.000)
       deallocate(Z37)
       deallocate(X37)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:M2,N1+1:M2))
     ...
     & N0,N1,N0,N1,N1,M2,N1,M2,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S430(N1+1:M2,N0+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K1
       I2=K9
       I3=K1
...
C
     ...
     & N0,N1,N1,M2,N1,M2,N1,M2,S430,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S431(N1+1:M2,N1+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K9
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,M2,N1,M2,N1,M2,N1,M2,X38,S431, 1.000)
       deallocate(S431)
C
       call sumx1234(N1,N3,N1,N3,N1,N3,N1,M2,
...
C
     ...
     & N1,M2,N1,M2,N2,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z38(N2+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9
       I2=K7*K7*K8*K0
       I3=K9*K9
...
C
       call
     & sum145623(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z38, 0.500)
       deallocate(Z38)
       deallocate(X38)
C
...
C
     ...
     & N1,N3,N0,M1,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S432(M1+1:N1,N0+1:M1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K5
       I2=K7
       I3=K3
...
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,M1,N0,N1,M2,N3,
     & N0,N1,N0,M1,M2,N3,M1,N1,S432,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S440(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N1,X94,S440,-1.000)
       deallocate(S440)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z326(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X94,F2,Z326)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z326, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z326,-1.000)
       deallocate(Z326)
       deallocate(X94)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,M1+1:N1))
     ...
     & N0,N1,N0,M1,M2,N3,M1,N1,S432,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S433(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N1,X90,S433,-1.000)
       deallocate(S433)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z322(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X90,F2,Z322)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z322,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z322, 1.000)
       deallocate(Z322)
       deallocate(X90)
C
     ...
     & N1,N3,N0,M1,N0,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S436(M1+1:N1,N0+1:M1,N0+1:N1,N2+1:M2))
       I1=K0*K1*K5
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N0,M1,N2,M2,M1,N1,S436,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S442(N1+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N2,M2,N1,M2,M1,N1,X96,S442,-1.000)
       deallocate(S442)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z328(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X96,F2,Z328)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z328, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z328,-1.000)
       deallocate(Z328)
       deallocate(X96)
C
       allocate(D1(N0+1:N1,N0+1:M1,N2+1:M2,M1+1:N1))
     ...
     & N0,N1,N0,M1,N2,M2,M1,N1,S436,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S437(N1+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N2,M2,N1,M2,M1,N1,X92,S437,-1.000)
       deallocate(S437)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z324(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X92,F2,Z324)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z324,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z324, 1.000)
       deallocate(Z324)
       deallocate(X92)
C
     ...
     & N1,N3,M1,N2,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S434(M1+1:N1,M1+1:N2,N0+1:N1,M2+1:N3))
       I1=K6*K1*K8
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,S434,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S441(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N1))
       I1=K7*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N1,X95,S441,-1.000)
       deallocate(S441)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z327(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X95,F2,Z327)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z327, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z327,-1.000)
       deallocate(Z327)
       deallocate(X95)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,M1+1:N1))
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,S434,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S435(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N1))
       I1=K7*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N1,X91,S435,-1.000)
       deallocate(S435)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z323(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X91,F2,Z323)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z323,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z323, 1.000)
       deallocate(Z323)
       deallocate(X91)
C
     ...
     & N1,N3,M1,N2,N0,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S438(M1+1:N1,M1+1:N2,N0+1:N1,N2+1:M2))
       I1=K0*K1*K8
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,S438,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S443(N1+1:M2,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,M1,N1,X97,S443,-1.000)
       deallocate(S443)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z329(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X97,F2,Z329)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z329, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z329,-1.000)
       deallocate(Z329)
       deallocate(X97)
C
       allocate(D1(N0+1:N1,M1+1:N2,N2+1:M2,M1+1:N1))
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,S438,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S439(N1+1:M2,M1+1:N2,N2+1:M2,M1+1:N1))
       I1=K7*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,M1,N1,X93,S439,-1.000)
       deallocate(S439)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z325(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X93,F2,Z325)
       deallocate(F2)
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z325,-1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z325, 1.000)
       deallocate(Z325)
       deallocate(X93)
C
     ...
     & N1,N3,N0,M1,N0,M1,N1,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S404(M1+1:N1,N0+1:M1,N0+1:M1,N1+1:N3))
       I1=K3*K5*K5
       I2=K7
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,N0,M1,M1,N1,S404,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S405(M1+1:N1,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K5
       I2=K7
       I3=K3
...
C
       call
     & sum3124(N0,M1,N0,M1,M1,N1,M1,N1,X25,S405, 1.000)
       deallocate(S405)
C
       call sumx3412(N0,N1,N0,N1,N0,N1,N0,N1,
...
C
       ...
       call reorder561234(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(Z25(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7
       I2=K8*K9*K9*K0
       I3=K5*K5
...
C
     ...
     & N1,N3,N0,M1,M1,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S406(M1+1:N1,N0+1:M1,M1+1:N1,N1+1:N3))
       I1=K3*K7*K5
       I2=K7
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,M1,N1,M1,N1,S406,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S407(M1+1:N1,N0+1:M1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K5
       I2=K7
       I3=K3
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N1,M1,N1,X26,S407, 1.000)
       deallocate(S407)
C
       call sumx3412(N0,N1,N0,N1,N0,N1,N0,N1,
...
C
       ...
       call reorder561234(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(Z26(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7
       I2=K8*K9*K9*K0
       I3=K7*K5
...
C
     ...
     & N0,N1,N0,N2,N1,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S446(N1+1:M2,N0+1:N2,N1+1:N3,M1+1:N2))
       I1=K8*K3*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S446,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S447(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X2,S447, 1.000)
       deallocate(S447)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,M1+1:N2))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N0,N2,N1,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S448(N1+1:M2,N0+1:N2,N1+1:N3,M1+1:N2))
       I1=K8*K3*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S448,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S449(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X3,S449, 1.000)
       deallocate(S449)
C
     ...
     & N2,N3,N0,N1,N1,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S450(M1+1:N2,N0+1:N1,N1+1:N3,N2+1:M2))
       I1=K0*K3*K1
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,S450,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S452(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X3,S452,-1.000)
       deallocate(S452)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder2341(M1,N2,N0,N1,N1,N3,N2,M2,
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X2,S451,-1.000)
       deallocate(S451)
C
     ...
     & N2,N3,N0,N2,N0,N1,M1,N1,VBHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S453(M1+1:N2,N0+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,N0,N2,M1,N2,M1,N1,S453,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S455(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S455,-1.000)
       deallocate(S455)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S453,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S551(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S551,-1.000)
       deallocate(S551)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S453,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S454(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X7,S454,-1.000)
       deallocate(S454)
C
     ...
     & N0,N1,N0,N2,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S458(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S458,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S459(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X10,S459, 1.000)
       deallocate(S459)
C
     ...
     & N1,N3,N0,N2,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S460(M1+1:N1,N0+1:N2,N2+1:N3,N1+1:M2))
       I1=K9*K4*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S460,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S464(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X9,S464,-1.000)
       deallocate(S464)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,M1,N1,S460,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S461(M1+1:N2,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X7,S461, 1.000)
       deallocate(S461)
C
       allocate(D1(N1+1:N3,N0+1:N2,N2+1:N3,N1+1:M2))
       call reorder2314(N2,N3,N1,N3,N0,N2,N1,N3,
     & N1,N3,N0,N2,N2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S462(M1+1:N1,N0+1:N2,N2+1:N3,N1+1:M2))
       I1=K9*K4*K2
       I2=K7
       I3=K3
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N2,N3,N1,M2,
     & N0,N2,N2,N3,N1,M2,M1,N1,S462,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S465(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X10,S465,-1.000)
       deallocate(S465)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,M1,N1,S462,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S463(M1+1:N2,N0+1:N2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K2
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X8,S463, 1.000)
       deallocate(S463)
C
     ...
     & N1,N3,N0,M1,N0,M1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S466(M1+1:N1,N0+1:M1,N0+1:M1,N2+1:N3))
       I1=K4*K5*K5
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N1,S466,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S467(M1+1:N2,N0+1:M1,N0+1:M1,M1+1:N1))
       I1=K7*K5*K5
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,M1,N0,M1,M1,N2,M1,N1,X39,S467, 1.000)
       deallocate(S467)
C
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(Z39(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K7*K9*K9*K0
       I3=K5*K5
...
C
       call
     & sum123546(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z39,-1.000)
       call
     & sum123645(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z39, 1.000)
       deallocate(Z39)
       deallocate(X39)
C
     ...
     & N1,N3,M1,N2,N0,M1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S468(M1+1:N1,M1+1:N2,N0+1:M1,N2+1:N3))
       I1=K4*K5*K8
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,S468,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S469(M1+1:N2,M1+1:N2,N0+1:M1,M1+1:N1))
       I1=K7*K5*K8
       I2=K8
       I3=K4
...
C
       call
     & sum3124(M1,N2,N0,M1,M1,N2,M1,N1,X40,S469, 1.000)
       deallocate(S469)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(Z40(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K7*K9*K9*K0
       I3=K5*K8
...
C
       call
     & sum123546(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z40,-1.000)
       call
     & sum123645(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z40, 1.000)
       deallocate(Z40)
       deallocate(X40)
C
     ...
     & N1,N3,N0,M1,M1,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S470(M1+1:N1,N0+1:M1,M1+1:N1,N2+1:N3))
       I1=K4*K7*K5
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,S470,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S471(M1+1:N2,N0+1:M1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K5
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N2,M1,N1,X41,S471, 1.000)
       deallocate(S471)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(Z41(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K7*K9*K9*K0
       I3=K7*K5
...
C
       call
     & sum123546(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z41,-1.000)
       call
     & sum123645(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z41, 1.000)
       deallocate(Z41)
       deallocate(X41)
C
     ...
     & N1,N3,M1,N2,M1,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S472(M1+1:N1,M1+1:N2,M1+1:N1,N2+1:N3))
       I1=K4*K7*K8
       I2=K7
       I3=K3
...
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,S472,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S473(M1+1:N2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K8
       I2=K8
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N1,M1,N2,M1,N1,X42,S473, 1.000)
       deallocate(S473)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       ...
       call reorder451236(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M1,N1,N2,M2,N1,M2,N1,M2,M1,N1,t3B1,F2)
       allocate(Z42(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8
       I2=K7*K9*K9*K0
       I3=K7*K8
...
C
       call
     & sum123546(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z42,-1.000)
       call
     & sum123645(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z42, 1.000)
       deallocate(Z42)
       deallocate(X42)
C
     ...
     & N1,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S474(M1+1:N1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N1,S474,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S475(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N1,X73,S475,-1.000)
       deallocate(S475)
C
       allocate(F2(N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z130(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K7*K8*K9*K9
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X73,F2,Z130)
       deallocate(F2)
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z130, 1.000)
       call
     & sum234615(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z130,-1.000)
       deallocate(Z130)
       deallocate(X73)
C
     ...
     & N1,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S476(M1+1:N1,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,S476,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S477(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N1))
       I1=K7*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N1,X74,S477,-1.000)
       deallocate(S477)
C
       allocate(F2(M1+1:N1,M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z131(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K7*K8*K9*K9
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X74,F2,Z131)
       deallocate(F2)
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z131, 1.000)
       call
     & sum234615(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z131,-1.000)
       deallocate(Z131)
       deallocate(X74)
C
     ...
     & N1,N3,N0,N2,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S478(M1+1:N1,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N1,S478,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S479(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N1,X75,S479,-1.000)
       deallocate(S479)
C
       allocate(F2(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z132(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K7*K8*K9*K9
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X75,F2,Z132)
       deallocate(F2)
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z132, 1.000)
       call
     & sum234615(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z132,-1.000)
       deallocate(Z132)
       deallocate(X75)
C
     ...
     & N1,N3,N0,N2,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S480(M1+1:N1,N0+1:N2,M1+1:N1,N2+1:M2))
       I1=K0*K7*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,M1,N1,N2,M2,M1,N1,S480,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S481(N2+1:M2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N2,M2,N2,M2,M1,N1,X76,S481,-1.000)
       deallocate(S481)
C
       allocate(F2(M1+1:N1,N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z133(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0
       I2=K7*K8*K9*K9
       I3=K0*K7
...
C
       call
     & sum234516(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z133, 1.000)
       call
     & sum234615(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z133,-1.000)
       deallocate(Z133)
       deallocate(X76)
C
...
C
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z15(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7
       I2=K7*K8*K9*K9*K0
       I3=K5
...
C
       V3B=V3B+Z15
       call
     & sum123465(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z15,-1.000)
       deallocate(Z15)
       deallocate(X15)
C
...
C
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       allocate(Z16(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       I1=K7
       I2=K7*K8*K9*K9*K0
       I3=K7
...
C
       V3B=V3B+Z16
       call
     & sum123465(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z16,-1.000)
       deallocate(Z16)
       deallocate(X16)
C
     ...
     & N2,N3,N0,M1,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S482(M1+1:N2,N0+1:M1,N0+1:N1,M2+1:N3))
       I1=K6*K1*K5
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N2,S482,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S490(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N2,X81,S490, 1.000)
       deallocate(S490)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z138(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K6*K5
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z138,-1.000)
       deallocate(Z138)
       deallocate(X81)
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,M1+1:N2))
     ...
     & N0,N1,N0,M1,M2,N3,M1,N2,S482,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S483(N1+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,M2,N3,N1,M2,M1,N2,X77,S483, 1.000)
       deallocate(S483)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z134(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K6*K5
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z134, 1.000)
       deallocate(Z134)
       deallocate(X77)
C
     ...
     & N2,N3,N0,M1,N0,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S486(M1+1:N2,N0+1:M1,N0+1:N1,N1+1:M2))
       I1=K9*K1*K5
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N2,S486,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S492(N1+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X83,S492, 1.000)
       deallocate(S492)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z140(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K9*K5
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z140,-1.000)
       deallocate(Z140)
       deallocate(X83)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,M1+1:N2))
     ...
     & N0,N1,N0,M1,N1,M2,M1,N2,S486,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S487(N1+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X79,S487, 1.000)
       deallocate(S487)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z136(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K9*K5
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z136, 1.000)
       deallocate(Z136)
       deallocate(X79)
C
     ...
     & N2,N3,M1,N2,N0,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S484(M1+1:N2,M1+1:N2,N0+1:N1,M2+1:N3))
       I1=K6*K1*K8
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N2,S484,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S491(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N2,X82,S491, 1.000)
       deallocate(S491)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z139(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K6*K8
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z139,-1.000)
       deallocate(Z139)
       deallocate(X82)
C
       allocate(D1(N0+1:N1,M1+1:N2,M2+1:N3,M1+1:N2))
     ...
     & N0,N1,M1,N2,M2,N3,M1,N2,S484,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S485(N1+1:M2,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,M2,N3,N1,M2,M1,N2,X78,S485, 1.000)
       deallocate(S485)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z135(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K6*K8
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z135, 1.000)
       deallocate(Z135)
       deallocate(X78)
C
     ...
     & N2,N3,M1,N2,N0,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S488(M1+1:N2,M1+1:N2,N0+1:N1,N1+1:M2))
       I1=K9*K1*K8
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,M1,N2,N1,M2,M1,N2,S488,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S493(N1+1:M2,M1+1:N2,N1+1:M2,M1+1:N2))
       I1=K8*K9*K8
       I2=K9
       I3=K1
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X84,S493, 1.000)
       deallocate(S493)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z141(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K9*K8
...
C
       call
     & sum125634(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z141,-1.000)
       deallocate(Z141)
       deallocate(X84)
C
       allocate(D1(N0+1:N1,M1+1:N2,N1+1:M2,M1+1:N2))
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X80,S489, 1.000)
       deallocate(S489)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,N2,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z137(N2+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9
       I2=K7*K7*K9*K0
       I3=K9*K8
...
C
       call
     & sum135624(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z137, 1.000)
       deallocate(Z137)
       deallocate(X80)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X85,Q66, 1.000)
       deallocate(Q66)
C
       allocate(F2(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z142(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,M1+1:N2))
       I1=K8
       I2=K7*K7*K9*K9*K0
       I3=K5
...
C
       call
     & sum123564(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z142,-1.000)
       deallocate(Z142)
       deallocate(X85)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X86,Q68, 1.000)
       deallocate(Q68)
C
       allocate(F2(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z143(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,M1+1:N2))
       I1=K8
       I2=K7*K7*K9*K9*K0
       I3=K8
...
C
       call
     & sum123564(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z143,-1.000)
       deallocate(Z143)
       deallocate(X86)
C
     ...
     & N0,N1,N0,N2,M2,N3,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S494(N1+1:M2,N0+1:N2,M2+1:N3,M2+1:N3))
       I1=K6*K6*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,M2,N3,M2,N3,N1,M2,S494,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S495(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X55,S495, 1.000)
       deallocate(S495)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,M2,N3,N2,M2,N1,M2,X55,VBAPPP, 1.000)
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z55(N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K7*K8*K9
       I3=K6*K6
...
C
       call
     & sum345612(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z55, 1.000)
       deallocate(Z55)
       deallocate(X55)
C
     ...
     & N0,N1,N0,N2,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S496(N1+1:M2,N0+1:N2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,S496,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S497(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X56,S497, 1.000)
       deallocate(S497)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,M2,N3,N2,M2,N1,M2,X56,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z56(N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K7*K8*K9
       I3=K6*K0
...
C
       call
     & sum345612(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z56, 1.000)
       deallocate(Z56)
       deallocate(X56)
C
     ...
     & N0,N1,N0,N2,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S498(N1+1:M2,N0+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,S498,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S499(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X57,S499, 1.000)
       deallocate(S499)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,N1,M2,N2,M2,N1,M2,X57,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z57(N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K7*K8*K9
       I3=K9*K6
...
C
       call
     & sum345612(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z57, 1.000)
       deallocate(Z57)
       deallocate(X57)
C
     ...
     & N0,N1,N0,N2,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S500(N1+1:M2,N0+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K2
       I2=K9
       I3=K1
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,S500,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S501(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X58,S501, 1.000)
       deallocate(S501)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,N1,M2,N2,M2,N1,M2,X58,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z58(N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K7*K8*K9
       I3=K9*K0
...
C
       call
     & sum345612(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z58, 1.000)
       deallocate(Z58)
       deallocate(X58)
C
       allocate(D1(N0+1:N1,N0+1:N2,M2+1:N3,M2+1:N3))
     ...
     & N0,N1,N0,N2,M2,N3,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S502(N1+1:M2,N0+1:N2,M2+1:N3,M2+1:N3))
       I1=K6*K6*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,M2+1:N3,M2+1:N3,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,M2,N3,M2,N3,
     & N0,N2,M2,N3,M2,N3,N1,M2,S502,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S503(N2+1:M2,M2+1:N3,M2+1:N3,N1+1:M2))
       I1=K9*K6*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,M2,N3,N2,M2,N1,M2,X59,S503, 1.000)
       deallocate(S503)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,M2,N3,N2,M2,N1,M2,X59,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z59(N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K7*K8*K9
       I3=K6*K6
...
C
       call
     & sum245613(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z59,-1.000)
       deallocate(Z59)
       deallocate(X59)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:M2,M2+1:N3))
     ...
     & N0,N1,N0,N2,N2,M2,M2,N3,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S504(N1+1:M2,N0+1:N2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:M2,M2+1:N3,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,N2,M2,M2,N3,
     & N0,N2,N2,M2,M2,N3,N1,M2,S504,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S505(N2+1:M2,N2+1:M2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,M2,N3,N2,M2,N1,M2,X60,S505, 1.000)
       deallocate(S505)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,M2,N3,N2,M2,N1,M2,X60,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z60(N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K7*K8*K9
       I3=K6*K0
...
C
       call
     & sum245613(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z60,-1.000)
       deallocate(Z60)
       deallocate(X60)
C
       allocate(D1(N0+1:N1,N0+1:N2,M2+1:N3,N1+1:M2))
     ...
     & N0,N1,N0,N2,M2,N3,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S506(N1+1:M2,N0+1:N2,M2+1:N3,N1+1:M2))
       I1=K9*K6*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,M2,N3,N1,M2,
     & N0,N2,M2,N3,N1,M2,N1,M2,S506,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S507(N2+1:M2,M2+1:N3,N1+1:M2,N1+1:M2))
       I1=K9*K9*K6
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M2,N3,N1,M2,N2,M2,N1,M2,X61,S507, 1.000)
       deallocate(S507)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & M2,N3,N1,M2,N2,M2,N1,M2,X61,VBAPPP, 1.000)
C
       allocate(F2(M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z61(N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K7*K8*K9
       I3=K9*K6
...
C
       call
     & sum245613(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z61,-1.000)
       deallocate(Z61)
       deallocate(X61)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:M2,N1+1:M2))
     ...
     & N0,N1,N0,N2,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S508(N1+1:M2,N0+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,N2,M2,N1,M2,
     & N0,N2,N2,M2,N1,M2,N1,M2,S508,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S509(N2+1:M2,N2+1:M2,N1+1:M2,N1+1:M2))
       I1=K9*K9*K0
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,M2,N1,M2,N2,M2,N1,M2,X62,S509, 1.000)
       deallocate(S509)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
     & N2,M2,N1,M2,N2,M2,N1,M2,X62,VBAPPP, 1.000)
C
       allocate(F2(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z62(N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0
       I2=K7*K7*K8*K9
       I3=K9*K0
...
C
       call
     & sum245613(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z62,-1.000)
       deallocate(Z62)
       deallocate(X62)
C
...
C
       call
     & sum21(M2,N3,N2,M2,X87,Q70,-1.000)
       deallocate(Q70)
C
       allocate(F2(M2+1:N3,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z152(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K7*K8*K9*K9
       I3=K6
       call DMATMAT(I1,I2,I3,X87,F2,Z152)
       deallocate(F2)
C
       call
     & sum234561(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z152, 1.000)
       deallocate(Z152)
       deallocate(X87)
C
...
C
       call
     & sum21(N2,M2,N2,M2,X88,Q72,-1.000)
       deallocate(Q72)
C
       allocate(F2(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z153(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K7*K8*K9*K9
       I3=K0
       call DMATMAT(I1,I2,I3,X88,F2,Z153)
       deallocate(F2)
C
       call
     & sum234561(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z153, 1.000)
       deallocate(Z153)
       deallocate(X88)
C
...
C
       ...
       call reorder213456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z19(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K7*K8*K9*K0
       I3=K6
...
C
       call
     & sum124563(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z19,-1.000)
       deallocate(Z19)
       deallocate(X19)
C
       allocate(B2(N0+1:N1,N1+1:M2))
...
C
       ...
       call reorder213456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z17(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K7*K8*K9*K0
       I3=K6
...
C
       call
     & sum134562(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z17, 1.000)
       deallocate(Z17)
       deallocate(X17)
C
...
C
       ...
       call reorder213456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z20(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K7*K8*K9*K0
       I3=K9
...
C
       call
     & sum124563(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z20,-1.000)
       deallocate(Z20)
       deallocate(X20)
C
       allocate(B2(N0+1:N1,N1+1:M2))
...
C
       ...
       call reorder213456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N1,M2,N2,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z18(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K7*K8*K9*K0
       I3=K9
...
C
       call
     & sum134562(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z18, 1.000)
       deallocate(Z18)
       deallocate(X18)
C
     ...
     & N1,N3,N0,N1,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S510(M1+1:N1,N0+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1*K1
       I2=K7
       I3=K3
...
C
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,S510,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S512(N1+1:M2,M1+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X67,S512, 1.000)
       deallocate(S512)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,S510,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S513(N1+1:M2,M1+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X68,S513,-1.000)
       deallocate(S513)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N0,N1,N1,N3,M1,N1,S510,D1)
       allocate(D2(N0+1:N1,N0+1:N1,N1+1:M2,N1+1:M2))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,M2,N1,M2,t2A,D2)
       allocate(S514(N1+1:M2,N1+1:M2,N1+1:N3,M1+1:N1))
       I1=K7*K3
       I2=K9*K9
       I3=K1*K1
...
C
       call
     & sum2314(N1,N3,N1,M2,N1,M2,M1,N1,X6,S514, 0.500)
       deallocate(S514)
C
       allocate(D1(N1+1:N3,N0+1:N1,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N1,N0,N1,N1,N3,
     & N1,N3,N0,N1,N0,N1,M1,N1,S510,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S599(M1+1:N1,N0+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1*K1
       I2=K7
       I3=K3
...
C
       allocate(D1(N0+1:N1,N0+1:N1,M1+1:N1,M1+1:N1))
       call reorder2314(M1,N1,N0,N1,N0,N1,M1,N1,
     & N0,N1,N0,N1,M1,N1,M1,N1,S599,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S600(N1+1:M2,N0+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X4,S600,-1.000)
       deallocate(S600)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X6,S603, 1.000)
       deallocate(S603)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N1,M1,N1,S510,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S511(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S511, 1.000)
       deallocate(S511)
C
       allocate(D1(N0+1:N1,N0+1:N1,M1+1:N1,M1+1:N1))
       call reorder3214(M1,N1,N0,N1,N0,N1,M1,N1,
     & N0,N1,N0,N1,M1,N1,M1,N1,S599,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S601(N1+1:M2,N0+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X5,S601, 1.000)
       deallocate(S601)
C
...
C
     ...
     & N1,N3,N0,N1,Q79,B1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       allocate(S522(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S522)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S522,-1.000)
       deallocate(S522)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q79,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S527(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K3
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S527, 1.000)
       deallocate(S527)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     & N1,N3,N0,N1,Q79,B1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       allocate(S520(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S520)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S520,-1.000)
       deallocate(S520)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder4231(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S523(N1+1:M2,M1+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K7*K9
       I3=K3*K1
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S523,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S524(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X6,S524,-1.000)
       deallocate(S524)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
     ...
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S525(N1+1:M2,M1+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,M1,N1,X6,S526,-1.000)
       deallocate(S526)
C
...
C
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z6(N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K9
       I2=K7*K8*K0
       I3=K3
...
C
       call
     & sum145236(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z6, 1.000)
       call
     & sum146235(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z6,-1.000)
       deallocate(Z6)
       deallocate(X6)
C
     ...
     & N1,N3,N1,N3,N0,N1,N0,N1,VAHHPP,D1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,N3,M1,N1,M1,N1,t2A,D2)
       allocate(S517(M1+1:N1,M1+1:N1,N0+1:N1,N0+1:N1))
       I1=K1*K1
       I2=K7*K7
       I3=K3*K3
...
C
     ...
     & N0,N1,N0,N1,M1,N1,M1,N1,S517,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S518(N1+1:M2,N0+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X4,S518,-0.500)
       deallocate(S518)
C
       allocate(D1(N0+1:N1,N0+1:N1,M1+1:N1,M1+1:N1))
     ...
     & N0,N1,N0,N1,M1,N1,M1,N1,S517,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S521(N1+1:M2,N0+1:N1,M1+1:N1,M1+1:N1))
       I1=K7*K7*K1
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X5,S521, 0.500)
       deallocate(S521)
C
     ...
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S530(N2+1:M2,M1+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K8*K0
       I3=K4*K2
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,S530,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S532(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X3,S532,-1.000)
       deallocate(S532)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,M1,N2,S530,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S531(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X2,S531,-1.000)
       deallocate(S531)
C
     ...
     & N1,N3,N0,N2,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
       allocate(S528(M1+1:N1,N0+1:N2,N0+1:N1,N2+1:N3))
       I1=K4*K1*K2
       I2=K7
       I3=K3
...
C
     ...
     & N0,N2,N0,N1,N2,N3,M1,N1,S528,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S534(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X9,S534, 1.000)
       deallocate(S534)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,M1,N1,S528,D1)
       allocate(D2(N0+1:N1,N2+1:N3,N1+1:M2,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S535(N1+1:M2,M1+1:N2,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X8,S535,-1.000)
       deallocate(S535)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,M1,N1,S528,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S536(N1+1:M2,M1+1:N2,N0+1:N2,M1+1:N1))
       I1=K7*K2
       I2=K8*K9
       I3=K4*K1
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X7,S536,-1.000)
       deallocate(S536)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S528,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S537(N1+1:M2,M1+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X67,S537, 1.000)
       deallocate(S537)
C
       allocate(D2(N0+1:N1,N2+1:M2,N1+1:M2,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       allocate(Z76(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:M2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K9
       I2=K8*K9*K0
       I3=K1
...
C
       call
     & sum134256(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z76,-1.000)
       call
     & sum134265(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z76, 1.000)
       deallocate(Z76)
       deallocate(X67)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
     ...
     & N0,N2,N2,N3,N0,N1,M1,N1,S528,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S538(N1+1:M2,M1+1:N1,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X68,S538, 1.000)
       deallocate(S538)
C
       allocate(D2(N0+1:N1,N2+1:M2,N1+1:M2,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       allocate(Z77(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:M2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K9
       I2=K8*K9*K0
       I3=K1
       call DMATMAT(I1,I2,I3,X68,D2,Z77)
       deallocate(D2)
C
       call
     & sum124356(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z77, 1.000)
       call
     & sum124365(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z77,-1.000)
       deallocate(Z77)
       deallocate(X68)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
     ...
     & N0,N2,N2,N3,N0,N1,M1,N1,S528,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S529(N2+1:M2,M1+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S529, 1.000)
       deallocate(S529)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N2,N0,N1,N2,N3,
     & N2,N3,N0,N2,N0,N1,M1,N1,S528,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S604(M1+1:N2,N0+1:N2,N0+1:N1,M1+1:N1))
       I1=K7*K1*K2
       I2=K8
       I3=K4
...
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S604,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S605(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X7,S605,-1.000)
       deallocate(S605)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,M1,N1,S528,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S609(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,S609,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S610(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X10,S610, 1.000)
       deallocate(S610)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,M1,N1,S528,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S607(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,S607,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S608(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X9,S608, 1.000)
       deallocate(S608)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,M1,N1,S528,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S533(N2+1:M2,N1+1:M2,N2+1:N3,M1+1:N1))
       I1=K7*K4
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N2,N3,N2,M2,N1,M2,M1,N1,X10,S533, 1.000)
       deallocate(S533)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S604,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S606(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S606,-1.000)
       deallocate(S606)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S604,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S611(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S611,-1.000)
       deallocate(S611)
C
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       allocate(Z1(N1+1:M2,N1+1:M2,M1+1:N1,N2+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K0
       I2=K7*K9*K9
       I3=K1
...
C
       call
     & sum235146(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z1, 1.000)
       call
     & sum236145(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z1,-1.000)
       deallocate(Z1)
       deallocate(X1)
C
     ...
     & N2,N3,N1,N3,N0,N2,N0,N1,VBHHPP,D1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
       allocate(S545(M1+1:N2,M1+1:N1,N0+1:N2,N0+1:N1))
       I1=K1*K2
       I2=K7*K8
       I3=K3*K4
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S545,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S584(N2+1:M2,N0+1:N1,M1+1:N2,M1+1:N1))
       I1=K7*K8*K1
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X89,S584,-1.000)
       deallocate(S584)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder4312(M1,N2,M1,N1,N0,N2,N0,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S545,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S546(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X7,S546,-1.000)
       deallocate(S546)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder4312(M1,N2,M1,N1,N0,N2,N0,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S545,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S549(N1+1:M2,N0+1:N2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K2
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S549,-1.000)
       deallocate(S549)
C
     ...
     & N2,N3,N0,N2,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S552(M1+1:N2,N0+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S552,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S553(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X2,S553,-1.000)
       deallocate(S553)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:N3,N1+1:M2))
       call reorder1324(N2,N3,N1,N3,N0,N2,N1,N3,
     & N2,N3,N0,N2,N1,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S554(M1+1:N2,N0+1:N2,N1+1:N3,N1+1:M2))
       I1=K9*K3*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S554,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S555(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X3,S555,-1.000)
       deallocate(S555)
C
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S556(M1+1:N2,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,S556,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S557(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X11,S557,-1.000)
       deallocate(S557)
C
...
C
       ...
       call reorder412356(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3A,F2)
       allocate(Z11(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K6*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z11, 1.000)
       deallocate(Z11)
       deallocate(X11)
C
     ...
     & N2,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S558(M1+1:N2,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N2,S558,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S559(N2+1:M2,M1+1:N1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N2,X12,S559,-1.000)
       deallocate(S559)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder412356(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3A,F2)
       allocate(Z12(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K6*K7
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z12, 1.000)
       deallocate(Z12)
       deallocate(X12)
C
     ...
     & N2,N3,N0,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S560(M1+1:N2,N0+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,S560,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S561(N2+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,M1,N2,X13,S561,-1.000)
       deallocate(S561)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder412356(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & N0,M1,N1,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3A,F2)
       allocate(Z13(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K9*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z13, 1.000)
       deallocate(Z13)
       deallocate(X13)
C
     ...
     & N2,N3,N0,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S562(M1+1:N2,N0+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,S562,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S563(N2+1:M2,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,M1,N2,X14,S563,-1.000)
       deallocate(S563)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder412356(N1,N3,N1,N3,N1,M2,N0,N1,N0,N1,M1,N1,
     & M1,N1,N1,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3A,F2)
       allocate(Z14(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K9*K7
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z14, 1.000)
       deallocate(Z14)
       deallocate(X14)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S564(M1+1:N2,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K8
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,M1,N2,S564,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S565(N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X63,S565, 1.000)
       deallocate(S565)
C
...
C
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z63(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K6*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z63,-1.000)
       deallocate(Z63)
       deallocate(X63)
C
     ...
     & N2,N3,N0,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S566(M1+1:N2,N0+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,S566,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S567(N2+1:M2,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,M2,N3,N2,M2,M1,N2,X64,S567, 1.000)
       deallocate(S567)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z64(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K6*K8
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z64,-1.000)
       deallocate(Z64)
       deallocate(X64)
C
     ...
     & N2,N3,N0,N2,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S568(M1+1:N2,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,S568,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S569(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N2))
       I1=K8*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N2,X65,S569, 1.000)
       deallocate(S569)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z65(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K0*K5
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z65,-1.000)
       deallocate(Z65)
       deallocate(X65)
C
     ...
     & N2,N3,N0,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S570(M1+1:N2,N0+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,S570,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S571(N2+1:M2,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,M1,N2,X66,S571, 1.000)
       deallocate(S571)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z66(N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K7*K7*K9*K9
       I3=K0*K8
...
C
       call
     & sum235614(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z66,-1.000)
       deallocate(Z66)
       deallocate(X66)
C
...
C
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z21(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,M1+1:N2))
       I1=K8
       I2=K7*K7*K9*K9*K0
       I3=K5
...
C
       call
     & sum123564(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z21,-1.000)
       deallocate(Z21)
       deallocate(X21)
C
...
C
       ...
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z22(N2+1:M2,N1+1:M2,N1+1:M2,M1+1:N1,M1+1:N1,M1+1:N2))
       I1=K8
       I2=K7*K7*K9*K9*K0
       I3=K8
...
C
       call
     & sum123564(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z22,-1.000)
       deallocate(Z22)
       deallocate(X22)
C
...
C
       ...
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z23(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K7*K8*K9*K9
       I3=K6
...
C
       call
     & sum234561(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z23, 1.000)
       deallocate(Z23)
       deallocate(X23)
C
...
C
       ...
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z24(N1+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1,N2+1:M2))
       I1=K0
       I2=K7*K7*K8*K9*K9
       I3=K0
...
C
       call
     & sum234561(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z24, 1.000)
       deallocate(Z24)
       deallocate(X24)
C
     ...
     & N2,N3,N0,N2,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S572(M1+1:N2,N0+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,N1,N1,N3,M1,N2,S572,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S574(N2+1:M2,N1+1:M2,N1+1:N3,M1+1:N2))
       I1=K8*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,M1,N2,X2,S574, 1.000)
       deallocate(S574)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S572,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S582(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X7,S582, 1.000)
       deallocate(S582)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S572,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S583(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X8,S583, 1.000)
       deallocate(S583)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N0,N2,N1,N3,M1,N2,S572,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S612(N1+1:M2,N0+1:N2,N1+1:N3,M1+1:N2))
       I1=K8*K3*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder2314(N1,M2,N0,N2,N1,N3,M1,N2,
     & N0,N2,N1,N3,N1,M2,M1,N2,S612,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S613(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X2,S613, 1.000)
       deallocate(S613)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N0,N2,N1,N3,M1,N2,S572,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S614(N1+1:M2,N0+1:N2,N1+1:N3,M1+1:N2))
       I1=K8*K3*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder2314(N1,M2,N0,N2,N1,N3,M1,N2,
     & N0,N2,N1,N3,N1,M2,M1,N2,S614,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S615(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X3,S615, 1.000)
       deallocate(S615)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N2,N0,N1,N1,N3,M1,N2,S572,D1)
       ...
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,N1,M2,t2B,D2)
       allocate(S573(N2+1:M2,N1+1:M2,N1+1:N3,M1+1:N2))
       I1=K8*K3
       I2=K9*K0
       I3=K1*K2
...
C
       call
     & sum2314(N1,N3,N2,M2,N1,M2,M1,N2,X3,S573, 1.000)
       deallocate(S573)
C
     ...
     & N0,N2,N1,N3,N0,N1,N2,N3,VBHHPP,D1)
       ...
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,N2,M2,M1,N1,t2B,D2)
       allocate(S543(N2+1:M2,M1+1:N1,N0+1:N1,N2+1:N3))
       I1=K4*K1
       I2=K7*K0
       I3=K3*K2
...
C
     ...
     & N0,N1,N2,N3,N2,M2,M1,N1,S543,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S544(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X99,S544,-1.000)
       deallocate(S544)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder3412(N2,M2,M1,N1,N0,N1,N2,N3,
     & N0,N1,N2,N3,N2,M2,M1,N1,S543,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S547(N1+1:M2,N2+1:N3,N2+1:M2,M1+1:N1))
       I1=K7*K0*K4
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N2,N3,N2,M2,N1,M2,M1,N1,X100,S547,-1.000)
       deallocate(S547)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder4312(N2,M2,M1,N1,N0,N1,N2,N3,
     & N2,N3,N0,N1,N2,M2,M1,N1,S543,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S581(M1+1:N2,N0+1:N1,N2+1:M2,M1+1:N1))
       I1=K7*K0*K1
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X89,S581,-1.000)
       deallocate(S581)
C
...
C
     ...
     & N2,N3,N0,N2,Q80,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S548(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S548)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X7,S548, 1.000)
       deallocate(S548)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q80,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S550(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S550)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S550, 1.000)
       deallocate(S550)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S587(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K3*K1
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S587,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z10(N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K0
       I2=K7*K8*K9
       I3=K4
...
C
       call
     & sum245136(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z10, 1.000)
       call
     & sum246135(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z10,-1.000)
       deallocate(Z10)
       deallocate(X10)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
...
C
     ...
     & N1,N3,N0,N1,Q89,B1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       allocate(S579(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K3
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X4,S579,-1.000)
       deallocate(S579)
C
...
C
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       allocate(Z4(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:M2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K9
       I2=K8*K9*K0
       I3=K1
...
C
       call
     & sum134256(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z4,-1.000)
       deallocate(Z4)
       deallocate(X4)
C
       allocate(B1(N1+1:N3,N0+1:N1))
     ...
     & N1,N3,N0,N1,Q89,B1)
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       allocate(S580(N1+1:M2,M1+1:N1,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S580)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S580,-1.000)
       deallocate(S580)
C
       call sumx2134(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       allocate(Z5(N2+1:M2,N1+1:M2,M1+1:N2,N1+1:M2,M1+1:N1,M1+1:N1))
       I1=K7*K7*K9
       I2=K8*K9*K0
       I3=K1
...
C
       call
     & sum124356(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z5, 1.000)
       deallocate(Z5)
       deallocate(X5)
C
       allocate(B1(N1+1:N3,N0+1:N1))
     ...
     & N1,N3,N0,N1,Q89,B1)
       ...
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S589(N2+1:M2,M1+1:N2,M1+1:N1,N0+1:N1))
       I1=K1
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S589)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X89,S589, 1.000)
       deallocate(S589)
C
       allocate(D2(N0+1:N1,N1+1:M2,N1+1:M2,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       allocate(Z236(N1+1:M2,N1+1:M2,M1+1:N1,N2+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K0
       I2=K7*K9*K9
       I3=K1
       call DMATMAT(I1,I2,I3,X89,D2,Z236)
       deallocate(D2)
C
       call
     & sum236145(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z236,-1.000)
       call
     & sum235146(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z236, 1.000)
       deallocate(Z236)
       deallocate(X89)
C
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S593(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S593,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S594(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X100,S594, 1.000)
       deallocate(S594)
C
       allocate(D2(N2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z342(N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K0
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,X100,D2,Z342)
       deallocate(D2)
C
       call
     & sum246135(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z342, 1.000)
       call
     & sum245136(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z342,-1.000)
       deallocate(Z342)
       deallocate(X100)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S595(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S595,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S596(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X99,S596,-1.000)
       deallocate(S596)
C
       allocate(D2(N2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z340(N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K0
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,X99,D2,Z340)
       deallocate(D2)
C
       call
     & sum346125(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z340,-1.000)
       call
     & sum345126(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z340, 1.000)
       deallocate(Z340)
       deallocate(X99)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
...
C
     ...
     & N2,N3,N0,N2,Q90,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S598(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S598)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S598, 1.000)
       deallocate(S598)
C
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       allocate(Z8(N2+1:M2,N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K9
       I2=K7*K9*K0
       I3=K2
...
C
       call
     & sum125346(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z8,-1.000)
       call
     & sum126345(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z8, 1.000)
       deallocate(Z8)
       deallocate(X8)
C
       allocate(B1(N2+1:N3,N0+1:N2))
     ...
     & N2,N3,N0,N2,Q90,B1)
       ...
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(S597(N1+1:M2,M1+1:N2,M1+1:N1,N0+1:N2))
       I1=K2
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S597)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X7,S597, 1.000)
       deallocate(S597)
C
       call sumx1234(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       allocate(Z7(N2+1:M2,N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K9
       I2=K7*K9*K0
       I3=K2
...
C
       call
     & sum135246(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z7, 1.000)
       call
     & sum136245(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z7,-1.000)
       deallocate(Z7)
       deallocate(X7)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
     ...
     & N0,N1,N1,N3,N0,N1,N1,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S515(N2+1:M2,M1+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K8*K0
       I3=K3*K1
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,M1,N2,S515,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S519(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X3,S519,-1.000)
       deallocate(S519)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,M1,N2,S515,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S516(N1+1:M2,N1+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N2,M2,N1,M2,M1,N2,X2,S516,-1.000)
       deallocate(S516)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S539(N1+1:M2,M1+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K7*K9
       I3=K4*K2
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S539,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S540(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum2134(N1,N3,N1,M2,N1,M2,M1,N1,X98,S540,-1.000)
       deallocate(S540)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S541(N1+1:M2,M1+1:N1,N0+1:N1,N1+1:N3))
       I1=K3*K1
       I2=K7*K9
       I3=K4*K2
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S541,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S542(N1+1:M2,N1+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K3
       I2=K9
       I3=K1
...
C
       call
     & sum3124(N1,N3,N1,M2,N1,M2,M1,N1,X98,S542, 1.000)
       deallocate(S542)
C
       allocate(D2(N1+1:N3,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z338(N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K9
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,X98,D2,Z338)
       deallocate(D2)
C
       call
     & sum146235(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z338,-1.000)
       call
     & sum145236(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z338, 1.000)
       deallocate(Z338)
       deallocate(X98)
C
     ...
     & N0,N1,N2,N3,N0,N2,N1,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S575(N1+1:M2,M1+1:N2,N0+1:N2,N1+1:N3))
       I1=K3*K2
       I2=K8*K9
       I3=K4*K1
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S575,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S576(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X3,S576, 1.000)
       deallocate(S576)
C
...
C
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       allocate(Z3(N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2,M1+1:N2))
       I1=K8*K9*K0
       I2=K7*K7*K9
       I3=K3
...
C
       call
     & sum256134(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z3,-1.000)
       deallocate(Z3)
       deallocate(X3)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
     ...
     & N0,N1,N0,N2,N2,N3,M1,N1,VBHHHP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S456(N1+1:M2,N0+1:N2,N2+1:N3,M1+1:N1))
       I1=K7*K4*K2
       I2=K9
       I3=K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,S456,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S457(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X9,S457, 1.000)
       deallocate(S457)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,N1+1:N3))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N0,N2,N1,N3,VBHHPP,D1)
       ...
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
       allocate(S577(N1+1:M2,M1+1:N2,N0+1:N2,N1+1:N3))
       I1=K3*K2
       I2=K8*K9
       I3=K4*K1
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder3412(N1,M2,M1,N2,N0,N2,N1,N3,
     & N0,N2,N1,N3,N1,M2,M1,N2,S577,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S578(N2+1:M2,N1+1:N3,N1+1:M2,M1+1:N2))
       I1=K8*K9*K3
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N1,N3,N2,M2,N1,M2,M1,N2,X2,S578, 1.000)
       deallocate(S578)
C
       call sumx2341(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       ...
       call reorder1234(N1,N3,N1,N3,N0,N1,N0,N1,
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       allocate(Z2(N1+1:M2,M1+1:N1,M1+1:N1,N2+1:M2,N1+1:M2,M1+1:N2))
       I1=K8*K9*K0
       I2=K7*K7*K9
       I3=K3
...
C
       call
     & sum356124(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z2, 1.000)
       deallocate(Z2)
       deallocate(X2)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,t2A,D2)
       allocate(S585(N1+1:M2,M1+1:N1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K7*K9
       I3=K3*K1
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S585,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S586(N2+1:M2,N2+1:N3,N1+1:M2,M1+1:N1))
       I1=K7*K9*K4
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N2,N3,N2,M2,N1,M2,M1,N1,X9,S586,-1.000)
       deallocate(S586)
C
       call sumx2314(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N2,M2,N1,M2,M1,N1,X9,VBHPPP, 1.000)
C
       allocate(D2(N2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       allocate(Z9(N1+1:M2,M1+1:N2,M1+1:N1,N2+1:M2,N1+1:M2,M1+1:N1))
       I1=K7*K9*K0
       I2=K7*K8*K9
       I3=K4
...
C
       call
     & sum345126(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z9,-1.000)
       call
     & sum346125(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z9, 1.000)
       deallocate(Z9)
       deallocate(X9)
C
...
C
     ...
     & N0,N2,N2,N3,N0,N2,M1,N2,S590,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S592(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X102,S592,-1.000)
       deallocate(S592)
C
       allocate(D2(N0+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       allocate(Z345(N2+1:M2,N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K9
       I2=K7*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X102,D2,Z345)
       deallocate(D2)
C
       call
     & sum136245(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z345,-1.000)
       call
     & sum135246(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z345, 1.000)
       deallocate(Z345)
       deallocate(X102)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
     ...
     & N0,N2,N2,N3,N0,N2,M1,N2,S590,D1)
       ...
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
       allocate(S591(N1+1:M2,M1+1:N1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K7*K9
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X101,S591,-1.000)
       deallocate(S591)
C
       allocate(D2(N0+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       allocate(Z344(N2+1:M2,N1+1:M2,M1+1:N1,N1+1:M2,M1+1:N2,M1+1:N1))
       I1=K7*K8*K9
       I2=K7*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X101,D2,Z344)
       deallocate(D2)
C
       call
     & sum126345(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z344,-1.000)
       call
     & sum125346(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z344, 1.000)
       deallocate(Z344)
       deallocate(X101)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,M1+1:N1))
     ...
     & N0,M1,M2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z67(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K5
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z67,-1.000)
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z67, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z67, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z67,-1.000)
       deallocate(Z67)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & M1,N2,M2,N3,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z68(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K6*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z68,-1.000)
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z68, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z68, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z68,-1.000)
       deallocate(Z68)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,M1,N2,M2,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z69(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K5
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z69,-1.000)
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z69, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z69, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z69,-1.000)
       deallocate(Z69)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
     & M1,N2,N2,M2,N1,M2,M1,N1,VBHPPH,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       allocate(Z70(N2+1:M2,N1+1:M2,M1+1:N2,M1+1:N1,N1+1:M2,M1+1:N1))
       I1=K7*K9
       I2=K7*K8*K9*K0
       I3=K0*K8
...
C
       call
     & sum134526(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z70,-1.000)
       call
     & sum124536(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z70, 1.000)
       call
     & sum134625(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z70, 1.000)
       call
     & sum124635(N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z70,-1.000)
       deallocate(Z70)
C
       call sumx3(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,HT3B1,V3B,1.0)
       deallocate(V3B)
C
       end
