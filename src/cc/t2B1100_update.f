...
C
     ...
     & M1,N1,N2,M2,N1,M2,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6
       I3=K9*K0*K7
       call DMATMAT(I1,I2,I3,X11,F2,Z19)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,N2,M2,M2,N3,M2,N3,M1,N1,t3C4,F2)
       ...
       I2=K7*K6*K6
       I3=K0*K5*K5
       call DMATMAT(I1,I2,I3,X14,F2,Z32)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,M2,N3,M1,N1,t3C1,F2)
       ...
       I2=K7*K6*K6
       I3=K0*K8*K5
       call DMATMAT(I1,I2,I3,X15,F2,Z33)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,M2,N3,M2,N3,M1,N1,t3C1,F2)
       ...
       I2=K7*K6*K6
       I3=K0*K8*K8
       call DMATMAT(I1,I2,I3,X16,F2,Z34)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X20,B2,Z86)
       deallocate(B2)
C
       V2B=V2B-Z86
       deallocate(Z86)
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6
       I3=K0*K0*K5
       call DMATMAT(I1,I2,I3,X17,F2,Z37)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6
       I3=K0*K0*K8
       call DMATMAT(I1,I2,I3,X18,F2,Z38)
       deallocate(F2)
C
       call
