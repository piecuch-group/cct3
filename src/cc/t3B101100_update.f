...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K8*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U193)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z194)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K8*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U279)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S174)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S175)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,M2,N3,M1,N2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K8*K6*K6
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z382)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K8*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U599)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z600)
       deallocate(F1)
       deallocate(D2)
C
       V3B=V3B+Z600
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,U778)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X110,B2,Z280)
       deallocate(B2)
C
       V3B=V3B-Z280
       deallocate(Z280)
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X87,F2,Z89)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X88,F2,Z136)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X89,F2,Z137)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X91,F2,Z154)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X115,F2,Z405)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X116,F2,Z406)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X117,F2,Z413)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X118,F2,Z414)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X121,F2,Z417)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X119,F2,Z415)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X122,F2,Z418)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X120,F2,Z416)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X92,F2,Z173)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X93,F2,Z174)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X94,F2,Z175)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X95,F2,Z176)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X104,F2,Z189)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X105,F2,Z190)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X103,F2,Z188)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6*K6
       I3=K5
       call DMATMAT(I1,I2,I3,X106,F2,Z191)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6*K6
       I3=K8
       call DMATMAT(I1,I2,I3,X107,F2,Z192)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K8*K9*K6
       I3=K6
       call DMATMAT(I1,I2,I3,X108,F2,Z201)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K8*K9*K6
       I3=K0
       call DMATMAT(I1,I2,I3,X109,F2,Z202)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q83,B2,Q85)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S759)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S751)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S757)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S792)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S811)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S827)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S828)
       deallocate(B1)
       deallocate(D2)
C
       call
