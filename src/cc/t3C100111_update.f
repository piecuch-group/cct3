...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K0*K0
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z213)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,N2,M2,N2,M2,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K0*K0
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z214)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z331)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z332)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z345)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,X81,F2,Z215)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,X82,F2,Z216)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K6*K7
       call EGEMM(I1,I2,I3,X64,F2,Z90)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K0*K7
       call EGEMM(I1,I2,I3,X65,F2,Z89)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0*K0
       I3=K8
       call EGEMM(I1,I2,I3,X72,F2,Z97)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K9*K0
       I3=K0
       call EGEMM(I1,I2,I3,X76,F2,Z109)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K9*K0
       I3=K0
       call EGEMM(I1,I2,I3,X75,F2,Z103)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S394)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S416)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S410)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S413)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S490)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,X78,D2,Z125)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S508)
       deallocate(B1)
       deallocate(D2)
C
       call
