...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,X39,B2,Z74)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6
       I3=K9*K0*K5
       call DMATMAT(I1,I2,I3,X23,F2,Z29)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N1,M2,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6
       I3=K9*K0*K7
       call DMATMAT(I1,I2,I3,X24,F2,Z30)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6
       I3=K0*K0*K8
       call DMATMAT(I1,I2,I3,X38,F2,Z60)
       deallocate(F2)
C
       call
