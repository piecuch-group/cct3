...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,S45,D1)
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z46, 1.000)
       deallocate(Z46)
       deallocate(S45)
C
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z48, 0.500)
       deallocate(Z48)
       deallocate(S47)
C
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,S63,D1)
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z64,-1.000)
       deallocate(Z64)
       deallocate(S63)
C
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,S65,D1)
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z66, 1.000)
       deallocate(Z66)
       deallocate(S65)
C
...
C
     ...
     & M1,N2,N2,M2,N1,M2,N1,M2,S67,D1)
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z68,-1.000)
       deallocate(Z68)
       deallocate(S67)
C
...
C
       ...
       X7=0.0d0
       call
     & sum4123(M1,N2,N0,M1,M2,N3,N0,M1,X7,S71, 1.000)
       deallocate(S71)
C
...
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z9,-1.000)
       deallocate(Z9)
       deallocate(X7)
C
...
C
       ...
       X8=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M2,N3,N0,M1,X8,S73, 1.000)
       deallocate(S73)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,t3B1,F2)
       ...
       I2=K5*K9*K6
       I3=K6*K7*K5
       call DMATMAT(I1,I2,I3,X8,F2,Z10)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z10, 1.000)
       deallocate(Z10)
       deallocate(X8)
C
...
C
       ...
       X9=0.0d0
       call
     & sum4123(M1,N2,M1,N1,M2,N3,N0,M1,X9,S75, 1.000)
       deallocate(S75)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,t3B1,F2)
       ...
       I2=K5*K9*K6
       I3=K6*K7*K8
       call DMATMAT(I1,I2,I3,X9,F2,Z11)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z11, 1.000)
       deallocate(Z11)
       deallocate(X9)
C
...
C
       ...
       X10=0.0d0
       call
     & sum4123(M1,N2,N0,M1,N1,M2,N0,M1,X10,S77, 1.000)
       deallocate(S77)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,N0,M1,N1,M2,M2,N3,N1,M2,N0,M1,t3B4,F2)
       ...
       I2=K5*K9*K6
       I3=K9*K5*K8
       call DMATMAT(I1,I2,I3,X10,F2,Z12)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z12,-1.000)
       deallocate(Z12)
       deallocate(X10)
C
...
C
       ...
       X11=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N1,M2,N0,M1,X11,S79, 1.000)
       deallocate(S79)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,N1,M2,N0,M1,t3B1,F2)
       ...
       I2=K5*K9*K6
       I3=K9*K7*K5
       call DMATMAT(I1,I2,I3,X11,F2,Z13)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z13, 1.000)
       deallocate(Z13)
       deallocate(X11)
C
...
C
       ...
       X12=0.0d0
       call
     & sum4123(M1,N2,M1,N1,N1,M2,N0,M1,X12,S81, 1.000)
       deallocate(S81)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,N1,M2,M2,N3,N1,M2,N0,M1,t3B1,F2)
       ...
       I2=K5*K9*K6
       I3=K9*K7*K8
       call DMATMAT(I1,I2,I3,X12,F2,Z14)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z14, 1.000)
       deallocate(Z14)
       deallocate(X12)
C
...
C
       ...
       X19=0.0d0
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X19,S83, 1.000)
       deallocate(S83)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X19,S85, 1.000)
       deallocate(S85)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X19,S87, 1.000)
       deallocate(S87)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X19,S89, 1.000)
       deallocate(S89)
C
...
C
       ...
       X15=0.0d0
       call
     & sum4123(N0,M1,M1,N2,M2,N3,N0,M1,X15,S93,-1.000)
       deallocate(S93)
C
...
C
     ...
     & N0,M1,M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,t3C3,F2)
       ...
       I2=K5*K9*K6
       I3=K6*K8*K5
       call DMATMAT(I1,I2,I3,X15,F2,Z30)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z30,-1.000)
       deallocate(Z30)
       deallocate(X15)
C
...
C
       ...
       X16=0.0d0
       call
     & sum4123(M1,N2,M1,N2,M2,N3,N0,M1,X16,S95,-1.000)
       deallocate(S95)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & M1,N2,M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,t3C3,F2)
       ...
       I2=K5*K9*K6
       I3=K6*K8*K8
       call DMATMAT(I1,I2,I3,X16,F2,Z31)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z31,-0.500)
       deallocate(Z31)
       deallocate(X16)
C
...
C
       ...
       X17=0.0d0
       call
     & sum4123(N0,M1,M1,N2,N2,M2,N0,M1,X17,S97,-1.000)
       deallocate(S97)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,t3C1,F2)
       ...
       I2=K5*K9*K6
       I3=K0*K8*K5
       call DMATMAT(I1,I2,I3,X17,F2,Z32)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z32, 1.000)
       deallocate(Z32)
       deallocate(X17)
C
...
C
       ...
       X18=0.0d0
       call
     & sum4123(M1,N2,M1,N2,N2,M2,N0,M1,X18,S99,-1.000)
       deallocate(S99)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & M1,N2,M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,t3C1,F2)
       ...
       I2=K5*K9*K6
       I3=K0*K8*K8
       call DMATMAT(I1,I2,I3,X18,F2,Z33)
       deallocate(F2)
C
       call
     & sum1243(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z33, 0.500)
       deallocate(Z33)
       deallocate(X18)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X19,S101,-0.500)
       deallocate(S101)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X19,S103,-1.000)
       deallocate(S103)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X19,S105,-0.500)
       deallocate(S105)
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X19,B2,Z84)
       deallocate(B2)
C
       V2B=V2B+Z84
       deallocate(Z84)
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z7, 1.000)
       deallocate(Z7)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z8, 0.500)
       deallocate(Z8)
C
...
C
       call
     & sum2341(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z15,-1.000)
       deallocate(Z15)
C
...
C
       call
     & sum2341(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z16,-1.000)
       deallocate(Z16)
C
...
C
       call
     & sum2341(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z17,-1.000)
       deallocate(Z17)
C
...
C
       call
     & sum2341(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z18,-1.000)
       deallocate(Z18)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z27, 1.000)
       deallocate(Z27)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z28,-1.000)
       deallocate(Z28)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum1342(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z29, 1.000)
       deallocate(Z29)
C
...
C
       call
     & sum2341(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z34, 0.500)
       deallocate(Z34)
C
...
C
       call
     & sum2341(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z35, 1.000)
       deallocate(Z35)
C
...
C
       call
     & sum2341(M2,N3,N1,M2,N0,M1,N0,M1,V2B,Z36, 0.500)
       deallocate(Z36)
C
