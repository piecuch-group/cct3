...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,Z189)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z193)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z194)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X75,D2,Z191)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X76,D2,Z212)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X80,D2,Z255)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X81,D2,Z261)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X77,D2,Z224)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X69,F2,Z172)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X70,F2,Z173)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X71,F2,Z174)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X72,F2,Z175)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,X27,F2,Z32)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K0*K6
       call DMATMAT(I1,I2,I3,X28,F2,Z33)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K0*K0
       call DMATMAT(I1,I2,I3,X29,F2,Z34)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0*K6
       I3=K5
       call DMATMAT(I1,I2,I3,X32,F2,Z37)
       deallocate(F2)
C
       V3D=V3D-Z37
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0*K6
       I3=K8
       call DMATMAT(I1,I2,I3,X33,F2,Z38)
       deallocate(F2)
C
       V3D=V3D-Z38
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q45,B2,Q49)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K6
       I3=K6
       call DMATMAT(I1,I2,I3,X36,F2,Z41)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q45,B2,Q51)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K6
       I3=K6
       call DMATMAT(I1,I2,I3,X38,F2,Z43)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X34,F2,Z39)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X35,F2,Z40)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q47,B2,Q52)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K6
       I3=K0
       call DMATMAT(I1,I2,I3,X39,F2,Z44)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q47,B2,Q50)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K6
       I3=K0
       call DMATMAT(I1,I2,I3,X37,F2,Z42)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S221)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q53,D2,S220)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X47,F2,Z64)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X51,F2,Z68)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X4,F2,Z5)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X50,F2,Z67)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X54,F2,Z71)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X7,F2,Z8)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X6,F2,Z7)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X53,F2,Z70)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X49,F2,Z66)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X5,F2,Z6)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X48,F2,Z65)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X52,F2,Z69)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X55,F2,Z99)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X57,F2,Z101)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X56,F2,Z100)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X58,F2,Z102)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X59,F2,Z103)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X60,F2,Z104)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X61,F2,Z105)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X62,F2,Z106)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,X63,F2,Z121)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,M2,N3,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K6
       I3=K0*K6
       call DMATMAT(I1,I2,I3,X30,F2,Z35)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K0*K6
       call DMATMAT(I1,I2,I3,X64,F2,Z122)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,X66,F2,Z124)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K0*K6
       call DMATMAT(I1,I2,I3,X67,F2,Z125)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q58,B2,Q64)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K0*K0
       call DMATMAT(I1,I2,I3,X65,F2,Z123)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K6
       I3=K0*K0
       call DMATMAT(I1,I2,I3,X31,F2,Z36)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q60,B2,Q65)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X43,D2,Z49)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X44,D2,Z50)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X74,D2,Z188)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,Z375)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,Z376)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X42,D2,Z48)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X45,D2,Z51)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X46,D2,Z52)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X3,D2,Z4)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X41,D2,Z47)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X40,D2,Z46)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X79,D2,Z246)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X78,D2,Z240)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q66,D2,S326)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X73,D2,Z184)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S332)
       deallocate(B1)
       deallocate(D2)
       deallocate(Q66)
C
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z3)
       deallocate(D1)
       deallocate(D2)
C
       call
