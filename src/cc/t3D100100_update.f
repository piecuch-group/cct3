...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U118)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,Z119)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S101)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X55,F2,Z152)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X56,F2,Z158)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X57,F2,Z159)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U287)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       ...
       I2=K6*K6
       I3=K2*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z288)
       deallocate(F1)
       deallocate(D2)
C
       V3D=V3D+0.250*Z288
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,U352)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N2+1:M2,N0+1:M1,N0+1:M1,M1+1:N2))
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,Z353)
       deallocate(F1)
       deallocate(B2)
C
       V3D=V3D+0.500*Z353
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X52,F2,Z94)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X53,F2,Z108)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X54,F2,Z109)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q49,B2,Q51)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X49,D2,Z60)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X48,D2,Z52)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S342)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X51,D2,Z62)
       deallocate(D2)
C
       call
