...
C
       ...
       X5=0.0d0
       call
     & sum4123(N0,M1,N0,M1,M2,N3,M1,N1,X5,S65,-1.000)
       deallocate(S65)
C
...
C
       ...
       X6=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M2,N3,M1,N1,X6,S67,-1.000)
       deallocate(S67)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       ...
       X7=0.0d0
       call
     & sum4123(M1,N1,M1,N1,M2,N3,M1,N1,X7,S69,-1.000)
       deallocate(S69)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       ...
       X8=0.0d0
       call
     & sum4123(N0,M1,N0,M1,N1,M2,M1,N1,X8,S71,-1.000)
       deallocate(S71)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       ...
       X9=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N1,M2,M1,N1,X9,S73,-1.000)
       deallocate(S73)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       ...
       X10=0.0d0
       call
     & sum4123(M1,N1,M1,N1,N1,M2,M1,N1,X10,S75,-1.000)
       deallocate(S75)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       ...
       X33=0.0d0
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S77, 1.000)
       deallocate(S77)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S79, 1.000)
       deallocate(S79)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S81, 2.000)
       deallocate(S81)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S83, 2.000)
       deallocate(S83)
C
...
C
     ...
     & N0,M1,N1,M2,N1,M2,N1,M2,S85,D1)
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z86,-0.500)
       deallocate(Z86)
       deallocate(S85)
C
...
C
     ...
     & M1,N1,N1,M2,N1,M2,N1,M2,S87,D1)
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z88,-0.500)
       deallocate(Z88)
       deallocate(S87)
C
...
C
     ...
     & N0,M1,N0,M1,M2,N3,M1,N1,S93,D1)
       allocate(F2(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2))
...
C
     ...
     & M1,N2,N0,M1,M2,N3,M1,N1,S95,D1)
...
C
     ...
     & N0,M1,M1,N1,M2,N3,M1,N1,S97,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2))
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,M2,N3,M1,N1,S99,D1)
...
C
     ...
     & N0,M1,N0,M1,N2,M2,M1,N1,S101,D1)
...
C
     ...
     & M1,N2,N0,M1,N2,M2,M1,N1,S103,D1)
...
C
     ...
     & N0,M1,M1,N1,N2,M2,M1,N1,S105,D1)
...
C
     ...
     & M1,N2,M1,N1,N2,M2,M1,N1,S107,D1)
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S109, 2.000)
       deallocate(S109)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S111, 2.000)
       deallocate(S111)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S113, 2.000)
       deallocate(S113)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S115, 2.000)
       deallocate(S115)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S117, 2.000)
       deallocate(S117)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X33,S119, 2.000)
       deallocate(S119)
C
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,X33,B2,Z78)
       deallocate(B2)
C
       call
     & sum2134(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z78,-0.500)
       deallocate(Z78)
       deallocate(X33)
C
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,S121,D1)
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z122,-1.000)
       deallocate(Z122)
       deallocate(S121)
C
...
C
     ...
     & M1,N2,N2,M2,N1,M2,N1,M2,S123,D1)
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z124,-1.000)
       deallocate(Z124)
       deallocate(S123)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
...
C
       ...
       X11=0.0d0
       call
     & sum4123(N0,M1,N0,M1,M2,N3,M1,N2,X11,S129, 1.000)
       deallocate(S129)
C
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z17,-1.000)
       deallocate(Z17)
       deallocate(X11)
C
...
C
       ...
       X12=0.0d0
       call
     & sum4123(M1,N2,N0,M1,M2,N3,M1,N2,X12,S131, 1.000)
       deallocate(S131)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z18,-1.000)
       deallocate(Z18)
       deallocate(X12)
C
...
C
       ...
       X13=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M2,N3,M1,N2,X13,S133, 1.000)
       deallocate(S133)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z19,-1.000)
       deallocate(Z19)
       deallocate(X13)
C
...
C
       ...
       X14=0.0d0
       call
     & sum4123(M1,N2,M1,N1,M2,N3,M1,N2,X14,S135, 1.000)
       deallocate(S135)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z20,-1.000)
       deallocate(Z20)
       deallocate(X14)
C
...
C
       ...
       X15=0.0d0
       call
     & sum4123(N0,M1,N0,M1,N1,M2,M1,N2,X15,S137, 1.000)
       deallocate(S137)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z21,-1.000)
       deallocate(Z21)
       deallocate(X15)
C
...
C
       ...
       X16=0.0d0
       call
     & sum4123(M1,N2,N0,M1,N1,M2,M1,N2,X16,S139, 1.000)
       deallocate(S139)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z22,-1.000)
       deallocate(Z22)
       deallocate(X16)
C
...
C
       ...
       X17=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N1,M2,M1,N2,X17,S141, 1.000)
       deallocate(S141)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z23,-1.000)
       deallocate(Z23)
       deallocate(X17)
C
...
C
       ...
       X18=0.0d0
       call
     & sum4123(M1,N2,M1,N1,N1,M2,M1,N2,X18,S143, 1.000)
       deallocate(S143)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z24,-1.000)
       deallocate(Z24)
       deallocate(X18)
C
...
C
       ...
       X34=0.0d0
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S145, 1.000)
       deallocate(S145)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S147, 1.000)
       deallocate(S147)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S149, 1.000)
       deallocate(S149)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S151, 1.000)
       deallocate(S151)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S153, 1.000)
       deallocate(S153)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S155, 1.000)
       deallocate(S155)
C
...
C
       ...
       X19=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N1,M2,N2,M2,X19,S157,-1.000)
       deallocate(S157)
C
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9
       I3=K9*K0*K5
       call DMATMAT(I1,I2,I3,X19,F2,Z31)
       deallocate(F2)
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z31, 1.000)
       deallocate(Z31)
       deallocate(X19)
C
...
C
       ...
       X20=0.0d0
       call
     & sum4123(M1,N1,N2,M2,N1,M2,N2,M2,X20,S159,-1.000)
       deallocate(S159)
C
       call sumx2341(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9
       I3=K9*K0*K7
       call DMATMAT(I1,I2,I3,X20,F2,Z32)
       deallocate(F2)
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z32, 1.000)
       deallocate(Z32)
       deallocate(X20)
C
...
C
       ...
       X25=0.0d0
       call
     & sum4123(N0,M1,N0,M1,M2,N3,M1,N2,X25,S165,-1.000)
       deallocate(S165)
C
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z53,-0.500)
       deallocate(Z53)
       deallocate(X25)
C
...
C
       ...
       X26=0.0d0
       call
     & sum4123(N0,M1,M1,N2,M2,N3,M1,N2,X26,S167,-1.000)
       deallocate(S167)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z54,-1.000)
       deallocate(Z54)
       deallocate(X26)
C
...
C
       ...
       X27=0.0d0
       call
     & sum4123(M1,N2,M1,N2,M2,N3,M1,N2,X27,S169,-1.000)
       deallocate(S169)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & M1,N2,M1,N2,M2,N3,N2,M2,N1,M2,M1,N1,t3C1,F2)
       ...
       I2=K7*K9*K0
       I3=K6*K8*K8
       call DMATMAT(I1,I2,I3,X27,F2,Z55)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z55,-0.500)
       deallocate(Z55)
       deallocate(X27)
C
...
C
       ...
       X28=0.0d0
       call
     & sum4123(N0,M1,N0,M1,N2,M2,M1,N2,X28,S171,-1.000)
       deallocate(S171)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N2,M2,N1,M2,M1,N1,t3C4,F2)
       ...
       I2=K7*K9*K0
       I3=K0*K5*K5
       call DMATMAT(I1,I2,I3,X28,F2,Z56)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z56,-0.500)
       deallocate(Z56)
       deallocate(X28)
C
...
C
       ...
       X29=0.0d0
       call
     & sum4123(N0,M1,M1,N2,N2,M2,M1,N2,X29,S173,-1.000)
       deallocate(S173)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N1,M2,M1,N1,t3C1,F2)
       ...
       I2=K7*K9*K0
       I3=K0*K8*K5
       call DMATMAT(I1,I2,I3,X29,F2,Z57)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z57,-1.000)
       deallocate(Z57)
       deallocate(X29)
C
...
C
       ...
       X30=0.0d0
       call
     & sum4123(M1,N2,M1,N2,N2,M2,M1,N2,X30,S175,-1.000)
       deallocate(S175)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N1,M2,M1,N1,t3C1,F2)
       ...
       I2=K7*K9*K0
       I3=K0*K8*K8
       call DMATMAT(I1,I2,I3,X30,F2,Z58)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z58,-0.500)
       deallocate(Z58)
       deallocate(X30)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S177,-0.500)
       deallocate(S177)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S179,-0.500)
       deallocate(S179)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S181,-1.000)
       deallocate(S181)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X34,S183,-1.000)
       deallocate(S183)
C
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,X34,B2,Z146)
       deallocate(B2)
C
       V2B=V2B-Z146
       deallocate(Z146)
...
C
       ...
       X31=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N2,M2,N2,M2,X31,S185,-1.000)
       deallocate(S185)
C
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9
       I3=K0*K0*K5
       call DMATMAT(I1,I2,I3,X31,F2,Z63)
       deallocate(F2)
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z63,-0.500)
       deallocate(Z63)
       deallocate(X31)
C
...
C
       ...
       X32=0.0d0
       call
     & sum4123(M1,N2,N2,M2,N2,M2,N2,M2,X32,S187,-1.000)
       deallocate(S187)
C
       call sumx2341(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9
       I3=K0*K0*K8
       call DMATMAT(I1,I2,I3,X32,F2,Z64)
       deallocate(F2)
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z64,-0.500)
       deallocate(Z64)
       deallocate(X32)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z11,-0.500)
       deallocate(Z11)
C
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z12,-0.500)
       deallocate(Z12)
C
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z13,-1.000)
       deallocate(Z13)
C
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z14,-1.000)
       deallocate(Z14)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z15,-0.500)
       deallocate(Z15)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z16,-0.500)
       deallocate(Z16)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z25, 1.000)
       deallocate(Z25)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z26, 1.000)
       deallocate(Z26)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z27, 1.000)
       deallocate(Z27)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z28, 1.000)
       deallocate(Z28)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z29, 1.000)
       deallocate(Z29)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z30, 1.000)
       deallocate(Z30)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,M1+1:N1))
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z45, 1.000)
       deallocate(Z45)
C
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z46, 1.000)
       deallocate(Z46)
C
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z47, 1.000)
       deallocate(Z47)
C
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z48, 1.000)
       deallocate(Z48)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z49, 1.000)
       deallocate(Z49)
C
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z50, 1.000)
       deallocate(Z50)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z51, 1.000)
       deallocate(Z51)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z52, 1.000)
       deallocate(Z52)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2))
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z59,-0.500)
       deallocate(Z59)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z60,-0.500)
       deallocate(Z60)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z61,-1.000)
       deallocate(Z61)
C
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,M1,N1,V2B,Z62,-1.000)
       deallocate(Z62)
C
