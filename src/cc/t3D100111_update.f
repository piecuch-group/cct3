...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,Q4,F2,Z47)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,Q5,F2,Z48)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,Z250)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z256)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z263)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X89,D2,Z246)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z355)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X36,F2,Z49)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X37,F2,Z50)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X35,F2,Z46)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X33,F2,Z44)
       deallocate(F2)
C
       V3D=V3D-Z44
       deallocate(Z44)
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0*K0
       I3=K5
       call DMATMAT(I1,I2,I3,X34,F2,Z45)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q43,B2,Q47)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X86,F2,Z236)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X84,F2,Z234)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q45,B2,Q48)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X87,F2,Z237)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X85,F2,Z235)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S288)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S289)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X50,F2,Z86)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X49,F2,Z88)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X52,F2,Z89)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X51,F2,Z87)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X55,F2,Z100)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X53,F2,Z104)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X58,F2,Z103)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X54,F2,Z106)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X57,F2,Z102)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X56,F2,Z101)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X59,F2,Z105)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,t3D,F2)
       ...
       I2=K5*K0*K0*K0
       I3=K8*K5
       call DMATMAT(I1,I2,I3,X28,F2,Z30)
       deallocate(F2)
C
       V3D=V3D-Z30
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,t3D,F2)
       ...
       I2=K5*K0*K0*K0
       I3=K8*K8
       call DMATMAT(I1,I2,I3,X29,F2,Z31)
       deallocate(F2)
C
       V3D=V3D+0.500*Z31
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X65,F2,Z131)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X63,F2,Z129)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X66,F2,Z132)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X64,F2,Z130)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X67,F2,Z133)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X68,F2,Z134)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K8*K5
       call DMATMAT(I1,I2,I3,X31,F2,Z35)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K8*K8
       call DMATMAT(I1,I2,I3,X32,F2,Z36)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X73,F2,Z149)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X69,F2,Z145)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X75,F2,Z151)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X71,F2,Z147)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X74,F2,Z150)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X70,F2,Z146)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X76,F2,Z152)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X72,F2,Z148)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X77,F2,Z153)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X78,F2,Z154)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X79,F2,Z155)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X80,F2,Z156)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K5*K5
       call DMATMAT(I1,I2,I3,X30,F2,Z34)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,X81,F2,Z167)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0
       I3=K0*K6
       call DMATMAT(I1,I2,I3,X82,F2,Z168)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X61,F2,Z123)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X88,D2,Z245)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X45,D2,Z74)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X46,D2,Z73)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X44,D2,Z72)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X43,D2,Z70)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X42,D2,Z71)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S449)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X91,D2,Z276)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X41,D2,Z60)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X40,D2,Z57)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X38,D2,Z53)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X39,D2,Z52)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X47,D2,Z75)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X48,D2,Z78)
       deallocate(D2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z28)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,B1,F2,Z29)
       deallocate(B1)
       deallocate(F2)
C
       call
