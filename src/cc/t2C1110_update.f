...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K6
       I3=K6*K0*K5
       call DMATMAT(I1,I2,I3,X13,F2,Z21)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K6
       I3=K6*K0*K7
       call DMATMAT(I1,I2,I3,X14,F2,Z22)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,M2,N3,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K6
       I3=K9*K6*K5
       call DMATMAT(I1,I2,I3,X15,F2,Z23)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K6
       I3=K9*K6*K7
       call DMATMAT(I1,I2,I3,X16,F2,Z24)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X29,B2,Z72)
       deallocate(B2)
C
       V2C=V2C-Z72
       deallocate(Z72)
