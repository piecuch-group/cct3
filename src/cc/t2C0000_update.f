...
C
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,N0,M1,N0,M1,t3C2,F2)
       ...
       I2=K5*K5*K6
       I3=K9*K6*K7
       call DMATMAT(I1,I2,I3,D1,F2,S23)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X9,B2,Z22)
       deallocate(B2)
C
       V2C=V2C+Z22
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,D1,B2,Z33)
       deallocate(D1)
       deallocate(B2)
C
       V2C=V2C-Z33
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,D1,B2,Z37)
       deallocate(D1)
       deallocate(B2)
C
       call
