...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U87)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z88)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U147)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S123)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U311)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z312)
       deallocate(F1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,U425)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X68,B2,Z148)
       deallocate(B2)
C
       V3C=V3C-Z148
       deallocate(Z148)
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N2,M2,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K0*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X70,F2,Z185)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,N0,M1,N0,M1,t3D,F2)
       ...
       I2=K5*K5*K0*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X72,F2,Z190)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,M2,N3,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X54,F2,Z78)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X56,F2,Z80)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N2,M2,M2,N3,N0,M1,N0,M1,t3C4,F2)
       ...
       I2=K5*K5*K6*K0
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X55,F2,Z79)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K0*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X57,F2,Z81)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K0*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X58,F2,Z82)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K0*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X59,F2,Z83)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N2,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K0*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X60,F2,Z84)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K0*K6
       I3=K5
       call DMATMAT(I1,I2,I3,X61,F2,Z85)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6*K0*K6
       I3=K8
       call DMATMAT(I1,I2,I3,X62,F2,Z86)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q55,B2,Q57)
       deallocate(B2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S354)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S376)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S370)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,N0,M1,t2C,D2)
       ...
       I2=K5*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S373)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S440)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S444)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X66,D2,Z111)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X67,D2,Z112)
       deallocate(D2)
C
       call
