...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X19,B2,Z46)
       deallocate(B2)
C
       V2C=V2C+Z46
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X20,B2,Z70)
       deallocate(B2)
C
       V2C=V2C-Z70
       deallocate(Z70)
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X21,B2,Z78)
       deallocate(B2)
C
       call
