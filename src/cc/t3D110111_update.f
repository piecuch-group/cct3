...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,Q5,F2,Z55)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,Q6,F2,Z56)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z263)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z264)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S156)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S157)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S158)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S159)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,Z290)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,Z293)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z305)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z306)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X106,D2,Z303)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X105,D2,Z301)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X109,D2,Z360)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X108,D2,Z348)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z448)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,Z483)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0
       I3=K0*K6
       call DMATMAT(I1,I2,I3,D1,F2,Z484)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0*K0
       I3=K5
       call DMATMAT(I1,I2,I3,X39,F2,Z53)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0*K0
       I3=K5
       call DMATMAT(I1,I2,I3,X37,F2,Z51)
       deallocate(F2)
C
       V3D=V3D-Z51
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X40,F2,Z54)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X38,F2,Z52)
       deallocate(F2)
C
       V3D=V3D+Z52
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q49,B2,Q53)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X101,F2,Z280)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X99,F2,Z278)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q51,B2,Q54)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X102,F2,Z281)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X100,F2,Z279)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S339)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S340)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X56,F2,Z96)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X54,F2,Z100)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X59,F2,Z99)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X61,F2,Z103)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X55,F2,Z102)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X58,F2,Z98)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X57,F2,Z97)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X60,F2,Z101)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X62,F2,Z124)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X69,F2,Z127)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X63,F2,Z126)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X68,F2,Z125)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K8*K5
       call DMATMAT(I1,I2,I3,X35,F2,Z38)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,t3D,F2)
       ...
       I2=K5*K0*K0*K0
       I3=K8*K5
       call DMATMAT(I1,I2,I3,X32,F2,Z35)
       deallocate(F2)
C
       V3D=V3D-Z35
       deallocate(Z35)
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K5*K5
       call DMATMAT(I1,I2,I3,X34,F2,Z37)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K8*K8
       call DMATMAT(I1,I2,I3,X36,F2,Z39)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,t3D,F2)
       ...
       I2=K5*K0*K0*K0
       I3=K8*K8
       call DMATMAT(I1,I2,I3,X33,F2,Z36)
       deallocate(F2)
C
       V3D=V3D+0.500*Z36
       deallocate(Z36)
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X76,F2,Z157)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X72,F2,Z153)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X78,F2,Z159)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X74,F2,Z155)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X77,F2,Z158)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X73,F2,Z154)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X79,F2,Z160)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X75,F2,Z156)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X80,F2,Z161)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X81,F2,Z162)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X88,F2,Z182)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X84,F2,Z178)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X90,F2,Z184)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X86,F2,Z180)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X89,F2,Z183)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X85,F2,Z179)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X91,F2,Z185)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X87,F2,Z181)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X92,F2,Z186)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X93,F2,Z187)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X94,F2,Z188)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X95,F2,Z189)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,X96,F2,Z200)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0
       I3=K0*K6
       call DMATMAT(I1,I2,I3,X97,F2,Z201)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0
       I3=K0*K0
       call DMATMAT(I1,I2,I3,X98,F2,Z202)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0
       I3=K0*K0
       call DMATMAT(I1,I2,I3,D1,F2,Z602)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q62,B2,Q66)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X70,F2,Z144)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q64,B2,Q67)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X71,F2,Z145)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X103,D2,Z289)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X45,D2,Z62)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X47,D2,Z63)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X46,D2,Z64)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X50,D2,Z71)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X51,D2,Z74)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X43,D2,Z61)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X44,D2,Z60)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X104,D2,Z295)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X112,D2,Z419)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X113,D2,Z425)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X48,D2,Z67)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X49,D2,Z66)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X111,D2,Z410)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X107,D2,Z320)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X110,D2,Z404)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X53,D2,Z86)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X52,D2,Z83)
       deallocate(D2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z33)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K5*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,B1,F2,Z34)
       deallocate(B1)
       deallocate(F2)
C
       call
