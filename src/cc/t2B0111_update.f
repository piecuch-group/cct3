       subroutine t2B0111_update(N0,N1,N2,N3,HT2B,shift,
...
C
       allocate(V2B(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       V2B=0.0d0
C
     ...
     & N1,N3,N0,M1,t1A,B2)
       allocate(S61(N0+1:M1,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5*K5
       I2=K5
       I3=K3
...
C
       ...
       X5=0.0d0
       call
     & sum4123(N0,M1,N0,M1,M2,N3,N0,M1,X5,S61,-1.000)
       deallocate(S61)
C
...
C
     ...
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(Z5(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K6*K5*K5
...
C
     ...
     & N1,N3,N0,M1,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S63(N0+1:M1,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K5
       I2=K5
       I3=K3
...
C
       ...
       X6=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M2,N3,N0,M1,X6,S63,-1.000)
       deallocate(S63)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(Z6(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K6*K7*K5
...
C
     ...
     & N1,N3,M1,N1,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S65(N0+1:M1,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K7
       I2=K5
       I3=K3
...
C
       ...
       X7=0.0d0
       call
     & sum4123(M1,N1,M1,N1,M2,N3,N0,M1,X7,S65,-1.000)
       deallocate(S65)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & M1,N1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(Z7(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K6*K7*K7
...
C
     ...
     & N1,N3,N0,M1,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S67(N0+1:M1,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5*K5
       I2=K5
       I3=K3
...
C
       ...
       X8=0.0d0
       call
     & sum4123(N0,M1,N0,M1,N1,M2,N0,M1,X8,S67,-1.000)
       deallocate(S67)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & N0,M1,N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,t3B4,F2)
       allocate(Z8(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K9*K5*K5
...
C
     ...
     & N1,N3,N0,M1,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S69(N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K5
       I2=K5
       I3=K3
...
C
       ...
       X9=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N1,M2,N0,M1,X9,S69,-1.000)
       deallocate(S69)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(Z9(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K9*K7*K5
...
C
     ...
     & N1,N3,M1,N1,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S71(N0+1:M1,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K7
       I2=K5
       I3=K3
...
C
       ...
       X10=0.0d0
       call
     & sum4123(M1,N1,M1,N1,N1,M2,N0,M1,X10,S71,-1.000)
       deallocate(S71)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,t3B1,F2)
       allocate(Z10(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K9*K7*K7
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,N0,M1,t3B2,F2)
       ...
       deallocate(F2)
C
       allocate(X29(N0+1:N1,N2+1:M2,M1+1:N2,N0+1:M1))
       X29=0.0d0
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S73, 1.000)
       deallocate(S73)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S75,-1.000)
       deallocate(S75)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S77, 2.000)
       deallocate(S77)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S79,-2.000)
       deallocate(S79)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       allocate(S81(N1+1:M2,N0+1:M1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K5
       I2=K9
       I3=K1
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z82,-0.500)
       deallocate(Z82)
       deallocate(S81)
C
     ...
     & N0,N1,M1,N1,N1,M2,N1,M2,VAHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S83(N1+1:M2,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z84, 0.500)
       deallocate(Z84)
       deallocate(S83)
C
...
C
     ...
     & N1,N3,N0,M1,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S89(N0+1:M1,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5*K5
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,M1,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S91(N0+1:M1,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K8
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S93(N0+1:M1,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K5
       I2=K5
       I3=K3
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N0,M1,S93,D1)
       allocate(F2(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:M2,N1+1:M2,M1+1:N2))
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z94(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K6*K7*K5
...
C
     ...
     & N1,N3,M1,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S95(N0+1:M1,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K8
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S97(N0+1:M1,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5*K5
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,M1,N2,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S99(N0+1:M1,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K8
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S101(N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2))
       I1=K0*K7*K5
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,M1,N2,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S103(N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0*K7*K8
       I2=K5
       I3=K3
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S105, 2.000)
       deallocate(S105)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S107, 2.000)
       deallocate(S107)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S109, 2.000)
       deallocate(S109)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S111, 2.000)
       deallocate(S111)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S113, 2.000)
       deallocate(S113)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,N0,M1,X29,S115, 2.000)
       deallocate(S115)
C
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(Z74(N1+1:M2,N2+1:M2,M1+1:N2,N0+1:M1))
       I1=K5*K8*K0
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,X29,B2,Z74)
       deallocate(B2)
C
       call
     & sum2134(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z74,-0.500)
       deallocate(Z74)
       deallocate(X29)
C
     ...
     & N0,N1,N0,M1,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S117(N1+1:M2,N0+1:M1,N2+1:M2,N1+1:M2))
       I1=K9*K0*K5
       I2=K9
       I3=K1
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z118,-1.000)
       deallocate(Z118)
       deallocate(S117)
C
     ...
     & N0,N1,M1,N2,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S119(N1+1:M2,M1+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z120,-1.000)
       deallocate(Z120)
       deallocate(S119)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z121(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K6*K5
       call DVECMAT(I2,I3,Q5,F2,Z121)
       deallocate(F2)
C
       V2B=V2B+Z121
       deallocate(Z121)
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z122(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K6*K8
       call DVECMAT(I2,I3,Q6,F2,Z122)
       deallocate(F2)
C
       V2B=V2B+Z122
       deallocate(Z122)
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z123(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K0*K5
       call DVECMAT(I2,I3,Q7,F2,Z123)
       deallocate(F2)
C
       V2B=V2B+Z123
       deallocate(Z123)
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z124(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K0*K8
       call DVECMAT(I2,I3,Q8,F2,Z124)
       deallocate(F2)
C
       V2B=V2B+Z124
       deallocate(Z124)
...
C
     ...
     & N2,N3,M1,N2,t1B,B2)
       allocate(S125(M1+1:N2,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K8
       I2=K8
       I3=K4
...
C
       ...
       X11=0.0d0
       call
     & sum4123(M1,N2,N0,M1,M2,N3,M1,N2,X11,S125, 1.000)
       deallocate(S125)
C
...
C
     ...
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(Z17(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K6*K5*K8
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z17,-1.000)
       deallocate(Z17)
       deallocate(X11)
C
     ...
     & N2,N3,N0,M1,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S127(M1+1:N2,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K5
       I2=K8
       I3=K4
...
C
       ...
       X12=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M2,N3,M1,N2,X12,S127, 1.000)
       deallocate(S127)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z18(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z18, 1.000)
       deallocate(Z18)
       deallocate(X12)
C
     ...
     & N2,N3,M1,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S129(M1+1:N2,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K8
       I2=K8
       I3=K4
...
C
       ...
       X13=0.0d0
       call
     & sum4123(M1,N2,M1,N1,M2,N3,M1,N2,X13,S129, 1.000)
       deallocate(S129)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z19(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K6*K7*K8
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z19, 1.000)
       deallocate(Z19)
       deallocate(X13)
C
     ...
     & N2,N3,M1,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S131(M1+1:N2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K8
       I2=K8
       I3=K4
...
C
       ...
       X14=0.0d0
       call
     & sum4123(M1,N2,N0,M1,N1,M2,M1,N2,X14,S131, 1.000)
       deallocate(S131)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(Z20(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K9*K5*K8
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z20,-1.000)
       deallocate(Z20)
       deallocate(X14)
C
     ...
     & N2,N3,N0,M1,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S133(M1+1:N2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K5
       I2=K8
       I3=K4
...
C
       ...
       X15=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N1,M2,M1,N2,X15,S133, 1.000)
       deallocate(S133)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z21(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z21, 1.000)
       deallocate(Z21)
       deallocate(X15)
C
     ...
     & N2,N3,M1,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S135(M1+1:N2,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K8
       I2=K8
       I3=K4
...
C
       ...
       X16=0.0d0
       call
     & sum4123(M1,N2,M1,N1,N1,M2,M1,N2,X16,S135, 1.000)
       deallocate(S135)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z22(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K9*K7*K8
...
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z22, 1.000)
       deallocate(Z22)
       deallocate(X16)
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(S137(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K6*K5
       ...
       deallocate(F2)
C
       allocate(X30(N0+1:N2,N1+1:M2,M1+1:N2,N0+1:M1))
       X30=0.0d0
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S137, 1.000)
       deallocate(S137)
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(S139(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S139,-1.000)
       deallocate(S139)
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(S141(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S141, 1.000)
       deallocate(S141)
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(S143(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S143,-1.000)
       deallocate(S143)
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(S145(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S145, 1.000)
       deallocate(S145)
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(S147(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S147,-1.000)
       deallocate(S147)
C
...
C
       ...
       X17=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N1,M2,N2,M2,X17,S149,-1.000)
       deallocate(S149)
C
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z29(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K9*K0*K5
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z29, 1.000)
       deallocate(Z29)
       deallocate(X17)
C
...
C
       ...
       X18=0.0d0
       call
     & sum4123(M1,N1,N2,M2,N1,M2,N2,M2,X18,S151,-1.000)
       deallocate(S151)
C
       call sumx2341(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z30(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K9*K0*K7
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z30,-1.000)
       deallocate(Z30)
       deallocate(X18)
C
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z1(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K6*K5
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z2(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K6*K7
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z3(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K9*K5
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z4(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K9*K7
...
C
     ...
     & N2,N3,N0,M1,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S157(M1+1:N2,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8*K5
       I2=K8
       I3=K4
...
C
       ...
       X23=0.0d0
       call
     & sum4123(N0,M1,M1,N2,M2,N3,M1,N2,X23,S157,-1.000)
       deallocate(S157)
C
...
C
     ...
     & N0,M1,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z51(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K6*K8*K5
       call DMATMAT(I1,I2,I3,X23,F2,Z51)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z51,-1.000)
       deallocate(Z51)
       deallocate(X23)
C
     ...
     & N2,N3,M1,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S159(M1+1:N2,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K8
       I2=K8
       I3=K4
...
C
       ...
       X24=0.0d0
       call
     & sum4123(M1,N2,M1,N2,M2,N3,M1,N2,X24,S159,-1.000)
       deallocate(S159)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & M1,N2,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z52(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K6*K8*K8
       call DMATMAT(I1,I2,I3,X24,F2,Z52)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z52,-0.500)
       deallocate(Z52)
       deallocate(X24)
C
     ...
     & N2,N3,N0,M1,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S161(M1+1:N2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8*K5
       I2=K8
       I3=K4
...
C
       ...
       X25=0.0d0
       call
     & sum4123(N0,M1,M1,N2,N2,M2,M1,N2,X25,S161,-1.000)
       deallocate(S161)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z53(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K0*K8*K5
       call DMATMAT(I1,I2,I3,X25,F2,Z53)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z53,-1.000)
       deallocate(Z53)
       deallocate(X25)
C
     ...
     & N2,N3,M1,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S163(M1+1:N2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K8
       I2=K8
       I3=K4
...
C
       ...
       X26=0.0d0
       call
     & sum4123(M1,N2,M1,N2,N2,M2,M1,N2,X26,S163,-1.000)
       deallocate(S163)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z54(N2+1:M2,N1+1:M2,N0+1:M1,M1+1:N2))
       I1=K8
       I2=K5*K9*K0
       I3=K0*K8*K8
       call DMATMAT(I1,I2,I3,X26,F2,Z54)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z54,-0.500)
       deallocate(Z54)
       deallocate(X26)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(S165(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S165,-0.500)
       deallocate(S165)
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(S167(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S167,-0.500)
       deallocate(S167)
C
     ...
     & N0,M1,M2,N3,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(S169(N1+1:M2,M1+1:N2,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K8*K9
       I3=K0*K6*K5
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S169,-1.000)
       deallocate(S169)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,N0,M1,X30,S171,-1.000)
       deallocate(S171)
C
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(Z138(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5*K8*K9
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,X30,B2,Z138)
       deallocate(B2)
C
       V2B=V2B-Z138
       deallocate(Z138)
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       deallocate(B2)
C
       allocate(X27(N0+1:M1,N2+1:M2,N2+1:M2,N2+1:M2))
       X27=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N2,M2,N2,M2,X27,S173,-1.000)
       deallocate(S173)
C
       call sumx2341(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,M1,N2,M2,N2,M2,N2,M2,X27,VCHPPP, 1.000)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z59(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K0*K0*K5
       call DMATMAT(I1,I2,I3,X27,F2,Z59)
       deallocate(F2)
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z59,-0.500)
       deallocate(Z59)
       deallocate(X27)
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       deallocate(B2)
C
       allocate(X28(M1+1:N2,N2+1:M2,N2+1:M2,N2+1:M2))
       X28=0.0d0
       call
     & sum4123(M1,N2,N2,M2,N2,M2,N2,M2,X28,S175,-1.000)
       deallocate(S175)
C
       call sumx2341(N2,N3,N2,N3,N2,N3,N0,N2,
     & M1,N2,N2,M2,N2,M2,N2,M2,X28,VCHPPP, 1.000)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z60(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K0*K0*K8
       call DMATMAT(I1,I2,I3,X28,F2,Z60)
       deallocate(F2)
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z60,-0.500)
       deallocate(Z60)
       deallocate(X28)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z31(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K6*K5
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z32(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K6*K8
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z33(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K0*K5
...
C
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z34(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I2=K5*K8*K9*K0
       I3=K0*K8
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder523146(N2,M2,M2,N3,M2,N3,M1,N2,N0,M1,N0,M1,
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,N0,M1,t3B2,F2)
       allocate(Z11(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K6*K6*K5
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z11,-0.500)
       deallocate(Z11)
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder623145(N2,M2,M2,N3,M2,N3,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,N0,M1,t3B3,F2)
       allocate(Z12(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K6*K6*K7
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z12, 0.500)
       deallocate(Z12)
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder523146(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,M2,N3,N1,M2,N2,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z13(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K9*K6*K5
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z13,-1.000)
       deallocate(Z13)
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder623145(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N2,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z14(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K9*K6*K7
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z14, 1.000)
       deallocate(Z14)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & N0,M1,N1,M2,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder523146(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N1,M2,N1,M2,N2,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z15(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K9*K9*K5
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z15,-0.500)
       deallocate(Z15)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & M1,N1,N1,M2,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder623145(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N1,M2,N2,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z16(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K9*K9*K7
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z16, 0.500)
       deallocate(Z16)
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z23(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z23, 1.000)
       deallocate(Z23)
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z24(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K6*K6*K7
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z24,-1.000)
       deallocate(Z24)
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z25(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K6*K0*K5
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z25, 1.000)
       deallocate(Z25)
C
     ...
     & M1,N1,N2,M2,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z26(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z26,-1.000)
       deallocate(Z26)
C
     ...
     & N0,M1,M2,N3,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder512346(N2,N3,N1,N3,N1,M2,M1,N2,N0,M1,N0,M1,
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       allocate(Z27(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K9*K6*K5
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z27, 1.000)
       deallocate(Z27)
C
     ...
     & M1,N1,M2,N3,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       allocate(Z28(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z28,-1.000)
       deallocate(Z28)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,M1,N0,M1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z35(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K6*K5*K5
...
C
     ...
     & M1,N2,N0,M1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z36(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K6*K5*K8
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z37(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K6*K7*K5
...
C
     ...
     & M1,N2,M1,N1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z38(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K6*K7*K8
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z39(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K0*K5*K5
...
C
     ...
     & M1,N2,N0,M1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z40(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K0*K5*K8
...
C
     ...
     & N0,M1,M1,N1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z41(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K0*K7*K5
...
C
     ...
     & M1,N2,M1,N1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,N2,M2,N2,M2,N1,M2,M1,N2,t3C1,F2)
       allocate(Z42(N2+1:M2,N1+1:M2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K9*K0
       I3=K0*K7*K8
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z43(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K6*K6*K5
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z43, 1.000)
       deallocate(Z43)
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z44(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K6*K6*K8
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z44, 1.000)
       deallocate(Z44)
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z45(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K6*K0*K5
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z45, 1.000)
       deallocate(Z45)
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z46(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K6*K0*K8
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z46, 1.000)
       deallocate(Z46)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,M1,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N1,M2,N2,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z47(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K9*K6*K5
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z47, 1.000)
       deallocate(Z47)
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N1,M2,N2,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z48(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K9*K6*K8
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z48, 1.000)
       deallocate(Z48)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & N0,M1,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N1,M2,N2,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z49(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K9*K0*K5
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z49, 1.000)
       deallocate(Z49)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & M1,N2,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder413256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,N2,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z50(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K8*K0
       I3=K9*K0*K8
...
C
       call
     & sum1342(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z50, 1.000)
       deallocate(Z50)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2))
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(Z55(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K6*K6*K5
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z55,-0.500)
       deallocate(Z55)
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       allocate(Z56(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z56,-0.500)
       deallocate(Z56)
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z57(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K0*K6*K5
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z57,-1.000)
       deallocate(Z57)
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       allocate(Z58(N1+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K8*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(N2,M2,N1,M2,M1,N2,N0,M1,V2B,Z58,-1.000)
       deallocate(Z58)
C
       call sumx2(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,M2,N1,M2,M1,N2,N0,M1,HT2B,V2B,1.0)
       deallocate(V2B)
C
       end
