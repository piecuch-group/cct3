...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U125)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z126)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U184)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K5*K6*K6
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z257)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z382)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U393)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z394)
       deallocate(F1)
       deallocate(D2)
C
       V3B=V3B+Z394
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,U507)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X80,B2,Z185)
       deallocate(B2)
C
       V3B=V3B-Z185
       deallocate(Z185)
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X64,F2,Z92)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X65,F2,Z93)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C2,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X82,F2,Z273)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C3,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X83,F2,Z274)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X86,F2,Z277)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X84,F2,Z275)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X87,F2,Z278)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X85,F2,Z276)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X66,F2,Z113)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X67,F2,Z114)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X68,F2,Z115)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X69,F2,Z116)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X70,F2,Z117)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X71,F2,Z118)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X74,F2,Z121)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X72,F2,Z119)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,M2,N3,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K6*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X75,F2,Z122)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X73,F2,Z120)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6*K6
       I3=K5
       call DMATMAT(I1,I2,I3,X76,F2,Z123)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6*K6
       I3=K8
       call DMATMAT(I1,I2,I3,X77,F2,Z124)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S453)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X62,D2,Z69)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X81,D2,Z209)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X91,D2,Z293)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X92,D2,Z294)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,X89,D2,Z289)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,X88,D2,Z287)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X90,D2,Z291)
       deallocate(D2)
C
       call
