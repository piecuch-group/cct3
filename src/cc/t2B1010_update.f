...
C
     ...
     & N0,M1,N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,t3B1,F2)
       ...
       I2=K7*K9*K6
       I3=K6*K5*K5
       call DMATMAT(I1,I2,I3,X9,F2,Z13)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,t3B1,F2)
       ...
       I2=K7*K9*K6
       I3=K6*K5*K8
       call DMATMAT(I1,I2,I3,X10,F2,Z14)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,t3C2,F2)
       ...
       I2=K7*K9*K6
       I3=K6*K5*K5
       call DMATMAT(I1,I2,I3,X21,F2,Z45)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,t3C3,F2)
       ...
       I2=K7*K9*K6
       I3=K6*K8*K5
       call DMATMAT(I1,I2,I3,X22,F2,Z46)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,t3C3,F2)
       ...
       I2=K7*K9*K6
       I3=K6*K8*K8
       call DMATMAT(I1,I2,I3,X23,F2,Z47)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,N2,M2,M2,N3,N1,M2,M1,N1,t3C4,F2)
       ...
       I2=K7*K9*K6
       I3=K0*K5*K5
       call DMATMAT(I1,I2,I3,X24,F2,Z48)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,t3C1,F2)
       ...
       I2=K7*K9*K6
       I3=K0*K8*K5
       call DMATMAT(I1,I2,I3,X25,F2,Z49)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,t3C1,F2)
       ...
       I2=K7*K9*K6
       I3=K0*K8*K8
       call DMATMAT(I1,I2,I3,X26,F2,Z50)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X27,B2,Z122)
       deallocate(B2)
C
       V2B=V2B-Z122
       deallocate(Z122)
