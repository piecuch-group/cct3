...
C
       ...
       X2=0.0d0
       call
     & sum4123(N0,N1,M2,N3,N0,M1,M1,N1,X2,S2, 1.000)
       deallocate(S2)
C
...
C
       ...
       X9=0.0d0
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X9,S6,-1.000)
       deallocate(S6)
C
...
C
       ...
       X10=0.0d0
       call
     & sum3124(N2,N3,M2,N3,N1,M2,M1,N1,X10,S7,-1.000)
       deallocate(S7)
C
...
C
       call
     & sum4123(N0,N2,N1,M2,N0,M1,M1,N1,X9,S9, 1.000)
       deallocate(S9)
C
...
C
       call
     & sum4123(N2,N3,M2,N3,N1,M2,M1,N1,X10,S10, 1.000)
       deallocate(S10)
C
...
C
     ...
     & N0,M1,N1,M2,N1,M2,M1,N1,S11,D1)
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z76,-1.000)
       deallocate(Z76)
       deallocate(S11)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z77,-1.000)
       deallocate(Z77)
       deallocate(S12)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z80,-1.000)
       deallocate(Z80)
       deallocate(S13)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z81,-1.000)
       deallocate(Z81)
       deallocate(S14)
C
...
C
       ...
       X30=0.0d0
       call
     & sum4123(M1,N2,N0,M1,M1,N2,M1,N1,X30,S15, 1.000)
       deallocate(S15)
C
...
C
       ...
       X31=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M1,N2,M1,N1,X31,S16, 1.000)
       deallocate(S16)
C
...
C
       ...
       X32=0.0d0
       call
     & sum4123(M1,N2,M1,N1,M1,N2,M1,N1,X32,S17, 1.000)
       deallocate(S17)
C
...
C
       ...
       X33=0.0d0
       call
     & sum4123(N0,M1,N0,M1,N0,M1,M1,N1,X33,S18, 1.000)
       deallocate(S18)
C
...
C
       ...
       X34=0.0d0
       call
     & sum4123(M1,N2,N0,M1,N0,M1,M1,N1,X34,S19, 1.000)
       deallocate(S19)
C
...
C
       ...
       X35=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N0,M1,M1,N1,X35,S20, 1.000)
       deallocate(S20)
C
...
C
       ...
       X36=0.0d0
       call
     & sum4123(M1,N2,M1,N1,N0,M1,M1,N1,X36,S21, 1.000)
       deallocate(S21)
C
...
C
       ...
       X65=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X65,S26, 1.000)
       deallocate(S26)
C
...
C
       ...
       X66=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X66,S27, 1.000)
       deallocate(S27)
C
...
C
       ...
       X69=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X69,S28, 1.000)
       deallocate(S28)
C
...
C
       ...
       X70=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,N0,M1,X70,S29, 1.000)
       deallocate(S29)
C
...
C
       ...
       X45=0.0d0
       call
     & sum4123(N2,M2,M2,N3,M2,N3,N1,M2,X45,S30,-1.000)
       deallocate(S30)
C
...
C
       ...
       X46=0.0d0
       call
     & sum4123(M2,N3,N1,M2,M2,N3,N1,M2,X46,S31,-1.000)
       deallocate(S31)
C
...
C
       ...
       X47=0.0d0
       call
     & sum4123(N2,M2,N1,M2,M2,N3,N1,M2,X47,S32,-1.000)
       deallocate(S32)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z107,-1.000)
       deallocate(Z107)
       deallocate(S33)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z108, 1.000)
       deallocate(Z108)
       deallocate(S34)
C
...
C
     ...
     & N0,M1,N2,M2,N1,M2,M1,N1,S35,D1)
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z109, 1.000)
       deallocate(Z109)
       deallocate(S35)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z110,-1.000)
       deallocate(Z110)
       deallocate(S36)
C
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S37,-1.000)
       deallocate(S37)
C
...
C
       call
     & sum3124(N0,N1,M2,N3,M1,N2,M1,N1,X1,S38, 1.000)
       deallocate(S38)
C
...
C
       call
     & sum2134(N0,N1,M2,N3,N0,M1,M1,N1,X2,S39,-1.000)
       deallocate(S39)
C
       allocate(D1(N2+1:N3,N0+1:N1,M2+1:N3,M1+1:N1))
       call reorder1432(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
       call
     & sum3124(N0,N1,M2,N3,N0,M1,M1,N1,X2,S40, 1.000)
       deallocate(S40)
C
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S41,-1.000)
       deallocate(S41)
C
...
C
       call
     & sum4123(N1,N3,M2,N3,N1,M2,M1,N2,X3,S42, 1.000)
       deallocate(S42)
C
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,N0,M1,X4,S43,-1.000)
       deallocate(S43)
C
       allocate(D1(N2+1:N3,N1+1:N3,M2+1:N3,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N2,N3,N1,M2,
...
C
       call
     & sum4123(N1,N3,M2,N3,N1,M2,N0,M1,X4,S44, 1.000)
       deallocate(S44)
C
...
C
       ...
       X5=0.0d0
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X5,S45,-1.000)
       deallocate(S45)
C
...
C
       call
     & sum3124(N0,N2,M2,N3,N0,M1,M1,N2,X5,S46, 1.000)
       deallocate(S46)
C
...
C
       ...
       X75=0.0d0
       call
     & sum3124(N2,N3,M2,N3,M2,N3,M1,N2,X75,S47, 1.000)
       deallocate(S47)
C
...
C
       call
     & sum4123(N0,N2,M2,N3,N0,M1,M1,N2,X5,S48,-1.000)
       deallocate(S48)
C
...
C
       ...
       X76=0.0d0
       call
     & sum3124(N2,N3,M2,N3,M2,N3,N0,M1,X76,S49, 1.000)
       deallocate(S49)
C
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X8,S50, 1.000)
       deallocate(S50)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3124(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,M1,N1,X9,S51, 1.000)
       deallocate(S51)
C
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S52,-1.000)
       deallocate(S52)
C
...
C
       ...
       X11=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X11,S53,-1.000)
       deallocate(S53)
C
...
C
       ...
       X12=0.0d0
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N2,X12,S54,-1.000)
       deallocate(S54)
C
...
C
       ...
       X13=0.0d0
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X13,S55,-1.000)
       deallocate(S55)
C
...
C
       ...
       X14=0.0d0
       call
     & sum3124(M1,N1,N1,M2,M2,N3,M1,N2,X14,S56,-1.000)
       deallocate(S56)
C
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N2,X11,S57, 1.000)
       deallocate(S57)
C
...
C
       call
     & sum4123(M1,N1,M2,N3,M2,N3,M1,N2,X12,S58, 1.000)
       deallocate(S58)
C
...
C
       call
     & sum4123(N0,M1,N1,M2,M2,N3,M1,N2,X13,S59, 1.000)
       deallocate(S59)
C
...
C
       call
     & sum4123(M1,N1,N1,M2,M2,N3,M1,N2,X14,S60, 1.000)
       deallocate(S60)
C
...
C
       ...
       X15=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,N0,M1,X15,S61,-1.000)
       deallocate(S61)
C
...
C
       ...
       X16=0.0d0
       call
     & sum3124(M1,N1,M2,N3,M2,N3,N0,M1,X16,S62,-1.000)
       deallocate(S62)
C
...
C
       ...
       X17=0.0d0
       call
     & sum3124(N0,M1,N1,M2,M2,N3,N0,M1,X17,S63,-1.000)
       deallocate(S63)
C
...
C
       ...
       X18=0.0d0
       call
     & sum3124(M1,N1,N1,M2,M2,N3,N0,M1,X18,S64,-1.000)
       deallocate(S64)
C
       allocate(D1(N2+1:N3,N0+1:M1,M2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,N0,M1,X15,S65, 1.000)
       deallocate(S65)
C
       allocate(D1(N2+1:N3,M1+1:N1,M2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum4123(M1,N1,M2,N3,M2,N3,N0,M1,X16,S66, 1.000)
       deallocate(S66)
C
       allocate(D1(N2+1:N3,N0+1:M1,N1+1:M2,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum4123(N0,M1,N1,M2,M2,N3,N0,M1,X17,S67, 1.000)
       deallocate(S67)
C
       allocate(D1(N2+1:N3,M1+1:N1,N1+1:M2,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum4123(M1,N1,N1,M2,M2,N3,N0,M1,X18,S68, 1.000)
       deallocate(S68)
C
...
C
       ...
       X22=0.0d0
       call
     & sum21(N0,M1,M1,N2,X22,Q13, 1.000)
       deallocate(Q13)
C
...
C
       ...
       X23=0.0d0
       call
     & sum21(M1,N2,M1,N2,X23,Q14, 1.000)
       deallocate(Q14)
C
       allocate(B1(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
...
C
       ...
       X24=0.0d0
       call
     & sum21(N0,M1,N0,M1,X24,Q15, 1.000)
       deallocate(Q15)
C
       allocate(B1(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
...
C
       ...
       X25=0.0d0
       call
     & sum21(M1,N2,N0,M1,X25,Q16, 1.000)
       deallocate(Q16)
C
...
C
       ...
       X26=0.0d0
       call
     & sum21(M2,N3,M2,N3,X26,Q17,-1.000)
       deallocate(Q17)
C
...
C
       ...
       X27=0.0d0
       call
     & sum21(N2,M2,M2,N3,X27,Q18,-1.000)
       deallocate(Q18)
C
...
C
       call
     & sum3124(M1,N2,N0,M1,M1,N2,M1,N1,X30,S69, 1.000)
       deallocate(S69)
C
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N2,M1,N1,X31,S70, 1.000)
       deallocate(S70)
C
...
C
       call
     & sum3124(M1,N2,M1,N1,M1,N2,M1,N1,X32,S71, 1.000)
       deallocate(S71)
C
...
C
       call
     & sum3124(N0,M1,N0,M1,N0,M1,M1,N1,X33,S72, 1.000)
       deallocate(S72)
C
       allocate(D1(N2+1:N3,M1+1:N2,N0+1:M1,M1+1:N1))
       call reorder1342(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum3124(M1,N2,N0,M1,N0,M1,M1,N1,X34,S73, 1.000)
       deallocate(S73)
C
       allocate(D1(N2+1:N3,N0+1:M1,M1+1:N1,M1+1:N1))
       call reorder1342(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum3124(N0,M1,M1,N1,N0,M1,M1,N1,X35,S74, 1.000)
       deallocate(S74)
C
       allocate(D1(N2+1:N3,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder1342(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum3124(M1,N2,M1,N1,N0,M1,M1,N1,X36,S75, 1.000)
       deallocate(S75)
C
...
C
       ...
       X37=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N1,X37,S76,-1.000)
       deallocate(S76)
C
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z37,-1.000)
       call
     & sum134526(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z37, 1.000)
       deallocate(Z37)
       deallocate(X37)
C
...
C
       ...
       X38=0.0d0
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N1,X38,S77,-1.000)
       deallocate(S77)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z38,-1.000)
       call
     & sum134526(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z38, 1.000)
       deallocate(Z38)
       deallocate(X38)
C
...
C
       ...
       X39=0.0d0
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N1,X39,S78,-1.000)
       deallocate(S78)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z39, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z39,-1.000)
       deallocate(Z39)
       deallocate(X39)
C
...
C
       ...
       X40=0.0d0
       call
     & sum3124(M1,N1,N2,M2,M2,N3,M1,N1,X40,S79,-1.000)
       deallocate(S79)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z40, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z40,-1.000)
       deallocate(Z40)
       deallocate(X40)
C
...
C
       ...
       X41=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,M1,N2,X41,S80, 1.000)
       deallocate(S80)
C
...
C
       call
     & sum124635(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z41, 1.000)
       deallocate(Z41)
       deallocate(X41)
C
...
C
       ...
       X42=0.0d0
       call
     & sum4123(M1,N2,N1,M2,N1,M2,M1,N2,X42,S81, 1.000)
       deallocate(S81)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum124635(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z42,-1.000)
       deallocate(Z42)
       deallocate(X42)
C
       allocate(D1(N2+1:N3,N0+1:M1,N1+1:M2,N1+1:M2))
...
C
       ...
       X43=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,N0,M1,X43,S82, 1.000)
       deallocate(S82)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum125634(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z43,-1.000)
       deallocate(Z43)
       deallocate(X43)
C
       allocate(D1(N2+1:N3,M1+1:N2,N1+1:M2,N1+1:M2))
...
C
       ...
       X44=0.0d0
       call
     & sum4123(M1,N2,N1,M2,N1,M2,N0,M1,X44,S83, 1.000)
       deallocate(S83)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum125634(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z44,-1.000)
       deallocate(Z44)
       deallocate(X44)
C
...
C
       call
     & sum3124(N2,M2,M2,N3,M2,N3,N1,M2,X45,S84,-1.000)
       deallocate(S84)
C
...
C
       call
     & sum3124(M2,N3,N1,M2,M2,N3,N1,M2,X46,S85,-1.000)
       deallocate(S85)
C
...
C
       call
     & sum3124(N2,M2,N1,M2,M2,N3,N1,M2,X47,S86,-1.000)
       deallocate(S86)
C
...
C
       ...
       X48=0.0d0
       call
     & sum3124(N0,M1,N0,M1,N0,M1,M1,N2,X48,S87, 1.000)
       deallocate(S87)
C
...
C
       ...
       X49=0.0d0
       call
     & sum3124(N0,M1,M1,N2,N0,M1,M1,N2,X49,S88, 1.000)
       deallocate(S88)
C
...
C
       ...
       X50=0.0d0
       call
     & sum3124(M1,N2,M1,N2,N0,M1,M1,N2,X50,S89, 1.000)
       deallocate(S89)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
...
C
       ...
       X51=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X51,S90,-1.000)
       deallocate(S90)
C
...
C
       ...
       X52=0.0d0
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X52,S91,-1.000)
       deallocate(S91)
C
...
C
       ...
       X53=0.0d0
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N2,X53,S92,-1.000)
       deallocate(S92)
C
...
C
       ...
       X54=0.0d0
       call
     & sum3124(M1,N2,N2,M2,M2,N3,M1,N2,X54,S93,-1.000)
       deallocate(S93)
C
...
C
       call
     & sum4123(N0,M1,N0,M1,N0,M1,M1,N2,X48,S94,-1.000)
       deallocate(S94)
C
...
C
       call
     & sum4123(N0,M1,M1,N2,N0,M1,M1,N2,X49,S95,-1.000)
       deallocate(S95)
C
...
C
       call
     & sum4123(M1,N2,M1,N2,N0,M1,M1,N2,X50,S96,-1.000)
       deallocate(S96)
C
       allocate(D1(N2+1:N3,N0+1:M1,M2+1:N3,M2+1:N3))
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N2,X51,S97,-1.000)
       deallocate(S97)
C
...
C
       call
     & sum4123(M1,N2,M2,N3,M2,N3,M1,N2,X52,S98,-1.000)
       deallocate(S98)
C
...
C
       call
     & sum4123(N0,M1,N2,M2,M2,N3,M1,N2,X53,S99,-1.000)
       deallocate(S99)
C
...
C
       call
     & sum4123(M1,N2,N2,M2,M2,N3,M1,N2,X54,S100,-1.000)
       deallocate(S100)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder3412(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       ...
       X55=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,N0,M1,X55,S101,-1.000)
       deallocate(S101)
C
...
C
       ...
       X56=0.0d0
       call
     & sum3124(M1,N2,M2,N3,M2,N3,N0,M1,X56,S102,-1.000)
       deallocate(S102)
C
...
C
       ...
       X57=0.0d0
       call
     & sum3124(N0,M1,N2,M2,M2,N3,N0,M1,X57,S103,-1.000)
       deallocate(S103)
C
...
C
       ...
       X58=0.0d0
       call
     & sum3124(M1,N2,N2,M2,M2,N3,N0,M1,X58,S104,-1.000)
       deallocate(S104)
C
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,N0,M1,X55,S105,-1.000)
       deallocate(S105)
C
       allocate(D1(N2+1:N3,M1+1:N2,M2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum4123(M1,N2,M2,N3,M2,N3,N0,M1,X56,S106,-1.000)
       deallocate(S106)
C
       allocate(D1(N2+1:N3,N0+1:M1,N2+1:M2,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum4123(N0,M1,N2,M2,M2,N3,N0,M1,X57,S107,-1.000)
       deallocate(S107)
C
       allocate(D1(N2+1:N3,M1+1:N2,N2+1:M2,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum4123(M1,N2,N2,M2,M2,N3,N0,M1,X58,S108,-1.000)
       deallocate(S108)
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U196)
       deallocate(D1)
       deallocate(F2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder561234(N1,M2,N0,M1,M1,N2,M1,N1,N0,N2,M2,N3,
     & N0,N2,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,U196,F1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,Z197)
       deallocate(F1)
       deallocate(B2)
C
       call
     & sum213456(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z197,-0.500)
       V3C=V3C+0.500*Z197
       deallocate(Z197)
       deallocate(U196)
C
...
C
     ...
     & M2,N3,N2,M2,M2,N3,M2,N3,S109,D1)
...
C
       call
     & sum345612(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z198,-1.000)
       call
     & sum345621(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z198, 1.000)
       deallocate(Z198)
       deallocate(S109)
C
...
C
     ...
     & N2,M2,N2,M2,M2,N3,M2,N3,S110,D1)
...
C
       call
     & sum345612(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z199,-0.500)
       call
     & sum345621(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z199, 0.500)
       deallocate(Z199)
       deallocate(S110)
C
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X8,S111, 1.000)
       deallocate(S111)
C
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X9,S112, 1.000)
       deallocate(S112)
C
...
C
       call
     & sum3412(N2,N3,M2,N3,N1,M2,M1,N1,X10,S113, 1.000)
       deallocate(S113)
C
...
C
       ...
       X77=0.0d0
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N1,X77,S114, 1.000)
       deallocate(S114)
C
...
C
       ...
       X78=0.0d0
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X78,S115, 1.000)
       deallocate(S115)
C
...
C
       call
     & sum21(N0,M1,M1,N1,X19,Q28, 0.500)
       deallocate(Q28)
C
...
C
       call
     & sum21(M1,N1,M1,N1,X20,Q29, 0.500)
       deallocate(Q29)
C
...
C
     ...
     & N1,M2,M2,N3,M2,N3,N0,M1,M1,N2,M1,N1,t3C3,F2)
       allocate(Z209(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K8*K5*K6*K6
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z209)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sum124563(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z209, 0.500)
       deallocate(Z209)
       deallocate(Q30)
C
...
C
       ...
       X79=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X79,S116, 1.000)
       deallocate(S116)
C
...
C
       ...
       X80=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X80,S117, 1.000)
       deallocate(S117)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S118, 1.000)
       deallocate(S118)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S119, 1.000)
       deallocate(S119)
C
...
C
       call
     & sum2314(N0,N1,M2,N3,N0,M1,M1,N1,X2,S120, 1.000)
       deallocate(S120)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N2,M1,N1,X1,S121, 1.000)
       deallocate(S121)
C
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,N0,M1,X4,S122,-1.000)
       deallocate(S122)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum2314(N1,N3,M2,N3,N1,M2,M1,N2,X3,S124, 1.000)
       deallocate(S124)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N2,M2,N3,N0,M1,M1,N2,X5,S125, 1.000)
       deallocate(S125)
C
...
C
       call
     & sum2413(N0,N1,M2,N3,M1,N2,M1,N1,X1,S126,-1.000)
       deallocate(S126)
C
...
C
       call
     & sum2314(N1,N3,M2,N3,N1,M2,N0,M1,X4,S127, 1.000)
       deallocate(S127)
C
...
C
       call
     & sum3412(N1,N3,M2,N3,N1,M2,N0,M1,X4,S128,-1.000)
       deallocate(S128)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,M2+1:N3))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,N0,M1,X76,S129,-1.000)
       deallocate(S129)
C
...
C
       call
     & sum3412(N0,N1,M2,N3,M1,N2,M1,N1,X1,S130, 1.000)
       deallocate(S130)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2413(N0,N2,M2,N3,N0,M1,M1,N2,X5,S131,-1.000)
       deallocate(S131)
C
...
C
       call
     & sum2413(N0,N1,M2,N3,N0,M1,M1,N1,X2,S132,-1.000)
       deallocate(S132)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,M2+1:N3))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3412(N1,N3,M2,N3,N1,M2,M1,N2,X3,S133,-1.000)
       deallocate(S133)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,M2+1:N3))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,M1,N2,X75,S134,-1.000)
       deallocate(S134)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N1,M2+1:N3))
       call reorder1243(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3412(N0,N1,M2,N3,N0,M1,M1,N1,X2,S135, 1.000)
       deallocate(S135)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S136, 1.000)
       deallocate(S136)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S137)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S137, 1.000)
       deallocate(S137)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S138)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S138,-1.000)
       deallocate(S138)
C
...
C
       call
     & sum2314(N0,N1,M2,N3,N0,M1,M1,N1,X2,S139, 1.000)
       deallocate(S139)
C
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X8,S140,-1.000)
       deallocate(S140)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N2,M1,N1,X1,S141, 1.000)
       deallocate(S141)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder4132(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,M1,N1,X9,S142,-1.000)
       deallocate(S142)
C
...
C
       call
     & sum2314(N2,N3,M2,N3,N1,M2,M1,N1,X10,S143, 1.000)
       deallocate(S143)
C
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,N0,M1,X4,S144, 1.000)
       deallocate(S144)
C
...
C
       call
     & sum3412(N0,N2,N1,M2,M1,N2,M1,N1,X8,S145, 1.000)
       deallocate(S145)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,M1,N2,X3,S146, 1.000)
       deallocate(S146)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:M2))
       call reorder1234(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum3412(N0,N2,N1,M2,N0,M1,M1,N1,X9,S147, 1.000)
       deallocate(S147)
C
...
C
       call
     & sum2413(N2,N3,M2,N3,N1,M2,M1,N1,X10,S148,-1.000)
       deallocate(S148)
C
...
C
       ...
       X6=0.0d0
       call
     & sum2314(N2,N3,M2,N3,M2,N3,M1,N2,X6,S149, 0.500)
       deallocate(S149)
C
...
C
       call
     & sum2314(N0,N2,M2,N3,N0,M1,M1,N2,X5,S150, 1.000)
       deallocate(S150)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
...
C
       ...
       X7=0.0d0
       call
     & sum2314(N2,N3,M2,N3,M2,N3,N0,M1,X7,S152, 0.500)
       deallocate(S152)
C
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,N0,M1,X76,S153, 1.000)
       deallocate(S153)
C
...
C
       call
     & sum2413(N0,N2,M2,N3,N0,M1,M1,N2,X5,S154,-1.000)
       deallocate(S154)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder4132(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X9,S155,-1.000)
       deallocate(S155)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,M2+1:N3))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,M1,N2,X75,S156, 1.000)
       deallocate(S156)
C
...
C
       call
     & sum3412(N0,N2,M2,N3,N0,M1,M1,N2,X5,S157, 0.500)
       deallocate(S157)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,M2+1:N3))
...
C
       call
     & sum3412(N2,N3,M2,N3,N1,M2,M1,N1,X10,S158, 1.000)
       deallocate(S158)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S159, 1.000)
       deallocate(S159)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S160, 0.500)
       deallocate(S160)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S161, 1.000)
       deallocate(S161)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S162, 0.500)
       deallocate(S162)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S163, 0.500)
       deallocate(S163)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S165, 0.500)
       deallocate(S165)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S166, 0.500)
       deallocate(S166)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S168, 0.500)
       deallocate(S168)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S169, 1.000)
       deallocate(S169)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S170, 1.000)
       deallocate(S170)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S171, 0.500)
       deallocate(S171)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S172, 0.500)
       deallocate(S172)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X11,S173, 1.000)
       deallocate(S173)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N2,X12,S174, 1.000)
       deallocate(S174)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N2,X13,S175, 1.000)
       deallocate(S175)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N2,X14,S176, 1.000)
       deallocate(S176)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S178, 1.000)
       deallocate(S178)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S179, 0.500)
       deallocate(S179)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S180, 0.500)
       deallocate(S180)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,N0,M1,X15,S181, 1.000)
       deallocate(S181)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,N0,M1,X16,S182, 1.000)
       deallocate(S182)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,N0,M1,X17,S183, 1.000)
       deallocate(S183)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,N0,M1,X18,S184, 1.000)
       deallocate(S184)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S185, 1.000)
       deallocate(S185)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S186,-1.000)
       deallocate(S186)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S187, 1.000)
       deallocate(S187)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S188,-1.000)
       deallocate(S188)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S189, 1.000)
       deallocate(S189)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,N0,M1,X4,S190,-1.000)
       deallocate(S190)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S191, 1.000)
       deallocate(S191)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S192,-1.000)
       deallocate(S192)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S193, 1.000)
       deallocate(S193)
C
...
C
       call
     & sum3412(M1,N2,N0,M1,M1,N2,M1,N1,X30,S194, 1.000)
       deallocate(S194)
C
...
C
       call
     & sum3412(N0,M1,M1,N1,M1,N2,M1,N1,X31,S195, 1.000)
       deallocate(S195)
C
...
C
       call
     & sum3412(M1,N2,M1,N1,M1,N2,M1,N1,X32,S196, 1.000)
       deallocate(S196)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S197,-1.000)
       deallocate(S197)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S198,-1.000)
       deallocate(S198)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S199,-1.000)
       deallocate(S199)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S200,-1.000)
       deallocate(S200)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S201, 1.000)
       deallocate(S201)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S202, 1.000)
       deallocate(S202)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S203, 1.000)
       deallocate(S203)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S204, 1.000)
       deallocate(S204)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X6,S205,-1.000)
       deallocate(S205)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X6,S206,-1.000)
       deallocate(S206)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X6,S207,-1.000)
       deallocate(S207)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X6,S208,-1.000)
       deallocate(S208)
C
...
C
       call
     & sum3412(N0,M1,N0,M1,N0,M1,M1,N1,X33,S209, 1.000)
       deallocate(S209)
C
       allocate(D1(N2+1:N3,N1+1:N3,M1+1:N2,N0+1:M1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N2,N0,M1,N0,M1,M1,N1,X34,S210, 1.000)
       deallocate(S210)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:M1,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,M1,N1,N0,M1,M1,N1,X35,S211, 1.000)
       deallocate(S211)
C
       allocate(D1(N2+1:N3,N1+1:N3,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N2,M1,N1,N0,M1,M1,N1,X36,S212, 1.000)
       deallocate(S212)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S213, 1.000)
       deallocate(S213)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S214, 1.000)
       deallocate(S214)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S215,-1.000)
       deallocate(S215)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S216,-1.000)
       deallocate(S216)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S217, 1.000)
       deallocate(S217)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S218, 1.000)
       deallocate(S218)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X61,S219,-1.000)
       deallocate(S219)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N1,X62,S220,-1.000)
       deallocate(S220)
C
...
C
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N1,X63,S221,-1.000)
       deallocate(S221)
C
...
C
       call
     & sum3412(M1,N1,N2,M2,M2,N3,M1,N1,X64,S222,-1.000)
       deallocate(S222)
C
...
C
       ...
       X28=0.0d0
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N1,X28,S223,-1.000)
       deallocate(S223)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z28,-1.000)
       deallocate(Z28)
       deallocate(X28)
C
...
C
       ...
       X29=0.0d0
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X29,S224,-1.000)
       deallocate(S224)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z29,-1.000)
       deallocate(Z29)
       deallocate(X29)
C
...
C
       call
     & sum21(N0,M1,M1,N1,X19,Q31, 1.000)
       deallocate(Q31)
C
...
C
       call
     & sum21(M1,N1,M1,N1,X20,Q32, 1.000)
       deallocate(Q32)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S225,-1.000)
       deallocate(S225)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S226, 1.000)
       deallocate(S226)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S227, 1.000)
       deallocate(S227)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S228,-1.000)
       deallocate(S228)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S229,-1.000)
       deallocate(S229)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S230, 1.000)
       deallocate(S230)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M2,N3,M2,N3,M1,N2,S231,D1)
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z327,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z327, 1.000)
       deallocate(Z327)
       deallocate(S231)
C
...
C
     ...
     & M1,N2,M2,N3,M2,N3,M1,N2,S232,D1)
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z328, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z328,-1.000)
       deallocate(Z328)
       deallocate(S232)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M1,N2,S233,D1)
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z329, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z329,-1.000)
       deallocate(Z329)
       deallocate(S233)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M1,N2,S234,D1)
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z330,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z330, 1.000)
       deallocate(Z330)
       deallocate(S234)
C
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N2,X65,S235, 1.000)
       deallocate(S235)
C
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,M1,N2,X66,S236, 1.000)
       deallocate(S236)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X67,Q33, 1.000)
       deallocate(Q33)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X68,Q34, 1.000)
       deallocate(Q34)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S238,-1.000)
       deallocate(S238)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S239, 1.000)
       deallocate(S239)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S240, 1.000)
       deallocate(S240)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S241,-1.000)
       deallocate(S241)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S242,-1.000)
       deallocate(S242)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N0,M1,S243,D1)
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z341, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z341,-1.000)
       deallocate(Z341)
       deallocate(S243)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N0,M1,S244,D1)
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z342, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z342,-1.000)
       deallocate(Z342)
       deallocate(S244)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N0,M1,S245,D1)
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z343,-1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z343, 1.000)
       deallocate(Z343)
       deallocate(S245)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N0,M1,S246,D1)
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z344,-1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z344, 1.000)
       deallocate(Z344)
       deallocate(S246)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:M1,N1+1:M2))
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,N0,M1,X69,S247, 1.000)
       deallocate(S247)
C
       allocate(D1(N0+1:N1,N2+1:N3,M1+1:N2,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,N0,M1,X70,S248, 1.000)
       deallocate(S248)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N0+1:M1))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N2,M2,M2,N3,M2,N3,N1,M2,X45,S249, 1.000)
       deallocate(S249)
C
...
C
       call
     & sum3412(M2,N3,N1,M2,M2,N3,N1,M2,X46,S250, 1.000)
       deallocate(S250)
C
...
C
       call
     & sum3412(N2,M2,N1,M2,M2,N3,N1,M2,X47,S251, 1.000)
       deallocate(S251)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X73,Q37,-1.000)
       deallocate(Q37)
C
...
C
       call
     & sum21(N2,M2,M2,N3,X74,Q38,-1.000)
       deallocate(Q38)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S252, 1.000)
       deallocate(S252)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S253,-0.500)
       deallocate(S253)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X6,S254,-0.500)
       deallocate(S254)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X6,S255,-1.000)
       deallocate(S255)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X6,S256,-0.500)
       deallocate(S256)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S257, 1.000)
       deallocate(S257)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S258,-1.000)
       deallocate(S258)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S259,-0.500)
       deallocate(S259)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S260, 0.500)
       deallocate(S260)
C
...
C
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X79,S261, 1.000)
       deallocate(S261)
C
...
C
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X80,S262, 1.000)
       deallocate(S262)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S263,-1.000)
       deallocate(S263)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S264,-1.000)
       deallocate(S264)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S265,-1.000)
       deallocate(S265)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S266,-1.000)
       deallocate(S266)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S267,-1.000)
       deallocate(S267)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S268,-1.000)
       deallocate(S268)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S269,-1.000)
       deallocate(S269)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S270,-1.000)
       deallocate(S270)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S271, 1.000)
       deallocate(S271)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S272, 1.000)
       deallocate(S272)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S273, 1.000)
       deallocate(S273)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S274, 1.000)
       deallocate(S274)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S276, 1.000)
       deallocate(S276)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S277, 1.000)
       deallocate(S277)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S278, 1.000)
       deallocate(S278)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X11,S279, 1.000)
       deallocate(S279)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N2,X12,S280, 1.000)
       deallocate(S280)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N2,X13,S281, 1.000)
       deallocate(S281)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N2,X14,S282, 1.000)
       deallocate(S282)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S283, 1.000)
       deallocate(S283)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S284, 1.000)
       deallocate(S284)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S285, 1.000)
       deallocate(S285)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S286, 1.000)
       deallocate(S286)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S287, 1.000)
       deallocate(S287)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S288, 1.000)
       deallocate(S288)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S289, 1.000)
       deallocate(S289)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S290, 1.000)
       deallocate(S290)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,N0,M1,X15,S291, 1.000)
       deallocate(S291)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,N0,M1,X16,S292, 1.000)
       deallocate(S292)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,N0,M1,X17,S293, 1.000)
       deallocate(S293)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,N0,M1,X18,S294, 1.000)
       deallocate(S294)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S295, 0.500)
       deallocate(S295)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S296, 1.000)
       deallocate(S296)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S297, 0.500)
       deallocate(S297)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S298,-0.500)
       deallocate(S298)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S299,-1.000)
       deallocate(S299)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X10,S300,-0.500)
       deallocate(S300)
C
...
C
       call
     & sum3412(N0,M1,N0,M1,N0,M1,M1,N2,X48,S301, 0.500)
       deallocate(S301)
C
...
C
       call
     & sum3412(N0,M1,M1,N2,N0,M1,M1,N2,X49,S302, 0.500)
       deallocate(S302)
C
...
C
       call
     & sum3412(M1,N2,M1,N2,N0,M1,M1,N2,X50,S303, 0.500)
       deallocate(S303)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S304,-0.500)
       deallocate(S304)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S305, 0.500)
       deallocate(S305)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S306,-1.000)
       deallocate(S306)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S307, 1.000)
       deallocate(S307)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S308,-0.500)
       deallocate(S308)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S309, 0.500)
       deallocate(S309)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X51,S310,-1.000)
       deallocate(S310)
C
...
C
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N2,X52,S311,-1.000)
       deallocate(S311)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N2,X53,S312,-1.000)
       deallocate(S312)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,N2,M2,M2,N3,M1,N2,X54,S313,-1.000)
       deallocate(S313)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X22,Q40, 0.500)
       deallocate(Q40)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X23,Q41, 0.500)
       deallocate(Q41)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S314,-0.500)
       deallocate(S314)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S315,-0.500)
       deallocate(S315)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S316,-1.000)
       deallocate(S316)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S317,-1.000)
       deallocate(S317)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S318,-0.500)
       deallocate(S318)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S319,-0.500)
       deallocate(S319)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,N0,M1,X55,S320,-1.000)
       deallocate(S320)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,M2,N3,M2,N3,N0,M1,X56,S321,-1.000)
       deallocate(S321)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,N2,M2,M2,N3,N0,M1,X57,S322,-1.000)
       deallocate(S322)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,N2,M2,M2,N3,N0,M1,X58,S323,-1.000)
       deallocate(S323)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N0+1:M1))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum21(N0,M1,N0,M1,X24,Q42, 0.500)
       deallocate(Q42)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,M1+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum21(M1,N2,N0,M1,X25,Q43, 0.500)
       deallocate(Q43)
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U431)
       deallocate(D1)
       deallocate(F2)
C
       allocate(F1(N0+1:N2,N0+1:N2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder561234(N1,M2,N0,M1,M1,N2,M1,N1,N0,N2,N0,N2,
     & N0,N2,N0,N2,N1,M2,N0,M1,M1,N2,M1,N1,U431,F1)
       allocate(D2(N0+1:N2,N0+1:N2,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       ...
       I2=K6*K6
       I3=K2*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z432)
       deallocate(F1)
       deallocate(D2)
C
       V3C=V3C+0.250*Z432
...
C
       allocate(F1(N0+1:N2,N0+1:N2,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder651234(N1,M2,N0,M1,M1,N2,M1,N1,N0,N2,N0,N2,
     & N0,N2,N0,N2,N1,M2,N0,M1,M1,N2,M1,N1,U431,F1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,U541)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2,M1+1:N1))
       call reorder213456(M2,N3,N0,N2,N1,M2,N0,M1,M1,N2,M1,N1,
     & N0,N2,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,U541,F1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,Z542)
       deallocate(F1)
       deallocate(B2)
C
       V3C=V3C+0.500*Z542
...
C
       ...
       X60=0.0d0
       call
     & sum3412(N2,M2,N2,M2,M2,N3,M2,N3,X60,S325, 0.500)
       deallocate(S325)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X26,Q44,-0.500)
       deallocate(Q44)
C
...
C
       call
     & sum21(N2,M2,M2,N3,X27,Q45,-0.500)
       deallocate(Q45)
C
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S326,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S340,-1.000)
       deallocate(S340)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,M1,N2,
     & N0,N1,N0,N2,M1,N2,M1,N1,S326,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S327,-1.000)
       deallocate(S327)
C
...
C
     ...
     & N2,N3,N0,N1,M2,N3,M1,N1,S330,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N1,M2,N3,M1,N2,M1,N1,X1,S341, 1.000)
       deallocate(S341)
C
       allocate(D1(N2+1:N3,N0+1:N1,M2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N2,N3,M2,N3,
...
C
       call
     & sum3124(N0,N1,M2,N3,N0,M1,M1,N1,X2,S343, 1.000)
       deallocate(S343)
C
       allocate(D1(N0+1:N1,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N2,N3,M2,N3,
     & N0,N1,N2,N3,M2,N3,M1,N1,S330,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N2,N3,M2,N3,N1,M2,M1,N1,X10,S331,-1.000)
       deallocate(S331)
C
...
C
       call
     & sum21(N0,M1,M1,N1,X19,Q47, 1.000)
       deallocate(Q47)
C
...
C
       call
     & sum21(M1,N1,M1,N1,X20,Q49, 1.000)
       deallocate(Q49)
C
...
C
     ...
     & N0,N1,N0,M1,N2,M2,M1,N1,S336,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,N1,M2,M1,N1,X79,S337,-1.000)
       deallocate(S337)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z210, 1.000)
       deallocate(Z210)
       deallocate(X79)
C
...
C
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,S338,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,M1,N1,X80,S339,-1.000)
       deallocate(S339)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder531246(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z211,-1.000)
       deallocate(Z211)
       deallocate(X80)
C
...
C
     ...
     & N0,N2,N0,N1,N0,M1,M1,N1,S328,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,N0,M1,M1,N1,X2,S342,-1.000)
       deallocate(S342)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N0,M1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S328,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X9,S329,-1.000)
       deallocate(S329)
C
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N1,S332,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N1,X77,S333,-1.000)
       deallocate(S333)
C
       allocate(F2(N0+1:M1,N1+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder631245(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C3,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X77,F2,Z205)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z205, 1.000)
       deallocate(Z205)
       deallocate(X77)
C
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S334,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X78,S335,-1.000)
       deallocate(S335)
C
       allocate(F2(M1+1:N1,N1+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder631245(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C3,F2)
       ...
       I2=K8*K5*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X78,F2,Z206)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z206, 1.000)
       deallocate(Z206)
       deallocate(X78)
C
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S344,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S345, 1.000)
       deallocate(S345)
C
...
C
     ...
     & N0,N1,N1,N3,M2,N3,M1,N2,S346,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N1,N3,M2,N3,N1,M2,M1,N2,X3,S347,-1.000)
       deallocate(S347)
C
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,N0,M1,X4,S349, 1.000)
       deallocate(S349)
C
       allocate(D1(N2+1:N3,N0+1:N1,N1+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
     ...
     & N0,N1,N1,N3,M2,N3,N0,M1,S350,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N1,N3,M2,N3,N1,M2,N0,M1,X4,S351,-1.000)
       deallocate(S351)
C
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S352,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S418,-1.000)
       deallocate(S418)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S352,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S353,-1.000)
       deallocate(S353)
C
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S356,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S357, 1.000)
       deallocate(S357)
C
...
C
     ...
     & N2,N3,N0,N2,N1,M2,M1,N1,S358,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(N0,N2,N1,M2,N0,M1,M1,N1,X9,S360, 1.000)
       deallocate(S360)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N2,N3,N1,M2,
     & N0,N2,N2,N3,N1,M2,M1,N1,S358,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S361,-1.000)
       deallocate(S361)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,N1,M2,
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X8,S359, 1.000)
       deallocate(S359)
C
...
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,S362,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(M1,N2,N0,M1,N0,M1,M1,N1,X34,S370, 1.000)
       deallocate(S370)
C
...
C
       call
     & sum123546(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z34, 1.000)
       deallocate(Z34)
       deallocate(X34)
C
       allocate(D1(N2+1:N3,M1+1:N2,N0+1:M1,M1+1:N1))
...
C
       call
     & sum3124(M1,N2,N0,M1,M1,N2,M1,N1,X30,S363, 1.000)
       deallocate(S363)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,S366,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M1,N1,N0,M1,M1,N1,X36,S372, 1.000)
       deallocate(S372)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum123546(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z36, 1.000)
       deallocate(Z36)
       deallocate(X36)
C
       allocate(D1(N2+1:N3,M1+1:N2,M1+1:N1,M1+1:N1))
...
C
       call
     & sum3124(M1,N2,M1,N1,M1,N2,M1,N1,X32,S367, 1.000)
       deallocate(S367)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,S364,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M1,N1,N0,M1,M1,N1,X35,S371, 1.000)
       deallocate(S371)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum123546(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z35, 1.000)
       deallocate(Z35)
       deallocate(X35)
C
       allocate(D1(N2+1:N3,N0+1:M1,M1+1:N1,M1+1:N1))
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N2,M1,N1,X31,S365, 1.000)
       deallocate(S365)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N1,S368,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N0,M1,N0,M1,M1,N1,X33,S369, 1.000)
       deallocate(S369)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum123546(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z33, 1.000)
       deallocate(Z33)
       deallocate(X33)
C
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N1,S373,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N1,X61,S374,-1.000)
       deallocate(S374)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z90,-1.000)
       call
     & sum134526(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z90, 1.000)
       deallocate(Z90)
       deallocate(X61)
C
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,S375,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N1,X62,S376,-1.000)
       deallocate(S376)
C
       allocate(F2(M1+1:N1,M2+1:N3,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder612345(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z91,-1.000)
       call
     & sum134526(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z91, 1.000)
       deallocate(Z91)
       deallocate(X62)
C
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N1,S377,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N1,X63,S378,-1.000)
       deallocate(S378)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder621345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z92, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z92,-1.000)
       deallocate(Z92)
       deallocate(X63)
C
...
C
     ...
     & N0,N2,M1,N1,N2,M2,M1,N1,S379,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,N2,M2,M2,N3,M1,N1,X64,S380,-1.000)
       deallocate(S380)
C
       allocate(F2(M1+1:N1,N2+1:M2,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N2))
       call reorder621345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K9*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X64,F2,Z93)
       deallocate(F2)
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z93, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z93,-1.000)
       deallocate(Z93)
       deallocate(X64)
C
...
C
       call
     & sum21(N0,M1,M1,N1,X19,Q53, 1.000)
       deallocate(Q53)
C
...
C
       call
     & sum21(M1,N1,M1,N1,X20,Q55, 1.000)
       deallocate(Q55)
C
       call sumx21(N0,N1,N0,N1,
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N2,S381,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X65,S382, 1.000)
       deallocate(S382)
C
       allocate(F2(N0+1:M1,N1+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N1))
       call reorder431256(M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,
...
C
       call
     & sum124635(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z94,-1.000)
       deallocate(Z94)
       deallocate(X65)
C
...
C
     ...
     & N0,N1,M1,N2,N1,M2,M1,N2,S383,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X66,S384, 1.000)
       deallocate(S384)
C
       allocate(F2(M1+1:N2,N1+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N1))
       call reorder531246(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum124635(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z95, 1.000)
       deallocate(Z95)
       deallocate(X66)
C
...
C
       call
     & sum21(N0,M1,N0,M1,X71,Q60, 1.000)
       deallocate(Q60)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6*K6
       I3=K5
       call DMATMAT(I1,I2,I3,X71,F2,Z100)
       deallocate(F2)
C
       call
     & sum123564(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z100,-1.000)
       deallocate(Z100)
       deallocate(X71)
C
       allocate(B1(N2+1:N3,N0+1:M1))
...
C
       call
     & sum21(N0,M1,M1,N2,X67,Q57, 1.000)
       deallocate(Q57)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C2,F2)
       ...
       I2=K7*K5*K9*K6*K6
       I3=K5
       call DMATMAT(I1,I2,I3,X67,F2,Z96)
       deallocate(F2)
C
       call
     & sum123465(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z96, 1.000)
       deallocate(Z96)
       deallocate(X67)
C
       allocate(D1(N2+1:N3,N0+1:M1,N0+1:N1,N1+1:M2))
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,N0,M1,X69,S386, 1.000)
       deallocate(S386)
C
       allocate(F2(N0+1:M1,N1+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder431256(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X69,F2,Z98)
       deallocate(F2)
C
       call
     & sum125634(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z98, 1.000)
       deallocate(Z98)
       deallocate(X69)
C
       allocate(D1(N2+1:N3,M1+1:N2,N0+1:N1,N1+1:M2))
...
C
     ...
     & N0,N1,M1,N2,N1,M2,N0,M1,S387,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,N0,M1,X70,S388, 1.000)
       deallocate(S388)
C
       allocate(F2(M1+1:N2,N1+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder431256(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,N1,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X70,F2,Z99)
       deallocate(F2)
C
       call
     & sum125634(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z99, 1.000)
       deallocate(Z99)
       deallocate(X70)
C
...
C
       call
     & sum21(M1,N2,N0,M1,X72,Q61, 1.000)
       deallocate(Q61)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum123564(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z101,-1.000)
       deallocate(Z101)
       deallocate(X72)
C
       allocate(B1(N2+1:N3,M1+1:N2))
...
C
       call
     & sum21(M1,N2,M1,N2,X68,Q59, 1.000)
       deallocate(Q59)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder512346(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3C3,F2)
       ...
       I2=K7*K5*K9*K6*K6
       I3=K8
       call DMATMAT(I1,I2,I3,X68,F2,Z97)
       deallocate(F2)
C
       call
     & sum123465(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z97,-1.000)
       deallocate(Z97)
       deallocate(X68)
C
...
C
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,S389,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,M2,M2,N3,M2,N3,N1,M2,X45,S390, 1.000)
       deallocate(S390)
C
...
C
       call
     & sum245613(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z45,-1.000)
       call
     & sum145623(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z45, 1.000)
       deallocate(Z45)
       deallocate(X45)
C
...
C
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,S391,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M2,N3,N1,M2,M2,N3,N1,M2,X46,S392, 1.000)
       deallocate(S392)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
...
C
       call
     & sum245613(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z46, 1.000)
       call
     & sum145623(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z46,-1.000)
       deallocate(Z46)
       deallocate(X46)
C
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,S393,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,M2,N1,M2,M2,N3,N1,M2,X47,S394, 1.000)
       deallocate(S394)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
...
C
       call
     & sum245613(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z47,-1.000)
       call
     & sum145623(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z47, 1.000)
       deallocate(Z47)
       deallocate(X47)
C
...
C
       call
     & sum234561(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z105, 1.000)
       call
     & sum134562(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z105,-1.000)
       deallocate(Z105)
       deallocate(X73)
C
...
C
       call
     & sum234561(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z106,-1.000)
       call
     & sum134562(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z106, 1.000)
       deallocate(Z106)
       deallocate(X74)
C
...
C
       call
     & sum124563(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z21, 1.000)
       deallocate(Z21)
       deallocate(X21)
C
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N2,M1,N1,X1,S397, 1.000)
       deallocate(S397)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N1,N0,N1,N1,N3,
...
C
       call
     & sum2314(N0,N1,M2,N3,N0,M1,M1,N1,X2,S396, 1.000)
       deallocate(S396)
C
...
C
     ...
     & N0,N1,N1,N3,N1,N3,N1,M2,S398,D1)
       allocate(D2(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,M1,N2,X3,S401,-1.000)
       deallocate(S401)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder2341(N1,M2,N0,N1,N1,N3,N1,N3,
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,N0,M1,X4,S399,-1.000)
       deallocate(S399)
C
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S402)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S402, 1.000)
       deallocate(S402)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S400)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S400, 1.000)
       deallocate(S400)
C
...
C
     ...
     & N0,N1,N2,N3,N0,N2,M1,N1,S403,D1)
       allocate(D2(N0+1:N1,N2+1:N3,N1+1:M2,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X8,S405,-1.000)
       deallocate(S405)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S403,D1)
       allocate(D2(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N2,M1,N1,X1,S406, 1.000)
       deallocate(S406)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
       call
     & sum2314(N0,N2,N1,M2,N0,M1,M1,N1,X9,S407,-1.000)
       deallocate(S407)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,M1,N1,S403,D1)
       allocate(D2(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,N1,M2,t2B,D2)
...
C
       call
     & sum2314(N2,N3,M2,N3,N1,M2,M1,N1,X10,S408, 1.000)
       deallocate(S408)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N2,N0,N1,N2,N3,
     & N2,N3,N0,N2,N0,N1,M1,N1,S403,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S524,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S525,-1.000)
       deallocate(S525)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,M1,N1,S403,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,S528,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S529, 1.000)
       deallocate(S529)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
     ...
     & N0,N1,N0,N2,N0,M1,M1,N1,S526,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X9,S527,-1.000)
       deallocate(S527)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
       call
     & sum2314(N0,N1,M2,N3,N0,M1,M1,N1,X2,S404, 1.000)
       deallocate(S404)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S524,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S530,-1.000)
       deallocate(S530)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S526,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,N0,M1,M1,N1,X2,S531,-1.000)
       deallocate(S531)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S417,-1.000)
       deallocate(S417)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S412, 1.000)
       deallocate(S412)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
...
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,M1+1:N1))
       call reorder2314(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,N0,M1,M1,N1,S354,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,N0,M1,M1,N1,X2,S419,-1.000)
       deallocate(S419)
C
       allocate(D1(N0+1:N1,N0+1:N2,N0+1:M1,M1+1:N1))
       call reorder3214(N0,M1,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,N0,M1,M1,N1,S354,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N0,N2,N1,M2,N0,M1,M1,N1,X9,S355,-1.000)
       deallocate(S355)
C
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S420,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S421,-1.000)
       deallocate(S421)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:N3,N1+1:M2))
       call reorder1324(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,N0,M1,X4,S423,-1.000)
       deallocate(S423)
C
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S424,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X5,S425,-1.000)
       deallocate(S425)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N2,S426,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N2,X6,S427, 1.000)
       deallocate(S427)
C
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S428,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X5,S429, 1.000)
       deallocate(S429)
C
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N2,S430,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,N3,M2,N3,M2,N3,M1,N2,X75,S432, 1.000)
       deallocate(S432)
C
       allocate(D1(N2+1:N3,N0+1:N2,M2+1:N3,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N2,N3,M2,N3,
     & N2,N3,N0,N2,M2,N3,M1,N2,S430,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(N0,N2,M2,N3,N0,M1,M1,N2,X5,S431, 1.000)
       deallocate(S431)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder4312(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,S433,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,N0,M1,X7,S434, 1.000)
       deallocate(S434)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,S435,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,N3,M2,N3,M2,N3,N0,M1,X76,S436,-1.000)
       deallocate(S436)
C
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,S437,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X11,S438,-1.000)
       deallocate(S438)
C
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z11,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z11, 1.000)
       deallocate(Z11)
       deallocate(X11)
C
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N2,S439,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N2,X12,S440,-1.000)
       deallocate(S440)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z12,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z12, 1.000)
       deallocate(Z12)
       deallocate(X12)
C
...
C
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,S441,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X13,S442,-1.000)
       deallocate(S442)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z13,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z13, 1.000)
       deallocate(Z13)
       deallocate(X13)
C
...
C
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,S443,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,N1,M2,M2,N3,M1,N2,X14,S444,-1.000)
       deallocate(S444)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z14,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z14, 1.000)
       deallocate(Z14)
       deallocate(X14)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
...
C
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,S445,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,N0,M1,X15,S446,-1.000)
       deallocate(S446)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z15, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z15,-1.000)
       deallocate(Z15)
       deallocate(X15)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N1,M2+1:N3))
...
C
     ...
     & N0,N2,M1,N1,M2,N3,N0,M1,S447,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,N0,M1,X16,S448,-1.000)
       deallocate(S448)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z16, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z16,-1.000)
       deallocate(Z16)
       deallocate(X16)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,N1+1:M2))
...
C
     ...
     & N0,N2,N0,M1,N1,M2,N0,M1,S449,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,N0,M1,X17,S450,-1.000)
       deallocate(S450)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z17, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z17,-1.000)
       deallocate(Z17)
       deallocate(X17)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N1,N1+1:M2))
...
C
     ...
     & N0,N2,M1,N1,N1,M2,N0,M1,S451,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,N1,M2,M2,N3,N0,M1,X18,S452,-1.000)
       deallocate(S452)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z18, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z18,-1.000)
       deallocate(Z18)
       deallocate(X18)
C
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N2,S453,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N0,M1,N0,M1,M1,N2,X48,S454, 1.000)
       deallocate(S454)
C
...
C
       call
     & sum123645(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z48, 0.500)
       deallocate(Z48)
       deallocate(X48)
C
...
C
     ...
     & N2,N3,N0,M1,M1,N2,M1,N2,S455,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M1,N2,N0,M1,M1,N2,X49,S456, 1.000)
       deallocate(S456)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
...
C
       call
     & sum123645(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z49, 1.000)
       deallocate(Z49)
       deallocate(X49)
C
...
C
     ...
     & N2,N3,M1,N2,M1,N2,M1,N2,S457,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M1,N2,N0,M1,M1,N2,X50,S458, 1.000)
       deallocate(S458)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
...
C
       call
     & sum123645(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z50, 0.500)
       deallocate(Z50)
       deallocate(X50)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,M1,N2,S459,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X51,S460, 1.000)
       deallocate(S460)
C
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z51, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z51,-1.000)
       deallocate(Z51)
       deallocate(X51)
C
...
C
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,S461,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X52,S462, 1.000)
       deallocate(S462)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z52,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z52, 1.000)
       deallocate(Z52)
       deallocate(X52)
C
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,S463,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N2,X53,S464, 1.000)
       deallocate(S464)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z53,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z53, 1.000)
       deallocate(Z53)
       deallocate(X53)
C
...
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,S465,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N2,N2,M2,M2,N3,M1,N2,X54,S466, 1.000)
       deallocate(S466)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum234615(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z54, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z54,-1.000)
       deallocate(Z54)
       deallocate(X54)
C
...
C
       call
     & sum21(N0,M1,N0,M1,X24,Q74, 1.000)
       deallocate(Q74)
C
...
C
       call
     & sum123564(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z24,-1.000)
       deallocate(Z24)
       deallocate(X24)
C
       allocate(B1(N2+1:N3,N0+1:M1))
...
C
       call
     & sum21(N0,M1,M1,N2,X22,Q71, 1.000)
       deallocate(Q71)
C
       call sumx21(N0,N2,N0,N2,
...
C
       call
     & sum123465(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z22, 1.000)
       deallocate(Z22)
       deallocate(X22)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,N0,M1,S467,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,N0,M1,X55,S468, 1.000)
       deallocate(S468)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z55,-1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z55, 1.000)
       deallocate(Z55)
       deallocate(X55)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N2,M2+1:N3))
...
C
     ...
     & N0,N2,M1,N2,M2,N3,N0,M1,S469,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,N0,M1,X56,S470, 1.000)
       deallocate(S470)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z56,-1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z56, 1.000)
       deallocate(Z56)
       deallocate(X56)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,N2+1:M2))
...
C
     ...
     & N0,N2,N0,M1,N2,M2,N0,M1,S471,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,N0,M1,X57,S472, 1.000)
       deallocate(S472)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z57, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z57,-1.000)
       deallocate(Z57)
       deallocate(X57)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N2,N2+1:M2))
...
C
     ...
     & N0,N2,M1,N2,N2,M2,N0,M1,S473,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N2,N2,M2,M2,N3,N0,M1,X58,S474, 1.000)
       deallocate(S474)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z58, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z58,-1.000)
       deallocate(Z58)
       deallocate(X58)
C
...
C
       call
     & sum21(M1,N2,N0,M1,X25,Q75, 1.000)
       deallocate(Q75)
C
       call sumx21(N0,N2,N0,N2,
...
C
       call
     & sum123564(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z25,-1.000)
       deallocate(Z25)
       deallocate(X25)
C
       allocate(B1(N2+1:N3,M1+1:N2))
...
C
       call
     & sum21(M1,N2,M1,N2,X23,Q73, 1.000)
       deallocate(Q73)
C
       call sumx21(N0,N2,N0,N2,
...
C
       call
     & sum123465(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z23,-1.000)
       deallocate(Z23)
       deallocate(X23)
C
...
C
       ...
       X59=0.0d0
       call
     & sum3412(M2,N3,N2,M2,M2,N3,M2,N3,X59,S324, 0.500)
       deallocate(S324)
C
       allocate(D1(N0+1:N2,N0+1:N2,M2+1:N3,N2+1:M2))
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M2,N3,S475,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M2,N3,N2,M2,M2,N3,M2,N3,X59,S476, 1.000)
       deallocate(S476)
C
...
C
       call
     & sum345612(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z59, 1.000)
       deallocate(Z59)
       deallocate(X59)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:M2,N2+1:M2))
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M2,N3,S477,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,M2,N2,M2,M2,N3,M2,N3,X60,S478, 1.000)
       deallocate(S478)
C
       call sumx3412(N2,N3,N2,N3,N2,N3,N2,M2,
...
C
       call
     & sum345612(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z60, 0.500)
       deallocate(Z60)
       deallocate(X60)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X26,Q77,-1.000)
       deallocate(Q77)
C
...
C
       call
     & sum234561(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z26, 1.000)
       call
     & sum134562(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z26,-1.000)
       deallocate(Z26)
       deallocate(X26)
C
...
C
       call
     & sum21(N2,M2,M2,N3,X27,Q79,-1.000)
       deallocate(Q79)
C
       call sumx12(N2,N3,N2,N3,
...
C
       call
     & sum234561(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z27,-1.000)
       call
     & sum134562(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z27, 1.000)
       deallocate(Z27)
       deallocate(X27)
C
...
C
     ...
     & N0,N2,N0,N1,N1,N3,M1,N2,S479,D1)
       allocate(D2(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,N1,M2,t2B,D2)
...
C
       call
     & sum2314(N1,N3,M2,N3,N1,M2,M1,N2,X3,S485, 1.000)
       deallocate(S485)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S479,D1)
       allocate(D2(N0+1:N1,N1+1:N3,M2+1:N3,N0+1:M1))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
...
C
       call
     & sum2314(N0,N2,M2,N3,N0,M1,M1,N2,X5,S486, 1.000)
       deallocate(S486)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,M1+1:N2))
       call reorder2431(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N2,N1,N3,N0,N1,M1,N2,S479,D1)
       allocate(D2(N0+1:N2,N1+1:N3,M2+1:N3,M1+1:N1))
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,M2,N3,M1,N1,t2B,D2)
...
C
       call
     & sum2413(N0,N1,M2,N3,M1,N2,M1,N1,X1,S487,-1.000)
       deallocate(S487)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X8,S480, 1.000)
       deallocate(S480)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S483,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S484,-1.000)
       deallocate(S484)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,N1+1:N3))
       call reorder1342(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N0,N1,N1,N3,N0,M1,S481,D1)
       allocate(D2(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,N1,M2,t2B,D2)
...
C
       call
     & sum2314(N1,N3,M2,N3,N1,M2,N0,M1,X4,S488, 1.000)
       deallocate(S488)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,N0,M1,S481,D1)
       allocate(D2(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
...
C
       call
     & sum2413(N0,N2,M2,N3,N0,M1,M1,N2,X5,S496,-1.000)
       deallocate(S496)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,N0+1:M1))
       call reorder2431(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N2,N1,N3,N0,N1,N0,M1,S481,D1)
       allocate(D2(N0+1:N2,N1+1:N3,M2+1:N3,M1+1:N1))
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,M2,N3,M1,N1,t2B,D2)
...
C
       call
     & sum2413(N0,N1,M2,N3,N0,M1,M1,N1,X2,S497,-1.000)
       deallocate(S497)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N1,N3,
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X9,S482, 1.000)
       deallocate(S482)
C
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S493,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S494,-1.000)
       deallocate(S494)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,N0,M1,M1,N1,X2,S504, 1.000)
       deallocate(S504)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X1,S495, 1.000)
       deallocate(S495)
C
...
C
       call
     & sum234156(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z1, 1.000)
       call
     & sum134256(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z1,-1.000)
       deallocate(Z1)
       deallocate(X1)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,S491,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,N0,M1,X76,S492, 1.000)
       deallocate(S492)
C
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S498,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S499, 1.000)
       deallocate(S499)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N2,S500,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N2,X75,S501, 1.000)
       deallocate(S501)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N0+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N0,N1,N0,M1,M1,N1,S502,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,N0,M1,M1,N1,X2,S503,-1.000)
       deallocate(S503)
C
       call sumx2134(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum235146(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z2,-1.000)
       call
     & sum135246(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z2, 1.000)
       deallocate(Z2)
       deallocate(X2)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,N1+1:N3))
...
C
     ...
     & N0,N2,N1,N3,N1,M2,N0,M1,S489,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,N0,M1,X4,S490, 1.000)
       deallocate(S490)
C
...
C
     ...
     & N0,N2,N2,N3,N0,N2,M1,N2,S505,D1)
       allocate(D2(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
...
C
       call
     & sum2314(N0,N2,M2,N3,N0,M1,M1,N2,X5,S507,-1.000)
       deallocate(S507)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X8,S508, 1.000)
       deallocate(S508)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,M1+1:N2))
       call reorder4231(M1,N2,N0,N2,N0,N2,N2,N3,
     & N2,N3,N0,N2,N0,N2,M1,N2,S505,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
...
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
       call reorder2314(N0,M1,N0,N2,N0,N2,M1,N2,
     & N0,N2,N0,N2,N0,M1,M1,N2,S536,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X5,S537, 1.000)
       deallocate(S537)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N0,N2,N2,N3,
     & N0,N2,N0,N2,N2,N3,M1,N2,S505,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder2314(M2,N3,N0,N2,N2,N3,M1,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,S538,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N2,X6,S539,-1.000)
       deallocate(S539)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
...
C
       call
     & sum2314(N2,N3,M2,N3,M2,N3,M1,N2,X6,S506,-0.500)
       deallocate(S506)
C
...
C
       call
     & sum346125(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z6, 1.000)
       deallocate(Z6)
       deallocate(X6)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,M1,N1,X9,S518, 1.000)
       deallocate(S518)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S523)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X5,S523,-1.000)
       deallocate(S523)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S513, 1.000)
       deallocate(S513)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder3412(M2,N3,M1,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,M2,N3,M1,N2,S516,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N2,X75,S517,-1.000)
       deallocate(S517)
C
       allocate(D2(N2+1:N3,N1+1:M2,N0+1:M1,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,X75,D2,Z121)
       deallocate(D2)
C
       call
     & sum346125(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z121,-1.000)
       call
     & sum346215(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z121, 1.000)
       deallocate(Z121)
       deallocate(X75)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,N2+1:N3))
...
C
     ...
     & N0,N2,N2,N3,N0,N2,N0,M1,S509,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
...
C
       call
     & sum2413(N0,N2,N1,M2,N0,M1,M1,N1,X9,S515, 1.000)
       deallocate(S515)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,N2,N2,N3,
     & N0,N2,N0,N2,N2,N3,N0,M1,S509,D1)
       allocate(D2(N0+1:N2,N0+1:N2,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
...
C
       call
     & sum2314(N2,N3,M2,N3,M2,N3,N0,M1,X7,S510,-0.500)
       deallocate(S510)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder2314(M2,N3,N0,N2,N2,N3,N0,M1,
     & N0,N2,N2,N3,M2,N3,N0,M1,S540,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,N0,M1,X7,S541,-1.000)
       deallocate(S541)
C
       call sumx2314(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum356124(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z7,-1.000)
       deallocate(Z7)
       deallocate(X7)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
...
C
       call
     & sum2413(N0,N2,M2,N3,N0,M1,M1,N2,X5,S514, 1.000)
       deallocate(S514)
C
...
C
     ...
     & N2,N3,N1,N3,N0,N2,N1,M2,S409,D1)
       allocate(D2(N2+1:N3,N1+1:N3,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
...
C
       call
     & sum3412(N0,N2,N1,M2,M1,N2,M1,N1,X8,S411,-1.000)
       deallocate(S411)
C
...
C
       call
     & sum124356(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z8, 1.000)
       deallocate(Z8)
       deallocate(X8)
C
       allocate(D1(N0+1:N2,N1+1:N3,N2+1:N3,N1+1:M2))
       call reorder2431(N1,M2,N0,N2,N2,N3,N1,N3,
     & N0,N2,N1,N3,N2,N3,N1,M2,S409,D1)
       allocate(D2(N0+1:N2,N1+1:N3,M2+1:N3,M1+1:N1))
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,M2,N3,M1,N1,t2B,D2)
...
C
       call
     & sum2413(N2,N3,M2,N3,N1,M2,M1,N1,X10,S416, 1.000)
       deallocate(S416)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,N2,N3,N1,N3,
     & N0,N2,N2,N3,N1,N3,N1,M2,S409,D1)
       allocate(D2(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,M1,N2,X3,S413,-1.000)
       deallocate(S413)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:M2))
       call reorder3421(N1,M2,N0,N2,N2,N3,N1,N3,
...
C
       call
     & sum3412(N0,N2,N1,M2,N0,M1,M1,N1,X9,S414,-1.000)
       deallocate(S414)
C
       call sumx1234(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum125346(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z9,-1.000)
       deallocate(Z9)
       deallocate(X9)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:N3,N1+1:M2))
       call reorder3241(N1,M2,N0,N2,N2,N3,N1,N3,
     & N2,N3,N0,N2,N1,N3,N1,M2,S409,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N1,N3,N1,M2,
     & N0,N2,N1,N3,N1,M2,M1,N2,S532,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S533, 1.000)
       deallocate(S533)
C
...
C
       call
     & sum246135(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z3,-1.000)
       call
     & sum146235(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z3, 1.000)
       deallocate(Z3)
       deallocate(X3)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:N3,N1+1:M2))
...
C
       allocate(D1(N0+1:N2,N1+1:N3,N1+1:M2,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N1,N3,N1,M2,
     & N0,N2,N1,N3,N1,M2,N0,M1,S534,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,N0,M1,X4,S535, 1.000)
       deallocate(S535)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder2341(N1,M2,N0,N2,N2,N3,N1,N3,
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,N0,M1,X4,S410,-1.000)
       deallocate(S410)
C
       call sumx2341(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum256134(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z4, 1.000)
       call
     & sum156234(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z4,-1.000)
       deallocate(Z4)
       deallocate(X4)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S521,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S522,-1.000)
       deallocate(S522)
C
...
C
       call
     & sum245136(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z10, 1.000)
       call
     & sum145236(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z10,-1.000)
       deallocate(Z10)
       deallocate(X10)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder3412(M2,N3,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,M2,N3,N0,M1,S511,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,N0,M1,X76,S512,-1.000)
       deallocate(S512)
C
       allocate(D2(N2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum356124(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z123, 1.000)
       call
     & sum356214(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z123,-1.000)
       deallocate(Z123)
       deallocate(X76)
C
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S519,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X5,S520,-0.500)
       deallocate(S520)
C
...
C
       call
     & sum236145(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z5,-1.000)
       call
     & sum136245(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z5, 1.000)
       deallocate(Z5)
       deallocate(X5)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z61, 1.000)
       deallocate(Z61)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,M1,N1,V3C,Z62,-1.000)
       deallocate(Z62)
C
