       subroutine t3D110100_update(N0,N1,N2,N3,HT3D,shift,
...
C
       ...
       real*8,allocatable::U336(:,:,:,:,:,:)
       real*8,allocatable::U409(:,:,:,:,:,:)
...
C
       allocate(V3D(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       V3D=0.0d0
C
...
C
     ...
     & N2,N3,M1,N2,t1B,B2)
       ...
       deallocate(B2)
C
       allocate(X56(N0+1:N2,M2+1:N3,M1+1:N2,M1+1:N2))
       X56=0.0d0
       call
     & sum3124(N0,N2,M2,N3,M1,N2,M1,N2,X56,S3, 1.000)
       deallocate(S3)
C
     ...
     & N2,N3,M1,N2,t1B,B2)
       ...
       deallocate(B2)
C
       allocate(X57(N0+1:N2,N2+1:M2,M1+1:N2,M1+1:N2))
       X57=0.0d0
       call
     & sum3124(N0,N2,N2,M2,M1,N2,M1,N2,X57,S4, 1.000)
       deallocate(S4)
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,VCHHHH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S5(M2+1:N3,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K6
       I3=K2
...
C
       ...
       X3=0.0d0
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X3,S5,-1.000)
       deallocate(S5)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
       call reorder4312(N0,N2,N0,N2,N0,N2,N0,N2,
...
C
       ...
       X4=0.0d0
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X4,S6, 1.000)
       deallocate(S6)
C
       allocate(D1(N2+1:N3,N0+1:N2,M2+1:N3,M1+1:N2))
       call reorder1432(N2,N3,N0,N2,N2,N3,N0,N2,
     & N2,N3,N0,N2,M2,N3,M1,N2,VCHPHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S7(N0+1:M1,N0+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,M2,N3,N0,M1,M1,N2,X3,S7, 1.000)
       deallocate(S7)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:M2,M1+1:N2))
       call reorder1432(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum3124(N0,N2,N2,M2,N0,M1,M1,N2,X4,S8, 1.000)
       deallocate(S8)
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N2,VCHPHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S9(M2+1:N3,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X58(N2+1:N3,M2+1:N3,M2+1:N3,M1+1:N2))
       X58=0.0d0
       call
     & sum3124(N2,N3,M2,N3,M2,N3,M1,N2,X58,S9, 1.000)
       deallocate(S9)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder4132(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,VCHPHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S10(N2+1:M2,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X6(N2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2))
       X6=0.0d0
       call
     & sum3124(N2,N3,M2,N3,N2,M2,M1,N2,X6,S10,-1.000)
       deallocate(S10)
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,VCHPHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S11(M2+1:N3,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,M1,N2,X6,S11, 1.000)
       deallocate(S11)
C
     ...
     & N2,N3,N0,N2,M2,N3,N0,M1,VCHPHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S12(M1+1:N2,N0+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K2
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,N2,M2,N3,N0,M1,M1,N2,X3,S12,-1.000)
       deallocate(S12)
C
...
C
       call
     & sum4123(N0,N2,N2,M2,N0,M1,M1,N2,X4,S13,-1.000)
       deallocate(S13)
C
...
C
       call
     & sum4123(N2,N3,M2,N3,N2,M2,M1,N2,X6,S14,-1.000)
       deallocate(S14)
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       allocate(X59(N2+1:N3,M2+1:N3,M2+1:N3,N0+1:M1))
       X59=0.0d0
       call
     & sum3124(N2,N3,M2,N3,M2,N3,N0,M1,X59,S15, 1.000)
       deallocate(S15)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder4132(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S19(M2+1:N3,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X9(N0+1:M1,M2+1:N3,M2+1:N3,M1+1:N2))
       X9=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X9,S19,-1.000)
       deallocate(S19)
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S20(M2+1:N3,M1+1:N1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K7
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X10(M1+1:N1,M2+1:N3,M2+1:N3,M1+1:N2))
       X10=0.0d0
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N2,X10,S20,-1.000)
       deallocate(S20)
C
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S21(M2+1:N3,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X11(N0+1:M1,N1+1:M2,M2+1:N3,M1+1:N2))
       X11=0.0d0
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X11,S21,-1.000)
       deallocate(S21)
C
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S22(M2+1:N3,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K7
       I2=K6
       I3=K2
...
C
       ...
       X12=0.0d0
       call
     & sum3124(M1,N1,N1,M2,M2,N3,M1,N2,X12,S22,-1.000)
       deallocate(S22)
C
       allocate(D1(N0+1:N2,N0+1:M1,N1+1:M2,M1+1:N2))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,M1,N1,M2,M1,N2,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S23(N2+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K0
       I3=K2
...
C
       ...
       X13=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N2,M2,M1,N2,X13,S23,-1.000)
       deallocate(S23)
C
       allocate(D1(N0+1:N2,M1+1:N1,N1+1:M2,M1+1:N2))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X14=0.0d0
       call
     & sum3124(M1,N1,N1,M2,N2,M2,M1,N2,X14,S24,-1.000)
       deallocate(S24)
C
     ...
     & N2,N3,N0,M1,M2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S25(M1+1:N2,N0+1:M1,M2+1:N3,M2+1:N3))
       I1=K6*K6*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N2,X9,S25, 1.000)
       deallocate(S25)
C
     ...
     & N2,N3,M1,N1,M2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S26(M1+1:N2,M1+1:N1,M2+1:N3,M2+1:N3))
       I1=K6*K6*K7
       I2=K8
       I3=K4
...
C
       call
     & sum4123(M1,N1,M2,N3,M2,N3,M1,N2,X10,S26, 1.000)
       deallocate(S26)
C
     ...
     & N2,N3,N0,M1,N1,M2,M2,N3,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S27(M1+1:N2,N0+1:M1,N1+1:M2,M2+1:N3))
       I1=K6*K9*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,N1,M2,M2,N3,M1,N2,X11,S27, 1.000)
       deallocate(S27)
C
     ...
     & N2,N3,M1,N1,N1,M2,M2,N3,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S28(M1+1:N2,M1+1:N1,N1+1:M2,M2+1:N3))
       I1=K6*K9*K7
       I2=K8
       I3=K4
...
C
       call
     & sum4123(M1,N1,N1,M2,M2,N3,M1,N2,X12,S28, 1.000)
       deallocate(S28)
C
     ...
     & N2,N3,N0,M1,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S29(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:M2))
       I1=K0*K9*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,N1,M2,N2,M2,M1,N2,X13,S29, 1.000)
       deallocate(S29)
C
...
C
       call
     & sum4123(M1,N1,N1,M2,N2,M2,M1,N2,X14,S30, 1.000)
       deallocate(S30)
C
...
C
       ...
       X15=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,N0,M1,X15,S31,-1.000)
       deallocate(S31)
C
...
C
       ...
       X16=0.0d0
       call
     & sum3124(M1,N1,M2,N3,M2,N3,N0,M1,X16,S32,-1.000)
       deallocate(S32)
C
...
C
       ...
       X17=0.0d0
       call
     & sum3124(N0,M1,N1,M2,M2,N3,N0,M1,X17,S33,-1.000)
       deallocate(S33)
C
...
C
       ...
       X18=0.0d0
       call
     & sum3124(M1,N1,N1,M2,M2,N3,N0,M1,X18,S34,-1.000)
       deallocate(S34)
C
       allocate(D1(N0+1:N2,N0+1:M1,N1+1:M2,N0+1:M1))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,M1,N1,M2,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S35(N2+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K0
       I3=K2
...
C
       ...
       X19=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N2,M2,N0,M1,X19,S35,-1.000)
       deallocate(S35)
C
       allocate(D1(N0+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N2,M1,N1,N1,M2,N0,M1,VBHHPH,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S36(N2+1:M2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K7
       I2=K0
       I3=K2
...
C
       ...
       X20=0.0d0
       call
     & sum3124(M1,N1,N1,M2,N2,M2,N0,M1,X20,S36,-1.000)
       deallocate(S36)
C
       allocate(D1(N2+1:N3,N0+1:M1,M2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N0,M1,M2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S37(N0+1:M1,N0+1:M1,M2+1:N3,M2+1:N3))
       I1=K6*K6*K5
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,N0,M1,X15,S37, 1.000)
       deallocate(S37)
C
       allocate(D1(N2+1:N3,M1+1:N1,M2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,M1,N1,M2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S38(N0+1:M1,M1+1:N1,M2+1:N3,M2+1:N3))
       I1=K6*K6*K7
       I2=K5
       I3=K4
...
C
       call
     & sum4123(M1,N1,M2,N3,M2,N3,N0,M1,X16,S38, 1.000)
       deallocate(S38)
C
       allocate(D1(N2+1:N3,N0+1:M1,N1+1:M2,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,N0,M1,N1,M2,M2,N3,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S39(N0+1:M1,N0+1:M1,N1+1:M2,M2+1:N3))
       I1=K6*K9*K5
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N0,M1,N1,M2,M2,N3,N0,M1,X17,S39, 1.000)
       deallocate(S39)
C
       allocate(D1(N2+1:N3,M1+1:N1,N1+1:M2,M2+1:N3))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
     & N2,N3,M1,N1,N1,M2,M2,N3,VBHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S40(N0+1:M1,M1+1:N1,N1+1:M2,M2+1:N3))
       I1=K6*K9*K7
       I2=K5
       I3=K4
...
C
       call
     & sum4123(M1,N1,N1,M2,M2,N3,N0,M1,X18,S40, 1.000)
       deallocate(S40)
C
       allocate(D1(N2+1:N3,N0+1:M1,N1+1:M2,N2+1:M2))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum4123(N0,M1,N1,M2,N2,M2,N0,M1,X19,S41, 1.000)
       deallocate(S41)
C
       allocate(D1(N2+1:N3,M1+1:N1,N1+1:M2,N2+1:M2))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum4123(M1,N1,N1,M2,N2,M2,N0,M1,X20,S42, 1.000)
       deallocate(S42)
C
...
C
       ...
       X21=0.0d0
       call
     & sum21(N0,M1,M1,N2,X21,Q8, 1.000)
       deallocate(Q8)
C
...
C
       ...
       X22=0.0d0
       call
     & sum21(M1,N2,M1,N2,X22,Q9, 1.000)
       deallocate(Q9)
C
       allocate(B1(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
...
C
       ...
       X23=0.0d0
       call
     & sum21(N0,M1,N0,M1,X23,Q10, 1.000)
       deallocate(Q10)
C
       allocate(B1(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,N0,M1,t1B,B2)
       ...
       deallocate(B2)
C
       allocate(X24(M1+1:N2,N0+1:M1))
       X24=0.0d0
       call
     & sum21(M1,N2,N0,M1,X24,Q11, 1.000)
       deallocate(Q11)
C
...
C
       ...
       X25=0.0d0
       call
     & sum21(M2,N3,M2,N3,X25,Q12,-1.000)
       deallocate(Q12)
C
...
C
       ...
       X26=0.0d0
       call
     & sum21(N2,M2,M2,N3,X26,Q13,-1.000)
       deallocate(Q13)
C
       allocate(B1(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
...
C
     ...
     & N2,N3,N0,M1,M1,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S43(M1+1:N2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5
       I2=K8
       I3=K4
...
C
     ...
     & N0,M1,M1,N2,M1,N2,M1,N2,S43,D1)
     ...
     & N0,M1,M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,t3D,F2)
       allocate(Z105(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8
       I2=K5*K0*K6*K6
       I3=K8*K5
...
C
       V3D=V3D-Z105
       call
     & sum123465(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z105, 1.000)
       deallocate(Z105)
       deallocate(S43)
C
     ...
     & N2,N3,M1,N2,M1,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S44(M1+1:N2,M1+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K8
       I2=K8
       I3=K4
...
C
     ...
     & M1,N2,M1,N2,M1,N2,M1,N2,S44,D1)
     ...
     & M1,N2,M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,t3D,F2)
       allocate(Z106(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8
       I2=K5*K0*K6*K6
       I3=K8*K8
...
C
       V3D=V3D+0.500*Z106
       call
     & sum123465(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z106,-0.500)
       deallocate(Z106)
       deallocate(S44)
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N2,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S45(N0+1:M1,N0+1:M1,N0+1:M1,M1+1:N2))
       I1=K8*K5*K5
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X30(N0+1:M1,N0+1:M1,N0+1:M1,M1+1:N2))
       X30=0.0d0
       call
     & sum3124(N0,M1,N0,M1,N0,M1,M1,N2,X30,S45, 1.000)
       deallocate(S45)
C
       allocate(D1(N2+1:N3,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder1342(N2,N3,N0,N2,N0,N2,N0,N2,
     & N2,N3,N0,M1,M1,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S46(N0+1:M1,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X31(N0+1:M1,M1+1:N2,N0+1:M1,M1+1:N2))
       X31=0.0d0
       call
     & sum3124(N0,M1,M1,N2,N0,M1,M1,N2,X31,S46, 1.000)
       deallocate(S46)
C
       allocate(D1(N2+1:N3,M1+1:N2,M1+1:N2,M1+1:N2))
       call reorder1342(N2,N3,N0,N2,N0,N2,N0,N2,
     & N2,N3,M1,N2,M1,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S47(N0+1:M1,M1+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K8
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X32(M1+1:N2,M1+1:N2,N0+1:M1,M1+1:N2))
       X32=0.0d0
       call
     & sum3124(M1,N2,M1,N2,N0,M1,M1,N2,X32,S47, 1.000)
       deallocate(S47)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S48(M2+1:N3,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X33(N0+1:M1,M2+1:N3,M2+1:N3,M1+1:N2))
       X33=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X33,S48,-1.000)
       deallocate(S48)
C
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S49(M2+1:N3,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X34(M1+1:N2,M2+1:N3,M2+1:N3,M1+1:N2))
       X34=0.0d0
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X34,S49,-1.000)
       deallocate(S49)
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S50(M2+1:N3,N0+1:M1,N2+1:M2,M1+1:N2))
       I1=K8*K0*K5
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X35(N0+1:M1,N2+1:M2,M2+1:N3,M1+1:N2))
       X35=0.0d0
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N2,X35,S50,-1.000)
       deallocate(S50)
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S51(M2+1:N3,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K8
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X36(M1+1:N2,N2+1:M2,M2+1:N3,M1+1:N2))
       X36=0.0d0
       call
     & sum3124(M1,N2,N2,M2,M2,N3,M1,N2,X36,S51,-1.000)
       deallocate(S51)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,M1+1:N2))
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S52(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N2))
       I1=K8*K0*K5
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X60(N0+1:M1,N2+1:M2,N2+1:M2,M1+1:N2))
       X60=0.0d0
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N2,X60,S52, 1.000)
       deallocate(S52)
C
       allocate(D1(N0+1:N2,M1+1:N2,N2+1:M2,M1+1:N2))
       call reorder4312(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,M1,N2,N2,M2,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S53(N2+1:M2,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K8
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X61(M1+1:N2,N2+1:M2,N2+1:M2,M1+1:N2))
       X61=0.0d0
       call
     & sum3124(M1,N2,N2,M2,N2,M2,M1,N2,X61,S53, 1.000)
       deallocate(S53)
C
...
C
     ...
     & N2,N3,N0,M1,N0,M1,N0,M1,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S54(M1+1:N2,N0+1:M1,N0+1:M1,N0+1:M1))
       I1=K5*K5*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,N0,M1,N0,M1,M1,N2,X30,S54,-1.000)
       deallocate(S54)
C
...
C
       call
     & sum4123(N0,M1,M1,N2,N0,M1,M1,N2,X31,S55,-1.000)
       deallocate(S55)
C
...
C
       call
     & sum4123(M1,N2,M1,N2,N0,M1,M1,N2,X32,S56,-1.000)
       deallocate(S56)
C
       allocate(D1(N2+1:N3,N0+1:M1,M2+1:N3,M2+1:N3))
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N2,X33,S57,-1.000)
       deallocate(S57)
C
...
C
       call
     & sum4123(M1,N2,M2,N3,M2,N3,M1,N2,X34,S58,-1.000)
       deallocate(S58)
C
     ...
     & N2,N3,N0,M1,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S59(M1+1:N2,N0+1:M1,N2+1:M2,M2+1:N3))
       I1=K6*K0*K5
       I2=K8
       I3=K4
...
C
       call
     & sum4123(N0,M1,N2,M2,M2,N3,M1,N2,X35,S59,-1.000)
       deallocate(S59)
C
     ...
     & N2,N3,M1,N2,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S60(M1+1:N2,M1+1:N2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K8
       I2=K8
       I3=K4
...
C
       call
     & sum4123(M1,N2,N2,M2,M2,N3,M1,N2,X36,S60,-1.000)
       deallocate(S60)
C
...
C
       ...
       X37=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N2,M2,M1,N2,X37,S61,-1.000)
       deallocate(S61)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,M1,N2,M2,N2,M2,M1,N2,X37,VCHPHP, 1.000)
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(Z37(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K0*K5
...
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z37,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z37, 1.000)
       deallocate(Z37)
       deallocate(X37)
C
...
C
       ...
       X38=0.0d0
       call
     & sum4123(M1,N2,N2,M2,N2,M2,M1,N2,X38,S62,-1.000)
       deallocate(S62)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & M1,N2,N2,M2,N2,M2,M1,N2,X38,VCHPHP, 1.000)
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(Z38(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K0*K8
...
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z38, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z38,-1.000)
       deallocate(Z38)
       deallocate(X38)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S63(M2+1:N3,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X39(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:M1))
       X39=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,N0,M1,X39,S63,-1.000)
       deallocate(S63)
C
     ...
     & N0,N2,M1,N2,M2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S64(M2+1:N3,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X40(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:M1))
       X40=0.0d0
       call
     & sum3124(M1,N2,M2,N3,M2,N3,N0,M1,X40,S64,-1.000)
       deallocate(S64)
C
     ...
     & N0,N2,N0,M1,N2,M2,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S65(M2+1:N3,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X41(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:M1))
       X41=0.0d0
       call
     & sum3124(N0,M1,N2,M2,M2,N3,N0,M1,X41,S65,-1.000)
       deallocate(S65)
C
     ...
     & N0,N2,M1,N2,N2,M2,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S66(M2+1:N3,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K6
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X42(M1+1:N2,N2+1:M2,M2+1:N3,N0+1:M1))
       X42=0.0d0
       call
     & sum3124(M1,N2,N2,M2,M2,N3,N0,M1,X42,S66,-1.000)
       deallocate(S66)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,N0+1:M1))
       call reorder4312(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N0,M1,N2,M2,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S67(N2+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X62(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:M1))
       X62=0.0d0
       call
     & sum3124(N0,M1,N2,M2,N2,M2,N0,M1,X62,S67, 1.000)
       deallocate(S67)
C
       allocate(D1(N0+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       call reorder4312(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,M1,N2,N2,M2,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S68(N2+1:M2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X63(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:M1))
       X63=0.0d0
       call
     & sum3124(M1,N2,N2,M2,N2,M2,N0,M1,X63,S68, 1.000)
       deallocate(S68)
C
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,N0,M1,X39,S69,-1.000)
       deallocate(S69)
C
       allocate(D1(N2+1:N3,M1+1:N2,M2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum4123(M1,N2,M2,N3,M2,N3,N0,M1,X40,S70,-1.000)
       deallocate(S70)
C
       allocate(D1(N2+1:N3,N0+1:M1,N2+1:M2,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,N0,M1,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S71(N0+1:M1,N0+1:M1,N2+1:M2,M2+1:N3))
       I1=K6*K0*K5
       I2=K5
       I3=K4
...
C
       call
     & sum4123(N0,M1,N2,M2,M2,N3,N0,M1,X41,S71,-1.000)
       deallocate(S71)
C
       allocate(D1(N2+1:N3,M1+1:N2,N2+1:M2,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,M1,N2,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S72(N0+1:M1,M1+1:N2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K8
       I2=K5
       I3=K4
...
C
       call
     & sum4123(M1,N2,N2,M2,M2,N3,N0,M1,X42,S72,-1.000)
       deallocate(S72)
C
       allocate(D1(N2+1:N3,N0+1:M1,N2+1:M2,N2+1:M2))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,N0,M1,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S73(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:M2))
       I1=K0*K0*K5
       I2=K5
       I3=K4
...
C
       ...
       X43=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N2,M2,N0,M1,X43,S73,-1.000)
       deallocate(S73)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,M1,N2,M2,N2,M2,N0,M1,X43,VCHPHP, 1.000)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(Z43(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K8*K8*K6*K6
       I3=K0*K5
...
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z43,-1.000)
       deallocate(Z43)
       deallocate(X43)
C
       allocate(D1(N2+1:N3,M1+1:N2,N2+1:M2,N2+1:M2))
     ...
     & N2,N3,M1,N2,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S74(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K8
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X44(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:M1))
       X44=0.0d0
       call
     & sum4123(M1,N2,N2,M2,N2,M2,N0,M1,X44,S74,-1.000)
       deallocate(S74)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & M1,N2,N2,M2,N2,M2,N0,M1,X44,VCHPHP, 1.000)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(Z44(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K8*K8*K6*K6
       I3=K0*K8
...
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z44,-1.000)
       deallocate(Z44)
       deallocate(X44)
C
     ...
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(U141(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2,N0+1:N2,M2+1:N3))
       I1=K6*K2
       I2=K8*K8*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U141)
       deallocate(D1)
       deallocate(F2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder561234(N2,M2,N0,M1,M1,N2,M1,N2,N0,N2,M2,N3,
     & N0,N2,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,U141,F1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(Z142(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5*K0*K6
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,Z142)
       deallocate(F1)
       deallocate(B2)
C
       call
     & sum213456(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z142,-0.500)
       V3D=V3D+0.500*Z142
       deallocate(Z142)
       deallocate(U141)
C
     ...
     & N0,N2,M2,N3,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S75(M2+1:N3,M2+1:N3,N2+1:M2,M2+1:N3))
       I1=K6*K0*K6
       I2=K6
       I3=K2
...
C
       call
     & sum345612(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z143,-1.000)
       call
     & sum345621(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z143, 1.000)
       deallocate(Z143)
       deallocate(S75)
C
     ...
     & N0,N2,N2,M2,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S76(M2+1:N3,N2+1:M2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K0
       I2=K6
       I3=K2
...
C
       call
     & sum345612(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z144,-0.500)
       call
     & sum345621(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z144, 0.500)
       deallocate(Z144)
       deallocate(S76)
C
       allocate(D1(N0+1:N2,M2+1:N3,N2+1:M2,M2+1:N3))
     ...
     & N0,N2,M2,N3,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S77(N2+1:M2,M2+1:N3,N2+1:M2,M2+1:N3))
       I1=K6*K0*K6
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X47(M2+1:N3,N2+1:M2,M2+1:N3,N2+1:M2))
       X47=0.0d0
       call
     & sum4123(M2,N3,N2,M2,M2,N3,N2,M2,X47,S77,-1.000)
       deallocate(S77)
C
       allocate(D1(N0+1:N2,N2+1:M2,N2+1:M2,M2+1:N3))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,M2,N2,M2,M2,N3,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S78(N2+1:M2,N2+1:M2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K0
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X48(N2+1:M2,N2+1:M2,M2+1:N3,N2+1:M2))
       X48=0.0d0
       call
     & sum4123(N2,M2,N2,M2,M2,N3,N2,M2,X48,S78,-1.000)
       deallocate(S78)
C
...
C
     ...
     & N0,N2,M2,N3,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S79(M2+1:N3,M2+1:N3,N2+1:M2,N2+1:M2))
       I1=K0*K0*K6
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M2,N3,N2,M2,M2,N3,N2,M2,X47,S79, 1.000)
       deallocate(S79)
C
     ...
     & N0,N2,N2,M2,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S80(M2+1:N3,N2+1:M2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K0
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N2,M2,N2,M2,M2,N3,N2,M2,X48,S80, 1.000)
       deallocate(S80)
C
...
C
       call
     & sum2314(N0,N2,M2,N3,M1,N2,M1,N2,X56,S81, 1.000)
       deallocate(S81)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S82(N2+1:M2,M1+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X57,S82, 1.000)
       deallocate(S82)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S83(M2+1:N3,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K6
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,M2,N3,N0,M1,M1,N2,X3,S83, 1.000)
       deallocate(S83)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     ...
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S84(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X4,S84, 1.000)
       deallocate(S84)
C
     ...
     & N0,N1,N1,N3,N0,N2,N0,M1,VBHHPH,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S85(M2+1:N3,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K6
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,M2,N3,N0,M1,M1,N2,X3,S85,-1.000)
       deallocate(S85)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N0,M1,VBHHPH,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S86(N2+1:M2,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X4,S86,-1.000)
       deallocate(S86)
C
     ...
     & N0,N1,N1,N3,N2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S87(M2+1:N3,M1+1:N2,N2+1:N3,M2+1:N3))
       I1=K6*K4
       I2=K8*K6
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,M1,N2,X58,S87,-1.000)
       deallocate(S87)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,M2+1:N3))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S88(N2+1:M2,M1+1:N2,N2+1:N3,M2+1:N3))
       I1=K6*K4
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,M2,N3,N2,M2,M1,N2,X6,S88, 1.000)
       deallocate(S88)
C
...
C
       call
     & sum2413(N2,N3,M2,N3,N2,M2,M1,N2,X6,S89,-1.000)
       deallocate(S89)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,M2+1:N3))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S90(M2+1:N3,N0+1:M1,N2+1:N3,M2+1:N3))
       I1=K6*K4
       I2=K5*K6
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,N0,M1,X59,S90,-1.000)
       deallocate(S90)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,M2+1:N3))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,M2,N3,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S91(N2+1:M2,N0+1:M1,N2+1:N3,M2+1:N3))
       I1=K6*K4
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum3412(N2,N3,M2,N3,N2,M2,N0,M1,X8,S91, 1.000)
       deallocate(S91)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
     & N0,N1,N1,N3,N2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S92(M2+1:N3,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K6
       I3=K3*K1
...
C
       call
     & sum2413(N2,N3,M2,N3,N2,M2,N0,M1,X8,S92,-1.000)
       deallocate(S92)
C
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S93(M2+1:N3,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K6
       I3=K3*K1
...
C
     ...
     & N0,M1,M2,N3,M2,N3,M1,N2,S93,D1)
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z164(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K6*K5
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z164, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z164,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z164,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z164, 1.000)
       deallocate(Z164)
       deallocate(S93)
C
     ...
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S94(M2+1:N3,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K8*K6
       I3=K3*K1
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z165, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z165,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z165,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z165, 1.000)
       deallocate(Z165)
       deallocate(S94)
C
     ...
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S95(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K6
       I3=K3*K1
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z166, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z166,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z166,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z166, 1.000)
       deallocate(Z166)
       deallocate(S95)
C
     ...
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S96(M2+1:N3,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K8*K6
       I3=K3*K1
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z167, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z167,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z167,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z167, 1.000)
       deallocate(Z167)
       deallocate(S96)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S97(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & N0,M1,N1,M2,N2,M2,M1,N2,S97,D1)
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C3,F2)
       allocate(Z168(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K9*K5
...
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z168, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z168,-1.000)
       deallocate(Z168)
       deallocate(S97)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
     ...
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S98(N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z169, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z169,-1.000)
       deallocate(Z169)
       deallocate(S98)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S99(M2+1:N3,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K6
       I3=K3*K1
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z170, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z170,-1.000)
       deallocate(Z170)
       deallocate(S99)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S100(M2+1:N3,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K6
       I3=K3*K1
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z171, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z171,-1.000)
       deallocate(Z171)
       deallocate(S100)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S101(M2+1:N3,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K6
       I3=K3*K1
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N0,M1,S101,D1)
       allocate(F2(N0+1:M1,N1+1:M2,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(Z172(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z172)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z172, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z172,-1.000)
       deallocate(Z172)
       deallocate(S101)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
     ...
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S102(M2+1:N3,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K6
       I3=K3*K1
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z173, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z173,-1.000)
       deallocate(Z173)
       deallocate(S102)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S103(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z174, 1.000)
       deallocate(Z174)
       deallocate(S103)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
     ...
     & N0,N1,N1,N3,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S104(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z175, 1.000)
       deallocate(Z175)
       deallocate(S104)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S105(M2+1:N3,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K6
       I3=K3*K1
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z176, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z176,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z176,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z176, 1.000)
       deallocate(Z176)
       deallocate(S105)
C
     ...
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S106(M2+1:N3,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K6
       I3=K3*K1
...
C
     ...
     & M1,N2,M2,N3,M2,N3,M1,N2,S106,D1)
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z177(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K6*K8
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z177,-1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z177, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z177, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z177,-1.000)
       deallocate(Z177)
       deallocate(S106)
C
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S107(M2+1:N3,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K6
       I3=K3*K1
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M1,N2,S107,D1)
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z178(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K0*K5
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z178,-1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z178, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z178, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z178,-1.000)
       deallocate(Z178)
       deallocate(S107)
C
     ...
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S108(M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K6
       I3=K3*K1
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M1,N2,S108,D1)
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z179(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K0*K8
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z179, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z179,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z179,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z179, 1.000)
       deallocate(Z179)
       deallocate(S108)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S109(N2+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K0
       I3=K3*K1
...
C
       ...
       X64=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N2,X64,S109, 1.000)
       deallocate(S109)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S110(N2+1:M2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K0
       I3=K3*K1
...
C
       ...
       X65=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N2,M2,M1,N2,X65,S110, 1.000)
       deallocate(S110)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X49,Q22, 1.000)
       deallocate(Q22)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X50,Q23, 1.000)
       deallocate(Q23)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S111(M2+1:N3,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K6
       I3=K3*K1
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z184(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K6*K5
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z184, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z184,-1.000)
       deallocate(Z184)
       deallocate(S111)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
     ...
     & N0,N1,N1,N3,M1,N2,M2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S112(M2+1:N3,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K6
       I3=K3*K1
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z185(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K6*K8
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z185, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z185,-1.000)
       deallocate(Z185)
       deallocate(S112)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S113(M2+1:N3,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K6
       I3=K3*K1
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z186(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K0*K5
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z186,-1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z186, 1.000)
       deallocate(Z186)
       deallocate(S113)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S114(M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K6
       I3=K3*K1
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z187(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K0*K8
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z187,-1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z187, 1.000)
       deallocate(Z187)
       deallocate(S114)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N1,N1,N3,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S115(N2+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K0
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X66(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:M1))
       X66=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N2,M2,N0,M1,X66,S115, 1.000)
       deallocate(S115)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M1,N2,N2,M2,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S116(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K0
       I3=K3*K1
       ...
       deallocate(D2)
C
       allocate(X67(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:M1))
       X67=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N2,M2,N0,M1,X67,S116, 1.000)
       deallocate(S116)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N0+1:M1))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum21(N0,M1,N0,M1,X51,Q24, 1.000)
       deallocate(Q24)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum21(M1,N2,N0,M1,X52,Q25, 1.000)
       deallocate(Q25)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X53,Q26,-1.000)
       deallocate(Q26)
C
...
C
       call
     & sum21(N2,M2,M2,N3,X54,Q27,-1.000)
       deallocate(Q27)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,N2+1:M2))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum21(N2,M2,N2,M2,X55,Q28,-1.000)
       deallocate(Q28)
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       allocate(S117(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S117)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S117,-1.000)
       deallocate(S117)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S118)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S118,-1.000)
       deallocate(S118)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S119(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S119)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X3,S119,-1.000)
       deallocate(S119)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(S120(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S120)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X4,S120,-1.000)
       deallocate(S120)
C
     ...
     & N0,N2,N0,N2,M2,N3,N2,M2,t2C,D2)
       allocate(S121(M2+1:N3,N2+1:M2,N2+1:N3,M1+1:N2))
       I1=K8*K4
       I2=K0*K6
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,M2,N3,N2,M2,M1,N2,X6,S121, 0.500)
       deallocate(S121)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
       call reorder3412(N2,N3,N0,N2,N0,N2,N0,N2,
     ...
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       allocate(S122(M2+1:N3,M2+1:N3,N2+1:N3,M1+1:N2))
       I1=K8*K4
       I2=K6*K6
       I3=K2*K2
       ...
       deallocate(D2)
C
       allocate(X5(N2+1:N3,M2+1:N3,M2+1:N3,M1+1:N2))
       X5=0.0d0
       call
     & sum2314(N2,N3,M2,N3,M2,N3,M1,N2,X5,S122, 0.500)
       deallocate(S122)
C
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S123(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X4,S123,-1.000)
       deallocate(S123)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S124(M2+1:N3,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,M2,N3,N0,M1,M1,N2,X3,S124, 1.000)
       deallocate(S124)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
     ...
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S125(M2+1:N3,M1+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,M2,N3,M1,N2,M1,N2,X56,S125, 1.000)
       deallocate(S125)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder4132(N2,N3,N0,N2,N0,N2,N0,N2,
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S126(N2+1:M2,M1+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X57,S126,-1.000)
       deallocate(S126)
C
     ...
     & N0,N2,N0,N2,N2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,N2,M2,t2C,D2)
       allocate(S127(M2+1:N3,N2+1:M2,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K0*K6
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,M2,N3,N2,M2,N0,M1,X8,S127, 0.500)
       deallocate(S127)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       allocate(S128(M2+1:N3,M2+1:N3,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K6*K6
       I3=K2*K2
...
C
       ...
       X7=0.0d0
       call
     & sum2314(N2,N3,M2,N3,M2,N3,N0,M1,X7,S128, 0.500)
       deallocate(S128)
C
     ...
     & N0,N2,N2,N3,N2,N3,M2,N3,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S129(N2+1:M2,N0+1:M1,N2+1:N3,M2+1:N3))
       I1=K6*K4
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,M2,N3,N2,M2,N0,M1,X8,S129, 1.000)
       deallocate(S129)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,M2+1:N3))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,M2,N3,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S130(M2+1:N3,N0+1:M1,N2+1:N3,M2+1:N3))
       I1=K6*K4
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,N0,M1,X59,S130, 1.000)
       deallocate(S130)
C
     ...
     & N2,N3,N2,N3,M1,N2,M1,N2,t2C,D2)
       allocate(S131(M1+1:N2,M1+1:N2,N0+1:N2,M2+1:N3))
       I1=K6*K2
       I2=K8*K8
       I3=K4*K4
...
C
       call
     & sum3412(N0,N2,M2,N3,M1,N2,M1,N2,X1,S131, 0.500)
       deallocate(S131)
C
     ...
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S132(M2+1:N3,N0+1:M1,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum2413(N2,N3,M2,N3,N2,M2,N0,M1,X8,S132,-1.000)
       deallocate(S132)
C
     ...
     & N2,N3,N2,N3,N0,N2,N2,M2,VCHPPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,M1,N2,M1,N2,t2C,D2)
       allocate(S133(M1+1:N2,M1+1:N2,N0+1:N2,N2+1:M2))
       I1=K0*K2
       I2=K8*K8
       I3=K4*K4
...
C
       call
     & sum3412(N0,N2,N2,M2,M1,N2,M1,N2,X2,S133, 0.500)
       deallocate(S133)
C
...
C
       ...
       X68=0.0d0
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X68,S134, 1.000)
       deallocate(S134)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S135(M2+1:N3,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K6
       I3=K4*K2
       ...
       deallocate(D2)
C
       allocate(X69(N0+1:N2,M2+1:N3,N0+1:M1,M1+1:N2))
       X69=0.0d0
       call
     & sum2413(N0,N2,M2,N3,N0,M1,M1,N2,X69,S135, 1.000)
       deallocate(S135)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,M2+1:N3))
       call reorder4213(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       ...
       X70=0.0d0
       call
     & sum3412(N2,N3,M2,N3,N2,M2,M1,N2,X70,S136, 1.000)
       deallocate(S136)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,M2+1:N3))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,M2,N3,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S137(M2+1:N3,M1+1:N2,N2+1:N3,M2+1:N3))
       I1=K6*K4
       I2=K8*K6
       I3=K4*K2
       ...
       deallocate(D2)
C
       allocate(X71(N2+1:N3,M2+1:N3,M2+1:N3,M1+1:N2))
       X71=0.0d0
       call
     & sum3412(N2,N3,M2,N3,M2,N3,M1,N2,X71,S137, 1.000)
       deallocate(S137)
C
       allocate(D1(N2+1:N3,N2+1:N3,N0+1:N2,M2+1:N3))
       call reorder1243(N2,N3,N2,N3,N2,N3,N0,N2,
     ...
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S138(N0+1:M1,M1+1:N2,N0+1:N2,M2+1:N3))
       I1=K6*K2
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(N0,N2,M2,N3,N0,M1,M1,N2,X3,S138, 0.500)
       deallocate(S138)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N2,N3,N2,N3,N0,N2,
     & N0,N2,N2,N3,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S139(M2+1:N3,M1+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum2413(N2,N3,M2,N3,N2,M2,M1,N2,X70,S139,-1.000)
       deallocate(S139)
C
       allocate(D1(N2+1:N3,N2+1:N3,N0+1:N2,N2+1:M2))
       call reorder1243(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,N2,N3,N0,N2,N2,M2,VCHPPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S140(N0+1:M1,M1+1:N2,N0+1:N2,N2+1:M2))
       I1=K0*K2
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(N0,N2,N2,M2,N0,M1,M1,N2,X4,S140, 0.500)
       deallocate(S140)
C
     ...
     & M1,N2,N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,t3C1,F2)
       allocate(S141(M2+1:N3,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K6
       I3=K6*K5*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S141, 1.000)
       deallocate(S141)
C
     ...
     & N0,M1,M1,N1,M2,N3,M2,N3,N2,M2,N0,M1,t3C4,F2)
       allocate(S142(M2+1:N3,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K6
       I3=K6*K7*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S142,-1.000)
       deallocate(S142)
C
     ...
     & M1,N2,M1,N1,M2,N3,M2,N3,N2,M2,N0,M1,t3C1,F2)
       allocate(S143(M2+1:N3,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K6
       I3=K6*K7*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S143, 1.000)
       deallocate(S143)
C
     ...
     & M1,N2,N0,M1,N1,M2,M2,N3,N2,M2,N0,M1,t3C1,F2)
       allocate(S144(M2+1:N3,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K6
       I3=K9*K5*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S144, 1.000)
       deallocate(S144)
C
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,N2,M2,N0,M1,t3C4,F2)
       allocate(S145(M2+1:N3,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K6
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S145,-1.000)
       deallocate(S145)
C
     ...
     & M1,N2,M1,N1,N1,M2,M2,N3,N2,M2,N0,M1,t3C1,F2)
       allocate(S146(M2+1:N3,N2+1:M2,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K0*K6
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S146, 1.000)
       deallocate(S146)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,t3C3,F2)
       allocate(S147(M2+1:N3,M2+1:N3,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K6*K6
       I3=K9*K5*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S147, 1.000)
       deallocate(S147)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,t3C2,F2)
       allocate(S148(M2+1:N3,M2+1:N3,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K6*K6
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S148,-1.000)
       deallocate(S148)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,t3C3,F2)
       allocate(S149(M2+1:N3,M2+1:N3,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K6*K6
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S149, 1.000)
       deallocate(S149)
C
     ...
     & N0,M1,N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,t3C1,F2)
       allocate(S150(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K6*K5*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S150,-1.000)
       deallocate(S150)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,t3C1,F2)
       allocate(S151(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K6*K5*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S151,-1.000)
       deallocate(S151)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,t3C1,F2)
       allocate(S152(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K6*K7*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S152,-1.000)
       deallocate(S152)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,t3C1,F2)
       allocate(S153(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K6*K7*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S153,-1.000)
       deallocate(S153)
C
     ...
     & N0,M1,N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,t3C1,F2)
       allocate(S154(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K9*K5*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S154,-1.000)
       deallocate(S154)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,t3C1,F2)
       allocate(S155(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K9*K5*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S155,-1.000)
       deallocate(S155)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,N2,M2,M1,N2,t3C1,F2)
       allocate(S156(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S156,-1.000)
       deallocate(S156)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,N1,M2,M2,N3,N2,M2,M1,N2,t3C1,F2)
       allocate(S157(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S157,-1.000)
       deallocate(S157)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N0,M1,N1,M2,M2,N3,M2,N3,M1,N2,t3C3,F2)
       ...
       deallocate(F2)
C
       allocate(X72(N2+1:N3,M2+1:N3,M2+1:N3,M1+1:N2))
       X72=0.0d0
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X72,S158, 1.000)
       deallocate(S158)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X72,S159, 1.000)
       deallocate(S159)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,M2,N3,M1,N2,t3C3,F2)
       allocate(S160(M2+1:N3,M2+1:N3,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K6*K6
       I3=K9*K7*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X72,S160, 1.000)
       deallocate(S160)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N2,M1,N1,N1,M2,M2,N3,M2,N3,M1,N2,t3C3,F2)
       allocate(S161(M2+1:N3,M2+1:N3,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K6*K6
       I3=K9*K7*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X72,S161, 1.000)
       deallocate(S161)
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S162(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S162,-1.000)
       deallocate(S162)
C
     ...
     & M1,N1,M2,N3,M2,N3,N0,N2,VBHHPP,D1)
       ...
       call reorder613245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S163(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K6*K6*K7
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S163,-1.000)
       deallocate(S163)
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S164(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S164,-1.000)
       deallocate(S164)
C
     ...
     & M1,N1,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S165(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S165,-1.000)
       deallocate(S165)
C
     ...
     & N0,M1,M2,N3,N1,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S166(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S166,-1.000)
       deallocate(S166)
C
     ...
     & M1,N1,M2,N3,N1,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S167(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S167,-1.000)
       deallocate(S167)
C
     ...
     & N0,M1,N2,M2,N1,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S168(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S168,-1.000)
       deallocate(S168)
C
     ...
     & M1,N1,N2,M2,N1,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(S169(N2+1:M2,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K0
       I3=K9*K0*K7
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S169,-1.000)
       deallocate(S169)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C1,F2)
       allocate(S170(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S170,-1.000)
       deallocate(S170)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C1,F2)
       allocate(S171(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S171,-1.000)
       deallocate(S171)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,N1,M2,M2,N3,N0,M1,M1,N2,t3C3,F2)
       allocate(S172(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S172, 1.000)
       deallocate(S172)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,N0,M1,M1,N2,t3C3,F2)
       allocate(S173(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S173, 1.000)
       deallocate(S173)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N2,M2,N1,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       allocate(S174(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S174,-1.000)
       deallocate(S174)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,N2,M2,N1,M2,M2,N3,N0,M1,M1,N2,t3C1,F2)
       allocate(S175(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K9*K0*K7
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S175,-1.000)
       deallocate(S175)
C
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S176(M2+1:N3,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X9,S176, 1.000)
       deallocate(S176)
C
     ...
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S177(M2+1:N3,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N2,X10,S177, 1.000)
       deallocate(S177)
C
     ...
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S178(M2+1:N3,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N2,X11,S178, 1.000)
       deallocate(S178)
C
     ...
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S179(M2+1:N3,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N2,X12,S179, 1.000)
       deallocate(S179)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S180(N2+1:M2,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X13,S180, 1.000)
       deallocate(S180)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S181(N2+1:M2,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X14,S181, 1.000)
       deallocate(S181)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N0,N2,VBHHPP,D1)
       ...
       call reorder613245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(S182(N2+1:M2,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K0
       I3=K6*K6*K5
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S182,-1.000)
       deallocate(S182)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & M1,N1,M2,N3,M2,N3,N0,N2,VBHHPP,D1)
       ...
       call reorder613245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(S183(N2+1:M2,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K0
       I3=K6*K6*K7
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S183,-1.000)
       deallocate(S183)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(S184(N2+1:M2,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K0
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S184,-1.000)
       deallocate(S184)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(S185(N2+1:M2,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K0
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S185,-1.000)
       deallocate(S185)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,N1,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(S186(N2+1:M2,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K0
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S186,-1.000)
       deallocate(S186)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S187,-1.000)
       deallocate(S187)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S188,-1.000)
       deallocate(S188)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S189,-1.000)
       deallocate(S189)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C1,F2)
       allocate(S190(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K6*K0*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S190, 1.000)
       deallocate(S190)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C1,F2)
       allocate(S191(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S191, 1.000)
       deallocate(S191)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,M2,N3,N1,M2,M2,N3,M1,N2,M1,N2,t3C3,F2)
       allocate(S192(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K9*K6*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S192,-1.000)
       deallocate(S192)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,M1,N2,M1,N2,t3C3,F2)
       allocate(S193(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S193,-1.000)
       deallocate(S193)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & N0,M1,N2,M2,N1,M2,M2,N3,M1,N2,M1,N2,t3C1,F2)
       allocate(S194(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K9*K0*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S194, 1.000)
       deallocate(S194)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     ...
     & M1,N1,N2,M2,N1,M2,M2,N3,M1,N2,M1,N2,t3C1,F2)
       allocate(S195(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K9*K0*K7
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S195, 1.000)
       deallocate(S195)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S196(M2+1:N3,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,N0,M1,X15,S196, 1.000)
       deallocate(S196)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S197(M2+1:N3,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,N0,M1,X16,S197, 1.000)
       deallocate(S197)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S198(M2+1:N3,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,N0,M1,X17,S198, 1.000)
       deallocate(S198)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S199(M2+1:N3,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,N0,M1,X18,S199, 1.000)
       deallocate(S199)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S200(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9*K5
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,N0,M1,X19,S200, 1.000)
       deallocate(S200)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S201(N2+1:M2,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,N0,M1,X20,S201, 1.000)
       deallocate(S201)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S202,-1.000)
       deallocate(S202)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S203, 0.500)
       deallocate(S203)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S204, 1.000)
       deallocate(S204)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,N0,M1,X8,S205,-0.500)
       deallocate(S205)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,t3D,F2)
       allocate(S206(M2+1:N3,M2+1:N3,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K6*K6
       I3=K0*K8*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S206, 1.000)
       deallocate(S206)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,t3D,F2)
       allocate(S207(M2+1:N3,M2+1:N3,N0+1:M1,N2+1:N3))
       I1=K4
       I2=K5*K6*K6
       I3=K0*K8*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,N0,M1,X7,S207,-0.500)
       deallocate(S207)
C
     ...
     & N2,N3,N2,N3,N0,M1,M1,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,M1,N2,M1,N2,t2C,D2)
       allocate(S208(M1+1:N2,M1+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K8*K8
       I3=K4*K4
       ...
       deallocate(D2)
C
       allocate(X28(N0+1:M1,M1+1:N2,M1+1:N2,M1+1:N2))
       X28=0.0d0
       call
     & sum3412(N0,M1,M1,N2,M1,N2,M1,N2,X28,S208, 0.500)
       deallocate(S208)
C
     ...
     & N2,N3,N2,N3,M1,N2,M1,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,M1,N2,M1,N2,t2C,D2)
       allocate(S209(M1+1:N2,M1+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8
       I2=K8*K8
       I3=K4*K4
       ...
       deallocate(D2)
C
       allocate(X29(M1+1:N2,M1+1:N2,M1+1:N2,M1+1:N2))
       X29=0.0d0
       call
     & sum3412(M1,N2,M1,N2,M1,N2,M1,N2,X29,S209, 0.500)
       deallocate(S209)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S210, 0.500)
       deallocate(S210)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,t3D,F2)
       allocate(S211(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K6*K8*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S211, 1.000)
       deallocate(S211)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,t3D,F2)
       allocate(S212(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K6*K8*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S212, 0.500)
       deallocate(S212)
C
     ...
     & N0,M1,N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,t3D,F2)
       allocate(S213(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K0*K5*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S213,-0.500)
       deallocate(S213)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,t3D,F2)
       allocate(S214(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K0*K8*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S214,-1.000)
       deallocate(S214)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,t3D,F2)
       allocate(S215(M2+1:N3,N2+1:M2,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K0*K6
       I3=K0*K8*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,N2,M2,M1,N2,X70,S215,-0.500)
       deallocate(S215)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,t3D,F2)
       allocate(S216(M2+1:N3,M2+1:N3,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K6*K6
       I3=K0*K5*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X72,S216, 0.500)
       deallocate(S216)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,t3D,F2)
       allocate(S217(M2+1:N3,M2+1:N3,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K6*K6
       I3=K0*K8*K5
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X72,S217, 1.000)
       deallocate(S217)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,t3D,F2)
       allocate(S218(M2+1:N3,M2+1:N3,M1+1:N2,N2+1:N3))
       I1=K4
       I2=K8*K6*K6
       I3=K0*K8*K8
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N2,X72,S218, 0.500)
       deallocate(S218)
C
       allocate(D2(N2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(Z236(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K6
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X72,D2,Z236)
       deallocate(D2)
C
       call
     & sum346125(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z236,-1.000)
       call
     & sum345126(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z236, 1.000)
       deallocate(Z236)
       deallocate(X72)
C
     ...
     & N2,N3,N2,N3,N0,M1,N0,M1,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S219(N0+1:M1,M1+1:N2,N0+1:M1,N0+1:M1))
       I1=K5*K5
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(N0,M1,N0,M1,N0,M1,M1,N2,X30,S219, 0.500)
       deallocate(S219)
C
       allocate(D1(N2+1:N3,N2+1:N3,N0+1:M1,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S220(N0+1:M1,M1+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(N0,M1,M1,N2,N0,M1,M1,N2,X31,S220, 0.500)
       deallocate(S220)
C
       allocate(D1(N2+1:N3,N2+1:N3,M1+1:N2,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,M1,N2,M1,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S221(N0+1:M1,M1+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8
       I2=K8*K5
       I3=K4*K4
...
C
       call
     & sum3412(M1,N2,M1,N2,N0,M1,M1,N2,X32,S221, 0.500)
       deallocate(S221)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S222, 0.500)
       deallocate(S222)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S223,-0.500)
       deallocate(S223)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S224, 1.000)
       deallocate(S224)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S225,-1.000)
       deallocate(S225)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S226, 0.500)
       deallocate(S226)
C
...
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X68,S227,-0.500)
       deallocate(S227)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(S228(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K0*K6*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S228,-1.000)
       deallocate(S228)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(S229(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K0*K6*K8
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S229, 1.000)
       deallocate(S229)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(S230(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K0*K0*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S230, 0.500)
       deallocate(S230)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(S231(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K0*K0*K8
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X69,S231,-0.500)
       deallocate(S231)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
     ...
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S232(M2+1:N3,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X33,S232,-1.000)
       deallocate(S232)
C
     ...
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S233(M2+1:N3,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N2,X34,S233,-1.000)
       deallocate(S233)
C
     ...
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S234(M2+1:N3,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N2,X35,S234,-1.000)
       deallocate(S234)
C
     ...
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S235(M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,M2,N3,M1,N2,X36,S235,-1.000)
       deallocate(S235)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
     ...
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S236(N2+1:M2,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N2,X64,S236, 1.000)
       deallocate(S236)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(Z180(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X64,F2,Z180)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z180, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z180,-1.000)
       deallocate(Z180)
       deallocate(X64)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S237(N2+1:M2,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,M1,N2,X65,S237, 1.000)
       deallocate(S237)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder531246(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(Z181(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X65,F2,Z181)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z181,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z181, 1.000)
       deallocate(Z181)
       deallocate(X65)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X21,Q29, 0.500)
       deallocate(Q29)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X22,Q30, 0.500)
       deallocate(Q30)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S238, 0.500)
       deallocate(S238)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S239, 0.500)
       deallocate(S239)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S240, 1.000)
       deallocate(S240)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S241, 1.000)
       deallocate(S241)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S242, 0.500)
       deallocate(S242)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S243, 0.500)
       deallocate(S243)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(S244(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K0*K6*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S244, 1.000)
       deallocate(S244)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(S245(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K0*K6*K8
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S245, 1.000)
       deallocate(S245)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(S246(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K0*K0*K5
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S246,-0.500)
       deallocate(S246)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(S247(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K0*K0*K8
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S247,-0.500)
       deallocate(S247)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S248(M2+1:N3,N0+1:M1,N0+1:M1,M2+1:N3))
       I1=K6*K5
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,N0,M1,X39,S248,-1.000)
       deallocate(S248)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S249(M2+1:N3,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,M2,N3,M2,N3,N0,M1,X40,S249,-1.000)
       deallocate(S249)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S250(M2+1:N3,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0*K5
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(N0,M1,N2,M2,M2,N3,N0,M1,X41,S250,-1.000)
       deallocate(S250)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S251(M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,M2,N3,N0,M1,X42,S251,-1.000)
       deallocate(S251)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,N0,M1,X66,S252, 1.000)
       deallocate(S252)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(Z188(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K8*K8*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X66,F2,Z188)
       deallocate(F2)
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z188, 1.000)
       deallocate(Z188)
       deallocate(X66)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
     ...
     & N0,N2,N2,N3,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S253(N2+1:M2,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,N0,M1,X67,S253, 1.000)
       deallocate(S253)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(Z189(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K8*K8*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X67,F2,Z189)
       deallocate(F2)
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z189, 1.000)
       deallocate(Z189)
       deallocate(X67)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N0+1:M1))
...
C
       call
     & sum21(N0,M1,N0,M1,X23,Q31, 0.500)
       deallocate(Q31)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,M1+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum21(M1,N2,N0,M1,X24,Q32, 0.500)
       deallocate(Q32)
C
     ...
     & M2,N3,M2,N3,N0,N2,N0,N2,VCHHPP,D1)
       ...
       call reorder123456(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(U336(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2,N0+1:N2,N0+1:N2))
       I1=K2*K2
       I2=K8*K8*K5*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U336)
       deallocate(D1)
       deallocate(F2)
C
       allocate(F1(N0+1:N2,N0+1:N2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder561234(N2,M2,N0,M1,M1,N2,M1,N2,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N0,M1,M1,N2,M1,N2,U336,F1)
       allocate(D2(N0+1:N2,N0+1:N2,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       allocate(Z337(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5*K0
       I2=K6*K6
       I3=K2*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z337)
       deallocate(F1)
       deallocate(D2)
C
       V3D=V3D+0.250*Z337
...
C
       allocate(F1(N0+1:N2,N0+1:N2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder651234(N2,M2,N0,M1,M1,N2,M1,N2,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N0,M1,M1,N2,M1,N2,U336,F1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(U409(M2+1:N3,N0+1:N2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5*K0*K2
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,U409)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder213456(M2,N3,N0,N2,N2,M2,N0,M1,M1,N2,M1,N2,
     & N0,N2,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,U409,F1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(Z410(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5*K0*K6
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,F1,B2,Z410)
       deallocate(F1)
       deallocate(B2)
C
       V3D=V3D+0.500*Z410
...
C
     ...
     & N0,N2,N0,N2,N2,M2,N2,M2,VCHHPP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       allocate(S255(M2+1:N3,M2+1:N3,N2+1:M2,N2+1:M2))
       I1=K0*K0
       I2=K6*K6
       I3=K2*K2
       ...
       deallocate(D2)
C
       allocate(X46(N2+1:M2,N2+1:M2,M2+1:N3,M2+1:N3))
       X46=0.0d0
       call
     & sum3412(N2,M2,N2,M2,M2,N3,M2,N3,X46,S255, 0.500)
       deallocate(S255)
C
     ...
     & N0,N2,N0,N2,M2,N3,N2,M2,VCHHPP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,N2,M2,t2C,D2)
       allocate(S256(M2+1:N3,N2+1:M2,M2+1:N3,N2+1:M2))
       I1=K0*K6
       I2=K0*K6
       I3=K2*K2
...
C
       call
     & sum3412(M2,N3,N2,M2,M2,N3,N2,M2,X47,S256, 0.500)
       deallocate(S256)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:M2,N2+1:M2))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,M2,N2,M2,VCHHPP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,N2,M2,t2C,D2)
       allocate(S257(M2+1:N3,N2+1:M2,N2+1:M2,N2+1:M2))
       I1=K0*K0
       I2=K0*K6
       I3=K2*K2
...
C
       call
     & sum3412(N2,M2,N2,M2,M2,N3,N2,M2,X48,S257, 0.500)
       deallocate(S257)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X25,Q33,-0.500)
       deallocate(Q33)
C
...
C
       call
     & sum21(N2,M2,M2,N3,X26,Q34,-0.500)
       deallocate(Q34)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N2+1:M2))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum21(N2,M2,N2,M2,X55,Q35, 0.500)
       deallocate(Q35)
C
...
C
       call
     & sum21(N0,M1,N0,M1,X51,Q40, 1.000)
       deallocate(Q40)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z51(M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K8*K0*K6*K6
       I3=K5
...
C
       call
     & sum123564(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z51,-1.000)
       deallocate(Z51)
       deallocate(X51)
C
       allocate(B1(N2+1:N3,N0+1:M1))
...
C
       call
     & sum21(N0,M1,M1,N2,X49,Q37, 1.000)
       deallocate(Q37)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z49(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8
       I2=K8*K5*K0*K6*K6
       I3=K5
...
C
       V3D=V3D-Z49
       call
     & sum123465(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z49, 1.000)
       deallocate(Z49)
       deallocate(X49)
C
...
C
       call
     & sum21(M1,N2,N0,M1,X52,Q41, 1.000)
       deallocate(Q41)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z52(M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K8*K0*K6*K6
       I3=K8
...
C
       call
     & sum123564(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z52,-1.000)
       deallocate(Z52)
       deallocate(X52)
C
       allocate(B1(N2+1:N3,M1+1:N2))
...
C
       call
     & sum21(M1,N2,M1,N2,X50,Q39, 1.000)
       deallocate(Q39)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z50(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8
       I2=K8*K5*K0*K6*K6
       I3=K8
...
C
       V3D=V3D+Z50
       call
     & sum123465(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z50,-1.000)
       deallocate(Z50)
       deallocate(X50)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X53,Q43,-1.000)
       deallocate(Q43)
C
       allocate(F2(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder123456(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z53(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6
       I2=K8*K8*K5*K0*K6
       I3=K6
...
C
       call
     & sum234561(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z53, 1.000)
       call
     & sum134562(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z53,-1.000)
       deallocate(Z53)
       deallocate(X53)
C
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q44,B2,Q46)
       deallocate(B2)
C
       call
     & sum21(N2,M2,N2,M2,X55,Q46,-1.000)
       deallocate(Q46)
C
       allocate(F2(N2+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder312456(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z55(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0
       I2=K8*K8*K5*K6*K6
       I3=K0
...
C
       call
     & sum124563(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z55, 1.000)
       deallocate(Z55)
       deallocate(X55)
C
       allocate(B2(N0+1:N2,M2+1:N3))
...
C
       call
     & sum21(N2,M2,M2,N3,X54,Q45,-1.000)
       deallocate(Q45)
C
     ...
     & N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z54(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6
       I2=K8*K8*K5*K0*K6
       I3=K0
...
C
       call
     & sum234561(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z54,-1.000)
       call
     & sum134562(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z54, 1.000)
       deallocate(Z54)
       deallocate(X54)
C
...
C
     ...
     & N2,N3,N0,N2,Q47,B1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       allocate(S259(N2+1:M2,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S259)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S259,-1.000)
       deallocate(S259)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S260)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X3,S260,-1.000)
       deallocate(S260)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S261)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X4,S261,-1.000)
       deallocate(S261)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S258)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S258,-1.000)
       deallocate(S258)
C
     ...
     & N2,N3,N0,N2,N0,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S262(M1+1:N2,N0+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,N2,M1,N2,M1,N2,S262,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S264(N2+1:M2,N0+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,M1,N2,M1,N2,X57,S264, 1.000)
       deallocate(S264)
C
       allocate(D1(N0+1:N2,N0+1:N2,M1+1:N2,M1+1:N2))
     ...
     & N0,N2,N0,N2,M1,N2,M1,N2,S262,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S263(M2+1:N3,N0+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K2
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N2,X56,S263,-1.000)
       deallocate(S263)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,M1+1:N2))
       call reorder1342(N2,N3,N0,N2,N0,N2,N0,N2,
     & N2,N3,N0,N2,N0,N2,M1,N2,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S265(N0+1:M1,N0+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S265,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S267(N2+1:M2,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X4,S267, 1.000)
       deallocate(S267)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S265,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S266(M2+1:N3,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X3,S266,-1.000)
       deallocate(S266)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
       call reorder4312(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,N3,M1,N2,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S268(M2+1:N3,N0+1:N2,N2+1:N3,M1+1:N2))
       I1=K8*K4*K2
       I2=K6
       I3=K2
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N2,S268,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S270(N2+1:M2,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,N2,M2,M1,N2,X6,S270,-1.000)
       deallocate(S270)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder2314(M2,N3,N0,N2,N2,N3,M1,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,S268,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S269(M2+1:N3,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N2,X5,S269, 1.000)
       deallocate(S269)
C
     ...
     & N2,N3,N0,N2,N2,N3,M2,N3,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S271(M1+1:N2,N0+1:N2,N2+1:N3,M2+1:N3))
       I1=K6*K4*K2
       I2=K8
       I3=K4
...
C
     ...
     & N2,N3,N0,N2,M2,N3,M1,N2,S271,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S278(N0+1:M1,N0+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,M2,N3,N0,M1,M1,N2,X3,S278, 1.000)
       deallocate(S278)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N2,N3,M2,N3,
     & N0,N2,N2,N3,M2,N3,M1,N2,S271,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S280(M2+1:N3,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,M2,N3,M1,N2,X58,S280, 1.000)
       deallocate(S280)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N2,N3,M2,N3,
     & N0,N2,N2,N3,M2,N3,M1,N2,S271,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S281(N2+1:M2,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,N2,M2,M1,N2,X6,S281,-1.000)
       deallocate(S281)
C
       allocate(D1(N2+1:N3,N0+1:N2,M2+1:N3,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N2,N3,M2,N3,
     & N2,N3,N0,N2,M2,N3,M1,N2,S271,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S272(M1+1:N2,N0+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K2
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N2,M2,N3,M1,N2,M1,N2,X1,S272, 1.000)
       deallocate(S272)
C
     ...
     & N2,N3,N0,N2,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S273(M1+1:N2,N0+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4*K2
       I2=K8
       I3=K4
...
C
     ...
     & N2,N3,N0,N2,N2,M2,M1,N2,S273,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S279(N0+1:M1,N0+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K2
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,N2,N2,M2,N0,M1,M1,N2,X4,S279, 1.000)
       deallocate(S279)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N2,N3,N2,M2,
     & N0,N2,N2,N3,N2,M2,M1,N2,S273,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S282(M2+1:N3,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,M1,N2,X6,S282, 1.000)
       deallocate(S282)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:M2,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N2,N3,N2,M2,
     & N2,N3,N0,N2,N2,M2,M1,N2,S273,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S274(M1+1:N2,N0+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K2
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,N2,N2,M2,M1,N2,M1,N2,X2,S274, 1.000)
       deallocate(S274)
C
     ...
     & N2,N3,N0,N2,N0,N2,N0,M1,VCHHHP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S275(M1+1:N2,N0+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S275,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S276(M2+1:N3,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X3,S276, 1.000)
       deallocate(S276)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S275,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S277(N2+1:M2,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X4,S277,-1.000)
       deallocate(S277)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder4312(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,N2,N0,N2,N2,N3,N0,M1,VCHHHP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S283(M2+1:N3,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K6
       I3=K2
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,S283,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S285(N2+1:M2,N2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,N2,M2,N0,M1,X8,S285,-1.000)
       deallocate(S285)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder2314(M2,N3,N0,N2,N2,N3,N0,M1,
     & N0,N2,N2,N3,M2,N3,N0,M1,S283,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S284(M2+1:N3,N2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,N0,M1,X7,S284, 1.000)
       deallocate(S284)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,N0,N2,N2,N3,M2,N3,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S286(N0+1:M1,N0+1:N2,N2+1:N3,M2+1:N3))
       I1=K6*K4*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,S286,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S288(N2+1:M2,N2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,N2,M2,N0,M1,X8,S288, 1.000)
       deallocate(S288)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N2,N3,M2,N3,
     & N0,N2,N2,N3,M2,N3,N0,M1,S286,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S287(M2+1:N3,N2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,M2,N3,N0,M1,X59,S287,-1.000)
       deallocate(S287)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:N3,N2+1:M2))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,N0,N2,N2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S289(N0+1:M1,N0+1:N2,N2+1:N3,N2+1:M2))
       I1=K0*K4*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,S289,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S290(M2+1:N3,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,N0,M1,X8,S290,-1.000)
       deallocate(S290)
C
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S291(M1+1:N2,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,S291,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S292(M2+1:N3,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X9,S292,-1.000)
       deallocate(S292)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,M1,M2,N3,M2,N3,M1,N2,X9,VBHPPH, 1.000)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z9(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K6*K5
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z9, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z9,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z9,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z9, 1.000)
       deallocate(Z9)
       deallocate(X9)
C
     ...
     & N2,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S293(M1+1:N2,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N2,S293,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S294(M2+1:N3,M1+1:N1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K7
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N2,X10,S294,-1.000)
       deallocate(S294)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
     & M1,N1,M2,N3,M2,N3,M1,N2,X10,VBHPPH, 1.000)
C
       allocate(F2(M1+1:N1,M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z10(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K6*K7
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z10, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z10,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z10,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z10, 1.000)
       deallocate(Z10)
       deallocate(X10)
C
     ...
     & N2,N3,N0,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S295(M1+1:N2,N0+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,S295,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S299(N2+1:M2,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,M1,N2,X13,S299,-1.000)
       deallocate(S299)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C3,F2)
       allocate(Z13(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K9*K5
...
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z13, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z13,-1.000)
       deallocate(Z13)
       deallocate(X13)
C
       allocate(D1(N0+1:N2,N0+1:M1,N1+1:M2,M1+1:N2))
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,S295,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S296(M2+1:N3,N0+1:M1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K5
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X11,S296,-1.000)
       deallocate(S296)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
     & N0,M1,N1,M2,M2,N3,M1,N2,X11,VBHPPH, 1.000)
C
       allocate(F2(N0+1:M1,N1+1:M2,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z11(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K9*K5
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z11, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z11,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z11,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z11, 1.000)
       deallocate(Z11)
       deallocate(X11)
C
     ...
     & N2,N3,N0,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S297(M1+1:N2,N0+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,S297,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S300(N2+1:M2,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,M1,N2,X14,S300,-1.000)
       deallocate(S300)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3C3,F2)
       allocate(Z14(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K9*K7
...
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z14, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z14,-1.000)
       deallocate(Z14)
       deallocate(X14)
C
       allocate(D1(N0+1:N2,M1+1:N1,N1+1:M2,M1+1:N2))
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,S297,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S298(M2+1:N3,M1+1:N1,N1+1:M2,M1+1:N2))
       I1=K8*K9*K7
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M1,N1,N1,M2,M2,N3,M1,N2,X12,S298,-1.000)
       deallocate(S298)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3C1,F2)
       allocate(Z12(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K9*K7
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z12, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z12,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z12,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z12, 1.000)
       deallocate(Z12)
       deallocate(X12)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S301(N0+1:M1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,M2,N3,N0,M1,S301,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S302(M2+1:N3,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,N0,M1,X15,S302,-1.000)
       deallocate(S302)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(Z15(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K6*K5
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z15, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z15,-1.000)
       deallocate(Z15)
       deallocate(X15)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N1,M2+1:N3))
     ...
     & N2,N3,N0,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S303(N0+1:M1,N0+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,M2,N3,N0,M1,S303,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S304(M2+1:N3,M1+1:N1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K7
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,N0,M1,X16,S304,-1.000)
       deallocate(S304)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(Z16(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K6*K7
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z16, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z16,-1.000)
       deallocate(Z16)
       deallocate(X16)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,N1+1:M2))
     ...
     & N2,N3,N0,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S305(N0+1:M1,N0+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N1,M2,N0,M1,S305,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S309(N2+1:M2,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,N0,M1,X19,S309,-1.000)
       deallocate(S309)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C3,F2)
       allocate(Z19(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K8*K8*K6*K6
       I3=K9*K5
...
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z19, 1.000)
       deallocate(Z19)
       deallocate(X19)
C
       allocate(D1(N0+1:N2,N0+1:M1,N1+1:M2,N0+1:M1))
     ...
     & N0,N2,N0,M1,N1,M2,N0,M1,S305,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S306(M2+1:N3,N0+1:M1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K5
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,N0,M1,X17,S306,-1.000)
       deallocate(S306)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(Z17(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K9*K5
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z17, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z17,-1.000)
       deallocate(Z17)
       deallocate(X17)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N1,N1+1:M2))
     ...
     & N2,N3,N0,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S307(N0+1:M1,N0+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N1,N1,M2,N0,M1,S307,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S310(N2+1:M2,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K7
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,N0,M1,X20,S310,-1.000)
       deallocate(S310)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C3,F2)
       allocate(Z20(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K8*K8*K6*K6
       I3=K9*K7
...
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z20, 1.000)
       deallocate(Z20)
       deallocate(X20)
C
       allocate(D1(N0+1:N2,M1+1:N1,N1+1:M2,N0+1:M1))
     ...
     & N0,N2,M1,N1,N1,M2,N0,M1,S307,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S308(M2+1:N3,M1+1:N1,N1+1:M2,N0+1:M1))
       I1=K5*K9*K7
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M1,N1,N1,M2,M2,N3,N0,M1,X18,S308,-1.000)
       deallocate(S308)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       ...
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       allocate(Z18(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K9*K7
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z18, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z18,-1.000)
       deallocate(Z18)
       deallocate(X18)
C
     ...
     & N2,N3,N0,M1,M1,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S311(M1+1:N2,N0+1:M1,M1+1:N2,N2+1:N3))
       I1=K4*K8*K5
       I2=K8
       I3=K4
...
C
     ...
     & N2,N3,N0,M1,M1,N2,M1,N2,S311,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S317(N0+1:M1,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N2,N0,M1,M1,N2,X31,S317, 1.000)
       deallocate(S317)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
     & N0,M1,M1,N2,N0,M1,M1,N2,X31,VCHHHH, 1.000)
C
       allocate(F2(N0+1:M1,M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder451236(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,t3D,F2)
       allocate(Z31(M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K8*K0*K6*K6
       I3=K8*K5
...
C
       call
     & sum123546(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z31,-1.000)
       call
     & sum123645(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z31, 1.000)
       deallocate(Z31)
       deallocate(X31)
C
       allocate(D1(N2+1:N3,N0+1:M1,M1+1:N2,M1+1:N2))
     ...
     & N2,N3,N0,M1,M1,N2,M1,N2,S311,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S312(M1+1:N2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8*K5
       I2=K8
       I3=K4
...
C
       call
     & sum3124(N0,M1,M1,N2,M1,N2,M1,N2,X28,S312, 1.000)
       deallocate(S312)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
     & N0,M1,M1,N2,M1,N2,M1,N2,X28,VCHHHH, 1.000)
C
       allocate(F2(N0+1:M1,M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1))
       call reorder461235(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,t3D,F2)
       allocate(Z28(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8
       I2=K5*K0*K6*K6
       I3=K8*K5
...
C
     ...
     & N2,N3,N0,M1,N0,M1,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S315(M1+1:N2,N0+1:M1,N0+1:M1,N2+1:N3))
       I1=K4*K5*K5
       I2=K8
       I3=K4
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N2,S315,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S316(N0+1:M1,N0+1:M1,N0+1:M1,M1+1:N2))
       I1=K8*K5*K5
       I2=K5
       I3=K4
...
C
       call
     & sum3124(N0,M1,N0,M1,N0,M1,M1,N2,X30,S316, 1.000)
       deallocate(S316)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
     & N0,M1,N0,M1,N0,M1,M1,N2,X30,VCHHHH, 1.000)
C
       allocate(F2(N0+1:M1,N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder451236(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,t3D,F2)
       allocate(Z30(M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K8*K0*K6*K6
       I3=K5*K5
...
C
       call
     & sum123546(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z30,-0.500)
       call
     & sum123645(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z30, 0.500)
       deallocate(Z30)
       deallocate(X30)
C
     ...
     & N2,N3,M1,N2,M1,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S313(M1+1:N2,M1+1:N2,M1+1:N2,N2+1:N3))
       I1=K4*K8*K8
       I2=K8
       I3=K4
...
C
     ...
     & N2,N3,M1,N2,M1,N2,M1,N2,S313,D1)
       allocate(B2(N2+1:N3,N0+1:M1))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S318(N0+1:M1,M1+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K8
       I2=K5
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N2,N0,M1,M1,N2,X32,S318, 1.000)
       deallocate(S318)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
     & M1,N2,M1,N2,N0,M1,M1,N2,X32,VCHHHH, 1.000)
C
       allocate(F2(M1+1:N2,M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder451236(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,t3D,F2)
       allocate(Z32(M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5
       I2=K8*K0*K6*K6
       I3=K8*K8
...
C
       call
     & sum123546(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z32,-0.500)
       call
     & sum123645(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z32, 0.500)
       deallocate(Z32)
       deallocate(X32)
C
       allocate(D1(N2+1:N3,M1+1:N2,M1+1:N2,M1+1:N2))
     ...
     & N2,N3,M1,N2,M1,N2,M1,N2,S313,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S314(M1+1:N2,M1+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K8
       I2=K8
       I3=K4
...
C
       call
     & sum3124(M1,N2,M1,N2,M1,N2,M1,N2,X29,S314, 1.000)
       deallocate(S314)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
     & M1,N2,M1,N2,M1,N2,M1,N2,X29,VCHHHH, 1.000)
C
       allocate(F2(M1+1:N2,M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1))
       call reorder561234(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,t3D,F2)
       allocate(Z29(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8*K8
       I2=K5*K0*K6*K6
       I3=K8*K8
...
C
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S319(M1+1:N2,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K8
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,M1,N2,S319,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S320(M2+1:N3,N0+1:M1,M2+1:N3,M1+1:N2))
       I1=K8*K6*K5
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X33,S320, 1.000)
       deallocate(S320)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,M1,M2,N3,M2,N3,M1,N2,X33,VCHPHP, 1.000)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z33(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K6*K5
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z33,-1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z33, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z33, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z33,-1.000)
       deallocate(Z33)
       deallocate(X33)
C
     ...
     & N2,N3,N0,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S321(M1+1:N2,N0+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,S321,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S322(M2+1:N3,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6*K8
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X34,S322, 1.000)
       deallocate(S322)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & M1,N2,M2,N3,M2,N3,M1,N2,X34,VCHPHP, 1.000)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z34(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K6*K8
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z34, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z34,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z34,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z34, 1.000)
       deallocate(Z34)
       deallocate(X34)
C
     ...
     & N2,N3,N0,N2,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S323(M1+1:N2,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,S323,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S324(M2+1:N3,N0+1:M1,N2+1:M2,M1+1:N2))
       I1=K8*K0*K5
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N2,X35,S324, 1.000)
       deallocate(S324)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,M1,N2,M2,M2,N3,M1,N2,X35,VCHPHP, 1.000)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder421356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z35(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K0*K5
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z35, 1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z35,-1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z35,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z35, 1.000)
       deallocate(Z35)
       deallocate(X35)
C
     ...
     & N2,N3,N0,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S325(M1+1:N2,N0+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,S325,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S326(M2+1:N3,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K8
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M1,N2,N2,M2,M2,N3,M1,N2,X36,S326, 1.000)
       deallocate(S326)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & M1,N2,N2,M2,M2,N3,M1,N2,X36,VCHPHP, 1.000)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder521346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z36(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M1+1:N2))
       I1=K8*K6
       I2=K8*K5*K0*K6
       I3=K0*K8
...
C
       call
     & sum234516(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z36,-1.000)
       call
     & sum134526(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z36, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z36, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z36,-1.000)
       deallocate(Z36)
       deallocate(X36)
C
     ...
     & N2,N3,N0,M1,N0,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S327(M1+1:N2,N0+1:M1,N0+1:N2,N2+1:M2))
       I1=K0*K2*K5
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,S327,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S328(N2+1:M2,N0+1:M1,N2+1:M2,M1+1:N2))
       I1=K8*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N2,X60,S328,-1.000)
       deallocate(S328)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(Z114(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X60,F2,Z114)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z114,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z114, 1.000)
       deallocate(Z114)
       deallocate(X60)
C
     ...
     & N2,N3,M1,N2,N0,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S329(M1+1:N2,M1+1:N2,N0+1:N2,N2+1:M2))
       I1=K0*K2*K8
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,S329,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S330(N2+1:M2,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,M1,N2,X61,S330,-1.000)
       deallocate(S330)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder531246(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,t3D,F2)
       allocate(Z115(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,N2+1:M2,M1+1:N2))
       I1=K8*K0
       I2=K8*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X61,F2,Z115)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z115, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z115,-1.000)
       deallocate(Z115)
       deallocate(X61)
C
...
C
       call
     & sum21(N0,M1,N0,M1,X23,Q52, 1.000)
       deallocate(Q52)
C
       call sumx21(N0,N2,N0,N2,
     & N0,M1,N0,M1,X23,FBHH, 1.000)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z23(M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K8*K0*K6*K6
       I3=K5
...
C
       call
     & sum123564(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z23,-1.000)
       deallocate(Z23)
       deallocate(X23)
C
       allocate(B1(N2+1:N3,N0+1:M1))
...
C
       call
     & sum21(N0,M1,M1,N2,X21,Q49, 1.000)
       deallocate(Q49)
C
       call sumx21(N0,N2,N0,N2,
...
C
       ...
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z21(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8
       I2=K8*K5*K0*K6*K6
       I3=K5
...
C
       V3D=V3D-Z21
       call
     & sum123465(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z21, 1.000)
       deallocate(Z21)
       deallocate(X21)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
     ...
     & N2,N3,N0,N2,N0,M1,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S331(N0+1:M1,N0+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,N0,M1,S331,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S332(M2+1:N3,N0+1:M1,M2+1:N3,N0+1:M1))
       I1=K5*K6*K5
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,N0,M1,X39,S332, 1.000)
       deallocate(S332)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,M1,M2,N3,M2,N3,N0,M1,X39,VCHPHP, 1.000)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z39(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K6*K5
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z39,-1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z39, 1.000)
       deallocate(Z39)
       deallocate(X39)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N2,M2+1:N3))
     ...
     & N2,N3,N0,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S333(N0+1:M1,N0+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,M2,N3,N0,M1,S333,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S334(M2+1:N3,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6*K8
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,N0,M1,X40,S334, 1.000)
       deallocate(S334)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & M1,N2,M2,N3,M2,N3,N0,M1,X40,VCHPHP, 1.000)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z40(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K6*K8
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z40,-1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z40, 1.000)
       deallocate(Z40)
       deallocate(X40)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,N2+1:M2))
     ...
     & N2,N3,N0,N2,N0,M1,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S335(N0+1:M1,N0+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N2,M2,N0,M1,S335,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S336(M2+1:N3,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,N0,M1,X41,S336, 1.000)
       deallocate(S336)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & N0,M1,N2,M2,M2,N3,N0,M1,X41,VCHPHP, 1.000)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder421356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z41(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K0*K5
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z41, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z41,-1.000)
       deallocate(Z41)
       deallocate(X41)
C
       allocate(D1(N2+1:N3,N0+1:N2,M1+1:N2,N2+1:M2))
     ...
     & N2,N3,N0,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S337(N0+1:M1,N0+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,N2,M2,N0,M1,S337,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S338(M2+1:N3,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M1,N2,N2,M2,M2,N3,N0,M1,X42,S338, 1.000)
       deallocate(S338)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
     & M1,N2,N2,M2,M2,N3,N0,M1,X42,VCHPHP, 1.000)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder421356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z42(M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       I1=K5*K6
       I2=K8*K8*K0*K6
       I3=K0*K8
...
C
       call
     & sum235614(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z42, 1.000)
       call
     & sum135624(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z42,-1.000)
       deallocate(Z42)
       deallocate(X42)
C
       allocate(D1(N2+1:N3,N0+1:M1,N0+1:N2,N2+1:M2))
     ...
     & N2,N3,N0,M1,N0,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S339(N0+1:M1,N0+1:M1,N0+1:N2,N2+1:M2))
       I1=K0*K2*K5
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N0,M1,N2,M2,N0,M1,S339,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S340(N2+1:M2,N0+1:M1,N2+1:M2,N0+1:M1))
       I1=K5*K0*K5
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,N0,M1,X62,S340,-1.000)
       deallocate(S340)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(Z131(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K8*K8*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X62,F2,Z131)
       deallocate(F2)
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z131,-1.000)
       deallocate(Z131)
       deallocate(X62)
C
       allocate(D1(N2+1:N3,M1+1:N2,N0+1:N2,N2+1:M2))
     ...
     & N2,N3,M1,N2,N0,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S341(N0+1:M1,M1+1:N2,N0+1:N2,N2+1:M2))
       I1=K0*K2*K8
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,M1,N2,N2,M2,N0,M1,S341,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S342(N2+1:M2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0*K8
       I2=K0
       I3=K2
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,N0,M1,X63,S342,-1.000)
       deallocate(S342)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder431256(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       allocate(Z132(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       I1=K5*K0
       I2=K8*K8*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X63,F2,Z132)
       deallocate(F2)
C
       call
     & sum125634(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z132,-1.000)
       deallocate(Z132)
       deallocate(X63)
C
...
C
       call
     & sum21(M1,N2,N0,M1,X24,Q53, 1.000)
       deallocate(Q53)
C
       call sumx21(N0,N2,N0,N2,
     & M1,N2,N0,M1,X24,FBHH, 1.000)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       allocate(Z24(M2+1:N3,M2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2,N0+1:M1))
       I1=K5
       I2=K8*K8*K0*K6*K6
       I3=K8
...
C
       call
     & sum123564(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z24,-1.000)
       deallocate(Z24)
       deallocate(X24)
C
       allocate(B1(N2+1:N3,M1+1:N2))
...
C
       call
     & sum21(M1,N2,M1,N2,X22,Q51, 1.000)
       deallocate(Q51)
C
       call sumx21(N0,N2,N0,N2,
...
C
       ...
       call reorder512346(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,t3D,F2)
       allocate(Z22(M2+1:N3,M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       I1=K8
       I2=K8*K5*K0*K6*K6
       I3=K8
...
C
       V3D=V3D+Z22
       call
     & sum123465(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z22,-1.000)
       deallocate(Z22)
       deallocate(X22)
C
       allocate(D1(N0+1:N2,N0+1:N2,M2+1:N3,N2+1:M2))
     ...
     & N0,N2,N0,N2,M2,N3,N2,M2,VCHHPP,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       allocate(S254(M2+1:N3,M2+1:N3,M2+1:N3,N2+1:M2))
       I1=K0*K6
       I2=K6*K6
       I3=K2*K2
       ...
       deallocate(D2)
C
       allocate(X45(M2+1:N3,N2+1:M2,M2+1:N3,M2+1:N3))
       X45=0.0d0
       call
     & sum3412(M2,N3,N2,M2,M2,N3,M2,N3,X45,S254, 0.500)
       deallocate(S254)
C
       allocate(D1(N0+1:N2,N0+1:N2,M2+1:N3,N2+1:M2))
     ...
     & N0,N2,N0,N2,M2,N3,N2,M2,VCHHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S343(M2+1:N3,N0+1:N2,M2+1:N3,N2+1:M2))
       I1=K0*K6*K2
       I2=K6
       I3=K2
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M2,N3,S343,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S347(N2+1:M2,M2+1:N3,N2+1:M2,M2+1:N3))
       I1=K6*K0*K6
       I2=K0
       I3=K2
...
C
       call
     & sum4123(M2,N3,N2,M2,M2,N3,N2,M2,X47,S347,-1.000)
       deallocate(S347)
C
       call sumx1234(N2,N3,N2,N3,N2,N3,N2,M2,
     & M2,N3,N2,M2,M2,N3,N2,M2,X47,VCAPPP, 1.000)
C
     ...
     & M2,N3,N2,M2,M2,N3,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z47(M2+1:N3,N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3,N2+1:M2))
       I1=K0*K6
       I2=K8*K8*K5*K6
       I3=K0*K6
...
C
       call
     & sum245613(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z47, 1.000)
       call
     & sum145623(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z47,-1.000)
       deallocate(Z47)
       deallocate(X47)
C
       allocate(D1(N0+1:N2,M2+1:N3,N2+1:M2,M2+1:N3))
     ...
     & N0,N2,M2,N3,N2,M2,M2,N3,S343,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S344(M2+1:N3,M2+1:N3,N2+1:M2,M2+1:N3))
       I1=K6*K0*K6
       I2=K6
       I3=K2
...
C
       call
     & sum3124(M2,N3,N2,M2,M2,N3,M2,N3,X45,S344, 1.000)
       deallocate(S344)
C
       call sumx3412(N2,N3,N2,N3,N2,N3,N2,M2,
     & M2,N3,N2,M2,M2,N3,M2,N3,X45,VCAPPP, 1.000)
C
       allocate(F2(M2+1:N3,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder123456(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z45(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K8*K8*K5*K0
       I3=K0*K6
...
C
       call
     & sum345612(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z45, 1.000)
       deallocate(Z45)
       deallocate(X45)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:M2,N2+1:M2))
     ...
     & N0,N2,N0,N2,N2,M2,N2,M2,VCHHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S345(M2+1:N3,N0+1:N2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K2
       I2=K6
       I3=K2
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M2,N3,S345,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S348(N2+1:M2,N2+1:M2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K0
       I2=K0
       I3=K2
...
C
       call
     & sum4123(N2,M2,N2,M2,M2,N3,N2,M2,X48,S348,-1.000)
       deallocate(S348)
C
       call sumx1234(N2,N3,N2,N3,N2,N3,N2,M2,
     & N2,M2,N2,M2,M2,N3,N2,M2,X48,VCAPPP, 1.000)
C
     ...
     & N2,M2,N2,M2,M2,N3,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z48(M2+1:N3,N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3,N2+1:M2))
       I1=K0*K6
       I2=K8*K8*K5*K6
       I3=K0*K0
...
C
       call
     & sum245613(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z48,-0.500)
       call
     & sum145623(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z48, 0.500)
       deallocate(Z48)
       deallocate(X48)
C
       allocate(D1(N0+1:N2,N2+1:M2,N2+1:M2,M2+1:N3))
     ...
     & N0,N2,N2,M2,N2,M2,M2,N3,S345,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S346(M2+1:N3,N2+1:M2,N2+1:M2,M2+1:N3))
       I1=K6*K0*K0
       I2=K6
       I3=K2
...
C
       call
     & sum3124(N2,M2,N2,M2,M2,N3,M2,N3,X46,S346, 1.000)
       deallocate(S346)
C
       call sumx3412(N2,N3,N2,N3,N2,N3,N2,M2,
     & N2,M2,N2,M2,M2,N3,M2,N3,X46,VCAPPP, 1.000)
C
       allocate(F2(N2+1:M2,N2+1:M2,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2))
       call reorder123456(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z46(N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3,M2+1:N3))
       I1=K6*K6
       I2=K8*K8*K5*K0
       I3=K0*K0
...
C
       call
     & sum345612(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z46, 0.500)
       deallocate(Z46)
       deallocate(X46)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X25,Q55,-1.000)
       deallocate(Q55)
C
...
C
       ...
       call reorder123456(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z25(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6
       I2=K8*K8*K5*K0*K6
       I3=K6
...
C
       call
     & sum234561(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z25, 1.000)
       call
     & sum134562(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z25,-1.000)
       deallocate(Z25)
       deallocate(X25)
C
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q56,B2,Q58)
       deallocate(B2)
C
       call
     & sum21(N2,M2,N2,M2,X27,Q58,-1.000)
       deallocate(Q58)
C
       call sumx12(N2,N3,N2,N3,
...
C
       ...
       call reorder312456(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N2,M2,M2,N3,M2,N3,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z27(M2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0
       I2=K8*K8*K5*K6*K6
       I3=K0
...
C
       call
     & sum124563(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z27, 1.000)
       deallocate(Z27)
       deallocate(X27)
C
       allocate(B2(N0+1:N2,M2+1:N3))
...
C
       call
     & sum21(N2,M2,M2,N3,X26,Q57,-1.000)
       deallocate(Q57)
C
       call sumx12(N2,N3,N2,N3,
...
C
       ...
       call reorder213456(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N2,M2,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,t3D,F2)
       allocate(Z26(M2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6
       I2=K8*K8*K5*K0*K6
       I3=K0
...
C
       call
     & sum234561(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z26,-1.000)
       call
     & sum134562(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z26, 1.000)
       deallocate(Z26)
       deallocate(X26)
C
     ...
     & N2,N3,N0,N2,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S349(M1+1:N2,N0+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N1,N1,N3,N0,N2,M1,N2,S349,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S351(N2+1:M2,M1+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X57,S351, 1.000)
       deallocate(S351)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S349,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S352(M2+1:N3,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K6
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,M2,N3,N0,M1,M1,N2,X3,S352, 1.000)
       deallocate(S352)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S349,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S353(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X4,S353, 1.000)
       deallocate(S353)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S349,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S350(M2+1:N3,M1+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K8*K6
       I3=K3*K1
...
C
       call
     & sum2314(N0,N2,M2,N3,M1,N2,M1,N2,X56,S350, 1.000)
       deallocate(S350)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,N1+1:N3))
       call reorder1342(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N0,N2,N0,N1,N1,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S354(N0+1:M1,N0+1:N2,N0+1:N1,N1+1:N3))
       I1=K3*K1*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N1,N1,N3,N0,N2,N0,M1,S354,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S356(N2+1:M2,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K0
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X4,S356,-1.000)
       deallocate(S356)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:M1))
       call reorder3421(N0,M1,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,N0,M1,S354,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S355(M2+1:N3,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K6
       I3=K3*K1
...
C
       call
     & sum2413(N0,N2,M2,N3,N0,M1,M1,N2,X3,S355,-1.000)
       deallocate(S355)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N2,t2B,D2)
       allocate(S357(M2+1:N3,M1+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K8*K6
       I3=K3*K1
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N2,S357,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S361(N2+1:M2,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,N2,M2,M1,N2,X6,S361, 1.000)
       deallocate(S361)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder3412(M2,N3,M1,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,M2,N3,M1,N2,S357,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S358(M2+1:N3,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N2,X58,S358, 1.000)
       deallocate(S358)
C
       allocate(D2(N2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(Z64(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K6
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X58,D2,Z64)
       deallocate(D2)
C
       call
     & sum345126(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z64, 1.000)
       call
     & sum345216(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z64,-1.000)
       call
     & sum346125(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z64,-1.000)
       call
     & sum346215(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z64, 1.000)
       deallocate(Z64)
       deallocate(X58)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       allocate(S359(N2+1:M2,M1+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K8*K0
       I3=K3*K1
...
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,S359,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S360(M2+1:N3,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,M1,N2,X6,S360,-1.000)
       deallocate(S360)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,M2,N3,N0,M1,t2B,D2)
       allocate(S362(M2+1:N3,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K6
       I3=K3*K1
...
C
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,S362,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N2,N3,M2,N3,N2,M2,N0,M1,X8,S366, 1.000)
       deallocate(S366)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder3412(M2,N3,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,M2,N3,N0,M1,S362,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S363(M2+1:N3,N2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,N0,M1,X59,S363, 1.000)
       deallocate(S363)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N0,N2,N2,N3,VBHHPP,D1)
       ...
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,N0,M1,t2B,D2)
       allocate(S364(N2+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K0
       I3=K3*K1
...
C
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,S364,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S365(M2+1:N3,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,N0,M1,X8,S365,-1.000)
       deallocate(S365)
C
     ...
     & N2,N3,N0,N2,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S367(M1+1:N2,N0+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2*K2
       I2=K8
       I3=K4
...
C
     ...
     & N0,N2,N0,N2,N2,N3,M1,N2,S367,D1)
       allocate(D2(N0+1:N2,N0+1:N2,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       allocate(S369(M2+1:N3,M2+1:N3,N2+1:N3,M1+1:N2))
       I1=K8*K4
       I2=K6*K6
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,M2,N3,M2,N3,M1,N2,X5,S369,-0.500)
       deallocate(S369)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,N0,N2,M1,N2,S367,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S370(N2+1:M2,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,N2,M2,N0,M1,M1,N2,X4,S370, 1.000)
       deallocate(S370)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
     ...
     & N0,N2,N2,N3,N0,N2,M1,N2,S367,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S371(M2+1:N3,N0+1:M1,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K5*K6
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,M2,N3,N0,M1,M1,N2,X3,S371,-1.000)
       deallocate(S371)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder2431(M1,N2,N0,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,N0,N2,M1,N2,S367,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S372(M2+1:N3,M1+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,M2,N3,M1,N2,M1,N2,X56,S372,-1.000)
       deallocate(S372)
C
       allocate(D2(N0+1:N2,M2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,M2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(Z58(M2+1:N3,N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2,M1+1:N2))
       I1=K8*K8*K6
       I2=K5*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X56,D2,Z58)
       deallocate(D2)
C
       call
     & sum234156(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z58,-1.000)
       call
     & sum134256(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z58, 1.000)
       call
     & sum234165(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z58, 1.000)
       call
     & sum134265(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z58,-1.000)
       deallocate(Z58)
       deallocate(X56)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
     ...
     & N0,N2,N2,N3,N0,N2,M1,N2,S367,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S373(N2+1:M2,M1+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X57,S373, 1.000)
       deallocate(S373)
C
       allocate(D2(N0+1:N2,M2+1:N3,M2+1:N3,N0+1:M1))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,M2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(Z59(M2+1:N3,M2+1:N3,N0+1:M1,N2+1:M2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K0
       I2=K5*K6*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X57,D2,Z59)
       deallocate(D2)
C
       call
     & sum124356(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z59,-1.000)
       call
     & sum124365(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z59, 1.000)
       deallocate(Z59)
       deallocate(X57)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,M1+1:N2))
       call reorder4231(M1,N2,N0,N2,N0,N2,N2,N3,
     & N2,N3,N0,N2,N0,N2,M1,N2,S367,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
       allocate(S399(M1+1:N2,N0+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2*K2
       I2=K8
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:N2,M1+1:N2,M1+1:N2))
       call reorder2314(M1,N2,N0,N2,N0,N2,M1,N2,
     & N0,N2,N0,N2,M1,N2,M1,N2,S399,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S400(M2+1:N3,N0+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K2
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N2,X1,S400, 1.000)
       deallocate(S400)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,M1+1:N2))
       call reorder4231(M1,N2,N0,N2,N0,N2,N2,N3,
     & N2,N3,N0,N2,N0,N2,M1,N2,S367,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S402(N0+1:M1,N0+1:N2,N0+1:N2,M1+1:N2))
       I1=K8*K2*K2
       I2=K5
       I3=K4
...
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
       call reorder2314(N0,M1,N0,N2,N0,N2,M1,N2,
     & N0,N2,N0,N2,N0,M1,M1,N2,S402,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S403(M2+1:N3,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X3,S403, 1.000)
       deallocate(S403)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
     ...
     & N0,N2,N0,N2,N2,N3,M1,N2,S367,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S405(M2+1:N3,N0+1:N2,N2+1:N3,M1+1:N2))
       I1=K8*K4*K2
       I2=K6
       I3=K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder2314(M2,N3,N0,N2,N2,N3,M1,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,S405,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S406(M2+1:N3,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N2,X5,S406,-1.000)
       deallocate(S406)
C
       call sumx2314(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,M2,N3,M2,N3,M1,N2,X5,VCHPPP, 1.000)
C
       allocate(D2(N2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(Z5(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K6
       I2=K8*K5*K0
       I3=K4
...
C
       call
     & sum345126(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z5,-1.000)
       call
     & sum346125(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z5, 1.000)
       deallocate(Z5)
       deallocate(X5)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
     ...
     & N0,N2,N0,N2,N2,N3,M1,N2,S367,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S407(N2+1:M2,N0+1:N2,N2+1:N3,M1+1:N2))
       I1=K8*K4*K2
       I2=K0
       I3=K2
...
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,S407,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S408(M2+1:N3,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,M1,N2,X6,S408,-1.000)
       deallocate(S408)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,N2,N2,N3,
     & N0,N2,N0,N2,N2,N3,M1,N2,S367,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,N2,M2,t2C,D2)
       allocate(S368(M2+1:N3,N2+1:M2,N2+1:N3,M1+1:N2))
       I1=K8*K4
       I2=K0*K6
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,M2,N3,N2,M2,M1,N2,X6,S368,-0.500)
       deallocate(S368)
C
       call sumx2314(N2,N3,N2,N3,N2,N3,N0,N2,
     & N2,N3,M2,N3,N2,M2,M1,N2,X6,VCHPPP, 1.000)
C
       allocate(D2(N2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(Z6(M2+1:N3,N0+1:M1,M1+1:N2,M2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K6
       I2=K8*K5*K6
       I3=K4
...
C
       call
     & sum245136(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z6, 1.000)
       call
     & sum145236(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z6,-1.000)
       call
     & sum246135(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z6,-1.000)
       call
     & sum146235(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z6, 1.000)
       deallocate(Z6)
       deallocate(X6)
C
       allocate(D1(N0+1:N2,N0+1:N2,M1+1:N2,M1+1:N2))
     ...
     & N0,N2,N0,N2,M1,N2,M1,N2,S399,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S401(N2+1:M2,N0+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,M1,N2,M1,N2,X2,S401,-1.000)
       deallocate(S401)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
       call reorder3214(N0,M1,N0,N2,N0,N2,M1,N2,
     & N0,N2,N0,N2,N0,M1,M1,N2,S402,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S404(N2+1:M2,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X4,S404,-1.000)
       deallocate(S404)
C
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S386)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X2,S386,-1.000)
       deallocate(S386)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q59,B1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S396(M2+1:N3,N0+1:M1,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K5*K6
       I3=K4
...
C
       call
     & sum2341(N0,N2,M2,N3,N0,M1,M1,N2,X3,S396,-1.000)
       deallocate(S396)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S398)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,N0,M1,M1,N2,X4,S398,-1.000)
       deallocate(S398)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     & N2,N3,N0,N2,Q59,B1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       allocate(S384(M2+1:N3,M1+1:N2,M1+1:N2,N0+1:N2))
       I1=K2
       I2=K8*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S384)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N2,X1,S384,-1.000)
       deallocate(S384)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,N2+1:N3))
       call reorder1342(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N0,N2,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S374(N0+1:M1,N0+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2*K2
       I2=K5
       I3=K4
...
C
     ...
     & N0,N2,N2,N3,N0,N2,N0,M1,S374,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S387(N2+1:M2,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K0
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,N2,M2,N0,M1,M1,N2,X68,S387,-1.000)
       deallocate(S387)
C
       allocate(D2(N0+1:N2,M2+1:N3,M2+1:N3,M1+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,M2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(Z212(M2+1:N3,M2+1:N3,M1+1:N2,N2+1:M2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K0
       I2=K8*K6*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X68,D2,Z212)
       deallocate(D2)
C
       call
     & sum126345(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z212,-1.000)
       call
     & sum125346(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z212, 1.000)
       deallocate(Z212)
       deallocate(X68)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,N2,N2,N3,
     & N0,N2,N0,N2,N2,N3,N0,M1,S374,D1)
       allocate(D2(N0+1:N2,N0+1:N2,M2+1:N3,N2+1:M2))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,N2,M2,t2C,D2)
       allocate(S375(M2+1:N3,N2+1:M2,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K0*K6
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,M2,N3,N2,M2,N0,M1,X8,S375,-0.500)
       deallocate(S375)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
       call reorder2341(N0,M1,N0,N2,N0,N2,N2,N3,
     & N0,N2,N0,N2,N2,N3,N0,M1,S374,D1)
       ...
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N0,N2,M2,N3,M2,N3,t2C,D2)
       allocate(S376(M2+1:N3,M2+1:N3,N2+1:N3,N0+1:M1))
       I1=K5*K4
       I2=K6*K6
       I3=K2*K2
...
C
       call
     & sum2314(N2,N3,M2,N3,M2,N3,N0,M1,X7,S376,-0.500)
       deallocate(S376)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
     ...
     & N0,N2,N0,N2,N2,N3,N0,M1,S374,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S409(M2+1:N3,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K6
       I3=K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder2314(M2,N3,N0,N2,N2,N3,N0,M1,
     & N0,N2,N2,N3,M2,N3,N0,M1,S409,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S410(M2+1:N3,N2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,N0,M1,X7,S410,-1.000)
       deallocate(S410)
C
       call sumx2314(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       allocate(Z7(N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K6
       I2=K8*K8*K0
       I3=K4
...
C
       call
     & sum356124(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z7,-1.000)
       deallocate(Z7)
       deallocate(X7)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N0+1:M1))
     ...
     & N0,N2,N0,N2,N2,N3,N0,M1,S374,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S411(N2+1:M2,N0+1:N2,N2+1:N3,N0+1:M1))
       I1=K5*K4*K2
       I2=K0
       I3=K2
...
C
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,S411,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S412(M2+1:N3,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,N0,M1,X8,S412,-1.000)
       deallocate(S412)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N0+1:M1))
     ...
     & N0,N2,N2,N3,N0,N2,N0,M1,S374,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S388(M2+1:N3,M1+1:N2,N0+1:N2,N0+1:M1))
       I1=K5*K2
       I2=K8*K6
       I3=K4*K2
...
C
       call
     & sum2413(N0,N2,M2,N3,N0,M1,M1,N2,X69,S388,-1.000)
       deallocate(S388)
C
       allocate(D2(N0+1:N2,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(Z213(M2+1:N3,N2+1:M2,M1+1:N2,M2+1:N3,N0+1:M1,M1+1:N2))
       I1=K8*K5*K6
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X69,D2,Z213)
       deallocate(D2)
C
       call
     & sum136245(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z213,-1.000)
       call
     & sum235146(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z213,-1.000)
       call
     & sum236145(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z213, 1.000)
       call
     & sum135246(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z213, 1.000)
       deallocate(Z213)
       deallocate(X69)
C
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(S393(N0+1:M1,M1+1:N2,N0+1:N2,N0+1:N2))
       I1=K2*K2
       I2=K8*K5
       I3=K4*K4
...
C
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S393,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S394(M2+1:N3,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N0,N2,M2,N3,N0,M1,M1,N2,X3,S394,-0.500)
       deallocate(S394)
C
...
C
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(Z3(M2+1:N3,N2+1:M2,M1+1:N2,M2+1:N3,N0+1:M1,M1+1:N2))
       I1=K8*K5*K6
       I2=K8*K0*K6
       I3=K2
...
C
       call
     & sum235146(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z3, 1.000)
       call
     & sum135246(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z3,-1.000)
       call
     & sum236145(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z3,-1.000)
       call
     & sum136245(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z3, 1.000)
       deallocate(Z3)
       deallocate(X3)
C
       allocate(D1(N0+1:N2,N0+1:N2,N0+1:M1,M1+1:N2))
     ...
     & N0,N2,N0,N2,N0,M1,M1,N2,S393,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S397(N2+1:M2,N0+1:N2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,N0,M1,M1,N2,X4,S397, 0.500)
       deallocate(S397)
C
       call sumx2134(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,M2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(Z4(M2+1:N3,M2+1:N3,M1+1:N2,N2+1:M2,N0+1:M1,M1+1:N2))
       I1=K8*K5*K0
       I2=K8*K6*K6
       I3=K2
...
C
       call
     & sum125346(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z4, 1.000)
       call
     & sum126345(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z4,-1.000)
       deallocate(Z4)
       deallocate(X4)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,M1,N2,t2C,D2)
       allocate(S391(M2+1:N3,M1+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K8*K6
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder3412(M2,N3,M1,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,M2,N3,M1,N2,S391,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S395(N2+1:M2,N2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,N2,M2,M1,N2,X70,S395,-1.000)
       deallocate(S395)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder3412(M2,N3,M1,N2,N0,N2,N2,N3,
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N2,X71,S392,-1.000)
       deallocate(S392)
C
       allocate(D2(N2+1:N3,N2+1:M2,N0+1:M1,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       allocate(Z215(N2+1:M2,N0+1:M1,M1+1:N2,M2+1:N3,M2+1:N3,M1+1:N2))
       I1=K8*K6*K6
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X71,D2,Z215)
       deallocate(D2)
C
       call
     & sum346125(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z215,-1.000)
       call
     & sum346215(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z215, 1.000)
       call
     & sum345126(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z215, 1.000)
       call
     & sum345216(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z215,-1.000)
       deallocate(Z215)
       deallocate(X71)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(S377(N2+1:M2,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K0
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,N0+1:M1))
       call reorder3412(N2,M2,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N2,M2,N0,M1,S377,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S378(M2+1:N3,N2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,N0,M1,X8,S378,-1.000)
       deallocate(S378)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
       call reorder4132(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(S379(M2+1:N3,N0+1:M1,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K5*K6
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
       call reorder3412(M2,N3,N0,M1,N0,N2,N2,N3,
     & N0,N2,N2,N3,M2,N3,N0,M1,S379,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S383(N2+1:M2,N2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K4
       I2=K0
       I3=K2
...
C
       call
     & sum3124(N2,N3,M2,N3,N2,M2,N0,M1,X8,S383,-1.000)
       deallocate(S383)
C
       call sumx2314(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       allocate(Z8(M2+1:N3,M1+1:N2,M1+1:N2,M2+1:N3,N2+1:M2,N0+1:M1))
       I1=K5*K0*K6
       I2=K8*K8*K6
       I3=K4
...
C
       call
     & sum256134(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z8, 1.000)
       call
     & sum156234(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z8,-1.000)
       deallocate(Z8)
       deallocate(X8)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N0+1:M1))
     ...
     & N0,N2,N2,N3,M2,N3,N0,M1,S379,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S380(M2+1:N3,N2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,N0,M1,X59,S380,-1.000)
       deallocate(S380)
C
       allocate(D2(N2+1:N3,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       allocate(Z70(N2+1:M2,M1+1:N2,M1+1:N2,M2+1:N3,M2+1:N3,N0+1:M1))
       I1=K5*K6*K6
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X59,D2,Z70)
       deallocate(D2)
C
       call
     & sum356124(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z70, 1.000)
       call
     & sum356214(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z70,-1.000)
       deallocate(Z70)
       deallocate(X59)
C
       allocate(D1(N2+1:N3,N2+1:N3,N0+1:N2,N0+1:N2))
     ...
     & N2,N3,N2,N3,N0,N2,N0,N2,VCHHPP,D1)
       ...
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,N2,N3,M1,N2,M1,N2,t2C,D2)
       allocate(S381(M1+1:N2,M1+1:N2,N0+1:N2,N0+1:N2))
       I1=K2*K2
       I2=K8*K8
       I3=K4*K4
...
C
     ...
     & N0,N2,N0,N2,M1,N2,M1,N2,S381,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S385(N2+1:M2,N0+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K2
       I2=K0
       I3=K2
...
C
       call
     & sum2134(N0,N2,N2,M2,M1,N2,M1,N2,X2,S385, 0.500)
       deallocate(S385)
C
       call sumx2134(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,M2,N3,M2,N3,N0,M1,t2C,D2)
       allocate(Z2(M2+1:N3,M2+1:N3,N0+1:M1,N2+1:M2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K0
       I2=K5*K6*K6
       I3=K2
...
C
       call
     & sum124356(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z2,-1.000)
       deallocate(Z2)
       deallocate(X2)
C
       allocate(D1(N0+1:N2,N0+1:N2,M1+1:N2,M1+1:N2))
     ...
     & N0,N2,N0,N2,M1,N2,M1,N2,S381,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S382(M2+1:N3,N0+1:N2,M1+1:N2,M1+1:N2))
       I1=K8*K8*K2
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N2,X1,S382,-0.500)
       deallocate(S382)
C
       call sumx2134(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,M2,N3,N2,M2,N0,M1,t2C,D2)
       allocate(Z1(M2+1:N3,N2+1:M2,N0+1:M1,M2+1:N3,M1+1:N2,M1+1:N2))
       I1=K8*K8*K6
       I2=K5*K0*K6
       I3=K2
...
C
       call
     & sum234156(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z1,-1.000)
       call
     & sum134256(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z1, 1.000)
       deallocate(Z1)
       deallocate(X1)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
     ...
     & N0,N2,N2,N3,N0,N2,N2,N3,VCHHPP,D1)
       ...
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       allocate(S389(N2+1:M2,M1+1:N2,N0+1:N2,N2+1:N3))
       I1=K4*K2
       I2=K8*K0
       I3=K4*K2
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N2,N2,N3,
     & N0,N2,N2,N3,N2,M2,M1,N2,S389,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       allocate(S390(M2+1:N3,N2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K4
       I2=K6
       I3=K2
...
C
       call
     & sum2134(N2,N3,M2,N3,N2,M2,M1,N2,X70,S390,-1.000)
       deallocate(S390)
C
       allocate(D2(N2+1:N3,M2+1:N3,N0+1:M1,M1+1:N2))
       call reorder1234(N2,N3,N2,N3,N0,N2,N0,N2,
     & N2,N3,M2,N3,N0,M1,M1,N2,t2C,D2)
       allocate(Z214(M2+1:N3,N0+1:M1,M1+1:N2,M2+1:N3,N2+1:M2,M1+1:N2))
       I1=K8*K0*K6
       I2=K8*K5*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X70,D2,Z214)
       deallocate(D2)
C
       call
     & sum246135(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z214,-1.000)
       call
     & sum146235(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z214, 1.000)
       call
     & sum245136(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z214, 1.000)
       call
     & sum145236(M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,V3D,Z214,-1.000)
       deallocate(Z214)
       deallocate(X70)
C
       call sumx3(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M2,N3,M2,N3,N2,M2,N0,M1,M1,N2,M1,N2,HT3D,V3D,1.0)
       deallocate(V3D)
C
       end
