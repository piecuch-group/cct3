...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S209)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z437)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z438)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z491)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X93,F2,Z318)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X89,F2,Z314)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X95,F2,Z320)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X91,F2,Z316)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X94,F2,Z319)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X90,F2,Z315)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X96,F2,Z321)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X92,F2,Z317)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K9
       I3=K6*K5
       call EGEMM(I1,I2,I3,X72,F2,Z127)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K9
       I3=K0*K7
       call EGEMM(I1,I2,I3,X75,F2,Z130)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X80,F2,Z135)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X76,F2,Z131)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X82,F2,Z137)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X81,F2,Z136)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X77,F2,Z132)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K9*K8
       call EGEMM(I1,I2,I3,X83,F2,Z138)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9*K6
       I3=K5
       call EGEMM(I1,I2,I3,X84,F2,Z139)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K9*K6
       I3=K8
       call EGEMM(I1,I2,I3,X85,F2,Z140)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9*K9
       I3=K6
       call EGEMM(I1,I2,I3,X86,F2,Z149)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N1,M2,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9*K9
       I3=K0
       call EGEMM(I1,I2,I3,X87,F2,Z150)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call EGEMM(I1,I2,I3,Q79,D2,S516)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call EGEMM(I1,I2,I3,Q89,D2,S576)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K9
       I3=K1
       call EGEMM(I1,I2,I3,X88,D2,Z248)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K6
       I3=K2
       call EGEMM(I1,I2,I3,X101,D2,Z337)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K6
       I3=K2
       call EGEMM(I1,I2,I3,X100,D2,Z336)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X98,D2,Z332)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S585)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S584)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,X97,D2,Z330)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X99,D2,Z334)
       deallocate(D2)
C
       call
