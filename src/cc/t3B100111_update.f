...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S183)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S184)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z369)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,D1,F2,Z370)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z371)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,D1,F2,Z372)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z380)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9*K0
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z381)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S285)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S286)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S287)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z632)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z633)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z660)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z661)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X83,F2,Z132)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X87,F2,Z147)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X108,F2,Z400)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X106,F2,Z398)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X109,F2,Z401)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X107,F2,Z399)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X114,F2,Z414)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X110,F2,Z410)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X116,F2,Z416)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X112,F2,Z412)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X115,F2,Z415)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X111,F2,Z411)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X117,F2,Z417)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X113,F2,Z413)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K9*K9
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X88,F2,Z171)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       ...
       I2=K5*K5*K9*K9
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X89,F2,Z172)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X90,F2,Z177)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X91,F2,Z178)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X92,F2,Z179)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X93,F2,Z180)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X98,F2,Z185)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X94,F2,Z181)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X100,F2,Z187)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X96,F2,Z183)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X99,F2,Z186)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X95,F2,Z182)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X101,F2,Z188)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X97,F2,Z184)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9*K0
       I3=K5
       call DMATMAT(I1,I2,I3,X102,F2,Z189)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N1,M2,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K9*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X103,F2,Z190)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K5*K9*K9
       I3=K6
       call DMATMAT(I1,I2,I3,X104,F2,Z199)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S727)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S720)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,N3,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5
       I3=K3*K4
       call DMATMAT(I1,I2,I3,D1,D2,S765)
       deallocate(D1)
       deallocate(D2)
C
       allocate(D1(N0+1:N2,N0+1:N1,N0+1:M1,N0+1:M1))
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S762)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S764)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S772)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S825)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S841)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S842)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S835)
       deallocate(B1)
       deallocate(D2)
C
       call
