...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,X37,B2,Z66)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,M2,N3,N2,M2,M2,N3,M1,N1,t3C4,F2)
       ...
       I2=K7*K6*K0
       I3=K6*K5*K5
       call DMATMAT(I1,I2,I3,X27,F2,Z47)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,M2,N3,N2,M2,M2,N3,M1,N1,t3C1,F2)
       ...
       I2=K7*K6*K0
       I3=K6*K8*K5
       call DMATMAT(I1,I2,I3,X28,F2,Z48)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,M2,N3,N2,M2,M2,N3,M1,N1,t3C1,F2)
       ...
       I2=K7*K6*K0
       I3=K6*K8*K8
       call DMATMAT(I1,I2,I3,X29,F2,Z49)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N2,M2,M2,N3,M1,N1,t3C4,F2)
       ...
       I2=K7*K6*K0
       I3=K0*K5*K5
       call DMATMAT(I1,I2,I3,X30,F2,Z50)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,M2,N3,M1,N1,t3C1,F2)
       ...
       I2=K7*K6*K0
       I3=K0*K8*K5
       call DMATMAT(I1,I2,I3,X31,F2,Z51)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,M2,N3,M1,N1,t3C1,F2)
       ...
       I2=K7*K6*K0
       I3=K0*K8*K8
       call DMATMAT(I1,I2,I3,X32,F2,Z52)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6
       I3=K0*K6*K5
       call DMATMAT(I1,I2,I3,X33,F2,Z53)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6
       I3=K0*K6*K8
       call DMATMAT(I1,I2,I3,X34,F2,Z54)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K6
       I3=K0*K0*K5
       call DMATMAT(I1,I2,I3,X35,F2,Z55)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K6
       I3=K0*K0*K8
       call DMATMAT(I1,I2,I3,X36,F2,Z56)
       deallocate(F2)
C
       call
