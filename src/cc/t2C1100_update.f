...
C
     ...
     & M1,N1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K6
       I3=K6*K0*K7
       call DMATMAT(I1,I2,I3,D1,F2,S36)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,M2,N3,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K6
       I3=K9*K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,S38)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K6
       I3=K9*K6*K7
       call DMATMAT(I1,I2,I3,D1,F2,S40)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X14,B2,Z35)
       deallocate(B2)
C
       V2C=V2C+Z35
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6
       I3=K0*K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,S54)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6
       I3=K0*K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,S56)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X15,B2,Z55)
       deallocate(B2)
C
       V2C=V2C-Z55
       deallocate(Z55)
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X16,B2,Z63)
       deallocate(B2)
C
       call
