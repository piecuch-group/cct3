...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U106)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,F1,B2,Z107)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U175)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K0*K6
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z218)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K0*K6
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z219)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S126)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z350)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z351)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,D1,F2,Z358)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K0
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U366)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call EGEMM(I1,I2,I3,F1,D2,Z367)
       deallocate(F1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,F1,B2,U499)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,X78,B2,Z176)
       deallocate(B2)
C
       V3C=V3C-Z176
       deallocate(Z176)
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call EGEMM(I1,I2,I3,X92,D2,Z411)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X79,F2,Z212)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K7
       call EGEMM(I1,I2,I3,X80,F2,Z213)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X81,F2,Z214)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K9*K7
       call EGEMM(I1,I2,I3,X82,F2,Z215)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X83,F2,Z220)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X84,F2,Z221)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X85,F2,Z222)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X86,F2,Z223)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K6*K6
       I3=K0
       call EGEMM(I1,I2,I3,X75,F2,Z116)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K6*K0
       I3=K0
       call EGEMM(I1,I2,I3,X74,F2,Z112)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S422)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S419)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,M2,N3,M1,N2,t2B,D2)
       ...
       I2=K8*K6*K0
       I3=K1
       call EGEMM(I1,I2,I3,X91,D2,Z246)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S441)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K6
       I3=K2
       call EGEMM(I1,I2,I3,X77,D2,Z135)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S519)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,X90,D2,Z237)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,X88,D2,Z228)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,X89,D2,Z229)
       deallocate(D2)
C
       call
