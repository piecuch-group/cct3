...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K8*K9*K6
       I3=K6
       call EGEMM(I1,I2,I3,B1,F2,Z259)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,N1,M2,M1,N2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K8*K9*K6
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z260)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K9*K9
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z380)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X58,F2,Z91)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X77,F2,Z287)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X73,F2,Z283)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X79,F2,Z289)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X75,F2,Z285)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X78,F2,Z288)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,N0,M1,t3C3,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X74,F2,Z284)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X80,F2,Z290)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X76,F2,Z286)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K9*K9
       I3=K6*K5
       call EGEMM(I1,I2,I3,X62,F2,Z116)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K9*K9
       I3=K6*K7
       call EGEMM(I1,I2,I3,X63,F2,Z117)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,t3B4,F2)
       ...
       I2=K5*K8*K9*K9
       I3=K0*K5
       call EGEMM(I1,I2,I3,X64,F2,Z118)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,t3B1,F2)
       ...
       I2=K5*K8*K9*K9
       I3=K0*K7
       call EGEMM(I1,I2,I3,X65,F2,Z119)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X68,F2,Z122)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K6*K8
       call EGEMM(I1,I2,I3,X66,F2,Z120)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K9*K8
       call EGEMM(I1,I2,I3,X69,F2,Z123)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N1,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K9*K8
       call EGEMM(I1,I2,I3,X67,F2,Z121)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K9*K9*K6
       I3=K8
       call EGEMM(I1,I2,I3,X70,F2,Z124)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N1,M2,N1,M2,M1,N2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K8*K9*K9
       I3=K6
       call EGEMM(I1,I2,I3,X71,F2,Z133)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N1,M2,N1,M2,M1,N2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K8*K9*K9
       I3=K0
       call EGEMM(I1,I2,I3,X72,F2,Z134)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,N0,M1,t2A,D2)
       ...
       I2=K5*K9*K9
       I3=K1
       call EGEMM(I1,I2,I3,Q72,D2,S451)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K6
       I3=K1
       call EGEMM(I1,I2,I3,X56,D2,Z65)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,N0,M1,t2A,D2)
       ...
       I2=K5*K5*K9
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S492)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,N1,M2,N0,M1,t2A,D2)
       ...
       I2=K5*K9*K9
       I3=K1
       call EGEMM(I1,I2,I3,Q80,D2,S503)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S471)
       deallocate(B1)
       deallocate(D2)
       deallocate(Q73)
C
