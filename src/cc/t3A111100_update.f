...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K7*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U59)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z60)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S42)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S43)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,t3A,F2)
       ...
       I2=K7*K9*K6
       I3=K6*K5*K5
       call DMATMAT(I1,I2,I3,D1,F2,S58)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M1,N1,M2,N3,M2,N3,N1,M2,M1,N1,t3A,F2)
       ...
       I2=K7*K9*K6
       I3=K6*K7*K7
       call DMATMAT(I1,I2,I3,D1,F2,S60)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M1,N1,N1,M2,M2,N3,N1,M2,M1,N1,t3A,F2)
       ...
       I2=K7*K9*K6
       I3=K9*K7*K5
       call DMATMAT(I1,I2,I3,D1,F2,S62)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,N1,M2,M2,N3,M2,N3,M1,N1,t3A,F2)
       ...
       I2=K7*K6*K6
       I3=K9*K5*K5
       call DMATMAT(I1,I2,I3,D1,F2,S64)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & M1,N1,M1,N1,N1,M2,M2,N3,M2,N3,M1,N1,t3A,F2)
       ...
       I2=K7*K6*K6
       I3=K9*K7*K7
       call DMATMAT(I1,I2,I3,D1,F2,S66)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K7*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U133)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,N0,N1,M2,N3,M2,N3,t2A,D2)
       ...
       I2=K6*K6
       I3=K1*K1
       call DMATMAT(I1,I2,I3,F1,D2,Z134)
       deallocate(F1)
       deallocate(D2)
C
       V3A=V3A+0.250*Z134
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,U211)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N1,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1,M1+1:N1))
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z212)
       deallocate(F1)
       deallocate(B2)
C
       V3A=V3A+0.500*Z212
...
C
     ...
     & N1,M2,M2,N3,M2,N3,M1,N1,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K7*K6*K6
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z141)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,X36,D2,Z109)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,M2,N3,M1,N1,t2A,D2)
       ...
       I2=K7*K6*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X37,D2,Z115)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X38,D2,Z121)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,M2,N3,M1,N1,t2A,D2)
       ...
       I2=K7*K6*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X28,D2,Z32)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X27,D2,Z31)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,X29,D2,Z33)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X30,F2,Z49)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X31,F2,Z50)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X39,F2,Z168)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X40,F2,Z169)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N1,M1,N1,t3B3,F2)
       ...
       I2=K7*K7*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X43,F2,Z172)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X41,F2,Z170)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N1,M1,N1,t3B3,F2)
       ...
       I2=K7*K7*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X44,F2,Z173)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X42,F2,Z171)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q41,B2,Q43)
       deallocate(B2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S195)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,M2,N3,M1,N1,t2A,D2)
       ...
       I2=K7*K6*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X32,D2,Z91)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X33,D2,Z92)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,X35,D2,Z94)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K6
       I3=K3
       call DMATMAT(I1,I2,I3,X34,D2,Z93)
       deallocate(D2)
C
       call
