...
C
       ...
       X63=0.0d0
       call
     & sum3124(N0,N1,M2,N3,M1,N1,M1,N1,X63,S6, 1.000)
       deallocate(S6)
C
...
C
       ...
       X64=0.0d0
       call
     & sum3124(N0,N1,N1,M2,M1,N1,M1,N1,X64,S7, 1.000)
       deallocate(S7)
C
...
C
     ...
     & N0,M1,N0,M1,M1,N1,M1,N1,S18,D1)
...
C
       V3B=V3B+0.500*Z87
       call
     & sum123465(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z87,-0.500)
       deallocate(Z87)
       deallocate(S18)
C
...
C
       V3B=V3B+Z88
       call
     & sum123465(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z88,-1.000)
       deallocate(Z88)
       deallocate(S19)
C
...
C
       V3B=V3B+0.500*Z89
       call
     & sum123465(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z89,-0.500)
       deallocate(Z89)
       deallocate(S20)
C
...
C
       ...
       X65=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N1,X65,S25, 1.000)
       deallocate(S25)
C
       allocate(D1(N0+1:N1,M1+1:N1,N1+1:M2,M1+1:N1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       ...
       X66=0.0d0
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X66,S26, 1.000)
       deallocate(S26)
C
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N1,X27,S27,-1.000)
       deallocate(S27)
C
...
C
       call
     & sum4123(M1,N1,M2,N3,M2,N3,M1,N1,X28,S28,-1.000)
       deallocate(S28)
C
...
C
       call
     & sum4123(N0,M1,N1,M2,M2,N3,M1,N1,X29,S29,-1.000)
       deallocate(S29)
C
...
C
       call
     & sum4123(M1,N1,N1,M2,M2,N3,M1,N1,X30,S30,-1.000)
       deallocate(S30)
C
...
C
       ...
       X31=0.0d0
       call
     & sum4123(N0,M1,N1,M2,N1,M2,M1,N1,X31,S31,-1.000)
       deallocate(S31)
C
...
C
       ...
       X32=0.0d0
       call
     & sum4123(M1,N1,N1,M2,N1,M2,M1,N1,X32,S32,-1.000)
       deallocate(S32)
C
...
C
       ...
       X33=0.0d0
       call
     & sum4123(M2,N3,N1,M2,M2,N3,N1,M2,X33,S33,-1.000)
       deallocate(S33)
C
...
C
       ...
       X34=0.0d0
       call
     & sum4123(N1,M2,N1,M2,M2,N3,N1,M2,X34,S34,-1.000)
       deallocate(S34)
C
...
C
       call
     & sum3124(M2,N3,N1,M2,M2,N3,N1,M2,X33,S35, 1.000)
       deallocate(S35)
C
...
C
       call
     & sum3124(N1,M2,N1,M2,M2,N3,N1,M2,X34,S36, 1.000)
       deallocate(S36)
C
...
C
       ...
       X35=0.0d0
       call
     & sum4123(N0,M1,N0,M1,M1,N2,M1,N1,X35,S37, 1.000)
       deallocate(S37)
C
...
C
       ...
       X36=0.0d0
       call
     & sum4123(M1,N2,N0,M1,M1,N2,M1,N1,X36,S38, 1.000)
       deallocate(S38)
C
...
C
       ...
       X37=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M1,N2,M1,N1,X37,S39, 1.000)
       deallocate(S39)
C
...
C
       ...
       X38=0.0d0
       call
     & sum4123(M1,N2,M1,N1,M1,N2,M1,N1,X38,S40, 1.000)
       deallocate(S40)
C
       allocate(D1(N1+1:N3,N0+1:M1,M2+1:N3,M2+1:N3))
...
C
       ...
       X67=0.0d0
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N1,X67,S41, 1.000)
       deallocate(S41)
C
       allocate(D1(N1+1:N3,M1+1:N1,M2+1:N3,M2+1:N3))
       call reorder2413(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       X68=0.0d0
       call
     & sum4123(M1,N1,M2,N3,M2,N3,M1,N1,X68,S42, 1.000)
       deallocate(S42)
C
...
C
       ...
       X69=0.0d0
       call
     & sum4123(N0,M1,N2,M2,M2,N3,M1,N1,X69,S43, 1.000)
       deallocate(S43)
C
...
C
       ...
       X70=0.0d0
       call
     & sum4123(M1,N1,N2,M2,M2,N3,M1,N1,X70,S44, 1.000)
       deallocate(S44)
C
...
C
       ...
       X71=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X71,S45, 1.000)
       deallocate(S45)
C
...
C
       ...
       X72=0.0d0
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X72,S46, 1.000)
       deallocate(S46)
C
...
C
       ...
       X73=0.0d0
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X73,S47, 1.000)
       deallocate(S47)
C
...
C
       ...
       X74=0.0d0
       call
     & sum3124(M1,N2,N1,M2,M2,N3,M1,N2,X74,S48, 1.000)
       deallocate(S48)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,M1+1:N2))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X75=0.0d0
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X75,S49, 1.000)
       deallocate(S49)
C
       allocate(D1(N0+1:N1,M1+1:N2,N1+1:M2,M1+1:N2))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X76=0.0d0
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X76,S50, 1.000)
       deallocate(S50)
C
...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U127)
       deallocate(D1)
       deallocate(F2)
C
       allocate(F1(N0+1:N1,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder561234(N1,M2,M1,N2,M1,N1,M1,N1,N0,N1,M2,N3,
     & N0,N1,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,U127,F1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z128)
       deallocate(F1)
       deallocate(B2)
C
       call
     & sum213456(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z128,-1.000)
       deallocate(Z128)
       deallocate(U127)
C
...
C
       ...
       X49=0.0d0
       call
     & sum4123(N2,M2,M2,N3,M2,N3,M2,N3,X49,S51,-1.000)
       deallocate(S51)
C
       allocate(D1(N0+1:N1,M2+1:N3,N1+1:M2,M2+1:N3))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       X50=0.0d0
       call
     & sum4123(M2,N3,N1,M2,M2,N3,M2,N3,X50,S52,-1.000)
       deallocate(S52)
C
...
C
       ...
       X51=0.0d0
       call
     & sum4123(N2,M2,N1,M2,M2,N3,M2,N3,X51,S53,-1.000)
       deallocate(S53)
C
       allocate(D1(N0+1:N1,N2+1:M2,M2+1:N3,M2+1:N3))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       X52=0.0d0
       call
     & sum4123(N2,M2,M2,N3,M2,N3,N1,M2,X52,S54,-1.000)
       deallocate(S54)
C
       allocate(D1(N0+1:N1,M2+1:N3,N1+1:M2,M2+1:N3))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       X53=0.0d0
       call
     & sum4123(M2,N3,N1,M2,M2,N3,N1,M2,X53,S55,-1.000)
       deallocate(S55)
C
       allocate(D1(N0+1:N1,N2+1:M2,N1+1:M2,M2+1:N3))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       X54=0.0d0
       call
     & sum4123(N2,M2,N1,M2,M2,N3,N1,M2,X54,S56,-1.000)
       deallocate(S56)
C
       allocate(D1(N0+1:N1,N1+1:N3,M2+1:N3,M2+1:N3))
...
C
     ...
     & N0,M1,M2,N3,M2,N3,M1,N1,S57,D1)
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z137, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z137,-1.000)
       deallocate(Z137)
       deallocate(S57)
C
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z138, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z138,-1.000)
       deallocate(Z138)
       deallocate(S58)
C
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M1,N1,S59,D1)
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z139,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z139, 1.000)
       deallocate(Z139)
       deallocate(S59)
C
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M1,N1,S60,D1)
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z140,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z140, 1.000)
       deallocate(Z140)
       deallocate(S60)
C
       allocate(D1(N0+1:N1,N0+1:M1,N2+1:M2,M1+1:N1))
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z141, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z141,-1.000)
       deallocate(Z141)
       deallocate(S61)
C
       allocate(D1(N0+1:N1,M1+1:N2,N2+1:M2,M1+1:N1))
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z142, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z142,-1.000)
       deallocate(Z142)
       deallocate(S62)
C
       allocate(D1(N1+1:N3,N0+1:M1,M2+1:N3,M2+1:N3))
...
C
     ...
     & N0,M1,M2,N3,M2,N3,M1,N1,S63,D1)
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z143,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z143, 1.000)
       deallocate(Z143)
       deallocate(S63)
C
...
C
     ...
     & M1,N2,M2,N3,M2,N3,M1,N1,S64,D1)
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z144,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z144, 1.000)
       deallocate(Z144)
       deallocate(S64)
C
       allocate(D1(N1+1:N3,N0+1:M1,N2+1:M2,M2+1:N3))
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M1,N1,S65,D1)
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder421356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z145, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z145,-1.000)
       deallocate(Z145)
       deallocate(S65)
C
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M1,N1,S66,D1)
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder421356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z146, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z146,-1.000)
       deallocate(Z146)
       deallocate(S66)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z147,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z147, 1.000)
       deallocate(Z147)
       deallocate(S67)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z148,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z148, 1.000)
       deallocate(Z148)
       deallocate(S68)
C
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S69,-1.000)
       deallocate(S69)
C
...
C
       call
     & sum3124(N0,N1,M2,N3,M1,N2,M1,N1,X1,S70, 1.000)
       deallocate(S70)
C
...
C
       call
     & sum2134(N1,N3,M2,N3,M2,N3,M1,N2,X2,S71,-1.000)
       deallocate(S71)
C
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S72,-1.000)
       deallocate(S72)
C
...
C
       call
     & sum4123(N1,N3,M2,N3,N1,M2,M1,N2,X3,S73, 1.000)
       deallocate(S73)
C
...
C
       call
     & sum3124(N0,N2,M2,N3,M1,N2,M1,N1,X7,S74, 1.000)
       deallocate(S74)
C
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X8,S75, 1.000)
       deallocate(S75)
C
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N1,X9,S76,-1.000)
       deallocate(S76)
C
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S77,-1.000)
       deallocate(S77)
C
...
C
       ...
       X11=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X11,S78,-1.000)
       deallocate(S78)
C
...
C
       ...
       X12=0.0d0
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N2,X12,S79,-1.000)
       deallocate(S79)
C
...
C
       ...
       X13=0.0d0
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X13,S80,-1.000)
       deallocate(S80)
C
...
C
       ...
       X14=0.0d0
       call
     & sum3124(M1,N1,N1,M2,M2,N3,M1,N2,X14,S81,-1.000)
       deallocate(S81)
C
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N2,X11,S82, 1.000)
       deallocate(S82)
C
...
C
       call
     & sum4123(M1,N1,M2,N3,M2,N3,M1,N2,X12,S83, 1.000)
       deallocate(S83)
C
...
C
       call
     & sum4123(N0,M1,N1,M2,M2,N3,M1,N2,X13,S84, 1.000)
       deallocate(S84)
C
...
C
       call
     & sum4123(M1,N1,N1,M2,M2,N3,M1,N2,X14,S85, 1.000)
       deallocate(S85)
C
...
C
       ...
       X20=0.0d0
       call
     & sum21(N0,M1,M1,N2,X20,Q15, 1.000)
       deallocate(Q15)
C
...
C
       ...
       X21=0.0d0
       call
     & sum21(M1,N2,M1,N2,X21,Q16, 1.000)
       deallocate(Q16)
C
...
C
       call
     & sum3124(N0,M1,N0,M1,M1,N2,M1,N1,X35,S86, 1.000)
       deallocate(S86)
C
...
C
       call
     & sum3124(M1,N2,N0,M1,M1,N2,M1,N1,X36,S87, 1.000)
       deallocate(S87)
C
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N2,M1,N1,X37,S88, 1.000)
       deallocate(S88)
C
...
C
       call
     & sum3124(M1,N2,M1,N1,M1,N2,M1,N1,X38,S89, 1.000)
       deallocate(S89)
C
...
C
       ...
       X39=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N1,X39,S90,-1.000)
       deallocate(S90)
C
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z39, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z39,-1.000)
       deallocate(Z39)
       deallocate(X39)
C
...
C
       ...
       X40=0.0d0
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N1,X40,S91,-1.000)
       deallocate(S91)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z40, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z40,-1.000)
       deallocate(Z40)
       deallocate(X40)
C
...
C
       ...
       X41=0.0d0
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N1,X41,S92,-1.000)
       deallocate(S92)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z41, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z41,-1.000)
       deallocate(Z41)
       deallocate(X41)
C
...
C
       ...
       X42=0.0d0
       call
     & sum3124(M1,N1,N2,M2,M2,N3,M1,N1,X42,S93,-1.000)
       deallocate(S93)
C
       call sumx2431(N2,N3,N0,N1,N2,N3,N0,N1,
...
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z42, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z42,-1.000)
       deallocate(Z42)
       deallocate(X42)
C
...
C
       ...
       X43=0.0d0
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N2,X43,S94, 1.000)
       deallocate(S94)
C
...
C
       call
     & sum135624(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z43,-1.000)
       deallocate(Z43)
       deallocate(X43)
C
...
C
       ...
       X44=0.0d0
       call
     & sum4123(M1,N2,M2,N3,M2,N3,M1,N2,X44,S95, 1.000)
       deallocate(S95)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum135624(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z44,-1.000)
       deallocate(Z44)
       deallocate(X44)
C
       allocate(D1(N2+1:N3,N0+1:M1,N1+1:M2,M2+1:N3))
...
C
       ...
       X45=0.0d0
       call
     & sum4123(N0,M1,N1,M2,M2,N3,M1,N2,X45,S96, 1.000)
       deallocate(S96)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum135624(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z45,-1.000)
       deallocate(Z45)
       deallocate(X45)
C
...
C
       ...
       X46=0.0d0
       call
     & sum4123(M1,N2,N1,M2,M2,N3,M1,N2,X46,S97, 1.000)
       deallocate(S97)
C
       call sumx4213(N0,N2,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum135624(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z46,-1.000)
       deallocate(Z46)
       deallocate(X46)
C
...
C
       call
     & sum125634(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z47,-1.000)
       deallocate(Z47)
       deallocate(X47)
C
...
C
       call
     & sum125634(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z48,-1.000)
       deallocate(Z48)
       deallocate(X48)
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U186)
       deallocate(D1)
       deallocate(F2)
C
       ...
       X81=0.0d0
       call
     & sum345612(N0,N2,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,X81,U186, 1.000)
       deallocate(U186)
C
...
C
       call
     & sum3124(N2,M2,M2,N3,M2,N3,M2,N3,X49,S100,-1.000)
       deallocate(S100)
C
...
C
       call
     & sum3124(M2,N3,N1,M2,M2,N3,M2,N3,X50,S101,-1.000)
       deallocate(S101)
C
...
C
       call
     & sum3124(N2,M2,N1,M2,M2,N3,M2,N3,X51,S102,-1.000)
       deallocate(S102)
C
...
C
       call
     & sum3124(N2,M2,M2,N3,M2,N3,N1,M2,X52,S103,-1.000)
       deallocate(S103)
C
...
C
       call
     & sum3124(M2,N3,N1,M2,M2,N3,N1,M2,X53,S104,-1.000)
       deallocate(S104)
C
...
C
       call
     & sum3124(N2,M2,N1,M2,M2,N3,N1,M2,X54,S105,-1.000)
       deallocate(S105)
C
...
C
       ...
       X55=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X55,S106,-1.000)
       deallocate(S106)
C
...
C
       ...
       X56=0.0d0
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X56,S107,-1.000)
       deallocate(S107)
C
...
C
       ...
       X57=0.0d0
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N2,X57,S108,-1.000)
       deallocate(S108)
C
...
C
       ...
       X58=0.0d0
       call
     & sum3124(M1,N2,N2,M2,M2,N3,M1,N2,X58,S109,-1.000)
       deallocate(S109)
C
...
C
       call
     & sum4123(N0,M1,M2,N3,M2,N3,M1,N2,X55,S110,-1.000)
       deallocate(S110)
C
       allocate(D1(N2+1:N3,M1+1:N2,M2+1:N3,M2+1:N3))
       call reorder1423(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum4123(M1,N2,M2,N3,M2,N3,M1,N2,X56,S111,-1.000)
       deallocate(S111)
C
...
C
       call
     & sum4123(N0,M1,N2,M2,M2,N3,M1,N2,X57,S112,-1.000)
       deallocate(S112)
C
...
C
       call
     & sum4123(M1,N2,N2,M2,M2,N3,M1,N2,X58,S113,-1.000)
       deallocate(S113)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M2+1:N3))
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S114,-1.000)
       deallocate(S114)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S115,-1.000)
       deallocate(S115)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
...
C
       ...
       X82=0.0d0
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S116, 1.000)
       deallocate(S116)
C
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N2,M1,N1,X1,S117, 1.000)
       deallocate(S117)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N1,M1,N1,X63,S118, 1.000)
       deallocate(S118)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X64,S119,-1.000)
       deallocate(S119)
C
...
C
       call
     & sum2314(N1,N3,M2,N3,N1,M2,M1,N1,X6,S120, 0.500)
       deallocate(S120)
C
...
C
       call
     & sum2413(N1,N3,M2,N3,M2,N3,M1,N2,X2,S121,-1.000)
       deallocate(S121)
C
...
C
       call
     & sum3412(N0,N1,M2,N3,M1,N1,M1,N1,X4,S122, 0.500)
       deallocate(S122)
C
...
C
       call
     & sum3412(N0,N1,N1,M2,M1,N1,M1,N1,X5,S124, 0.500)
       deallocate(S124)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,M2+1:N3))
...
C
       call
     & sum3412(N1,N3,M2,N3,N1,M2,M1,N1,X6,S125, 1.000)
       deallocate(S125)
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:N3,N1+1:M2))
       call reorder4213(N1,N3,N1,N3,N1,N3,N0,N1,
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,M1,N1,X6,S126,-1.000)
       deallocate(S126)
C
...
C
       call
     & sum2314(N1,N3,M2,N3,M2,N3,M1,N2,X2,S128, 1.000)
       deallocate(S128)
C
...
C
       call
     & sum3412(N1,N3,M2,N3,M2,N3,M1,N2,X2,S130,-1.000)
       deallocate(S130)
C
...
C
       call
     & sum2413(N0,N1,M2,N3,M1,N2,M1,N1,X82,S131,-1.000)
       deallocate(S131)
C
...
C
       call
     & sum2413(N0,N2,M2,N3,M1,N2,M1,N1,X7,S132, 1.000)
       deallocate(S132)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X8,S133, 1.000)
       deallocate(S133)
C
...
C
       call
     & sum3412(N0,N1,M2,N3,M1,N2,M1,N1,X82,S134, 1.000)
       deallocate(S134)
C
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,M1,N1,X9,S135, 1.000)
       deallocate(S135)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,M2+1:N3))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3412(N2,N3,M2,N3,N1,M2,M1,N1,X10,S136, 1.000)
       deallocate(S136)
C
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N2,M1,N1,X1,S137, 1.000)
       deallocate(S137)
C
...
C
       call
     & sum2413(N1,N3,M2,N3,M2,N3,M1,N2,X2,S138, 1.000)
       deallocate(S138)
C
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,M1,N2,X3,S139, 1.000)
       deallocate(S139)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S140, 0.500)
       deallocate(S140)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S141, 1.000)
       deallocate(S141)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S143, 0.500)
       deallocate(S143)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S144, 1.000)
       deallocate(S144)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S145, 0.500)
       deallocate(S145)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,M2,N3,M1,N2,X2,S146, 0.500)
       deallocate(S146)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,M2,N3,M1,N2,X2,S147, 1.000)
       deallocate(S147)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,M2,N3,M1,N2,X2,S148, 0.500)
       deallocate(S148)
C
...
C
       ...
       X24=0.0d0
       call
     & sum3412(N0,M1,N0,M1,M1,N1,M1,N1,X24,S149, 0.500)
       deallocate(S149)
C
...
C
       ...
       X25=0.0d0
       call
     & sum3412(N0,M1,M1,N1,M1,N1,M1,N1,X25,S150, 0.500)
       deallocate(S150)
C
...
C
       ...
       X26=0.0d0
       call
     & sum3412(M1,N1,M1,N1,M1,N1,M1,N1,X26,S151, 0.500)
       deallocate(S151)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S152, 1.000)
       deallocate(S152)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S153, 1.000)
       deallocate(S153)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S154, 0.500)
       deallocate(S154)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S155, 0.500)
       deallocate(S155)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X27,S156,-1.000)
       deallocate(S156)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N1,X28,S157,-1.000)
       deallocate(S157)
C
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N1,X29,S158,-1.000)
       deallocate(S158)
C
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N1,X30,S159,-1.000)
       deallocate(S159)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
...
C
     ...
     & N0,M1,N1,M2,N1,M2,M1,N1,S160,D1)
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z255,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z255, 1.000)
       deallocate(Z255)
       deallocate(S160)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
...
C
     ...
     & M1,N1,N1,M2,N1,M2,M1,N1,S161,D1)
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z256,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z256, 1.000)
       deallocate(Z256)
       deallocate(S161)
C
...
C
       call
     & sum3412(M2,N3,N1,M2,M2,N3,N1,M2,X33,S162, 0.500)
       deallocate(S162)
C
...
C
       call
     & sum3412(N1,M2,N1,M2,M2,N3,N1,M2,X34,S163, 0.500)
       deallocate(S163)
C
...
C
     ...
     & N1,M2,M2,N3,M2,N3,M1,N2,M1,N1,M1,N1,t3B1,F2)
       allocate(Z263(M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9
       I2=K7*K7*K8*K6*K6
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z263)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sum124563(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z263, 0.500)
       deallocate(Z263)
       deallocate(Q32)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S164,-1.000)
       deallocate(S164)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S165,-1.000)
       deallocate(S165)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S166,-1.000)
       deallocate(S166)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N2,X3,S167,-1.000)
       deallocate(S167)
C
...
C
       call
     & sum2341(N1,N3,M2,N3,M2,N3,M1,N2,X2,S172, 1.000)
       deallocate(S172)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,M2,N3,M1,N2,X2,S173, 1.000)
       deallocate(S173)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,M2,N3,M1,N2,X2,S174, 1.000)
       deallocate(S174)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,M2,N3,M1,N2,X2,S175, 1.000)
       deallocate(S175)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S176,-1.000)
       deallocate(S176)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S177,-1.000)
       deallocate(S177)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S178, 1.000)
       deallocate(S178)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S179, 1.000)
       deallocate(S179)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S180,-1.000)
       deallocate(S180)
C
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S181,-1.000)
       deallocate(S181)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
...
C
       ...
       X83=0.0d0
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X83,S182, 1.000)
       deallocate(S182)
C
...
C
       ...
       X84=0.0d0
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N1,X84,S183, 1.000)
       deallocate(S183)
C
...
C
       ...
       X85=0.0d0
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N1,X85,S184, 1.000)
       deallocate(S184)
C
...
C
       ...
       X86=0.0d0
       call
     & sum3412(M1,N2,N2,M2,M2,N3,M1,N1,X86,S185, 1.000)
       deallocate(S185)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X87=0.0d0
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X87,S186, 1.000)
       deallocate(S186)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X88=0.0d0
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X88,S187, 1.000)
       deallocate(S187)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X7,S188, 1.000)
       deallocate(S188)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S189, 1.000)
       deallocate(S189)
C
...
C
       call
     & sum2314(N2,N3,M2,N3,N1,M2,M1,N1,X10,S190, 1.000)
       deallocate(S190)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum2314(N2,N3,M2,N3,M2,N3,M1,N1,X9,S191, 1.000)
       deallocate(S191)
C
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X8,S192,-1.000)
       deallocate(S192)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder4132(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N2,M2,N3,M1,N2,M1,N1,X7,S193,-1.000)
       deallocate(S193)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N1,M1,N1,X63,S194, 1.000)
       deallocate(S194)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X64,S195, 1.000)
       deallocate(S195)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,M2+1:N3))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       ...
       X89=0.0d0
       call
     & sum3412(N1,N3,M2,N3,N1,M2,M1,N1,X89,S196, 1.000)
       deallocate(S196)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,M1,N1,X89,S197,-1.000)
       deallocate(S197)
C
...
C
       ...
       X90=0.0d0
       call
     & sum2413(N2,N3,M2,N3,M2,N3,M1,N1,X90,S198, 1.000)
       deallocate(S198)
C
...
C
       call
     & sum3412(N0,N2,M2,N3,M1,N2,M1,N1,X7,S199, 1.000)
       deallocate(S199)
C
...
C
       ...
       X91=0.0d0
       call
     & sum2413(N2,N3,M2,N3,N1,M2,M1,N1,X91,S200, 1.000)
       deallocate(S200)
C
...
C
       call
     & sum3412(N0,N2,N1,M2,M1,N2,M1,N1,X8,S201, 1.000)
       deallocate(S201)
C
...
C
       ...
       X92=0.0d0
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X92,S202, 1.000)
       deallocate(S202)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       ...
       X93=0.0d0
       call
     & sum2413(N0,N2,M2,N3,M1,N2,M1,N1,X93,S203, 1.000)
       deallocate(S203)
C
...
C
       call
     & sum3412(N2,N3,M2,N3,N1,M2,M1,N1,X91,S204,-1.000)
       deallocate(S204)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,M2+1:N3))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum3412(N2,N3,M2,N3,M2,N3,M1,N1,X90,S205, 1.000)
       deallocate(S205)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S206, 0.500)
       deallocate(S206)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S207, 1.000)
       deallocate(S207)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S208, 0.500)
       deallocate(S208)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S209,-0.500)
       deallocate(S209)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S210,-1.000)
       deallocate(S210)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S211,-0.500)
       deallocate(S211)
C
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S212, 0.500)
       deallocate(S212)
C
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S213, 0.500)
       deallocate(S213)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S214, 1.000)
       deallocate(S214)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S215, 1.000)
       deallocate(S215)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S216, 0.500)
       deallocate(S216)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder4123(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S217, 0.500)
       deallocate(S217)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S218, 1.000)
       deallocate(S218)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S219, 1.000)
       deallocate(S219)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S220,-0.500)
       deallocate(S220)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S221,-0.500)
       deallocate(S221)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X11,S222, 1.000)
       deallocate(S222)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N2,X12,S223, 1.000)
       deallocate(S223)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N2,X13,S224, 1.000)
       deallocate(S224)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N2,X14,S225, 1.000)
       deallocate(S225)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S226,-1.000)
       deallocate(S226)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S227,-1.000)
       deallocate(S227)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S228,-1.000)
       deallocate(S228)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S229,-1.000)
       deallocate(S229)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S230,-1.000)
       deallocate(S230)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S231,-1.000)
       deallocate(S231)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S232,-1.000)
       deallocate(S232)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,M2,N3,N1,M2,M1,N1,X89,S233,-1.000)
       deallocate(S233)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S234, 1.000)
       deallocate(S234)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S235, 1.000)
       deallocate(S235)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S236, 1.000)
       deallocate(S236)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S237, 1.000)
       deallocate(S237)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S238, 1.000)
       deallocate(S238)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S239, 1.000)
       deallocate(S239)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S240, 1.000)
       deallocate(S240)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S241, 1.000)
       deallocate(S241)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N1,X90,S242,-1.000)
       deallocate(S242)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N1,X90,S243,-1.000)
       deallocate(S243)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N1,X90,S244,-1.000)
       deallocate(S244)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N1,X90,S245,-1.000)
       deallocate(S245)
C
...
C
       call
     & sum3412(N0,M1,N0,M1,M1,N2,M1,N1,X35,S246, 1.000)
       deallocate(S246)
C
...
C
       call
     & sum3412(M1,N2,N0,M1,M1,N2,M1,N1,X36,S247, 1.000)
       deallocate(S247)
C
...
C
       call
     & sum3412(N0,M1,M1,N1,M1,N2,M1,N1,X37,S248, 1.000)
       deallocate(S248)
C
...
C
       call
     & sum3412(M1,N2,M1,N1,M1,N2,M1,N1,X38,S249, 1.000)
       deallocate(S249)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S250,-1.000)
       deallocate(S250)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S251,-1.000)
       deallocate(S251)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S252,-1.000)
       deallocate(S252)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S253,-1.000)
       deallocate(S253)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S254,-1.000)
       deallocate(S254)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S255,-1.000)
       deallocate(S255)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S256,-1.000)
       deallocate(S256)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S257,-1.000)
       deallocate(S257)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S258, 1.000)
       deallocate(S258)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S259, 1.000)
       deallocate(S259)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S260,-1.000)
       deallocate(S260)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S261,-1.000)
       deallocate(S261)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S262,-1.000)
       deallocate(S262)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S263,-1.000)
       deallocate(S263)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X67,S264,-1.000)
       deallocate(S264)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N1,X68,S265,-1.000)
       deallocate(S265)
C
...
C
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N1,X69,S266,-1.000)
       deallocate(S266)
C
...
C
       call
     & sum3412(M1,N1,N2,M2,M2,N3,M1,N1,X70,S267,-1.000)
       deallocate(S267)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X27,S268,-1.000)
       deallocate(S268)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N1,X28,S269,-1.000)
       deallocate(S269)
C
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N1,X29,S270,-1.000)
       deallocate(S270)
C
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N1,X30,S271,-1.000)
       deallocate(S271)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N1,X31,S272,-1.000)
       deallocate(S272)
C
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z31, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z31,-1.000)
       deallocate(Z31)
       deallocate(X31)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
...
C
       call
     & sum3412(M1,N1,N1,M2,N1,M2,M1,N1,X32,S273,-1.000)
       deallocate(S273)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z32, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z32,-1.000)
       deallocate(Z32)
       deallocate(X32)
C
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S274,-1.000)
       deallocate(S274)
C
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S275,-1.000)
       deallocate(S275)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S276,-1.000)
       deallocate(S276)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S277,-1.000)
       deallocate(S277)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S278,-1.000)
       deallocate(S278)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S279,-1.000)
       deallocate(S279)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S280,-1.000)
       deallocate(S280)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S281,-1.000)
       deallocate(S281)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S282,-1.000)
       deallocate(S282)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S283,-1.000)
       deallocate(S283)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S284, 1.000)
       deallocate(S284)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S285, 1.000)
       deallocate(S285)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S286, 1.000)
       deallocate(S286)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S287, 1.000)
       deallocate(S287)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M2,N3,M2,N3,M1,N2,S288,D1)
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z390, 1.000)
       deallocate(Z390)
       deallocate(S288)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
...
C
     ...
     & M1,N2,M2,N3,M2,N3,M1,N2,S289,D1)
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z391, 1.000)
       deallocate(Z391)
       deallocate(S289)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M1,N2,S290,D1)
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z392, 1.000)
       deallocate(Z392)
       deallocate(S290)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M1,N2,S291,D1)
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z393, 1.000)
       deallocate(Z393)
       deallocate(S291)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X71,S292, 1.000)
       deallocate(S292)
C
...
C
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N2,X72,S293, 1.000)
       deallocate(S293)
C
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N2,X73,S294, 1.000)
       deallocate(S294)
C
...
C
       call
     & sum3412(M1,N2,N1,M2,M2,N3,M1,N2,X74,S295, 1.000)
       deallocate(S295)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N1,M2,M1,N2,X75,S296, 1.000)
       deallocate(S296)
C
       allocate(D1(N0+1:N1,N2+1:N3,M1+1:N2,N1+1:M2))
       call reorder4132(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N2,N1,M2,N1,M2,M1,N2,X76,S297, 1.000)
       deallocate(S297)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X77,Q35, 1.000)
       deallocate(Q35)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X78,Q36, 1.000)
       deallocate(Q36)
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K8*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U402)
       deallocate(D1)
       deallocate(F2)
C
       allocate(F1(N0+1:N2,N0+1:N1,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder561234(N1,M2,M1,N2,M1,N1,M1,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,N1,M2,M1,N2,M1,N1,M1,N1,U402,F1)
       allocate(D2(N0+1:N2,N0+1:N1,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
       ...
       I2=K6*K6
       I3=K1*K2
       call DMATMAT(I1,I2,I3,F1,D2,Z403)
       deallocate(F1)
       deallocate(D2)
C
       V3B=V3B+Z403
...
C
       ...
       call reorder651234(N1,M2,M1,N2,M1,N1,M1,N1,N0,N2,N0,N1,
     & N0,N1,N0,N2,N1,M2,M1,N2,M1,N1,M1,N1,U402,F1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,U517)
       deallocate(F1)
       deallocate(B2)
C
       call
     & sum213456(N0,N2,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,X81,U517,-1.000)
       deallocate(U517)
C
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call DMATMAT(I1,I2,I3,X81,B2,Z187)
       deallocate(B2)
C
       V3B=V3B-Z187
       deallocate(Z187)
...
C
       call
     & sum3412(M2,N3,N1,M2,M2,N3,M2,N3,X50,S299, 1.000)
       deallocate(S299)
C
...
C
       call
     & sum3412(N2,M2,N1,M2,M2,N3,M2,N3,X51,S300, 1.000)
       deallocate(S300)
C
...
C
       call
     & sum3412(N2,M2,M2,N3,M2,N3,N1,M2,X52,S301, 1.000)
       deallocate(S301)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M2,N3,N1,M2,M2,N3,N1,M2,X53,S302, 1.000)
       deallocate(S302)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N2,M2,N1,M2,M2,N3,N1,M2,X54,S303, 1.000)
       deallocate(S303)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X79,Q37,-1.000)
       deallocate(Q37)
C
...
C
       call
     & sum21(N2,M2,M2,N3,X80,Q38,-1.000)
       deallocate(Q38)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S304,-0.500)
       deallocate(S304)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S305,-1.000)
       deallocate(S305)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S306,-0.500)
       deallocate(S306)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S307, 0.500)
       deallocate(S307)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S308, 1.000)
       deallocate(S308)
C
...
C
       call
     & sum2341(N2,N3,M2,N3,N1,M2,M1,N1,X91,S309, 0.500)
       deallocate(S309)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N1,X90,S310,-0.500)
       deallocate(S310)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N1,X90,S311,-1.000)
       deallocate(S311)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,M2,N3,M2,N3,M1,N1,X90,S312,-0.500)
       deallocate(S312)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S313, 0.500)
       deallocate(S313)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S314, 0.500)
       deallocate(S314)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S315, 1.000)
       deallocate(S315)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S316, 1.000)
       deallocate(S316)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S317, 0.500)
       deallocate(S317)
C
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X92,S318, 0.500)
       deallocate(S318)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S319, 1.000)
       deallocate(S319)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S320, 1.000)
       deallocate(S320)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S321, 0.500)
       deallocate(S321)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X93,S322, 0.500)
       deallocate(S322)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
...
C
       ...
       X59=0.0d0
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X59,S323, 1.000)
       deallocate(S323)
C
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z59,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z59, 1.000)
       deallocate(Z59)
       deallocate(X59)
C
...
C
       ...
       X60=0.0d0
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N1,X60,S324, 1.000)
       deallocate(S324)
C
       call sumx1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z60,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z60, 1.000)
       deallocate(Z60)
       deallocate(X60)
C
...
C
       ...
       X61=0.0d0
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N1,X61,S325, 1.000)
       deallocate(S325)
C
       call sumx1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z61, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z61,-1.000)
       deallocate(Z61)
       deallocate(X61)
C
...
C
       ...
       X62=0.0d0
       call
     & sum3412(M1,N2,N2,M2,M2,N3,M1,N1,X62,S326, 1.000)
       deallocate(S326)
C
       call sumx1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z62, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z62,-1.000)
       deallocate(Z62)
       deallocate(X62)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
...
C
       call
     & sum3412(N0,M1,N2,M2,N1,M2,M1,N1,X87,S327, 1.000)
       deallocate(S327)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder4231(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,N2,M2,N1,M2,M1,N1,X88,S328, 1.000)
       deallocate(S328)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X11,S329, 1.000)
       deallocate(S329)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N2,X12,S330, 1.000)
       deallocate(S330)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N2,X13,S331, 1.000)
       deallocate(S331)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N2,X14,S332, 1.000)
       deallocate(S332)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X55,S333,-1.000)
       deallocate(S333)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N2,X56,S334,-1.000)
       deallocate(S334)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N2,X57,S335,-1.000)
       deallocate(S335)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,N2,M2,M2,N3,M1,N2,X58,S336,-1.000)
       deallocate(S336)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X20,Q42, 0.500)
       deallocate(Q42)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X21,Q43, 0.500)
       deallocate(Q43)
C
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X64,S339, 1.000)
       deallocate(S339)
C
       allocate(D1(N0+1:N1,N0+1:N1,M1+1:N1,M1+1:N1))
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N1,M1,N1,X63,S338,-1.000)
       deallocate(S338)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
       call reorder4312(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S340,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N1,X6,S341, 1.000)
       deallocate(S341)
C
...
C
     ...
     & N0,N1,N1,N3,M2,N3,M1,N1,S342,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N1,N3,M2,N3,N1,M2,M1,N1,X6,S346,-1.000)
       deallocate(S346)
C
       allocate(D1(N1+1:N3,N0+1:N1,M2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N1,N3,M2,N3,
     & N1,N3,N0,N1,M2,N3,M1,N1,S342,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
...
C
       call
     & sum3124(N0,N1,M2,N3,M1,N1,M1,N1,X4,S343, 1.000)
       deallocate(S343)
C
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N1,X6,S347, 1.000)
       deallocate(S347)
C
       allocate(D1(N1+1:N3,N0+1:N1,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N1,N3,N1,M2,
     & N1,N3,N0,N1,N1,M2,M1,N1,S344,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
...
C
       call
     & sum3124(N0,N1,N1,M2,M1,N1,M1,N1,X5,S345, 1.000)
       deallocate(S345)
C
...
C
     ...
     & N0,N1,N0,N2,M1,N2,M1,N1,S348,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S350,-1.000)
       deallocate(S350)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,M1,N2,
     & N0,N2,N0,N1,M1,N2,M1,N1,S348,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S386,-1.000)
       deallocate(S386)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,M1,N2,
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N1,X7,S349,-1.000)
       deallocate(S349)
C
...
C
     ...
     & N0,N1,N2,N3,M2,N3,M1,N1,S351,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,M2,N3,M2,N3,M1,N1,X9,S352,-1.000)
       deallocate(S352)
C
       allocate(D1(N2+1:N3,N0+1:N1,M2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N2,N3,M2,N3,
     & N2,N3,N0,N1,M2,N3,M1,N1,S351,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N1,M2,N3,M1,N2,M1,N1,X1,S387, 1.000)
       deallocate(S387)
C
       allocate(D1(N0+1:N1,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N2,N3,M2,N3,
...
C
       call
     & sum3124(N2,N3,M2,N3,N1,M2,M1,N1,X10,S353,-1.000)
       deallocate(S353)
C
...
C
     ...
     & N1,N3,M1,N1,M1,N1,M1,N1,S358,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
...
C
       call
     & sum3124(M1,N1,M1,N1,M1,N1,M1,N1,X26,S359, 1.000)
       deallocate(S359)
C
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N1,S360,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N1,X27,S361, 1.000)
       deallocate(S361)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z27, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z27,-1.000)
       deallocate(Z27)
       deallocate(X27)
C
...
C
     ...
     & N0,N1,M1,N1,M2,N3,M1,N1,S362,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N1,X28,S363, 1.000)
       deallocate(S363)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z28, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z28,-1.000)
       deallocate(Z28)
       deallocate(X28)
C
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N1,S364,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N1,X29,S365, 1.000)
       deallocate(S365)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z29, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z29,-1.000)
       deallocate(Z29)
       deallocate(X29)
C
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S366,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N1,N1,M2,M2,N3,M1,N1,X30,S367, 1.000)
       deallocate(S367)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z30, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z30,-1.000)
       deallocate(Z30)
       deallocate(X30)
C
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N1,S368,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N1,X65,S369,-1.000)
       deallocate(S369)
C
       allocate(F2(N0+1:M1,N1+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder531246(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X65,F2,Z94)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z94, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z94,-1.000)
       deallocate(Z94)
       deallocate(X65)
C
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S370,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(M1,N1,N1,M2,N1,M2,M1,N1,X66,S371,-1.000)
       deallocate(S371)
C
       allocate(F2(M1+1:N1,N1+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder531246(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X66,F2,Z95)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z95, 1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z95,-1.000)
       deallocate(Z95)
       deallocate(X66)
C
...
C
     ...
     & N0,N1,M2,N3,N1,M2,N1,M2,S372,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M2,N3,N1,M2,M2,N3,N1,M2,X33,S373, 1.000)
       deallocate(S373)
C
...
C
       call
     & sum145623(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z33, 1.000)
       deallocate(Z33)
       deallocate(X33)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:M2,N1+1:M2))
...
C
     ...
     & N0,N1,N1,M2,N1,M2,N1,M2,S374,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N1,M2,N1,M2,M2,N3,N1,M2,X34,S375, 1.000)
       deallocate(S375)
C
       call sumx1234(N1,N3,N1,N3,N1,N3,N1,M2,
...
C
       call
     & sum145623(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z34, 0.500)
       deallocate(Z34)
       deallocate(X34)
C
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q52,B2,Q54)
       deallocate(B2)
C
       call
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N1,X83,S377,-1.000)
       deallocate(S377)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X83,F2,Z282)
       deallocate(F2)
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z282,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z282, 1.000)
       deallocate(Z282)
       deallocate(X83)
C
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,S378,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N1,X84,S379,-1.000)
       deallocate(S379)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder412356(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X84,F2,Z283)
       deallocate(F2)
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z283,-1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z283, 1.000)
       deallocate(Z283)
       deallocate(X84)
C
...
C
     ...
     & N0,N1,N0,M1,N2,M2,M1,N1,S380,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,N1,M2,M1,N1,X87,S384,-1.000)
       deallocate(S384)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder421356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X87,F2,Z286)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z286,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z286, 1.000)
       deallocate(Z286)
       deallocate(X87)
C
       allocate(D1(N0+1:N1,N0+1:M1,N2+1:M2,M1+1:N1))
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N1,X85,S381,-1.000)
       deallocate(S381)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder421356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X85,F2,Z284)
       deallocate(F2)
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z284, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z284,-1.000)
       deallocate(Z284)
       deallocate(X85)
C
...
C
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,S382,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(M1,N2,N2,M2,N1,M2,M1,N1,X88,S385,-1.000)
       deallocate(S385)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder421356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X88,F2,Z287)
       deallocate(F2)
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z287,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z287, 1.000)
       deallocate(Z287)
       deallocate(X88)
C
       allocate(D1(N0+1:N1,M1+1:N2,N2+1:M2,M1+1:N1))
...
C
       call
     & sum3124(M1,N2,N2,M2,M2,N3,M1,N1,X86,S383,-1.000)
       deallocate(S383)
C
       allocate(F2(M1+1:N2,N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder421356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X86,F2,Z285)
       deallocate(F2)
C
       call
     & sum134526(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z285, 1.000)
       call
     & sum134625(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z285,-1.000)
       deallocate(Z285)
       deallocate(X86)
C
...
C
     ...
     & N1,N3,N0,M1,N0,M1,M1,N1,S354,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N0,M1,M1,N1,M1,N1,X24,S355, 1.000)
       deallocate(S355)
C
       call sumx3412(N0,N1,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & N1,N3,N0,M1,M1,N1,M1,N1,S356,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N1,M1,N1,X25,S357, 1.000)
       deallocate(S357)
C
       call sumx3412(N0,N1,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & N0,N2,N1,N3,M2,N3,M1,N2,S388,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,M2,N3,M1,N2,X2,S389, 1.000)
       deallocate(S389)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,M1+1:N2))
       call reorder4321(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S390,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S391, 1.000)
       deallocate(S391)
C
...
C
     ...
     & N0,N1,N1,N3,M2,N3,M1,N2,S392,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N1,N3,M2,N3,N1,M2,M1,N2,X3,S394,-1.000)
       deallocate(S394)
C
       allocate(D1(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N1,N1,N3,M2,N3,
...
C
       call
     & sum3124(N1,N3,M2,N3,M2,N3,M1,N2,X2,S393,-1.000)
       deallocate(S393)
C
...
C
     ...
     & N0,N1,N0,N2,M1,N2,M1,N1,S395,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S397,-1.000)
       deallocate(S397)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S395,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S487,-1.000)
       deallocate(S487)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N1,X7,S396,-1.000)
       deallocate(S396)
C
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S400,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S401, 1.000)
       deallocate(S401)
C
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N1,S402,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N1,X9,S406,-1.000)
       deallocate(S406)
C
       allocate(D1(N2+1:N3,N0+1:N2,M2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,M2,N3,
     & N2,N3,N0,N2,M2,N3,M1,N1,S402,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N2,M2,N3,M1,N2,M1,N1,X7,S403, 1.000)
       deallocate(S403)
C
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S404,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S407,-1.000)
       deallocate(S407)
C
       allocate(D1(N2+1:N3,N0+1:N2,N1+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,N1,M2,
     & N2,N3,N0,N2,N1,M2,M1,N1,S404,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N2,N1,M2,M1,N2,M1,N1,X8,S405, 1.000)
       deallocate(S405)
C
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N1,S408,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N0,M1,M1,N2,M1,N1,X35,S409, 1.000)
       deallocate(S409)
C
...
C
       call
     & sum123546(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z35,-1.000)
       call
     & sum123645(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z35, 1.000)
       deallocate(Z35)
       deallocate(X35)
C
...
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,S410,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(M1,N2,N0,M1,M1,N2,M1,N1,X36,S411, 1.000)
       deallocate(S411)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum123546(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z36,-1.000)
       call
     & sum123645(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z36, 1.000)
       deallocate(Z36)
       deallocate(X36)
C
...
C
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,S412,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N2,M1,N1,X37,S413, 1.000)
       deallocate(S413)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum123546(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z37,-1.000)
       call
     & sum123645(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z37, 1.000)
       deallocate(Z37)
       deallocate(X37)
C
...
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,S414,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M1,N1,M1,N2,M1,N1,X38,S415, 1.000)
       deallocate(S415)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum123546(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z38,-1.000)
       call
     & sum123645(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z38, 1.000)
       deallocate(Z38)
       deallocate(X38)
C
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N1,S416,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N1,X67,S417,-1.000)
       deallocate(S417)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X67,F2,Z115)
       deallocate(F2)
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z115, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z115,-1.000)
       deallocate(Z115)
       deallocate(X67)
C
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,S418,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N1,X68,S419,-1.000)
       deallocate(S419)
C
       allocate(F2(M1+1:N1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X68,F2,Z116)
       deallocate(F2)
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z116, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z116,-1.000)
       deallocate(Z116)
       deallocate(X68)
C
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N1,S420,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N1,X69,S421,-1.000)
       deallocate(S421)
C
       allocate(F2(N0+1:M1,N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X69,F2,Z117)
       deallocate(F2)
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z117, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z117,-1.000)
       deallocate(Z117)
       deallocate(X69)
C
...
C
     ...
     & N0,N2,M1,N1,N2,M2,M1,N1,S422,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,N2,M2,M2,N3,M1,N1,X70,S423,-1.000)
       deallocate(S423)
C
       allocate(F2(M1+1:N1,N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder512346(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,M2,N3,N1,M2,M1,N2,M1,N1,t3B1,F2)
       ...
       I2=K7*K8*K9*K6
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X70,F2,Z118)
       deallocate(F2)
C
       call
     & sum234516(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z118, 1.000)
       call
     & sum234615(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z118,-1.000)
       deallocate(Z118)
       deallocate(X70)
C
...
C
       V3B=V3B+Z15
       call
     & sum123465(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z15,-1.000)
       deallocate(Z15)
       deallocate(X15)
C
...
C
       V3B=V3B+Z16
       call
     & sum123465(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z16,-1.000)
       deallocate(Z16)
       deallocate(X16)
C
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N2,S424,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X71,S425, 1.000)
       deallocate(S425)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X71,F2,Z119)
       deallocate(F2)
C
       call
     & sum135624(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z119, 1.000)
       deallocate(Z119)
       deallocate(X71)
C
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N2,S426,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X72,S427, 1.000)
       deallocate(S427)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X72,F2,Z120)
       deallocate(F2)
C
       call
     & sum135624(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z120, 1.000)
       deallocate(Z120)
       deallocate(X72)
C
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N2,S428,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,N1,M2,M1,N2,X75,S432, 1.000)
       deallocate(S432)
C
       allocate(F2(N0+1:M1,N1+1:M2,M2+1:N3,M2+1:N3,M1+1:N1,M1+1:N1))
       call reorder431256(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X75,F2,Z123)
       deallocate(F2)
C
       call
     & sum125634(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z123, 1.000)
       deallocate(Z123)
       deallocate(X75)
C
       allocate(D1(N0+1:N1,N0+1:M1,N1+1:M2,M1+1:N2))
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X73,S429, 1.000)
       deallocate(S429)
C
       allocate(F2(N0+1:M1,N1+1:M2,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,N1,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X73,F2,Z121)
       deallocate(F2)
C
       call
     & sum135624(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z121, 1.000)
       deallocate(Z121)
       deallocate(X73)
C
...
C
     ...
     & N0,N1,M1,N2,N1,M2,M1,N2,S430,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(M1,N2,N1,M2,N1,M2,M1,N2,X76,S433, 1.000)
       deallocate(S433)
C
       allocate(F2(M1+1:N2,N1+1:M2,M2+1:N3,M2+1:N3,M1+1:N1,M1+1:N1))
       call reorder431256(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,M2,N3,M2,N3,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K6*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X76,F2,Z124)
       deallocate(F2)
C
       call
     & sum125634(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z124, 1.000)
       deallocate(Z124)
       deallocate(X76)
C
       allocate(D1(N0+1:N1,M1+1:N2,N1+1:M2,M1+1:N2))
...
C
       call
     & sum3124(M1,N2,N1,M2,M2,N3,M1,N2,X74,S431, 1.000)
       deallocate(S431)
C
       allocate(F2(M1+1:N2,N1+1:M2,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder421356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,N1,M2,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6
       I3=K9*K8
       call DMATMAT(I1,I2,I3,X74,F2,Z122)
       deallocate(F2)
C
       call
     & sum135624(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z122, 1.000)
       deallocate(Z122)
       deallocate(X74)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X77,Q60, 1.000)
       deallocate(Q60)
C
       allocate(F2(N0+1:M1,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6*K6
       I3=K5
       call DMATMAT(I1,I2,I3,X77,F2,Z125)
       deallocate(F2)
C
       call
     & sum123564(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z125,-1.000)
       deallocate(Z125)
       deallocate(X77)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X78,Q62, 1.000)
       deallocate(Q62)
C
       allocate(F2(M1+1:N2,M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N1,M1+1:N1))
       call reorder412356(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N1,M1,N1,t3B1,F2)
       ...
       I2=K7*K7*K9*K6*K6
       I3=K8
       call DMATMAT(I1,I2,I3,X78,F2,Z126)
       deallocate(F2)
C
       call
     & sum123564(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z126,-1.000)
       deallocate(Z126)
       deallocate(X78)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
...
C
       call
     & sum3412(N2,M2,M2,N3,M2,N3,M2,N3,X49,S298, 1.000)
       deallocate(S298)
C
...
C
     ...
     & N0,N2,N2,M2,M2,N3,M2,N3,S434,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,M2,M2,N3,M2,N3,M2,N3,X49,S435, 1.000)
       deallocate(S435)
C
...
C
       call
     & sum345612(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z49, 1.000)
       deallocate(Z49)
       deallocate(X49)
C
...
C
     ...
     & N0,N2,M2,N3,N1,M2,M2,N3,S436,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M2,N3,N1,M2,M2,N3,M2,N3,X50,S437, 1.000)
       deallocate(S437)
C
...
C
       call
     & sum345612(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z50, 1.000)
       deallocate(Z50)
       deallocate(X50)
C
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M2,N3,S438,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,M2,N1,M2,M2,N3,M2,N3,X51,S439, 1.000)
       deallocate(S439)
C
       call sumx3412(N2,N3,N1,N3,N2,N3,N1,M2,
...
C
       call
     & sum345612(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z51, 1.000)
       deallocate(Z51)
       deallocate(X51)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:M2,M2+1:N3))
...
C
     ...
     & N0,N2,N2,M2,M2,N3,N1,M2,S440,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,M2,M2,N3,M2,N3,N1,M2,X52,S441, 1.000)
       deallocate(S441)
C
...
C
       call
     & sum245613(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z52,-1.000)
       deallocate(Z52)
       deallocate(X52)
C
       allocate(D1(N0+1:N1,N0+1:N2,M2+1:N3,N1+1:M2))
...
C
     ...
     & N0,N2,M2,N3,N1,M2,N1,M2,S442,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M2,N3,N1,M2,M2,N3,N1,M2,X53,S443, 1.000)
       deallocate(S443)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
...
C
       call
     & sum245613(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z53, 1.000)
       deallocate(Z53)
       deallocate(X53)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:M2,N1+1:M2))
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N1,M2,S444,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N2,M2,N1,M2,M2,N3,N1,M2,X54,S445, 1.000)
       deallocate(S445)
C
       call sumx1234(N2,N3,N1,N3,N2,N3,N1,M2,
...
C
       call
     & sum245613(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z54, 1.000)
       deallocate(Z54)
       deallocate(X54)
C
...
C
       call
     & sum21(M2,N3,M2,N3,X79,Q64,-1.000)
       deallocate(Q64)
C
       allocate(F2(M2+1:N3,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
...
C
       call
     & sum234561(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z135, 1.000)
       deallocate(Z135)
       deallocate(X79)
C
...
C
       call
     & sum21(N2,M2,M2,N3,X80,Q66,-1.000)
       deallocate(Q66)
C
       allocate(F2(N2+1:M2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1,M1+1:N1))
       call reorder123456(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
...
C
       call
     & sum234561(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z136, 1.000)
       deallocate(Z136)
       deallocate(X80)
C
...
C
       call
     & sum134562(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z17, 1.000)
       deallocate(Z17)
       deallocate(X17)
C
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q69,B2,Q71)
       deallocate(B2)
C
       call
...
C
       call
     & sum124563(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z19, 1.000)
       deallocate(Z19)
       deallocate(X19)
C
       allocate(B2(N0+1:N1,M2+1:N3))
...
C
       call
     & sum134562(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z18, 1.000)
       deallocate(Z18)
       deallocate(X18)
C
...
C
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,S446,D1)
       allocate(D2(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N1,t2A,D2)
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N1,M1,N1,X63,S448, 1.000)
       deallocate(S448)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X64,S449,-1.000)
       deallocate(S449)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N0,N1,N1,N3,
     & N0,N1,N0,N1,N1,N3,M1,N1,S446,D1)
       allocate(D2(N0+1:N1,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,M2,N3,N1,M2,t2A,D2)
...
C
       call
     & sum2314(N1,N3,M2,N3,N1,M2,M1,N1,X6,S450, 0.500)
       deallocate(S450)
C
       allocate(D1(N1+1:N3,N0+1:N1,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N1,N0,N1,N1,N3,
     & N1,N3,N0,N1,N0,N1,M1,N1,S446,D1)
       allocate(B2(N1+1:N3,M1+1:N1))
       call reorder12(N1,N3,N0,N1,
     & N1,N3,M1,N1,t1A,B2)
...
C
       allocate(D1(N0+1:N1,N0+1:N1,M1+1:N1,M1+1:N1))
       call reorder2314(M1,N1,N0,N1,N0,N1,M1,N1,
     & N0,N1,N0,N1,M1,N1,M1,N1,S535,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N1,M1,N1,X4,S536,-1.000)
       deallocate(S536)
C
       allocate(D1(N0+1:N1,N0+1:N1,N1+1:N3,M1+1:N1))
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder2314(N1,M2,N0,N1,N1,N3,M1,N1,
     & N0,N1,N1,N3,N1,M2,M1,N1,S538,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N1,X6,S539, 1.000)
       deallocate(S539)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N1,N0,N1,N1,N3,
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N2,M1,N1,X1,S447, 1.000)
       deallocate(S447)
C
       allocate(D1(N0+1:N1,N0+1:N1,M1+1:N1,M1+1:N1))
       call reorder3214(M1,N1,N0,N1,N0,N1,M1,N1,
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X5,S537, 1.000)
       deallocate(S537)
C
...
C
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S458)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S458,-1.000)
       deallocate(S458)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S463, 1.000)
       deallocate(S463)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     ...
     & N1,N3,M2,N3,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S456)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S456,-1.000)
       deallocate(S456)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder4231(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
     ...
     & N0,N1,N1,N3,N1,M2,M1,N1,S459,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N1,X6,S460,-1.000)
       deallocate(S460)
C
...
C
     ...
     & N0,N1,N1,N3,N1,N3,N1,M2,S461,D1)
       allocate(D2(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N1,t2A,D2)
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,M1,N1,X6,S462,-1.000)
       deallocate(S462)
C
...
C
       call
     & sum145236(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z6, 1.000)
       call
     & sum146235(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z6,-1.000)
       deallocate(Z6)
       deallocate(X6)
C
...
C
     ...
     & N0,N1,N0,N1,M1,N1,M1,N1,S453,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N1,M1,N1,X4,S454,-0.500)
       deallocate(S454)
C
       allocate(D1(N0+1:N1,N0+1:N1,M1+1:N1,M1+1:N1))
...
C
       call
     & sum2134(N0,N1,N1,M2,M1,N1,M1,N1,X5,S457, 0.500)
       deallocate(S457)
C
...
C
     ...
     & N0,N1,N1,N3,M2,N3,M1,N2,S466,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N1,N3,M2,N3,N1,M2,M1,N2,X3,S468,-1.000)
       deallocate(S468)
C
       allocate(D1(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N2))
       call reorder3412(M2,N3,M1,N2,N0,N1,N1,N3,
...
C
       call
     & sum3124(N1,N3,M2,N3,M2,N3,M1,N2,X2,S467,-1.000)
       deallocate(S467)
C
...
C
     ...
     & N0,N2,N0,N1,N2,N3,M1,N1,S464,D1)
       allocate(D2(N0+1:N2,N0+1:N1,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
...
C
       call
     & sum2314(N2,N3,M2,N3,M2,N3,M1,N1,X9,S470, 1.000)
       deallocate(S470)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,M1,N1,S464,D1)
       allocate(D2(N0+1:N1,N2+1:N3,N1+1:M2,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,N1,M2,M1,N2,t2B,D2)
...
C
       call
     & sum2314(N0,N2,N1,M2,M1,N2,M1,N1,X8,S471,-1.000)
       deallocate(S471)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
       call
     & sum2314(N0,N2,M2,N3,M1,N2,M1,N1,X7,S472,-1.000)
       deallocate(S472)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N2,N3,N0,N1,M1,N1,S464,D1)
       allocate(D2(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M2,N3,M1,N1,t2B,D2)
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N1,M1,N1,X63,S473, 1.000)
       deallocate(S473)
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X63,D2,Z70)
       deallocate(D2)
C
       call
     & sum134256(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z70,-1.000)
       call
     & sum134265(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z70, 1.000)
       deallocate(Z70)
       deallocate(X63)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
...
C
       call
     & sum2314(N0,N1,N1,M2,M1,N1,M1,N1,X64,S474, 1.000)
       deallocate(S474)
C
     ...
     & N0,N1,M2,N3,M2,N3,M1,N2,t2B,D2)
       ...
       I2=K8*K6*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X64,D2,Z71)
       deallocate(D2)
C
       call
     & sum124356(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z71, 1.000)
       call
     & sum124365(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z71,-1.000)
       deallocate(Z71)
       deallocate(X64)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
...
C
       call
     & sum2314(N0,N1,M2,N3,M1,N2,M1,N1,X1,S465, 1.000)
       deallocate(S465)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N2,N0,N1,N2,N3,
     & N2,N3,N0,N2,N0,N1,M1,N1,S464,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S540,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N1,X7,S541,-1.000)
       deallocate(S541)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N0,N2,N2,N3,M1,N1,S464,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S546, 1.000)
       deallocate(S546)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N1,S543,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N1,X9,S544, 1.000)
       deallocate(S544)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
       call
     & sum2314(N2,N3,M2,N3,N1,M2,M1,N1,X10,S469, 1.000)
       deallocate(S469)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
...
C
       call
     & sum2134(N0,N2,N1,M2,M1,N2,M1,N1,X8,S542,-1.000)
       deallocate(S542)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S540,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X1,S547,-1.000)
       deallocate(S547)
C
...
C
       call
     & sum235146(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z1, 1.000)
       call
     & sum236145(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z1,-1.000)
       deallocate(Z1)
       deallocate(X1)
C
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N1,M2,S477,D1)
       allocate(D2(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M2,N3,M1,N1,t2B,D2)
...
C
       call
     & sum2413(N1,N3,M2,N3,N1,M2,M1,N1,X89,S478, 1.000)
       deallocate(S478)
C
       allocate(D1(N0+1:N2,N1+1:N3,N2+1:N3,N1+1:M2))
       call reorder2431(N1,M2,N0,N2,N2,N3,N1,N3,
     & N0,N2,N1,N3,N2,N3,N1,M2,S477,D1)
       allocate(D2(N0+1:N2,N1+1:N3,M2+1:N3,M1+1:N1))
       call reorder3214(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N1,N3,M2,N3,M1,N1,t2B,D2)
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S550,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S551, 1.000)
       deallocate(S551)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:M2))
       call reorder3421(N1,M2,N0,N2,N2,N3,N1,N3,
     & N2,N3,N1,N3,N0,N2,N1,M2,S477,D1)
       allocate(D2(N2+1:N3,N1+1:N3,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,N3,M1,N2,M1,N1,t2B,D2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S491,-1.000)
       deallocate(S491)
C
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,S492,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X11,S493,-1.000)
       deallocate(S493)
C
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z11, 1.000)
       deallocate(Z11)
       deallocate(X11)
C
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N2,S494,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N2,X12,S495,-1.000)
       deallocate(S495)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z12, 1.000)
       deallocate(Z12)
       deallocate(X12)
C
...
C
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,S496,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X13,S497,-1.000)
       deallocate(S497)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z13,-1.000)
       deallocate(Z13)
       deallocate(X13)
C
...
C
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,S498,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N1,N1,M2,M2,N3,M1,N2,X14,S499,-1.000)
       deallocate(S499)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z14,-1.000)
       deallocate(Z14)
       deallocate(X14)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X55,S501, 1.000)
       deallocate(S501)
C
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z55,-1.000)
       deallocate(Z55)
       deallocate(X55)
C
...
C
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,S502,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X56,S503, 1.000)
       deallocate(S503)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z56,-1.000)
       deallocate(Z56)
       deallocate(X56)
C
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,S504,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N2,X57,S505, 1.000)
       deallocate(S505)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z57,-1.000)
       deallocate(Z57)
       deallocate(X57)
C
...
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,S506,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum3124(M1,N2,N2,M2,M2,N3,M1,N2,X58,S507, 1.000)
       deallocate(S507)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum235614(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z58,-1.000)
       deallocate(Z58)
       deallocate(X58)
C
...
C
       call
     & sum21(N0,M1,M1,N2,X20,Q75, 1.000)
       deallocate(Q75)
C
...
C
       call
     & sum123564(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z20,-1.000)
       deallocate(Z20)
       deallocate(X20)
C
...
C
       call
     & sum21(M1,N2,M1,N2,X21,Q77, 1.000)
       deallocate(Q77)
C
       call sumx21(N0,N2,N0,N2,
...
C
       call
     & sum123564(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z21,-1.000)
       deallocate(Z21)
       deallocate(X21)
C
...
C
       call
     & sum234561(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z22, 1.000)
       deallocate(Z22)
       deallocate(X22)
C
...
C
       call
     & sum234561(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z23, 1.000)
       deallocate(Z23)
       deallocate(X23)
C
...
C
     ...
     & N0,N2,N0,N1,N1,N3,M1,N2,S508,D1)
       allocate(D2(N0+1:N2,N0+1:N1,M2+1:N3,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,M2,N3,M2,N3,t2B,D2)
...
C
       call
     & sum2314(N1,N3,M2,N3,M2,N3,M1,N2,X2,S510, 1.000)
       deallocate(S510)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S508,D1)
       allocate(D2(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N1,t2A,D2)
...
C
       call
     & sum2413(N0,N2,M2,N3,M1,N2,M1,N1,X7,S518, 1.000)
       deallocate(S518)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X8,S519, 1.000)
       deallocate(S519)
C
       allocate(D1(N0+1:N1,N0+1:N2,N1+1:N3,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N0,N2,N1,N3,M1,N2,S508,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       allocate(D1(N0+1:N2,N1+1:N3,M2+1:N3,M1+1:N2))
       call reorder2314(M2,N3,N0,N2,N1,N3,M1,N2,
     & N0,N2,N1,N3,M2,N3,M1,N2,S548,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,M2,N3,M1,N2,X2,S549, 1.000)
       deallocate(S549)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,N1,N1,N3,
...
C
       call
     & sum2314(N1,N3,M2,N3,N1,M2,M1,N2,X3,S509, 1.000)
       deallocate(S509)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N2,M1,N1,X82,S525, 1.000)
       deallocate(S525)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
...
C
       call
     & sum2341(N0,N1,M2,N3,M1,N1,M1,N1,X4,S515,-1.000)
       deallocate(S515)
C
...
C
       call
     & sum134256(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z4,-1.000)
       deallocate(Z4)
       deallocate(X4)
C
       allocate(B1(N1+1:N3,N0+1:N1))
     ...
     & N1,N3,N1,M2,M1,N1,M1,N1,t2A,D2)
       ...
       I2=K7*K7*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S516)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N1,M2,M1,N1,M1,N1,X5,S516,-1.000)
       deallocate(S516)
C
       call sumx2134(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       call
     & sum124356(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z5, 1.000)
       deallocate(Z5)
       deallocate(X5)
C
...
C
     ...
     & N0,N2,N1,N3,M2,N3,M1,N2,S513,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,M2,N3,M1,N2,X2,S514, 1.000)
       deallocate(S514)
C
...
C
     ...
     & N0,N1,N0,N2,M1,N2,M1,N1,S481,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N1,X7,S482,-1.000)
       deallocate(S482)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder3412(M1,N2,M1,N1,N0,N2,N0,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S481,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N0,N1,M2,N3,M1,N2,M1,N1,X82,S520,-1.000)
       deallocate(S520)
C
...
C
     ...
     & N0,N2,N2,N3,N1,M2,M1,N1,S523,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X10,S524,-1.000)
       deallocate(S524)
C
...
C
       call
     & sum245136(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z10, 1.000)
       call
     & sum246135(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z10,-1.000)
       deallocate(Z10)
       deallocate(X10)
C
...
C
     ...
     & N0,N1,N2,N3,M2,N3,M1,N1,S479,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,M2,N3,M2,N3,M1,N1,X90,S480,-1.000)
       deallocate(S480)
C
       allocate(D1(N2+1:N3,N0+1:N1,M2+1:N3,M1+1:N1))
       call reorder4312(M2,N3,M1,N1,N0,N1,N2,N3,
     & N2,N3,N0,N1,M2,N3,M1,N1,S479,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N1,M2,N3,M1,N2,M1,N1,X82,S517,-1.000)
       deallocate(S517)
C
       allocate(D2(N0+1:N1,M2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X82,D2,Z211)
       deallocate(D2)
C
       call
     & sum236145(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z211,-1.000)
       call
     & sum235146(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z211, 1.000)
       deallocate(Z211)
       deallocate(X82)
C
...
C
     ...
     & N0,N2,N2,N3,N0,N2,M1,N2,S526,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,M2,M1,N1,t2B,D2)
...
C
       call
     & sum2413(N0,N2,N1,M2,M1,N2,M1,N1,X92,S527,-1.000)
       deallocate(S527)
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N1,t2B,D2)
       ...
       I2=K7*K6*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X92,D2,Z302)
       deallocate(D2)
C
       call
     & sum126345(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z302,-1.000)
       call
     & sum125346(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z302, 1.000)
       deallocate(Z302)
       deallocate(X92)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
...
C
       call
     & sum2413(N0,N2,M2,N3,M1,N2,M1,N1,X93,S528,-1.000)
       deallocate(S528)
C
     ...
     & N0,N2,M2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X93,D2,Z303)
       deallocate(D2)
C
       call
     & sum136245(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z303,-1.000)
       call
     & sum135246(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z303, 1.000)
       deallocate(Z303)
       deallocate(X93)
C
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N1,S531,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N1,X90,S532,-1.000)
       deallocate(S532)
C
       allocate(D2(N2+1:N3,N1+1:M2,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,X90,D2,Z298)
       deallocate(D2)
C
       call
     & sum346125(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z298,-1.000)
       call
     & sum345126(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z298, 1.000)
       deallocate(Z298)
       deallocate(X90)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
...
C
       call
     & sum2341(N0,N2,N1,M2,M1,N2,M1,N1,X8,S534, 1.000)
       deallocate(S534)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S533)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X7,S533, 1.000)
       deallocate(S533)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       allocate(D1(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N2))
       call reorder3412(M2,N3,M1,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,M2,N3,M1,N2,S451,D1)
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
...
C
       call
     & sum3124(N1,N3,M2,N3,N1,M2,M1,N2,X3,S455,-1.000)
       deallocate(S455)
C
       allocate(D1(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N2))
       call reorder3412(M2,N3,M1,N2,N0,N1,N1,N3,
...
C
       call
     & sum3124(N1,N3,M2,N3,M2,N3,M1,N2,X2,S452,-1.000)
       deallocate(S452)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N1,N1,N3,
     & N0,N1,N1,N3,N1,M2,M1,N1,S475,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N1,X89,S476,-1.000)
       deallocate(S476)
C
       allocate(D2(N1+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call DMATMAT(I1,I2,I3,X89,D2,Z296)
       deallocate(D2)
C
       call
     & sum146235(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z296,-1.000)
       call
     & sum145236(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z296, 1.000)
       deallocate(Z296)
       deallocate(X89)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X7,S484, 1.000)
       deallocate(S484)
C
...
C
       call
     & sum135246(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z7, 1.000)
       call
     & sum136245(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z7,-1.000)
       deallocate(Z7)
       deallocate(X7)
C
       allocate(B1(N2+1:N3,N0+1:N2))
...
C
       call
     & sum125346(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z8,-1.000)
       call
     & sum126345(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z8, 1.000)
       deallocate(Z8)
       deallocate(X8)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N2+1:N3))
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N1,X9,S522,-1.000)
       deallocate(S522)
C
       allocate(D1(N0+1:N1,N0+1:N2,N2+1:N3,M1+1:N1))
       call reorder4312(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder2314(M2,N3,N0,N2,N2,N3,M1,N1,
     & N0,N2,N2,N3,M2,N3,M1,N1,S398,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,M2,N3,M1,N1,X9,S399, 1.000)
       deallocate(S399)
C
       call sumx2314(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum345126(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z9,-1.000)
       call
     & sum346125(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z9, 1.000)
       deallocate(Z9)
       deallocate(X9)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:M2,M1+1:N1))
       call reorder3412(N1,M2,M1,N1,N0,N2,N2,N3,
     & N0,N2,N2,N3,N1,M2,M1,N1,S529,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N2,N3,M2,N3,N1,M2,M1,N1,X91,S530, 1.000)
       deallocate(S530)
C
       allocate(D2(N2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X91,D2,Z300)
       deallocate(D2)
C
       call
     & sum246135(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z300, 1.000)
       call
     & sum245136(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z300,-1.000)
       deallocate(Z300)
       deallocate(X91)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,N1+1:N3))
...
C
     ...
     & N0,N2,N1,N3,N1,M2,M1,N2,S511,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,N1,M2,M1,N2,X3,S512, 1.000)
       deallocate(S512)
C
...
C
       call
     & sum256134(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z3,-1.000)
       deallocate(Z3)
       deallocate(X3)
C
...
C
     ...
     & N0,N2,N1,N3,M2,N3,M1,N2,S488,D1)
       allocate(B2(N0+1:N2,M2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,M2,N3,t1B,B2)
...
C
       call
     & sum2134(N1,N3,M2,N3,M2,N3,M1,N2,X2,S489,-1.000)
       deallocate(S489)
C
       call sumx2341(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum356124(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z2, 1.000)
       deallocate(Z2)
       deallocate(X2)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,M1+1:N1))
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z63,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z63, 1.000)
       deallocate(Z63)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum124536(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z64,-1.000)
       call
     & sum124635(M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,M1,N1,V3B,Z64, 1.000)
       deallocate(Z64)
C
