...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,Q3,F2,Z33)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,Q4,F2,Z34)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K0
       I3=K3*K1
       call DMATMAT(I1,I2,I3,D1,D2,S59)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S80)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S81)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S82)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,Z160)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z164)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,D1,D2,Z165)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X62,D2,Z162)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X64,D2,Z183)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X68,D2,Z228)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X65,D2,Z195)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X69,D2,Z234)
       deallocate(D2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X23,F2,Z35)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X24,F2,Z36)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0*K0
       I3=K5
       call DMATMAT(I1,I2,I3,X21,F2,Z31)
       deallocate(F2)
C
       V3D=V3D-Z31
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X22,F2,Z32)
       deallocate(F2)
C
       V3D=V3D-Z32
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q37,B2,Q41)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X59,F2,Z153)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X57,F2,Z151)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q39,B2,Q42)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X60,F2,Z154)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X58,F2,Z152)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X32,F2,Z60)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X37,F2,Z59)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X39,F2,Z63)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X33,F2,Z62)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X36,F2,Z58)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X35,F2,Z57)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X38,F2,Z61)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K5*K5
       call DMATMAT(I1,I2,I3,X18,F2,Z21)
       deallocate(F2)
C
       V3D=V3D+0.500*Z21
       call
...
C
     ...
     & N0,M1,M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K8*K5
       call DMATMAT(I1,I2,I3,X19,F2,Z22)
       deallocate(F2)
C
       V3D=V3D+Z22
       call
...
C
     ...
     & M1,N2,M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,t3D,F2)
       ...
       I2=K8*K0*K0*K0
       I3=K8*K8
       call DMATMAT(I1,I2,I3,X20,F2,Z23)
       deallocate(F2)
C
       V3D=V3D+0.500*Z23
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X46,F2,Z89)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X42,F2,Z85)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X48,F2,Z91)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X44,F2,Z87)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X47,F2,Z90)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X43,F2,Z86)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X49,F2,Z92)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X45,F2,Z88)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X50,F2,Z93)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X51,F2,Z94)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X52,F2,Z95)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X53,F2,Z96)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K6*K6
       call DMATMAT(I1,I2,I3,X54,F2,Z107)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K0*K6
       call DMATMAT(I1,I2,I3,X55,F2,Z108)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0
       I3=K0*K0
       call DMATMAT(I1,I2,I3,X56,F2,Z109)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q48,B2,Q52)
       deallocate(B2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X40,F2,Z78)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q50,B2,Q53)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X41,F2,Z79)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X29,D2,Z41)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X28,D2,Z42)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X61,D2,Z159)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,D1,D2,Z345)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X27,D2,Z40)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X30,D2,Z43)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X31,D2,Z46)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X25,D2,Z39)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X26,D2,Z38)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X67,D2,Z219)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X63,D2,Z167)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,X66,D2,Z213)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S264)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S269)
       deallocate(B1)
       deallocate(D2)
       deallocate(Q54)
C
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z19)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K8*K0*K0
       I3=K0
       call DMATMAT(I1,I2,I3,B1,F2,Z20)
       deallocate(B1)
       deallocate(F2)
C
       call
