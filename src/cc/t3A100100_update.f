...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3A,F2)
       ...
       I2=K7*K5*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U94)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,F1,B2,Z95)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S68)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S69)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,N0,M1,t2A,D2)
       ...
       I2=K5*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S70)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,N0,M1,t2A,D2)
       ...
       I2=K5*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S71)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,M1,N1,t3A,F2)
       ...
       I2=K7*K5*K5*K9
       I3=K6*K6
       call DMATMAT(I1,I2,I3,D1,F2,U212)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N1,N0,N1,M2,N3,M2,N3,t2A,D2)
       ...
       I2=K6*K6
       I3=K1*K1
       call DMATMAT(I1,I2,I3,F1,D2,Z213)
       deallocate(F1)
       deallocate(D2)
C
       V3A=V3A+0.250*Z213
...
C
     ...
     & N1,M2,M2,N3,M2,N3,N0,M1,N0,M1,M1,N1,t3A,F2)
       ...
       I2=K7*K5*K5*K6*K6
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z220)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3A,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X43,F2,Z70)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N0,M1,t1A,B2)
       ...
       I2=K5
       I3=K3
       call DMATMAT(I1,I2,I3,B1,B2,Q35)
       deallocate(B1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3A,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X44,F2,Z84)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3A,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X45,F2,Z85)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,Q36,B2,Q37)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q38,B2,Q40)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,Q38,B2,Q39)
       deallocate(B2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X46,F2,Z237)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,N0,M1,t3B2,F2)
       ...
       I2=K5*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X48,F2,Z239)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3B4,F2)
       ...
       I2=K5*K5*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X47,F2,Z238)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X49,F2,Z266)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X50,F2,Z267)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X53,F2,Z270)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X51,F2,Z268)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,N0,M1,M1,N1,t3B3,F2)
       ...
       I2=K7*K5*K6*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X54,F2,Z271)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,N0,M1,M1,N1,t3B1,F2)
       ...
       I2=K7*K5*K9*K6
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X52,F2,Z269)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,Q48,B2,Q50)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,M2,N3,M1,N1,t2A,D2)
       ...
       I2=K7*K6*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X41,D2,Z55)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N1,t2A,D2)
       ...
       I2=K7*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X40,D2,Z54)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S350)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,N0,M1,N0,M1,t2A,D2)
       ...
       I2=K5*K5*K6
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S352)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N1,M2,N0,M1,M1,N1,t2A,D2)
       ...
       I2=K7*K5*K9
       I3=K3
       call DMATMAT(I1,I2,I3,X42,D2,Z56)
       deallocate(D2)
C
       call
