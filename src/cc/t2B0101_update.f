...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,X35,B2,Z70)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,M1,M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,t3C1,F2)
       ...
       I2=K5*K6*K0
       I3=K6*K8*K5
       call EGEMM(I1,I2,I3,X27,F2,Z49)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M1,N2,M2,N3,N2,M2,M2,N3,N0,M1,t3C1,F2)
       ...
       I2=K5*K6*K0
       I3=K6*K8*K8
       call EGEMM(I1,I2,I3,X28,F2,Z50)
       deallocate(F2)
C
       call
