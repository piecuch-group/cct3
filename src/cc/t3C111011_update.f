...
C
       ...
       X8=0.0d0
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N1,X8,S3,-1.000)
       deallocate(S3)
C
...
C
       call
     & sum4123(N0,N2,M2,N3,M1,N2,M1,N1,X8,S5, 1.000)
       deallocate(S5)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z88,-1.000)
       deallocate(Z88)
       deallocate(S7)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z89,-1.000)
       deallocate(Z89)
       deallocate(S8)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z90,-1.000)
       deallocate(Z90)
       deallocate(S9)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z91,-1.000)
       deallocate(Z91)
       deallocate(S10)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z94,-1.000)
       deallocate(Z94)
       deallocate(S11)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z95,-1.000)
       deallocate(Z95)
       deallocate(S12)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z96,-1.000)
       deallocate(Z96)
       deallocate(S13)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z97,-1.000)
       deallocate(Z97)
       deallocate(S14)
C
...
C
       ...
       X70=0.0d0
       call
     & sum4123(N0,M1,M2,N3,N2,M2,M1,N1,X70,S19, 1.000)
C
...
C
       ...
       X72=0.0d0
       call
     & sum4123(N0,M1,N2,M2,N2,M2,M1,N1,X72,S21, 1.000)
C
...
C
       ...
       X74=0.0d0
       call
     & sum4123(M1,N1,M2,N3,N2,M2,M1,N1,X74,S20, 1.000)
C
...
C
       ...
       X76=0.0d0
       call
     & sum4123(M1,N1,N2,M2,N2,M2,M1,N1,X76,S22, 1.000)
C
...
C
       ...
       X78=0.0d0
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X78,S23, 1.000)
       deallocate(S23)
C
...
C
       ...
       X79=0.0d0
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X79,S24, 1.000)
       deallocate(S24)
C
...
C
       ...
       X80=0.0d0
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X80,S25, 1.000)
       deallocate(S25)
C
...
C
       ...
       X81=0.0d0
       call
     & sum3124(M1,N2,N1,M2,M2,N3,M1,N2,X81,S26, 1.000)
       deallocate(S26)
C
...
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,M1+1:N1))
       call reorder2314(M2,N3,N0,M1,M2,N3,M1,N1,
     & N0,M1,M2,N3,M2,N3,M1,N1,S31,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z130,-1.000)
       deallocate(Z130)
       deallocate(S31)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z131,-1.000)
       deallocate(Z131)
       deallocate(S32)
C
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M1,N1,S33,D1)
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z132,-1.000)
       deallocate(Z132)
       deallocate(S33)
C
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M1,N1,S34,D1)
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z133,-1.000)
       deallocate(Z133)
       deallocate(S34)
C
       allocate(D1(N1+1:N3,N0+1:M1,M2+1:N3,M2+1:N3))
...
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,M1,M2,N3,M2,N3,
     & N0,M1,M2,N3,M2,N3,M1,N1,S35,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z134, 1.000)
       deallocate(Z134)
       deallocate(S35)
C
...
C
     ...
     & M1,N2,M2,N3,M2,N3,M1,N1,S36,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z135, 1.000)
       deallocate(Z135)
       deallocate(S36)
C
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M1,N1,S37,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z136, 1.000)
       deallocate(Z136)
       deallocate(S37)
C
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M1,N1,S38,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z137, 1.000)
       deallocate(Z137)
       deallocate(S38)
C
...
C
       call
     & sum3124(N0,N2,M2,N3,M1,N2,M1,N1,X8,S54, 1.000)
       deallocate(S54)
C
...
C
       call
     & sum2134(N2,N3,N2,M2,M2,N3,M1,N1,X9,S55,-1.000)
       deallocate(S55)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum2134(N2,N3,N2,M2,M2,N3,M1,N1,X10,S56,-1.000)
       deallocate(S56)
C
...
C
       call
     & sum234516(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z37,-1.000)
       deallocate(Z37)
       deallocate(X37)
C
...
C
       call
     & sum234516(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z38,-1.000)
       deallocate(Z38)
       deallocate(X38)
C
...
C
       call
     & sum234516(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z39,-1.000)
       deallocate(Z39)
       deallocate(X39)
C
...
C
       call
     & sum234516(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z40,-1.000)
       deallocate(Z40)
       deallocate(X40)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N1))
...
C
       call
     & sum134526(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z41, 1.000)
       deallocate(Z41)
       deallocate(X41)
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,M1+1:N1))
...
C
       call
     & sum134526(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z42, 1.000)
       deallocate(Z42)
       deallocate(X42)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,M1+1:N1))
...
C
       call
     & sum134526(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z43, 1.000)
       deallocate(Z43)
       deallocate(X43)
C
       allocate(D1(N0+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
...
C
       call
     & sum134526(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z44, 1.000)
       deallocate(Z44)
       deallocate(X44)
C
...
C
       call
     & sum124635(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z45, 1.000)
       call
     & sum125634(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z45,-1.000)
       deallocate(Z45)
       deallocate(X45)
C
...
C
       call
     & sum124635(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z46, 1.000)
       call
     & sum125634(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z46,-1.000)
       deallocate(Z46)
       deallocate(X46)
C
...
C
       call
     & sum124635(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z47, 1.000)
       call
     & sum125634(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z47,-1.000)
       deallocate(Z47)
       deallocate(X47)
C
...
C
       call
     & sum124635(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z48, 1.000)
       call
     & sum125634(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z48,-1.000)
       deallocate(Z48)
       deallocate(X48)
C
...
C
       call
     & sum123645(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z206, 0.500)
       call
     & sum123654(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z206,-0.500)
       deallocate(Z206)
       deallocate(S97)
C
...
C
       call
     & sum123645(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z207, 1.000)
       call
     & sum123654(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z207,-1.000)
       deallocate(Z207)
       deallocate(S98)
C
...
C
       call
     & sum123645(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z208, 0.500)
       call
     & sum123654(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z208,-0.500)
       deallocate(Z208)
       deallocate(S99)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
...
C
       call
     & sum3124(M2,N3,N2,M2,N2,M2,N2,M2,X68,S118, 1.000)
       deallocate(S118)
C
       allocate(D1(N0+1:N2,N2+1:M2,N2+1:M2,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum3124(N2,M2,N2,M2,N2,M2,N2,M2,X69,S119, 1.000)
       deallocate(S119)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum2413(N0,N2,M2,N3,M1,N2,M1,N1,X8,S120, 1.000)
       deallocate(S120)
C
...
C
       call
     & sum3412(N2,N3,N2,M2,M2,N3,M1,N1,X9,S121, 1.000)
C
       call
     & sum3412(N2,N3,N2,M2,M2,N3,M1,N1,X10,S121, 1.000)
       deallocate(S121)
C
...
C
       ...
       X90=0.0d0
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X90,S122, 1.000)
       deallocate(S122)
C
...
C
       ...
       X91=0.0d0
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N1,X91,S123, 1.000)
       deallocate(S123)
C
...
C
       ...
       X92=0.0d0
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N1,X92,S124, 1.000)
       deallocate(S124)
C
...
C
       ...
       X93=0.0d0
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N1,X93,S125, 1.000)
       deallocate(S125)
C
...
C
     ...
     & M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z244)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sum124563(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z244, 0.500)
       deallocate(Z244)
       deallocate(Q31)
C
...
C
       call
     & sum124563(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z245, 0.500)
       deallocate(Z245)
       deallocate(Q32)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
...
C
       ...
       X94=0.0d0
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X94,S126, 1.000)
       deallocate(S126)
C
...
C
       ...
       X95=0.0d0
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N1,X95,S127, 1.000)
       deallocate(S127)
C
...
C
       ...
       X96=0.0d0
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N1,X96,S128, 1.000)
       deallocate(S128)
C
...
C
       ...
       X97=0.0d0
       call
     & sum3412(M1,N2,N2,M2,M2,N3,M1,N1,X97,S129, 1.000)
       deallocate(S129)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S130, 1.000)
       deallocate(S130)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder12(N1,N3,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S131, 1.000)
       deallocate(S131)
C
...
C
       ...
       X98=0.0d0
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X98,S132, 1.000)
       deallocate(S132)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S133, 1.000)
       deallocate(S133)
C
...
C
       ...
       X100=0.0d0
       call
     & sum2413(N1,N3,N2,M2,M2,N3,M1,N2,X100,S135, 1.000)
       deallocate(S135)
C
...
C
       call
     & sum2314(N1,N3,N2,M2,M2,N3,M1,N2,X4,S136, 1.000)
       deallocate(S136)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2314(N1,N3,N2,M2,M2,N3,M1,N2,X3,S137, 1.000)
       deallocate(S137)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X89,S138, 1.000)
       deallocate(S138)
C
...
C
       call
     & sum2413(N0,N1,N2,M2,M1,N2,M1,N1,X1,S139,-1.000)
       deallocate(S139)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder4231(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X88,S140, 1.000)
       deallocate(S140)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,M1+1:N2))
       call reorder3241(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2413(N0,N1,N2,M2,M1,N2,M1,N1,X2,S141,-1.000)
       deallocate(S141)
C
...
C
       call
     & sum3412(N1,N3,N2,M2,M2,N3,M1,N2,X100,S142, 1.000)
       deallocate(S142)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       ...
       X101=0.0d0
       call
     & sum3412(N2,N3,N2,M2,N2,M2,M1,N2,X101,S143, 1.000)
       deallocate(S143)
C
...
C
       call
     & sum3412(N0,N1,N2,M2,M1,N2,M1,N1,X1,S144, 1.000)
       deallocate(S144)
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3412(N1,N3,N2,M2,M2,N3,M1,N2,X99,S145, 1.000)
       deallocate(S145)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum2413(N2,N3,N2,M2,N2,M2,M1,N2,X101,S146,-1.000)
       deallocate(S146)
C
       allocate(D1(N2+1:N3,N1+1:N3,N0+1:N1,N2+1:M2))
       call reorder1243(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum3412(N0,N1,N2,M2,M1,N2,M1,N1,X2,S147, 1.000)
       deallocate(S147)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X8,S148, 1.000)
       deallocate(S148)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X6,S149,-1.000)
       deallocate(S149)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder12(N2,N3,N0,N2,
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X5,S150,-1.000)
       deallocate(S150)
C
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X98,S151, 1.000)
       deallocate(S151)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder3142(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       ...
       X102=0.0d0
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X102,S152, 1.000)
       deallocate(S152)
C
...
C
       call
     & sum2314(N0,N2,M2,N3,M1,N2,M1,N1,X8,S153,-1.000)
       deallocate(S153)
C
...
C
       call
     & sum2314(N2,N3,N2,M2,M2,N3,M1,N1,X9,S154, 1.000)
       deallocate(S154)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum2314(N2,N3,N2,M2,M2,N3,M1,N1,X10,S155, 1.000)
       deallocate(S155)
C
...
C
       call
     & sum2413(N1,N3,N2,M2,M2,N3,M1,N2,X100,S157,-1.000)
       deallocate(S157)
C
...
C
       call
     & sum3412(N0,N2,M2,N3,M1,N2,M1,N1,X8,S158, 1.000)
       deallocate(S158)
C
...
C
       call
     & sum2413(N2,N3,N2,M2,M2,N3,M1,N1,X9,S159,-1.000)
       deallocate(S159)
C
       allocate(D1(N0+1:N2,N1+1:N3,N2+1:N3,M2+1:N3))
       call reorder3214(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum2413(N2,N3,N2,M2,M2,N3,M1,N1,X10,S160,-1.000)
       deallocate(S160)
C
...
C
       call
     & sum2314(N2,N3,N2,M2,N2,M2,M1,N2,X7,S161, 0.500)
       deallocate(S161)
C
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X89,S162, 1.000)
       deallocate(S162)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
       call reorder3142(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X88,S163, 1.000)
       deallocate(S163)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
...
C
       call
     & sum2413(N0,N2,M2,N3,M1,N2,M1,N1,X8,S164,-1.000)
       deallocate(S164)
C
...
C
       call
     & sum3412(N2,N3,N2,M2,N2,M2,M1,N2,X101,S165,-1.000)
       deallocate(S165)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4123(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum2413(N2,N3,N2,M2,N2,M2,M1,N2,X101,S166, 1.000)
       deallocate(S166)
C
...
C
       call
     & sum3412(N0,N2,N2,M2,M1,N2,M1,N2,X5,S167, 0.500)
       deallocate(S167)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
...
C
       call
     & sum3412(N2,N3,N2,M2,M2,N3,M1,N1,X9,S168, 1.000)
       deallocate(S168)
C
       allocate(D1(N2+1:N3,N2+1:N3,N0+1:N2,N2+1:M2))
       call reorder1243(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum3412(N0,N2,N2,M2,M1,N2,M1,N2,X6,S169, 0.500)
       deallocate(S169)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder4213(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       call
     & sum3412(N2,N3,N2,M2,M2,N3,M1,N1,X10,S170, 1.000)
       deallocate(S170)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S171,-0.500)
       deallocate(S171)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S172,-1.000)
       deallocate(S172)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S173,-0.500)
       deallocate(S173)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S174, 0.500)
       deallocate(S174)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S175, 1.000)
       deallocate(S175)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S177,-0.500)
       deallocate(S177)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S178,-1.000)
       deallocate(S178)
C
       allocate(D1(M1+1:N1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S179,-0.500)
       deallocate(S179)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S180, 0.500)
       deallocate(S180)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S181, 1.000)
       deallocate(S181)
C
       allocate(D1(M1+1:N1,M1+1:N1,N1+1:M2,N1+1:N3))
       call reorder3421(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S182, 0.500)
       deallocate(S182)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S183, 0.500)
       deallocate(S183)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S184, 0.500)
       deallocate(S184)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S185, 1.000)
       deallocate(S185)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S186, 1.000)
       deallocate(S186)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S187, 0.500)
       deallocate(S187)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S188, 0.500)
       deallocate(S188)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X11,S189, 1.000)
       deallocate(S189)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X12,S190, 1.000)
       deallocate(S190)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X13,S191, 1.000)
       deallocate(S191)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X14,S192, 1.000)
       deallocate(S192)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S193, 0.500)
       deallocate(S193)
C
       allocate(D1(M1+1:N1,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S194, 0.500)
       deallocate(S194)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S195, 1.000)
       deallocate(S195)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S196, 1.000)
       deallocate(S196)
C
       allocate(D1(N0+1:M1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S197, 0.500)
       deallocate(S197)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S198, 0.500)
       deallocate(S198)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X15,S199, 1.000)
       deallocate(S199)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X16,S200, 1.000)
       deallocate(S200)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X17,S201, 1.000)
       deallocate(S201)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X18,S202, 1.000)
       deallocate(S202)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S203, 1.000)
       deallocate(S203)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S204, 1.000)
       deallocate(S204)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S205, 1.000)
       deallocate(S205)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S206, 1.000)
       deallocate(S206)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S207, 1.000)
       deallocate(S207)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S208, 1.000)
       deallocate(S208)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X99,S209, 1.000)
       deallocate(S209)
C
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S211, 1.000)
       deallocate(S211)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S212, 1.000)
       deallocate(S212)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S213, 1.000)
       deallocate(S213)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S214, 1.000)
       deallocate(S214)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S215, 1.000)
       deallocate(S215)
C
       allocate(D1(M1+1:N2,N0+1:M1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S216, 1.000)
       deallocate(S216)
C
       allocate(D1(N0+1:M1,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S217, 1.000)
       deallocate(S217)
C
       allocate(D1(M1+1:N2,M1+1:N1,N2+1:M2,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N1,N3,N2,M2,M2,N3,M1,N2,X100,S218, 1.000)
       deallocate(S218)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X101,S219,-1.000)
       deallocate(S219)
C
...
C
       call
     & sum3412(N0,M1,N0,M1,M1,N2,M1,N1,X33,S227, 1.000)
       deallocate(S227)
C
...
C
       call
     & sum3412(M1,N2,N0,M1,M1,N2,M1,N1,X34,S228, 1.000)
       deallocate(S228)
C
...
C
       call
     & sum3412(N0,M1,M1,N1,M1,N2,M1,N1,X35,S229, 1.000)
       deallocate(S229)
C
...
C
       call
     & sum3412(M1,N2,M1,N1,M1,N2,M1,N1,X36,S230, 1.000)
       deallocate(S230)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N1,X70,S239,-1.000)
       deallocate(S239)
C
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N1,X74,S240,-1.000)
       deallocate(S240)
C
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N1,X72,S241,-1.000)
       deallocate(S241)
C
...
C
       call
     & sum3412(M1,N1,N2,M2,N2,M2,M1,N1,X76,S242,-1.000)
       deallocate(S242)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N1,X71,S251,-1.000)
       deallocate(S251)
C
       allocate(D1(N0+1:N2,N1+1:N3,M1+1:N1,M2+1:N3))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N1,X75,S252,-1.000)
       deallocate(S252)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:M1,N2+1:M2))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N1,X73,S253,-1.000)
       deallocate(S253)
C
       allocate(D1(N0+1:N2,N1+1:N3,M1+1:N1,N2+1:M2))
       call reorder3241(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,N2,M2,N2,M2,M1,N1,X77,S254,-1.000)
       deallocate(S254)
C
...
C
       ...
       X29=0.0d0
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X29,S255,-1.000)
       deallocate(S255)
C
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z29,-1.000)
       deallocate(Z29)
       deallocate(X29)
C
...
C
       ...
       X30=0.0d0
       call
     & sum3412(M1,N1,M2,N3,M2,N3,M1,N1,X30,S256,-1.000)
       deallocate(S256)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z30,-1.000)
       deallocate(Z30)
       deallocate(X30)
C
...
C
       ...
       X31=0.0d0
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N1,X31,S257,-1.000)
       deallocate(S257)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z31,-1.000)
       deallocate(Z31)
       deallocate(X31)
C
...
C
       ...
       X32=0.0d0
       call
     & sum3412(M1,N1,N1,M2,M2,N3,M1,N1,X32,S258,-1.000)
       deallocate(S258)
C
       call sumx2431(N1,N3,N0,N1,N1,N3,N0,N1,
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z32,-1.000)
       deallocate(Z32)
       deallocate(X32)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S259, 1.000)
       deallocate(S259)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S260, 1.000)
       deallocate(S260)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S261, 1.000)
       deallocate(S261)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S262, 1.000)
       deallocate(S262)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S263, 1.000)
       deallocate(S263)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S264, 1.000)
       deallocate(S264)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S265, 1.000)
       deallocate(S265)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X98,S266, 1.000)
       deallocate(S266)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M2,N3,N2,M2,M1,N2,S267,D1)
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z389,-1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z389, 1.000)
       deallocate(Z389)
       deallocate(S267)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
...
C
     ...
     & M1,N2,M2,N3,N2,M2,M1,N2,S268,D1)
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z390,-1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z390, 1.000)
       deallocate(Z390)
       deallocate(S268)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
...
C
     ...
     & N0,M1,N2,M2,N2,M2,M1,N2,S269,D1)
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z391,-1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z391, 1.000)
       deallocate(Z391)
       deallocate(S269)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
...
C
     ...
     & M1,N2,N2,M2,N2,M2,M1,N2,S270,D1)
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z392,-1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z392, 1.000)
       deallocate(Z392)
       deallocate(S270)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N1))
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S271, 1.000)
       deallocate(S271)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S272, 1.000)
       deallocate(S272)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S273, 1.000)
       deallocate(S273)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S274, 1.000)
       deallocate(S274)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S275, 1.000)
       deallocate(S275)
C
       allocate(D1(M1+1:N2,M2+1:N3,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S276, 1.000)
       deallocate(S276)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S277, 1.000)
       deallocate(S277)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N0+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X102,S278, 1.000)
       deallocate(S278)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,M2+1:N3))
       call reorder4231(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,M1,M2,N3,
     & N0,M1,M2,N3,N2,M2,M1,N2,S279,D1)
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z401, 1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z401,-1.000)
       deallocate(Z401)
       deallocate(S279)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,M2+1:N3))
...
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,M1,N2,M2,N3,
     & M1,N2,M2,N3,N2,M2,M1,N2,S280,D1)
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z402, 1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z402,-1.000)
       deallocate(Z402)
       deallocate(S280)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:M1,N2+1:M2))
...
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,M1,N2,M2,
     & N0,M1,N2,M2,N2,M2,M1,N2,S281,D1)
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z403, 1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z403,-1.000)
       deallocate(Z403)
       deallocate(S281)
C
       allocate(D1(N0+1:N1,N1+1:N3,M1+1:N2,N2+1:M2))
...
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,M1,N2,N2,M2,
     & M1,N2,N2,M2,N2,M2,M1,N2,S282,D1)
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder412356(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,M2,N3,M1,N2,M1,N1,t3C1,F2)
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z404, 1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z404,-1.000)
       deallocate(Z404)
       deallocate(S282)
C
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N2,X78,S283, 1.000)
       deallocate(S283)
C
...
C
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N2,X79,S284, 1.000)
       deallocate(S284)
C
...
C
       call
     & sum3412(N0,M1,N1,M2,M2,N3,M1,N2,X80,S285, 1.000)
       deallocate(S285)
C
...
C
       call
     & sum3412(M1,N2,N1,M2,M2,N3,M1,N2,X81,S286, 1.000)
       deallocate(S286)
C
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,M2,N3,X49,S287, 1.000)
       deallocate(S287)
C
...
C
       call
     & sum3412(N2,M2,M2,N3,N2,M2,M2,N3,X50,S288, 1.000)
       deallocate(S288)
C
...
C
       call
     & sum3412(M2,N3,N1,M2,N2,M2,M2,N3,X51,S289, 1.000)
       deallocate(S289)
C
...
C
       call
     & sum3412(N2,M2,N1,M2,N2,M2,M2,N3,X52,S290, 1.000)
       deallocate(S290)
C
...
C
       call
     & sum3412(M2,N3,M2,N3,N2,M2,M2,N3,X53,S291, 1.000)
       deallocate(S291)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N2,M2,M2,N3,N2,M2,M2,N3,X54,S292, 1.000)
       deallocate(S292)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M2,N3,N1,M2,N2,M2,M2,N3,X55,S293, 1.000)
       deallocate(S293)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N2,M2,N1,M2,N2,M2,M2,N3,X56,S294, 1.000)
       deallocate(S294)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X101,S295,-0.500)
       deallocate(S295)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X101,S296,-1.000)
       deallocate(S296)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X101,S297,-0.500)
       deallocate(S297)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X101,S299,-1.000)
       deallocate(S299)
C
...
C
       call
     & sum2341(N2,N3,N2,M2,N2,M2,M1,N2,X101,S300,-0.500)
       deallocate(S300)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,N0+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,M2,N3,M2,N3,M1,N1,X94,S307, 1.000)
       deallocate(S307)
C
...
C
       call
     & sum3412(M1,N2,M2,N3,M2,N3,M1,N1,X95,S308, 1.000)
       deallocate(S308)
C
...
C
       call
     & sum3412(N0,M1,N2,M2,M2,N3,M1,N1,X96,S309, 1.000)
       deallocate(S309)
C
...
C
       call
     & sum3412(M1,N2,N2,M2,M2,N3,M1,N1,X97,S310, 1.000)
       deallocate(S310)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S311,-1.000)
       deallocate(S311)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S312,-1.000)
       deallocate(S312)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S313,-1.000)
       deallocate(S313)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S315, 1.000)
       deallocate(S315)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S316, 1.000)
       deallocate(S316)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S318, 1.000)
       deallocate(S318)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S319,-1.000)
       deallocate(S319)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S320,-1.000)
       deallocate(S320)
C
       allocate(D1(N0+1:M1,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S321,-1.000)
       deallocate(S321)
C
       allocate(D1(M1+1:N2,M1+1:N1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S322,-1.000)
       deallocate(S322)
C
       allocate(D1(N0+1:M1,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S323, 1.000)
       deallocate(S323)
C
       allocate(D1(M1+1:N2,N0+1:M1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S324, 1.000)
       deallocate(S324)
C
       allocate(D1(N0+1:M1,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S325, 1.000)
       deallocate(S325)
C
       allocate(D1(M1+1:N2,M1+1:N1,N1+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S326, 1.000)
       deallocate(S326)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       ...
       X103=0.0d0
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S327, 1.000)
       deallocate(S327)
C
       allocate(D1(M1+1:N1,N2+1:M2,M2+1:N3,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S328, 1.000)
       deallocate(S328)
C
       allocate(D1(N0+1:M1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S329,-1.000)
       deallocate(S329)
C
       allocate(D1(M1+1:N1,M2+1:N3,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S330,-1.000)
       deallocate(S330)
C
       allocate(D1(N0+1:M1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S331,-1.000)
       deallocate(S331)
C
       allocate(D1(M1+1:N1,N2+1:M2,N1+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S332,-1.000)
       deallocate(S332)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X11,S333, 1.000)
       deallocate(S333)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X12,S334, 1.000)
       deallocate(S334)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X13,S335, 1.000)
       deallocate(S335)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X14,S336, 1.000)
       deallocate(S336)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X15,S337, 1.000)
       deallocate(S337)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,M2+1:N3))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,M2,N3,N2,M2,M1,N2,X16,S338, 1.000)
       deallocate(S338)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(N0,M1,N1,M2,N2,M2,M1,N2,X17,S339, 1.000)
       deallocate(S339)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N1,N1+1:M2))
       call reorder3142(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3412(M1,N1,N1,M2,N2,M2,M1,N2,X18,S340, 1.000)
       deallocate(S340)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S341, 0.500)
       deallocate(S341)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S342, 1.000)
       deallocate(S342)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S343, 0.500)
       deallocate(S343)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S344, 0.500)
       deallocate(S344)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S345, 1.000)
       deallocate(S345)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X10,S346, 0.500)
       deallocate(S346)
C
       allocate(D1(N0+1:M1,N0+1:M1,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S347, 0.500)
       deallocate(S347)
C
       allocate(D1(N0+1:M1,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S348, 1.000)
       deallocate(S348)
C
       allocate(D1(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S349, 0.500)
       deallocate(S349)
C
       allocate(D1(N0+1:M1,N0+1:M1,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S350, 0.500)
       deallocate(S350)
C
       allocate(D1(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S351, 1.000)
       deallocate(S351)
C
       allocate(D1(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:N3))
       call reorder3421(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N2,N3,N2,M2,M2,N3,M1,N1,X9,S352, 0.500)
       deallocate(S352)
C
...
C
       ...
       X57=0.0d0
       call
     & sum3412(N0,M1,N0,M1,M1,N2,M1,N2,X57,S353, 0.500)
       deallocate(S353)
C
...
C
       ...
       X58=0.0d0
       call
     & sum3412(N0,M1,M1,N2,M1,N2,M1,N2,X58,S354, 0.500)
       deallocate(S354)
C
...
C
       ...
       X59=0.0d0
       call
     & sum3412(M1,N2,M1,N2,M1,N2,M1,N2,X59,S355, 0.500)
       deallocate(S355)
C
       allocate(D1(N0+1:M1,M2+1:N3,N2+1:M2,N0+1:N2))
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S356,-1.000)
       deallocate(S356)
C
       allocate(D1(M1+1:N2,M2+1:N3,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S357,-1.000)
       deallocate(S357)
C
       allocate(D1(N0+1:M1,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S358,-0.500)
       deallocate(S358)
C
       allocate(D1(M1+1:N2,N2+1:M2,N2+1:M2,N0+1:N2))
       call reorder4123(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X103,S359,-0.500)
       deallocate(S359)
C
     ...
     & N0,N2,N2,M2,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K0
       I3=K2
       call DMATMAT(I1,I2,I3,X103,D2,Z463)
       deallocate(D2)
C
       call
     & sum125346(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z463,-1.000)
       call
     & sum124356(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z463, 1.000)
       deallocate(Z463)
       deallocate(X103)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X60,S360,-1.000)
       deallocate(S360)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,M2,N3,N2,M2,M1,N2,X61,S361,-1.000)
       deallocate(S361)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N2,X62,S362,-1.000)
       deallocate(S362)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,M1,N2,X63,S363,-1.000)
       deallocate(S363)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,M2,N3,N2,M2,M1,N2,X64,S364,-1.000)
       deallocate(S364)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,M2+1:N3))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,M2,N3,N2,M2,M1,N2,X65,S365,-1.000)
       deallocate(S365)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:M1,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(N0,M1,N2,M2,N2,M2,M1,N2,X66,S366,-1.000)
       deallocate(S366)
C
       allocate(D1(N0+1:N2,N2+1:N3,M1+1:N2,N2+1:M2))
       call reorder3142(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       call
     & sum3412(M1,N2,N2,M2,N2,M2,M1,N2,X67,S367,-1.000)
       deallocate(S367)
C
...
C
       call
     & sum3412(M2,N3,N2,M2,N2,M2,N2,M2,X68,S368, 0.500)
       deallocate(S368)
C
...
C
       call
     & sum3412(N2,M2,N2,M2,N2,M2,N2,M2,X69,S369, 0.500)
       deallocate(S369)
C
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S390,-1.000)
       deallocate(S390)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,M1,N2,
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X2,S391,-1.000)
       deallocate(S391)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N1,S374,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N1,X90,S375,-1.000)
       deallocate(S375)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X90,F2,Z238)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z238, 1.000)
       deallocate(Z238)
       deallocate(X90)
C
...
C
     ...
     & N0,N1,M1,N1,M2,N3,M1,N1,S376,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,M2,N3,M1,N1,X91,S377,-1.000)
       deallocate(S377)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X91,F2,Z239)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z239, 1.000)
       deallocate(Z239)
       deallocate(X91)
C
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N1,S378,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N1,X92,S379,-1.000)
       deallocate(S379)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X92,F2,Z240)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z240, 1.000)
       deallocate(Z240)
       deallocate(X92)
C
...
C
     ...
     & N0,N1,M1,N1,N1,M2,M1,N1,S380,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N1,N1,M2,M2,N3,M1,N1,X93,S381,-1.000)
       deallocate(S381)
C
       allocate(F2(M1+1:N1,N1+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder631245(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N1,N1,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3C1,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X93,F2,Z241)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z241, 1.000)
       deallocate(Z241)
       deallocate(X93)
C
...
C
       allocate(D1(N0+1:N1,N0+1:M1,M2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,M1,N0,N1,M2,N3,
     & N0,N1,N0,M1,M2,N3,M1,N1,S382,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N1,X94,S383,-1.000)
       deallocate(S383)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X94,F2,Z246)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z246, 1.000)
       deallocate(Z246)
       deallocate(X94)
C
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N1,S384,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N1,X95,S385,-1.000)
       deallocate(S385)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,M2,N3,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X95,F2,Z247)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z247, 1.000)
       deallocate(Z247)
       deallocate(X95)
C
...
C
     ...
     & N0,N1,N0,M1,N2,M2,M1,N1,S386,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,M2,N3,M1,N1,X96,S387,-1.000)
       deallocate(S387)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & N0,M1,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X96,F2,Z248)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z248, 1.000)
       deallocate(Z248)
       deallocate(X96)
C
...
C
     ...
     & N0,N1,M1,N2,N2,M2,M1,N1,S388,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N2,N2,M2,M2,N3,M1,N1,X97,S389,-1.000)
       deallocate(S389)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N2))
       call reorder412356(N2,N3,N2,N3,N2,M2,N0,N2,N0,N2,M1,N2,
     & M1,N2,N2,M2,N2,M2,N2,M2,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X97,F2,Z249)
       deallocate(F2)
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z249, 1.000)
       deallocate(Z249)
       deallocate(X97)
C
...
C
     ...
     & N2,N3,N0,N1,N2,M2,M1,N1,S372,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X1,S392, 1.000)
       deallocate(S392)
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder3241(M1,N1,N0,N1,N2,N3,N2,M2,
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X2,S393, 1.000)
       deallocate(S393)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder2341(M1,N1,N0,N1,N2,N3,N2,M2,
     & N0,N1,N2,N3,N2,M2,M1,N1,S372,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,N2,M2,M2,N3,M1,N1,X9,S373,-1.000)
C
       call
     & sum3124(N2,N3,N2,M2,M2,N3,M1,N1,X10,S373,-1.000)
       deallocate(S373)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X3,S395, 1.000)
       deallocate(S395)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder3421(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X4,S397, 1.000)
       deallocate(S397)
C
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,S398,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X3,S399,-1.000)
       deallocate(S399)
C
       allocate(D1(N2+1:N3,N0+1:N1,N1+1:N3,N2+1:M2))
       call reorder1423(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder2341(M1,N2,N0,N1,N1,N3,N2,M2,
     & N0,N1,N1,N3,N2,M2,M1,N2,S400,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X4,S401,-1.000)
       deallocate(S401)
C
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S402,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S484,-1.000)
       deallocate(S484)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X2,S485,-1.000)
       deallocate(S485)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S402,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N1,X8,S403,-1.000)
       deallocate(S403)
C
...
C
     ...
     & N0,N2,N2,N3,M2,N3,M1,N1,S408,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N2,N3,N2,M2,M2,N3,M1,N1,X9,S410,-1.000)
       deallocate(S410)
C
       allocate(D1(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N2,N3,M2,N3,
...
C
       call
     & sum2134(N2,N3,N2,M2,M2,N3,M1,N1,X10,S411,-1.000)
       deallocate(S411)
C
       allocate(D1(N2+1:N3,N0+1:N2,M2+1:N3,M1+1:N1))
       call reorder3241(M1,N1,N0,N2,N2,N3,M2,N3,
     & N2,N3,N0,N2,M2,N3,M1,N1,S408,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N2,M2,N3,M1,N2,M1,N1,X8,S409, 1.000)
       deallocate(S409)
C
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N1,S412,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N0,M1,M1,N2,M1,N1,X33,S413, 1.000)
       deallocate(S413)
C
...
C
       V3C=V3C-Z33
       call
     & sum123546(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z33, 1.000)
       deallocate(Z33)
       deallocate(X33)
C
...
C
     ...
     & N2,N3,M1,N2,N0,M1,M1,N1,S414,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(M1,N2,N0,M1,M1,N2,M1,N1,X34,S415, 1.000)
       deallocate(S415)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       V3C=V3C-Z34
       call
     & sum123546(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z34, 1.000)
       deallocate(Z34)
       deallocate(X34)
C
...
C
     ...
     & N2,N3,N0,M1,M1,N1,M1,N1,S416,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M1,N1,M1,N2,M1,N1,X35,S417, 1.000)
       deallocate(S417)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       V3C=V3C-Z35
       call
     & sum123546(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z35, 1.000)
       deallocate(Z35)
       deallocate(X35)
C
...
C
     ...
     & N2,N3,M1,N2,M1,N1,M1,N1,S418,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M1,N1,M1,N2,M1,N1,X36,S419, 1.000)
       deallocate(S419)
C
       call sumx3412(N0,N2,N0,N1,N0,N2,N0,N1,
...
C
       V3C=V3C-Z36
       call
     & sum123546(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z36, 1.000)
       deallocate(Z36)
       deallocate(X36)
C
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N1,S420,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N1,X71,S428,-1.000)
       deallocate(S428)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum134526(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z108, 1.000)
       deallocate(Z108)
       deallocate(X71)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N1))
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N1,X70,S421,-1.000)
       deallocate(S421)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum234516(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z104,-1.000)
       deallocate(Z104)
       deallocate(X70)
C
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N1,S424,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum134526(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z110, 1.000)
       deallocate(Z110)
       deallocate(X73)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,M1+1:N1))
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N1,X72,S425,-1.000)
       deallocate(S425)
C
       allocate(F2(N0+1:M1,N2+1:M2,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum234516(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z106,-1.000)
       deallocate(Z106)
       deallocate(X72)
C
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N1,S422,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N1,X75,S429,-1.000)
       deallocate(S429)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum134526(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z109, 1.000)
       deallocate(Z109)
       deallocate(X75)
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,M1+1:N1))
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N1,X74,S423,-1.000)
       deallocate(S423)
C
       allocate(F2(M1+1:N1,M2+1:N3,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum234516(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z105,-1.000)
       deallocate(Z105)
       deallocate(X74)
C
...
C
     ...
     & N0,N2,M1,N1,N2,M2,M1,N1,S426,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(M1,N1,N2,M2,N2,M2,M1,N1,X77,S431,-1.000)
       deallocate(S431)
C
       allocate(F2(M1+1:N1,N2+1:M2,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum134526(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z111, 1.000)
       deallocate(Z111)
       deallocate(X77)
C
       allocate(D1(N0+1:N2,M1+1:N1,N2+1:M2,M1+1:N1))
...
C
       call
     & sum3124(M1,N1,N2,M2,N2,M2,M1,N1,X76,S427,-1.000)
       deallocate(S427)
C
       allocate(F2(M1+1:N1,N2+1:M2,N2+1:M2,M2+1:N3,M1+1:N2,M1+1:N2))
       call reorder612345(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum234516(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z107,-1.000)
       deallocate(Z107)
       deallocate(X76)
C
...
C
     ...
     & N0,N1,N0,M1,M2,N3,M1,N2,S432,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,M2,N3,M1,N2,X78,S433, 1.000)
       deallocate(S433)
C
       allocate(F2(N0+1:M1,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum124635(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z112,-1.000)
       call
     & sum125634(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z112, 1.000)
       deallocate(Z112)
       deallocate(X78)
C
...
C
     ...
     & N0,N1,M1,N2,M2,N3,M1,N2,S434,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N2,M2,N3,M2,N3,M1,N2,X79,S435, 1.000)
       deallocate(S435)
C
       allocate(F2(M1+1:N2,M2+1:N3,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum124635(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z113,-1.000)
       call
     & sum125634(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z113, 1.000)
       deallocate(Z113)
       deallocate(X79)
C
...
C
     ...
     & N0,N1,N0,M1,N1,M2,M1,N2,S436,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,M2,N3,M1,N2,X80,S437, 1.000)
       deallocate(S437)
C
       allocate(F2(N0+1:M1,N1+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum124635(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z114,-1.000)
       call
     & sum125634(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z114, 1.000)
       deallocate(Z114)
       deallocate(X80)
C
...
C
     ...
     & N0,N1,M1,N2,N1,M2,M1,N2,S438,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(M1,N2,N1,M2,M2,N3,M1,N2,X81,S439, 1.000)
       deallocate(S439)
C
       allocate(F2(M1+1:N2,N1+1:M2,N2+1:M2,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder431256(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
...
C
       call
     & sum124635(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z115,-1.000)
       call
     & sum125634(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z115, 1.000)
       deallocate(Z115)
       deallocate(X81)
C
...
C
       call
     & sum123465(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z116, 1.000)
       call
     & sum123564(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z116,-1.000)
       deallocate(Z116)
       deallocate(X82)
C
...
C
       call
     & sum123465(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z117, 1.000)
       call
     & sum123564(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z117,-1.000)
       deallocate(Z117)
       deallocate(X83)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,M2+1:N3))
...
C
     ...
     & N0,N1,M2,N3,M2,N3,N2,M2,S440,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum4123(M2,N3,M2,N3,N2,M2,M2,N3,X49,S441, 1.000)
       deallocate(S441)
C
...
C
       call
     & sum245613(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z49, 1.000)
       deallocate(Z49)
       deallocate(X49)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
...
C
     ...
     & N0,N1,N2,M2,M2,N3,N2,M2,S442,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum4123(N2,M2,M2,N3,N2,M2,M2,N3,X50,S443, 1.000)
       deallocate(S443)
C
       call sumx1234(N2,N3,N1,N3,N2,M2,N1,N3,
...
C
       call
     & sum245613(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z50, 1.000)
       deallocate(Z50)
       deallocate(X50)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
...
C
     ...
     & N0,N1,M2,N3,N1,M2,N2,M2,S444,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum4123(M2,N3,N1,M2,N2,M2,M2,N3,X51,S445, 1.000)
       deallocate(S445)
C
       call sumx1234(N2,N3,N1,N3,N2,M2,N1,N3,
...
C
       call
     & sum245613(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z51, 1.000)
       deallocate(Z51)
       deallocate(X51)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
...
C
     ...
     & N0,N1,N2,M2,N1,M2,N2,M2,S446,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum4123(N2,M2,N1,M2,N2,M2,M2,N3,X52,S447, 1.000)
       deallocate(S447)
C
       call sumx1234(N2,N3,N1,N3,N2,M2,N1,N3,
...
C
       call
     & sum245613(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z52, 1.000)
       deallocate(Z52)
       deallocate(X52)
C
...
C
       call
     & sum134562(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z128,-1.000)
       deallocate(Z128)
       deallocate(X85)
C
       allocate(B2(N0+1:N2,N2+1:M2))
...
C
       call
     & sum234561(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z122, 1.000)
       deallocate(Z122)
       deallocate(X84)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,M2+1:N3))
...
C
       allocate(D1(N0+1:N1,M2+1:N3,M2+1:N3,N2+1:M2))
       call reorder2341(N2,M2,N0,N1,M2,N3,M2,N3,
     & N0,N1,M2,N3,M2,N3,N2,M2,S448,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum4123(M2,N3,M2,N3,N2,M2,M2,N3,X53,S449, 1.000)
       deallocate(S449)
C
       call sumx1234(N2,N3,N1,N3,N2,M2,N1,N3,
...
C
       call
     & sum145623(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z53,-1.000)
       deallocate(Z53)
       deallocate(X53)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
...
C
       allocate(D1(N0+1:N1,N2+1:M2,M2+1:N3,N2+1:M2))
       call reorder2341(N2,M2,N0,N1,N2,M2,M2,N3,
     & N0,N1,N2,M2,M2,N3,N2,M2,S450,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum4123(N2,M2,M2,N3,N2,M2,M2,N3,X54,S451, 1.000)
       deallocate(S451)
C
       call sumx1234(N2,N3,N1,N3,N2,M2,N1,N3,
...
C
       call
     & sum145623(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z54,-1.000)
       deallocate(Z54)
       deallocate(X54)
C
       allocate(D1(N0+1:N2,N0+1:N1,M2+1:N3,N1+1:M2))
...
C
       allocate(D1(N0+1:N1,M2+1:N3,N1+1:M2,N2+1:M2))
       call reorder2341(N2,M2,N0,N1,M2,N3,N1,M2,
     & N0,N1,M2,N3,N1,M2,N2,M2,S452,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum4123(M2,N3,N1,M2,N2,M2,M2,N3,X55,S453, 1.000)
       deallocate(S453)
C
       call sumx1234(N2,N3,N1,N3,N2,M2,N1,N3,
...
C
       call
     & sum145623(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z55,-1.000)
       deallocate(Z55)
       deallocate(X55)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:M2,N1+1:M2))
...
C
       allocate(D1(N0+1:N1,N2+1:M2,N1+1:M2,N2+1:M2))
       call reorder2341(N2,M2,N0,N1,N2,M2,N1,M2,
     & N0,N1,N2,M2,N1,M2,N2,M2,S454,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum4123(N2,M2,N1,M2,N2,M2,M2,N3,X56,S455, 1.000)
       deallocate(S455)
C
       call sumx1234(N2,N3,N1,N3,N2,M2,N1,N3,
...
C
       call
     & sum145623(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z56,-1.000)
       deallocate(Z56)
       deallocate(X56)
C
...
C
       call
     & sum134562(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z129,-1.000)
       deallocate(Z129)
       deallocate(X87)
C
       allocate(B2(N0+1:N2,N2+1:M2))
...
C
       call
     & sum234561(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z123, 1.000)
       deallocate(Z123)
       deallocate(X86)
C
...
C
       call
     & sum124563(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z21, 1.000)
       deallocate(Z21)
       deallocate(X21)
C
...
C
       call
     & sum124563(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z22, 1.000)
       deallocate(Z22)
       deallocate(X22)
C
...
C
     ...
     & N0,N1,N1,N3,N0,N1,M1,N1,S456,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X1,S458, 1.000)
       deallocate(S458)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N1,N0,N1,N1,N3,
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X98,S457, 1.000)
       deallocate(S457)
C
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X99,S460, 1.000)
       deallocate(S460)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S464, 1.000)
       deallocate(S464)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S461)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S461, 1.000)
       deallocate(S461)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N1+1:N3))
       call reorder3142(N1,N3,N1,N3,N0,N1,N0,N1,
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X100,S463, 1.000)
       deallocate(S463)
C
...
C
     ...
     & N0,N2,N2,N3,N0,N1,M1,N1,S465,D1)
       allocate(D2(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder3124(N2,N3,N2,N3,N0,N2,N0,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X102,S467, 1.000)
       deallocate(S467)
C
     ...
     & N0,N1,N2,M2,M2,N3,M1,N2,t2B,D2)
       ...
       I2=K8*K6*K0
       I3=K1
       call DMATMAT(I1,I2,I3,X102,D2,Z272)
       deallocate(D2)
C
       call
     & sum235146(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z272,-1.000)
       call
     & sum234156(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z272, 1.000)
       deallocate(Z272)
       deallocate(X102)
C
       allocate(D1(N0+1:N1,N2+1:N3,N0+1:N2,M1+1:N1))
       call reorder3421(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N1,N2,N3,N0,N2,M1,N1,S465,D1)
       allocate(D2(N0+1:N1,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,M2,N3,M1,N2,t2B,D2)
...
C
       call
     & sum2314(N0,N2,M2,N3,M1,N2,M1,N1,X8,S468,-1.000)
       deallocate(S468)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
     & N0,N2,N0,N1,N2,N3,M1,N1,S465,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,M2,N3,t2B,D2)
...
C
       call
     & sum2314(N2,N3,N2,M2,M2,N3,M1,N1,X9,S469, 1.000)
       deallocate(S469)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
       call
     & sum2314(N2,N3,N2,M2,M2,N3,M1,N1,X10,S470, 1.000)
       deallocate(S470)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,M1+1:N1))
       call reorder4231(M1,N1,N0,N2,N0,N1,N2,N3,
     & N2,N3,N0,N2,N0,N1,M1,N1,S465,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder3214(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S573,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N1,X8,S574,-1.000)
       deallocate(S574)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
     ...
     & N0,N1,N2,N3,N2,M2,M1,N1,S575,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,N2,M2,M2,N3,M1,N1,X9,S576, 1.000)
       deallocate(S576)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder2341(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder2314(N2,M2,N0,N1,N2,N3,M1,N1,
     & N0,N1,N2,N3,N2,M2,M1,N1,S577,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,N2,M2,M2,N3,M1,N1,X10,S578, 1.000)
       deallocate(S578)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,M1+1:N1))
       call reorder2431(M1,N1,N0,N2,N0,N1,N2,N3,
...
C
       call
     & sum2314(N0,N1,N2,M2,M1,N2,M1,N1,X98,S466, 1.000)
       deallocate(S466)
C
       allocate(D2(N0+1:N1,N2+1:M2,M2+1:N3,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum135246(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z252, 1.000)
       call
     & sum134256(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z252,-1.000)
       deallocate(Z252)
       deallocate(X98)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
     & N0,N2,N0,N1,M1,N2,M1,N1,S573,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S579,-1.000)
       deallocate(S579)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder2314(M1,N2,N0,N2,N0,N1,M1,N1,
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X2,S580,-1.000)
       deallocate(S580)
C
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S483)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X5,S483,-1.000)
       deallocate(S483)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S477)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X8,S477, 1.000)
       deallocate(S477)
C
       allocate(B1(N2+1:N3,N0+1:N2))
       call reorder21(N0,N2,N2,N3,
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S480)
       deallocate(B1)
       deallocate(D2)
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X6,S480,-1.000)
       deallocate(S480)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder2314(N2,M2,N0,N1,N2,N3,M1,N1,
     & N0,N1,N2,N3,N2,M2,M1,N1,S404,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,N2,M2,M2,N3,M1,N1,X9,S405, 1.000)
       deallocate(S405)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,M1+1:N1))
       call reorder3412(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder2314(N2,M2,N0,N1,N2,N3,M1,N1,
     & N0,N1,N2,N3,N2,M2,M1,N1,S406,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,N2,M2,M2,N3,M1,N1,X10,S407, 1.000)
       deallocate(S407)
C
...
C
     ...
     & N0,N2,N1,N3,M2,N3,M1,N2,S486,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N1,N3,N2,M2,M2,N3,M1,N2,X4,S488,-1.000)
       deallocate(S488)
C
       allocate(D1(N0+1:N2,N1+1:N3,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N1,N3,M2,N3,
...
C
       call
     & sum2134(N1,N3,N2,M2,M2,N3,M1,N2,X3,S487,-1.000)
       deallocate(S487)
C
...
C
     ...
     & N0,N2,N0,N2,M1,N2,M1,N2,S489,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N2,N2,M2,M1,N2,M1,N2,X88,S490,-1.000)
       deallocate(S490)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
...
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,S492,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X7,S493, 1.000)
       deallocate(S493)
C
...
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,S494,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N2,N3,N2,M2,N2,M2,M1,N2,X7,S498,-1.000)
       deallocate(S498)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:M2,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N2,N3,N2,M2,
     & N2,N3,N0,N2,N2,M2,M1,N2,S494,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N2,N2,M2,M1,N2,M1,N2,X5,S495, 1.000)
       deallocate(S495)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:N3,N2+1:M2))
       call reorder2413(N2,N3,N2,N3,N2,N3,N0,N2,
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N2,N3,N2,M2,
     & N0,N2,N2,N3,N2,M2,M1,N2,S496,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X7,S499, 1.000)
       deallocate(S499)
C
       allocate(D1(N2+1:N3,N0+1:N2,N2+1:M2,M1+1:N2))
       call reorder3241(M1,N2,N0,N2,N2,N3,N2,M2,
     & N2,N3,N0,N2,N2,M2,M1,N2,S496,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N2,N2,M2,M1,N2,M1,N2,X6,S497, 1.000)
       deallocate(S497)
C
...
C
     ...
     & N0,N2,N0,M1,M2,N3,M1,N2,S500,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X15,S508,-1.000)
       deallocate(S508)
C
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z15, 1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z15,-1.000)
       deallocate(Z15)
       deallocate(X15)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X11,S501,-1.000)
       deallocate(S501)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z11,-1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z11, 1.000)
       deallocate(Z11)
       deallocate(X11)
C
...
C
     ...
     & N0,N2,N0,M1,N1,M2,M1,N2,S504,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,M1,N2,X17,S510,-1.000)
       deallocate(S510)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z17,-1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z17, 1.000)
       deallocate(Z17)
       deallocate(X17)
C
       allocate(D1(N0+1:N2,N0+1:M1,N1+1:M2,M1+1:N2))
...
C
       call
     & sum3124(N0,M1,N1,M2,N2,M2,M1,N2,X13,S505,-1.000)
       deallocate(S505)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z13, 1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z13,-1.000)
       deallocate(Z13)
       deallocate(X13)
C
...
C
     ...
     & N0,N2,M1,N1,M2,N3,M1,N2,S502,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N2,X16,S509,-1.000)
       deallocate(S509)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z16, 1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z16,-1.000)
       deallocate(Z16)
       deallocate(X16)
C
       allocate(D1(N0+1:N2,M1+1:N1,M2+1:N3,M1+1:N2))
...
C
       call
     & sum3124(M1,N1,M2,N3,N2,M2,M1,N2,X12,S503,-1.000)
       deallocate(S503)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z12,-1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z12, 1.000)
       deallocate(Z12)
       deallocate(X12)
C
...
C
     ...
     & N0,N2,M1,N1,N1,M2,M1,N2,S506,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,M1,N2,X18,S511,-1.000)
       deallocate(S511)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z18,-1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z18, 1.000)
       deallocate(Z18)
       deallocate(X18)
C
       allocate(D1(N0+1:N2,M1+1:N1,N1+1:M2,M1+1:N2))
...
C
       call
     & sum3124(M1,N1,N1,M2,N2,M2,M1,N2,X14,S507,-1.000)
       deallocate(S507)
C
       call sumx4231(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z14, 1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z14,-1.000)
       deallocate(Z14)
       deallocate(X14)
C
...
C
     ...
     & N2,N3,N0,M1,N0,M1,M1,N2,S512,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N0,M1,M1,N2,M1,N2,X57,S513, 1.000)
       deallocate(S513)
C
...
C
       call
     & sum123645(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z57, 0.500)
       deallocate(Z57)
       deallocate(X57)
C
...
C
     ...
     & N2,N3,N0,M1,M1,N2,M1,N2,S514,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M1,N2,M1,N2,M1,N2,X58,S515, 1.000)
       deallocate(S515)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
...
C
       call
     & sum123645(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z58, 1.000)
       deallocate(Z58)
       deallocate(X58)
C
...
C
     ...
     & N2,N3,M1,N2,M1,N2,M1,N2,S516,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M1,N2,M1,N2,M1,N2,X59,S517, 1.000)
       deallocate(S517)
C
       call sumx3412(N0,N2,N0,N2,N0,N2,N0,N2,
...
C
       call
     & sum123645(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z59, 0.500)
       deallocate(Z59)
       deallocate(X59)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:M1,M2+1:N3))
...
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,M1,M2,N3,
     & N0,N2,N0,M1,M2,N3,M1,N2,S518,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X64,S526, 1.000)
       deallocate(S526)
C
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z64,-1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z64, 1.000)
       deallocate(Z64)
       deallocate(X64)
C
       allocate(D1(N0+1:N2,N0+1:M1,M2+1:N3,M1+1:N2))
...
C
       call
     & sum3124(N0,M1,M2,N3,N2,M2,M1,N2,X60,S519, 1.000)
       deallocate(S519)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z60, 1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z60,-1.000)
       deallocate(Z60)
       deallocate(X60)
C
...
C
     ...
     & N0,N2,N0,M1,N2,M2,M1,N2,S522,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N2,X66,S528, 1.000)
       deallocate(S528)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z66,-1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z66, 1.000)
       deallocate(Z66)
       deallocate(X66)
C
       allocate(D1(N0+1:N2,N0+1:M1,N2+1:M2,M1+1:N2))
...
C
       call
     & sum3124(N0,M1,N2,M2,N2,M2,M1,N2,X62,S523, 1.000)
       deallocate(S523)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z62, 1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z62,-1.000)
       deallocate(Z62)
       deallocate(X62)
C
...
C
     ...
     & N0,N2,M1,N2,M2,N3,M1,N2,S520,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(M1,N2,M2,N3,N2,M2,M1,N2,X65,S527, 1.000)
       deallocate(S527)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z65,-1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z65, 1.000)
       deallocate(Z65)
       deallocate(X65)
C
       allocate(D1(N0+1:N2,M1+1:N2,M2+1:N3,M1+1:N2))
...
C
       call
     & sum3124(M1,N2,M2,N3,N2,M2,M1,N2,X61,S521, 1.000)
       deallocate(S521)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z61, 1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z61,-1.000)
       deallocate(Z61)
       deallocate(X61)
C
...
C
     ...
     & N0,N2,M1,N2,N2,M2,M1,N2,S524,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,M1,N2,X67,S529, 1.000)
       deallocate(S529)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum134625(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z67,-1.000)
       call
     & sum135624(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z67, 1.000)
       deallocate(Z67)
       deallocate(X67)
C
       allocate(D1(N0+1:N2,M1+1:N2,N2+1:M2,M1+1:N2))
...
C
       call
     & sum3124(M1,N2,N2,M2,N2,M2,M1,N2,X63,S525, 1.000)
       deallocate(S525)
C
       call sumx2431(N2,N3,N0,N2,N2,N3,N0,N2,
...
C
       call
     & sum234615(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z63, 1.000)
       call
     & sum235614(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z63,-1.000)
       deallocate(Z63)
       deallocate(X63)
C
...
C
       call
     & sum123465(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z23, 1.000)
       call
     & sum123564(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z23,-1.000)
       deallocate(Z23)
       deallocate(X23)
C
...
C
       call
     & sum123465(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z24, 1.000)
       call
     & sum123564(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z24,-1.000)
       deallocate(Z24)
       deallocate(X24)
C
       allocate(D1(N0+1:N2,N0+1:N2,M2+1:N3,N2+1:M2))
...
C
     ...
     & N0,N2,M2,N3,N2,M2,N2,M2,S530,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(M2,N3,N2,M2,N2,M2,N2,M2,X68,S531, 1.000)
       deallocate(S531)
C
...
C
       call
     & sum345612(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z68, 1.000)
       deallocate(Z68)
       deallocate(X68)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:M2,N2+1:M2))
...
C
     ...
     & N0,N2,N2,M2,N2,M2,N2,M2,S532,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum3124(N2,M2,N2,M2,N2,M2,N2,M2,X69,S533, 1.000)
       deallocate(S533)
C
       call sumx1234(N2,N3,N2,N3,N2,N3,N2,M2,
...
C
       call
     & sum345612(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z69, 0.500)
       deallocate(Z69)
       deallocate(X69)
C
...
C
       call
     & sum134562(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z27,-1.000)
       deallocate(Z27)
       deallocate(X27)
C
       allocate(B2(N0+1:N2,N2+1:M2))
...
C
       call
     & sum234561(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z25, 1.000)
       deallocate(Z25)
       deallocate(X25)
C
...
C
       call
     & sum134562(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z28,-1.000)
       deallocate(Z28)
       deallocate(X28)
C
       allocate(B2(N0+1:N2,N2+1:M2))
...
C
       call
     & sum234561(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z26, 1.000)
       deallocate(Z26)
       deallocate(X26)
C
...
C
     ...
     & N0,N2,N0,N1,N1,N3,M1,N2,S534,D1)
       allocate(D2(N0+1:N2,N0+1:N1,N2+1:M2,M2+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,M2,M2,N3,t2B,D2)
...
C
       call
     & sum2314(N1,N3,N2,M2,M2,N3,M1,N2,X4,S540, 1.000)
       deallocate(S540)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
       call reorder2341(M1,N2,N0,N2,N0,N1,N1,N3,
...
C
       call
     & sum2314(N1,N3,N2,M2,M2,N3,M1,N2,X3,S541, 1.000)
       deallocate(S541)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N0,N2,M1,N2,S534,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X89,S542, 1.000)
       deallocate(S542)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
       call reorder3421(M1,N2,N0,N2,N0,N1,N1,N3,
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder2314(N2,M2,N0,N1,N1,N3,M1,N2,
     & N0,N1,N1,N3,N2,M2,M1,N2,S581,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X3,S582, 1.000)
       deallocate(S582)
C
...
C
       call
     & sum246135(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z3,-1.000)
       call
     & sum256134(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z3, 1.000)
       deallocate(Z3)
       deallocate(X3)
C
       allocate(D1(N0+1:N2,N0+1:N1,N1+1:N3,M1+1:N2))
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder2314(N2,M2,N0,N1,N1,N3,M1,N2,
     & N0,N1,N1,N3,N2,M2,M1,N2,S583,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X4,S584, 1.000)
       deallocate(S584)
C
       call sumx2341(N2,N3,N1,N3,N0,N2,N1,N3,
...
C
       call
     & sum146235(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z4, 1.000)
       call
     & sum156234(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z4,-1.000)
       deallocate(Z4)
       deallocate(X4)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,M1+1:N2))
...
C
       call
     & sum2413(N0,N2,M2,N3,M1,N2,M1,N1,X8,S535, 1.000)
       deallocate(S535)
C
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N2,M2,S538,D1)
       allocate(D2(N0+1:N1,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,M2,N3,M1,N2,t2B,D2)
...
C
       call
     & sum3412(N1,N3,N2,M2,M2,N3,M1,N2,X99,S549,-1.000)
       deallocate(S549)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder2431(N2,M2,N0,N1,N2,N3,N1,N3,
     & N0,N1,N1,N3,N2,N3,N2,M2,S538,D1)
       allocate(D2(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder4213(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
...
C
       call
     & sum2413(N2,N3,N2,M2,N2,M2,M1,N2,X101,S551, 1.000)
       deallocate(S551)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder2431(N2,M2,N0,N1,N2,N3,N1,N3,
...
C
       call
     & sum3412(N2,N3,N2,M2,M2,N3,M1,N1,X10,S539,-1.000)
       deallocate(S539)
C
       allocate(D1(N0+1:N2,N0+1:N1,N2+1:N3,N1+1:N3))
       call reorder3412(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       allocate(D1(N0+1:N1,N2+1:N3,N1+1:N3,N2+1:M2))
       call reorder2341(N2,M2,N0,N1,N2,N3,N1,N3,
     & N0,N1,N2,N3,N1,N3,N2,M2,S536,D1)
       allocate(D2(N0+1:N1,N2+1:N3,M2+1:N3,M1+1:N2))
       call reorder4123(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N1,N2,N3,M2,N3,M1,N2,t2B,D2)
...
C
       call
     & sum3412(N1,N3,N2,M2,M2,N3,M1,N2,X100,S546,-1.000)
       deallocate(S546)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder2431(N2,M2,N0,N1,N2,N3,N1,N3,
     & N0,N1,N1,N3,N2,N3,N2,M2,S536,D1)
       allocate(D2(N0+1:N1,N1+1:N3,M2+1:N3,M1+1:N1))
       call reorder3124(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N1,N3,M2,N3,M1,N1,t2A,D2)
...
C
       call
     & sum3412(N2,N3,N2,M2,M2,N3,M1,N1,X9,S537,-1.000)
       deallocate(S537)
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:N3,N2+1:M2))
       call reorder2431(N2,M2,N0,N1,N2,N3,N1,N3,
...
C
       call
     & sum3412(N2,N3,N2,M2,N2,M2,M1,N2,X101,S547,-1.000)
       deallocate(S547)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X2,S553, 1.000)
       deallocate(S553)
C
       allocate(B1(N1+1:N3,N0+1:N1))
       call reorder21(N0,N1,N1,N3,
...
C
       call
     & sum2341(N0,N1,N2,M2,M1,N2,M1,N1,X1,S550, 1.000)
       deallocate(S550)
C
...
C
     ...
     & N0,N2,N0,N1,M1,N2,M1,N1,S475,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X1,S548,-1.000)
       deallocate(S548)
C
       allocate(D1(N0+1:N1,N0+1:N2,M1+1:N2,M1+1:N1))
       call reorder4312(M1,N2,M1,N1,N0,N2,N0,N1,
     & N0,N1,N0,N2,M1,N2,M1,N1,S475,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum2134(N0,N2,M2,N3,M1,N2,M1,N1,X8,S476,-1.000)
       deallocate(S476)
C
       allocate(D1(N0+1:N2,N0+1:N1,M1+1:N2,M1+1:N1))
       call reorder3412(M1,N2,M1,N1,N0,N2,N0,N1,
...
C
       call
     & sum2134(N0,N1,N2,M2,M1,N2,M1,N1,X2,S552,-1.000)
       deallocate(S552)
C
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X88,S557,-1.000)
       deallocate(S557)
C
...
C
       call
     & sum236145(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z148,-1.000)
       call
     & sum236154(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z148, 1.000)
       deallocate(Z148)
       deallocate(X88)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
...
C
       call
     & sum2413(N0,N2,M2,N3,M1,N2,M1,N1,X8,S558, 1.000)
       deallocate(S558)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
...
C
       call
     & sum2314(N2,N3,N2,M2,N2,M2,M1,N2,X7,S555,-0.500)
       deallocate(S555)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N2,M1+1:N2))
...
C
       allocate(D1(N0+1:N2,N0+1:N2,M1+1:N2,M1+1:N2))
       call reorder2314(M1,N2,N0,N2,N0,N2,M1,N2,
     & N0,N2,N0,N2,M1,N2,M1,N2,S585,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N0,N2,N2,M2,M1,N2,M1,N2,X5,S586, 1.000)
       deallocate(S586)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,M1+1:N2))
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:M2,M1+1:N2))
       call reorder2314(N2,M2,N0,N2,N2,N3,M1,N2,
     & N0,N2,N2,N3,N2,M2,M1,N2,S588,D1)
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X7,S589,-1.000)
       deallocate(S589)
C
...
C
       call
     & sum346125(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z7, 1.000)
       call
     & sum356124(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z7,-1.000)
       deallocate(Z7)
       deallocate(X7)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,M1+1:N2))
...
C
       call
     & sum2314(N0,N2,N2,M2,M1,N2,M1,N2,X89,S556,-1.000)
       deallocate(S556)
C
       allocate(D2(N0+1:N2,N2+1:M2,M2+1:N3,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
...
C
       call
     & sum136245(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z149, 1.000)
       call
     & sum136254(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z149,-1.000)
       deallocate(Z149)
       deallocate(X89)
C
       allocate(D1(N0+1:N2,N0+1:N2,M1+1:N2,M1+1:N2))
...
C
       call
     & sum2134(N0,N2,N2,M2,M1,N2,M1,N2,X6,S587, 1.000)
       deallocate(S587)
C
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N2,M2,S566,D1)
       allocate(D2(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M2,N3,M1,N1,t2B,D2)
...
C
       call
     & sum3412(N2,N3,N2,M2,M2,N3,M1,N1,X9,S567,-1.000)
       deallocate(S567)
C
...
C
       call
     & sum2134(N0,N2,N2,M2,M1,N2,M1,N2,X5,S565,-0.500)
       deallocate(S565)
C
       allocate(D1(N0+1:N2,N0+1:N2,M1+1:N2,M1+1:N2))
       call reorder3412(M1,N2,M1,N2,N0,N2,N0,N2,
...
C
       call
     & sum2134(N0,N2,N2,M2,M1,N2,M1,N2,X6,S568,-0.500)
       deallocate(S568)
C
       allocate(D1(N0+1:N2,N0+1:N2,N2+1:N3,N2+1:N3))
       call reorder3412(N2,N3,N2,N3,N0,N2,N0,N2,
...
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N2+1:M2))
       call reorder2431(N2,M2,N0,N2,N2,N3,N2,N3,
     & N0,N2,N2,N3,N2,N3,N2,M2,S570,D1)
       allocate(D2(N0+1:N2,N2+1:N3,M2+1:N3,M1+1:N1))
       call reorder3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,M2,N3,M1,N1,t2B,D2)
...
C
       call
     & sum3412(N2,N3,N2,M2,M2,N3,M1,N1,X10,S571,-1.000)
       deallocate(S571)
C
...
C
       call
     & sum2341(N0,N2,M2,N3,M1,N2,M1,N1,X8,S563, 1.000)
       deallocate(S563)
C
...
C
       call
     & sum124356(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z8, 1.000)
       call
     & sum125346(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z8,-1.000)
       deallocate(Z8)
       deallocate(X8)
C
       allocate(B1(N2+1:N3,N0+1:N2))
...
C
       call
     & sum136245(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z6, 1.000)
       deallocate(Z6)
       deallocate(X6)
C
       allocate(B1(N2+1:N3,N0+1:N2))
...
C
       call
     & sum2341(N0,N2,N2,M2,M1,N2,M1,N2,X5,S572,-1.000)
       deallocate(S572)
C
       call sumx2134(N2,N3,N0,N2,N0,N2,N0,N2,
...
C
       call
     & sum236145(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z5,-1.000)
       deallocate(Z5)
       deallocate(X5)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
...
C
       call
     & sum2134(N2,N3,N2,M2,N2,M2,M1,N2,X101,S560, 1.000)
       deallocate(S560)
C
...
C
     ...
     & N2,N3,N0,N1,N2,M2,M1,N1,S481,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X2,S545,-1.000)
       deallocate(S545)
C
...
C
       call
     & sum134256(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z2,-1.000)
       call
     & sum135246(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z2, 1.000)
       deallocate(Z2)
       deallocate(X2)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder3412(N2,M2,M1,N1,N0,N1,N2,N3,
     & N0,N1,N2,N3,N2,M2,M1,N1,S481,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,N2,M2,M2,N3,M1,N1,X10,S482, 1.000)
       deallocate(S482)
C
...
C
       call
     & sum145236(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z10,-1.000)
       deallocate(Z10)
       deallocate(X10)
C
       allocate(D1(N0+1:N2,N1+1:N3,N0+1:N1,N2+1:N3))
...
C
       allocate(D1(N2+1:N3,N0+1:N1,N2+1:M2,M1+1:N1))
       call reorder4312(N2,M2,M1,N1,N0,N1,N2,N3,
     & N2,N3,N0,N1,N2,M2,M1,N1,S478,D1)
       allocate(B2(N2+1:N3,M1+1:N2))
       call reorder12(N2,N3,N0,N2,
     & N2,N3,M1,N2,t1B,B2)
...
C
       call
     & sum3124(N0,N1,N2,M2,M1,N2,M1,N1,X1,S543,-1.000)
       deallocate(S543)
C
       call sumx2134(N2,N3,N0,N1,N0,N2,N0,N1,
...
C
       call
     & sum234156(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z1, 1.000)
       call
     & sum235146(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z1,-1.000)
       deallocate(Z1)
       deallocate(X1)
C
       allocate(D1(N0+1:N1,N2+1:N3,N2+1:M2,M1+1:N1))
       call reorder3412(N2,M2,M1,N1,N0,N1,N2,N3,
     & N0,N1,N2,N3,N2,M2,M1,N1,S478,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N2,N3,N2,M2,M2,N3,M1,N1,X9,S479, 1.000)
       deallocate(S479)
C
       call sumx2314(N2,N3,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum245136(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z9, 1.000)
       deallocate(Z9)
       deallocate(X9)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N2,N2+1:N3))
...
C
       call
     & sum3124(N2,N3,N2,M2,N2,M2,M1,N2,X101,S562, 1.000)
       deallocate(S562)
C
       allocate(D2(N2+1:N3,M2+1:N3,M1+1:N2,M1+1:N1))
       call reorder1234(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K4
       call DMATMAT(I1,I2,I3,X101,D2,Z263)
       deallocate(D2)
C
       call
     & sum356124(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z263,-1.000)
       call
     & sum346125(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z263, 1.000)
       deallocate(Z263)
       deallocate(X101)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X99,S472, 1.000)
       deallocate(S472)
C
       allocate(D2(N1+1:N3,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,X99,D2,Z254)
       deallocate(D2)
C
       call
     & sum156234(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z254, 1.000)
       call
     & sum146235(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z254,-1.000)
       deallocate(Z254)
       deallocate(X99)
C
       allocate(D1(N0+1:N2,N2+1:N3,N0+1:N1,N1+1:N3))
...
C
       allocate(D1(N0+1:N1,N1+1:N3,N2+1:M2,M1+1:N2))
       call reorder3412(N2,M2,M1,N2,N0,N1,N1,N3,
     & N0,N1,N1,N3,N2,M2,M1,N2,S473,D1)
       allocate(B2(N0+1:N1,M2+1:N3))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,M2,N3,t1A,B2)
...
C
       call
     & sum3124(N1,N3,N2,M2,M2,N3,M1,N2,X100,S474, 1.000)
       deallocate(S474)
C
       allocate(D2(N1+1:N3,N2+1:M2,M1+1:N2,M1+1:N1))
       call reorder2134(N2,N3,N1,N3,N0,N2,N0,N1,
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,X100,D2,Z255)
       deallocate(D2)
C
       call
     & sum256134(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z255,-1.000)
       call
     & sum246135(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z255, 1.000)
       deallocate(Z255)
       deallocate(X100)
C
       allocate(D1(N0+1:M1,M2+1:N3,M2+1:N3,M1+1:N1))
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z70, 1.000)
       deallocate(Z70)
C
       allocate(D1(M1+1:N2,M2+1:N3,M2+1:N3,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z71, 1.000)
       deallocate(Z71)
C
       allocate(D1(N0+1:M1,N2+1:M2,M2+1:N3,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z72, 1.000)
       deallocate(Z72)
C
       allocate(D1(M1+1:N2,N2+1:M2,M2+1:N3,M1+1:N1))
       call reorder1324(N0,N2,N1,N3,N2,N3,N0,N1,
...
C
       call
     & sum124536(N2,M2,N2,M2,M2,N3,M1,N2,M1,N2,M1,N1,V3C,Z73, 1.000)
       deallocate(Z73)
C
