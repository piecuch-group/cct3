...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,B1,D2,S163)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X103,D2,Z454)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K9*K6
       I3=K0
       call DMATMAT(I1,I2,I3,X87,F2,Z128)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call DMATMAT(I1,I2,I3,Q77,D2,S471)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K6
       I3=K1
       call DMATMAT(I1,I2,I3,X99,D2,Z252)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q78,D2,S490)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S488)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call DMATMAT(I1,I2,I3,Q89,D2,S561)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K6
       I3=K2
       call DMATMAT(I1,I2,I3,X89,D2,Z148)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S581)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,M1,N1,t2B,D2)
       ...
       I2=K7*K9*K0
       I3=K2
       call DMATMAT(I1,I2,I3,Q90,D2,S583)
       deallocate(D2)
C
       call
