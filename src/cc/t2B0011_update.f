       subroutine t2B0011_update(N0,N1,N2,N3,HT2B,shift,
...
C
       allocate(V2B(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       V2B=0.0d0
C
     ...
     & N1,N3,N0,M1,t1A,B2)
       allocate(S39(N0+1:M1,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K5
       I2=K5
       I3=K3
...
C
       ...
       X3=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M2,N3,N0,M1,X3,S39,-1.000)
       deallocate(S39)
C
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z3(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
     ...
     & N1,N3,M1,N1,M1,N1,M2,N3,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S41(N0+1:M1,M1+1:N1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K7
       I2=K5
       I3=K3
...
C
       ...
       X4=0.0d0
       call
     & sum4123(M1,N1,M1,N1,M2,N3,N0,M1,X4,S41,-1.000)
       deallocate(S41)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & M1,N1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z4(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K7*K7
...
C
     ...
     & N1,N3,N0,M1,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S43(N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K5
       I2=K5
       I3=K3
...
C
       ...
       X5=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N1,M2,N0,M1,X5,S43,-1.000)
       deallocate(S43)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z5(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K9*K7*K5
...
C
     ...
     & N1,N3,M1,N1,M1,N1,N1,M2,VAHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S45(N0+1:M1,M1+1:N1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K7
       I2=K5
       I3=K3
...
C
       ...
       X6=0.0d0
       call
     & sum4123(M1,N1,M1,N1,N1,M2,N0,M1,X6,S45,-1.000)
       deallocate(S45)
C
       call sumx3412(N1,N3,N0,N1,N0,N1,N0,N1,
...
C
     ...
     & M1,N1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z6(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K9*K7*K7
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,t3B3,F2)
       ...
       deallocate(F2)
C
       allocate(X21(N0+1:N1,N2+1:M2,N0+1:M1,N0+1:M1))
       X21=0.0d0
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X21,S47, 1.000)
       deallocate(S47)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X21,S49, 2.000)
       deallocate(S49)
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       allocate(S51(N1+1:M2,M1+1:N1,N1+1:M2,N1+1:M2))
       I1=K9*K9*K7
       I2=K9
       I3=K1
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z52, 0.500)
       deallocate(Z52)
       deallocate(S51)
C
...
C
     ...
     & N1,N3,M1,N2,N0,M1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S55(N0+1:M1,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K8
       I2=K5
       I3=K3
...
C
     ...
     & M1,N2,N0,M1,M2,N3,N0,M1,S55,D1)
     ...
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z56(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K5*K8
...
C
     ...
     & N1,N3,N0,M1,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S57(N0+1:M1,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K5
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,M1,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S59(N0+1:M1,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K8
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,M1,N2,N0,M1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S61(N0+1:M1,M1+1:N2,N0+1:M1,N2+1:M2))
       I1=K0*K5*K8
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,N0,M1,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S63(N0+1:M1,N0+1:M1,M1+1:N1,N2+1:M2))
       I1=K0*K7*K5
       I2=K5
       I3=K3
...
C
     ...
     & N1,N3,M1,N2,M1,N1,N2,M2,VBHHPP,D1)
       ...
       call reorder12(N1,N3,N0,N1,
     & N1,N3,N0,M1,t1A,B2)
       allocate(S65(N0+1:M1,M1+1:N2,M1+1:N1,N2+1:M2))
       I1=K0*K7*K8
       I2=K5
       I3=K3
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X21,S67, 2.000)
       deallocate(S67)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X21,S69, 2.000)
       deallocate(S69)
C
...
C
       call
     & sum2341(N0,N1,N2,M2,N0,M1,N0,M1,X21,S71, 2.000)
       deallocate(S71)
C
       allocate(B2(N0+1:N1,N1+1:M2))
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(Z48(N1+1:M2,N2+1:M2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K0
       I2=K9
       I3=K1
       call DMATMAT(I1,I2,I3,X21,B2,Z48)
       deallocate(B2)
C
       call
     & sum2134(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z48, 0.500)
       deallocate(Z48)
       deallocate(X21)
C
     ...
     & N0,N1,M1,N2,N2,M2,N1,M2,VBHHPP,D1)
       ...
       call reorder21(N1,N3,N0,N1,
     & N0,N1,N1,M2,t1A,B2)
       allocate(S73(N1+1:M2,M1+1:N2,N2+1:M2,N1+1:M2))
       I1=K9*K0*K8
       I2=K9
       I3=K1
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z74, 1.000)
       deallocate(Z74)
       deallocate(S73)
C
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z75(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I2=K5*K5*K9*K0
       I3=K6*K8
       call DVECMAT(I2,I3,Q3,F2,Z75)
       deallocate(F2)
C
       V2B=V2B-Z75
       deallocate(Z75)
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z76(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I2=K5*K5*K9*K0
       I3=K0*K8
       call DVECMAT(I2,I3,Q4,F2,Z76)
       deallocate(F2)
C
       V2B=V2B-Z76
       deallocate(Z76)
...
C
     ...
     & N2,N3,N0,M1,t1B,B2)
       allocate(S77(N0+1:M1,M1+1:N2,N0+1:M1,M2+1:N3))
       I1=K6*K5*K8
       I2=K5
       I3=K4
...
C
       ...
       X7=0.0d0
       call
     & sum4123(M1,N2,N0,M1,M2,N3,N0,M1,X7,S77, 1.000)
       deallocate(S77)
C
...
C
     ...
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(Z10(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K5*K8
...
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z10,-1.000)
       deallocate(Z10)
       deallocate(X7)
C
     ...
     & N2,N3,N0,M1,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S79(N0+1:M1,N0+1:M1,M1+1:N1,M2+1:N3))
       I1=K6*K7*K5
       I2=K5
       I3=K4
...
C
       ...
       X8=0.0d0
       call
     & sum4123(N0,M1,M1,N1,M2,N3,N0,M1,X8,S79, 1.000)
       deallocate(S79)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z11(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z11, 1.000)
       deallocate(Z11)
       deallocate(X8)
C
     ...
     & N2,N3,M1,N2,M1,N1,M2,N3,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S81(N0+1:M1,M1+1:N2,M1+1:N1,M2+1:N3))
       I1=K6*K7*K8
       I2=K5
       I3=K4
...
C
       ...
       X9=0.0d0
       call
     & sum4123(M1,N2,M1,N1,M2,N3,N0,M1,X9,S81, 1.000)
       deallocate(S81)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z12(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K7*K8
...
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z12, 1.000)
       deallocate(Z12)
       deallocate(X9)
C
     ...
     & N2,N3,M1,N2,N0,M1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S83(N0+1:M1,M1+1:N2,N0+1:M1,N1+1:M2))
       I1=K9*K5*K8
       I2=K5
       I3=K4
...
C
       ...
       X10=0.0d0
       call
     & sum4123(M1,N2,N0,M1,N1,M2,N0,M1,X10,S83, 1.000)
       deallocate(S83)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,N0,M1,N1,M2,N2,M2,N1,M2,N0,M1,t3B4,F2)
       allocate(Z13(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K9*K5*K8
...
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z13,-1.000)
       deallocate(Z13)
       deallocate(X10)
C
     ...
     & N2,N3,N0,M1,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S85(N0+1:M1,N0+1:M1,M1+1:N1,N1+1:M2))
       I1=K9*K7*K5
       I2=K5
       I3=K4
...
C
       ...
       X11=0.0d0
       call
     & sum4123(N0,M1,M1,N1,N1,M2,N0,M1,X11,S85, 1.000)
       deallocate(S85)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
       ...
       call reorder462135(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & N0,M1,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z14(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K9*K7*K5
...
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z14, 1.000)
       deallocate(Z14)
       deallocate(X11)
C
     ...
     & N2,N3,M1,N2,M1,N1,N1,M2,VBHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S87(N0+1:M1,M1+1:N2,M1+1:N1,N1+1:M2))
       I1=K9*K7*K8
       I2=K5
       I3=K4
...
C
       ...
       X12=0.0d0
       call
     & sum4123(M1,N2,M1,N1,N1,M2,N0,M1,X12,S87, 1.000)
       deallocate(S87)
C
       call sumx4312(N0,N2,N1,N3,N0,N2,N0,N1,
...
C
     ...
     & M1,N2,M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,t3B1,F2)
       allocate(Z15(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K9*K7*K8
...
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z15, 1.000)
       deallocate(Z15)
       deallocate(X12)
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       ...
       deallocate(F2)
C
       allocate(X22(N0+1:N2,N1+1:M2,N0+1:M1,N0+1:M1))
       X22=0.0d0
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X22,S89, 1.000)
       deallocate(S89)
C
     ...
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(S91(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X22,S91, 1.000)
       deallocate(S91)
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(S93(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X22,S93, 1.000)
       deallocate(S93)
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       allocate(S95(N2+1:M2,M1+1:N1,N2+1:M2,N1+1:M2))
       I1=K9*K0*K7
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X13(M1+1:N1,N2+1:M2,N1+1:M2,N2+1:M2))
       X13=0.0d0
       call
     & sum4123(M1,N1,N2,M2,N1,M2,N2,M2,X13,S95,-1.000)
       deallocate(S95)
C
       call sumx2341(N2,N3,N1,N3,N2,N3,N0,N1,
     & M1,N1,N2,M2,N1,M2,N2,M2,X13,VBHPPP, 1.000)
C
       allocate(F2(M1+1:N1,N2+1:M2,N1+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z19(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K5*K9
       I3=K9*K0*K7
...
C
       call
     & sum2341(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z19,-1.000)
       deallocate(Z19)
       deallocate(X13)
C
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z1(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I2=K5*K5*K9*K0
       I3=K6*K7
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z2(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I2=K5*K5*K9*K0
       I3=K9*K7
...
C
     ...
     & N2,N3,N0,M1,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S99(N0+1:M1,N0+1:M1,M1+1:N2,M2+1:N3))
       I1=K6*K8*K5
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X16(N0+1:M1,M1+1:N2,M2+1:N3,N0+1:M1))
       X16=0.0d0
       call
     & sum4123(N0,M1,M1,N2,M2,N3,N0,M1,X16,S99,-1.000)
       deallocate(S99)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,M1,M1,N2,M2,N3,N0,M1,X16,VCHHHP, 1.000)
C
     ...
     & N0,M1,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z32(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K8*K5
       call DMATMAT(I1,I2,I3,X16,F2,Z32)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z32,-1.000)
       deallocate(Z32)
       deallocate(X16)
C
     ...
     & N2,N3,M1,N2,M1,N2,M2,N3,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S101(N0+1:M1,M1+1:N2,M1+1:N2,M2+1:N3))
       I1=K6*K8*K8
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X17(M1+1:N2,M1+1:N2,M2+1:N3,N0+1:M1))
       X17=0.0d0
       call
     & sum4123(M1,N2,M1,N2,M2,N3,N0,M1,X17,S101,-1.000)
       deallocate(S101)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & M1,N2,M1,N2,M2,N3,N0,M1,X17,VCHHHP, 1.000)
C
       allocate(F2(M1+1:N2,M1+1:N2,M2+1:N3,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z33(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K8*K8
       call DMATMAT(I1,I2,I3,X17,F2,Z33)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z33,-0.500)
       deallocate(Z33)
       deallocate(X17)
C
     ...
     & N2,N3,N0,M1,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S103(N0+1:M1,N0+1:M1,M1+1:N2,N2+1:M2))
       I1=K0*K8*K5
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X18(N0+1:M1,M1+1:N2,N2+1:M2,N0+1:M1))
       X18=0.0d0
       call
     & sum4123(N0,M1,M1,N2,N2,M2,N0,M1,X18,S103,-1.000)
       deallocate(S103)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & N0,M1,M1,N2,N2,M2,N0,M1,X18,VCHHHP, 1.000)
C
       allocate(F2(N0+1:M1,M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & N0,M1,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z34(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K0*K8*K5
       call DMATMAT(I1,I2,I3,X18,F2,Z34)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z34,-1.000)
       deallocate(Z34)
       deallocate(X18)
C
     ...
     & N2,N3,M1,N2,M1,N2,N2,M2,VCHHPP,D1)
       ...
       call reorder12(N2,N3,N0,N2,
     & N2,N3,N0,M1,t1B,B2)
       allocate(S105(N0+1:M1,M1+1:N2,M1+1:N2,N2+1:M2))
       I1=K0*K8*K8
       I2=K5
       I3=K4
       ...
       deallocate(B2)
C
       allocate(X19(M1+1:N2,M1+1:N2,N2+1:M2,N0+1:M1))
       X19=0.0d0
       call
     & sum4123(M1,N2,M1,N2,N2,M2,N0,M1,X19,S105,-1.000)
       deallocate(S105)
C
       call sumx3412(N2,N3,N0,N2,N0,N2,N0,N2,
     & M1,N2,M1,N2,N2,M2,N0,M1,X19,VCHHHP, 1.000)
C
       allocate(F2(M1+1:N2,M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1))
       call reorder451236(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z35(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K0*K8*K8
       call DMATMAT(I1,I2,I3,X19,F2,Z35)
       deallocate(F2)
C
       call
     & sum1243(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z35,-0.500)
       deallocate(Z35)
       deallocate(X19)
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3C3,F2)
       allocate(S107(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X22,S107,-0.500)
       deallocate(S107)
C
     ...
     & M1,N2,M2,N3,N2,M2,N0,N2,VCHHPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(S109(N1+1:M2,N0+1:M1,N0+1:M1,N0+1:N2))
       I1=K2
       I2=K5*K5*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(N0,N2,N1,M2,N0,M1,N0,M1,X22,S109,-1.000)
       deallocate(S109)
C
       allocate(B2(N0+1:N2,N2+1:M2))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(Z90(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5*K5*K9
       I2=K0
       I3=K2
       call DMATMAT(I1,I2,I3,X22,B2,Z90)
       deallocate(B2)
C
       V2B=V2B+Z90
       deallocate(Z90)
...
C
     ...
     & N0,N2,M1,N2,N2,M2,N2,M2,VCHHPP,D1)
       ...
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,M2,t1B,B2)
       allocate(S111(N2+1:M2,M1+1:N2,N2+1:M2,N2+1:M2))
       I1=K0*K0*K8
       I2=K0
       I3=K2
       ...
       deallocate(B2)
C
       allocate(X20(M1+1:N2,N2+1:M2,N2+1:M2,N2+1:M2))
       X20=0.0d0
       call
     & sum4123(M1,N2,N2,M2,N2,M2,N2,M2,X20,S111,-1.000)
       deallocate(S111)
C
       call sumx2341(N2,N3,N2,N3,N2,N3,N0,N2,
     & M1,N2,N2,M2,N2,M2,N2,M2,X20,VCHPPP, 1.000)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z38(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K5*K9
       I3=K0*K0*K8
       call DMATMAT(I1,I2,I3,X20,F2,Z38)
       deallocate(F2)
C
       call
     & sum2341(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z38, 0.500)
       deallocate(Z38)
       deallocate(X20)
C
...
C
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z20(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I2=K5*K5*K9*K0
       I3=K6*K8
       call DVECMAT(I2,I3,X14,F2,Z20)
       deallocate(F2)
C
       V2B=V2B-Z20
       deallocate(Z20)
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       deallocate(B2)
C
       allocate(X15(M1+1:N2,N2+1:M2))
       X15=0.0d0
       X15=X15+Q8
       deallocate(Q8)
C
       call sumx21(N2,N3,N0,N2,
     & M1,N2,N2,M2,X15,FBHP, 1.000)
C
       allocate(F2(M1+1:N2,N2+1:M2,N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z21(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I2=K5*K5*K9*K0
       I3=K0*K8
       call DVECMAT(I2,I3,X15,F2,Z21)
       deallocate(F2)
C
       V2B=V2B-Z21
       deallocate(Z21)
...
C
     ...
     & M1,N1,M2,N3,M2,N3,N1,M2,VAHPPP,D1)
       ...
       call reorder623145(N2,M2,M2,N3,M2,N3,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,t3B3,F2)
       allocate(Z7(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K5*K0
       I3=K6*K6*K7
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z7, 0.500)
       deallocate(Z7)
C
     ...
     & M1,N1,M2,N3,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder623145(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N2,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z8(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K5*K0
       I3=K9*K6*K7
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z8, 1.000)
       deallocate(Z8)
C
       allocate(D1(M1+1:N1,N1+1:M2,N1+1:M2,N1+1:M2))
       call reorder4123(N1,N3,N1,N3,N1,N3,N0,N1,
     & M1,N1,N1,M2,N1,M2,N1,M2,VAHPPP,D1)
       ...
       call reorder623145(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N1,M2,N1,M2,N2,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z9(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K5*K0
       I3=K9*K9*K7
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z9, 0.500)
       deallocate(Z9)
C
     ...
     & M1,N1,M2,N3,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z16(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K5*K9
       I3=K6*K6*K7
...
C
       call
     & sum2341(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z16,-1.000)
       deallocate(Z16)
C
     ...
     & M1,N1,N2,M2,M2,N3,N2,M2,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,N2,M2,M2,N3,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z17(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K5*K9
       I3=K6*K0*K7
...
C
       call
     & sum2341(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z17,-1.000)
       deallocate(Z17)
C
     ...
     & M1,N1,M2,N3,N1,M2,N2,M2,VBHPPP,D1)
       ...
       call reorder612345(N2,N3,N1,N3,N1,M2,N0,N2,N0,N1,M1,N1,
     & M1,N1,M2,N3,N1,M2,N1,M2,N0,M1,N0,M1,t3B1,F2)
       allocate(Z18(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K5*K9
       I3=K9*K6*K7
...
C
       call
     & sum2341(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z18,-1.000)
       deallocate(Z18)
C
       allocate(D1(M1+1:N2,N0+1:M1,M2+1:N3,N0+1:M1))
     ...
     & M1,N2,N0,M1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder561234(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z22(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K5*K8
...
C
     ...
     & N0,M1,M1,N1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3C4,F2)
       allocate(Z23(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K7*K5
...
C
     ...
     & M1,N2,M1,N1,M2,N3,N0,M1,VBHHHP,D1)
       ...
       call reorder561234(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z24(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K6*K7*K8
...
C
     ...
     & M1,N2,N0,M1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder561234(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z25(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K0*K5*K8
...
C
     ...
     & N0,M1,M1,N1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder461235(N2,N3,N2,M2,N1,N3,N0,M1,N0,M1,M1,N1,
     & N0,M1,M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,t3C4,F2)
       allocate(Z26(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K0*K7*K5
...
C
     ...
     & M1,N2,M1,N1,N2,M2,N0,M1,VBHHHP,D1)
       ...
       call reorder561234(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,t3C1,F2)
       allocate(Z27(N2+1:M2,N1+1:M2,N0+1:M1,N0+1:M1))
       I1=K5
       I2=K5*K9*K0
       I3=K0*K7*K8
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder513246(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N2,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z28(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K5*K0
       I3=K6*K6*K8
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z28,-1.000)
       deallocate(Z28)
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,VBPHPP,D1)
       ...
       call reorder513246(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,M2,N3,N2,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z29(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K5*K0
       I3=K6*K0*K8
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z29,-1.000)
       deallocate(Z29)
C
     ...
     & M1,N2,M2,N3,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder513246(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N1,M2,N2,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z30(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K5*K0
       I3=K9*K6*K8
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z30,-1.000)
       deallocate(Z30)
C
       allocate(D1(M1+1:N2,N2+1:M2,N1+1:M2,N1+1:M2))
       call reorder3124(N2,N3,N1,N3,N0,N2,N1,N3,
     & M1,N2,N2,M2,N1,M2,N1,M2,VBPHPP,D1)
       ...
       call reorder513246(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,N2,M2,N1,M2,N2,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z31(N2+1:M2,N0+1:M1,N0+1:M1,N1+1:M2))
       I1=K9
       I2=K5*K5*K0
       I3=K9*K0*K8
...
C
       call
     & sum1342(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z31,-1.000)
       deallocate(Z31)
C
     ...
     & M1,N2,M2,N3,M2,N3,N2,M2,VCHPPP,D1)
       ...
       call reorder512346(M2,N3,M2,N3,N1,M2,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,M2,N3,N1,M2,N0,M1,N0,M1,t3C3,F2)
       allocate(Z36(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K5*K9
       I3=K6*K6*K8
...
C
       call
     & sum2341(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z36, 0.500)
       deallocate(Z36)
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,VCHPPP,D1)
       ...
       call reorder512346(N2,N3,N2,M2,N1,N3,N0,N2,M1,N2,N0,N1,
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       allocate(Z37(N1+1:M2,N0+1:M1,N0+1:M1,N2+1:M2))
       I1=K0
       I2=K5*K5*K9
       I3=K0*K6*K8
...
C
       call
     & sum2341(N2,M2,N1,M2,N0,M1,N0,M1,V2B,Z37, 1.000)
       deallocate(Z37)
C
       call sumx2(N2,N3,N1,N3,N0,N2,N0,N1,
     & N2,M2,N1,M2,N0,M1,N0,M1,HT2B,V2B,1.0)
       deallocate(V2B)
C
       end
