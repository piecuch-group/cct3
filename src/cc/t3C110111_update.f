...
C
     ...
     & M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K0*K0
       I3=K6
       call DMATMAT(I1,I2,I3,B1,F2,Z354)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K0*K0
       I3=K9
       call DMATMAT(I1,I2,I3,B1,F2,Z355)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S238)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S239)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z592)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C4,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,D1,F2,Z593)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,M1,N1,t3C1,F2)
       ...
       I2=K7*K5*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z594)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z612)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z624)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N2,M2,N0,M1,t2C,D2)
       ...
       I2=K5*K0
       I3=K4*K2
       call DMATMAT(I1,I2,I3,D1,D2,S537)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N2,M2,M1,N2,t2C,D2)
       ...
       I2=K8*K0
       I3=K4*K2
       call DMATMAT(I1,I2,I3,D1,D2,S562)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X130,F2,Z356)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K8
       call DMATMAT(I1,I2,I3,X131,F2,Z357)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X132,F2,Z358)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,X133,F2,Z359)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K5
       call DMATMAT(I1,I2,I3,X128,F2,Z350)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X126,F2,Z348)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X127,F2,Z349)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K9*K7
       call DMATMAT(I1,I2,I3,X129,F2,Z351)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K9*K0
       I3=K6*K7
       call DMATMAT(I1,I2,I3,X106,F2,Z146)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K9*K0
       I3=K0*K7
       call DMATMAT(I1,I2,I3,X108,F2,Z148)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K9*K0
       I3=K0*K5
       call DMATMAT(I1,I2,I3,X105,F2,Z151)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,t3C1,F2)
       ...
       I2=K8*K5*K9*K0
       I3=K6*K5
       call DMATMAT(I1,I2,I3,X103,F2,Z149)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K9*K0*K0
       I3=K8
       call DMATMAT(I1,I2,I3,X121,F2,Z164)
       deallocate(F2)
C
       call
...
C
     ...
     & M2,N3,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K9*K0
       I3=K6
       call DMATMAT(I1,I2,I3,X123,F2,Z175)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K9*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X125,F2,Z176)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K9*K0
       I3=K0
       call DMATMAT(I1,I2,I3,X124,F2,Z170)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S704)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S707)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S710)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S701)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S726)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S733)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S739)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,M2,N2,M2,N1,M2,N0,M1,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K5*K9
       I3=K0*K0
       call DMATMAT(I1,I2,I3,X101,F2,Z101)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S866)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K0
       I3=K3
       call DMATMAT(I1,I2,I3,B1,D2,S851)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S896)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S898)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,M1,N1,t2B,D2)
       ...
       I2=K7*K5*K9
       I3=K4
       call DMATMAT(I1,I2,I3,B1,D2,S890)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N2,M2,N0,M1,M1,N2,t3D,F2)
       ...
       I2=K8*K5*K0*K0
       I3=K0*K8
       call DMATMAT(I1,I2,I3,D1,F2,Z105)
       deallocate(D1)
       deallocate(F2)
C
       call
