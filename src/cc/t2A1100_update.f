...
C
     ...
     & N0,M1,M2,N3,N1,M2,M2,N3,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K6
       I3=K9*K6*K5
       call DMATMAT(I1,I2,I3,D1,F2,S28)
       deallocate(D1)
       deallocate(F2)
C
...
C
     ...
     & M1,N1,M2,N3,N1,M2,M2,N3,M1,N1,M1,N1,t3A,F2)
       ...
       I2=K7*K7*K6
       I3=K9*K6*K7
       call DMATMAT(I1,I2,I3,D1,F2,S30)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,X8,B2,Z29)
       deallocate(B2)
C
       V2A=V2A-Z29
       deallocate(Z29)
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,X9,B2,Z37)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call DMATMAT(I1,I2,I3,X10,B2,Z55)
       deallocate(B2)
C
       V2A=V2A-Z55
       call
