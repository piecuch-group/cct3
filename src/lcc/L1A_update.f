...
C
     ...
     & N0,N1,N1,N3,N1,N3,N0,N1,t2A,D2)
       ...
       I2=K1
       I3=K3*K3*K1
       call DMATMAT(I1,I2,I3,D1,D2,Q11)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N1,N3,N0,N1,t1A,B2)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,B1,B2,Q25)
       deallocate(B1)
       deallocate(B2)
       deallocate(Q21)
C
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,B1,B2,Q31)
       deallocate(B1)
       deallocate(B2)
       deallocate(Q27)
C
...
C
     ...
     & N2,N3,N0,N2,t1B,B2)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,B1,B2,Q33)
       deallocate(B1)
       deallocate(B2)
       deallocate(Q29)
C
...
C
     ...
     & N0,N1,N1,N3,l1A,B2)
       ...
       I2=K3
       I3=K1
       call DMATMAT(I1,I2,I3,B1,B2,U1)
       deallocate(B1)
       deallocate(B2)
C
       V1A=V1A-U1
...
C
     ...
     & N1,N3,N0,N1,l1A,B2)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,B1,B2,U2)
       deallocate(B1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,l2B,D2)
       ...
       I2=K1
       I3=K3*K4*K2
       call DMATMAT(I1,I2,I3,D1,D2,U18)
       deallocate(D1)
       deallocate(D2)
C
       call
