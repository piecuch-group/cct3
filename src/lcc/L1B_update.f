...
C
     ...
     & N0,N1,N0,N1,N1,N3,N1,N3,t2A,D2)
       ...
       I2=K3
       I3=K3*K1*K1
       call DMATMAT(I1,I2,I3,D1,D2,Q12)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N2,N3,N0,N2,l1B,B2)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,B1,B2,U3)
       deallocate(B1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,l2C,D2)
       ...
       I2=K4
       I3=K4*K2*K2
       call DMATMAT(I1,I2,I3,D1,D2,U33)
       deallocate(D1)
       deallocate(D2)
C
       V1B=V1B-1.0d0/2*U33
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,l2C,D2)
       ...
       I2=K2
       I3=K4*K4*K2
       call DMATMAT(I1,I2,I3,D1,D2,U34)
       deallocate(D1)
       deallocate(D2)
C
       call
