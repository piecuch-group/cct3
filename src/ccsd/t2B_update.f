       subroutine ccsd_t2B_update(N0,N1,N2,N3,V2B,shift,
     & K1,K2,K3,K4,
...
C
     ...
     & N1,N3,N0,N1,N2,N3,N0,N2,VBHPPH,D1)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,D1,t1A,S16)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N0,N1,N2,N3,N0,N1,VBHPHP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S20)
       deallocate(D1)
C
...
C
     ...
     & N1,N3,N0,N2,N1,N3,N0,N2,VBPHPH,D1)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,D1,t1A,S22)
       deallocate(D1)
C
...
C
     ...
     & N1,N3,N0,N1,N1,N3,N1,N3,VAHPPP,D1)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,D1,t1A,S29)
       deallocate(D1)
C
...
C
     ...
     & N1,N3,N0,N2,N0,N1,N0,N2,VBHHPH,D1)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,D1,t1A,S32)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N1,N3,N0,N1,N2,N3,VBHPPP,D1)
       ...
       I2=K1*K2
       I3=K3*K4
       call DMATMAT(I1,I2,I3,D1,t2B,S39)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N0,N2,N1,N3,N0,N1,S44,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S104)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N0,N1,N1,N3,N2,N3,VBHPPP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S50)
       deallocate(D1)
C
...
C
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,FBHP,t1B,Q7)
C
...
C
     ...
     & N2,N3,N0,N2,N0,N1,N0,N1,VBHHHP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S54)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N0,N2,N1,N3,N1,N3,VBPHPP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S59)
       deallocate(D1)
C
...
C
       ...
       I2=K1*K2
       I3=K3*K4
       call DMATMAT(I1,I2,I3,VBPHPP,t2B,S61)
C
...
C
     ...
     & N2,N3,N0,N2,N2,N3,N2,N3,VCHPPP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S67)
       deallocate(D1)
C
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       ...
       I2=K1*K3
       I3=K4*K2
       call DMATMAT(I1,I2,I3,X12,D2,U14)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,N1,N3,N0,N1,t2A,D2)
       ...
       I2=K1
       I3=K3*K3*K1
       call DMATMAT(I1,I2,I3,D1,D2,Q13)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N0,N1,N0,N1,N1,N3,N1,N3,t2A,D2)
       ...
       I2=K3
       I3=K3*K1*K1
       call DMATMAT(I1,I2,I3,D1,D2,Q14)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N2,N3,N0,N2,N1,N3,N0,N1,S74,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S119)
       deallocate(D1)
C
...
C
       ...
       I2=K1*K2
       I3=K3*K4
       call DMATMAT(I1,I2,I3,VBHHPP,t2B,S78)
C
...
C
     ...
     & N0,N2,N1,N3,N2,N3,N0,N1,t2B,D2)
       ...
       I2=K1*K4
       I3=K3*K2
       call DMATMAT(I1,I2,I3,X11,D2,U13)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N0,N2,N1,N3,N0,N2,S81,D1)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,D1,t1A,S108)
       deallocate(D1)
C
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       I2=K2*K4
       I3=K4*K2
       call DMATMAT(I1,I2,I3,X13,D2,U15)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N0,N2,N1,N3,N0,N1,S88,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S121)
       deallocate(D1)
C
...
C
     ...
     & N1,N3,N0,N1,N2,N3,N2,N3,VBHPPP,D1)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,D1,t1A,S34)
       deallocate(D1)
C
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K3
       I3=K4*K1
       call DMATMAT(I1,I2,I3,X10,D2,U12)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N0,N1,N2,N3,N0,N1,S34,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S92)
       deallocate(D1)
C
...
C
     ...
     & N1,N3,N0,N1,N0,N1,N1,N3,VAHHPP,D1)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,D1,t1A,S94)
       deallocate(D1)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N1,N0+1:N1))
...
C
     ...
     & N1,N3,N0,N2,N0,N1,N2,N3,VBHHPP,D1)
       ...
       I2=K1
       I3=K3
       call DMATMAT(I1,I2,I3,D1,t1A,S99)
       deallocate(D1)
C
       allocate(D1(N2+1:N3,N0+1:N2,N0+1:N1,N0+1:N1))
     ...
     & N2,N3,N0,N2,N0,N1,N0,N1,S99,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S106)
       deallocate(D1)
C
...
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       ...
       I2=K3*K4
       I3=K1*K2
       call DMATMAT(I1,I2,I3,X9,D2,U11)
       deallocate(D2)
C
       V2B=V2B+U11
       deallocate(U11)
...
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K4
       I3=K3*K1
       call DMATMAT(I1,I2,I3,X8,D2,U10)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N0,N2,N1,N3,N0,N1,VBHPPH,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S46)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N0,N2,N0,N1,N1,N3,VBHHPP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S111)
       deallocate(D1)
C
       allocate(D1(N0+1:N1,N1+1:N3,N0+1:N2,N0+1:N2))
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,Q26,B2,Q27)
       deallocate(B2)
C
...
C
     ...
     & N0,N1,N1,N3,t1A,B2)
       ...
       I2=K3
       I3=K1
       call DMATMAT(I1,I2,I3,Q28,B2,Q29)
       deallocate(B2)
C
...
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       ...
       I2=K3
       I3=K4*K1*K2
       call DMATMAT(I1,I2,I3,D1,D2,Q15)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N0,N1,N1,N3,t1A,B2)
       ...
       I2=K3
       I3=K1
       call DMATMAT(I1,I2,I3,Q22,B2,Q23)
       deallocate(B2)
C
...
C
     ...
     & N1,N3,N2,N3,N0,N2,N0,N1,t2B,D2)
       ...
       I2=K1*K2*K4
       I3=K3
       call DMATMAT(I1,I2,I3,X5,D2,U7)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,Q30,B2,Q32)
       deallocate(B2)
C
...
C
       ...
       I2=K1*K2*K3
       I3=K4
       call DMATMAT(I1,I2,I3,X7,t2B,U9)
C
       call
...
C
     ...
     & N2,N3,N0,N2,Q30,B1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,B1,t1B,Q31)
       deallocate(B1)
C
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       ...
       I2=K1*K3*K4
       I3=K2
       call DMATMAT(I1,I2,I3,X6,D2,U8)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,X2,B2,U3)
       deallocate(B2)
C
       V2B=V2B-U3
       deallocate(U3)
...
C
     ...
     & N2,N3,N2,N3,N1,N3,N0,N1,VBHPPP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,U4)
       deallocate(D1)
C
       call
