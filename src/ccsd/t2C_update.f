       subroutine ccsd_t2C_update(N0,N1,N2,N3,V2C,shift,
     & K1,K2,K3,K4,
...
C
     ...
     & N2,N3,N0,N2,N2,N3,N0,N2,VCHPHP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S12)
       deallocate(D1)
C
...
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K4
       I3=K3*K1
       call DMATMAT(I1,I2,I3,D1,D2,S14)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N2,N3,N0,N1,N1,N3,N2,N3,VBHPPP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S16)
       deallocate(D1)
C
...
C
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,FBHP,t1B,Q3)
C
...
C
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,t2C,D2)
       ...
       I2=K4*K4
       I3=K2*K2
       call DMATMAT(I1,I2,I3,D1,D2,U21)
       deallocate(D1)
       deallocate(D2)
C
       V2C=V2C+0.500*U21
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,D1,B2,U45)
       deallocate(D1)
       deallocate(B2)
C
       V2C=V2C+U45
...
C
     ...
     & N2,N3,N0,N2,N2,N3,N2,N3,VCHPPP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S25)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N0,N2,N2,N3,N0,N2,S32,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S48)
       deallocate(D1)
C
...
C
       ...
       I2=K2*K2
       I3=K4*K4
       call DMATMAT(I1,I2,I3,VCHHPP,t2C,S37)
C
...
C
     ...
     & N2,N3,N0,N2,N2,N3,N0,N2,S40,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S53)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N0,N2,Q11,B1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,B1,t1B,Q12)
       deallocate(B1)
C
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,Q11,B2,Q13)
       deallocate(B2)
C
...
C
     ...
     & N2,N3,N2,N3,N0,N2,N2,N3,VCHPPP,D1)
       ...
       I2=K2*K2
       I3=K4*K4
       call DMATMAT(I1,I2,I3,D1,t2C,S27)
       deallocate(D1)
C
...
C
     ...
     & N2,N3,N0,N2,N0,N2,N0,N2,S50,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,S51)
       deallocate(D1)
C
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,X7,B2,U11)
       deallocate(B2)
C
       V2C=V2C+U11
       deallocate(U11)
...
C
       ...
       I2=K2*K2*K4
       I3=K4
       call DMATMAT(I1,I2,I3,X4,t2C,U5)
C
       call
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call DMATMAT(I1,I2,I3,X8,B2,U13)
       deallocate(B2)
C
       call
...
C
     ...
     & N2,N3,N2,N3,N2,N3,N0,N2,VCHPPP,D1)
       ...
       I2=K2
       I3=K4
       call DMATMAT(I1,I2,I3,D1,t1B,U2)
       deallocate(D1)
C
       call
