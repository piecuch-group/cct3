...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,X23,B2,Z62)
       deallocate(B2)
C
       V2C=V2C-Z62
       deallocate(Z62)
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,X24,B2,Z77)
       deallocate(B2)
C
       call
