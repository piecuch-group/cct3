...
C
     ...
     & M2,N3,M2,N3,N1,M2,M1,N2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K8*K9
       I3=K6*K6
       call EGEMM(I1,I2,I3,D1,F2,U131)
       deallocate(D1)
       deallocate(F2)
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,Z132)
       deallocate(F1)
       deallocate(B2)
C
       call
...
C
     ...
     & N1,M2,M2,N3,M2,N3,M1,N2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K8*K6*K6
       I3=K9
       call EGEMM(I1,I2,I3,B1,F2,Z143)
       deallocate(B1)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X61,D2,Z191)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,M2,N3,M1,N2,t2C,D2)
       ...
       I2=K8*K6*K6
       I3=K2
       call EGEMM(I1,I2,I3,X62,D2,Z250)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,U356)
       deallocate(F1)
       deallocate(B2)
C
       allocate(F1(N0+1:N2,M2+1:N3,N1+1:M2,M1+1:N2,M1+1:N2,M1+1:N1))
     ...
     & N0,N2,M2,N3,t1B,B2)
       ...
       I2=K6
       I3=K2
       call EGEMM(I1,I2,I3,F1,B2,Z357)
       deallocate(F1)
       deallocate(B2)
C
       V3C=V3C+0.500*Z357
...
C
     ...
     & N0,M1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K9*K5
       call EGEMM(I1,I2,I3,X54,F2,Z139)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N1,N1,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3C3,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K9*K7
       call EGEMM(I1,I2,I3,X55,F2,Z140)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K0*K5
       call EGEMM(I1,I2,I3,X56,F2,Z144)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,M2,N3,M1,N2,M1,N2,t3D,F2)
       ...
       I2=K8*K8*K6*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,X57,F2,Z145)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,M2,N3,N1,M2,M1,N2,M1,N1,t3C3,F2)
       ...
       I2=K7*K8*K9*K6*K6
       I3=K8
       call EGEMM(I1,I2,I3,X49,F2,Z71)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,M1,N2,M1,N2,M1,N1,t3C1,F2)
       ...
       I2=K7*K8*K8*K9*K6
       I3=K0
       call EGEMM(I1,I2,I3,X51,F2,Z76)
       deallocate(F2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S262)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,M2,N3,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K6
       I3=K1
       call EGEMM(I1,I2,I3,X58,D2,Z147)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X53,D2,Z87)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,X59,D2,Z148)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,M2,N3,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K6
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S322)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S329)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S334)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,M2,N3,M1,N2,M1,N2,t2C,D2)
       ...
       I2=K8*K8*K6
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S272)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S270)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,M1,N1,t2B,D2)
       ...
       I2=K7*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,X60,D2,Z153)
       deallocate(D2)
C
       call
