...
C
     ...
     & N0,N1,M2,N3,t1A,B2)
       ...
       I2=K6
       I3=K1
       call EGEMM(I1,I2,I3,X15,B2,Z60)
       deallocate(B2)
C
       V2A=V2A+0.500*Z60
       deallocate(Z60)
