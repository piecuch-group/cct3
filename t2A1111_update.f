...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call EGEMM(I1,I2,I3,X17,B2,Z64)
       deallocate(B2)
C
       V2A=V2A+0.500*Z64
       deallocate(Z64)
...
C
     ...
     & N0,N1,N1,M2,t1A,B2)
       ...
       I2=K9
       I3=K1
       call EGEMM(I1,I2,I3,X18,B2,Z76)
       deallocate(B2)
C
       call
