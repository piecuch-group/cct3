...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S192)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S194)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S229)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,B1,D2,S230)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & M1,N2,M2,N3,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K6*K8
       call EGEMM(I1,I2,I3,D1,F2,Z520)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,N2,M2,N1,M2,N0,M1,N0,M1,t3C1,F2)
       ...
       I2=K5*K5*K9*K0
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z521)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,N2,M2,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K0
       I3=K6*K5
       call EGEMM(I1,I2,I3,D1,F2,Z538)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & M1,N2,N2,M2,M2,N3,N1,M2,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K9*K6
       I3=K0*K8
       call EGEMM(I1,I2,I3,D1,F2,Z551)
       deallocate(D1)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,M1,M2,N3,M2,N3,N1,M2,N0,M1,M1,N2,t3C3,F2)
       ...
       I2=K8*K5*K9*K6
       I3=K6*K5
       call EGEMM(I1,I2,I3,X93,F2,Z136)
       deallocate(F2)
C
       call
...
C
     ...
     & N2,M2,M2,N3,N1,M2,N0,M1,M1,N2,N0,M1,t3C1,F2)
       ...
       I2=K5*K8*K5*K9*K6
       I3=K0
       call EGEMM(I1,I2,I3,X109,F2,Z159)
       deallocate(F2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,N2,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K0
       I3=K3*K1
       call EGEMM(I1,I2,I3,D1,D2,S633)
       deallocate(D1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,Q83,D2,S641)
       deallocate(D2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S643)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,Q83,D2,S636)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,Q90,B2,Q94)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,t1B,B2)
       ...
       I2=K0
       I3=K2
       call EGEMM(I1,I2,I3,Q92,B2,Q95)
       deallocate(B2)
C
       call
...
C
     ...
     & N1,N3,N2,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K0
       I3=K3
       call EGEMM(I1,I2,I3,B1,D2,S769)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,M1,N2,t2B,D2)
       ...
       I2=K8*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,Q96,D2,S781)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K1
       call EGEMM(I1,I2,I3,Q96,D2,S765)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,N0,M1,N0,M1,t2B,D2)
       ...
       I2=K5*K5*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S803)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S809)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q97,D2,S811)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,M2,N1,M2,N0,M1,t2B,D2)
       ...
       I2=K5*K9*K0
       I3=K2
       call EGEMM(I1,I2,I3,Q84,D2,S666)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N1,M2,M1,N2,N0,M1,t2B,D2)
       ...
       I2=K5*K8*K9
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S658)
       deallocate(B1)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N2,M2,N0,M1,M1,N2,t2C,D2)
       ...
       I2=K8*K5*K0
       I3=K4
       call EGEMM(I1,I2,I3,B1,D2,S664)
       deallocate(B1)
       deallocate(D2)
C
       call
